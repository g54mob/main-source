...
namespace Linework.Common.Utils
{
	public static class RenderUtils
	{
		...
		{
			PassData passData;
			using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PassData>("Clear Stencil (Fast Outline)", out passData, ".\\Packages\\dev.ameye.linework\\Runtime\\Common\\Utils\\RenderUtils.cs", 133);
