...
namespace GameCreator.Runtime.Common
{
	...
	public class GetScaleValueDecimals : PropertyTypeGetScale
	{
		[SerializeField]
		...
		public static PropertyGetScale Create => new PropertyGetScale(new GetScaleValueDecimals());
		...
		{
			return new Vector3((float)m_X.Get(args), (float)m_X.Get(args), (float)m_X.Get(args));
		}
	}
}
