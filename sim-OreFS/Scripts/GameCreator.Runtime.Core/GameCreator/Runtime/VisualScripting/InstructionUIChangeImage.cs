...
namespace GameCreator.Runtime.VisualScripting
{
	...
	{
		[SerializeField]
		private bool m_OverrideSprite = true;
		...
		public override string Title => $"Image {m_Image} = {m_Sprite}";
		...
		protected override Task Run(Args args)
		{
			...
			if (m_OverrideSprite)
			{
				image.overrideSprite = m_Sprite.Get(args);
			}
			else
			{
				image.sprite = m_Sprite.Get(args);
			}
			return Instruction.DefaultResult;
		}
	}
