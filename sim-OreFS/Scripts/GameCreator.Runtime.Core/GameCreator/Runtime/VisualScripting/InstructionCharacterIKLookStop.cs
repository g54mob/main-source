...
namespace GameCreator.Runtime.VisualScripting
{
	...
	public class InstructionCharacterIKLookStop : Instruction
	{
		...
		public override string Title => $"{m_Character} stop look at {m_Target}";
		...
		protected override Task Run(Args args)
		{
			...
			LookToTransform look = new LookToTransform(m_Priority, transform, Vector3.zero);
			character.IK.GetRig<RigLookTo>().RemoveTarget(look);
			return Instruction.DefaultResult;
		}
	}
}
