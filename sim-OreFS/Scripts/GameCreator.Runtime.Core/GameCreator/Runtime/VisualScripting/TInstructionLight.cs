...
namespace GameCreator.Runtime.VisualScripting
{
	...
	[Keywords(new string[] { "Light", "Spot", "Sun", "Point", "Strength", "Burn", "Dark" })]
	[Image(typeof(IconLight), ColorTheme.Type.Yellow)]
	public abstract class TInstructionLight : Instruction
	{
		[SerializeField]
		protected PropertyGetGameObject m_Light = new PropertyGetGameObject();

		[Space]
		[SerializeField]
		protected Transition m_Transition = new Transition();
	}
}
