...
namespace GameCreator.Runtime.VisualScripting
{
	...
	[Keywords(new string[] { "Check", "Collide", "Touch", "Suit", "Square", "Cube", "2D" })]
	...
	public class ConditionPhysicsCheckBox2D : Condition
	{
		...
		protected override string Summary => $"check Box 2D at {m_Position}";

		protected override bool Run(Args args)
		{
			return Physics2D.OverlapBox(m_Position.Get(args).XY(), m_Size, m_Angle, new ContactFilter2D
			{
				useLayerMask = true,
