...
namespace Heathen.SteamworksIntegration
{
	...
	public class SteamSettings : ScriptableObject
	{
		...
		public static InitializeSteamworks behaviour;

		public uint applicationId = 480u;
		...
		public static AppData ApplicationId => (current != null) ? current.applicationId : 0u;
		...
		public void Initialize()
		{
			...
			App.callbackTick_Milliseconds = callbackTick_Milliseconds;
			if (client == null)
			{
