...
namespace Heathen.SteamworksIntegration
{
	...
	public struct GameData : IEquatable<AppId_t>, IEquatable<CGameID>, IEquatable<uint>, IEquatable<ulong>, IEquatable<AppData>, IComparable<AppData>, IComparable<AppId_t>, IComparable<uint>, IComparable<ulong>
	{
		...
		public static GameData Me => Heathen.SteamworksIntegration.API.App.Client.Id;
		...
		public static bool NamesLoaded => Heathen.SteamworksIntegration.API.App.Web.IsAppsListLoaded;
		...
		{
			return Heathen.SteamworksIntegration.API.App.Web.GetAppName(App, out name);
		}

		public readonly void GetName(Action<string, bool> callback)
		{
			Heathen.SteamworksIntegration.API.App.Web.GetAppName(App, callback);
		}

		public static void LoadNames(Action callback)
		{
			Heathen.SteamworksIntegration.API.App.Web.LoadAppNames(callback);
		}
