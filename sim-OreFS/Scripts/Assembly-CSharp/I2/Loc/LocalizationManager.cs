...
namespace I2.Loc
{
	public static class LocalizationManager
	{
		...
		public static string GetTranslation(InteractionMode mode, bool FixForRTL = true, int maxLineLengthForRTL = 0, bool ignoreRTLnumbers = true, bool applyParameters = false, GameObject localParametersRoot = null, string overrideLanguage = null, bool allowLocalizedParameters = true)
		{
			if (mode == InteractionMode.None)
			{
				return "";
			}
			string text = $"Enum_InteractionMode_{mode}";
			string translation = GetTranslation(text, FixForRTL, maxLineLengthForRTL, ignoreRTLnumbers, applyParameters, localParametersRoot, overrideLanguage, allowLocalizedParameters);
			if (string.IsNullOrEmpty(translation))
			{
				return text;
			}
		...
		public static string GetTranslation(PrimaryState state, bool FixForRTL = true, int maxLineLengthForRTL = 0, bool ignoreRTLnumbers = true, bool applyParameters = false, GameObject localParametersRoot = null, string overrideLanguage = null, bool allowLocalizedParameters = true)
		{
			if (state == PrimaryState.None)
			{
				return "";
			}
			string text = $"Enum_PrimaryState_{state}";
			string translation = GetTranslation(text, FixForRTL, maxLineLengthForRTL, ignoreRTLnumbers, applyParameters, localParametersRoot, overrideLanguage, allowLocalizedParameters);
			if (string.IsNullOrEmpty(translation))
			{
				return text;
		...
		public static string GetTranslation(SecondaryState state, bool FixForRTL = true, int maxLineLengthForRTL = 0, bool ignoreRTLnumbers = true, bool applyParameters = false, GameObject localParametersRoot = null, string overrideLanguage = null, bool allowLocalizedParameters = true)
		{
			if (state == SecondaryState.None)
			{
				return "";
			}
			string text = $"Enum_SecondaryState_{state}";
			string translation = GetTranslation(text, FixForRTL, maxLineLengthForRTL, ignoreRTLnumbers, applyParameters, localParametersRoot, overrideLanguage, allowLocalizedParameters);
			if (string.IsNullOrEmpty(translation))
			{
				return text;
		...
		public static string GetTranslation(ItemType itemType, bool FixForRTL = true, int maxLineLengthForRTL = 0, bool ignoreRTLnumbers = true, bool applyParameters = false, GameObject localParametersRoot = null, string overrideLanguage = null, bool allowLocalizedParameters = true)
		{
			if (itemType == ItemType.None)
			{
				return "";
			}
			string text = $"Enum_ItemType_{itemType}";
			string translation = GetTranslation(text, FixForRTL, maxLineLengthForRTL, ignoreRTLnumbers, applyParameters, localParametersRoot, overrideLanguage, allowLocalizedParameters);
			if (string.IsNullOrEmpty(translation))
			{
				return text;
		...
		public static string GetTranslation(PropertyType propertyType, bool FixForRTL = true, int maxLineLengthForRTL = 0, bool ignoreRTLnumbers = true, bool applyParameters = false, GameObject localParametersRoot = null, string overrideLanguage = null, bool allowLocalizedParameters = true)
		{
			string text = $"Enum_PropertyType_{propertyType}";
			string translation = GetTranslation(text, FixForRTL, maxLineLengthForRTL, ignoreRTLnumbers, applyParameters, localParametersRoot, overrideLanguage, allowLocalizedParameters);
			if (string.IsNullOrEmpty(translation))
			{
				return text;
		...
		public static string GetTranslation(PickupType pickupType, bool FixForRTL = true, int maxLineLengthForRTL = 0, bool ignoreRTLnumbers = true, bool applyParameters = false, GameObject localParametersRoot = null, string overrideLanguage = null, bool allowLocalizedParameters = true)
		{
			string text = $"Enum_PickupType_{pickupType}";
			string translation = GetTranslation(text, FixForRTL, maxLineLengthForRTL, ignoreRTLnumbers, applyParameters, localParametersRoot, overrideLanguage, allowLocalizedParameters);
			if (string.IsNullOrEmpty(translation))
			{
				return text;
		...
		public static string GetTranslation(PlayerActionNotificationType actionType, bool FixForRTL = true, int maxLineLengthForRTL = 0, bool ignoreRTLnumbers = true, bool applyParameters = false, GameObject localParametersRoot = null, string overrideLanguage = null, bool allowLocalizedParameters = true)
		{
			if (actionType == PlayerActionNotificationType.None)
			{
				return "";
			}
			string text = $"PlayerActionNotificationType_{actionType}";
			string translation = GetTranslation(text, FixForRTL, maxLineLengthForRTL, ignoreRTLnumbers, applyParameters, localParametersRoot, overrideLanguage, allowLocalizedParameters);
			if (string.IsNullOrEmpty(translation))
			{
				return text;
