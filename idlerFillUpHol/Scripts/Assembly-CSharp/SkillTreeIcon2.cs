...
public class SkillTreeIcon2 : MonoBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler, IPointerClickHandler
{
	...
	static SkillTreeIcon2()
	{
		...
		_iconInfo.Add(IconTypeEnum.B1_Bu_Catapult, new IconInfo(IconTypeEnum.B1_Bu_Catapult, Catapult.GlobalInfo.LevelUpAttribute, "Catapult", "Unlock Building\n\nPeon will store trash in the catapult, which will be thrown into the hole.\n\n+1 maximum catapult on map."));
		...
		_iconInfo.Add(IconTypeEnum.E1_Bu_Research, new IconInfo(IconTypeEnum.E1_Bu_Research, Research.GlobalInfo.LevelUpAttribute, "Research Lab", "Unlock Building\n\nResearch Lab allow peon to produce RP (research point).\n\n+1 maximum research lab on map."));
		...
		_iconInfo.Add(IconTypeEnum.F1_Bu_Training, new IconInfo(IconTypeEnum.F1_Bu_Training, Training.GlobalInfo.LevelUpAttribute, "Training", "Unlock Building\n\nTraining center help increase peons abilities.\n\n+1 maximum training on map."));
		...
		_iconInfo.Add(IconTypeEnum.I1_Bu_Power, new IconInfo(IconTypeEnum.I1_Bu_Power, Power.GlobalInfo.LevelUpAttribute, "Power", "Unlock Building\n\nPower stations increase attributes of nearby buildings.\n\n+1 maximum power on map."));
		...
		_iconInfo.Add(IconTypeEnum.K1_Bu_Baloon, new IconInfo(IconTypeEnum.K1_Bu_Baloon, HotAirStation.GlobalInfo.LevelUpAttribute, "Hangar", "Unlock Building\n\nHot Air balloon will fly and grab trash to throw back in the hole.\n\n+1 maximum hangar on map."));
