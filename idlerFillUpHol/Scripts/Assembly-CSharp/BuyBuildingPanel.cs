...
public class BuyBuildingPanel : BaseBuildingPanel
{
	...
	private void Start()
	{
		Title.Initialize(base.gameObject, "Build Building");
		HouseRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "House");
		CatapultRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "Catapult");
		TempleRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "Temple");
		HelicopterRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "Helipad");
		DroneRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "Cloud Seeder");
		ResearchRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "Research Lab");
		HotAirRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "Hangar");
		TrainingRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "Training");
		IndustryRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "Factory");
		PowerRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "Power");
		CompressorRow.Initialize(base.gameObject, MixedRow.StateEnum.NoValue, "Compressor");
		HouseRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("House", "", HousePanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.House).ToNumber() + "$"));
		CatapultRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Catapult", "", CatapultPanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.Catapult).ToNumber() + "$"));
		TempleRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Temple", "", TemplePanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.Temple).ToNumber() + "$"));
		HelicopterRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Helipad", "", HelicopterPanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.Helicopter).ToNumber() + "$"));
		DroneRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Cloud Seeder", "", DronePanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.Drone).ToNumber() + "$"));
		ResearchRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Research Lab", "", ResearchPanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.Research).ToNumber() + "$"));
		HotAirRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Hangar", "", HotAirStationPanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.HotAirBaloon).ToNumber() + "$"));
		TrainingRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Training", "", TrainingPanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.Training).ToNumber() + "$"));
		IndustryRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Factory", "", IndustryPanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.Industry).ToNumber() + "$"));
		PowerRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Power", "", PowerPanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.Power).ToNumber() + "$"));
		CompressorRow.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Compressor", "", CompressorPanel.GetTooltip(null), GetNewBuildingCost(BaseBuilding.BuildingTypeEnum.Compressor).ToNumber() + "$"));
