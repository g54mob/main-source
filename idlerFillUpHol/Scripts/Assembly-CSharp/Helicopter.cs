...
public class Helicopter : BaseBuildingWorker
{
	...
	public BaseMoneyLevelAttribute HasMoreGarbageAttribute = new BaseMoneyLevelAttribute("HasMoreGarbage", 10, (int l) => GameController.Instance.AddPrestigeCountTax(200 + 200 * l), () => true);
