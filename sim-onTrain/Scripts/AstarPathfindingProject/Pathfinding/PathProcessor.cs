...
namespace Pathfinding
{
	public class PathProcessor
	{
		...
		public void InitializeNode(GraphNode node)
		{
			...
			{
				throw new Exception("Trying to initialize a node when it is not safe to initialize any nodes. Must be done during a graph update. See https://arongranberg.com/astar/docs/graphupdates.html#direct");
			}
