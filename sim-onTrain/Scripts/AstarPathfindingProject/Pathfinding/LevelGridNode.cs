...
namespace Pathfinding
{
	public class LevelGridNode : GridNodeBase
	{
		...
		internal const ulong AxisAlignedConnectionsMask = 4294967295uL;

		public const int MaxLayerCount = 255;

		public override bool HasConnectionsToAllEightNeighbours => false;

		public override bool HasConnectionsToAllAxisAlignedNeighbours => (gridConnections & 0xFFFFFFFFu) == uint.MaxValue;
