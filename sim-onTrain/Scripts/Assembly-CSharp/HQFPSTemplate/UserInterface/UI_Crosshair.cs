...
namespace HQFPSTemplate.UserInterface
{
	public class UI_Crosshair : MonoBehaviour
	{
		...
		[SerializeField]
		private Image m_CenterImg;

		[SerializeField]
		private Image m_TopImg;

		[SerializeField]
		private Image m_BottomImg;
		...
		{
			m_Spring.AddForce(force);
		}

		public void AddSpringForce(UI_SpringForce force)
		{
			m_Spring.AddForce(force);
		}
		...
		public virtual void UpdateInfo(UI_CrosshairInfo crosshairInfo, int crosshairId)
		{
			...
			m_RectTransform.localEulerAngles = new Vector3(0f, 0f, crosshairInfo.GraphicsInfo.PivotRotation);
			if (m_Spring == null)
			{
