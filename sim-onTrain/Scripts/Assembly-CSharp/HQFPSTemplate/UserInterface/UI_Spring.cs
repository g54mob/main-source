...
namespace HQFPSTemplate.UserInterface
{
	public class UI_Spring
	{
		...
		public struct Data
		{
			...
			{
				Stiffness = Vector2.one * 0.1f,
				Damping = Vector2.one * 0.25f
			};
		...
		public Vector2 Position => m_LerpedPosition;

		public float Scale { get; set; }

		public float LerpSpeed { get; set; }

		public UI_Spring(RectTransform transform = null, Vector2 restVector = default(Vector2), float lerpSpeed = 25f)
		{
			Scale = 1f;
