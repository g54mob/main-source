...
namespace HQFPSTemplate
{
	public class Spring
	{
		...
		{
			DontUpdate = 0,
			OverrideLocalPosition = 1,
			AddToLocalPosition = 2,
			OverrideLocalRotation = 3,
			AddToLocalRotation = 4,
			OverrideLocalScale = 5,
			AddToLocalScale = 6
		}
		...
		public struct Data
		{
			...
			{
				Stiffness = Vector3.one * 0.1f,
				Damping = Vector3.one * 0.25f
			};
		...
		public Vector3 Position => m_LerpedPosition;
