...
namespace HQFPSTemplate.Equipment
{
	...
	public class MeleeWeaponInfo : EquipmentItemInfo
	{
		...
		public class SwingData
		{
			...
			[Space(3f)]
			[Tooltip("Network-synced swing sound")]
			public NetworkSoundData networkSwingSound;

			[Tooltip("Network-synced hit sound")]
			public NetworkSoundData networkHitSound;
		...
		[Group("5: ", true)]
		public MeleeSettingsInfo MeleeSettings;
	}
}
