...
namespace HQFPSTemplate.Equipment
{
	...
	public class ProjectileWeaponInfo : EquipmentItemInfo
	{
		...
		public class ShootingInfo
		{
			...
			public AnimationCurve FireRateOverTime = new AnimationCurve(new Keyframe(0f, 1f), new Keyframe(1f, 1f));
			...
			public NetworkSoundData networkShootSound;

			public NetworkSoundData networkShootTailAudio;

			public NetworkSoundData networkReloadStartSound;

			public NetworkSoundData networkReloadEndSound;

			public NetworkSoundData networkReloadSound;
		...
		public class ReloadingInfo
		{
			...
			[SerializeField]
			[EnableIf("HasEmptyReload", true, 0f)]
		...
		[Space]
		[Group("5: ", true)]
		public ShootingInfo Shooting;

		[Group("6: ", true)]
		public ReloadingInfo Reloading;
	}
}
