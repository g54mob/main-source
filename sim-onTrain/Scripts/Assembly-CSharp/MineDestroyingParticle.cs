...
public class MineDestroyingParticle : MonoBehaviour
{
	[SerializeField]
	...
	private void Start()
	{
		...
		{
			obj.transform.eulerAngles = new Vector3(Random.Range(0f, 360f), Random.Range(0f, 360f), Random.Range(0f, 360f));
			obj.transform.localScale = Vector3.one * Random.Range(0.5f, 0.7f);
		...
		DOVirtual.DelayedCall(0.5f, FadeOutMaterials).SetTarget(this);
	}
	...
	private void FadeOutMaterials()
	{
		...
		foreach (Renderer renderer in array)
		{
			...
			{
				currentColor.a = x;
			}, 0f, 0.25f).SetEase(Ease.InSine).SetTarget(this)
				.OnUpdate(delegate
				{
