...
namespace StylizedWater2
{
	...
	public class WaterObject : MonoBehaviour
	{
		...
		{
			WaterObject component = new GameObject("Water Object", typeof(MeshFilter), typeof(MeshRenderer), typeof(WaterObject)).GetComponent<WaterObject>();
		...
		public static WaterObject Find(Vector3 position, bool rotationSupport)
		{
			...
			foreach (WaterObject instance in Instances)
			{
				if (rotationSupport)
				{
					ray.origin = instance.transform.InverseTransformPoint(position + Vector3.up * 1000f);
