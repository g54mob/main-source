...
namespace GPUInstancerPro
{
	public class GPUIRuntimeSettings : ScriptableObject
	{
		...
		{
			if (!(overwriteSettings == null) && !(_instance == overwriteSettings))
			{
		...
		public void DetermineOperationMode()
		{
			...
			GraphicsDeviceType graphicsDeviceType = GraphicsDeviceType;
			DisableShaderBuffers = graphicsDeviceType != GraphicsDeviceType.Direct3D11 && graphicsDeviceType != GraphicsDeviceType.PlayStation4 && graphicsDeviceType != GraphicsDeviceType.XboxOne && graphicsDeviceType != GraphicsDeviceType.Metal && graphicsDeviceType != GraphicsDeviceType.OpenGLCore && graphicsDeviceType != GraphicsDeviceType.Direct3D12 && graphicsDeviceType != GraphicsDeviceType.XboxOneD3D12 && graphicsDeviceType != GraphicsDeviceType.GameCoreXboxOne && graphicsDeviceType != GraphicsDeviceType.GameCoreXboxSeries && graphicsDeviceType != GraphicsDeviceType.PlayStation5 && graphicsDeviceType != GraphicsDeviceType.PlayStation5NGGC;
		...
		public void SetDefaultValues()
		{
			...
			if (platform == RuntimePlatform.Android || platform == RuntimePlatform.IPhonePlayer || platform == RuntimePlatform.Switch)
			{
		...
		public bool TryGetURPAsset(out UniversalRenderPipelineAsset urpAsset)
		{
