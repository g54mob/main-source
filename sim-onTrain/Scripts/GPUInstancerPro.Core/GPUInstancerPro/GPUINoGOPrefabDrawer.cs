...
namespace GPUInstancerPro
{
	...
	public class GPUINoGOPrefabDrawer : MonoBehaviour
	{
		...
		private void RegisterRenderers()
		{
			...
			if (instanceCount > 0)
			{
				GPUICoreAPI.RegisterRenderer(this, prefabObject, profile, out _rendererKey);
				...
				if (enableColorVariations)
				{
					...
					GPUICoreAPI.AddMaterialPropertyOverride(_rendererKey, "gpuiProFloat4Variation", GenerateColorBuffer());
				}
				else
				{
