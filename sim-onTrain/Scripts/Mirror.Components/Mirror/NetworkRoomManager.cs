...
namespace Mirror
{
	...
	public class NetworkRoomManager : NetworkManager
	{
		...
		public void CheckReadyToBegin()
		{
			if (Utils.IsSceneActive(RoomScene))
			{
				int num = NetworkServer.connections.Count((KeyValuePair<int, NetworkConnectionToClient> conn) => conn.Value != null && conn.Value.identity != null && conn.Value.identity.TryGetComponent<NetworkRoomPlayer>(out var component) && component.readyToBegin);
