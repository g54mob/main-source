...
namespace Dissonance.Config
{
	public sealed class VoiceSettings : ScriptableObject, INotifyPropertyChanged
	{
		...
		[NotNull]
		public static VoiceSettings Instance => _instance ?? (_instance = Load());
		...
		{
			return $"Quality: {Quality}, FrameSize: {FrameSize}, FEC: {ForwardErrorCorrection}, DenoiseAmount: {DenoiseAmount}, VoiceDuckLevel: {VoiceDuckLevel}";
		}
	}
}
