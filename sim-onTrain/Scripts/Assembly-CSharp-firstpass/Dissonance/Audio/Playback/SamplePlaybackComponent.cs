...
namespace Dissonance.Audio.Playback
{
	public class SamplePlaybackComponent : MonoBehaviour
	{
		...
		public float CorrectedPlaybackSpeed => _desync.CorrectedPlaybackSpeed;
		...
		public void OnAudioFilterRead(float[] data, int channels)
		{
			...
			try
			{
				...
				if (!flag)
				{
					flag = Filter(value, data, channels, _temp, _diagnosticOutput, out var arv, out var samplesRead, MultiplyBySource);
					_arv = arv;
