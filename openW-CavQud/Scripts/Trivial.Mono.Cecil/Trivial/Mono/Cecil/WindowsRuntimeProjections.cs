...
namespace Trivial.Mono.Cecil
{
	internal sealed class WindowsRuntimeProjections
	{
		...
		public void AddVirtualReferences(Collection<AssemblyNameReference> references)
		{
			...
			AssemblyNameReference[] array2 = array;
			foreach (AssemblyNameReference item in array2)
			{
				references.Add(item);
			}
		}
		...
		public void RemoveVirtualReferences(Collection<AssemblyNameReference> references)
		{
			...
			AssemblyNameReference[] array = virtualReferences;
		...
		private static AssemblyNameReference[] GetAssemblyReferences(AssemblyNameReference corlib)
		{
			...
			{
				byte[] array = (assemblyNameReference5.PublicKey = corlib.PublicKey);
				byte[] array2 = (assemblyNameReference4.PublicKey = array);
				byte[] array4 = array2;
				AssemblyNameReference assemblyNameReference7 = assemblyNameReference;
				AssemblyNameReference assemblyNameReference8 = assemblyNameReference2;
				AssemblyNameReference assemblyNameReference9 = assemblyNameReference3;
				array2 = (assemblyNameReference6.PublicKey = contract_pk);
				byte[] array6 = array2;
				array2 = (assemblyNameReference9.PublicKey = array6);
				byte[] array8 = array2;
				array = (assemblyNameReference8.PublicKey = array8);
				array2 = (assemblyNameReference7.PublicKey = array);
				array4 = array2;
			}
			else
			{
				byte[] array = (assemblyNameReference5.PublicKeyToken = corlib.PublicKeyToken);
				byte[] array2 = (assemblyNameReference4.PublicKeyToken = array);
				byte[] array12 = array2;
				AssemblyNameReference assemblyNameReference10 = assemblyNameReference;
				AssemblyNameReference assemblyNameReference11 = assemblyNameReference2;
				AssemblyNameReference assemblyNameReference12 = assemblyNameReference3;
				array2 = (assemblyNameReference6.PublicKeyToken = contract_pk_token);
				byte[] array14 = array2;
				array2 = (assemblyNameReference12.PublicKeyToken = array14);
				byte[] array16 = array2;
				array = (assemblyNameReference11.PublicKeyToken = array16);
				array2 = (assemblyNameReference10.PublicKeyToken = array);
				array12 = array2;
			}
		...
		private AssemblyNameReference GetAssemblyReference(string name)
		{
			AssemblyNameReference[] virtualReferences = VirtualReferences;
			AssemblyNameReference[] array = virtualReferences;
			foreach (AssemblyNameReference assemblyNameReference in array)
			{
