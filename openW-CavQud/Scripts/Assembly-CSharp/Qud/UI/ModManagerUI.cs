...
namespace Qud.UI
{
	...
	public class ModManagerUI : SingletonWindowBase<ModManagerUI>
	{
		...
		{
			QudMenuBottomContext componentInChildren = GetComponentInChildren<QudMenuBottomContext>(includeInactive: true);
			QudMenuItem value = componentInChildren.items[0];
			value.text = "Back";
			componentInChildren.items[0] = value;
