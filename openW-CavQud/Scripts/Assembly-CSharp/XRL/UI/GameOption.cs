...
namespace XRL.UI
{
	public class GameOption
	{
		...
		public string SwitchDisplayText;
		...
		public bool RequiresCapabilityMet()
		{
			if (string.IsNullOrEmpty(RequiresCapability))
			{
				return true;
			}
			return CapabilityManager.HasCapability(RequiresCapability);
		}
	}
}
