...
namespace Galaxy.Api
{
	public class IUser : IDisposable
	{
		...
		{
			GalaxyInstancePINVOKE.IUser_SignInXbox__SWIG_0(swigCPtr, xboxID, IAuthListener.getCPtr(listener));
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			GalaxyInstancePINVOKE.IUser_SignInXbox__SWIG_1(swigCPtr, xboxID);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			GalaxyInstancePINVOKE.IUser_SignInAuthorizationCode__SWIG_0(swigCPtr, authorizationCode, redirectURI, IAuthListener.getCPtr(listener));
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			GalaxyInstancePINVOKE.IUser_SignInAuthorizationCode__SWIG_1(swigCPtr, authorizationCode, redirectURI);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			string result = GalaxyInstancePINVOKE.IUser_GetRefreshToken(swigCPtr);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		public virtual void GetRefreshTokenCopy(out string buffer, uint bufferLength)
		{
			...
			try
			{
				GalaxyInstancePINVOKE.IUser_GetRefreshTokenCopy(swigCPtr, array, bufferLength);
				if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
				{
					throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
				}
		...
		{
			string result = GalaxyInstancePINVOKE.IUser_GetIDToken(swigCPtr);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		public virtual void GetIDTokenCopy(out string buffer, uint bufferLength)
		{
			...
			try
			{
				GalaxyInstancePINVOKE.IUser_GetIDTokenCopy(swigCPtr, array, bufferLength);
				if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
				{
					throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
				}
