...
namespace Galaxy.Api
{
	public class IApps : IDisposable
	{
		...
		{
			string result = GalaxyInstancePINVOKE.IApps_GetCurrentGameLanguageCode__SWIG_0(swigCPtr, productID);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			string result = GalaxyInstancePINVOKE.IApps_GetCurrentGameLanguageCode__SWIG_1(swigCPtr);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		public virtual void GetCurrentGameLanguageCodeCopy(out string buffer, uint bufferLength, ulong productID)
		{
			...
			try
			{
				GalaxyInstancePINVOKE.IApps_GetCurrentGameLanguageCodeCopy__SWIG_0(swigCPtr, array, bufferLength, productID);
				if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
				{
					throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
				}
		...
		public virtual void GetCurrentGameLanguageCodeCopy(out string buffer, uint bufferLength)
		{
			...
			try
			{
				GalaxyInstancePINVOKE.IApps_GetCurrentGameLanguageCodeCopy__SWIG_1(swigCPtr, array, bufferLength);
				if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
				{
					throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
				}
