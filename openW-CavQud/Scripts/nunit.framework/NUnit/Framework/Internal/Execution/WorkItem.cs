	...
	public abstract class WorkItem
	{
		...
		public virtual void Execute()
		{
			...
			else
			{
				...
				ApartmentState apartment = (((ownThreadReason | OwnThreadReason.DifferentApartment) != OwnThreadReason.NotNeeded) ? TargetApartment : CurrentApartment);
		...
		private void RunThread(int timeout)
		{
			...
			if (Context.ExecutionStatus != TestExecutionStatus.AbortRequested)
			{
				...
				Result.SetResult(ResultState.Failure, $"Test exceeded Timeout value of {timeout}ms");
				WorkItemComplete();
			}
		}
