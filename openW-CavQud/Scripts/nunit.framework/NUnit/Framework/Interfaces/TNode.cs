...
namespace NUnit.Framework.Interfaces
{
	public class TNode
	{
		...
		public TNode(string name, string value)
			: this(name, value, valueIsCDATA: false)
		{
		}
		...
		{
			TNode tNode = new TNode(name, EscapeInvalidXmlCharacters(value), valueIsCDATA: true);
			ChildNodes.Add(tNode);
			return tNode;
		}
		...
		{
			return ApplySelection(new NodeList { this }, xpath);
		}
