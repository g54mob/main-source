...
namespace NUnit.Framework
{
	public class TestContext
	{
		...
		public static TestContext CurrentContext => new TestContext(CurrentTestExecutionContext ?? TestExecutionContext.CurrentContext);

		public static TextWriter Out => (CurrentTestExecutionContext ?? TestExecutionContext.CurrentContext).OutWriter;
		...
		public string WorkerId => _testExecutionContext.WorkerId;
		...
		{
			AddFormatter((ValueFormatter next) => (object val) => (!(val is TSUPPORTED)) ? next(val) : formatter(val));
		}
	}
}
