	...
	public class EqualConstraint : Constraint
	{
		...
		private void AdjustArgumentIfNeeded<T>(ref T arg)
		{
			if (arg != null)
			{
				...
				if ((NUnit.Compatibility.TypeExtensions.GetTypeInfo(type).IsGenericType ? type.GetGenericTypeDefinition() : null) == typeof(ArraySegment<>) && type.GetProperty("Array").GetValue(arg, null) == null)
				{
					Array array = Array.CreateInstance(type.GetGenericArguments()[0], 0);
