...
namespace NUnit.Framework
{
	...
	public class ValueSourceAttribute : DataAttribute, IParameterDataSource
	{
		...
		private IEnumerable GetDataSource(IParameterInfo parameter)
		{
			...
			IEnumerable dataSourceValue = GetDataSourceValue(type.GetMember(SourceName, BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.FlattenHierarchy));
