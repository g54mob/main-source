...
namespace Rewired.Components
{
	...
	public class PlayerController : ComponentWrapper<Rewired.PlayerController>, IPlayerController
	{
		...
		internal virtual List<ElementInfo> XqRdFJOlAzulsrMeBTzrZtLMVvM()
		{
			return null;
		}

		private void XxQpYZXGCoGJNRPixnVPzQXCKoC(int P_0, bool P_1)
		{
		}

		private void eUkigvhovXTpDjxNlghkvfBNLFy(int P_0, float P_1)
		{
		}

		private void HtqLzAJwytqguUJnlAOYiFvBRUpm(bool P_0)
		{
		}

		private void nhWbbkaVDgJNXBYcFIxvtKofGllG()
		{
		}
	}
}
