...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class fGCPqiAApvftVcOKHOiOaFjgUqBW : IControllerExtensionSource
		{
			public readonly ISteamControllerInternal iRbNqIMVdjRRIkAJsCFKpOLsqKZ;

			public fGCPqiAApvftVcOKHOiOaFjgUqBW(ISteamControllerInternal internalController)
			{
			}
		}

		private fGCPqiAApvftVcOKHOiOaFjgUqBW nyCueoCEaeJTFXVlFaQxFQWnGtp;
		...
		private void nKQbCtkHPOPnqlOqEQhEesshditg()
		{
		}
	}
}
