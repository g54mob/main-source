...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class fgBFWWbMfeSetcyvaxzCDXLjIcLM : IControllerExtensionSource
		{
			public readonly IDriver_DualSense SdrkurrNmqegCIcGzxlmzPxvtEE;

			public readonly bool XqGTZIoFqJEzYtPZLAGeNDbdpVG;

			public readonly int MfEzZmPsgQpPXFCudtWcxqDKNDx;

			public fgBFWWbMfeSetcyvaxzCDXLjIcLM(IDriver_DualSense driver, bool supportsVibration, int vibrationMotorCount)
			{
			}
		}

		private fgBFWWbMfeSetcyvaxzCDXLjIcLM imwgydyWOVgGruTMVBaQZGRbcjmk;
		...
		private Vector3 ZEwpfsLEcvGAZNFRVApGeysgotj()
		{
			return default(Vector3);
		}
		...
		{
			//ILSpy generated this explicit interface implementation from .override directive in ZEwpfsLEcvGAZNFRVApGeysgotj
			return this.ZEwpfsLEcvGAZNFRVApGeysgotj();
		}

		private Vector3 zsbmVoLOnJYPHLkkLVNTZRYUZBW()
		{
			return default(Vector3);
		}
		...
		{
			//ILSpy generated this explicit interface implementation from .override directive in zsbmVoLOnJYPHLkkLVNTZRYUZBW
			return this.zsbmVoLOnJYPHLkkLVNTZRYUZBW();
		}
		...
		private void wsHELmCkpDEMIppXIlYndwCDtBJk(DualShock4MotorType P_0, float P_1, float P_2)
		{
		}
	}
}
