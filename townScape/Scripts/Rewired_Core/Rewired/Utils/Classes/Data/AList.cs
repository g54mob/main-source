...
namespace Rewired.Utils.Classes.Data
{
	...
	{
		[Serializable]
		public struct BivoTWfCMxKZRSYLakkxDjltQds : IDisposable, IEnumerator, IEnumerator<T>
		{
			...
			internal BivoTWfCMxKZRSYLakkxDjltQds(AList<T> list)
			{
				this.list = null;
				index = 0;
				version = 0;
		...
		private const int liXAbjQNeDFRsfFVkegdotixhYg = 4;

		private static readonly T[] jrFDRInHGAvcoouLoOeQlTHyMaR;

		private IEqualityComparer<T> srVBuqRwhAWCiyoXssvcAnhhCXj;

		public T[] _items;

		private int ckVfvSAHJIaaTnVdYdQGXoorBaQ;

		public int _count;

		private int ckzyNeFvJsTwsEVQfqdysLEJmSH;

		private bool jUUcCsAdjvRGbIgQXhBOFmXLTrho;

		private readonly int nmjeBztUJDeHTarLbIlPSaMoTFsT;

		private readonly bool XQlRVJHTEkfwwulvPtQOWLoiaZK;

		private int XwiTwqbvUPtdoJnIffXQkTzurQu;

		[NonSerialized]
		private object KQDahQjbgGERdNKHcYQsYKQcGhd;
		...
		private int vGAIOThrPZrFUExXSJvYiybKmSQ(int P_0, bool P_1 = false)
		{
			return 0;
		}

		private int tWFEdTfcXbgtGhIYxGFbRygEJLYM(int P_0, int P_1)
		{
			return 0;
		}

		private bool rzUYkGDOrinBXqCQzWLdtTIJkfX(int P_0, bool P_1 = false)
		{
			return false;
		}
		...
		private static bool NptHXHqNKOmqmzgXSSwQaepNZws(object P_0)
		{
			return false;
		}
	}
