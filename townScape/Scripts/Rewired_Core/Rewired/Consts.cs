...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static ReadOnlyCollection<ControllerElementIdentifier> VKaCiBAeZCZXlLfjhIezHbwSvZhf;

		private static ReadOnlyCollection<ControllerElementIdentifier> OqhcpXCzrODPdInrkUksLFyAdFq;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] GKqZFxUxwubxxGdalvOYJmLgttx;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] vzPyABPnwHWRIktEnZlEbEnOagO;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] sEtQbzivKVGbYWfCboZaTeohrzA;
		...
		private static readonly string[] TRNzPagzBDHiRAgfkBWJNXJNqTx;

		internal static readonly IList<PidVid> pidVids_sony_dualShock4;

		private static readonly PidVid[] DGVzlgNofwiHjrfEqCChRfxsawZ;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] UFBPFDbVGWRHVTGuCGAUcLYXQFaw;

		private static readonly ControllerElementIdentifier[] vySmufqPNdEKxaRBrNDKWMDeevy;
		...
		private static ControllerElementIdentifier[] kMSzZeAKzDfSFqUTVBPXKcIAUkV()
		{
			return null;
		}
	}
