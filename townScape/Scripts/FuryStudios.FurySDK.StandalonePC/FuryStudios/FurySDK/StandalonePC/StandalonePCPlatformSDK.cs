...
{
	public class StandalonePCPlatformSDK : BasePlatformSDK
	{
		protected AsyncRequestScheduler systemRequestScheduler;

		protected AsyncRequestScheduler storageRequestScheduler;

		protected AsyncRequestScheduler statsRequestScheduler;
		...
		public override void Init(PlatformSettings settings)
		{
		}
		...
		public override IAsyncRequest OpenURL(string url)
		{
			return null;
		}
	}
