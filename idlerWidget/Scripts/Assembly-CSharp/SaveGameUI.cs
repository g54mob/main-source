...
public class SaveGameUI : MonoBehaviour
{
	...
	public virtual void DoExecuteAction()
	{
		...
		{
			UIAlertWindow.Show("Error saving game", "Your game progress could not be saved due to an error. Most likely, the game does not have sufficient permissions to write to its default output path.");
