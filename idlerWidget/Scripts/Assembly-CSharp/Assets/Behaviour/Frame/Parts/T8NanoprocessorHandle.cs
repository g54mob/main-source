...
namespace Assets.Behaviour.Frame.Parts
{
	public class T8NanoprocessorHandle : MonoBehaviour
	{
		...
		private void OnMouseUp()
		{
			if (_puzzleActive)
			{
				_parent.ShowWarning(new WorldAnchor(WorldAnchorType.HandCraft, 0), "Interrupted!");
				_resetPuzzle();
			}
		}
		...
		private void OnMouseExit()
		{
			if (_puzzleActive)
			{
				_parent.ShowWarning(new WorldAnchor(WorldAnchorType.HandCraft, 0), "Tracking disrupted!");
				_resetPuzzle();
			}
		}
