	...
	public sealed class fsData
	{
		...
		public fsDataType Type
		{
			get
			{
				...
				throw new InvalidOperationException("unknown JSON data type: " + _value.GetType().Name);
			}
		}
		...
		public bool IsNaN
		{
			get
			{
				if (_value is string a)
				{
					return string.Equals(a, "NaN", StringComparison.Ordinal);
				}
				return false;
			}
		}
