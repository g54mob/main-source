...
namespace PixelCrushers.DialogueSystem
{
	...
	public class DialogueSystemTrigger : MonoBehaviour
	{
		...
		public GameObject overrideDialogueUI;
		...
		protected void PopulateCache(Transform speaker, Transform listener)
		{
			...
			ConversationModel conversationModel = new ConversationModel(DialogueManager.masterDatabase, barkConversation, speaker, listener, DialogueManager.allowLuaExceptions, DialogueManager.isDialogueEntryValid, barkEntryID, stopAtFirstValid: false, DialogueManager.useLinearGroupMode);
		...
		protected void BarkNextCachedLine(Transform speaker, Transform listener)
		{
			...
			int nextIndex = BarkHistory.GetNextIndex(array.Length);
		...
		protected virtual void DoConversationAction(Transform actor)
		{
			...
			IDialogueUI dialogueUI = ((overrideDialogueUI != null) ? overrideDialogueUI.GetComponent<IDialogueUI>() : null);
			DialogueManager.StartConversation(this.conversation, actor2, transform, initialDialogueEntryID, dialogueUI);
