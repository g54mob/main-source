...
namespace PixelCrushers.DialogueSystem.Articy.Articy_2_2
{
	...
	public class ReferenceStripPropertyDefinitionType
	{
		...
		public int MaxReferenceCount
		{
			get
			{
				return maxReferenceCountField;
			}
			set
			{
				maxReferenceCountField = value;
			}
		}
		...
		public bool MaxReferenceCountSpecified
		{
			get
			{
				return maxReferenceCountFieldSpecified;
			}
			set
			{
				maxReferenceCountFieldSpecified = value;
			}
		}
		...
		public ObjectTypes ObjectTypes
		{
			get
			{
				return objectTypesField;
			}
			set
			{
				objectTypesField = value;
			}
		}
