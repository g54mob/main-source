...
internal static class moNrVnhMyxFSevnVWYTclYHmdtVI
{
	public static ControllerElementType cTKZnruLFvxhZtYhgEqaKiQIZvgl(ElementAssignmentType P_0)
	{
		switch (P_0)
		{
	...
	public static ElementAssignmentType tULUduDXuBGHqhobFvTnTYhMQpbQ(ControllerType P_0, ControllerElementType P_1, AxisRange P_2)
	{
	...
	public static AxisRange yzrzRfKtwedtXZULWITzZhtvvfls(Pole P_0)
	{
		return P_0 switch
		{
	...
	public static Type UcymfpEUEGwogwpzEombQtOGDEmq<_0001>() where _0001 : Controller
	{
		return FwbeTFcKsfgKLeerztEOTqDkKRiG(typeof(_0001));
	}

	public static Type FwbeTFcKsfgKLeerztEOTqDkKRiG(Type P_0)
	{
	...
	public static Type RWvbPUCZbuEZcuPKXUsKqNfzWPHKA(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static Type EiEfQoSaOGPuNbdyxvJKdzcLBTMf(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerType NiWZsfpPqypjVjipJZcZdwmeDEYA(Type P_0)
	{
		if (P_0 == null)
		{
	...
	public static ControllerType kdWDDQlNysyeMSiTdEzmUlUWJJKf<_0001>()
	{
		return NiWZsfpPqypjVjipJZcZdwmeDEYA(typeof(_0001));
	}

	public static ControllerType JMKMQOKSFRTlVHBuornUZcZaHxBA(Type P_0)
	{
		if (!bUqLXEjZfxhLbArqAPXGQdXwpeTf(P_0, out var result))
		{
			throw new Exception(P_0.Name + " is not an allowed type.");
		}
		return result;
	...
	public static ControllerType BPfcqinxhiNWUdPZTeGqROmfJAAR<_0001>() where _0001 : ControllerMap
	{
		return JMKMQOKSFRTlVHBuornUZcZaHxBA(typeof(_0001));
	}

	public static bool bUqLXEjZfxhLbArqAPXGQdXwpeTf(Type P_0, out ControllerType P_1)
	{
		if (P_0 == null)
		{
	...
	public static bool UZAFWWKgIIIkiKjsWvxCGmCOwHhdA<_0001>(out ControllerType P_0) where _0001 : ControllerMap
	{
		return bUqLXEjZfxhLbArqAPXGQdXwpeTf(typeof(_0001), out P_0);
	}

	public static ControllerType KBTcDNPVbcMpYKLaQEznySOwaFwx(Type P_0)
	{
		if (P_0 == null)
		{
	...
	public static ControllerType dHlGoYwWtiJBUBHSUgoJGERjUnTt<_0001>() where _0001 : ControllerMapSaveData
	{
		return KBTcDNPVbcMpYKLaQEznySOwaFwx(typeof(_0001));
	}

	public static bool EmtfqMepZwcXCFhNCitgwJkNmldC(ControllerTemplateElementType P_0, ControllerElementType P_1)
	{
		return P_1 switch
		{
	...
	public static ControllerElementType fJMwuWRXTRFXmEhDaUYJNMxiWjGe(object P_0)
	{
		if (P_0 == null)
		{
		...
		{
			return dCqlSqVXwvunrbuwgbTXXLOvGmWfA((ControllerTemplateElementType)P_0);
		}
		throw new NotImplementedException();
	}

	public static ControllerElementType dCqlSqVXwvunrbuwgbTXXLOvGmWfA(ControllerTemplateElementType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerTemplateElementSourceType tWndHcbmixjydCbXifaFPduGQNfTb(ControllerTemplateElementType P_0, bool P_1)
	{
		switch (P_0)
		{
	...
	public static ControllerTemplateElementType MVoneWLkkmeMXQTwvZgHYVaXfzqk(ControllerElementType P_0, bool P_1)
	{
		switch (P_0)
		{
		case ControllerElementType.Axis:
