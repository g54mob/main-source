...
namespace Rewired.Data
{
	...
	public sealed class CustomController_Editor
	{
		...
		private sealed class xlILRBuVdzgSBcQpJfDermiqmyYu : IEnumerable<ControllerElementIdentifier>, IEnumerable, IEnumerator<ControllerElementIdentifier>, IEnumerator, IDisposable
		{
			private int mXzYRahNiyzJcIyZaqSKObhzyatb;

			private ControllerElementIdentifier vxxpShTZesQslMUPjXMVQgtodXwn;

			private int rbyTNNNcfGQztwgyznmwRWSQOdKS;

			public CustomController_Editor fUhYCoTEHQCnNjBsEZmkHMuPCpAg;

			private int GrauaKuhWTqYRYlmmACahtuNlygN;
			...
			ControllerElementIdentifier IEnumerator<ControllerElementIdentifier>.Current
			{
				...
				get
				{
					return vxxpShTZesQslMUPjXMVQgtodXwn;
				}
			}
			...
			[DebuggerHidden]
			public xlILRBuVdzgSBcQpJfDermiqmyYu(int P_0)
			{
				mXzYRahNiyzJcIyZaqSKObhzyatb = P_0;
				rbyTNNNcfGQztwgyznmwRWSQOdKS = Environment.CurrentManagedThreadId;
			}
			...
			{
				int num = mXzYRahNiyzJcIyZaqSKObhzyatb;
				CustomController_Editor customController_Editor = fUhYCoTEHQCnNjBsEZmkHMuPCpAg;
				switch (num)
				{
				default:
					return false;
				case 0:
					mXzYRahNiyzJcIyZaqSKObhzyatb = -1;
					if (customController_Editor._elementIdentifiers == null)
					{
						return false;
					}
					GrauaKuhWTqYRYlmmACahtuNlygN = 0;
					break;
				case 1:
					mXzYRahNiyzJcIyZaqSKObhzyatb = -1;
					GrauaKuhWTqYRYlmmACahtuNlygN++;
					break;
				}
				if (GrauaKuhWTqYRYlmmACahtuNlygN < customController_Editor._elementIdentifiers.Count)
				{
					vxxpShTZesQslMUPjXMVQgtodXwn = customController_Editor._elementIdentifiers[GrauaKuhWTqYRYlmmACahtuNlygN];
					mXzYRahNiyzJcIyZaqSKObhzyatb = 1;
					return true;
				}
				return false;
			...
			{
				xlILRBuVdzgSBcQpJfDermiqmyYu xlILRBuVdzgSBcQpJfDermiqmyYu2;
				if (mXzYRahNiyzJcIyZaqSKObhzyatb == -2 && rbyTNNNcfGQztwgyznmwRWSQOdKS == Environment.CurrentManagedThreadId)
				{
					mXzYRahNiyzJcIyZaqSKObhzyatb = 0;
					xlILRBuVdzgSBcQpJfDermiqmyYu2 = this;
				}
				else
				{
					xlILRBuVdzgSBcQpJfDermiqmyYu2 = new xlILRBuVdzgSBcQpJfDermiqmyYu(0);
					xlILRBuVdzgSBcQpJfDermiqmyYu2.fUhYCoTEHQCnNjBsEZmkHMuPCpAg = fUhYCoTEHQCnNjBsEZmkHMuPCpAg;
				}
				return xlILRBuVdzgSBcQpJfDermiqmyYu2;
			}
		...
		{
			[IteratorStateMachine(typeof(xlILRBuVdzgSBcQpJfDermiqmyYu))]
			get
			{
				return new xlILRBuVdzgSBcQpJfDermiqmyYu(-2)
				{
					fUhYCoTEHQCnNjBsEZmkHMuPCpAg = this
				};
			}
		}
		...
		public void AddAxis()
		{
			axes.Add((Axis)mosfgacALDmKUAyiCDBPzcXQasILB(ControllerElementType.Axis));
		}

		public void AddButton()
		{
			buttons.Add((Button)mosfgacALDmKUAyiCDBPzcXQasILB(ControllerElementType.Button));
		}
		...
		public void InsertAxis(int index)
		{
			...
			axes.Insert(index, (Axis)mosfgacALDmKUAyiCDBPzcXQasILB(ControllerElementType.Axis));
		}
		...
		public void InsertButton(int index)
		{
			...
			buttons.Insert(index, (Button)mosfgacALDmKUAyiCDBPzcXQasILB(ControllerElementType.Button));
		}
		...
		public void DuplicateElement(ControllerElementType type, int index)
		{
			...
			{
			case ControllerElementType.Axis:
				hvVAupHXvyMXzqEjINMNHTzwUzcmA(index, axes);
				break;
			case ControllerElementType.Button:
				hvVAupHXvyMXzqEjINMNHTzwUzcmA(index, buttons);
				break;
			default:
				throw new NotImplementedException();
			}
		...
		private void hvVAupHXvyMXzqEjINMNHTzwUzcmA<_0001>(int P_0, List<_0001> P_1) where _0001 : Element
		{
			...
			ControllerElementIdentifier controllerElementIdentifier = bPTCDRDeihxndohlXVvWRSJQhIjbA(val.elementIdentifierId, text);
		...
		private ControllerElementIdentifier bPTCDRDeihxndohlXVvWRSJQhIjbA(int P_0, string P_1)
		{
		...
		private Element mosfgacALDmKUAyiCDBPzcXQasILB(ControllerElementType P_0)
		{
			switch (P_0)
			{
			case ControllerElementType.Axis:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier2 = uoHfbfjRtDzTxpYkYcdlfTNggosy(P_0, text2, string.Empty, string.Empty, key, string.Empty, string.Empty);
			...
			case ControllerElementType.Button:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier = uoHfbfjRtDzTxpYkYcdlfTNggosy(P_0, text, string.Empty, string.Empty, key, string.Empty, string.Empty);
		...
		private ControllerElementIdentifier uoHfbfjRtDzTxpYkYcdlfTNggosy(ControllerElementType P_0, string P_1, string P_2, string P_3, string P_4, string P_5, string P_6)
		{
			int elementIdentifierIdCounter = _elementIdentifierIdCounter;
			_elementIdentifierIdCounter++;
			ControllerElementIdentifier controllerElementIdentifier = new ControllerElementIdentifier(new ControllerElementIdentifier.bSeqdIyVjkTFqqpLamBpjhuEDWyN
