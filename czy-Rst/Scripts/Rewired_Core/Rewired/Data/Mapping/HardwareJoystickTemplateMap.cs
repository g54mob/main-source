...
namespace Rewired.Data.Mapping
{
	public sealed class HardwareJoystickTemplateMap : HardwareControllerTemplateMap, IHardwareControllerTemplateMap, IHardwareControllerTemplateMap_Internal, IHardwareControllerMap, IHardwareControllerMap_Internal
	{
		...
		private sealed class qzOhgkJEcNRSTRPbcdGLVeaFIqdr : IEnumerable<IControllerElementIdentifierCommon_Internal>, IEnumerable, IEnumerator<IControllerElementIdentifierCommon_Internal>, IEnumerator, IDisposable
		{
			private int fNpATtWuRkeYGbayyXnuZcuIytdB;

			private IControllerElementIdentifierCommon_Internal TvxtDxXdjEupNGjEqBPEKhChctRGA;

			private int tTfRSpbuwbfIjFbxFbEtuLWmRVeE;

			public HardwareJoystickTemplateMap VJExLWeyhDHnOrRAPyoBxDtCZGvB;

			private int YeCJfrCewUvfslxrTqVLBNEyKJbc;
			...
			IControllerElementIdentifierCommon_Internal IEnumerator<IControllerElementIdentifierCommon_Internal>.Current
			{
				...
				get
				{
					return TvxtDxXdjEupNGjEqBPEKhChctRGA;
				}
			}
			...
			[DebuggerHidden]
			public qzOhgkJEcNRSTRPbcdGLVeaFIqdr(int P_0)
			{
				fNpATtWuRkeYGbayyXnuZcuIytdB = P_0;
				tTfRSpbuwbfIjFbxFbEtuLWmRVeE = Environment.CurrentManagedThreadId;
			}
			...
			{
				int num = fNpATtWuRkeYGbayyXnuZcuIytdB;
				HardwareJoystickTemplateMap vJExLWeyhDHnOrRAPyoBxDtCZGvB = VJExLWeyhDHnOrRAPyoBxDtCZGvB;
				switch (num)
				{
				default:
					return false;
				case 0:
					fNpATtWuRkeYGbayyXnuZcuIytdB = -1;
					if (vJExLWeyhDHnOrRAPyoBxDtCZGvB.elementIdentifiers == null)
					{
						return false;
					}
					YeCJfrCewUvfslxrTqVLBNEyKJbc = 0;
					break;
				case 1:
					fNpATtWuRkeYGbayyXnuZcuIytdB = -1;
					YeCJfrCewUvfslxrTqVLBNEyKJbc++;
					break;
				}
				if (YeCJfrCewUvfslxrTqVLBNEyKJbc < vJExLWeyhDHnOrRAPyoBxDtCZGvB.elementIdentifiers.Length)
				{
					TvxtDxXdjEupNGjEqBPEKhChctRGA = vJExLWeyhDHnOrRAPyoBxDtCZGvB.elementIdentifiers[YeCJfrCewUvfslxrTqVLBNEyKJbc];
					fNpATtWuRkeYGbayyXnuZcuIytdB = 1;
					return true;
				}
				return false;
			...
			{
				qzOhgkJEcNRSTRPbcdGLVeaFIqdr qzOhgkJEcNRSTRPbcdGLVeaFIqdr2;
				if (fNpATtWuRkeYGbayyXnuZcuIytdB == -2 && tTfRSpbuwbfIjFbxFbEtuLWmRVeE == Environment.CurrentManagedThreadId)
				{
					fNpATtWuRkeYGbayyXnuZcuIytdB = 0;
					qzOhgkJEcNRSTRPbcdGLVeaFIqdr2 = this;
				}
				else
				{
					qzOhgkJEcNRSTRPbcdGLVeaFIqdr2 = new qzOhgkJEcNRSTRPbcdGLVeaFIqdr(0);
					qzOhgkJEcNRSTRPbcdGLVeaFIqdr2.VJExLWeyhDHnOrRAPyoBxDtCZGvB = VJExLWeyhDHnOrRAPyoBxDtCZGvB;
				}
				return qzOhgkJEcNRSTRPbcdGLVeaFIqdr2;
			}
		...
		private sealed class EJMLYcaAPceUNBlHvzSMPrecrieR : IEnumerable<ControllerTemplateElementIdentifier>, IEnumerable, IEnumerator<ControllerTemplateElementIdentifier>, IEnumerator, IDisposable
		{
			private int XJNVhrHGjWetFFACXuTvEpGlNuMcb;

			private ControllerTemplateElementIdentifier YUhaUqdnRJoazzjUuqDsaLGtQkEQ;

			private int BugtGsAPuvjjGWGcpytSxiETVebj;

			public HardwareJoystickTemplateMap KfvawqlnNDjJNEFMgEFBLuOJKzqDb;

			private int SDJStLUPoHvJZAAFomeSjoRwKrsg;
			...
			ControllerTemplateElementIdentifier IEnumerator<ControllerTemplateElementIdentifier>.Current
			{
				...
				get
				{
					return YUhaUqdnRJoazzjUuqDsaLGtQkEQ;
				}
			}
			...
			[DebuggerHidden]
			public EJMLYcaAPceUNBlHvzSMPrecrieR(int P_0)
			{
				XJNVhrHGjWetFFACXuTvEpGlNuMcb = P_0;
				BugtGsAPuvjjGWGcpytSxiETVebj = Environment.CurrentManagedThreadId;
			}
			...
			private bool MoveNext()
			{
				int xJNVhrHGjWetFFACXuTvEpGlNuMcb = XJNVhrHGjWetFFACXuTvEpGlNuMcb;
				HardwareJoystickTemplateMap kfvawqlnNDjJNEFMgEFBLuOJKzqDb = KfvawqlnNDjJNEFMgEFBLuOJKzqDb;
				switch (xJNVhrHGjWetFFACXuTvEpGlNuMcb)
				{
				default:
					return false;
				case 0:
					XJNVhrHGjWetFFACXuTvEpGlNuMcb = -1;
					if (kfvawqlnNDjJNEFMgEFBLuOJKzqDb.elementIdentifiers == null)
					{
						return false;
					}
					SDJStLUPoHvJZAAFomeSjoRwKrsg = 0;
					break;
				case 1:
					XJNVhrHGjWetFFACXuTvEpGlNuMcb = -1;
					SDJStLUPoHvJZAAFomeSjoRwKrsg++;
					break;
				}
				if (SDJStLUPoHvJZAAFomeSjoRwKrsg < kfvawqlnNDjJNEFMgEFBLuOJKzqDb.elementIdentifiers.Length)
				{
					YUhaUqdnRJoazzjUuqDsaLGtQkEQ = kfvawqlnNDjJNEFMgEFBLuOJKzqDb.elementIdentifiers[SDJStLUPoHvJZAAFomeSjoRwKrsg];
					XJNVhrHGjWetFFACXuTvEpGlNuMcb = 1;
					return true;
				}
				return false;
			...
			{
				EJMLYcaAPceUNBlHvzSMPrecrieR eJMLYcaAPceUNBlHvzSMPrecrieR;
				if (XJNVhrHGjWetFFACXuTvEpGlNuMcb == -2 && BugtGsAPuvjjGWGcpytSxiETVebj == Environment.CurrentManagedThreadId)
				{
					XJNVhrHGjWetFFACXuTvEpGlNuMcb = 0;
					eJMLYcaAPceUNBlHvzSMPrecrieR = this;
				}
				else
				{
					eJMLYcaAPceUNBlHvzSMPrecrieR = new EJMLYcaAPceUNBlHvzSMPrecrieR(0);
					eJMLYcaAPceUNBlHvzSMPrecrieR.KfvawqlnNDjJNEFMgEFBLuOJKzqDb = KfvawqlnNDjJNEFMgEFBLuOJKzqDb;
				}
				return eJMLYcaAPceUNBlHvzSMPrecrieR;
			}
		...
		[NonSerialized]
		private Func<Guid, Entry> DIYrTyMNQLeWufCccAEKDXldJEnwb;
		...
		{
			[IteratorStateMachine(typeof(EJMLYcaAPceUNBlHvzSMPrecrieR))]
			get
			{
				return new EJMLYcaAPceUNBlHvzSMPrecrieR(-2)
				{
					KfvawqlnNDjJNEFMgEFBLuOJKzqDb = this
				};
			}
		}
		...
		{
			[IteratorStateMachine(typeof(qzOhgkJEcNRSTRPbcdGLVeaFIqdr))]
			get
			{
				return new qzOhgkJEcNRSTRPbcdGLVeaFIqdr(-2)
				{
					VJExLWeyhDHnOrRAPyoBxDtCZGvB = this
				};
			}
		}
		...
		private Func<Guid, Entry> NauGpXHNQZUgLTXtEGRMunVvLQLaA => lrfHjvvqVtdohIWAXjVpwPctoBqS;
		...
		public override ControllerTemplateElementIdentifier GetElementIdentifier(int id)
		{
			...
			return cDaseMZwurZaEyjiNmzZdtqkkkSL(array, id);
		}
		...
		{
			ControllerTemplateElementIdentifier[] array = elementIdentifiers;
			return qDaZBVqHTUkajzGrEeFrHDlrlFsZA(array, id);
		}
		...
		internal bool qUXgnBaKyMbezYjknJFiicDQsjl(ControllerMap_Editor P_0, HardwareJoystickMap P_1, Guid P_2, out string P_3)
		{
			if (P_0 == null)
			{
			...
			Entry entry = lrfHjvvqVtdohIWAXjVpwPctoBqS(P_2);
			if (entry == null)
			{
				Guid guid = P_2;
				...
				using (TempListPool.TList<ElementIdentifierMap> tList2 = TempListPool.GetTList<ElementIdentifierMap>())
				{
					...
					for (int i = 0; i < actionElementMaps.Count; i++)
					{
						...
						for (int j = 0; j < list2.Count; j++)
						{
							...
							bool flag = false;
							ControllerTemplateElementIdentifier[] array = elementIdentifiers;
							int num = ZwRxcMQKyQRFQSqigKVlxwjRlHVg(array, elementIdentifierId);
							if (num >= 0 && num < elementIdentifiers.Length)
							{
								...
								if (elementIdentifier != null && controllerTemplateElementIdentifier_Editor != null)
								{
									...
									if (!moNrVnhMyxFSevnVWYTclYHmdtVI.EmtfqMepZwcXCFhNCitgwJkNmldC(effectiveElementType, elementIdentifier.elementType))
									{
		...
		internal WRScrEekSojpdBXyEFARqvkVFcPPb SUFEzFdfSjFmkiJVcpGhAFpgGRjwA()
		{
			int num = ((joysticks != null) ? joysticks.Count : 0);
			...
			return new WRScrEekSojpdBXyEFARqvkVFcPPb(this, list, array);
		}

		private Entry lrfHjvvqVtdohIWAXjVpwPctoBqS(Guid P_0)
		{
			if (joysticks == null)
			{
				return null;
		...
		{
			return TLKwvFGTYoCSNpPghOtkqmLkNEZK(this, controller, elementIdentifierId, NauGpXHNQZUgLTXtEGRMunVvLQLaA);
		}
		...
		{
			return eaVikJJgHonsjxiMfSroXOlObaZfA(this, controller, elementIdentifierId, NauGpXHNQZUgLTXtEGRMunVvLQLaA);
		}

		internal static vgyLkSessULxWIPilRPgXWnpbfGE TLKwvFGTYoCSNpPghOtkqmLkNEZK(IHardwareControllerTemplateMap_Internal P_0, Controller P_1, int P_2, Func<Guid, Entry> P_3)
		{
			if (P_0 == null)
			{
				return null;
			...
			Entry entry = P_3(P_1.lcQyDEaPLwhlbiUKrOtQaptBTwRjc);
			if (entry == null)
			{
				return null;
			}
			...
			for (int i = 0; i < count; i++)
			{
				...
				if (elementIdentifierMap != null && elementIdentifierMap.templateId == P_2)
				{
					if (elementIdentifierMap.splitAxis)
					{
						return new vgyLkSessULxWIPilRPgXWnpbfGE(ControllerTemplateElementType.Axis, true, new QpmNXOwiqgDcvsLLtrkLzeVpLiAW(P_1, -1, AxisRange.Full), new QpmNXOwiqgDcvsLLtrkLzeVpLiAW(P_1, elementIdentifierMap.joystickId, AxisRange.Positive), new QpmNXOwiqgDcvsLLtrkLzeVpLiAW(P_1, elementIdentifierMap.joystickId2, AxisRange.Positive));
					}
					return new vgyLkSessULxWIPilRPgXWnpbfGE(ControllerTemplateElementType.Axis, false, new QpmNXOwiqgDcvsLLtrkLzeVpLiAW(P_1, elementIdentifierMap.joystickId, AxisRange.Full), new QpmNXOwiqgDcvsLLtrkLzeVpLiAW(P_1, -1, AxisRange.Positive), new QpmNXOwiqgDcvsLLtrkLzeVpLiAW(P_1, -1, AxisRange.Positive));
				}
			}
			return null;
		}

		internal static vgyLkSessULxWIPilRPgXWnpbfGE eaVikJJgHonsjxiMfSroXOlObaZfA(IHardwareControllerTemplateMap_Internal P_0, Controller P_1, int P_2, Func<Guid, Entry> P_3)
		{
			if (P_0 == null)
			{
				return null;
			...
			for (int i = 0; i < count; i++)
			{
				...
				if (elementIdentifierMap != null && elementIdentifierMap.templateId == P_2)
				{
					return new vgyLkSessULxWIPilRPgXWnpbfGE(ControllerTemplateElementType.Button, false, new QpmNXOwiqgDcvsLLtrkLzeVpLiAW(P_1, elementIdentifierMap.joystickId, AxisRange.Full), new QpmNXOwiqgDcvsLLtrkLzeVpLiAW(P_1, -1, AxisRange.Positive), new QpmNXOwiqgDcvsLLtrkLzeVpLiAW(P_1, -1, AxisRange.Positive));
				}
			}
			return null;
		}

		internal static ControllerTemplateElementIdentifier cDaseMZwurZaEyjiNmzZdtqkkkSL(ControllerTemplateElementIdentifier[] P_0, int P_1)
		{
			int num = ZwRxcMQKyQRFQSqigKVlxwjRlHVg(P_0, P_1);
		...
		internal static int ZwRxcMQKyQRFQSqigKVlxwjRlHVg(ControllerTemplateElementIdentifier[] P_0, int P_1)
		{
			if (P_0 == null)
			{
				return -1;
		...
		internal static bool qDaZBVqHTUkajzGrEeFrHDlrlFsZA(ControllerTemplateElementIdentifier[] P_0, int P_1)
		{
			return ZwRxcMQKyQRFQSqigKVlxwjRlHVg(P_0, P_1) >= 0;
		}
	}
}
