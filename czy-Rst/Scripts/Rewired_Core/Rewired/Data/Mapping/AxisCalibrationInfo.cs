...
namespace Rewired.Data.Mapping
{
	...
	public class AxisCalibrationInfo : IDeepCloneable
	{
		...
		internal static AxisCalibrationData kdfOpmJAvkSxCewowbsqkKHmDUwCA(AxisCalibrationInfo P_0)
		{
			if (P_0 == null)
			{
		...
		internal static AxisCalibrationInfo cYcRsaZNEzZLrqahutwWQsbhLqt(AxisCalibrationData P_0)
		{
