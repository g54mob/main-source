...
namespace Rewired.Data.Mapping
{
	...
	internal interface IHardwareControllerTemplateMap_Internal
	{
		...
		vgyLkSessULxWIPilRPgXWnpbfGE GetAxisTarget(Controller controller, int elementIdentifierId);

		vgyLkSessULxWIPilRPgXWnpbfGE GetButtonTarget(Controller controller, int elementIdentifierId);
	}
}
