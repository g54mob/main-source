...
namespace Rewired.Utils
{
	...
	{
		private static byte[] BXniVVIhicTeOJXRVvgIOwweFimL;

		private static byte[] intToFloatBuffer => BXniVVIhicTeOJXRVvgIOwweFimL ?? (BXniVVIhicTeOJXRVvgIOwweFimL = new byte[4]);
