...
namespace Rewired.Utils
{
	...
	{
		private static string atMXgZfjALGYnOPItMFQMltDhYBL;
		...
		static StringTools()
		{
			atMXgZfjALGYnOPItMFQMltDhYBL = Regex.Escape(new string(Path.GetInvalidFileNameChars()));
		}

		public static string CleanUpFileName(string name)
		{
			name = name.Trim();
			string pattern = "[ ~`,:;'\\.\\$\\^\\{\\}\\[\\]\\(\\|\\)\\*\\+\\?\\\\" + atMXgZfjALGYnOPItMFQMltDhYBL + "]";
