...
namespace Rewired.Utils.Classes.Utility
{
	...
	internal class ObjectPool<T> : IObjectPool, IObjectPool<T> where T : class
	{
		...
		private ulong PIUgWopcBXyUwFvmKTwjoRwDyLYC;

		protected ulong InstanceCount => PIUgWopcBXyUwFvmKTwjoRwDyLYC;
		...
		private object noNaiDehEdMVUvzhgsTOTaaaIuALA()
		{
			return Get();
		}
		...
		{
			//ILSpy generated this explicit interface implementation from .override directive in noNaiDehEdMVUvzhgsTOTaaaIuALA
			return this.noNaiDehEdMVUvzhgsTOTaaaIuALA();
		}

		private bool OqZccjfRvQxVxHZOVIsoaMrDsyOK(object P_0)
		{
		...
		{
			//ILSpy generated this explicit interface implementation from .override directive in OqZccjfRvQxVxHZOVIsoaMrDsyOK
			return this.OqZccjfRvQxVxHZOVIsoaMrDsyOK(P_0);
		}
		...
		{
			PIUgWopcBXyUwFvmKTwjoRwDyLYC = ((PIUgWopcBXyUwFvmKTwjoRwDyLYC < ulong.MaxValue) ? (PIUgWopcBXyUwFvmKTwjoRwDyLYC + 1) : 0);
			return PIUgWopcBXyUwFvmKTwjoRwDyLYC;
		}
	}
}
