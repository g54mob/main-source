...
namespace Rewired.Components
{
	...
	public class PlayerController : ComponentWrapper<Rewired.PlayerController>, IPlayerController
	{
		...
		protected override void OnAwakeFinished()
		{
			...
			if (base.initialized)
			{
				eSRfowxMXWrAQNytDqFsYIpIaBpI(true);
			}
		}
		...
		protected override void Subscribe()
		{
			...
			if (base.source != null)
			{
				base.source.Rewired_002EIPlayerController_002EButtonStateChangedEvent += ateMoBoTCnAnuLdKyctZPWfzGUXi;
				base.source.Rewired_002EIPlayerController_002EAxisValueChangedEvent += NSLSiGcMxDdYnTkWGVdavgcMEakjA;
				base.source.Rewired_002EIPlayerController_002EEnabledStateChangedEvent += eSRfowxMXWrAQNytDqFsYIpIaBpI;
			}
		}
		...
		internal virtual List<ElementInfo> ymFDkJWrlvhkTiqPmMfPyAUpQbqg()
		{
		...
		private void ateMoBoTCnAnuLdKyctZPWfzGUXi(int P_0, bool P_1)
		{
		...
		private void NSLSiGcMxDdYnTkWGVdavgcMEakjA(int P_0, float P_1)
		{
			if (!base.isActiveAndEnabled)
			{
				return;
		...
		private void eSRfowxMXWrAQNytDqFsYIpIaBpI(bool P_0)
		{
			try
			{
		...
		private void oNsJJdYAbJSkoCNFwBomVEaDCAhc()
		{
			if (_elements == null || _elements.Count <= 0)
			{
				_elements = ymFDkJWrlvhkTiqPmMfPyAUpQbqg();
			}
		}
	}
}
