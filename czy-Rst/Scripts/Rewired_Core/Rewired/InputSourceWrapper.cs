...
namespace Rewired
{
	...
	{
		private T DzRWiohRxXWYZceFrEYgEgIMjFUd;

		private bool btKObzBXjAksAAVPnhDWwBMudNFE;

		public T source => DzRWiohRxXWYZceFrEYgEgIMjFUd;
		...
		{
			DzRWiohRxXWYZceFrEYgEgIMjFUd = P_0;
		}
		...
		{
			if (!btKObzBXjAksAAVPnhDWwBMudNFE)
			{
				btKObzBXjAksAAVPnhDWwBMudNFE = true;
			}
		}
	}
}
