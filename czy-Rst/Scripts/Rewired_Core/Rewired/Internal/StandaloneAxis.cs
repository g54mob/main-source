...
namespace Rewired.Internal
{
	...
	internal sealed class StandaloneAxis
	{
		...
		[CompilerGenerated]
		private AxisValueChangedEventHandler WcHEkCbgJgfPFgJQLLkcEawyBAuLA;

		[CompilerGenerated]
		private AxisValueChangedEventHandler VCmBUxdbupojWBNORzMUbsonsUvOA;

		[CompilerGenerated]
		private ButtonDownEventHandler mbhoKoCuXquwcWVzuuFuAqRjHlg;

		[CompilerGenerated]
		private ButtonUpEventHandler MWfAeMAPuNhyOsUeQLCFYCxVevHz;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler nGNskXnybKjqCKhsVQqIhyOlWOkP;

		[CompilerGenerated]
		private ButtonDownEventHandler vlLzOIdqRxSgvrvtnDbOAMlMgSHcA;

		[CompilerGenerated]
		private ButtonUpEventHandler xyQgCvYbrxEdKDBJoYQEpbaUvrCW;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler mKagwEaXCoSFqffEkCuCzjNfBPFL;
		...
		private event AxisValueChangedEventHandler _AxisValueChangedEvent
		{
			...
			add
			{
				AxisValueChangedEventHandler axisValueChangedEventHandler = WcHEkCbgJgfPFgJQLLkcEawyBAuLA;
				...
				do
				{
					...
					axisValueChangedEventHandler = Interlocked.CompareExchange(ref WcHEkCbgJgfPFgJQLLkcEawyBAuLA, axisValueChangedEventHandler3, axisValueChangedEventHandler2);
				}
		...
		private event AxisValueChangedEventHandler _RawAxisValueChangedEvent
		{
			...
			add
			{
				AxisValueChangedEventHandler axisValueChangedEventHandler = VCmBUxdbupojWBNORzMUbsonsUvOA;
				AxisValueChangedEventHandler axisValueChangedEventHandler2;
				do
				{
					axisValueChangedEventHandler2 = axisValueChangedEventHandler;
					AxisValueChangedEventHandler axisValueChangedEventHandler3 = (AxisValueChangedEventHandler)Delegate.Combine(axisValueChangedEventHandler2, b);
					axisValueChangedEventHandler = Interlocked.CompareExchange(ref VCmBUxdbupojWBNORzMUbsonsUvOA, axisValueChangedEventHandler3, axisValueChangedEventHandler2);
				}
				while ((object)axisValueChangedEventHandler != axisValueChangedEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonDownEventHandler _ButtonDownEvent
		{
			...
			add
			{
				ButtonDownEventHandler buttonDownEventHandler = mbhoKoCuXquwcWVzuuFuAqRjHlg;
				...
				do
				{
					...
					buttonDownEventHandler = Interlocked.CompareExchange(ref mbhoKoCuXquwcWVzuuFuAqRjHlg, buttonDownEventHandler3, buttonDownEventHandler2);
				}
		...
		private event ButtonUpEventHandler _ButtonUpEvent
		{
			...
			add
			{
				ButtonUpEventHandler buttonUpEventHandler = MWfAeMAPuNhyOsUeQLCFYCxVevHz;
				...
				do
				{
					...
					buttonUpEventHandler = Interlocked.CompareExchange(ref MWfAeMAPuNhyOsUeQLCFYCxVevHz, buttonUpEventHandler3, buttonUpEventHandler2);
				}
		...
		private event ButtonValueChangedEventHandler _ButtonValueChangedEvent
		{
			...
			add
			{
				ButtonValueChangedEventHandler buttonValueChangedEventHandler = nGNskXnybKjqCKhsVQqIhyOlWOkP;
				...
				do
				{
					...
					buttonValueChangedEventHandler = Interlocked.CompareExchange(ref nGNskXnybKjqCKhsVQqIhyOlWOkP, buttonValueChangedEventHandler3, buttonValueChangedEventHandler2);
				}
		...
		private event ButtonDownEventHandler _RawButtonDownEvent
		{
			...
			add
			{
				ButtonDownEventHandler buttonDownEventHandler = vlLzOIdqRxSgvrvtnDbOAMlMgSHcA;
				ButtonDownEventHandler buttonDownEventHandler2;
				do
				{
					buttonDownEventHandler2 = buttonDownEventHandler;
					ButtonDownEventHandler buttonDownEventHandler3 = (ButtonDownEventHandler)Delegate.Combine(buttonDownEventHandler2, b);
					buttonDownEventHandler = Interlocked.CompareExchange(ref vlLzOIdqRxSgvrvtnDbOAMlMgSHcA, buttonDownEventHandler3, buttonDownEventHandler2);
				}
				while ((object)buttonDownEventHandler != buttonDownEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonUpEventHandler _RawButtonUpEvent
		{
			...
			add
			{
				ButtonUpEventHandler buttonUpEventHandler = xyQgCvYbrxEdKDBJoYQEpbaUvrCW;
				ButtonUpEventHandler buttonUpEventHandler2;
				do
				{
					buttonUpEventHandler2 = buttonUpEventHandler;
					ButtonUpEventHandler buttonUpEventHandler3 = (ButtonUpEventHandler)Delegate.Combine(buttonUpEventHandler2, b);
					buttonUpEventHandler = Interlocked.CompareExchange(ref xyQgCvYbrxEdKDBJoYQEpbaUvrCW, buttonUpEventHandler3, buttonUpEventHandler2);
				}
				while ((object)buttonUpEventHandler != buttonUpEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonValueChangedEventHandler _RawButtonValueChangedEvent
		{
			...
			add
			{
				ButtonValueChangedEventHandler buttonValueChangedEventHandler = mKagwEaXCoSFqffEkCuCzjNfBPFL;
				ButtonValueChangedEventHandler buttonValueChangedEventHandler2;
				do
				{
					buttonValueChangedEventHandler2 = buttonValueChangedEventHandler;
					ButtonValueChangedEventHandler buttonValueChangedEventHandler3 = (ButtonValueChangedEventHandler)Delegate.Combine(buttonValueChangedEventHandler2, b);
					buttonValueChangedEventHandler = Interlocked.CompareExchange(ref mKagwEaXCoSFqffEkCuCzjNfBPFL, buttonValueChangedEventHandler3, buttonValueChangedEventHandler2);
				}
				while ((object)buttonValueChangedEventHandler != buttonValueChangedEventHandler2);
			}
			[CompilerGenerated]
		...
		public void SetRawValue(float value)
		{
			...
			if (VCmBUxdbupojWBNORzMUbsonsUvOA != null && _valueRaw != _valueRawPrev)
			{
				VCmBUxdbupojWBNORzMUbsonsUvOA(_valueRaw);
			}
			if (WcHEkCbgJgfPFgJQLLkcEawyBAuLA != null)
			{
				float num = this.value;
				if (num != valuePrev)
				{
					WcHEkCbgJgfPFgJQLLkcEawyBAuLA(num);
				}
			}
			if (mKagwEaXCoSFqffEkCuCzjNfBPFL != null)
			{
				bool flag = rawButtonValue;
				if (flag != rawButtonValuePrev)
				{
					mKagwEaXCoSFqffEkCuCzjNfBPFL(flag);
				}
			}
			if (vlLzOIdqRxSgvrvtnDbOAMlMgSHcA != null && rawButtonValue && !rawButtonValuePrev)
			{
				vlLzOIdqRxSgvrvtnDbOAMlMgSHcA();
			}
			if (xyQgCvYbrxEdKDBJoYQEpbaUvrCW != null && !rawButtonValue && rawButtonValuePrev)
			{
				xyQgCvYbrxEdKDBJoYQEpbaUvrCW();
			}
			if (nGNskXnybKjqCKhsVQqIhyOlWOkP != null)
			{
				bool flag2 = buttonValue;
				if (flag2 != buttonValuePrev)
				{
					nGNskXnybKjqCKhsVQqIhyOlWOkP(flag2);
				}
			}
			if (mbhoKoCuXquwcWVzuuFuAqRjHlg != null && buttonValue && !buttonValuePrev)
			{
				mbhoKoCuXquwcWVzuuFuAqRjHlg();
			}
			if (MWfAeMAPuNhyOsUeQLCFYCxVevHz != null && !buttonValue && buttonValuePrev)
			{
				MWfAeMAPuNhyOsUeQLCFYCxVevHz();
			}
		}
