...
namespace Rewired
{
	...
	{
		private const string zkXjaxBlFJNUBToaxaiWXUAONzwJ = "[^a-fA-F0-9]";
		...
		{
			if (string.IsNullOrEmpty(flVqEprQLjabpwUoAWlzBdJpwywK(P_0)))
			{
				productId = 0;
				vendorId = 0;
				return;
		...
		{
			return RyOBWAsOZzyCUNsNJlsAWTUDcbHo(flVqEprQLjabpwUoAWlzBdJpwywK(pidVid));
		}
		...
		private bool RyOBWAsOZzyCUNsNJlsAWTUDcbHo(string P_0)
		{
		...
		private static string flVqEprQLjabpwUoAWlzBdJpwywK(string P_0)
		{
