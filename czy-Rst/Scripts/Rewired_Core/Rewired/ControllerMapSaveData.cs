...
namespace Rewired
{
	public abstract class ControllerMapSaveData
	{
		...
		internal readonly int JcmwvsWTGnnACgSgNLhcMBlBzzBU;
		...
		internal ControllerMapSaveData(Controller P_0, ControllerMap P_1)
		{
			_controller = P_0;
			_map = P_1;
			JcmwvsWTGnnACgSgNLhcMBlBzzBU = ReInput.id;
		}

		internal static _0001 YpqAOsXFJwAdEKpZuywlBcqBHaBrA<_0001>(Controller P_0, ControllerMap P_1) where _0001 : ControllerMapSaveData
		{
			return (_0001)YpqAOsXFJwAdEKpZuywlBcqBHaBrA(P_0, P_1);
		}

		internal static ControllerMapSaveData YpqAOsXFJwAdEKpZuywlBcqBHaBrA(Controller P_0, ControllerMap P_1)
		{
