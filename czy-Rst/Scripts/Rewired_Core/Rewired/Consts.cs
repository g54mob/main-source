...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static readonly Guid[] vENvSBCmZrTiVSNIgpbTmhPEngvm;

		internal static readonly ReadOnlyCollection<Guid> reservedHardwareTypeGuids;

		private static ControllerElementIdentifier.bSeqdIyVjkTFqqpLamBpjhuEDWyN[] xIoIROWfAtsNLPiYLUltiKzsjMlF;

		private static ReadOnlyCollection<ControllerElementIdentifier> UMaenHLTuFbMJErquSJlucARCFgf;

		private static ReadOnlyCollection<ControllerElementIdentifier> jQZDecvZxwTAwruSVOBQfTnJDkGu;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] zkUBmCadJEouChSWShPtnrBPdfRy;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] yDFcYbijEZtgVNlcTuZOvBYoOvWm;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] ahjBFGBjdeEdyuQTUmBzVxByhMDB;

		internal static readonly IList<int> keyboardKeyValues;

		internal static readonly int[] _keyboardKeyValues;

		private static readonly IList<string> BUlFKGEbQXCTManbvnmTcdbRDbzM;

		private static readonly string[] ZQEYfVOAuPydsmcCtkvibeBdsDnJ;

		private static readonly IList<string> aclqFHccywKeUkOlraaAkdexLIHD;

		private static readonly string[] zLyPGGNmiYbAUJRrjzgjmXNQafHQA;
		...
		private static readonly PidVid[] pzCIkIEiLgeTInLwDCmfJoQXaEnnA;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] yCEAwIbDhcwHCvKlTCIngjFEKDeQA;

		internal static readonly IList<PidVid> pidVids_sony_dualSense;

		private static readonly PidVid[] IimFcTgrVoYkbtSuCcsUVCbeTFvjA;

		internal static readonly IList<string> productNames_sony_dualSense;

		private static readonly string[] yOTBchvaYADhPkubJmcJgMtDLpKA;

		private static readonly ControllerElementIdentifier[] lziiXmRuVPaItvFzVhZLUTkvBzDK;
		...
		internal static ControllerElementIdentifier.bSeqdIyVjkTFqqpLamBpjhuEDWyN[] commonMouseElementIdentifierInitOptions
		{
			get
			{
				if (xIoIROWfAtsNLPiYLUltiKzsjMlF != null)
				{
					return xIoIROWfAtsNLPiYLUltiKzsjMlF;
				}
				xIoIROWfAtsNLPiYLUltiKzsjMlF = new ControllerElementIdentifier.bSeqdIyVjkTFqqpLamBpjhuEDWyN[11]
				{
					new ControllerElementIdentifier.bSeqdIyVjkTFqqpLamBpjhuEDWyN
					{
						id = 0,
		...
		internal static IList<ControllerElementIdentifier> unityUnifiedMouseElementIdentifiers => UMaenHLTuFbMJErquSJlucARCFgf ?? (UMaenHLTuFbMJErquSJlucARCFgf = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[11]
		{
		...
		internal static IList<ControllerElementIdentifier> rawInputUnifiedMouseElementIdentifiers => jQZDecvZxwTAwruSVOBQfTnJDkGu ?? (jQZDecvZxwTAwruSVOBQfTnJDkGu = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[9]
		{
			new ControllerElementIdentifier(commonMouseElementIdentifierInitOptions[0]),
			new ControllerElementIdentifier(commonMouseElementIdentifierInitOptions[1]),
			new ControllerElementIdentifier(commonMouseElementIdentifierInitOptions[2]),
		...
		public static IList<string> keyboardKeyKeys => BUlFKGEbQXCTManbvnmTcdbRDbzM;

		public static IList<string> keyboardModifierKeyKeys => aclqFHccywKeUkOlraaAkdexLIHD;

		internal static ControllerElementIdentifier[] unknownJoystickElementIdentifiers_orig => lziiXmRuVPaItvFzVhZLUTkvBzDK;
		...
		static Consts()
		{
			...
			vENvSBCmZrTiVSNIgpbTmhPEngvm = new Guid[3] { joystickGuid_unknownController, hardwareTypeGuid_universalKeyboard, hardwareTypeGuid_universalMouse };
			zkUBmCadJEouChSWShPtnrBPdfRy = new string[3] { "MouseAxis1", "MouseAxis2", "MouseAxis3" };
			yDFcYbijEZtgVNlcTuZOvBYoOvWm = new string[7] { "MouseButton0", "MouseButton1", "MouseButton2", "MouseButton3", "MouseButton4", "MouseButton5", "MouseButton6" };
			ahjBFGBjdeEdyuQTUmBzVxByhMDB = new string[132]
			{
			...
			ZQEYfVOAuPydsmcCtkvibeBdsDnJ = new string[132]
			{
				"", "a", "b", "c", "d", "e", "f", "g", "h", "i",
				"j", "k", "l", "m", "n", "o", "p", "q", "r", "s",
			...
			zLyPGGNmiYbAUJRrjzgjmXNQafHQA = new string[5] { "", "control", "alt", "shift", "command" };
			...
			pzCIkIEiLgeTInLwDCmfJoQXaEnnA = new PidVid[3]
			{
				new PidVid(1476, 1356),
				new PidVid(2976, 1356),
				new PidVid(2508, 1356)
			};
			yCEAwIbDhcwHCvKlTCIngjFEKDeQA = new string[5] { "Sony Computer Entertainment Wireless Controller", "Sony Interactive Entertainment DUALSHOCK®4 USB Wireless Adaptor", "Wireless Controller", "Sony Interactive Entertainment Wireless Controller", "Wireless Controller Touchpad" };
			IimFcTgrVoYkbtSuCcsUVCbeTFvjA = new PidVid[2]
			{
				new PidVid(3302, 1356),
				new PidVid(3570, 1356)
			};
			yOTBchvaYADhPkubJmcJgMtDLpKA = new string[1] { "DualSense Wireless Controller" };
			mouseAxisUnityNames = new ReadOnlyCollection<string>(zkUBmCadJEouChSWShPtnrBPdfRy);
			mouseButtonUnityNames = new ReadOnlyCollection<string>(yDFcYbijEZtgVNlcTuZOvBYoOvWm);
			keyboardKeyNames = new ReadOnlyCollection<string>(ahjBFGBjdeEdyuQTUmBzVxByhMDB);
			keyboardKeyValues = new ReadOnlyCollection<int>(_keyboardKeyValues);
			BUlFKGEbQXCTManbvnmTcdbRDbzM = new ReadOnlyCollection<string>(ZQEYfVOAuPydsmcCtkvibeBdsDnJ);
			aclqFHccywKeUkOlraaAkdexLIHD = new ReadOnlyCollection<string>(zLyPGGNmiYbAUJRrjzgjmXNQafHQA);
			pidVids_sony_dualShock4 = new ReadOnlyCollection<PidVid>(pzCIkIEiLgeTInLwDCmfJoQXaEnnA);
			productNames_sony_dualShock4 = new ReadOnlyCollection<string>(yCEAwIbDhcwHCvKlTCIngjFEKDeQA);
			pidVids_sony_dualSense = new ReadOnlyCollection<PidVid>(IimFcTgrVoYkbtSuCcsUVCbeTFvjA);
			productNames_sony_dualSense = new ReadOnlyCollection<string>(yOTBchvaYADhPkubJmcJgMtDLpKA);
			reservedHardwareTypeGuids = new ReadOnlyCollection<Guid>(vENvSBCmZrTiVSNIgpbTmhPEngvm);
			...
			lziiXmRuVPaItvFzVhZLUTkvBzDK = OeVsoFfRKuJfAsKrBOjfoHIFdgDZ();
			if (132 != ahjBFGBjdeEdyuQTUmBzVxByhMDB.Length)
			{
			...
			if (132 != ZQEYfVOAuPydsmcCtkvibeBdsDnJ.Length)
			{
				Logger.LogError("Consts.keyboardKeyCount does not match _keyboardKeyStringKeys.Length!");
			}
		}

		private static ControllerElementIdentifier[] OeVsoFfRKuJfAsKrBOjfoHIFdgDZ()
		{
			int num = 0;
			List<ControllerElementIdentifier> list = new List<ControllerElementIdentifier>(288);
			ControllerElementIdentifier.bSeqdIyVjkTFqqpLamBpjhuEDWyN bSeqdIyVjkTFqqpLamBpjhuEDWyN = new ControllerElementIdentifier.bSeqdIyVjkTFqqpLamBpjhuEDWyN();
			for (int i = 0; i < 32; i++)
			{
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.id = num;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.name = "Axis " + i;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.positiveName = string.Empty;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.negativeName = string.Empty;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.key = LocalizationManager.ConcatenateKeyStrings("axis", i.ToString());
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.positiveKey = string.Empty;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.negativeKey = string.Empty;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.elementType = ControllerElementType.Axis;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.compoundElementType = CompoundControllerElementType.Axis2D;
				list.Add(new ControllerElementIdentifier(bSeqdIyVjkTFqqpLamBpjhuEDWyN));
				num++;
			}
			for (int j = 0; j < 128; j++)
			{
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.id = num;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.name = "Button " + j;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.positiveName = string.Empty;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.negativeName = string.Empty;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.key = LocalizationManager.ConcatenateKeyStrings("button", j.ToString());
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.positiveKey = string.Empty;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.negativeKey = string.Empty;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.elementType = ControllerElementType.Button;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.compoundElementType = CompoundControllerElementType.Axis2D;
				list.Add(new ControllerElementIdentifier(bSeqdIyVjkTFqqpLamBpjhuEDWyN));
				num++;
			}
			int num2 = num;
			int num3 = num + 64;
			bSeqdIyVjkTFqqpLamBpjhuEDWyN = new ControllerElementIdentifier.bSeqdIyVjkTFqqpLamBpjhuEDWyN();
			bSeqdIyVjkTFqqpLamBpjhuEDWyN.elementType = ControllerElementType.Button;
			bSeqdIyVjkTFqqpLamBpjhuEDWyN.compoundElementType = CompoundControllerElementType.Axis2D;
			for (int k = 0; k < 16; k++)
			{
				string a = LocalizationManager.ConcatenateKeyStrings("hat", k.ToString());
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.id = num2++;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.name = "Hat " + k + " Up";
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.key = LocalizationManager.AppendToKeyAsPath(a, "up");
				list.Add(new ControllerElementIdentifier(bSeqdIyVjkTFqqpLamBpjhuEDWyN));
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.id = num3++;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.name = "Hat " + k + " Up Right";
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.key = LocalizationManager.AppendToKeyAsPath(a, "up_right");
				list.Add(new ControllerElementIdentifier(bSeqdIyVjkTFqqpLamBpjhuEDWyN));
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.id = num2++;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.name = "Hat " + k + " Right";
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.key = LocalizationManager.AppendToKeyAsPath(a, "right");
				list.Add(new ControllerElementIdentifier(bSeqdIyVjkTFqqpLamBpjhuEDWyN));
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.id = num3++;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.name = "Hat " + k + " Down Right";
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.key = LocalizationManager.AppendToKeyAsPath(a, "down_right");
				list.Add(new ControllerElementIdentifier(bSeqdIyVjkTFqqpLamBpjhuEDWyN));
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.id = num2++;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.name = "Hat " + k + " Down";
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.key = LocalizationManager.AppendToKeyAsPath(a, "down");
				list.Add(new ControllerElementIdentifier(bSeqdIyVjkTFqqpLamBpjhuEDWyN));
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.id = num3++;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.name = "Hat " + k + " Down Left";
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.key = LocalizationManager.AppendToKeyAsPath(a, "down_left");
				list.Add(new ControllerElementIdentifier(bSeqdIyVjkTFqqpLamBpjhuEDWyN));
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.id = num2++;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.name = "Hat " + k + " Left";
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.key = LocalizationManager.AppendToKeyAsPath(a, "left");
				list.Add(new ControllerElementIdentifier(bSeqdIyVjkTFqqpLamBpjhuEDWyN));
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.id = num3++;
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.name = "Hat " + k + " Up Left";
				bSeqdIyVjkTFqqpLamBpjhuEDWyN.key = LocalizationManager.AppendToKeyAsPath(a, "up_left");
				list.Add(new ControllerElementIdentifier(bSeqdIyVjkTFqqpLamBpjhuEDWyN));
			}
			return list.ToArray();
		}
