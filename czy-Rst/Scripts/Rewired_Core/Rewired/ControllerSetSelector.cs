...
namespace Rewired
{
	...
	public sealed class ControllerSetSelector : ISerializationCallbackReceiver, IDeepCloneable
	{
		...
		[NonSerialized]
		private Guid zyMmKdsoQeexGNLGRIhRmLMpOaB;

		internal bool QfKPjZJacbKsLddxcfkcEFxqPKEoA => _type != Type.All;
		...
		public Guid hardwareTypeGuid
		{
			get
			{
				...
				return zyMmKdsoQeexGNLGRIhRmLMpOaB;
			}
			set
			{
				...
				zyMmKdsoQeexGNLGRIhRmLMpOaB = value;
		...
		public ControllerSetSelector(ControllerSetSelector P_0)
		{
			...
			zyMmKdsoQeexGNLGRIhRmLMpOaB = P_0.zyMmKdsoQeexGNLGRIhRmLMpOaB;
		}
		...
		internal ControllerSetSelector(Type P_0, ControllerType P_1, string P_2, string P_3, int P_4)
		{
			...
			_controllerType = P_1;
			_guid = P_2;
			zyMmKdsoQeexGNLGRIhRmLMpOaB = StringTools.ToGuid(P_2);
		...
		public bool Matches(Controller controller)
		{
			...
			case Type.HardwareType:
				if (zyMmKdsoQeexGNLGRIhRmLMpOaB != Guid.Empty)
				{
					return zyMmKdsoQeexGNLGRIhRmLMpOaB == controller.hardwareTypeGuid;
				}
			...
			case Type.ControllerTemplateType:
				return controller.ImplementsTemplate(zyMmKdsoQeexGNLGRIhRmLMpOaB);
			case Type.PersistentControllerInstance:
				return controller.deviceInstanceGuid == zyMmKdsoQeexGNLGRIhRmLMpOaB;
		...
		private void IsCArSnqqofXcOyOgSKiAqTBTysi()
		{
			_guid = string.Empty;
			zyMmKdsoQeexGNLGRIhRmLMpOaB = Guid.Empty;
		}

		void ISerializationCallbackReceiver.OnAfterDeserialize()
		{
			zyMmKdsoQeexGNLGRIhRmLMpOaB = StringTools.ToGuid(_guid);
		}
