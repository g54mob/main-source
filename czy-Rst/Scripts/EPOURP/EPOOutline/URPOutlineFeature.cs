	...
	public class URPOutlineFeature : ScriptableRendererFeature
	{
		private class SRPOutline : ScriptableRenderPass, IDisposable
		{
			...
			public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
			{
				...
				using (IUnsafeRenderGraphBuilder unsafeRenderGraphBuilder = renderGraph.AddUnsafePass<MainRenderFunctionParameter>("EPO Outline", out passData, "D:\\REPOS\\Mandragora\\Restory\\Assets\\Plugins\\Easy performant outline\\Scripts\\URP support\\URPOutlineFeature.cs", 53))
				{
				...
				using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<BlitRenderFunctionParameter>("EPO Blit", out passData2, "D:\\REPOS\\Mandragora\\Restory\\Assets\\Plugins\\Easy performant outline\\Scripts\\URP support\\URPOutlineFeature.cs", 107);
