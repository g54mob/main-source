...
namespace NSubstitute.Core
{
	public class ThreadLocalContext : IThreadLocalContext
	{
		private class PendingSpecificationWrapper : IPendingSpecification
		{
			...
			{
				_003CvalueHolder_003EP = valueHolder;
				base._002Ector();
			}

			public bool HasPendingCallSpecInfo()
			{
				return _003CvalueHolder_003EP.Value.HasValue;
			}

			public PendingSpecificationInfo? UseCallSpecInfo()
			{
				PendingSpecInfoData value = _003CvalueHolder_003EP.Value;
				Clear();
			...
			{
				_003CvalueHolder_003EP.Value = PendingSpecInfoData.FromCallSpecification(callSpecification);
			}

			public void SetLastCall(ICall lastCall)
			{
				_003CvalueHolder_003EP.Value = PendingSpecInfoData.FromLastCall(lastCall);
			}

			public void Clear()
			{
				_003CvalueHolder_003EP.Value = default(PendingSpecInfoData);
			}
		}
