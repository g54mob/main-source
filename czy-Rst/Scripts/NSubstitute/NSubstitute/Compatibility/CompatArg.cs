...
namespace NSubstitute.Compatibility
{
	public class CompatArg
	{
		...
		public Arg.AnyType Is<T>(Expression<Predicate<object>> predicate) where T : Arg.AnyType
		{
		...
		public static Arg.AnyType Do<T>(Action<object> useArgument) where T : Arg.AnyType
		{
