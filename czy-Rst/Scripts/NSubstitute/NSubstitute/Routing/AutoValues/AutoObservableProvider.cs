...
namespace NSubstitute.Routing.AutoValues
{
	public class AutoObservableProvider : IAutoValueProvider
	{
		...
		{
			_003CautoValueProviders_003EP = autoValueProviders;
			base._002Ector();
		}
		...
		public object? GetValue(Type type)
		{
			...
			IAutoValueProvider autoValueProvider = _003CautoValueProviders_003EP.Value.FirstOrDefault((IAutoValueProvider vp) => vp.CanProvideValueFor(innerType));
