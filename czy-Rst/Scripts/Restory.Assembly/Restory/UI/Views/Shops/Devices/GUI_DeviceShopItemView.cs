...
{
	public sealed class GUI_DeviceShopItemView : UIBehaviour, ICleanableComponent
	{
		[Header("Device")]
		[SerializeField]
		...
		public void Init(Sprite deviceIcon, string deviceName, string lotDescription, int lotPrice, string sellerName, SellerRating sellerRating, TimeSpan timeSpan, Sprite backgroundIcon)
		{
