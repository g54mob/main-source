...
namespace app.plat
{
	public class PlatformSocialLocal : HxObject
	{
		public string name;
		...
		public PlatformSocialLocal(EmptyObject empty)
			: base(default(EmptyObject))
		{
		}

		public PlatformSocialLocal(string name_, Array ids_)
			: base(default(EmptyObject))
		{
		}

		protected static void __hx_ctor_app_plat_PlatformSocialLocal(PlatformSocialLocal __hx_this, string name_, Array ids_)
		{
		}
		...
		public virtual void setFromPull(string id, object value)
		{
		}

		public virtual void setFromPush(string id, object value)
		{
		}

		public virtual void set(string id, object value, bool fromPush)
		{
		}
		...
		public virtual void retryPush(string reason, string id, object value)
		{
		}
		...
		public virtual void push(string id, object value)
		{
		}

		public virtual bool matches(object a, object b)
		{
			return false;
		}
