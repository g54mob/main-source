...
namespace DigitalOpus.MB.Core
{
	internal class MB3_TextureCombinerPackerMeshBakerFastV2 : MB_ITextureCombinerPacker
	{
		...
		{
			Rect[] rect = packedAtlasRects.rects;
			...
			try
			{
				...
				for (int i = 0; i < data.numAtlases; i++)
				{
					...
					else
					{
						...
						MeshFilter component = renderAtlasesGO.GetComponent<MeshFilter>();
						component.sharedMesh = mesh;
						MeshRenderer component2 = renderAtlasesGO.GetComponent<MeshRenderer>();
