...
public class PlayerManager : MonoBehaviour
{
	...
	public bool p1Locked
	{
		get
		{
			return devicesHoldingJoin.Count > 0;
		}
	}
	...
	public InputDevice p1Device
	{
		get
		{
			return (activeDevices.Count <= 0) ? devicesHoldingJoin[0] : activeDevices[0];
		}
	}
