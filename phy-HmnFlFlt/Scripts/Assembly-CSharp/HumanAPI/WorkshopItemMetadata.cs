...
namespace HumanAPI
{
	public class WorkshopItemMetadata
	{
		...
		public string metaPath
		{
			get
			{
				return FileTools.Combine(folder, "metadata.json");
			}
		}
		...
		public virtual string thumbPath
		{
			get
			{
				return FileTools.Combine(folder, "thumbnail.png");
			}
		}
		...
		public bool isLevel
		{
			get
			{
				return (itemType == WorkshopItemType.Levels) | (itemType == WorkshopItemType.Level);
			}
		}
		...
		public bool isPreset
		{
			get
			{
				return itemType == WorkshopItemType.RagdollPreset;
			}
		}
