	...
	public class ReverbOverlay
	{
		...
		private void ShowReverbs()
		{
			...
			for (int i = 0; i < activeReverb.zones.Length; i++)
			{
				...
				GUILayout.Label("level", AudioUI.style, GUILayout.ExpandWidth(false));
				...
				GUILayout.Label("delay", AudioUI.style, GUILayout.ExpandWidth(false));
				...
				GUILayout.Label("diffusion", AudioUI.style, GUILayout.ExpandWidth(false));
				rect2 = GUILayoutUtility.GetRect(100f, rect.height, GUILayout.ExpandWidth(false));
				reverbZone.diffusion = AudioUI.DrawHorizontalSlider(rect2, 0.01f, 1f, 0.5f, reverbZone.diffusion, AudioSliderType.Linear);
				GUILayout.Label("HP", AudioUI.style, GUILayout.ExpandWidth(false));
				rect2 = GUILayoutUtility.GetRect(100f, rect.height, GUILayout.ExpandWidth(false));
