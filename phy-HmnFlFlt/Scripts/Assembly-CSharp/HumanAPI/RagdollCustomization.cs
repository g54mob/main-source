...
namespace HumanAPI
{
	public class RagdollCustomization : MonoBehaviour
	{
		...
		public bool allowHead
		{
			get
			{
				return (main == null || main.allowHead) && (upper == null || upper.allowHead) && (lower == null || lower.allowHead);
			}
		}
		...
		public bool allowUpper
		{
			get
			{
				return (main == null || main.allowUpperBody) && (lower == null || lower.allowUpperBody) && (head == null || head.allowUpperBody);
			}
		}
		...
		public bool allowLower
		{
			get
			{
				return (main == null || main.allowLowerBody) && (upper == null || upper.allowLowerBody) && (head == null || head.allowLowerBody);
			}
		}
		...
		private RagdollModel BindToSkin(WorkshopItemMetadata wsMeta, bool useBaseTexture)
		{
			if (wsMeta == null)
			{
				return null;
			...
			if (ragdollModelMetadata != null)
			{
				...
				component.texture.LoadFromPreset(preset, useBaseTexture);
				return component;
			}
			return null;
		}
		...
		internal void ApplyPreset(RagdollPresetMetadata preset, bool forceRebuild = false, bool useBaseTexture = false)
		{
			...
			if (!forceRebuild)
			{
				string text = ((!(main != null) || main.meta == null || main.meta.folder == null) ? string.Empty : main.meta.folder);
				string text2 = ((preset == null || preset.main == null || preset.main.modelPath == null) ? string.Empty : preset.main.modelPath);
				flag = text != text2;
			}
			bool flag2 = RebindMain(preset, forceRebuild, useBaseTexture);
			bool flag3 = RebindHead(preset, forceRebuild, useBaseTexture);
			bool flag4 = RebindUpper(preset, forceRebuild, useBaseTexture);
			bool flag5 = RebindLower(preset, forceRebuild, useBaseTexture);
			...
			if (!forceRebuild)
			{
				...
				if (flag6)
				{
					...
					if (!flag2)
					{
						flag2 = RebindMain(preset, forceRebuild, useBaseTexture);
					}
				}
			}
		...
		private bool RebindMain(RagdollPresetMetadata preset, bool forceRebuild, bool useBaseTexture)
		{
			...
			if (main == null && preset != null && preset.main != null)
			{
				...
				if (item != null)
				{
					main = BindToSkin(item, useBaseTexture);
					return true;
				}
			}
			return false;
		...
		private bool RebindHead(RagdollPresetMetadata preset, bool forceRebuild, bool useBaseTexture)
		{
			...
			if (head == null && allowHead && preset != null && preset.head != null)
			{
				...
				if (item != null)
				{
					head = BindToSkin(item, useBaseTexture);
					return true;
				}
			}
			return false;
		...
		private bool RebindUpper(RagdollPresetMetadata preset, bool forceRebuild, bool useBaseTexture)
		{
			...
			if (upper == null && allowUpper && preset != null && preset.upperBody != null)
			{
				...
				if (item != null)
				{
					upper = BindToSkin(item, useBaseTexture);
					return true;
				}
			}
			return false;
		...
		private bool RebindLower(RagdollPresetMetadata preset, bool forceRebuild, bool useBaseTexture)
		{
			...
			if (lower == null && allowLower && preset != null && preset.lowerBody != null)
			{
				...
				if (item != null)
				{
					lower = BindToSkin(item, useBaseTexture);
					return true;
				}
			}
			return false;
