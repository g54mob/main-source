...
namespace ReliableNetcode.Utils
{
	public class ByteStream : Stream
	{
		...
		public float ReadSingle()
		{
			...
			unionVal unionVal2 = new unionVal
			{
				intVal = intVal
			};
			return unionVal2.floatVal;
		}
