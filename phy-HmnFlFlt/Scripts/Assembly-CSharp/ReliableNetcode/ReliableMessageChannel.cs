...
namespace ReliableNetcode
{
	internal class ReliableMessageChannel : MessageChannel
	{
		...
		public float PacketLoss
		{
			get
			{
				return packetController.PacketLoss;
			}
		}
		...
		public float SentBandwidthKBPS
		{
			get
			{
				return packetController.SentBandwidthKBPS;
			}
		}
		...
		public float ReceivedBandwidthKBPS
		{
			get
			{
				return packetController.ReceivedBandwidthKBPS;
			}
		}
