...
public class ReplayRecorder : MonoBehaviour
{
	...
	public static bool isRecording
	{
		get
		{
			return instance.state == ReplayState.Record;
		}
	}
	...
	public static bool isPlaying
	{
		get
		{
			return instance.state == ReplayState.PlayForward || instance.state == ReplayState.PlayBackward || instance.state == ReplayState.Stop;
		}
	}
	...
	{
		if (Game.instance == null || state == ReplayState.None)
		{
			return;
		}
	...
	{
		NetFrames value;
		if (!capture.TryGetValue(scope.netId, out value))
		{
			value = new NetFrames();
	...
	{
		NetFrames value;
		if (!scope.exitingLevel && capture.TryGetValue(scope.netId, out value))
		{
