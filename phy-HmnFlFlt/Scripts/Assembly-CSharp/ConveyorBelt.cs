	...
	private void Wrap(float delta)
	{
		...
		if (linearIsLong)
		{
			if (currentOffset < 0f)
			{
				...
				WrapParts(topPart, startPart, num, post, true);
				WrapParts(bottomPart, endPart, num, post, true);
			...
			else
			{
				...
				WrapParts(startPart, topPart, num2, post2, false);
				WrapParts(endPart, bottomPart, num2, post2, false);
		...
		else
		{
			if (currentOffset > segmentSpacing)
			{
				...
				WrapParts(topPart, endPart, num3, post3, false);
				WrapParts(bottomPart, startPart, num3, post3, false);
				currentOffset -= segmentSpacing;
				topTrack.position -= axisForward * segmentSpacing;
				bottomTrack.position += axisForward * segmentSpacing;
			}
			else
			{
				...
				WrapParts(startPart, bottomPart, num4, post4, true);
				WrapParts(endPart, topPart, num4, post4, true);
