...
public class SteamManager : MonoBehaviour
{
	...
	private static SteamManager Instance
	{
		get
		{
			if (s_instance == null)
			{
				...
				SteamManager result = gameObject.AddComponent<SteamManager>();
				gameObject.AddComponent<SteamRichPresence>();
				return result;
			}
			return s_instance;
		}
	...
	private void OnEnable()
	{
		...
		string text2 = SteamApps.GetCurrentGameLanguage();
		if (text2.Equals("schinese"))
		{
		...
		LocalizationManager.CurrentLanguage = text2;
	}
