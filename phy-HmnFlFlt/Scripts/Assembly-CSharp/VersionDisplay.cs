...
public class VersionDisplay : MonoBehaviour
{
	...
	public static uint netCode = 26u;
	...
	public static string fullVersion
	{
		get
		{
			return string.Format("{0} {1}", gameVersion, gameBuild);
		}
	}
	...
	private void Start()
	{
		...
		gameVersionString = string.Format("v{0}{1}{2}{3}", versionNumber.majorVersion, versionNumber.minorVersion, versionNumber.build, versionNumber.revision);
		...
		gameBuildString = string.Format("v{0}{1}{2}{3}", versionNumber.majorVersion, versionNumber.minorVersion, versionNumber.build, versionNumber.revision);
