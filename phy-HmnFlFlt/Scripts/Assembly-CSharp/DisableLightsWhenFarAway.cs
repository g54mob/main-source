	...
	public void FixedUpdate()
	{
		...
		foreach (NetPlayer player in game.players)
		{
			...
			if (!(child == null))
			{
				...
				Vector3 direction;
				float distance;
				if (!(component == null) && Physics.ComputePenetration(component, child.position, child.rotation, selfCollider, base.transform.position, base.transform.rotation, out direction, out distance))
				{
					flag = true;
					break;
				}
