...
namespace Multiplayer
{
	public struct NetVector3Delta
	{
		...
		{
			NetVector3Delta result = new NetVector3Delta
			{
				isRelative = stream.ReadBool()
			};
		...
		{
			return string.Format("{0} ({1},{2},{3}) ({4},{5},{6})", isRelative, x, y, z, NetFloat.Dequantize(x, 500f, 18), NetFloat.Dequantize(y, 500f, 18), NetFloat.Dequantize(z, 500f, 18));
		}
