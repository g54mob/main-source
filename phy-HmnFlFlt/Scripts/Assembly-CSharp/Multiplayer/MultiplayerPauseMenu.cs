...
namespace Multiplayer
{
	public class MultiplayerPauseMenu : MenuTransition
	{
		...
		private void OnGameOverlayActivation(byte active)
		{
			...
			{
				RatingMenu.instance.QueryRatingStatus(Game.instance.workshopLevel.workshopId, false);
			}
		}
		...
		public override void OnGotFocus()
		{
			...
			{
				workshopLevelButton.gameObject.SetActive(false);
				return;
			}
			workshopLevelButton.gameObject.SetActive(true);
		...
		{
			base.OnLostFocus();
			m_MenuOptions.SetPlayerActionVisibility(false);
		}
		...
		private void RefreshLobby()
		{
			...
			{
				NetGame.instance.transport.RequestLobbyDataRefresh(null, true);
