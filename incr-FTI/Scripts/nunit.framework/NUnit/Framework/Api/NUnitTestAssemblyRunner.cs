...
namespace NUnit.Framework.Api
{
	public class NUnitTestAssemblyRunner : ITestAssemblyRunner
	{
		...
		private ManualResetEvent _runComplete = new ManualResetEvent(initialState: false);
		...
		public ITestResult Result => (TopLevelWorkItem == null) ? null : TopLevelWorkItem.Result;
		...
		{
			return _runComplete.WaitOne(timeout, exitContext: false);
		}
