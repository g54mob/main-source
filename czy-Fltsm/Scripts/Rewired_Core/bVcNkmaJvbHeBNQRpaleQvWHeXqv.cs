...
internal static class bVcNkmaJvbHeBNQRpaleQvWHeXqv
{
	public static ControllerElementType hprGByjpElSVqTapPvrydgHxKrZq(ElementAssignmentType P_0)
	{
		switch (P_0)
		{
	...
	public static ElementAssignmentType khwphXYrwNjHZFbAcujKqsDvXdKD(ControllerType P_0, ControllerElementType P_1, AxisRange P_2)
	{
	...
	public static AxisRange bGlVeHWzuTMwrzRfyPbsEuOFXGK(Pole P_0)
	{
		return P_0 switch
		{
	...
	public static Type XgRfAyDRPYKrLGTzzHBfbpPjgWDj<_0001>() where _0001 : Controller
	{
		return INEakMcxxbxMkCGvGwKYjwQPymLJA(typeof(_0001));
	}

	public static Type INEakMcxxbxMkCGvGwKYjwQPymLJA(Type P_0)
	{
	...
	public static Type CLANOPIAcefQRbeScAFOioaYXpqQ(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static Type NWvPnfLGDYapuCReMKWOWqvezhvT(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerType OnLYJboGGeZFMLKwCBymIGxZgjpHA(Type P_0)
	{
		if (P_0 == null)
		{
	...
	public static ControllerType zzvIXJkhxoPAdanZIgbgivDbxfvgA<_0001>()
	{
		return OnLYJboGGeZFMLKwCBymIGxZgjpHA(typeof(_0001));
	}

	public static ControllerType OUrWYBVdZLZrCdmXHEQpygdsQlKx(Type P_0)
	{
		if (!kPFpDXcXgjlLGsycndqAxscPwJyr(P_0, out var result))
		{
			throw new Exception(P_0.Name + " is not an allowed type.");
		}
		return result;
	...
	public static ControllerType WPAMmjaTkemihFOLiHpmwzpMGwfu<_0001>() where _0001 : ControllerMap
	{
		return OUrWYBVdZLZrCdmXHEQpygdsQlKx(typeof(_0001));
	}

	public static bool kPFpDXcXgjlLGsycndqAxscPwJyr(Type P_0, out ControllerType P_1)
	{
		if (P_0 == null)
		{
	...
	public static bool RkpAQNVHmMMuVLgUrSmQLXsfjnGE<_0001>(out ControllerType P_0) where _0001 : ControllerMap
	{
		return kPFpDXcXgjlLGsycndqAxscPwJyr(typeof(_0001), out P_0);
	}

	public static ControllerType FDeoHKKmoiBZjmKsvAAbeNXZGfDRA(Type P_0)
	{
		if (P_0 == null)
		{
	...
	public static ControllerType kwAmnVpusybgnlLYlBcXfzSGBOem<_0001>() where _0001 : ControllerMapSaveData
	{
		return FDeoHKKmoiBZjmKsvAAbeNXZGfDRA(typeof(_0001));
	}

	public static bool LrIgjFjPWmoAlronxTteVcEmIKQR(ControllerTemplateElementType P_0, ControllerElementType P_1)
	{
		return P_1 switch
		{
	...
	public static ControllerElementType yujaqPaQIFHtLwmnHBfPIsHCZerdc(object P_0)
	{
		if (P_0 == null)
		{
		...
		{
			return ogZYejSWnbZCMRXcJqTBeoTKCOjm((ControllerTemplateElementType)P_0);
		}
		throw new NotImplementedException();
	}

	public static ControllerElementType ogZYejSWnbZCMRXcJqTBeoTKCOjm(ControllerTemplateElementType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerTemplateElementSourceType omIVfvtBbvSnYNTqKHHPWFbbdjKH(ControllerTemplateElementType P_0, bool P_1)
	{
		switch (P_0)
		{
	...
	public static ControllerTemplateElementType TNHBwBMkdeWayymwSdZZbFdaDBNT(ControllerElementType P_0, bool P_1)
	{
		switch (P_0)
		{
		case ControllerElementType.Axis:
