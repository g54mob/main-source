...
namespace Rewired
{
	...
	{
		private const string csuibeKwQZemuvcgYVLIwGDvNhZH = "[^a-fA-F0-9]";
		...
		{
			if (string.IsNullOrEmpty(ssaQrsyvChRQCILgvSGdybCCkATu(P_0)))
			{
				productId = 0;
				vendorId = 0;
				return;
		...
		{
			return IKbKkPxdUbgUzfHwaHiKhTwmPbmg(ssaQrsyvChRQCILgvSGdybCCkATu(pidVid));
		}
		...
		private bool IKbKkPxdUbgUzfHwaHiKhTwmPbmg(string P_0)
		{
		...
		private static string ssaQrsyvChRQCILgvSGdybCCkATu(string P_0)
		{
