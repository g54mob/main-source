...
namespace Rewired.Components
{
	...
	public sealed class PlayerMouse : PlayerController, IPlayerMouse, IPlayerController, IMouseInputSource
	{
		...
		private Rewired.PlayerMouse NhIOFEBNxgiEJWnYdBCClJfFCNEm => base.source as Rewired.PlayerMouse;
		...
		bool IPlayerMouse.defaultToCenter
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EdefaultToCenter;
			}
			set
			{
				if (NhIOFEBNxgiEJWnYdBCClJfFCNEm == null)
				{
					_defaultToCenter = value;
					return;
				}
				NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EdefaultToCenter = value;
				_defaultToCenter = NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EdefaultToCenter;
			}
		}
		...
		public bool clampToMovementArea
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.clampToMovementArea;
			}
			set
			{
				if (NhIOFEBNxgiEJWnYdBCClJfFCNEm == null)
				...
				NhIOFEBNxgiEJWnYdBCClJfFCNEm.clampToMovementArea = value;
				_clampToMovementArea = NhIOFEBNxgiEJWnYdBCClJfFCNEm.clampToMovementArea;
			}
		}
		...
		ScreenRect IPlayerMouse.movementArea
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EmovementArea;
			}
			set
			{
				if (NhIOFEBNxgiEJWnYdBCClJfFCNEm == null)
				...
				NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EmovementArea = value;
				_movementArea = new Rect(NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EmovementArea.xMin, NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EmovementArea.yMin, NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EmovementArea.width, NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EmovementArea.height);
			}
		}
		...
		Rewired.PlayerMouse.MovementAreaUnit IPlayerMouse.movementAreaUnit
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EmovementAreaUnit;
			}
			set
			{
				if (NhIOFEBNxgiEJWnYdBCClJfFCNEm == null)
				...
				NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EmovementAreaUnit = value;
				_movementAreaUnit = NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EmovementAreaUnit;
			}
		}
		...
		Vector2 IPlayerMouse.screenPosition
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EscreenPosition;
			}
			set
			{
				if (NhIOFEBNxgiEJWnYdBCClJfFCNEm != null)
				{
					NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EscreenPosition = value;
				}
			}
		}
		...
		Vector2 IPlayerMouse.screenPositionPrev
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EscreenPositionPrev;
			}
		}
		...
		Vector2 IPlayerMouse.screenPositionDelta
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EscreenPositionDelta;
			}
		}
		...
		Rewired.PlayerController.MouseAxis IPlayerMouse.xAxis
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002ExAxis;
			}
		}
		...
		Rewired.PlayerController.MouseAxis IPlayerMouse.yAxis
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EyAxis;
			}
		}
		...
		Rewired.PlayerController.MouseWheel IPlayerMouse.wheel
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002Ewheel;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.leftButton
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EleftButton;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.rightButton
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002ErightButton;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.middleButton
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EmiddleButton;
			}
		}
		...
		float IPlayerMouse.pointerSpeed
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EpointerSpeed;
			}
			set
			{
				if (value < 0f)
				...
				if (base.initialized)
				{
					NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EpointerSpeed = value;
					_pointerSpeed = NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EpointerSpeed;
				}
			}
		}
		...
		bool IPlayerMouse.useHardwarePointerPosition
		{
			get
			{
				...
				return NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EuseHardwarePointerPosition;
			}
			set
			{
				...
				if (base.initialized)
				{
					NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EuseHardwarePointerPosition = value;
				}
			}
		}
		...
		bool IMouseInputSource.enabled
		{
			get
			{
				...
				return ((IMouseInputSource)NhIOFEBNxgiEJWnYdBCClJfFCNEm).enabled;
			}
		}
		...
		Vector2 IMouseInputSource.screenPosition
		{
			get
			{
				...
				return ((IMouseInputSource)NhIOFEBNxgiEJWnYdBCClJfFCNEm).screenPosition;
			}
		}
		...
		Vector2 IMouseInputSource.screenPositionDelta
		{
			get
			{
				...
				return ((IMouseInputSource)NhIOFEBNxgiEJWnYdBCClJfFCNEm).screenPositionDelta;
			}
		}
		...
		Vector2 IMouseInputSource.wheelDelta
		{
			get
			{
				...
				return ((IMouseInputSource)NhIOFEBNxgiEJWnYdBCClJfFCNEm).wheelDelta;
			}
		}
		...
		bool IMouseInputSource.locked
		{
			get
			{
				...
				return ((IMouseInputSource)NhIOFEBNxgiEJWnYdBCClJfFCNEm).locked;
			}
		}
		...
		event Action<Vector2> IPlayerMouse.ScreenPositionChangedEvent
		{
			add
			{
				if (base.initialized)
				{
					NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EScreenPositionChangedEvent += value;
				}
			}
			remove
			{
		...
		protected override void Subscribe()
		{
			...
			if (NhIOFEBNxgiEJWnYdBCClJfFCNEm != null)
			{
				NhIOFEBNxgiEJWnYdBCClJfFCNEm.Rewired_002EIPlayerMouse_002EScreenPositionChangedEvent += NZhrxsYEwidpCCsmFpEJEqcmracD;
			}
		}
		...
		internal List<ElementInfo> GdfAplIodaMzGffmrTUgrAeiMbxhA()
		{
		...
		private void NZhrxsYEwidpCCsmFpEJEqcmracD(Vector2 P_0)
		{
		...
		bool IMouseInputSource.GetButtonDown(int button)
		{
			...
			return ((IMouseInputSource)NhIOFEBNxgiEJWnYdBCClJfFCNEm).GetButtonDown(button);
		}
		...
		bool IMouseInputSource.GetButtonUp(int button)
		{
			...
			return ((IMouseInputSource)NhIOFEBNxgiEJWnYdBCClJfFCNEm).GetButtonUp(button);
		}
		...
		bool IMouseInputSource.GetButton(int button)
		{
			...
			return ((IMouseInputSource)NhIOFEBNxgiEJWnYdBCClJfFCNEm).GetButton(button);
		}
	}
}
