...
namespace Rewired.Data.Mapping
{
	...
	internal interface IHardwareControllerTemplateMap_Internal
	{
		...
		wyBGNVjftIezdumZCvkmiqVKqZjAA GetAxisTarget(Controller controller, int elementIdentifierId);

		wyBGNVjftIezdumZCvkmiqVKqZjAA GetButtonTarget(Controller controller, int elementIdentifierId);
	}
}
