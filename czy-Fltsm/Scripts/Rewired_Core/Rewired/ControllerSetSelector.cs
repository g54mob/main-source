...
namespace Rewired
{
	...
	public sealed class ControllerSetSelector : ISerializationCallbackReceiver, IDeepCloneable
	{
		...
		[NonSerialized]
		private Guid oCZaSdasnUFANCuRBlyEjerQzLhFB;

		internal bool RDtTFCChfbuGeHQlJGPuhqsProjJA => _type != Type.All;
		...
		public Guid hardwareTypeGuid
		{
			get
			{
				...
				return oCZaSdasnUFANCuRBlyEjerQzLhFB;
			}
			set
			{
				...
				oCZaSdasnUFANCuRBlyEjerQzLhFB = value;
		...
		public ControllerSetSelector(ControllerSetSelector P_0)
		{
			...
			oCZaSdasnUFANCuRBlyEjerQzLhFB = P_0.oCZaSdasnUFANCuRBlyEjerQzLhFB;
		}
		...
		internal ControllerSetSelector(Type P_0, ControllerType P_1, string P_2, string P_3, int P_4)
		{
			...
			_controllerType = P_1;
			_guid = P_2;
			oCZaSdasnUFANCuRBlyEjerQzLhFB = StringTools.ToGuid(P_2);
		...
		public bool Matches(Controller controller)
		{
			...
			case Type.HardwareType:
				if (oCZaSdasnUFANCuRBlyEjerQzLhFB != Guid.Empty)
				{
					return oCZaSdasnUFANCuRBlyEjerQzLhFB == controller.hardwareTypeGuid;
				}
			...
			case Type.ControllerTemplateType:
				return controller.ImplementsTemplate(oCZaSdasnUFANCuRBlyEjerQzLhFB);
			case Type.PersistentControllerInstance:
				return controller.deviceInstanceGuid == oCZaSdasnUFANCuRBlyEjerQzLhFB;
		...
		private void LqxnvRuVfsbPLwGMNDrocfGmGvLLA()
		{
			_guid = string.Empty;
			oCZaSdasnUFANCuRBlyEjerQzLhFB = Guid.Empty;
		}

		void ISerializationCallbackReceiver.OnAfterDeserialize()
		{
			oCZaSdasnUFANCuRBlyEjerQzLhFB = StringTools.ToGuid(_guid);
		}
