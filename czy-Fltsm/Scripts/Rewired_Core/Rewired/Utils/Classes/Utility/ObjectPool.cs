...
namespace Rewired.Utils.Classes.Utility
{
	...
	internal class ObjectPool<T> : IObjectPool, IObjectPool<T> where T : class
	{
		...
		private ulong QAdGkvDkjBPUTartdOejjBCusSrsA;

		protected ulong InstanceCount => QAdGkvDkjBPUTartdOejjBCusSrsA;
		...
		private object ouiovEuGTnfhvTBfRKoILlrLlUrr()
		{
			return Get();
		}
		...
		{
			//ILSpy generated this explicit interface implementation from .override directive in ouiovEuGTnfhvTBfRKoILlrLlUrr
			return this.ouiovEuGTnfhvTBfRKoILlrLlUrr();
		}

		private bool JpgoHwgFoQzYMxdMkLqoFDagiAbU(object P_0)
		{
		...
		{
			//ILSpy generated this explicit interface implementation from .override directive in JpgoHwgFoQzYMxdMkLqoFDagiAbU
			return this.JpgoHwgFoQzYMxdMkLqoFDagiAbU(P_0);
		}
		...
		{
			QAdGkvDkjBPUTartdOejjBCusSrsA = ((QAdGkvDkjBPUTartdOejjBCusSrsA < ulong.MaxValue) ? (QAdGkvDkjBPUTartdOejjBCusSrsA + 1) : 0);
			return QAdGkvDkjBPUTartdOejjBCusSrsA;
		}
	}
}
