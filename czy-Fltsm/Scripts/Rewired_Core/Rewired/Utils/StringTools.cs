...
namespace Rewired.Utils
{
	...
	{
		private static string vfcmUcaJZPiMUwQSTgCdhcwrugDb;
		...
		static StringTools()
		{
			vfcmUcaJZPiMUwQSTgCdhcwrugDb = Regex.Escape(new string(Path.GetInvalidFileNameChars()));
		}

		public static string CleanUpFileName(string name)
		{
			name = name.Trim();
			string pattern = "[ ~`,:;'\\.\\$\\^\\{\\}\\[\\]\\(\\|\\)\\*\\+\\?\\\\" + vfcmUcaJZPiMUwQSTgCdhcwrugDb + "]";
