...
namespace Rewired.Utils
{
	...
	{
		private static byte[] OFEJkKLqbsAPnjaHmkZSrFvRbrJm;

		private static byte[] intToFloatBuffer => OFEJkKLqbsAPnjaHmkZSrFvRbrJm ?? (OFEJkKLqbsAPnjaHmkZSrFvRbrJm = new byte[4]);
