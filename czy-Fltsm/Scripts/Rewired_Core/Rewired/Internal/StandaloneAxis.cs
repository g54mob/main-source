...
namespace Rewired.Internal
{
	...
	internal sealed class StandaloneAxis
	{
		...
		[CompilerGenerated]
		private AxisValueChangedEventHandler LGmMoLsjSufhqIzKewPuhZpXbcFtA;

		[CompilerGenerated]
		private AxisValueChangedEventHandler AJWiRgvEnDEfjMjobqCFnmIizEe;

		[CompilerGenerated]
		private ButtonDownEventHandler feQalLgvdLJWBCQJhMFBjJrEyHaIe;

		[CompilerGenerated]
		private ButtonUpEventHandler FiUniVVvzNFQrGfytwhNhhoieRcDA;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler eyisGYofiUgIfkRgorNMANRGUqZW;

		[CompilerGenerated]
		private ButtonDownEventHandler omjQVfmGfrMQmJthMCYmvexteuqB;

		[CompilerGenerated]
		private ButtonUpEventHandler yflDiiXtsrKLxfOXPLnUYMlhJPdp;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler tSPEsZgzGuYcBZDCNxzKOXEYfOel;
		...
		private event AxisValueChangedEventHandler _AxisValueChangedEvent
		{
			...
			add
			{
				AxisValueChangedEventHandler axisValueChangedEventHandler = LGmMoLsjSufhqIzKewPuhZpXbcFtA;
				...
				do
				{
					...
					axisValueChangedEventHandler = Interlocked.CompareExchange(ref LGmMoLsjSufhqIzKewPuhZpXbcFtA, axisValueChangedEventHandler3, axisValueChangedEventHandler2);
				}
		...
		private event AxisValueChangedEventHandler _RawAxisValueChangedEvent
		{
			...
			add
			{
				AxisValueChangedEventHandler axisValueChangedEventHandler = AJWiRgvEnDEfjMjobqCFnmIizEe;
				AxisValueChangedEventHandler axisValueChangedEventHandler2;
				do
				{
					axisValueChangedEventHandler2 = axisValueChangedEventHandler;
					AxisValueChangedEventHandler axisValueChangedEventHandler3 = (AxisValueChangedEventHandler)Delegate.Combine(axisValueChangedEventHandler2, b);
					axisValueChangedEventHandler = Interlocked.CompareExchange(ref AJWiRgvEnDEfjMjobqCFnmIizEe, axisValueChangedEventHandler3, axisValueChangedEventHandler2);
				}
				while ((object)axisValueChangedEventHandler != axisValueChangedEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonDownEventHandler _ButtonDownEvent
		{
			...
			add
			{
				ButtonDownEventHandler buttonDownEventHandler = feQalLgvdLJWBCQJhMFBjJrEyHaIe;
				...
				do
				{
					...
					buttonDownEventHandler = Interlocked.CompareExchange(ref feQalLgvdLJWBCQJhMFBjJrEyHaIe, buttonDownEventHandler3, buttonDownEventHandler2);
				}
		...
		private event ButtonUpEventHandler _ButtonUpEvent
		{
			...
			add
			{
				ButtonUpEventHandler buttonUpEventHandler = FiUniVVvzNFQrGfytwhNhhoieRcDA;
				...
				do
				{
					...
					buttonUpEventHandler = Interlocked.CompareExchange(ref FiUniVVvzNFQrGfytwhNhhoieRcDA, buttonUpEventHandler3, buttonUpEventHandler2);
				}
		...
		private event ButtonValueChangedEventHandler _ButtonValueChangedEvent
		{
			...
			add
			{
				ButtonValueChangedEventHandler buttonValueChangedEventHandler = eyisGYofiUgIfkRgorNMANRGUqZW;
				...
				do
				{
					...
					buttonValueChangedEventHandler = Interlocked.CompareExchange(ref eyisGYofiUgIfkRgorNMANRGUqZW, buttonValueChangedEventHandler3, buttonValueChangedEventHandler2);
				}
		...
		private event ButtonDownEventHandler _RawButtonDownEvent
		{
			...
			add
			{
				ButtonDownEventHandler buttonDownEventHandler = omjQVfmGfrMQmJthMCYmvexteuqB;
				ButtonDownEventHandler buttonDownEventHandler2;
				do
				{
					buttonDownEventHandler2 = buttonDownEventHandler;
					ButtonDownEventHandler buttonDownEventHandler3 = (ButtonDownEventHandler)Delegate.Combine(buttonDownEventHandler2, b);
					buttonDownEventHandler = Interlocked.CompareExchange(ref omjQVfmGfrMQmJthMCYmvexteuqB, buttonDownEventHandler3, buttonDownEventHandler2);
				}
				while ((object)buttonDownEventHandler != buttonDownEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonUpEventHandler _RawButtonUpEvent
		{
			...
			add
			{
				ButtonUpEventHandler buttonUpEventHandler = yflDiiXtsrKLxfOXPLnUYMlhJPdp;
				ButtonUpEventHandler buttonUpEventHandler2;
				do
				{
					buttonUpEventHandler2 = buttonUpEventHandler;
					ButtonUpEventHandler buttonUpEventHandler3 = (ButtonUpEventHandler)Delegate.Combine(buttonUpEventHandler2, b);
					buttonUpEventHandler = Interlocked.CompareExchange(ref yflDiiXtsrKLxfOXPLnUYMlhJPdp, buttonUpEventHandler3, buttonUpEventHandler2);
				}
				while ((object)buttonUpEventHandler != buttonUpEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonValueChangedEventHandler _RawButtonValueChangedEvent
		{
			...
			add
			{
				ButtonValueChangedEventHandler buttonValueChangedEventHandler = tSPEsZgzGuYcBZDCNxzKOXEYfOel;
				ButtonValueChangedEventHandler buttonValueChangedEventHandler2;
				do
				{
					buttonValueChangedEventHandler2 = buttonValueChangedEventHandler;
					ButtonValueChangedEventHandler buttonValueChangedEventHandler3 = (ButtonValueChangedEventHandler)Delegate.Combine(buttonValueChangedEventHandler2, b);
					buttonValueChangedEventHandler = Interlocked.CompareExchange(ref tSPEsZgzGuYcBZDCNxzKOXEYfOel, buttonValueChangedEventHandler3, buttonValueChangedEventHandler2);
				}
				while ((object)buttonValueChangedEventHandler != buttonValueChangedEventHandler2);
			}
			[CompilerGenerated]
		...
		public void SetRawValue(float value)
		{
			...
			if (AJWiRgvEnDEfjMjobqCFnmIizEe != null && _valueRaw != _valueRawPrev)
			{
				AJWiRgvEnDEfjMjobqCFnmIizEe(_valueRaw);
			}
			if (LGmMoLsjSufhqIzKewPuhZpXbcFtA != null)
			{
				float num = this.value;
				if (num != valuePrev)
				{
					LGmMoLsjSufhqIzKewPuhZpXbcFtA(num);
				}
			}
			if (tSPEsZgzGuYcBZDCNxzKOXEYfOel != null)
			{
				bool flag = rawButtonValue;
				if (flag != rawButtonValuePrev)
				{
					tSPEsZgzGuYcBZDCNxzKOXEYfOel(flag);
				}
			}
			if (omjQVfmGfrMQmJthMCYmvexteuqB != null && rawButtonValue && !rawButtonValuePrev)
			{
				omjQVfmGfrMQmJthMCYmvexteuqB();
			}
			if (yflDiiXtsrKLxfOXPLnUYMlhJPdp != null && !rawButtonValue && rawButtonValuePrev)
			{
				yflDiiXtsrKLxfOXPLnUYMlhJPdp();
			}
			if (eyisGYofiUgIfkRgorNMANRGUqZW != null)
			{
				bool flag2 = buttonValue;
				if (flag2 != buttonValuePrev)
				{
					eyisGYofiUgIfkRgorNMANRGUqZW(flag2);
				}
			}
			if (feQalLgvdLJWBCQJhMFBjJrEyHaIe != null && buttonValue && !buttonValuePrev)
			{
				feQalLgvdLJWBCQJhMFBjJrEyHaIe();
			}
			if (FiUniVVvzNFQrGfytwhNhhoieRcDA != null && !buttonValue && buttonValuePrev)
			{
				FiUniVVvzNFQrGfytwhNhhoieRcDA();
			}
		}
