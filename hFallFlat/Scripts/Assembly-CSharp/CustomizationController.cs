...
public class CustomizationController : MonoBehaviour
{
	...
	public Camera mainCamera
	{
		get
		{
			return cameraController.cameraHolder.GetComponentInChildren<Camera>();
		}
	}
	...
	{
		Ragdoll component = UnityEngine.Object.Instantiate(Game.instance.ragdollPrefab.gameObject, parent, false).GetComponent<Ragdoll>();
		component.Lock();
	...
	public void SetActivePlayer(int index)
	{
		...
		activePlayer = index;
		angleFrom = turntable.rotation.eulerAngles.y;
	...
	public void ShowBoth()
	{
		...
		coopCharacter.gameObject.SetActive(true);
	}
	...
	private void ReloadSkin(int playerIdx)
	{
		...
		customizations[playerIdx].RebindColors(false);
	}
	...
	public void SetColor(WorkshopItemType part, int channel, Color color)
	{
		...
		activeCustomization.RebindColors(false);
	}
