...
public class PaintTool : MonoBehaviour
{
	...
	public void Paint()
	{
		...
		unprojectMaterial.SetVector("_PointPos", new Vector4(Input.mousePosition.x, Input.mousePosition.y, 0f, 0f));
