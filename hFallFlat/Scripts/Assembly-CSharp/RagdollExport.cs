...
public class RagdollExport : MonoBehaviour
{
	...
	public class SerializedTransform
	{
		...
		public void Lerp(SerializedTransform f2, float t)
		{
			...
			pos = new float[3] { vector.x, vector.y, vector.z };
			rot = new float[4] { quaternion.x, quaternion.y, quaternion.z, quaternion.w };
		}
	}
	...
	private void FixedUpdate()
	{
		...
		if (frames.Count > 1060)
		{
			...
			{
				File.AppendAllText(filename, JsonUtility.ToJson(frames[j], false));
	...
	private SerializedTransform StoreTransform(Transform t)
	{
		...
		serializedTransform.rot = new float[4] { quaternion.x, quaternion.y, quaternion.z, quaternion.w };
