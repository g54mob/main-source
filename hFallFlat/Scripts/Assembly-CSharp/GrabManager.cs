...
public class GrabManager : MonoBehaviour
{
	...
	public void ObjectGrabbed(GameObject grabObject)
	{
		...
		if (flag)
		{
			...
			IGrabbableWithInfo componentInParent2 = grabObject.GetComponentInParent<IGrabbableWithInfo>();
			if (componentInParent2 != null)
			{
				componentInParent2.OnGrab(this);
			}
			grabStartPositions[grabObject] = grabObject.transform.position;
			Human componentInParent3 = grabObject.GetComponentInParent<Human>();
			if (componentInParent3 != null)
			{
				componentInParent3.grabbedByHuman = human;
			}
		}
	}
	...
	private void CheckCarryEnd(GameObject grabObject)
	{
		...
		if (componentInParent2 != null)
		{
			componentInParent2.OnRelease(this);
		}
		...
		if (!CheatCodes.throwCheat)
		{
			...
			if (componentInParent3 != null)
			{
				componentInParent3.grabbedByHuman = null;
			}
		}
	}
