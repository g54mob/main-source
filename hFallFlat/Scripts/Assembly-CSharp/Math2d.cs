...
public static class Math2d
{
	...
	{
		Vector2 vector = a + b;
		float num = vector.x * b.x + vector.y * b.y;
		if (num != 0f)
		{
			return vector / num;
		}
	...
	{
		Vector2 lhs = point - linePoint;
		float num = Vector2.Dot(lhs, lineVec);
	...
	{
		Vector2 vector = ProjectPointOnLineSegment(linePoint1, linePoint2, point);
		return ((Vector3)(vector - point)).magnitude;
	}
