	...
	public class WallVolume : MonoBehaviour
	{
		...
		public void FillMesh(Mesh mesh, bool forceExact)
		{
			...
			for (int i = 0; i < faces.Count; i++)
			{
				...
				vertices[i * 4] = vector * gridSize;
				vertices[i * 4 + 1] = (vector + vector3) * gridSize;
				vertices[i * 4 + 2] = (vector + vector4 + vector3) * gridSize;
				vertices[i * 4 + 3] = (vector + vector4) * gridSize;
				normals[i * 4] = vector2;
