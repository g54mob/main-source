...
namespace HumanAPI
{
	public class AmbienceOverlay
	{
		...
		public void OnGUI()
		{
			...
			{
				activeAmbience.Save();
				SoundManager.level.Save(true);
			}
			scrollPos = GUILayout.BeginScrollView(scrollPos, GUILayout.Width(Screen.width));
			GUILayout.BeginHorizontal();
			GUILayoutUtility.GetRect(100f, 20f, GUILayout.ExpandWidth(false));
			for (int i = 0; i < sources.Length; i++)
			{
				Rect rect = GUILayoutUtility.GetRect(100f, 20f, GUILayout.ExpandWidth(false));
			...
			{
				Rect rect3 = GUILayoutUtility.GetRect(100f, 20f, GUILayout.ExpandWidth(false));
			...
			GUILayout.Label(string.Empty, GUILayout.Width(100f), GUILayout.ExpandWidth(false));
			GUILayout.Label("Verb", GUILayout.Width(75f), GUILayout.ExpandWidth(false));
			GUILayout.Label("Music", GUILayout.Width(75f), GUILayout.ExpandWidth(false));
			GUILayout.Label("Ambience", GUILayout.Width(75f), GUILayout.ExpandWidth(false));
			GUILayout.Label("Effects", GUILayout.Width(75f), GUILayout.ExpandWidth(false));
			GUILayout.Label("Physics", GUILayout.Width(75f), GUILayout.ExpandWidth(false));
			GUILayout.Label("Character", GUILayout.Width(75f), GUILayout.ExpandWidth(false));
			GUILayout.Label("AmbienceFx", GUILayout.Width(75f), GUILayout.ExpandWidth(false));
			GUILayout.EndHorizontal();
			for (int k = 0; k < zones.Length; k++)
			{
				...
				GUILayout.BeginHorizontal(GUILayout.Height(rect2.height));
				int num = (k + 2) * 20;
				Rect rect4 = GUILayoutUtility.GetRect(100f, 20f, GUILayout.ExpandWidth(false));
				...
				{
					rect4 = GUILayoutUtility.GetRect(100f, 20f, GUILayout.ExpandWidth(false));
				...
				GUILayout.Label("x", AudioUI.style, GUILayout.ExpandWidth(false));
				rect4 = GUILayoutUtility.GetRect(100f, 20f, GUILayout.ExpandWidth(false));
		...
		{
			Rect rect = GUILayoutUtility.GetRect(75f, 20f, GUILayout.ExpandWidth(false));
			float num = get(zone);
