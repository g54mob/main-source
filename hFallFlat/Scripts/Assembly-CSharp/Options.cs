...
public static class Options
{
	...
	public static int parental
	{
		get
		{
			return PlayerPrefs.GetInt("parental", 0);
		}
		set
		{
			PlayerPrefs.SetInt("parental", value);
		}
	}

	public static int usePINForParental
	{
		get
		{
			return PlayerPrefs.GetInt("usePINForParental", 1);
		}
		set
		{
			PlayerPrefs.SetInt("usePINForParental", value);
		}
	}
	...
	public static ulong multiplayerLobbyLevelStore
	{
		...
		set
		{
			...
			PlayerPrefs.SetInt("multiplayerLobbyLevelL", (int)(value & 0xFFFFFFFFu));
		}
	}
	...
	public static void LoadKeyboardBindings()
	{
		...
		{
			string data = PlayerPrefs.GetString("Bindings");
			keyboardBindings.Load(data);
		}
	}
