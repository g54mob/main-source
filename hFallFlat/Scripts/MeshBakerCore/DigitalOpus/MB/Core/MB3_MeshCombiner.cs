	...
	public abstract class MB3_MeshCombiner : MB_IMeshBakerSettings
	{
		...
		public class MBBlendShapeKey
		{
			...
			public override bool Equals(object obj)
			{
				...
				return gameObject == mBBlendShapeKey.gameObject && blendShapeIndexInSrc == mBBlendShapeKey.blendShapeIndexInSrc;
			}

			public override int GetHashCode()
			{
				int num = 23;
				num = num * 31 + gameObject.GetInstanceID();
		...
		{
			return UpdateGameObjects(gos, true, true, true, true, true, false, false, false, false, false, false, false, false, false);
		}
