...
public class WaypointInitializationSystem : SystemBase
{
	...
	private EntityQuery __query_1822386707_0;

	private EntityQuery __query_1822386707_1;

	private EntityQuery __query_1822386707_2;

	private EntityQuery __query_1822386707_3;
	...
	private void ActivateSpawnersForCable(CableInfo cable, float finalSpeed, HashSet<int> customersOnCable, HashSet<string> directions)
	{
	}

	private string MapDirectionToSibling(CableInfo primary, CableInfo sibling, string direction)
	{
		return null;
	}

	private void UpdateAllUI(Dictionary<int, CustomerNetworkInfo> customerInfo, List<(int customerId, List<string> path)> allRoutes, Dictionary<int, float> cableLoad, Dictionary<(string, string), CableInfo> cablePairLookup)
	{
	}
