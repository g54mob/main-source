...
public class ComputerShop : Interact
{
	...
	private bool isPendingColorPurchase;

	private int pendingItemID;

	private int pendingPrice;

	private PlayerManager.ObjectInHand pendingItemType;

	private string pendingDisplayName;

	private ShopCartItem pendingCartItem;
	...
	private bool wasTutorialShownAlready;
	...
	public void ButtonBuyShopItem(int itemID, int price, PlayerManager.ObjectInHand itemType, string displayName, bool isCustomColor = false)
	{
	}
	...
	private void SpawnNewCartItem(int itemID, int price, PlayerManager.ObjectInHand itemType, string displayName, Color? chosenColor)
	{
	}
	...
	public void ButtonChosenColor()
	{
	}

	public void ButtonCancelColorPicker()
	{
	}

	private void ApplyColorToSpawnedItem(int uid, Color color, PlayerManager.ObjectInHand itemType)
	{
	}
