...
namespace UMA.Examples
{
	...
	{
		public float _breastStiffness;

		public float _breastMass;

		public float _breastDamping;

		public float _breastGravity;

		public bool _breastSquashAndStretch;

		public float _breastFrontStretch;

		public float _breastSideStretch;
