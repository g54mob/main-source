...
namespace Eflatun.SceneReference.Exceptions
{
	...
	public class AddressNotUniqueException : SceneReferenceException
	{
		...
		internal AddressNotUniqueException(string address)
			: base(MakeExceptionMessage(address))
		{
		}

		internal AddressNotUniqueException(string address, Exception inner)
			: base(MakeExceptionMessage(address), inner)
		{
		}

		private protected AddressNotUniqueException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
	}
