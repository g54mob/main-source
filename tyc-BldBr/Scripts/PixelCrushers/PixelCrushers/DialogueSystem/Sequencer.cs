		...
		public void SetDialoguePanel(bool show, bool immediate)
		{
			...
			if (standardDialogueUI != null)
			{
				...
				for (int k = 0; k < standardDialogueUI.conversationUIElements.subtitlePanels.Length; k++)
				{
					...
					m_setDialoguePanelPreviousContinueButtonStates.Add(standardDialogueUI.conversationUIElements.subtitlePanels[k].continueButton != null && standardDialogueUI.conversationUIElements.subtitlePanels[k].continueButton.gameObject.activeInHierarchy);
