...
{
	public readonly struct CastArrayEnumerator<TList, TCast> : IEnumerable<TCast>, IEnumerable where TList : class
	{
		public struct Enumerator : IEnumerator<TCast>, IEnumerator, IDisposable
		{
			private readonly TList[] _array;
		...
		public CastArrayEnumerator(TList[] array)
		{
			_array = array;
		}
