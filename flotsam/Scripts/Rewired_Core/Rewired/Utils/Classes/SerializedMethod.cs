...
namespace Rewired.Utils.Classes
{
	...
	{
		private const int NLBGSqwSdhxMFHBbApYaDLohSZMA = 3;

		[NonSerialized]
		private bool yrkFFidDLlglCaLUiPeXpeFjOSESB;
		...
		{
			if (!yrkFFidDLlglCaLUiPeXpeFjOSESB)
			{
				EVbaZvcvCtRtvEeQJkVAPrEsokGlc();
			}
		...
		private void EVbaZvcvCtRtvEeQJkVAPrEsokGlc()
		{
			_data = new List<TypeWrapper>(3);
			yrkFFidDLlglCaLUiPeXpeFjOSESB = true;
		}
	}
}
