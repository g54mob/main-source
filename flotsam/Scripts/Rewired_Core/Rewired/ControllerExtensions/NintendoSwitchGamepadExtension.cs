...
namespace Rewired.ControllerExtensions
{
	...
	public abstract class NintendoSwitchGamepadExtension : Controller.Extension, IControllerVibrator, IHIDControllerExtension
	{
		...
		private ExtSource_Base CizBtfckGMQgsMRnGAkLlqpujBvib;

		private bool rTBhSZBiWngmcfzKQMNcyxsbQXWoA;

		protected bool isValid => rTBhSZBiWngmcfzKQMNcyxsbQXWoA;

		protected Joystick joystick => GetController<Joystick>();

		protected object source => CizBtfckGMQgsMRnGAkLlqpujBvib;
		...
		int IControllerVibrator.vibrationMotorCount
		{
			get
			{
				...
				if (!rTBhSZBiWngmcfzKQMNcyxsbQXWoA)
				{
					return 0;
				}
				return CizBtfckGMQgsMRnGAkLlqpujBvib.driver.vibrationMotorCount;
			}
		}
		...
		ushort IHIDControllerExtension.vendorId
		{
			get
			{
				...
				return CizBtfckGMQgsMRnGAkLlqpujBvib.driver.vendorId;
			}
		}
		...
		ushort IHIDControllerExtension.productId
		{
			get
			{
				...
				return CizBtfckGMQgsMRnGAkLlqpujBvib.driver.productId;
			}
		}
		...
		string IHIDControllerExtension.productName
		{
			get
			{
				...
				return CizBtfckGMQgsMRnGAkLlqpujBvib.driver.productName;
			}
		}
		...
		string IHIDControllerExtension.manufacturer
		{
			get
			{
				...
				return CizBtfckGMQgsMRnGAkLlqpujBvib.driver.manufacturer;
			}
		}
		...
		ushort IHIDControllerExtension.usagePage
		{
			get
			{
				...
				return CizBtfckGMQgsMRnGAkLlqpujBvib.driver.usagePage;
			}
		}
		...
		ushort IHIDControllerExtension.usage
		{
			get
			{
				...
				return CizBtfckGMQgsMRnGAkLlqpujBvib.driver.usage;
			}
		}
		...
		public NintendoSwitchGamepadVibration GetVibration(int motorIndex)
		{
			...
			{
				ReInput.CheckInitialized(_reInputId);
				return NintendoSwitchGamepadVibration.NytgttbRRiQtEQkWChygmIOQSuKr;
			}
			if (!rTBhSZBiWngmcfzKQMNcyxsbQXWoA || !base.enabled)
			{
				return NintendoSwitchGamepadVibration.NytgttbRRiQtEQkWChygmIOQSuKr;
			}
			CizBtfckGMQgsMRnGAkLlqpujBvib.driver.GetVibration(motorIndex, out var amplitudeLow, out var frequencyLow, out var amplitudeHigh, out var frequencyHigh);
		...
		public void SetVibration(int motorIndex, float amplitudeLow, float frequencyLow, float amplitudeHigh, float frequencyHigh)
		{
			...
			else if (rTBhSZBiWngmcfzKQMNcyxsbQXWoA && base.enabled)
			{
				CizBtfckGMQgsMRnGAkLlqpujBvib.driver.SetVibration(motorIndex, amplitudeLow, frequencyLow, amplitudeHigh, frequencyHigh);
			}
		}
		...
		public void SetVibration(int motorIndex, float amplitudeLow, float frequencyLow, float amplitudeHigh, float frequencyHigh, bool stopOtherMotors)
		{
			...
			{
				CizBtfckGMQgsMRnGAkLlqpujBvib.driver.SetVibration(motorIndex, amplitudeLow, frequencyLow, amplitudeHigh, frequencyHigh, stopOtherMotors);
			}
		}
		...
		public void SetVibration(int motorIndex, float amplitudeLow, float frequencyLow, float amplitudeHigh, float frequencyHigh, float duration)
		{
			...
			{
				CizBtfckGMQgsMRnGAkLlqpujBvib.driver.SetVibration(motorIndex, amplitudeLow, frequencyLow, amplitudeHigh, frequencyHigh, duration);
			}
		}
		...
		public void SetVibration(int motorIndex, float amplitudeLow, float frequencyLow, float amplitudeHigh, float frequencyHigh, float duration, bool stopOtherMotors)
		{
			...
			{
				CizBtfckGMQgsMRnGAkLlqpujBvib.driver.SetVibration(motorIndex, amplitudeLow, frequencyLow, amplitudeHigh, frequencyHigh, duration, stopOtherMotors);
			}
		}
		...
		public void SetVibration(int motorIndex, NintendoSwitchGamepadVibration vibration)
		{
			...
			{
				CizBtfckGMQgsMRnGAkLlqpujBvib.driver.SetVibration(motorIndex, vibration.amplitudeLow, vibration.frequencyLow, vibration.amplitudeHigh, vibration.frequencyHigh);
			}
		}
		...
		public void SetVibration(int motorIndex, NintendoSwitchGamepadVibration vibration, float duration)
		{
			...
			{
				CizBtfckGMQgsMRnGAkLlqpujBvib.driver.SetVibration(motorIndex, vibration.amplitudeLow, vibration.frequencyLow, vibration.amplitudeHigh, vibration.frequencyHigh, duration);
			}
		}
		...
		public void SetVibration(int motorIndex, NintendoSwitchGamepadVibration vibration, float duration, bool stopOtherMotors)
		{
			...
			{
				CizBtfckGMQgsMRnGAkLlqpujBvib.driver.SetVibration(motorIndex, vibration.amplitudeLow, vibration.frequencyLow, vibration.amplitudeHigh, vibration.frequencyHigh, duration, stopOtherMotors);
			}
		}
		...
		public void SetVibration(int motorIndex, NintendoSwitchGamepadVibration vibration, bool stopOtherMotors)
		{
			...
			{
				CizBtfckGMQgsMRnGAkLlqpujBvib.driver.SetVibration(motorIndex, vibration.amplitudeLow, vibration.frequencyLow, vibration.amplitudeHigh, vibration.frequencyHigh, stopOtherMotors);
			}
		}
		...
		public void StopVibration(int motorIndex)
		{
			...
			else if (rTBhSZBiWngmcfzKQMNcyxsbQXWoA)
			{
				CizBtfckGMQgsMRnGAkLlqpujBvib.driver.StopVibration(motorIndex);
			}
		}
		...
		public void StopVibration()
		{
			...
			{
				CizBtfckGMQgsMRnGAkLlqpujBvib.driver.StopVibration();
			}
		}
		...
		{
			CizBtfckGMQgsMRnGAkLlqpujBvib = source as ExtSource_Base;
			rTBhSZBiWngmcfzKQMNcyxsbQXWoA = CizBtfckGMQgsMRnGAkLlqpujBvib != null && CizBtfckGMQgsMRnGAkLlqpujBvib.driver != null;
		}
	}
}
