	...
	public class RotateAroundAxis : MonoBehaviour
	{
		...
		private void Update()
		{
			if (_speed != Speed.Stopped)
			{
				...
				base.transform.Rotate(egOhUYJKklDwnqpaKYLveKnHfcpU(_rotateAroundAxis), num * Time.deltaTime, _relativeTo);
			}
		}

		private static Vector3 egOhUYJKklDwnqpaKYLveKnHfcpU(RotationAxis P_0)
		{
			return P_0 switch
			{
