...
namespace Rewired.Platforms.Custom
{
	...
	{
		private sealed class kbIFwvKxUutVWitmmiglldmjxWbG : IEnumerable<HardwareJoystickMap.Platform_Custom.Axis>, IEnumerable, IEnumerator<HardwareJoystickMap.Platform_Custom.Axis>, IEnumerator, IDisposable
		{
			private int UOKbddbdQLsrFmIGIaFJBNrbXurUB;

			private HardwareJoystickMap.Platform_Custom.Axis yKsgfYrSAmjLmSCLxmzazyvdsCSH;

			private int YXpRjBPIKMZZJuXBKpuSeWGZtMmo;

			public HardwareJoystickMapCustomPlatformMap<TMatchingCriteria> wbMYvpHDcysszildIizPQbxfGPogA;

			private int daIsUMCdTRHbrJiVLfoghOrsGMVgb;
			...
			HardwareJoystickMap.Platform_Custom.Axis IEnumerator<HardwareJoystickMap.Platform_Custom.Axis>.Current
			{
				...
				get
				{
					return yKsgfYrSAmjLmSCLxmzazyvdsCSH;
				}
			}
			...
			[DebuggerHidden]
			public kbIFwvKxUutVWitmmiglldmjxWbG(int P_0)
			{
				UOKbddbdQLsrFmIGIaFJBNrbXurUB = P_0;
				YXpRjBPIKMZZJuXBKpuSeWGZtMmo = Environment.CurrentManagedThreadId;
			}

			[DebuggerHidden]
			void IDisposable.Dispose()
			{
				UOKbddbdQLsrFmIGIaFJBNrbXurUB = -2;
			}

			private bool MoveNext()
			{
				int uOKbddbdQLsrFmIGIaFJBNrbXurUB = UOKbddbdQLsrFmIGIaFJBNrbXurUB;
				HardwareJoystickMapCustomPlatformMap<TMatchingCriteria> hardwareJoystickMapCustomPlatformMap = wbMYvpHDcysszildIizPQbxfGPogA;
				switch (uOKbddbdQLsrFmIGIaFJBNrbXurUB)
				{
				default:
					return false;
				case 0:
					UOKbddbdQLsrFmIGIaFJBNrbXurUB = -1;
					if (hardwareJoystickMapCustomPlatformMap.elements == null || hardwareJoystickMapCustomPlatformMap.elements.axes == null)
					{
						return false;
					}
					daIsUMCdTRHbrJiVLfoghOrsGMVgb = 0;
					break;
				case 1:
					UOKbddbdQLsrFmIGIaFJBNrbXurUB = -1;
					daIsUMCdTRHbrJiVLfoghOrsGMVgb++;
					break;
				}
				if (daIsUMCdTRHbrJiVLfoghOrsGMVgb < hardwareJoystickMapCustomPlatformMap.elements.axes.Length)
				{
					yKsgfYrSAmjLmSCLxmzazyvdsCSH = hardwareJoystickMapCustomPlatformMap.elements.axes[daIsUMCdTRHbrJiVLfoghOrsGMVgb];
					UOKbddbdQLsrFmIGIaFJBNrbXurUB = 1;
					return true;
				}
				return false;
			...
			{
				kbIFwvKxUutVWitmmiglldmjxWbG kbIFwvKxUutVWitmmiglldmjxWbG2;
				if (UOKbddbdQLsrFmIGIaFJBNrbXurUB == -2 && YXpRjBPIKMZZJuXBKpuSeWGZtMmo == Environment.CurrentManagedThreadId)
				{
					UOKbddbdQLsrFmIGIaFJBNrbXurUB = 0;
					kbIFwvKxUutVWitmmiglldmjxWbG2 = this;
				}
				else
				{
					kbIFwvKxUutVWitmmiglldmjxWbG2 = new kbIFwvKxUutVWitmmiglldmjxWbG(0);
					kbIFwvKxUutVWitmmiglldmjxWbG2.wbMYvpHDcysszildIizPQbxfGPogA = wbMYvpHDcysszildIizPQbxfGPogA;
				}
				return kbIFwvKxUutVWitmmiglldmjxWbG2;
			}
		...
		private sealed class BYcdYbgpMdibjbZbEwvrMfiOGyzMb : IEnumerable<HardwareJoystickMap.Platform_Custom.Button>, IEnumerable, IEnumerator<HardwareJoystickMap.Platform_Custom.Button>, IEnumerator, IDisposable
		{
			private int NPGxaaFdEzavmWoGBQZAhFrOYrLx;

			private HardwareJoystickMap.Platform_Custom.Button JIoGjJsQIAERnPROLwpyWwYVbSPm;

			private int lygcxBQvsOUNiBeQkcLnHSasyhFQ;

			public HardwareJoystickMapCustomPlatformMap<TMatchingCriteria> uFZftoQVQzVXbDVUvSZjWYClkMLj;

			private int dUOhtHChgTdHCsOyoxeNROGDbnpEA;
			...
			HardwareJoystickMap.Platform_Custom.Button IEnumerator<HardwareJoystickMap.Platform_Custom.Button>.Current
			{
				...
				get
				{
					return JIoGjJsQIAERnPROLwpyWwYVbSPm;
				}
			}
			...
			[DebuggerHidden]
			public BYcdYbgpMdibjbZbEwvrMfiOGyzMb(int P_0)
			{
				NPGxaaFdEzavmWoGBQZAhFrOYrLx = P_0;
				lygcxBQvsOUNiBeQkcLnHSasyhFQ = Environment.CurrentManagedThreadId;
			}

			[DebuggerHidden]
			void IDisposable.Dispose()
			{
				NPGxaaFdEzavmWoGBQZAhFrOYrLx = -2;
			}

			private bool MoveNext()
			{
				int nPGxaaFdEzavmWoGBQZAhFrOYrLx = NPGxaaFdEzavmWoGBQZAhFrOYrLx;
				HardwareJoystickMapCustomPlatformMap<TMatchingCriteria> hardwareJoystickMapCustomPlatformMap = uFZftoQVQzVXbDVUvSZjWYClkMLj;
				switch (nPGxaaFdEzavmWoGBQZAhFrOYrLx)
				{
				default:
					return false;
				case 0:
					NPGxaaFdEzavmWoGBQZAhFrOYrLx = -1;
					if (hardwareJoystickMapCustomPlatformMap.elements == null || hardwareJoystickMapCustomPlatformMap.elements.buttons == null)
					{
						return false;
					}
					dUOhtHChgTdHCsOyoxeNROGDbnpEA = 0;
					break;
				case 1:
					NPGxaaFdEzavmWoGBQZAhFrOYrLx = -1;
					dUOhtHChgTdHCsOyoxeNROGDbnpEA++;
					break;
				}
				if (dUOhtHChgTdHCsOyoxeNROGDbnpEA < hardwareJoystickMapCustomPlatformMap.elements.buttons.Length)
				{
					JIoGjJsQIAERnPROLwpyWwYVbSPm = hardwareJoystickMapCustomPlatformMap.elements.buttons[dUOhtHChgTdHCsOyoxeNROGDbnpEA];
					NPGxaaFdEzavmWoGBQZAhFrOYrLx = 1;
					return true;
				}
				return false;
			...
			{
				BYcdYbgpMdibjbZbEwvrMfiOGyzMb bYcdYbgpMdibjbZbEwvrMfiOGyzMb;
				if (NPGxaaFdEzavmWoGBQZAhFrOYrLx == -2 && lygcxBQvsOUNiBeQkcLnHSasyhFQ == Environment.CurrentManagedThreadId)
				{
					NPGxaaFdEzavmWoGBQZAhFrOYrLx = 0;
					bYcdYbgpMdibjbZbEwvrMfiOGyzMb = this;
				}
				else
				{
					bYcdYbgpMdibjbZbEwvrMfiOGyzMb = new BYcdYbgpMdibjbZbEwvrMfiOGyzMb(0);
					bYcdYbgpMdibjbZbEwvrMfiOGyzMb.uFZftoQVQzVXbDVUvSZjWYClkMLj = uFZftoQVQzVXbDVUvSZjWYClkMLj;
				}
				return bYcdYbgpMdibjbZbEwvrMfiOGyzMb;
			}
		...
		[IteratorStateMachine(typeof(HardwareJoystickMapCustomPlatformMap<>.kbIFwvKxUutVWitmmiglldmjxWbG))]
		internal override IEnumerable<HardwareJoystickMap.Platform_Custom.Axis> IterateAxes()
		{
			return new kbIFwvKxUutVWitmmiglldmjxWbG(-2)
			{
				wbMYvpHDcysszildIizPQbxfGPogA = this
			};
		}

		[IteratorStateMachine(typeof(HardwareJoystickMapCustomPlatformMap<>.BYcdYbgpMdibjbZbEwvrMfiOGyzMb))]
		internal override IEnumerable<HardwareJoystickMap.Platform_Custom.Button> IterateButtons()
		{
			return new BYcdYbgpMdibjbZbEwvrMfiOGyzMb(-2)
			{
				uFZftoQVQzVXbDVUvSZjWYClkMLj = this
			};
		}
