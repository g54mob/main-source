...
namespace Novell.Directory.Ldap.Rfc2251
{
	public class RfcFilter : Asn1Choice
	{
		...
		private Asn1Tagged parseFilterComp()
		{
			...
			case 0:
			case 1:
				result = new Asn1Tagged(new Asn1Identifier(2, true, opOrAttr), parseFilterList(), false);
				break;
			case 2:
				result = new Asn1Tagged(new Asn1Identifier(2, true, opOrAttr), parseFilter(), true);
				break;
			default:
			{
				...
				case 6:
				case 8:
					result = new Asn1Tagged(new Asn1Identifier(2, true, filterType), new RfcAttributeValueAssertion(new RfcAttributeDescription(ft.Attr), new RfcAssertionValue(unescapeString(value))), false);
					break;
				case 3:
					if (value.Equals("*"))
					{
						result = new Asn1Tagged(new Asn1Identifier(2, false, 7), new RfcAttributeDescription(ft.Attr), false);
					}
					else if (value.IndexOf('*') != -1)
					{
						SupportClass.Tokenizer tokenizer2 = new SupportClass.Tokenizer(value, "*", true);
						...
						while (tokenizer2.HasMoreTokens())
						{
							...
							{
								asn1SequenceOf.add(new Asn1Tagged(new Asn1Identifier(2, false, 0), new RfcLdapString(unescapeString(text5)), false));
							}
							else if (num < count)
							{
								asn1SequenceOf.add(new Asn1Tagged(new Asn1Identifier(2, false, 1), new RfcLdapString(unescapeString(text5)), false));
							}
							else
							{
								asn1SequenceOf.add(new Asn1Tagged(new Asn1Identifier(2, false, 2), new RfcLdapString(unescapeString(text5)), false));
							}
							text4 = text5;
						}
						result = new Asn1Tagged(new Asn1Identifier(2, true, 4), new RfcSubstringFilter(new RfcAttributeDescription(ft.Attr), asn1SequenceOf), false);
					}
					else
					{
						result = new Asn1Tagged(new Asn1Identifier(2, true, 3), new RfcAttributeValueAssertion(new RfcAttributeDescription(ft.Attr), new RfcAssertionValue(unescapeString(value))), false);
					}
					break;
				case 9:
				{
					...
					result = new Asn1Tagged(new Asn1Identifier(2, true, 9), new RfcMatchingRuleAssertion((text2 == null) ? null : new RfcMatchingRuleId(text2), (text == null) ? null : new RfcAttributeDescription(text), new RfcAssertionValue(unescapeString(value)), (!flag) ? null : new Asn1Boolean(true)), false);
					break;
				}
				}
				break;
