...
namespace Novell.Directory.Ldap
{
	public class LdapCompareRequest : LdapMessage
	{
		public virtual string AttributeDescription
		{
			get
			{
				return ((RfcCompareRequest)Asn1Object.getRequest()).AttributeValueAssertion.AttributeDescription;
			}
		}
		...
		public virtual sbyte[] AssertionValue
		{
			get
			{
				return ((RfcCompareRequest)Asn1Object.getRequest()).AttributeValueAssertion.AssertionValue;
			}
		}
