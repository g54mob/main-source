...
namespace Novell.Directory.Ldap
{
	public class LdapModifyDNRequest : LdapMessage
	{
		...
		public virtual string NewRDN
		{
			get
			{
				return ((RfcRelativeLdapDN)((RfcModifyDNRequest)Asn1Object.getRequest()).toArray()[1]).stringValue();
			}
		}
		...
		public virtual bool DeleteOldRDN
		{
			get
			{
				return ((Asn1Boolean)((RfcModifyDNRequest)Asn1Object.getRequest()).toArray()[2]).booleanValue();
			}
		}
