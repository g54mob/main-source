	...
	public class LdapBackupResponse : LdapExtendedResponse
	{
			...
			: base(rfcMessage)
		{
			...
			if (ResultCode == 0)
			{
				...
				Asn1Integer obj = (Asn1Integer)lBERDecoder.decode(in_Renamed);
				if (obj == null)
				{
					throw new IOException("Decoding error");
				}
				num = obj.intValue();
				Asn1Integer obj2 = (Asn1Integer)lBERDecoder.decode(in_Renamed);
				if (obj2 == null)
				{
					throw new IOException("Decoding error");
				}
				...
				Asn1Sequence obj3 = (Asn1Sequence)lBERDecoder.decode(in_Renamed);
				if (obj3 == null)
				{
					throw new IOException("Decoding error");
				}
