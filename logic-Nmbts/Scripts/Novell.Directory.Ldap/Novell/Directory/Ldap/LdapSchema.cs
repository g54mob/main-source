...
namespace Novell.Directory.Ldap
{
	public class LdapSchema : LdapEntry
	{
		...
		public virtual IEnumerator AttributeSchemas
		{
			get
			{
				return new EnumeratedIterator(idTable[0].Values.GetEnumerator());
			}
		}
		...
		public virtual IEnumerator DITContentRuleSchemas
		{
			get
			{
				return new EnumeratedIterator(idTable[4].Values.GetEnumerator());
			}
		}
		...
		public virtual IEnumerator DITStructureRuleSchemas
		{
			get
			{
				return new EnumeratedIterator(idTable[5].Values.GetEnumerator());
			}
		}
		...
		public virtual IEnumerator MatchingRuleSchemas
		{
			get
			{
				return new EnumeratedIterator(idTable[6].Values.GetEnumerator());
			}
		}
		...
		public virtual IEnumerator MatchingRuleUseSchemas
		{
			get
			{
				return new EnumeratedIterator(idTable[7].Values.GetEnumerator());
			}
		}
		...
		public virtual IEnumerator NameFormSchemas
		{
			get
			{
				return new EnumeratedIterator(idTable[3].Values.GetEnumerator());
			}
		}
		...
		public virtual IEnumerator ObjectClassSchemas
		{
			get
			{
				return new EnumeratedIterator(idTable[1].Values.GetEnumerator());
			}
		}
		...
		public virtual IEnumerator SyntaxSchemas
		{
			get
			{
				return new EnumeratedIterator(idTable[2].Values.GetEnumerator());
			}
		}
		...
		public virtual IEnumerator AttributeNames
		{
			get
			{
				return new EnumeratedIterator(new SupportClass.SetSupport(nameTable[0].Keys).GetEnumerator());
			}
		}
		...
		public virtual IEnumerator DITContentRuleNames
		{
			get
			{
				return new EnumeratedIterator(new SupportClass.SetSupport(nameTable[4].Keys).GetEnumerator());
			}
		}
		...
		public virtual IEnumerator DITStructureRuleNames
		{
			get
			{
				return new EnumeratedIterator(new SupportClass.SetSupport(nameTable[5].Keys).GetEnumerator());
			}
		}
		...
		public virtual IEnumerator MatchingRuleNames
		{
			get
			{
				return new EnumeratedIterator(new SupportClass.SetSupport(nameTable[6].Keys).GetEnumerator());
			}
		}
		...
		public virtual IEnumerator MatchingRuleUseNames
		{
			get
			{
				return new EnumeratedIterator(new SupportClass.SetSupport(nameTable[7].Keys).GetEnumerator());
			}
		}
		...
		public virtual IEnumerator NameFormNames
		{
			get
			{
				return new EnumeratedIterator(new SupportClass.SetSupport(nameTable[3].Keys).GetEnumerator());
			}
		}
		...
		public virtual IEnumerator ObjectClassNames
		{
			get
			{
				return new EnumeratedIterator(new SupportClass.SetSupport(nameTable[1].Keys).GetEnumerator());
			}
		}
