		...
		protected override void DeserializeImplementation(ref T value, IDataReader reader)
		{
			...
			if (array3 != null)
			{
				...
				if ((object)obj2 != null)
				{
					...
					{
						reader.Context.Config.DebugContext.LogWarning("Could not cast recombined delegate of type " + obj2.GetType().GetNiceFullName() + " to expected delegate type " + typeof(T).GetNiceFullName() + ".");
						return;
					}
				}
				return;
