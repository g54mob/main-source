...
namespace I18N.CJK
{
	internal class GB18030Source
	{
		...
		{
			gbxBase = FromGBXRaw(129, 48, 129, 48, false);
			gbxSuppBase = FromGBXRaw(144, 48, 129, 48, false);
			ranges = new GB18030Map[14]
			{
				new GB18030Map(1106, 8207, FromGBXRaw(129, 48, 211, 48, false), FromGBXRaw(129, 54, 165, 49, false), false),
				new GB18030Map(9795, 11904, FromGBXRaw(129, 55, 168, 57, false), FromGBXRaw(129, 56, 253, 56, false), false),
				new GB18030Map(13851, 14615, FromGBXRaw(130, 48, 166, 51, false), FromGBXRaw(130, 48, 242, 55, false), false),
				new GB18030Map(15585, 16469, FromGBXRaw(130, 49, 212, 56, false), FromGBXRaw(130, 50, 175, 50, false), false),
				new GB18030Map(16736, 17206, FromGBXRaw(130, 50, 201, 55, false), FromGBXRaw(130, 50, 248, 55, false), false),
				new GB18030Map(17623, 17995, FromGBXRaw(130, 51, 163, 57, false), FromGBXRaw(130, 51, 201, 49, false), false),
				new GB18030Map(18318, 18758, FromGBXRaw(130, 51, 232, 56, false), FromGBXRaw(130, 52, 150, 56, false), false),
				new GB18030Map(18872, 19574, FromGBXRaw(130, 52, 161, 49, false), FromGBXRaw(130, 52, 231, 51, false), false),
				new GB18030Map(19968, 40869, 0L, 0L, true),
				new GB18030Map(40870, 55295, FromGBXRaw(130, 53, 143, 51, false), FromGBXRaw(131, 54, 199, 56, false), false),
				new GB18030Map(55296, 59243, 0L, 0L, true),
				new GB18030Map(59493, 63787, FromGBXRaw(131, 54, 208, 48, false), FromGBXRaw(132, 48, 133, 52, false), false),
				new GB18030Map(64042, 65071, FromGBXRaw(132, 48, 156, 56, false), FromGBXRaw(132, 49, 133, 55, false), false),
				new GB18030Map(65510, 65535, FromGBXRaw(132, 49, 162, 52, false), FromGBXRaw(132, 49, 164, 57, false), false)
			};
		...
		public static long FromGBX(byte[] bytes, int start)
		{
			...
			if (b >= 144)
			{
				return FromGBXRaw(b, b2, b3, b4, true);
			}
			long num = FromGBXRaw(b, b2, b3, b4, false);
			long num2 = 0L;
			long num3 = 0L;
			...
			throw new SystemException(string.Format("GB18030 INTERNAL ERROR (should not happen): GBX {0:x02} {1:x02} {2:x02} {3:x02}", b, b2, b3, b4));
		}
