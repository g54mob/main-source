...
{
	public class GarageLocationData : LocationData
	{
		public void Init(GarageLocationSetting settings, Random randomGenerator, GalaxyMapSector sector, EMissionDifficulty difficulty, EMissionComplexity complexity)
		{
