...
namespace I2.Loc
{
	public static class LocalizationManager
	{
		...
		public static void ApplyLocalizationParams(ref string translation, string key, string value)
		{
			ApplyLocalizationParams(ref translation, new Dictionary<string, string> { { key, value } });
		}

		public static void ApplyLocalizationParams(ref string translation, Dictionary<string, string> parameters, bool allowLocalizedParameters = true)
		{
