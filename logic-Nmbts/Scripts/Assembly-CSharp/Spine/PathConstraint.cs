		...
		public void Update()
		{
			...
			if (flag4 || flag2)
			{
				...
				while (num6 < num7)
				{
					...
					exposedList.Items[++num6] = (flag2 ? (length + num5) : num5) * num10 / length;
				}
			}
			else
			{
			...
			while (num14 < count)
			{
				...
				if (flag)
				{
					...
					float c = bone3.c;
					float d = bone3.d;
					float num22 = (flag3 ? array[num15 - 1] : ((!(exposedList.Items[num14 + 1] < 1E-05f)) ? MathUtils.Atan2(num19, num18) : array[num15 + 2]));
					...
					if (flag5)
					{
						...
						num11 += (length2 * (num23 * a - num24 * c) - num18) * num;
						num12 += (length2 * (num24 * a + num23 * c) - num19) * num;
					}
					else
					{
						num22 += num13;
