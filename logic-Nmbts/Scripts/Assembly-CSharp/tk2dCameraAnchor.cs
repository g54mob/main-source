...
public class tk2dCameraAnchor : MonoBehaviour
{
	...
	private void UpdateTransform()
	{
		...
		tk2dCamera tk2dCamera2 = ((AnchorTk2dCamera != null && AnchorTk2dCamera.CameraSettings.projection != tk2dCameraSettings.ProjectionType.Perspective) ? AnchorTk2dCamera : null);
		Rect rect = default(Rect);
		if (tk2dCamera2 != null)
		{
			rect = (anchorToNativeBounds ? tk2dCamera2.NativeScreenExtents : tk2dCamera2.ScreenExtents);
		...
		else if (myTransform.localPosition != vector2)
		{
