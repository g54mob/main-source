...
public class INIParser
{
				...
				while (flag)
				{
					...
					if (text2 != null || !flag)
					{
						if (value != null && value.Count > 0)
						{
							...
							{
								if (value.TryGetValue(key, out Value))
								{
					...
					else if (value != null && ParseKeyValuePair(text, ref Key, ref Value) && value.TryGetValue(Key, out Value))
					{
						flag3 = false;
						value.Remove(Key);
						stringWriter.Write(Key);
					...
					if (flag3)
					{
						...
						else if (value2 != null && ParseKeyValuePair(text, ref Key2, ref Value2))
						{
							flag2 = !value2.ContainsKey(Key2);
						}
					}
					if (flag3)
					{
	...
	public bool IsKeyExists(string SectionName, string Key)
	{
		if (m_Sections.ContainsKey(SectionName))
		{
			...
			m_Sections.TryGetValue(SectionName, out value);
	...
	public string ReadValue(string SectionName, string Key, string DefaultValue)
	{
		...
		{
			Dictionary<string, string> value;
			if (!m_Sections.TryGetValue(SectionName, out value))
			{
				return DefaultValue;
			}
			string value2;
	...
	{
		int result;
		if (int.TryParse(ReadValue(SectionName, Key, DefaultValue.ToString(CultureInfo.InvariantCulture)), out result))
		{
			return result != 0;
		}
		return DefaultValue;
	...
	{
		int result;
		if (int.TryParse(ReadValue(SectionName, Key, DefaultValue.ToString(CultureInfo.InvariantCulture)), NumberStyles.Any, CultureInfo.InvariantCulture, out result))
		{
			return result;
		}
		return DefaultValue;
	...
	{
		long result;
		if (long.TryParse(ReadValue(SectionName, Key, DefaultValue.ToString(CultureInfo.InvariantCulture)), NumberStyles.Any, CultureInfo.InvariantCulture, out result))
		{
			return result;
		}
		return DefaultValue;
	...
	{
		double result;
		if (double.TryParse(ReadValue(SectionName, Key, DefaultValue.ToString(CultureInfo.InvariantCulture)), NumberStyles.Any, CultureInfo.InvariantCulture, out result))
		{
			return result;
		}
		return DefaultValue;
	...
	{
		float result;
		if (float.TryParse(ReadValue(SectionName, Key, DefaultValue.ToString(CultureInfo.InvariantCulture)), NumberStyles.Any, CultureInfo.InvariantCulture, out result))
		{
			return result;
		}
		return DefaultValue;
	...
	{
		DateTime result;
		if (DateTime.TryParse(ReadValue(SectionName, Key, DefaultValue.ToString(CultureInfo.InvariantCulture)), CultureInfo.InvariantCulture, DateTimeStyles.AllowWhiteSpaces | DateTimeStyles.NoCurrentDateDefault | DateTimeStyles.AssumeLocal, out result))
		{
			return result;
		}
		return DefaultValue;
