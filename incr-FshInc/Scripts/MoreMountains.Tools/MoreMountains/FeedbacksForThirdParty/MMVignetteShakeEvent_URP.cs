...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMVignetteShakeEvent_URP
	{
		...
		{
			MMVignetteShakeEvent_URP.OnEvent = null;
		}
		...
		{
			MMVignetteShakeEvent_URP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore, interpolateColor, colorCurve, remapColorZero, remapColorOne, targetColor);
		}
	}
}
