...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMChromaticAberrationShakeEvent
	{
		...
		{
			MMChromaticAberrationShakeEvent.OnEvent = null;
		}
		...
		{
			MMChromaticAberrationShakeEvent.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, feedbacksIntensity, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
