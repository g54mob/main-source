...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMVolumeBlendShakeEvent_URP
	{
		...
		{
			MMVolumeBlendShakeEvent_URP.OnEvent = null;
		}
		...
		{
			MMVolumeBlendShakeEvent_URP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
