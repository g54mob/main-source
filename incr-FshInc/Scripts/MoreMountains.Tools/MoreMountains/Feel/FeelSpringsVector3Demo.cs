...
namespace MoreMountains.Feel
{
	...
	public class FeelSpringsVector3Demo : MonoBehaviour
	{
		...
		{
			float value = BumpAmountSlider.value;
			SpringX.BumpRandom(0f - value, value);
			SpringY.BumpRandom(0f - value, value);
			SpringZ.BumpRandom(0f - value, value);
		}
		...
		protected virtual void Update()
		{
			...
			_newPosition.x = MMMaths.Remap(SpringX.CurrentValue, -1f, 1f, 0f - _range, _range);
			_newPosition.y = MMMaths.Remap(SpringY.CurrentValue, -1f, 1f, 0f - _range, _range) + 1f;
			_newPosition.z = MMMaths.Remap(SpringZ.CurrentValue, -1f, 1f, 0f - _range, _range);
