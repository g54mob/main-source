...
namespace MoreMountains.Feedbacks
{
	...
	public class MMAudioFilterEchoShaker : MMShaker
	{
		...
		{
			base.Initialization();
			_targetAudioEchoFilter = base.gameObject.GetComponent<AudioEchoFilter>();
		}
		...
		{
			float wetMix = ShakeFloat(ShakeEcho, RemapEchoZero, RemapEchoOne, RelativeEcho, _initialEcho);
			_targetAudioEchoFilter.wetMix = wetMix;
		}
