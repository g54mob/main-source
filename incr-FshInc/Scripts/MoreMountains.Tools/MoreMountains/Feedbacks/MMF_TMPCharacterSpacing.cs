...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_TMPCharacterSpacing : MMF_FeedbackBase
	{
		...
		public MMTweenType CharacterSpacingCurve = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f)), "", "");
		...
		protected override void FillTargets()
		{
			if (!(TargetTMPText == null))
			{
				...
				mMPropertyReceiver.TargetPropertyName = "characterSpacing";
				mMPropertyReceiver.RelativeValue = RelativeValues;
				mMF_FeedbackBaseTarget.Target = mMPropertyReceiver;
				mMF_FeedbackBaseTarget.LevelCurve = CharacterSpacingCurve;
				mMF_FeedbackBaseTarget.RemapLevelZero = RemapZero;
				mMF_FeedbackBaseTarget.RemapLevelOne = RemapOne;
				mMF_FeedbackBaseTarget.InstantLevel = InstantSpacing;
				mMF_FeedbackBaseTarget.ToDestinationLevel = DestinationSpacing;
