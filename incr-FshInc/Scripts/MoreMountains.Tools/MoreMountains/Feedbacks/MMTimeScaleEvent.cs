...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMTimeScaleEvent
	{
		...
		{
			MMTimeScaleEvent.OnEvent?.Invoke(timeScaleMethod, timeScale, duration, lerp, lerpSpeed, infinite, timeScaleLerpMode, timeScaleLerpCurve, timeScaleLerpDuration, timeScaleLerpOnUnfreeze, timeScaleLerpCurveOnUnfreeze, timeScaleLerpDurationOnUnfreeze);
		}

		public static void Unfreeze()
		{
			MMTimeScaleEvent.OnEvent?.Invoke(MMTimeScaleMethods.Unfreeze, 0f, 0f, lerp: false, 0f, infinite: false);
		}

		public static void Reset()
		{
			MMTimeScaleEvent.OnEvent?.Invoke(MMTimeScaleMethods.Reset, 0f, 0f, lerp: false, 0f, infinite: false);
		}
	}
}
