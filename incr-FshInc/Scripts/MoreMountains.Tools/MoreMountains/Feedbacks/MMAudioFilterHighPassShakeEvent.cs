...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMAudioFilterHighPassShakeEvent
	{
		...
		{
			MMAudioFilterHighPassShakeEvent.OnEvent?.Invoke(highPassCurve, duration, remapMin, remapMax, relativeHighPass, feedbacksIntensity, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
