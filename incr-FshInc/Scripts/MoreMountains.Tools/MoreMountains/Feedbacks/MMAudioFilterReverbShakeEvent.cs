...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMAudioFilterReverbShakeEvent
	{
		...
		{
			MMAudioFilterReverbShakeEvent.OnEvent?.Invoke(reverbCurve, duration, remapMin, remapMax, relativeReverb, feedbacksIntensity, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
