...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMAudioFilterEchoShakeEvent
	{
		...
		{
			MMAudioFilterEchoShakeEvent.OnEvent = null;
		}
		...
		{
			MMAudioFilterEchoShakeEvent.OnEvent?.Invoke(echoCurve, duration, remapMin, remapMax, relativeEcho, feedbacksIntensity, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
