...
namespace Lofelt.NiceVibrations
{
	...
	public class MMTouchButton : MonoBehaviour, IPointerDownHandler, IEventSystemHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler, ISubmitHandler
	{
		...
		protected virtual void Update()
		{
			...
			if (_image != null && PressedChangeColor && Time.unscaledTime - _lastStateChangeAt < LerpColorDuration)
			{
		...
		{
			if (!(Time.unscaledTime - _lastClickTimestamp < BufferDuration) && CurrentState == ButtonStates.Off)
			{
