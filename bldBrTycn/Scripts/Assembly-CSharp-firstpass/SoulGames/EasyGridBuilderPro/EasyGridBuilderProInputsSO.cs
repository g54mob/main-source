...
{
	[CreateAssetMenu(menuName = "SoulGames/Easy Grid Builder Pro/EasyGridBuilderProInputsSO", order = 100)]
	public class EasyGridBuilderProInputsSO : ScriptableObject
	{
		[Space]
		...
		public bool useBuildModeActivationKey;
		...
		public bool useSelectionModeActivationKey;
