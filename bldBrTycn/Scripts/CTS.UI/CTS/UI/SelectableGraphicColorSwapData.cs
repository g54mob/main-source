...
namespace CTS.UI
{
	[CreateAssetMenu(menuName = "CTS/UI/Button Swapper (Graphic Color)")]
	public class SelectableGraphicColorSwapData : SelectableSwapData<Graphic>
	{
		[SerializeField]
		...
		{
			obj.color = selectionState switch
			{
