...
namespace Pathfinding
{
	...
	{
		public delegate int Calculate_000004C2_0024PostfixBurstDelegate(in HeuristicObjective objective, ref int3 point, uint nodeIndex);

		internal static class Calculate_000004C2_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Calculate_000004C2_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static Calculate_000004C2_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		{
			return Calculate_000004C2_0024BurstDirectCall.Invoke(in objective, ref point, nodeIndex);
		}
