	...
	internal static class MeshUtility
	{
		...
		public struct JobRemoveDuplicateVertices : IJob
		{
			...
			public unsafe void Execute()
			{
				...
				outputTags->Reset();
				NativeParallelHashMap<Int3, int> nativeParallelHashMap = new NativeParallelHashMap<Int3, int>(vertices.Length, Allocator.Temp);
				...
				{
					if (nativeParallelHashMap.TryAdd(vertices[i], num2))
					{
						nativeArray[i] = num2;
					...
					{
						nativeArray[i] = nativeParallelHashMap[vertices[i]];
					}
				}
				int num3 = 0;
				int num4 = 0;
		...
		public delegate void MakeTrianglesClockwise_00000E33_0024PostfixBurstDelegate(ref UnsafeSpan<Int3> vertices, ref UnsafeSpan<int> triangles);

		internal static class MakeTrianglesClockwise_00000E33_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(MakeTrianglesClockwise_00000E33_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static MakeTrianglesClockwise_00000E33_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		{
			MakeTrianglesClockwise_00000E33_0024BurstDirectCall.Invoke(ref vertices, ref triangles);
		}
