...
namespace Febucci.UI.Core
{
	...
	public abstract class TAnimCore : MonoBehaviour
	{
		...
		public void SetVisibilityChar(int index, bool isVisible, bool canPlayEffects = true)
		{
			...
			else if (characters[index].info.disappearancesMaxDuration > characters[index].passedTime && characters[index].passedTime >= characters[index].info.appearancesMaxDuration)
			{
			...
			if (!canPlayEffects)
			{
				...
				{
					characters[index].passedTime = 0f;
				}
			}
		}
