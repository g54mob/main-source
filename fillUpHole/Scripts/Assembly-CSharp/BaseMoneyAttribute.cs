...
public class BaseMoneyAttribute : BaseSavableAttribute
{
	public BaseMoneyAttribute(string name, Func<int> getCost, Func<bool> canHave)
	{
		_name = name;
	...
	public bool TryToEnable()
	{
		...
		GameController.Instance.GainMoney(-GetCost());
		_level = 1;
		return true;
	}
