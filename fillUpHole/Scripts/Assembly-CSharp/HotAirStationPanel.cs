...
public class HotAirStationPanel : BaseBuildingPanel
{
	...
	private void Start()
	{
		Title.Initialize(base.gameObject, "Hangar");
		...
		Title.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Hangar", "Lvl " + Building.GetLevel() + "/10", GetTooltip(Building), ""));
