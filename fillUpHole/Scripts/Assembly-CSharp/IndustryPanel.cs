...
public class IndustryPanel : BaseBuildingPanel
{
	...
	private void Start()
	{
		Title.Initialize(base.gameObject, "Factory");
		...
		Title.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Factory", "Lvl " + Building.GetLevel() + "/10", GetTooltip(Building), ""));
