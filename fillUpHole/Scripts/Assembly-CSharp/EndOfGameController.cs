...
public class EndOfGameController : MonoBehaviour
{
	...
	private void Start()
	{
		...
		TotalGarbageText.text = Stats_TotalGarbageCreated.ToNumber() + " Trash";
		TotalMoneyText.text = Stats_TotalMoney.ToNumber() + " $";
		TotalRPText.text = Stats_TotalRP.ToNumber() + " RP";
		TotalYellowText.text = Stats_TotalYellow.ToNumber() + " Y.S.";
		TotalBlueText.text = Stats_TotalBlue.ToNumber() + " B.S.";
		TotalRedText.text = Stats_TotalRed.ToNumber() + " R.S.";
		TotalBookText.text = Stats_TotalBook.ToNumber() + " Books";
		Peon1.IgnoreBubble();
		Peon2.IgnoreBubble();
