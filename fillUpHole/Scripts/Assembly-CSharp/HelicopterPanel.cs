...
public class HelicopterPanel : BaseBuildingPanel
{
	...
	private void Start()
	{
		Title.Initialize(base.gameObject, "Helipad");
		...
		Title.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update("Helipad", "Lvl " + Building.GetLevel() + "/10", GetTooltip(Building), ""));
