...
namespace Rewired.Libraries.SharpDX.DirectInput
{
	...
	internal struct DeviceObjectId
	{
		...
		public gxhgVrOliVamAhmjXjgnPKfDmZY Flags
		{
			get
			{
				return (gxhgVrOliVamAhmjXjgnPKfDmZY)(_rawType & -16776961);
			}
		}
		...
		public DeviceObjectId(gxhgVrOliVamAhmjXjgnPKfDmZY typeFlags, int instanceNumber)
		{
			this = default(DeviceObjectId);
			_rawType = (int)(typeFlags & ~gxhgVrOliVamAhmjXjgnPKfDmZY.uAaFAQaCLLytDjyXGmNFDnPtZoM) | ((!(instanceNumber < 0 || instanceNumber > 65534)) ? ((instanceNumber & 0xFFFF) << 8) : 0);
		}
		...
		public override bool Equals(object obj)
		{
			...
			if ((object)obj.GetType() != typeof(DeviceObjectId))
			{
				return false;
			}
