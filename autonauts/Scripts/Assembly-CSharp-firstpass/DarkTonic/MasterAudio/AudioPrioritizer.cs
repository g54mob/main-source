	...
	public static class AudioPrioritizer
	{
		...
		public static void Set3DPriority(SoundGroupVariation variation, bool useClipAgePriority)
		{
			...
			case AudioRolloffMode.Logarithmic:
				num2 = varAudio.volume / Mathf.Max(varAudio.minDistance, num - varAudio.minDistance);
				break;
			case AudioRolloffMode.Linear:
				num2 = Mathf.Lerp(varAudio.volume, 0f, Mathf.Max(0f, num - varAudio.minDistance) / (varAudio.maxDistance - varAudio.minDistance));
				break;
			default:
				num2 = Mathf.Lerp(varAudio.volume, 0f, Mathf.Max(0f, num - varAudio.minDistance) / (varAudio.maxDistance - varAudio.minDistance));
				break;
