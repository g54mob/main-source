...
public class ToyMod : Toy
{
	public override void Restart()
	{
		...
		Vector3 Rot;
		if (ModManager.Instance.ModToyClass.GetModelRotation(m_TypeIdentifier, out Rot))
		{
			m_ModelRoot.transform.localRotation = Quaternion.Euler(Rot.x, Rot.y, Rot.z);
		}
		Vector3 Trans;
		if (ModManager.Instance.ModToyClass.GetModelTranslation(m_TypeIdentifier, out Trans))
		{
