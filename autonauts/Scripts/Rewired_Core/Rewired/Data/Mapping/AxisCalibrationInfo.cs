...
namespace Rewired.Data.Mapping
{
	...
	public class AxisCalibrationInfo : IDeepCloneable
	{
		...
		internal static AxisCalibrationData uPlFhnexdOBTVzVjwVqpiuBIXqE(AxisCalibrationInfo P_0)
		{
			if (P_0 == null)
			{
		...
		internal static AxisCalibrationInfo evMoibFVbyhNUKCcQxvEfTTeRgY(AxisCalibrationData P_0)
		{
