...
namespace Sirenix.Serialization
{
	public static class UnitySerializationUtility
	{
		...
		public static void CopyFromTo(UnityEngine.Object from, UnityEngine.Object to)
		{
			byte[] bytes = null;
			List<UnityEngine.Object> referencedUnityObjects = null;
			SerializeUnityObject(from, ref bytes, ref referencedUnityObjects, DataFormat.Binary, serializeUnityFields: true);
			DeserializeUnityObject(to, ref bytes, ref referencedUnityObjects, DataFormat.Binary);
		}
