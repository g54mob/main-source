...
namespace MonoMod.Utils
{
	public static class PlatformHelper
	{
		...
		private static void DeterminePlatform()
		{
			...
			if (!string.IsNullOrEmpty(environmentVariable) && MultiTargetShims.Contains(environmentVariable, "\\", StringComparison.Ordinal) && Directory.Exists(environmentVariable))
			{
