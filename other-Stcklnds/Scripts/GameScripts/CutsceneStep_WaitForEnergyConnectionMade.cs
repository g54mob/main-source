...
public class CutsceneStep_WaitForEnergyConnectionMade : CutsceneStep
{
	public override IEnumerator Process()
	{
		...
		while (cards.All((GameCard x) => x.CardConnectorChildren.Count((CardConnector cardConnector) => cardConnector.ConnectedNode != null && (cardConnector.ConnectionType == ConnectionType.LV || cardConnector.ConnectionType == ConnectionType.HV)) <= 0) && !WorldManager.instance.ContinueClicked)
		{
			yield return null;
