...
public static class AllQuests
{
	...
	{
		OnSpecialAction = (string action) => action == "cities_cable_connected" && WorldManager.instance.GetAllCardsOnBoard(WorldManager.instance.CurrentBoard.Id).Sum((GameCard x) => x.CardConnectorChildren.Count((CardConnector cardConnector) => cardConnector.ConnectionType == ConnectionType.Transport && cardConnector.ConnectedNode != null)) >= 1,
		QuestGroup = QuestGroup.Cities_Automation
	};

	public static Quest CitiesConnectTransport5 = new Quest("cities_transport_5")
	{
		OnSpecialAction = (string action) => action == "cities_cable_connected" && WorldManager.instance.GetAllCardsOnBoard(WorldManager.instance.CurrentBoard.Id).Sum((GameCard x) => x.CardConnectorChildren.Count((CardConnector cardConnector) => cardConnector.ConnectionType == ConnectionType.Transport && cardConnector.CardDirection == CardDirection.input && cardConnector.ConnectedNode != null)) >= 5,
		QuestGroup = QuestGroup.Cities_Automation
	};
	...
	{
		OnSpecialAction = (string action) => action == "cities_cable_connected" && WorldManager.instance.GetAllCardsOnBoard(WorldManager.instance.CurrentBoard.Id).Sum((GameCard x) => x.CardConnectorChildren.Count((CardConnector cardConnector) => (cardConnector.ConnectionType == ConnectionType.LV || cardConnector.ConnectionType == ConnectionType.HV) && cardConnector.ConnectedNode != null)) >= 1,
	...
	{
		OnSpecialAction = (string action) => action == "cities_cable_connected" && WorldManager.instance.GetAllCardsOnBoard(WorldManager.instance.CurrentBoard.Id).Sum((GameCard x) => x.CardConnectorChildren.Count((CardConnector cardConnector) => cardConnector.ConnectionType == ConnectionType.LV && cardConnector.CardDirection == CardDirection.input && cardConnector.ConnectedNode != null)) >= 5,
		QuestGroup = QuestGroup.Cities_Power
	};

	public static Quest Cities10LowPower = new Quest("cities_10_low_power")
	{
		OnSpecialAction = (string action) => action == "cities_cable_connected" && WorldManager.instance.GetAllCardsOnBoard(WorldManager.instance.CurrentBoard.Id).Sum((GameCard x) => x.CardConnectorChildren.Count((CardConnector cardConnector) => cardConnector.ConnectionType == ConnectionType.LV && cardConnector.CardDirection == CardDirection.input && cardConnector.ConnectedNode != null)) >= 10,
		QuestGroup = QuestGroup.Cities_Power
	};
	...
	{
		OnSpecialAction = (string action) => action == "cities_cable_connected" && WorldManager.instance.GetAllCardsOnBoard(WorldManager.instance.CurrentBoard.Id).Any((GameCard x) => x.CardConnectorChildren.Any((CardConnector cardConnector) => cardConnector.ConnectionType == ConnectionType.HV && cardConnector.ConnectedNode != null)),
		QuestGroup = QuestGroup.Cities_Power
	};

	public static Quest Cities10HighPower = new Quest("cities_5_high_power")
	{
		OnSpecialAction = (string action) => action == "cities_cable_connected" && WorldManager.instance.GetAllCardsOnBoard(WorldManager.instance.CurrentBoard.Id).Sum((GameCard x) => x.CardConnectorChildren.Count((CardConnector cardConnector) => cardConnector.ConnectionType == ConnectionType.HV && cardConnector.CardDirection == CardDirection.input && cardConnector.ConnectedNode != null)) >= 5,
		QuestGroup = QuestGroup.Cities_Power
	};
	...
	public static Quest CitiesGreenEnergy = new Quest("cities_green_energy")
	{
		OnSpecialAction = delegate(string action)
		{
			...
			return action == "cities_cable_connected" && WorldManager.instance.GetAllCardsOnBoard(WorldManager.instance.CurrentBoard.Id).Sum((GameCard x) => x.CardConnectorChildren.Count((CardConnector cardConnector) => (cardConnector.ConnectionType == ConnectionType.LV || cardConnector.ConnectionType == ConnectionType.HV) && cardConnector.ConnectedNode != null && greenConnectors.Contains(cardConnector.ConnectedNode.Parent.CardData.Id))) >= 10;
		},
		QuestGroup = QuestGroup.Cities_Misc
	};
}
