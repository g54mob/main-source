internal class gHzTXrHeAIfAVbOoWkioRiCWOPvBA
{
	public static class YxspqRPDrcFPyODxiaSjDtggbtBEA
	{
		public enum OCmuIeJoiJSELrXhXVchlHhmjtqv : ushort
		{
			Undefined = 0,
			Pointer = 1,
			Mouse = 2,
		...
		public static bool RDtXrISfYYhyVInwBVrnGcRLJZYd(ushort P_0)
		{
			return false;
		}

		public static bool dBYLKLzeAgTPbQJoyahQmRiZDiRl(ushort P_0)
		{
			return false;
		}

		public static bool ecBRzdAEsNvyCRuINaatdrenLaZH(ushort P_0)
		{
			return false;
		}
	}

	public static class QBJDUDfvocVQsKtWpPdiUFKMCpmo
	{
		public enum uPhtyFJyXjnDOXbbqAhXKtYKimKi : ushort
		{
			Aileron = 176,
			AileronTrim = 177,
		...
		public static bool hfWqSblTHafvjpenvxmVMxvLJkiK(ushort P_0)
		{
			return false;
		}

		public static bool DWCbXfHeUzXLUXkPeebsYUIGHfOO(ushort P_0)
		{
			return false;
		}
	}

	public static class tHfvJZNPOySQQnTSMrMSFTPaNSlg
	{
		public enum lDZKiTsMWKPQkXezabcqTSWjfHkaA : ushort
		{
			ConsumerControl = 1,
			NumericKeyPad = 2,
		...
		public static bool NoIodPfDuZEmpjdPCRpcpcaPWiUk(ushort P_0)
		{
			return false;
		}

		public static bool xDUzPDumQCpfKiONBFzmwXOmgmiaA(ushort P_0)
		{
			return false;
		}
	}

	public static class CIDgdqcaqpHCgEFcRitQqSaIfbkI
	{
		public enum sEoiHvmWXWwxzgTLAOopnwtjUZBN : ushort
		{
			_3DGameController = 1,
			PinballDevice = 2,
			GunDevice = 3,
		...
		public static bool OTSUIwBqZkSJZSQjRkCtPyzLCGIv(ushort P_0)
		{
			return false;
		}

		public static bool lAcbehEZImJTrBKBzOOgHTBFhmpBc(ushort P_0)
		{
			return false;
		}
	}

	public const ushort VxXdfAjdgSzwDpZIoUqfYKWcVgRi = 1;

	public const ushort wWrEUUdLWUPevwMmbrPNYeOMPWpc = 2;

	public const ushort YjwVleFJpddLOIHLGySSZIqtPuQK = 5;

	public const ushort DDiAzhyixCeFPBNZQSpneMYBFKABA = 9;

	public const ushort qLpFjQIUogxVpzKlEseTYZYNZJKE = 12;

	public static bool CwTFEfmgRVFhfgodaLKGMUecrOPkA(ushort P_0, ushort P_1)
	{
		return false;
	}

	public static bool DqraUEAfANFKIHveaGZLGXLBLIKde(ushort P_0, ushort P_1)
	{
		return false;
	}

	public static bool NayoxTGgFMieyWrBmpVRtByhUnVX(ushort P_0, ushort P_1)
	{
		return false;
	}

	public static bool mmPahVneNVRDxDTixDuqdMzLJLDy(ushort P_0)
	{
		return false;
	}

	public static bool HOGfiCIOLMFPTihSeAphnIjRxFoJA(ushort P_0)
	{
		return false;
	}

	public static bool blYRFVCAbiljgbDsZpHpKSdWQXIm(ushort P_0)
	{
		return false;
	}

	public static bool lIcFlCAcrpRcjtAJSJCLbuLgIOMo(ushort P_0, ushort P_1)
	{
		return false;
	}
}
