...
namespace Rewired
{
	...
	public sealed class InputBehavior
	{
		...
		internal void DboPLWXhkoNktVNooZrJbVrFpujC(SerializedObject P_0)
		{
		}

		private static void eoZuanvKUcoQGfINSVqOmOjWORvs(InputBehavior P_0, InputBehavior P_1, bool P_2)
		{
		}
	}
}
