...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class NcoItSJQEOPxcOrwnCSdEquNiegt : IControllerExtensionSource
		{
			public readonly ISteamControllerInternal FFsEQMjYHUluUhiskBKjDqABehLT;

			public NcoItSJQEOPxcOrwnCSdEquNiegt(ISteamControllerInternal P_0)
			{
			}
		}

		private NcoItSJQEOPxcOrwnCSdEquNiegt xTBWLcMzSiuAlxEdkFLQdMhyeeFab;
