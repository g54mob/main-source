...
namespace Rewired
{
	...
	{
		private enum PUezliGykPuAiJZIHdJAMvZbRHrE
		{
			Error = 0,
			FoundIndex = 1,
			IsWholeElement = 2
		...
		private readonly DeviceLocalizationInfo WulVOTHhNGQKnjKKigArzHlzpkVs;
		...
		private int AbtnbLWFSvRffIQfUegbWAGxFJIW(ControllerElementIdentifier[] P_0, int P_1)
		{
			return 0;
		}

		private static PUezliGykPuAiJZIHdJAMvZbRHrE yaShXCAKcdcuEHXoApShoGzoeDNF(HardwareJoystickMap.CompoundElement P_0, ControllerElementIdentifier P_1, IList<ActionElementMap> P_2, out int P_3)
		{
			P_3 = default(int);
			return default(PUezliGykPuAiJZIHdJAMvZbRHrE);
		}
	}
}
