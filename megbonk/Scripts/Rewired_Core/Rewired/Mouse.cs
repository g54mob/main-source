...
namespace Rewired
{
	...
	{
		private TimerAbs NSJtCpJpmoWOkZdYSNscxmfmmXri;

		private float[] ugVDtZOcyAWhPZawZcFrbdNMdjkBA;

		private Vector2 kecCOiFPqamgNlnMkVMGjqjMCzcoA;

		private Vector2 aQEMmtwJyWlJybYRrzwuUFvSVjlf;

		private int KWJZgPBtwXRZHrhUKjnUKOHILVcT;

		private readonly IUnifiedMouseSource BFlDSqbfPhELnikreWPnFJUqhFXgc;

		private static Guid okeBOiuhcKeDQTvcItgKwtcsixLo;
