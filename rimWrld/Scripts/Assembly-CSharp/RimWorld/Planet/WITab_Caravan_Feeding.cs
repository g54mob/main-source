...
namespace RimWorld.Planet
{
	public class WITab_Caravan_Feeding : WITab
	{
		...
		public override bool IsVisible => Pawns.Any((Pawn pawn) => ChildcareUtility.CanSuckle(pawn, out var _));
		...
		protected override void FillTab()
		{
			...
			RectDivider scrollViewRect = divider.CreateViewRect(Pawns.Count((Pawn pawn) => ChildcareUtility.CanSuckle(pawn, out var _)), 34f);
