...
namespace RLD
{
	...
	public class GizmoCap3DLookAndFeel
	{
		...
		[SerializeField]
		private float _trPrismWidth = 1f;

		[SerializeField]
		private float _trPrismHeight = 1f;

		[SerializeField]
		private float _trPrismDepth = 1f;
		...
		public float ConeHeight
		{
			...
			set
			{
				_coneHeight = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float ConeRadius
		{
			...
			set
			{
				_coneRadius = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float PyramidHeight
		{
			...
			set
			{
				_pyramidHeight = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float PyramidWidth
		{
			...
			set
			{
				_pyramidWidth = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float PyramidDepth
		{
			get
			{
				return _pyramidDepth;
			}
			set
			{
				_pyramidDepth = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float BoxWidth
		{
			...
			set
			{
				_boxWidth = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float BoxHeight
		{
			...
			set
			{
				_boxHeight = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float BoxDepth
		{
			...
			set
			{
				_boxDepth = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float SphereRadius
		{
			...
			set
			{
				_sphereRadius = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float TrPrismWidth
		{
			get
			{
				return _trPrismWidth;
			}
			set
			{
				_trPrismWidth = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float TrPrismHeight
		{
			get
			{
				return _trPrismHeight;
			}
			set
			{
				_trPrismHeight = Mathf.Max(1E-05f, value);
			}
		}
		...
		public float TrPrismDepth
		{
			get
			{
				return _trPrismDepth;
			}
			set
			{
				_trPrismDepth = Mathf.Max(1E-05f, value);
			}
		}
		...
		public bool IsSphereBorderVisible
		{
			get
			{
				return _isSphereBorderVisible;
			}
			set
			{
				_isSphereBorderVisible = value;
			}
		}
		...
		public Color SphereBorderColor
		{
			get
			{
				return _sphereBorderColor;
			}
			set
			{
				_sphereBorderColor = value;
			}
		}
		...
		public int NumSphereBorderPoints
		{
			get
			{
				return _numSphereBorderPoints;
			}
			set
			{
				_numSphereBorderPoints = Mathf.Max(3, value);
			}
		}
