...
namespace RLD
{
	public class CircleShape3D : Shape3D
	{
		...
		{
			Graphics.DrawMeshNow(Singleton<MeshPool>.Get.UnitCircleXY, Matrix4x4.TRS(_center, _rotation, Vector3Ex.FromValue(_radius)));
		}

		public override void RenderWire()
		{
			Graphics.DrawMeshNow(Singleton<MeshPool>.Get.UnitWireCircleXY, Matrix4x4.TRS(_center, _rotation, Vector3Ex.FromValue(_radius)));
		}
