...
namespace RLD
{
	...
	{
		[SerializeField]
		private float _areaHoverEps = 1E-05f;

		[SerializeField]
		private float _extrudeHoverEps = 1E-05f;
		...
		[SerializeField]
		private float _offsetSnapStepRight = 1f;

		[SerializeField]
		private float _offsetSnapStepUp = 1f;
		...
		public float AreaHoverEps
		{
			get
			{
				return _areaHoverEps;
			}
			set
			{
				_areaHoverEps = Mathf.Max(0f, value);
			}
		}
		...
		public float ExtrudeHoverEps
		{
			get
			{
				return _extrudeHoverEps;
			}
			set
			{
				_extrudeHoverEps = Mathf.Max(0f, value);
			}
		}
		...
		public float BorderLineHoverEps
		{
			get
			{
				return _borderLineHoverEps;
			}
			set
			{
				_borderLineHoverEps = Mathf.Max(0f, value);
			}
		}
		...
		public float BorderBoxHoverEps
		{
			get
			{
				return _borderBoxHoverEps;
			}
			set
			{
				_borderBoxHoverEps = Mathf.Max(0f, value);
			}
		}
		...
		public float BorderTorusHoverEps
		{
			get
			{
				return _borderTorusHoverEps;
			}
			set
			{
				_borderTorusHoverEps = Mathf.Max(0f, value);
			}
		}
		...
		public bool IsCircleHoverCullEnabled
		{
			get
			{
				return _isCircleHoverCullEnabled;
			}
			set
			{
				_isCircleHoverCullEnabled = value;
			}
		}
		...
		public float OffsetSnapStepRight
		{
			get
			{
				return _offsetSnapStepRight;
			}
			set
			{
				_offsetSnapStepRight = Mathf.Max(0.0001f, value);
			}
		}
		...
		public float OffsetSnapStepUp
		{
			get
			{
				return _offsetSnapStepUp;
			}
			set
			{
				_offsetSnapStepUp = Mathf.Max(0.0001f, value);
			}
		}
		...
		public float ScaleSnapStepRight
		{
			get
			{
				return _scaleSnapStepRight;
			}
			set
			{
				_scaleSnapStepRight = Mathf.Max(0.0001f, value);
			}
		}
		...
		public float ScaleSnapStepUp
		{
			get
			{
				return _scaleSnapStepUp;
			}
			set
			{
				_scaleSnapStepUp = Mathf.Max(0.0001f, value);
			}
		}
		...
		public float ProportionalScaleSnapStep
		{
			get
			{
				return _proportionalScaleSnapStep;
			}
			set
			{
				_proportionalScaleSnapStep = Mathf.Max(0.0001f, value);
			}
		}
