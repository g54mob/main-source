	...
	public class ShaderPool : Singleton<ShaderPool>
	{
		...
		public Shader LinearGradientCameraBk
		{
			get
			{
				...
				{
					_linearGradientCameraBk = Shader.Find("RTUnityApp/LinearGradientCameraBk");
				}
		...
		public Shader XZGrid_Plane
		{
			get
			{
				...
				{
					_xzGrid_Plane = Shader.Find("RTUnityApp/XZGrid_Plane");
				}
		...
		public Shader GizmoSolidHandle
		{
			get
			{
				...
				{
					_gizmoSolidHandle = Shader.Find("RTUnityApp/GizmoSolidHandle");
				}
		...
		public Shader TintedTexture
		{
			get
			{
				...
				{
					_tintedTexture = Shader.Find("RTUnityApp/TintedTexture");
				}
		...
		public Shader SimpleColor
		{
			get
			{
				...
				{
					_simpleColor = Shader.Find("RTUnityApp/SimpleColor");
				}
				return _simpleColor;
			}
		}
		...
		public Shader CircleCull
		{
			get
			{
				if (_circleCull == null)
				{
					_circleCull = Shader.Find("RTUnityApp/CircleCull");
				}
				return _circleCull;
			}
		}
		...
		public Shader TorusCull
		{
			get
			{
				if (_torusCull == null)
				{
					_torusCull = Shader.Find("RTUnityApp/TorusCull");
				}
				return _torusCull;
			}
		}
		...
		public Shader CylindricalTorusCull
		{
			get
			{
				...
				{
					_cylindricalTorusCull = Shader.Find("RTUnityApp/CylindricalTorusCull");
				}
