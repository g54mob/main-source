...
namespace RLD
{
	...
	public class GizmoCap2DLookAndFeel
	{
		...
		[SerializeField]
		private float _arrowBaseRadius = 5f;

		[SerializeField]
		private float _arrowHeight = 20f;
		...
		public float ArrowBaseRadius
		{
			get
			{
				return _arrowBaseRadius;
			}
			set
			{
				_arrowBaseRadius = Mathf.Max(0f, value);
			}
		}
		...
		public float ArrowHeight
		{
			...
			set
			{
				_arrowHeight = Mathf.Max(0f, value);
			}
		}
