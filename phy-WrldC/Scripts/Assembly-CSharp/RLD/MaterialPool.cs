...
namespace RLD
{
	public class MaterialPool : Singleton<MaterialPool>
	{
		...
		public Material LinearGradientCameraBk
		{
			get
			{
				if (_linearGradientCameraBk == null)
				{
					_linearGradientCameraBk = new Material(Singleton<ShaderPool>.Get.LinearGradientCameraBk);
				}
		...
		public Material XZGrid_Plane
		{
			get
			{
				if (_xzGrid_Plane == null)
				{
					_xzGrid_Plane = new Material(Singleton<ShaderPool>.Get.XZGrid_Plane);
				}
		...
		public Material GizmoSolidHandle
		{
			get
			{
				if (_gizmoSolidHandle == null)
				{
					_gizmoSolidHandle = new Material(Singleton<ShaderPool>.Get.GizmoSolidHandle);
				}
		...
		public Material TintedTexture
		{
			get
			{
				...
				{
					_tintedTexture = new Material(Singleton<ShaderPool>.Get.TintedTexture);
				}
		...
		public Material SimpleColor
		{
			get
			{
				...
				{
					_simpleColor = new Material(Singleton<ShaderPool>.Get.SimpleColor);
				}
				return _simpleColor;
			}
		}
		...
		public Material CircleCull
		{
			get
			{
				if (_circleCull == null)
				{
					_circleCull = new Material(Singleton<ShaderPool>.Get.CircleCull);
				}
				return _circleCull;
			}
		}
		...
		public Material TorusCull
		{
			get
			{
				if (_torusCull == null)
				{
					_torusCull = new Material(Singleton<ShaderPool>.Get.TorusCull);
				}
				return _torusCull;
			}
		}
		...
		public Material CylindricalTorusCull
		{
			get
			{
				if (_cylindricalTorusCull == null)
				{
					_cylindricalTorusCull = new Material(Singleton<ShaderPool>.Get.CylindricalTorusCull);
				}
