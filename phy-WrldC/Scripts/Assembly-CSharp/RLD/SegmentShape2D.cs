...
namespace RLD
{
	public class SegmentShape2D : Shape2D
	{
		...
		public float RaycastEps
		{
			get
			{
				return _epsilon.RaycastEps;
			}
			set
			{
				_epsilon.RaycastEps = value;
			}
		}
		...
		public float PtOnSegmentEps
		{
			get
			{
				return _epsilon.PtOnSegmentEps;
			}
			set
			{
				_epsilon.PtOnSegmentEps = value;
			}
		}
		...
		{
			return RectEx.FromPoints(new Vector2[2] { _startPoint, _endPoint });
		}
	}
}
