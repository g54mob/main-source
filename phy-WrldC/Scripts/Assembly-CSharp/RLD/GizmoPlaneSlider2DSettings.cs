...
namespace RLD
{
	...
	public class GizmoPlaneSlider2DSettings
	{
		...
		[SerializeField]
		private float _borderLineHoverEps = 7f;

		[SerializeField]
		private float _thickBorderPolyHoverEps = 7f;
		...
		public float ThickBorderPolyHoverEps
		{
			get
			{
				return _thickBorderPolyHoverEps;
			}
			set
			{
				_thickBorderPolyHoverEps = Mathf.Max(0f, value);
			}
		}
