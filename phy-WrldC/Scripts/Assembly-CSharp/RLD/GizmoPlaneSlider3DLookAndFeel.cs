...
namespace RLD
{
	...
	public class GizmoPlaneSlider3DLookAndFeel
	{
		...
		[SerializeField]
		private float _quadWidth = 1f;

		[SerializeField]
		private float _quadHeight = 1f;

		[SerializeField]
		private float _raTriangleXLength = 1f;

		[SerializeField]
		private float _raTriangleYLength = 1f;
		...
		public float RATriangleXLength
		{
			get
			{
				return _raTriangleXLength;
			}
			set
			{
				_raTriangleXLength = Mathf.Max(0f, value);
			}
		}
		...
		public float RATriangleYLength
		{
			get
			{
				return _raTriangleYLength;
			}
			set
			{
				_raTriangleYLength = Mathf.Max(0f, value);
			}
		}
		...
		public float BorderCircleCullAlphaScale
		{
			get
			{
				return _borderCircleCullAlphaScale;
			}
			set
			{
				_borderCircleCullAlphaScale = Mathf.Clamp(value, 0f, 1f);
			}
		}
		...
		public float BorderBoxHeight
		{
			...
			set
			{
				_borderBoxHeight = Mathf.Max(0f, value);
			}
		}
		...
		public float BorderBoxDepth
		{
			get
			{
				return _borderBoxDepth;
			}
			set
			{
				_borderBoxDepth = Mathf.Max(0f, value);
			}
		}
		...
		public float BorderTorusThickness
		{
			get
			{
				return _borderTorusThickness;
			}
			set
			{
				_borderTorusThickness = Mathf.Max(0f, value);
			}
		}
		...
		public float BorderCylTorusWidth
		{
			get
			{
				return _borderCylTorusWidth;
			}
			set
			{
				_borderCylTorusWidth = Mathf.Max(0f, value);
			}
		}
		...
		public float BorderCylTorusHeight
		{
			get
			{
				return _borderCylTorusHeight;
			}
			set
			{
				_borderCylTorusHeight = Mathf.Max(0f, value);
			}
		}
		...
		public int NumBorderTorusWireAxialSlices
		{
			get
			{
				return _numBorderTorusWireAxialSlices;
			}
			set
			{
				_numBorderTorusWireAxialSlices = Mathf.Max(2, value);
			}
		}
		...
		public GizmoShadeMode BorderShadeMode
		{
			get
			{
				return _borderShadeMode;
			}
			set
			{
				_borderShadeMode = value;
			}
		}
		...
		public GizmoFillMode3D BorderFillMode
		{
			get
			{
				return _borderFillMode;
			}
			set
			{
				_borderFillMode = value;
			}
		}
		...
		public GizmoRATriangle3DBorderType RATriangleBorderType
		{
			get
			{
				return _raTriangleBorderType;
			}
			set
			{
				_raTriangleBorderType = value;
			}
		}
