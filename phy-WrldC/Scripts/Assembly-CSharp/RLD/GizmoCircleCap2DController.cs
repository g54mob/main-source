...
namespace RLD
{
	public class GizmoCircleCap2DController : GizmoCap2DController
	{
		...
		{
			_data.CapHandle.Set2DShapeVisible(_data.ArrowIndex, isVisible: false);
			_data.CapHandle.Set2DShapeVisible(_data.QuadIndex, isVisible: false);
		...
		{
			return _data.Cap.GetRealCircleRadius() * 2f;
		}
	}
}
