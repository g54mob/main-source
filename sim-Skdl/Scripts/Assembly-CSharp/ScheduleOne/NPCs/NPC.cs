...
namespace ScheduleOne.NPCs
{
	...
	public class NPC : NetworkBehaviour, IGUIDRegisterable, ISaveable, ICombatTargetable, IDamageable, ISightable, INetworkedEquippableUser, IEquippableUser, IWeatherEntity
	{
		...
		public IThirdPersonReferencesProvider ThirdPersonReferences => null;
		...
		public EntityVisibility VisibilityComponent => null;
		...
		Transform IWeatherEntity.Transform => null;

		string IWeatherEntity.WeatherVolume
		{
			[CompilerGenerated]
			get
			{
		...
		NetworkObject ICombatTargetable.NetworkObject => null;

		GameObject IDamageable.gameObject => null;

		NetworkObject ISightable.NetworkObject => null;
