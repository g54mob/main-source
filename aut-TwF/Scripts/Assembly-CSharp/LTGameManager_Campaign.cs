...
public class LTGameManager_Campaign : LTGameManager
{
	...
	private void OnEnemyDie(Enemy enemy)
	{
		...
		if ((bool)MatchInfo.instance.CurrentLevelData)
		{
			...
			LTFunctionLibrary.GetLevelsProgressionManager().CompleteBoss(MatchInfo.instance.CurrentLevelData.Id, enemy.Data, LTFunctionLibrary.GetMatchInfo().CurrentGameMode.Id == "expert");
		}
	...
	protected override void EndGame()
	{
		...
		if ((bool)MatchInfo.instance.CurrentLevelData)
		{
			...
			LTFunctionLibrary.GetLevelsProgressionManager().CompleteLevel(MatchInfo.instance.CurrentLevelData.Id, LTFunctionLibrary.GetMatchInfo().CurrentGameMode.Id == "expert");
		}
