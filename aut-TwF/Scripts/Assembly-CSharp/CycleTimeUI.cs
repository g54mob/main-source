...
public class CycleTimeUI : MonoBehaviour
{
	...
	[Header("Incoming enemies")]
	[SerializeField]
	private IncomingEnemiesUI incomingEnemiesObject;

	private bool isIncomingEnemiesVisible;
	...
	private void Awake()
	{
		...
		SetupCrystals();
		ShowIncomingEnemiesUI(isIncomingEnemiesVisible);
	}
	...
	public void ToggleShowIncomingEnemiesUI()
	{
		ShowIncomingEnemiesUI(!isIncomingEnemiesVisible);
	}

	private void ShowIncomingEnemiesUI(bool show)
	{
		isIncomingEnemiesVisible = show;
		incomingEnemiesObject.gameObject.SetActive(isIncomingEnemiesVisible);
		if (isIncomingEnemiesVisible)
		{
			incomingEnemiesObject.gameObject.GetComponent<AutoTransformRebuild>().RebuildTransform();
		}
	}
}
