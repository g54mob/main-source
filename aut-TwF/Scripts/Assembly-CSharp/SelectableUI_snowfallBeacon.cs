...
public class SelectableUI_snowfallBeacon : SelectableUI
{
	...
	{
		effectDescriptionText.text = string.Format(LocalizationSettings.StringDatabase.GetLocalizedString("UI_InGame", "UI_InGame_selectable_snowfallBeacon_effect", null, FallbackBehavior.UseProjectSettings), snowfallBeacon.FlamePower);
