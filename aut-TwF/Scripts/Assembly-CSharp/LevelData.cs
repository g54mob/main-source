...
{
	[Serializable]
	public class FMapGeneratorPrefabs
	{
		public GameObject MapGenerator_xs;

		public GameObject MapGenerator_s;

		public GameObject MapGenerator_m;

		public GameObject MapGenerator_l;

		public GameObject MapGenerator_xl;
	}
	...
	[Space]
	[SerializeField]
	private FMapGeneratorPrefabs mapGeneratorPrefabs;
	...
	[SerializeField]
	private FMapGeneratorPrefabs christmasMapGeneratorPrefabs;
	...
	public GameObject GetMapGenerator(EMapSize mapSize)
	{
		FMapGeneratorPrefabs fMapGeneratorPrefabs = null;
		if (!SettingsController.instance.SeasonalContentEnabled)
		{
			fMapGeneratorPrefabs = mapGeneratorPrefabs;
		}
		...
		case LTFunctionLibrary.ESeason.Christmas:
			if (christmasMapGeneratorPrefabs != null)
			{
				fMapGeneratorPrefabs = christmasMapGeneratorPrefabs;
			}
			break;
		}
		return mapSize switch
		{
			EMapSize.XS => fMapGeneratorPrefabs.MapGenerator_xs, 
			EMapSize.S => fMapGeneratorPrefabs.MapGenerator_s, 
			EMapSize.M => fMapGeneratorPrefabs.MapGenerator_m, 
			EMapSize.L => fMapGeneratorPrefabs.MapGenerator_l, 
			EMapSize.XL => fMapGeneratorPrefabs.MapGenerator_xl, 
			_ => fMapGeneratorPrefabs.MapGenerator_m, 
		};
	}
