...
namespace HeathenEngineering.SteamworksIntegration.API
{
	public static class Matchmaking
	{
		public static class Client
		{
			...
			public static HServerQuery ServerRules(uint ip, ushort port, ISteamMatchmakingRulesResponse responce)
			{
				return SteamMatchmakingServers.ServerRules(ip, port, responce);
			}

			public static HServerQuery ServerRules(string ip, ushort port, ISteamMatchmakingRulesResponse responce)
			{
				return SteamMatchmakingServers.ServerRules(Utilities.IPStringToUint(ip), port, responce);
			}
