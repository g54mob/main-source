...
namespace Pathfinding.Util
{
	...
	public struct HierarchicalBitset
	{
		...
		{
			public delegate bool MoveNextBurst_00000CFB_0024PostfixBurstDelegate(ref Iterator iter);

			internal static class MoveNextBurst_00000CFB_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(MoveNextBurst_00000CFB_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static MoveNextBurst_00000CFB_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				return MoveNextBurst_00000CFB_0024BurstDirectCall.Invoke(ref iter);
			}
