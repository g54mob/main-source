...
namespace Pathfinding
{
	...
	internal static class NavmeshCutJobs
	{
		...
		public unsafe delegate void CalculateContour_0000088B_0024PostfixBurstDelegate(JobCalculateContour* job);

		internal static class CalculateContour_0000088B_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(CalculateContour_0000088B_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static CalculateContour_0000088B_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		{
			CalculateContour_0000088B_0024BurstDirectCall.Invoke(job);
		}
