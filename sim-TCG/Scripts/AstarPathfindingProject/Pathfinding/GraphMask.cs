...
namespace Pathfinding
{
	...
	public struct GraphMask
	{
		...
		{
			return FromGraph(AstarPath.active.data.FindGraph((NavGraph g) => g.name == graphName) ?? throw new ArgumentException("Could not find any graph with the name '" + graphName + "'"));
		}
	}
}
