...
namespace Pathfinding.Drawing
{
	...
	public struct CommandBuilder : IDisposable
	{
		...
		private class JobWireMesh
		{
			...
			public unsafe delegate void WireMesh_00000211_0024PostfixBurstDelegate(float3* verts, int* indices, int vertexCount, int indexCount, ref CommandBuilder draw);

			internal static class WireMesh_00000211_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(WireMesh_00000211_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static WireMesh_00000211_0024BurstDirectCall()
				{
					Constructor();
				}
				...
				public unsafe static void Invoke(float3* verts, int* indices, int vertexCount, int indexCount, ref CommandBuilder draw)
				{
					...
					WireMesh_0024BurstManaged(verts, indices, vertexCount, indexCount, ref draw);
				}
			}

			public delegate void Execute_00000212_0024PostfixBurstDelegate(ref Mesh.MeshData rawMeshData, ref CommandBuilder draw);

			internal static class Execute_00000212_0024BurstDirectCall
			{
				private static IntPtr Pointer;
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Execute_00000212_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static Execute_00000212_0024BurstDirectCall()
				{
					Constructor();
				}
				...
				public unsafe static void Invoke(ref Mesh.MeshData rawMeshData, ref CommandBuilder draw)
				{
					...
					Execute_0024BurstManaged(ref rawMeshData, ref draw);
				}
			}
			...
			{
				WireMesh_00000211_0024BurstDirectCall.Invoke(verts, indices, vertexCount, indexCount, ref draw);
			}
			...
			{
				Execute_00000212_0024BurstDirectCall.Invoke(ref rawMeshData, ref draw);
			}

			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			[BurstCompile]
			public unsafe static void WireMesh_0024BurstManaged(float3* verts, int* indices, int vertexCount, int indexCount, ref CommandBuilder draw)
			{
			...
			[BurstCompile]
			[MonoPInvokeCallback(typeof(JobWireMeshDelegate))]
			public unsafe static void Execute_0024BurstManaged(ref Mesh.MeshData rawMeshData, ref CommandBuilder draw)
			{
				int num = 0;
		...
		internal static readonly float4x4 XZtoXYPlaneMatrix = float4x4.RotateX(-MathF.PI / 2f);

		internal static readonly float4x4 XZtoYZPlaneMatrix = float4x4.RotateZ(MathF.PI / 2f);
		...
		public static void Initialize_0024JobWireMesh_WireMesh_00000211_0024BurstDirectCall()
		{
			JobWireMesh.WireMesh_00000211_0024BurstDirectCall.Initialize();
		}

		public static void Initialize_0024JobWireMesh_Execute_00000212_0024BurstDirectCall()
		{
			JobWireMesh.Execute_00000212_0024BurstDirectCall.Initialize();
		}
	}
}
