...
namespace FullSerializerSave
{
	public class fsAotCompilationManager
	{
		...
		{
			return "FullSerializerSave.Speedup." + type.CSharpName(includeNamespace: true, ensureSafeDeclarationName: true) + "_DirectConverter";
		}
		...
		private static string GenerateDirectConverterForTypeInCSharp(Type type, fsMetaProperty[] members, bool isConstructorPublic)
		{
			...
			stringBuilder.AppendLine("namespace FullSerializerSave {");
			...
			stringBuilder.AppendLine("}");
			stringBuilder.AppendLine();
			stringBuilder.AppendLine("namespace FullSerializerSave.Speedup {");
