...
namespace FullSerializerSave.Internal
{
	public class fsForwardConverter : fsConverter
	{
		...
		public override fsResult TrySerialize(object instance, out fsData serialized, Type storageType)
		{
			...
			return Serializer.TrySerialize(property.StorageType, null, instance2, out serialized);
		}
		...
		public override fsResult TryDeserialize(fsData data, ref object instance, Type storageType)
		{
			...
			object result = null;
			if ((success += Serializer.TryDeserialize(data, property.StorageType, null, ref result)).Failed)
			{
				return success;
			}
