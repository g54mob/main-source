...
namespace FullInspector
{
	public class fiSettings
	{
		...
		public static int InspectorAutomaticReferenceInstantiationAllowedDepth;
		...
		static fiSettings()
		{
			...
			EnableGlobalOrdering = false;
			EnableSettingsProcessor = true;
			EnableLogs = false;
			PrettyPrintSerializedJson = false;
			DefaultCommentType = CommentType.Info;
			ForceDisplayInlineObjectEditor = false;
			EnableAnimation = true;
			ForceSaveAllAssetsOnSceneSave = false;
			ForceSaveAllAssetsOnRecompilation = false;
			ForceRestoreAllAssetsOnRecompilation = false;
			AutomaticReferenceInstantation = false;
			InspectorAutomaticReferenceInstantation = true;
			InspectorAutomaticReferenceInstantiationAllowedDepth = 5;
			InspectorRequireShowInInspector = false;
			SerializeAutoProperties = true;
			EmitWarnings = false;
			EmitGraphMetadataCulls = false;
			MinimumFoldoutHeight = 80f;
			EnableOpenScriptButton = true;
			ForceDisableMultithreadedSerialization = false;
