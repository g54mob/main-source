...
internal static class bEUEMZWgpCwBXKGSoWTyQESUVD
{
	public static ControllerElementType ImSGBfeSUdhdHajXEMFVtcmiijjJ(ElementAssignmentType P_0)
	{
		switch (P_0)
		{
	...
	public static ElementAssignmentType hSAHtMOPXTxyINedALtRTSYOQEN(ControllerType P_0, ControllerElementType P_1, AxisRange P_2)
	{
	...
	public static AxisRange lhvDVPYAuOClTrEPrWsutRIVQHX(Pole P_0)
	{
		return P_0 switch
		{
	...
	public static Type CwZeXoiPzKJANggANeOKVIlvMmmG<T>() where T : Controller
	{
		return CwZeXoiPzKJANggANeOKVIlvMmmG(typeof(T));
	}

	public static Type CwZeXoiPzKJANggANeOKVIlvMmmG(Type P_0)
	{
	...
	public static Type sbugZxMepCdGZhbvyvpyBtkIflOs(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static Type vORJMHXuiWVvmHMAlanHCOEFZMlM(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerType cBNLAYcmxbcLkZElXOxElVAbwGi(Type P_0)
	{
		if ((object)P_0 == null)
		{
	...
	public static ControllerType cBNLAYcmxbcLkZElXOxElVAbwGi<T>()
	{
		return cBNLAYcmxbcLkZElXOxElVAbwGi(typeof(T));
	}

	public static ControllerType CopuTrtjBVrkWTQmpWAPqArJZCQ(Type P_0)
	{
		if (!YMoLVIIWiTPkmefXIKyfZeEBOIY(P_0, out var result))
		{
			throw new Exception(P_0.Name + " is not an allowed type.");
		}
		return result;
	...
	public static ControllerType CopuTrtjBVrkWTQmpWAPqArJZCQ<T>() where T : ControllerMap
	{
		return CopuTrtjBVrkWTQmpWAPqArJZCQ(typeof(T));
	}

	public static bool YMoLVIIWiTPkmefXIKyfZeEBOIY(Type P_0, out ControllerType P_1)
	{
		if ((object)P_0 == null)
		{
	...
	public static bool YMoLVIIWiTPkmefXIKyfZeEBOIY<T>(out ControllerType P_0) where T : ControllerMap
	{
		return YMoLVIIWiTPkmefXIKyfZeEBOIY(typeof(T), out P_0);
	}

	public static ControllerType QArtBhHPXsBRkBXusELJmddQoWdX(Type P_0)
	{
		if ((object)P_0 == null)
		{
	...
	public static ControllerType QArtBhHPXsBRkBXusELJmddQoWdX<T>() where T : ControllerMapSaveData
	{
		return QArtBhHPXsBRkBXusELJmddQoWdX(typeof(T));
	}

	public static bool QuyjPPVLYssrxnLbKpFVOFYkPay(ControllerTemplateElementType P_0, ControllerElementType P_1)
	{
		return P_1 switch
		{
	...
	public static ControllerElementType dLPwDUrjSeBQsjFuYopHtVAQALt(object P_0)
	{
		if (P_0 == null)
		{
		...
		{
			return dLPwDUrjSeBQsjFuYopHtVAQALt((ControllerTemplateElementType)P_0);
		}
		throw new NotImplementedException();
	}

	public static ControllerElementType dLPwDUrjSeBQsjFuYopHtVAQALt(ControllerTemplateElementType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerTemplateElementSourceType XTtNjVcbsHiNgoCtwpmbAFGrKts(ControllerTemplateElementType P_0, bool P_1)
	{
		switch (P_0)
		{
	...
	public static ControllerTemplateElementType PvAqsaUpMgXOMnQDleuMFTFrJXd(ControllerElementType P_0, bool P_1)
	{
		switch (P_0)
		{
		case ControllerElementType.Axis:
