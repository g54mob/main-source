...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static ReadOnlyCollection<ControllerElementIdentifier> qQDfQtmrhvjyiBbtKkiVvnLQvaQc;

		private static ReadOnlyCollection<ControllerElementIdentifier> prAAAvSrJbMagmkdHNAIHzLAFeZ;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] vkJEbBfAEFfWkwsmOXQwsNculAOL;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] MugMZvJUCctsJEEAORhaxMUQNAj;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] FGwVFwhLqhRFijtWIiGNZFtOrj;
		...
		private static readonly string[] wXgARKwrdmogAislFHOpFDoDlsQp;

		internal static readonly IList<PidVid> pidVids_sony_dualShock4;

		private static readonly PidVid[] ymoXXOLQZXVliHTKXCOXJIXcBhu;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] nAsuxhdtcdMqSjlslpIoPhvVJgR;

		private static readonly ControllerElementIdentifier[] CDzOHRosjEvnuCfPOLocIUkkZXJ;
		...
		internal static IList<ControllerElementIdentifier> unityUnifiedMouseElementIdentifiers => qQDfQtmrhvjyiBbtKkiVvnLQvaQc ?? (qQDfQtmrhvjyiBbtKkiVvnLQvaQc = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[11]
		{
		...
		internal static IList<ControllerElementIdentifier> rawInputUnifiedMouseElementIdentifiers => prAAAvSrJbMagmkdHNAIHzLAFeZ ?? (prAAAvSrJbMagmkdHNAIHzLAFeZ = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[9]
		{
			new ControllerElementIdentifier(0, "Mouse Horizontal", "Mouse Right", "Mouse Left", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, isMappableOnPlatform: true),
			new ControllerElementIdentifier(1, "Mouse Vertical", "Mouse Up", "Mouse Down", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, isMappableOnPlatform: true),
			new ControllerElementIdentifier(2, "Mouse Wheel", "Mouse Wheel Up", "Mouse Wheel Down", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, isMappableOnPlatform: true),
		...
		internal static ControllerElementIdentifier[] unknownJoystickElementIdentifiers_orig => CDzOHRosjEvnuCfPOLocIUkkZXJ;
		...
		static Consts()
		{
			...
			vkJEbBfAEFfWkwsmOXQwsNculAOL = new string[3] { "MouseAxis1", "MouseAxis2", "MouseAxis3" };
			MugMZvJUCctsJEEAORhaxMUQNAj = new string[7] { "MouseButton0", "MouseButton1", "MouseButton2", "MouseButton3", "MouseButton4", "MouseButton5", "MouseButton6" };
			FGwVFwhLqhRFijtWIiGNZFtOrj = new string[132]
			{
			...
			wXgARKwrdmogAislFHOpFDoDlsQp = new string[5] { "", "Ctrl", "Alt", "Shift", "Cmd" };
			ymoXXOLQZXVliHTKXCOXJIXcBhu = new PidVid[3]
			{
				new PidVid(1476, 1356),
				new PidVid(2976, 1356),
				new PidVid(2508, 1356)
			};
			nAsuxhdtcdMqSjlslpIoPhvVJgR = new string[4] { "Sony Computer Entertainment Wireless Controller", "Sony Interactive Entertainment DUALSHOCK®4 USB Wireless Adaptor", "Wireless Controller", "Sony Interactive Entertainment Wireless Controller" };
			mouseAxisUnityNames = new ReadOnlyCollection<string>(vkJEbBfAEFfWkwsmOXQwsNculAOL);
			mouseButtonUnityNames = new ReadOnlyCollection<string>(MugMZvJUCctsJEEAORhaxMUQNAj);
			keyboardKeyNames = new ReadOnlyCollection<string>(FGwVFwhLqhRFijtWIiGNZFtOrj);
			keyboardKeyValues = new ReadOnlyCollection<int>(_keyboardKeyValues);
			modifierKeyShortNames = new ReadOnlyCollection<string>(wXgARKwrdmogAislFHOpFDoDlsQp);
			pidVids_sony_dualShock4 = new ReadOnlyCollection<PidVid>(ymoXXOLQZXVliHTKXCOXJIXcBhu);
			productNames_sony_dualShock4 = new ReadOnlyCollection<string>(nAsuxhdtcdMqSjlslpIoPhvVJgR);
			...
			CDzOHRosjEvnuCfPOLocIUkkZXJ = HSvHmYYMFcMpCYIXmZPfCVvYrGm();
			if (132 != FGwVFwhLqhRFijtWIiGNZFtOrj.Length)
			{
		...
		private static ControllerElementIdentifier[] HSvHmYYMFcMpCYIXmZPfCVvYrGm()
		{
			int num = 0;
