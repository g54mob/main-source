	...
	public class RotateAroundAxis : MonoBehaviour
	{
		...
		private void Update()
		{
			if (_speed != Speed.Stopped)
			{
				...
				base.transform.Rotate(bsHsWdfzFMHFUIfGPqyxaThkxi(_rotateAroundAxis), num * Time.deltaTime, _relativeTo);
			}
		}

		private static Vector3 bsHsWdfzFMHFUIfGPqyxaThkxi(RotationAxis P_0)
		{
			return P_0 switch
			{
