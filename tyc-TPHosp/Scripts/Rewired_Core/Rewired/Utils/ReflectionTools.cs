...
namespace Rewired.Utils
{
	...
	public static class ReflectionTools
	{
		...
		{
			return QnStNshgZQBJShACqrWnbmeWGVX(classPath, true, ignoreCase);
		}

		internal static Type GetTypeInUnityBuildAssembly(string classPath, bool ignoreCase = false)
		{
			return QnStNshgZQBJShACqrWnbmeWGVX(classPath, false, ignoreCase);
		}

		private static Type QnStNshgZQBJShACqrWnbmeWGVX(string P_0, bool P_1, bool P_2 = false)
		{
			Assembly[] assemblies = AppDomain.CurrentDomain.GetAssemblies();
