...
namespace Rewired.Utils
{
	...
	{
		private static string NpezjEQarnZcHCLRqDdmYHheIgmA;
		...
		static StringTools()
		{
			...
			NpezjEQarnZcHCLRqDdmYHheIgmA = Regex.Escape(new string(invalidFileNameChars));
		}

		public static string CleanUpFileName(string name)
		{
			name = name.Trim();
			string pattern = "[ ~`,:;'\\.\\$\\^\\{\\}\\[\\]\\(\\|\\)\\*\\+\\?\\\\" + NpezjEQarnZcHCLRqDdmYHheIgmA + "]";
