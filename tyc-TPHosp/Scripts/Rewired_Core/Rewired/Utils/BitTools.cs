...
namespace Rewired.Utils
{
	...
	{
		private static byte[] xbqaSJccGFUjZRtigRufdHltytI;

		private static byte[] intToFloatBuffer => xbqaSJccGFUjZRtigRufdHltytI ?? (xbqaSJccGFUjZRtigRufdHltytI = new byte[4]);
