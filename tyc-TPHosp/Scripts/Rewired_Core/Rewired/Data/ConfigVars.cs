...
namespace Rewired.Data
{
	...
	{
		private static class vXSLDZsIieImVkcfEiwoAvavzoz
		{
			public const string iTlZorELHQDCESPLUCqUXMAKNVy = "updateLoop";

			public const string jkIponCxcZFJtOizlJicOKibHjT = "alwaysUseUnityInput";

			public const string EKXGpwDnqePCkYEVEisfBKekLTjV = "windowsStandalonePrimaryInputSource";

			public const string HuDnwMtixyIzyguaUypCYhCNcTM = "osx_primaryInputSource";

			public const string QIWZMoOczWuZdeEJJufpbIuIZmr = "linux_primaryInputSource";

			public const string znDuoELMmKOJIEaEwpoDkexOuMy = "windowsUWP_primaryInputSource";

			public const string wcQCwyXUhnhmvHmyHqrwBciyvfT = "xboxOne_primaryInputSource";

			public const string FJgDXagcDkPFgghSAWxageuuCir = "gameCoreXboxOne_primaryInputSource";

			public const string hWTWCbtjZRGmmPVhdcwsFLQXZCKd = "gameCoreScarlett_primaryInputSource";

			public const string YilcOkGymnRzDKeFsffabNYDswnU = "ps4_primaryInputSource";

			public const string UznpwxiTGqZIEwTQovRSYZdCTNU = "ps5_primaryInputSource";

			public const string DWCbyMZoXztTIfYPeGjjdwQUbyh = "webGL_primaryInputSource";

			public const string PREhNEXUlCGPKwwvwXygGvUizyh = "stadia_primaryInputSource";

			public const string dDcivGnyhSdpZxfyLbaQczMGIjK = "useXInput";

			public const string WFIPLUScMuKNPAjMKHdwJNIMsHl = "windowsStandalone_useSteamRawInputControllerWorkaround";

			public const string jgOSJPNPnNVpYfgcPuURIxaMAPq = "osxStandalone_useEnhancedDeviceSupport";

			public const string LtDjNGEfOOEXrDCvTdLLKCswdMdW = "android_supportUnknownGamepads";

			public const string bmldXSoyjXkUtyKPfXGOJivrQXG = "ps4_assignJoysticksByPS4JoyId";

			public const string FsVxQeujFfJPxTMQVVVdFNxshQf = "useSteamControllerSupport";

			public const string jZgezGWdLblSdLpqapBpgMJntie = "logToScreen";

			public const string CHFcqyiRXkVkPTznzYKCFnIUKAqe = "runInEditMode";

			public const string FnDjusjuMSsHiFUjUeMJkaEPuCa = "allowInputInEditorSceneView";

			public const string kNTgciaKmEwWeEfwRASoNBlVONf = "maxJoysticksPerPlayer";

			public const string mtCCYahlrOCfVfZaqTfhqGoxBheZ = "autoAssignJoysticks";

			public const string yyHqXzdgoHFaYTINHmrLvjDDGpn = "assignJoysticksToPlayingPlayersOnly";

			public const string LDbHmOiInjhJLKYTFzprIFjrSphB = "distributeJoysticksEvenly";

			public const string WVPzSZueFBeXhQgVTTIWXvFUAre = "reassignJoystickToPreviousOwnerOnReconnect";

			public const string cusfegEhKUNvCyknCSyJjIVfaaM = "defaultJoystickAxis2DDeadZoneType";

			public const string ntTXYDmTIRTIEsLbcFaZzTCTFeW = "defaultJoystickAxis2DSensitivityType";

			public const string ZZdftSozgjwiaBmIWLYwRTbKlLd = "defaultAxisSensitivityType";

			public const string sTgCKMOkLfwEqhBYJBFtADyMOfH = "force4WayHats";

			public const string iaRruYxUCEMzDdvceXJwuXRmrsY = "throttleCalibrationMode";

			public const string qBsmNuXCquvSgFVXoKsdkPfMCsG = "activateActionButtonsOnNegativeValue";

			public const string gMrLtvMCRkoQIGcCXdaefYPpdLWF = "deferControllerConnectedEventsOnStart";

			public const string AMKXuEQzhDBNEfliGWqKIkWzfcW = "logLevel";

			public const string RYbDynDSaUdWIkkhwpbmMltMxPbl = "disableKeyboard";

			public const string FqKxLnHoidzEKKcXtgKVdVzASdv = "ignoreInputWhenAppNotInFocus";

			public const string QVrpZnIPzjLvruUBwdVpWeNcsXx = "useEnhancedDeviceSupport";

			public const string SkshxwFqBQHCajPaMwyqtDsxdvV = "useNativeMouse";

			public const string vMvHkjrrDvqjdJoXZLuDTEyAbaX = "useNativeKeyboard";

			public const string jcnCdoUoZXPwIwyehXkKwwyhqbg = "joystickRefreshRate";

			public const string RSUUuHYmnbQofwgQBicHTnlIIPU = "assignJoysticksBySystemId";
		}
		...
		private class jWNffkEgpWzbswbbOlijhupPkIH
		{
			public Func<PlatformVars> vRvRfzKawnoItbciIRETDHpmuZg;

			public string XfhwdEIUxPiRtDydzkviSIFVQLz;

			public jWNffkEgpWzbswbbOlijhupPkIH(Func<PlatformVars> getDelegate, string dataPath)
			{
				vRvRfzKawnoItbciIRETDHpmuZg = getDelegate;
				XfhwdEIUxPiRtDydzkviSIFVQLz = dataPath;
			}
		}

		private class ycCiLMBhLktFeOQDMsuYtuhGVJs
		{
			public Func<Platform, object> vRvRfzKawnoItbciIRETDHpmuZg;

			public Action<Platform, object> zeCYQzqdupfwSCFaZgSOnIFwOrcD;

			public ycCiLMBhLktFeOQDMsuYtuhGVJs(Func<Platform, object> getDelegate, Action<Platform, object> setDelegate)
			{
				vRvRfzKawnoItbciIRETDHpmuZg = getDelegate;
				zeCYQzqdupfwSCFaZgSOnIFwOrcD = setDelegate;
			}
		}
		...
		private Dictionary<int, jWNffkEgpWzbswbbOlijhupPkIH> __platformVarsDict;

		private Dictionary<int, ycCiLMBhLktFeOQDMsuYtuhGVJs> __getSetPlatformVariableDict;

		private KeyedGetSetValueStore<string> __configVarsValues;

		private Dictionary<string, object> __valueDelegates;

		private Dictionary<int, jWNffkEgpWzbswbbOlijhupPkIH> platformVarsDict => __platformVarsDict ?? (__platformVarsDict = new Dictionary<int, jWNffkEgpWzbswbbOlijhupPkIH>
		{
			{
				1,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_windowsStandalone), "platformVars_windowsStandalone")
			},
			{
				2,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_windows8Store), "platformVars_windows8Store")
			},
			{
				3,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_windows8Store), "platformVars_windows8Store")
			...
			{
				29,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_windowsUWP), "platformVars_windowsUWP")
			},
			{
				6,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_linuxStandalone), "platformVars_linuxStandalone")
			},
			{
				4,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_osxStandalone), "platformVars_osxStandalone")
			},
			{
				5,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_iOS), "platformVars_iOS")
			},
			{
				28,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_tvOS), "platformVars_tvOS")
			},
			{
				12,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_ps3), "platformVars_ps3")
			},
			{
				13,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_ps4), "platformVars_ps4")
			},
			{
				106,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_ps5), "platformVars_ps5")
			},
			{
				15,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_psVita), "platformVars_psVita")
			},
			{
				14,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_psVita), "platformVars_psVita")
			...
			{
				16,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_wii), "platformVars_wii")
			},
			{
				18,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_wiiu), "platformVars_wiiu")
			},
			{
				32,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_switch), "platformVars_switch")
			},
			{
				10,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_xbox360), "platformVars_xbox360")
			},
			{
				11,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_xboxOne), "platformVars_xboxOne")
			},
			{
				104,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_gameCoreXboxOne), "platformVars_gameCoreXboxOne")
			},
			{
				105,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_gameCoreScarlett), "platformVars_gameCoreScarlett")
			},
			{
				19,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_webGL), "platformVars_webGL")
			},
			{
				103,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_stadia), "platformVars_stadia")
			},
			{
				7,
				new jWNffkEgpWzbswbbOlijhupPkIH(() => GetOrCreatePlatformVars(ref platformVars_android), "platformVars_android")
			}
		});

		private Dictionary<int, ycCiLMBhLktFeOQDMsuYtuhGVJs> getSetPlatformVariableDict => __getSetPlatformVariableDict ?? (__getSetPlatformVariableDict = new Dictionary<int, ycCiLMBhLktFeOQDMsuYtuhGVJs>
		{
			{
				0,
				new ycCiLMBhLktFeOQDMsuYtuhGVJs((Platform p) => GetPlatformVars(p).disableKeyboard, delegate(Platform platform, object value)
				{
			...
			{
				1,
				new ycCiLMBhLktFeOQDMsuYtuhGVJs((Platform platform) => GetPlatformVars(platform).ignoreInputWhenAppNotInFocus, delegate(Platform platform, object value)
				{
		...
		internal string GetPlatformVarsRelPath(Platform platform)
		{
			...
			{
				return platformVarsDict[(int)platform].XfhwdEIUxPiRtDydzkviSIFVQLz;
			}
		...
		{
			PlatformVars platformVars = ((!platformVarsDict.ContainsKey((int)platform)) ? GetOrCreatePlatformVars(ref platformVars_unknown) : platformVarsDict[(int)platform].vRvRfzKawnoItbciIRETDHpmuZg());
		...
		{
			foreach (KeyValuePair<int, jWNffkEgpWzbswbbOlijhupPkIH> item in platformVarsDict)
			{
				if (getSetPlatformVariableDict.ContainsKey((int)var))
				{
					getSetPlatformVariableDict[(int)var].zeCYQzqdupfwSCFaZgSOnIFwOrcD((Platform)item.Key, value);
				}
			}
		}
		...
		private MultiBoolValue GetAllSerializedPlatformVar_multiBool(AllPlatformVar var)
		{
			...
			foreach (KeyValuePair<int, jWNffkEgpWzbswbbOlijhupPkIH> item in platformVarsDict)
			{
				...
				object obj = getSetPlatformVariableDict[(int)var].vRvRfzKawnoItbciIRETDHpmuZg((Platform)item.Key);
				if (obj == null)
				{
					continue;
				}
				...
				{
					return MultiBoolValue.iWfvRFgyfYnmUXmriRMDjFFigRp;
				}
			}
			if (!flag)
			{
				return MultiBoolValue.vzRTPkAxQouGEgDZGevsgfcpaRF;
			}
			return MultiBoolValue.azLWpLIAMvIpDxdUTFgLLfAIMtW;
		}
