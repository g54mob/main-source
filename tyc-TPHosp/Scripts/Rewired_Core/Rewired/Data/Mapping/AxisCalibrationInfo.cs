...
namespace Rewired.Data.Mapping
{
	...
	public class AxisCalibrationInfo : IDeepCloneable
	{
		...
		internal static AxisCalibrationData DXeLVXLnnssdcXviGoSlSlzJWMy(AxisCalibrationInfo P_0)
		{
			if (P_0 == null)
			{
		...
		internal static AxisCalibrationInfo XhJFMHkfrUqOrQQdkTjYMDtbIvuV(AxisCalibrationData P_0)
		{
