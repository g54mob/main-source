...
namespace Rewired.Data.Mapping
{
	...
	internal interface IHardwareControllerTemplateMap_Internal
	{
		...
		uRvJKnYnMDIXSDaSbLxWqKFPfOYl GetAxisTarget(Controller controller, int elementIdentifierId);

		uRvJKnYnMDIXSDaSbLxWqKFPfOYl GetButtonTarget(Controller controller, int elementIdentifierId);
	}
}
