...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class MJAcpTmClSQMWqrMoCmEtdKkVIP : IControllerExtensionSource
		{
			public readonly IDriver_DualShock4 dyKYGRpafBLeBoCSSijQzhOhFYt;

			public readonly bool swbwxminWkIfPLDNkfAOLJChHuv;

			public readonly int hFnuhMXoYvgyCariIlYOShuWnqMq;

			public MJAcpTmClSQMWqrMoCmEtdKkVIP(IDriver_DualShock4 driver, bool supportsVibration, int vibrationMotorCount)
			{
		...
		private MJAcpTmClSQMWqrMoCmEtdKkVIP NsRIQHseimotuEJGoIuiBqmlsEN;
		...
		internal DualShock4Extension(IDriver_DualShock4 driver)
			: base(new MJAcpTmClSQMWqrMoCmEtdKkVIP(driver, driver.VibrationMotorCount > 0, driver.VibrationMotorCount))
		{
		...
		public void SetLightFlash(float onDuration, float offDuration)
		{
			...
			{
				NsRIQHseimotuEJGoIuiBqmlsEN.dyKYGRpafBLeBoCSSijQzhOhFYt.LightFlashOnDuration = onDuration;
				NsRIQHseimotuEJGoIuiBqmlsEN.dyKYGRpafBLeBoCSSijQzhOhFYt.LightFlashOffDuration = offDuration;
			}
		}
		...
		public void StopLightFlash()
		{
			...
			{
				NsRIQHseimotuEJGoIuiBqmlsEN.dyKYGRpafBLeBoCSSijQzhOhFYt.StopLightFlash();
			}
		}
		...
		{
			NsRIQHseimotuEJGoIuiBqmlsEN = P_0 as MJAcpTmClSQMWqrMoCmEtdKkVIP;
