...
namespace Rewired
{
	public sealed class ControllerMapEnabler
	{
		...
		internal class FIAqEJWjdCiOptKWtsxrOjilkTn
		{
			public bool LlgfVabWLxPZFgsjVvjcWTGeerxs;

			public OvIEhpkUuYDGzFeekgFXDXgYKTqC[] HfsifiJbuMlcqPAumVCdmQNaoBY;

			public FIAqEJWjdCiOptKWtsxrOjilkTn(bool enabled, OvIEhpkUuYDGzFeekgFXDXgYKTqC[] startingRuleSets)
			{
		...
		private FIAqEJWjdCiOptKWtsxrOjilkTn iEcBSOYAsKtgABwNtsQrKywyfaW;
		...
		internal ControllerMapEnabler(Player player, FIAqEJWjdCiOptKWtsxrOjilkTn startingSettings)
		{
			if (player == null)
			{
		...
		public void LoadDefaults()
		{
			...
			for (int i = 0; i < num; i++)
			{
				RuleSet controllerMapEnablerRuleSetInstance = ReInput.mapping.GetControllerMapEnablerRuleSetInstance(iEcBSOYAsKtgABwNtsQrKywyfaW.HfsifiJbuMlcqPAumVCdmQNaoBY[i].id);
				...
				controllerMapEnablerRuleSetInstance.enabled = iEcBSOYAsKtgABwNtsQrKywyfaW.HfsifiJbuMlcqPAumVCdmQNaoBY[i].startEnabled;
