...
namespace Rewired
{
	...
	public sealed class InputBehavior
	{
		...
		public InputBehavior(InputBehavior source)
			: this()
		{
			DgaISBOYhYIzzijMdIEaQqNCgT(source, this, true);
		}
		...
		public string ToXmlString()
		{
			try
			{
				return PqhjvNPiBwCpEqlIvYHWxfloWcX().ToXmlString(writeDocumentTag: true);
			}
			catch (Exception ex)
			{
		...
		public bool ImportXmlString(string xmlString)
		{
			try
			{
				yVXFqVXzLlBDILgCcWPHxsSqcfA(SerializedObject.FromXml(GetType(), xmlString));
				return true;
			}
			catch (Exception ex)
			{
		...
		public string ToJsonString()
		{
			try
			{
				return PqhjvNPiBwCpEqlIvYHWxfloWcX().ToJsonString();
			}
			catch (Exception ex)
			{
		...
		public bool ImportJsonString(string jsonString)
		{
			try
			{
				yVXFqVXzLlBDILgCcWPHxsSqcfA(SerializedObject.FromJson(GetType(), jsonString));
				return true;
			}
			catch (Exception ex)
			{
		...
		public bool ImportData(InputBehavior inputBehavior)
		{
			...
			DgaISBOYhYIzzijMdIEaQqNCgT(inputBehavior, this, false);
			return true;
		}
		...
		public void Reset()
		{
			InputBehavior inputBehavior = ReInput.mapping.FrIEWThKozntQoWhXMslnsKoxTm(_id);
			if (inputBehavior != null)
			{
				DgaISBOYhYIzzijMdIEaQqNCgT(inputBehavior, this, true);
			}
		}

		internal SerializedObject PqhjvNPiBwCpEqlIvYHWxfloWcX()
		{
			...
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.OyVEtLlgkNfHXzDuiVPrVGAKdJW
			{
				...
				HpxePuhaScltgSCBmgsrsCpjliL = 5.ToString()
			});
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.OyVEtLlgkNfHXzDuiVPrVGAKdJW
			{
				zYwYmGHTCLOJxCByvWzioBevSzj = "id",
				HpxePuhaScltgSCBmgsrsCpjliL = _id.ToString()
			});
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.OyVEtLlgkNfHXzDuiVPrVGAKdJW
			{
			...
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.OyVEtLlgkNfHXzDuiVPrVGAKdJW
			{
				...
				oseqaDGmYbdubOOmISVVBGRFzNc = null,
				HpxePuhaScltgSCBmgsrsCpjliL = string.Format("{0} {1}{2}{3}{4}{5}", "http://guavaman.com/rewired", "http://guavaman.com/schemas/rewired/", "1.4", "/", GetType().Name, ".xsd")
			});
		...
		internal void yVXFqVXzLlBDILgCcWPHxsSqcfA(SerializedObject P_0)
		{
			Reset();
		...
		private static void DgaISBOYhYIzzijMdIEaQqNCgT(InputBehavior P_0, InputBehavior P_1, bool P_2)
		{
			if (P_2)
			{
				P_1._id = P_0._id;
