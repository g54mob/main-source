...
namespace Rewired.Components
{
	...
	public class PlayerController : ComponentWrapper<Rewired.PlayerController>, IPlayerController
	{
		...
		protected override void OnAwakeFinished()
		{
			...
			if (base.initialized)
			{
				kzLoHeRsSUXRbiQjCvKcJaWLWfQ(true);
			}
		}
		...
		protected override void Subscribe()
		{
			...
			if (base.source != null)
			{
				base.source.ButtonStateChangedEvent += wwpMwrVjyXoQEbHeCJBbxKgKjTxH;
				base.source.AxisValueChangedEvent += BORFITtzDidAGHXDCfVAfBgNjyT;
				base.source.EnabledStateChangedEvent += kzLoHeRsSUXRbiQjCvKcJaWLWfQ;
			}
		}
		...
		protected override Rewired.PlayerController CreateSource(object args)
		{
			...
			if (list == null || list.Count == 0)
			{
				...
				list = swsVrnISuYNOxHxkgTlFZBsSoyd();
			}
		...
		internal virtual List<ElementInfo> swsVrnISuYNOxHxkgTlFZBsSoyd()
		{
		...
		private void wwpMwrVjyXoQEbHeCJBbxKgKjTxH(int P_0, bool P_1)
		{
		...
		private void BORFITtzDidAGHXDCfVAfBgNjyT(int P_0, float P_1)
		{
			if (!base.isActiveAndEnabled)
			{
				return;
		...
		private void kzLoHeRsSUXRbiQjCvKcJaWLWfQ(bool P_0)
		{
			try
			{
		...
		private void AhxgZOZXrZfuGAsilljNOAFGzSYR()
		{
			if (_elements == null || _elements.Count <= 0)
			{
				_elements = swsVrnISuYNOxHxkgTlFZBsSoyd();
			}
		}
	}
}
