...
namespace Rewired.Components
{
	...
	public sealed class PlayerMouse : PlayerController, IPlayerController, IPlayerMouse, IMouseInputSource
	{
		...
		protected override void Subscribe()
		{
			...
			if (source != null)
			{
				source.ScreenPositionChangedEvent += rVJmbQCNaYkdWidOcaydfnELVylI;
			}
		}
		...
		internal override List<ElementInfo> swsVrnISuYNOxHxkgTlFZBsSoyd()
		{
		...
		private void rVJmbQCNaYkdWidOcaydfnELVylI(Vector2 P_0)
		{
