...
namespace Rewired
{
	...
	{
		private const string qKHGkZtpBiiszNyevJGzRdBXXpd = "[^a-fA-F0-9]";
		...
		{
			if (string.IsNullOrEmpty(yiabocRvKgUaBlXrAtpIhIwbDsVh(pidVid)))
			{
				productId = 0;
				vendorId = 0;
				return;
		...
		{
			return TPUIJbCbAQolEkICdEnpXzWmZEr(yiabocRvKgUaBlXrAtpIhIwbDsVh(pidVid));
		}
		...
		private bool TPUIJbCbAQolEkICdEnpXzWmZEr(string P_0)
		{
		...
		private static string yiabocRvKgUaBlXrAtpIhIwbDsVh(string P_0)
		{
