...
namespace Rewired
{
	...
	internal class HardwareControllerMap_Game
	{
			...
			: this(controllerName)
		{
			...
			for (int k = 0; k < num; k++)
			{
				int num5 = PjvYgmpDKuHFbZfwNbPRATIJphL(hardwareElementIdentifiers, buttonElementIdentifierIds[k]);
				if (num5 < 0)
				{
			...
			{
				int num6 = PjvYgmpDKuHFbZfwNbPRATIJphL(hardwareElementIdentifiers, axisElementIdentifierIds[l]);
				if (num6 < 0)
				{
					Logger.LogError("Invalid hardware element identifier id!");
				}
			...
			{
				int num7 = PjvYgmpDKuHFbZfwNbPRATIJphL(hardwareElementIdentifiers, array[m]);
				if (num7 < 0)
				{
					Logger.LogError("Invalid hardware element identifier id!");
				}
			...
			{
				int num8 = PjvYgmpDKuHFbZfwNbPRATIJphL(hardwareElementIdentifiers, array2[n]);
				if (num8 < 0)
				{
					Logger.LogError("Invalid hardware element identifier id!");
				}
		...
		private int PjvYgmpDKuHFbZfwNbPRATIJphL(ControllerElementIdentifier[] P_0, int P_1)
		{
			if (P_0 == null)
			{
				return -1;
