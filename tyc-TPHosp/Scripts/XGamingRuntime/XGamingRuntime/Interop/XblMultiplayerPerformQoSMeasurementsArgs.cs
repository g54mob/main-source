...
namespace XGamingRuntime.Interop
{
	internal struct XblMultiplayerPerformQoSMeasurementsArgs
	{
		...
		{
			remoteClients = (XblMultiplayerConnectionAddressDeviceTokenPair*)(void*)Converters.ClassArrayToPtr(publicObject.RemoteClients, (XGamingRuntime.XblMultiplayerConnectionAddressDeviceTokenPair x, DisposableCollection dc) => new XblMultiplayerConnectionAddressDeviceTokenPair(x, dc), disposableCollection, out remoteClientsSize);
		}
	}
}
