...
namespace XGamingRuntime.Interop
{
	internal static class XblInterop
	{
		...
		private const string ThunkDllName = "Microsoft_Xbox_Services_141_GSDK_C_Thunks";

		[DllImport("Microsoft_Xbox_Services_141_GSDK_C_Thunks", CallingConvention = CallingConvention.StdCall)]
