...
namespace XGamingRuntime.Interop
{
	...
	internal class XblPresenceQueryFiltersRef
	{
		...
		{
			deviceTypes = Converters.ClassArrayToPtr(filters.DeviceTypes, (XblPresenceDeviceType dt, DisposableCollection _) => dt, disposableCollection, out deviceTypesCount);
			titleIds = Converters.ClassArrayToPtr(filters.TitleIds, (uint titleId, DisposableCollection _) => titleId, disposableCollection, out titleIdsCount);
