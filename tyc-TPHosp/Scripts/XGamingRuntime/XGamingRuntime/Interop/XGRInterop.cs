...
namespace XGamingRuntime.Interop
{
	internal class XGRInterop
	{
		...
		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		internal static extern int XPackageGetCurrentProcessPackageIdentifier(SizeT bufferSize, [Out] byte[] buffer);
		...
		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		internal static extern int XPackageGetUserLocale(SizeT localeSize, [Out] byte[] locale);
		...
		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		internal static extern int XPackageMount(byte[] packageIdentifier, out XPackageMountHandle mountHandle);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		internal static extern int XPackageGetMountPathSize(XPackageMountHandle mountHandle, out SizeT pathSize);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		internal static extern int XPackageGetMountPath(XPackageMountHandle mountHandle, SizeT pathSize, [Out] byte[] path);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		internal static extern void XPackageCloseMountHandle(XPackageMountHandle mountHandle);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		internal static extern int XPackageCreateInstallationMonitor(byte[] packageIdentifier, uint selectorCount, [Optional] XPackageChunkSelector[] selectors, uint minimumUpdateIntervalMs, [Optional] XTaskQueueHandle queue, out XPackageInstallationMonitorHandle installationMonitor);
		...
		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		[return: MarshalAs(UnmanagedType.U1)]
		internal static extern bool XPackageUnregisterInstallationProgressChanged(XPackageInstallationMonitorHandle installationMonitor, XTaskQueueRegistrationToken token, [MarshalAs(UnmanagedType.U1)] bool wait);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		internal static extern int XPackageEstimateDownloadSize(byte[] packageIdentifier, uint selectorCount, [Optional] XPackageChunkSelector[] selectors, out ulong downloadSize, [Optional][MarshalAs(UnmanagedType.U1)] out bool shouldPresentUserConfirmation);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreCreateContext(XUserHandle user, out XStoreContextHandle storeContextHandle);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern void XStoreCloseContextHandle(XStoreContextHandle storeContextHandle);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreAcquireLicenseForPackageAsync(XStoreContextHandle storeContextHandle, byte[] packageIdentifier, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreAcquireLicenseForPackageResult(XAsyncBlockPtr asyncBlock, out XStoreLicenseHandle storeLicenseHandle);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreCanAcquireLicenseForPackageAsync(XStoreContextHandle storeContextHandle, byte[] packageIdentifier, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreCanAcquireLicenseForPackageResult(XAsyncBlockPtr asyncBlock, out XStoreCanAcquireLicenseResult storeCanAcquireLicense);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreCanAcquireLicenseForStoreIdAsync(XStoreContextHandle storeContextHandle, byte[] storeProductId, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreCanAcquireLicenseForStoreIdResult(XAsyncBlockPtr asyncBlock, out XStoreCanAcquireLicenseResult storeCanAcquireLicense);
		...
		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryAddOnLicensesAsync(XStoreContextHandle storeContextHandle, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryAddOnLicensesResult(XAsyncBlockPtr asyncBlock, uint count, IntPtr addOnLicenses);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryAddOnLicensesResultCount(XAsyncBlockPtr asyncBlock, out uint count);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryGameLicenseAsync(XStoreContextHandle storeContextHandle, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryGameLicenseResult(XAsyncBlockPtr asyncBlock, out XStoreGameLicense license);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryLicenseTokenAsync(XStoreContextHandle storeContextHandle, IntPtr productIds, SizeT productIdsCount, byte[] customDeveloperString, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryLicenseTokenResult(XAsyncBlockPtr asyncBlock, SizeT size, byte[] result);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryLicenseTokenResultSize(XAsyncBlockPtr asyncBlock, out SizeT size);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreRegisterGameLicenseChanged(XStoreContextHandle storeContextHandle, XTaskQueueHandle queue, IntPtr context, XStoreGameLicenseChangedCallback callback, out XTaskQueueRegistrationToken token);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreRegisterPackageLicenseLost(XStoreLicenseHandle licenseHandle, XTaskQueueHandle queue, IntPtr context, XStorePackageLicenseLostCallback callback, out XTaskQueueRegistrationToken token);
		...
		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryGameAndDlcPackageUpdatesAsync(XStoreContextHandle storeContextHandle, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryGameAndDlcPackageUpdatesResultCount(XAsyncBlockPtr asyncBlock, out uint count);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryGameAndDlcPackageUpdatesResult(XAsyncBlockPtr asyncBlock, uint count, IntPtr packageUpdates);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreDownloadAndInstallPackagesAsync(XStoreContextHandle storeContextHandle, IntPtr storeIds, SizeT storeIdsCount, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreDownloadAndInstallPackagesResultCount(XAsyncBlockPtr asyncBlock, out uint count);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreDownloadAndInstallPackagesResult(XAsyncBlockPtr asyncBlock, uint count, [Out] byte[] packageIdentifiers);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreDownloadAndInstallPackageUpdatesAsync(XStoreContextHandle storeContextHandle, IntPtr packageIdentifiers, SizeT packageIdentifiersCount, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreDownloadAndInstallPackageUpdatesResult(XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreDownloadPackageUpdatesAsync(XStoreContextHandle storeContextHandle, IntPtr packageIdentifiers, SizeT packageIdentifiersCount, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreDownloadPackageUpdatesResult(XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryPackageIdentifier(byte[] storeId, SizeT size, [Out] byte[] packageIdentifier);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreShowRedeemTokenUIAsync(XStoreContextHandle storeContextHandle, byte[] token, IntPtr allowedStoreIds, SizeT allowedStoreIdsCount, bool disallowCsvRedeption, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreShowRedeemTokenUIResult(XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreShowRateAndReviewUIAsync(XStoreContextHandle storeContextHandle, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreShowRateAndReviewUIResult(XAsyncBlockPtr asyncBlock, out XStoreRateAndReview result);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreShowPurchaseUIAsync(XStoreContextHandle storeContextHandle, byte[] storeId, [Optional] byte[] name, [Optional] byte[] extendedJsonData, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreShowPurchaseUIResult(XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryConsumableBalanceRemainingAsync(XStoreContextHandle storeContextHandle, byte[] storeProductId, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryConsumableBalanceRemainingResult(XAsyncBlockPtr asyncBlock, out XStoreConsumable result);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreReportConsumableFulfillmentAsync(XStoreContextHandle storeContextHandle, byte[] storeProductId, uint quantity, Guid trackingId, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreReportConsumableFulfillmentResult(XAsyncBlockPtr asyncBlock, out XStoreConsumable result);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreGetUserCollectionsIdAsync(XStoreContextHandle storeContextHandle, byte[] serviceTicket, byte[] publisherUserId, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreGetUserCollectionsIdResultSize(XAsyncBlockPtr asyncBlock, out SizeT size);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreGetUserCollectionsIdResult(XAsyncBlockPtr asyncBlock, SizeT size, [Out] byte[] token);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreGetUserPurchaseIdAsync(XStoreContextHandle storeContextHandle, byte[] serviceTicket, byte[] publisherUserId, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreGetUserPurchaseIdResultSize(XAsyncBlockPtr asyncBlock, out SizeT size);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreGetUserPurchaseIdResult(XAsyncBlockPtr asyncBlock, SizeT size, [Out] byte[] token);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryAssociatedProductsAsync(XStoreContextHandle storeContextHandle, XStoreProductKind productKinds, uint maxItemsToRetrievePerPage, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryAssociatedProductsResult(XAsyncBlockPtr asyncBlock, out XStoreProductQueryHandle productQueryHandle);
		...
		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreEnumerateProductsQuery(XStoreProductQueryHandle productQueryHandle, IntPtr context, XStoreProductQueryCallback callback);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreProductsQueryNextPageAsync(XStoreProductQueryHandle productQueryHandle, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreProductsQueryNextPageResult(XAsyncBlockPtr asyncBlock, out XStoreProductQueryHandle productQueryHandle);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryEntitledProductsAsync(XStoreContextHandle storeContextHandle, XStoreProductKind productKinds, uint maxItemsToRetrievePerPage, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryEntitledProductsResult(XAsyncBlockPtr asyncBlock, out XStoreProductQueryHandle productQueryHandle);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryProductForCurrentGameAsync(XStoreContextHandle storeContextHandle, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryProductForCurrentGameResult(XAsyncBlockPtr asyncBlock, out XStoreProductQueryHandle productQueryHandle);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryProductForPackageAsync(XStoreContextHandle storeContextHandle, XStoreProductKind productKinds, byte[] packageIdentifier, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryProductForPackageResult(XAsyncBlockPtr asyncBlock, out XStoreProductQueryHandle productQueryHandle);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryProductsAsync(XStoreContextHandle storeContextHandle, XStoreProductKind productKinds, IntPtr storeIds, SizeT storeIdsCount, IntPtr actionFilters, SizeT actionFiltersCount, XAsyncBlockPtr asyncBlock);

		[DllImport("XGamingRuntimeThunks", CallingConvention = CallingConvention.StdCall)]
		public static extern int XStoreQueryProductsResult(XAsyncBlockPtr asyncBlock, out XStoreProductQueryHandle productQueryHandle);
