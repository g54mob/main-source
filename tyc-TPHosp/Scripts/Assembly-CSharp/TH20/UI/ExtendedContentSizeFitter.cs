...
namespace TH20.UI
{
	...
	public class ExtendedContentSizeFitter : UIBehaviour, ILayoutSelfController, ILayoutController
	{
		public enum FitMode
		{
			Unconstrained = 0,
		...
		protected ExtendedContentSizeFitter()
		{
		}
		...
		private void HandleSelfFittingAlongAxis(int axis)
		{
			...
			{
				rectTransform.SetSizeWithCurrentAnchorsSafe((RectTransform.Axis)axis, LayoutUtility.GetMinSize(m_Rect, axis));
			}
			else
			{
				rectTransform.SetSizeWithCurrentAnchorsSafe((RectTransform.Axis)axis, LayoutUtility.GetPreferredSize(m_Rect, axis));
			}
		}
