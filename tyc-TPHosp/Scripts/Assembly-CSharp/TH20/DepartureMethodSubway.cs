...
namespace TH20
{
	public class DepartureMethodSubway : DepartureMethod, IAnimationEndEvent
	{
		private readonly DepartureMethodSubwayDefinition _definition;
		...
		public DepartureMethodSubway(DepartureMethodSubwayDefinition definition, Character character, IDepartedCallback callback)
			: base(character, callback)
		{
			_definition = definition;
			Transform transform = DepartureSubwayComponent.RandomSubway().GetTransform();
