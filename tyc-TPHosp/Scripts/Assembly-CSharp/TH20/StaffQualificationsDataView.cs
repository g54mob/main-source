...
namespace TH20
{
	public class StaffQualificationsDataView : IDataViewMode
	{
		...
		public StaffQualificationsDataView(DataViewManager.Config config, VisualManager visualManager, Level level)
		{
