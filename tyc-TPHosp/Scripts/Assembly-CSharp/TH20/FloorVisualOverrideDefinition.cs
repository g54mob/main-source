...
namespace TH20
{
	[CreateAssetMenu(menuName = "TH20/Floor Visual Override Definition", order = 1033)]
	public class FloorVisualOverrideDefinition : ScriptableObjectWithID, IFloorVisualOverrideDefinition, ISilverUnlockable, ISilverUnlockToken
	{
		[SerializeField]
