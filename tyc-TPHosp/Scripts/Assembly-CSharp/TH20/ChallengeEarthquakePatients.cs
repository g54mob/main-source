...
namespace TH20
{
	public class ChallengeEarthquakePatients : ChallengeEarthquake, IPatientSpawned
	{
		...
		private readonly ChallengeEarthquakePatientsConfig _config;
		...
		public ChallengeEarthquakePatients(ChallengeConfig config, Level level)
			: base(config, level)
		{
			_config = GetConfig<ChallengeEarthquakePatientsConfig>();
