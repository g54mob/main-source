...
namespace TH20
{
	public class AdvisorTriggerPatientEnvironmentCheckDefinition : AdvisorTriggerDefinition
	{
		[Header("Patient Attribute Check")]
		[Tooltip("The patient attribute we are checking")]
		public AdvisorTriggerPatientEnvironmentCheck.EnvironmentalCheck EnvironmentCheck = AdvisorTriggerPatientEnvironmentCheck.EnvironmentalCheck.Attractiveness;
		...
		{
			return new AdvisorTriggerPatientEnvironmentCheck(this);
		}
	}
}
