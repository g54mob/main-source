...
namespace TH20
{
	...
	public class StaffChallengeSubGoalDefinitionCompleteMaintenanceJobs : SubGoalDefinition
	{
		...
		{
			return new StaffChallengeLevelObjectiveCompleteMaintenanceJobs(owner, this);
		}
