...
namespace TH20
{
	...
	public class ArrivalHelipadComponent : ArrivalBaseComponent
	{
		private static readonly ArrivalVehicleFlowControl _control = new ArrivalVehicleFlowControl();

		private static readonly List<ArrivalHelipadComponent> _spawnPoints = new List<ArrivalHelipadComponent>();

		public static List<ArrivalHelipadComponent> SpawnPoints => _spawnPoints;
