...
namespace IdSharp.Tagging.ID3v2
{
	public static class LanguageHelper
	{
		...
		public static Dictionary<string, string> Languages => m_Languages;

		public static string[] SortedLanguages => m_SortedLanguages;

		static LanguageHelper()
		{
			m_SortedLanguages = new string[403]
			{
				"Abkhazian", "Achinese", "Acoli", "Adangme", "Afar", "Afrihili", "Afrikaans", "Afro-Asiatic (Other)", "Akan", "Akkadian",
				"Albanian", "Aleut", "Algonquian Languages", "Altaic (Other)", "Amharic", "Apache Languages", "Arabic", "Aramaic", "Arapaho", "Araucanian",
				"Arawak", "Armenian", "Artificial (Other)", "Assamese", "Athapascan Languages", "Austronesian (Other)", "Avaric", "Avestan", "Awadhi", "Aymara",
				"Azerbaijani", "Aztec", "Balinese", "Baltic (Other)", "Baluchi", "Bambara", "Bamileke Languages", "Banda", "Bantu (Other)", "Basa",
				"Bashkir", "Basque", "Beja", "Bemba", "Bengali", "Berber (Other)", "Bhojpuri", "Bihari", "Bikol", "Bini",
				"Bislama", "Bosnian", "Braj", "Breton", "Buginese", "Bulgarian", "Buriat", "Burmese", "Byelorussian", "Caddo",
				"Carib", "Catalan", "Caucasian (Other)", "Cebuano", "Celtic (Other)", "Central American Indian (Other)", "Chagatai", "Chamorro", "Chechen", "Cherokee",
				"Cheyenne", "Chibcha", "Chinese", "Chinook jargon", "Choctaw", "Church Slavic", "Chuvash", "Coptic", "Cornish", "Corsican",
				"Cree", "Creek", "Creoles and Pidgins (Other)", "Creoles and Pidgins, English-based (Other)", "Creoles and Pidgins, French-based (Other)", "Creoles and Pidgins, Portuguese-based (Other)", "Croatian", "Cushitic (Other)", "Czech", "Dakota",
				"Danish", "Delaware", "Dinka", "Divehi", "Dogri", "Dravidian (Other)", "Duala", "Dutch", "Dutch, Middle (ca. 1050-1350)", "Dyula",
				"Dzongkha", "Efik", "Egyptian (Ancient)", "Ekajuk", "Elamite", "English", "English, Old (ca. 450-1100)", "Eskimo (Other)", "Esperanto", "Estonian",
				"Ewe", "Ewondo", "Fang", "Fanti", "Faroese", "Fijian", "Finnish", "Finno-Ugrian (Other)", "Fon", "French",
				"French, Middle (ca. 1400-1600)", "French, Old (842- ca. 1400)", "Frisian", "Fulah", "Ga", "Gaelic (Scots)", "Gallegan", "Ganda", "Gayo", "Geez",
				"Georgian", "German", "German, Middle High (ca. 1050-1500)", "German, Old High (ca. 750-1050)", "Germanic (Other)", "Gilbertese", "Gondi", "Gothic", "Grebo", "Greek",
				"Greek, Ancient (to 1453)", "Greenlandic", "Guarani", "Gujarati", "Haida", "Hausa", "Hawaiian", "Hebrew", "Herero", "Hiligaynon",
				"Himachali", "Hindi", "Hiri Motu", "Hungarian", "Hupa", "Iban", "Icelandic", "Igbo", "Ijo", "Iloko",
				"Indic (Other)", "Indo-European (Other) Interlingue", "Indonesian", "Interlingua (International Auxiliary language Association)", "Inuktitut", "Inupiak", "Iranian (Other)", "Irish", "Irish, Middle (900 - 1200)", "Irish, Old (to 900)",
				"Iroquoian uages", "Italian", "Japanese", "Javanese", "Judeo-Arabic", "Judeo-Persian", "Kabyle", "Kachin", "Kamba", "Kannada",
				"Kanuri", "Kara-Kalpak", "Karen", "Kashmiri", "Kawi", "Kazakh", "Khasi", "Khmer", "Khoisan (Other)", "Khotanese",
				"Kikuyu", "Kinyarwanda", "Kirghiz", "Komi", "Kongo", "Konkani", "Korean", "Kpelle", "Kru", "Kuanyama",
				"Kumyk", "Kurdish", "Kurukh", "Kusaie", "Kutenai", "Ladino", "Lahnda", "Lamba", "Langue d'Oc (post 1500)", "Lao",
				"Latin", "Latvian", "Letzeburgesch", "Lezghian", "Lingala", "Lithuanian", "Lozi", "Luba-Katanga", "Luiseno", "Lunda",
				"Luo (Kenya and Tanzania)", "Macedonian", "Macedonian Makasar", "Madurese", "Magahi", "Maithili", "Malagasy", "Malay", "Malayalam", "Maltese",
				"Mandingo", "Manipuri", "Manobo Languages", "Manx", "Maori", "Marathi", "Mari", "Marshall", "Marwari", "Masai",
				"Mayan Languages", "Mende", "Micmac", "Middle English (ca. 1100-1500)", "Minangkabau", "Miscellaneous (Other)", "Mohawk", "Moldavian", "Mongo", "Mongolian",
				"Mon-Kmer (Other)", "Mossi", "Multiple Languages", "Munda Languages", "Nauru", "Navajo", "Ndebele, North", "Ndebele, South", "Ndongo", "Nepali",
				"Newari", "Niger-Kordofanian (Other)", "Nilo-Saharan (Other)", "Niuean", "Norse, Old", "North American Indian (Other)", "Norwegian", "Norwegian (Nynorsk)", "Nubian Languages", "Nyamwezi",
				"Nyanja", "Nyankole", "Nyoro", "Nzima", "Ojibwa", "Oriya", "Oromo", "Osage", "Ossetic", "Otomian Languages",
				"Pahlavi", "Palauan", "Pali", "Pampanga", "Pangasinan", "Panjabi", "Papiamento", "Papuan-Australian (Other)", "Persian", "Persian, Old (ca 600 - 400 B.C.)",
				"Phoenician", "Polish", "Ponape", "Portuguese", "Prakrit uages", "Provencal, Old (to 1500)", "Pushto", "Quechua", "Rajasthani", "Rarotongan",
				"Rhaeto-Romance", "Romance (Other)", "Romanian", "Romany", "Rundi", "Russian", "Salishan Languages", "Samaritan Aramaic", "Sami Languages", "Samoan",
				"Sandawe", "Sango", "Sanskrit", "Sardinian", "Scots", "Selkup", "Semitic (Other)", "Serbian", "Serer", "Shan",
				"Shona", "Sidamo", "Siksika", "Sindhi", "Singhalese", "Sino-Tibetan (Other)", "Siouan Languages", "Siswant Swazi", "Slavic (Other)", "Slovak",
				"Slovenian", "Sogdian", "Somali", "Songhai", "Sorbian Languages", "Sotho, Northern", "Sotho, Southern", "South American Indian (Other)", "Spanish", "Sudanese",
				"Sukuma", "Sumerian", "Susu", "Swahili", "Swedish", "Syriac", "Tagalog", "Tahitian", "Tajik", "Tamashek",
				"Tamil", "Tatar", "Telugu", "Tereno", "Thai", "Tibetan", "Tigre", "Tigrinya", "Timne", "Tivi",
				"Tlingit", "Tokelau", "Tonga (Nyasa)", "Tonga (Tonga Islands)", "Truk", "Tsimshian", "Tsonga", "Tswana", "Tumbuka", "Turkish",
				"Turkish, Ottoman (1500 - 1928)", "Turkmen", "Tuvinian", "Twi", "Ugaritic", "Uighur", "Ukrainian", "Umbundu", "Undetermined", "Urdu",
				"Uzbek", "Vai", "Venda", "Vietnamese", "Volapük", "Votic", "Wakashan Languages", "Walamo", "Waray", "Washo",
				"Welsh", "Wolof", "Xhosa", "Yakut", "Yao", "Yap", "Yiddish", "Yoruba", "Zapotec", "Zenaga",
				"Zhuang", "Zulu", "Zuni"
			};
