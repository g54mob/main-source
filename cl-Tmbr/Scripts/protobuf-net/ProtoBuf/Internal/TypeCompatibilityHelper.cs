...
namespace ProtoBuf.Internal
{
	internal static class TypeCompatibilityHelper
	{
		...
		internal static CompatibilityLevel GetModuleCompatibilityLevel(Module module)
		{
			...
			{
				if (Attribute.GetCustomAttribute(module2, typeof(CompatibilityLevelAttribute), inherit: true) is CompatibilityLevelAttribute { Level: >CompatibilityLevel.NotSpecified } compatibilityLevelAttribute)
				{
					return compatibilityLevelAttribute.Level;
				}
				Assembly assembly = module2.Assembly;
				if ((object)assembly != null && Attribute.GetCustomAttribute(assembly, typeof(CompatibilityLevelAttribute), inherit: true) is CompatibilityLevelAttribute { Level: >CompatibilityLevel.NotSpecified } compatibilityLevelAttribute2)
				{
		...
		{
			if (Attribute.GetCustomAttribute(type, typeof(CompatibilityLevelAttribute), inherit: true) is CompatibilityLevelAttribute { Level: >CompatibilityLevel.NotSpecified } compatibilityLevelAttribute)
			{
				return compatibilityLevelAttribute.Level;
			}
		...
		{
			if (!(Attribute.GetCustomAttribute(member, typeof(CompatibilityLevelAttribute), inherit: true) is CompatibilityLevelAttribute { Level: >CompatibilityLevel.NotSpecified } compatibilityLevelAttribute))
			{
				return typeLevel;
			}
			return compatibilityLevelAttribute.Level;
