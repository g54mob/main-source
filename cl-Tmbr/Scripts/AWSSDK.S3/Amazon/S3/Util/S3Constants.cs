...
namespace Amazon.S3.Util
{
	internal static class S3Constants
	{
		...
		internal static string AmzHeaderArchiveStatus = "x-amz-archive-status";

		internal static string AmzHeaderBucketKeyEnabled = "x-amz-server-side-encryption-bucket-key-enabled";

		internal static string AmzHeaderExpectedBucketOwner = "x-amz-expected-bucket-owner";

		internal static string AmzHeaderExpectedSourceBucketOwner = "x-amz-source-expected-bucket-owner";
		...
		internal static string AmzHeaderSkipDestinationValidation = "x-amz-skip-destination-validation";

		internal static string AmzHeaderChecksumAlgorithm = "x-amz-checksum-algorithm";

		internal static string AmzHeaderChecksumType = "x-amz-checksum-type";

		internal static string AmzHeaderSdkChecksumAlgorithm = "x-amz-sdk-checksum-algorithm";

		internal static string AmzHeaderChecksumMode = "x-amz-checksum-mode";

		internal static string AmzHeaderIfMatchInitiatedTime = "x-amz-if-match-initiated-time";

		internal static string AmzHeaderIfMatchLastModifiedTime = "x-amz-if-match-last-modified-time";

		internal static string AmzHeaderIfMatchSize = "x-amz-if-match-size";

		internal static string AmzOptionalObjectAttributes = "x-amz-optional-object-attributes";

		internal static string AmzHeaderRestoreOutputPath = "x-amz-restore-output-path";
		...
		internal static readonly string[] BucketVersions = new string[3] { "", "V1", "V2" };

		internal const string REGION_US_EAST_1 = "us-east-1";

		internal const string REGION_EU_WEST_1 = "eu-west-1";

		internal static readonly string[] MetadataDirectives = new string[2] { "COPY", "REPLACE" };
		...
		internal static HashSet<string> GetObjectExtraSubResources = new HashSet<string> { "response-cache-control", "response-content-disposition", "response-content-encoding", "response-content-language", "response-content-type", "response-expires" };
