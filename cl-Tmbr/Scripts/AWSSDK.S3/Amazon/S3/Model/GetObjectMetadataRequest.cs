...
namespace Amazon.S3.Model
{
	public class GetObjectMetadataRequest : AmazonWebServiceRequest
	{
		...
		public string ResponseContentDisposition
		{
			get
			{
				return _responseContentDisposition;
			}
			set
			{
				_responseContentDisposition = value;
			}
		}
		...
		public string ResponseContentEncoding
		{
			...
			set
			{
				_responseContentEncoding = value;
			}
		}
		...
		public string ResponseContentLanguage
		{
			get
			{
				return _responseContentLanguage;
			}
			set
			{
				_responseContentLanguage = value;
			}
		}
		...
		{
			return _responseCacheControl != null;
		}

		internal bool IsSetResponseContentDisposition()
		{
			return _responseContentDisposition != null;
		}

		internal bool IsSetResponseContentEncoding()
		{
			return _responseContentEncoding != null;
		}

		internal bool IsSetResponseContentLanguage()
		{
			return _responseContentLanguage != null;
		}

		internal bool IsSetResponseContentType()
		{
			return _responseContentType != null;
		}

		internal bool IsSetResponseExpires()
		{
			return _responseExpires.HasValue;
		}
	}
}
