		...
		public LifecycleRule Unmarshall(XmlUnmarshallerContext context)
		{
			...
			while (context.Read())
			{
				if (context.IsStartElement || context.IsAttribute)
				{
					...
					{
						if (lifecycleRule.Transitions == null)
						{
							lifecycleRule.Transitions = new List<LifecycleTransition>();
						}
					...
					{
						if (lifecycleRule.NoncurrentVersionTransitions == null)
						{
							lifecycleRule.NoncurrentVersionTransitions = new List<LifecycleRuleNoncurrentVersionTransition>();
						}
