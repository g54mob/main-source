...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
	public class GetObjectRequestMarshaller : IMarshaller<IRequest, GetObjectRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
	{
		...
		public IRequest Marshall(GetObjectRequest getObjectRequest)
		{
			...
			{
				request.Headers.Add("If-Modified-Since", S3Transforms.ToStringValue(getObjectRequest.ModifiedSinceDate.Value));
			}
			...
			{
				request.Headers.Add("If-Unmodified-Since", S3Transforms.ToStringValue(getObjectRequest.UnmodifiedSinceDate.Value));
			}
			...
			{
				throw new ArgumentException("BucketName is a required property and must be set before making this call.", "GetObjectRequest.BucketName");
			}
			if (string.IsNullOrEmpty(getObjectRequest.Key))
			{
				throw new ArgumentException("Key is a required property and must be set before making this call.", "GetObjectRequest.Key");
