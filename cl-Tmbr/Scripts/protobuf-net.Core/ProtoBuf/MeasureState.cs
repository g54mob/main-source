...
namespace ProtoBuf
{
	public struct MeasureState<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors | DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.NonPublicMethods | DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.NonPublicFields | DynamicallyAccessedMemberTypes.PublicNestedTypes | DynamicallyAccessedMemberTypes.NonPublicNestedTypes | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.NonPublicProperties)] T> : IDisposable
	{
		...
		private readonly void SerializeCore(ProtoWriter.State state)
		{
			try
			{
				ProtoWriter writer = _writer ?? throw new ObjectDisposedException("MeasureState");
		...
		internal readonly int GetLengthHits(out int misses)
		{
		...
		public readonly void Serialize(IBufferWriter<byte> writer)
		{
