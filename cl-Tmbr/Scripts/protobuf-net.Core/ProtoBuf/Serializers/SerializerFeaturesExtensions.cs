...
namespace ProtoBuf.Serializers
{
	internal static class SerializerFeaturesExtensions
	{
		...
		{
			return (features & (SerializerFeatures.OptionPackedDisabled | SerializerFeatures.OptionWrappedValue)) != 0;
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool IsScalar(this SerializerFeatures features)
		{
			return features.GetCategory() == SerializerFeatures.CategoryScalar;
		}
		...
		{
			return (features & (SerializerFeatures)31) == SerializerFeatures.WireTypeStartGroup;
		}
