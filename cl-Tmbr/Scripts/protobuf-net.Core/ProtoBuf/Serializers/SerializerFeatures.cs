...
namespace ProtoBuf.Serializers
{
	...
	public enum SerializerFeatures
	{
		...
		OptionWrappedValue = 0x800,
		OptionWrappedValueGroup = 0x1000,
		OptionWrappedValueFieldPresence = 0x2000,
		OptionWrappedCollection = 0x4000,
		OptionWrappedCollectionGroup = 0x8000
	}
}
