...
namespace ProtoBuf.Internal
{
	internal static class ThrowHelper
	{
		...
		{
			InvalidOperationException ex = new InvalidOperationException("No serializer defined for type: " + type.NormalizeName());
			if ((object)type != null && type.FindInterfaces((Type i, object _) => i.FullName == "Google.Protobuf.IMessage", null).Length != 0)
			{
				try
				{
					throw ex;
				...
				{
					ex = new InvalidOperationException("Type '" + type.NormalizeName() + "' looks like a Google.Protobuf type; it cannot be used directly with protobuf-net without manual configuration; it may be possible to generate a protobuf-net type instead; see https://protobuf-net.github.io/protobuf-net/contract_first", innerException);
				}
			}
			throw ex;
		}
