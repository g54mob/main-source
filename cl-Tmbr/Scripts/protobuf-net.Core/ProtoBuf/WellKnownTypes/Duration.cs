...
namespace ProtoBuf.WellKnownTypes
{
	...
	public readonly struct Duration
	{
		...
		{
			Seconds = PrimaryTypeProvider.ToDurationSeconds(ticks, out var nanos, isTimestamp: false);
			Nanoseconds = nanos;
		}

		public TimeSpan AsTimeSpan()
		{
			return TimeSpan.FromTicks(ToTicks());
		}

		internal long ToTicks()
		{
			return PrimaryTypeProvider.ToTicks(Seconds, Nanoseconds);
		}
