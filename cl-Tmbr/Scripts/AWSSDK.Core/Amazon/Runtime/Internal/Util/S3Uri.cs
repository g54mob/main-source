...
namespace Amazon.Runtime.Internal.Util
{
	public class S3Uri
	{
		...
		private static readonly Regex _s3EndpointRegex = new Regex("^(.+\\.)?s3[.-]([a-z0-9-]+)\\.", RegexOptions.Compiled);

		private static readonly Regex _s3ControlExlusionRegex = new Regex("^(.+\\.)?s3-control\\.", RegexOptions.Compiled);
		...
		{
			return _s3EndpointRegex;
		}

		private static Regex S3ControlExlusionRegex()
		{
			return _s3ControlExlusionRegex;
		}
