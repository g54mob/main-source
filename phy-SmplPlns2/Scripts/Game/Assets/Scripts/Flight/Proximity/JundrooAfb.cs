...
{
	public class JundrooAfb : ProximityLoadedObject
	{
		protected virtual string TerrainPrefabPath
		{
			get
			{
				...
				{
					EnvironmentQualitySettings.TerrainQualityLevel.High => "Terrain/JundrooAfbTerrain", 
					EnvironmentQualitySettings.TerrainQualityLevel.Medium => "Terrain/JundrooAfbTerrain", 
					_ => "Terrain/JundrooAfbTerrain", 
				};
			}
		}
