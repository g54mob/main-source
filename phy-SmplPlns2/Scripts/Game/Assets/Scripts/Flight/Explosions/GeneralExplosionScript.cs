...
{
	public class GeneralExplosionScript : ExplosionBaseScript
	{
		[Serializable]
		private class DebrisComponent
		{
			...
			public void Awake()
			{
				if (Prefab == null)
				{
					Debug.LogError("General explosion debris prefab not found");
				}
				else if (Config == null)
				{
					Debug.LogError("General explosion debris configuration not found");
				}
			}
		}
		...
		private class ExplosionCoreComponent
		{
			...
			public void Awake()
			{
				if (Object == null)
				{
					Debug.LogError("General explosion core component object not found");
				}
				else if (Config == null)
				{
					Debug.LogError("General explosion core component configuration not found");
				}
		...
		private class ExplosionSoundComponent
		{
			...
			public void Awake()
			{
				if (Object == null)
				{
					Debug.LogError("General explosion sound component object not found");
				}
				else if (Config == null)
				{
					Debug.LogError("General explosion sound component configuration not found");
				}
		...
		private class ExplosionSparksComponent
		{
			...
			public void Awake()
			{
				if (Object == null)
				{
					Debug.LogError("General explosion sparks component object not found");
				}
				else if (Config == null)
				{
					Debug.LogError("General explosion sparks component configuration not found");
				}
				ParticleSystem = Object.GetComponent<ParticleSystem>();
			}
		...
		private class ExplosiveForceComponent
		{
			...
			public void Awake()
			{
				if (Object == null)
				{
					Debug.LogError("General explosive force component object not found");
				}
				else if (Config == null)
				{
					Debug.LogError("General explosive force component configuration not found");
				}
		...
		public override void Explode(float scale, Vector3? blastDirection, AircraftScript owner, Rigidbody ownerBody, Vector3? impactDirection, ExplosiveWeaponImpactType impactType)
		{
			...
			_explosionSound.AudioSource.pitch = 2f / _scale;
			_explosionSound.AudioSource.PlayDelayed(Vector3.Distance(CameraManagerScript.Instance.CameraTransform.position, base.transform.position) / 340.29f);
