...
namespace Web.Client.Models
{
	...
	public class RequiredModModel
	{
		...
		public static RequiredModModel CreateFromXml(XElement xml)
		{
			...
			bool valueOrDefault = (bool?)xml.Attribute("requiresCodeExecution") == true;
			return new RequiredModModel(name, author, version, lastModified, steamWorkshopId, valueOrDefault);
		}
