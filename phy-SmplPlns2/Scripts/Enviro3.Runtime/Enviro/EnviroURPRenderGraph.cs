...
namespace Enviro
{
	public class EnviroURPRenderGraph : ScriptableRenderPass
	{
		...
		{
			PassData passData;
			using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PassData>(passName, out passData, "C:\\Users\\avgar\\dev\\SimplePlanes2\\SimplePlanesNext\\Assets\\Packages\\ThirdParty\\Enviro3\\Scripts\\Runtime\\Base\\Renderer\\EnviroURPRenderGraph.cs", 52);
			passData.src = src;
		...
		{
			PassData passData;
			using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PassData>(passName, out passData, "C:\\Users\\avgar\\dev\\SimplePlanes2\\SimplePlanesNext\\Assets\\Packages\\ThirdParty\\Enviro3\\Scripts\\Runtime\\Base\\Renderer\\EnviroURPRenderGraph.cs", 76);
			passData.src = src;
			passData.target = target;
		...
		{
			PassData passData;
			using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PassData>(passName, out passData, "C:\\Users\\avgar\\dev\\SimplePlanes2\\SimplePlanesNext\\Assets\\Packages\\ThirdParty\\Enviro3\\Scripts\\Runtime\\Base\\Renderer\\EnviroURPRenderGraph.cs", 109);
			passData.src = src;
			passData.target = target;
			passData.read1 = read1;
			passData.read1Name = read1Name;
		...
		public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
		{
			...
			PassData passData;
			using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PassData>("Enviro 3 Copy Texture", out passData, "C:\\Users\\avgar\\dev\\SimplePlanes2\\SimplePlanesNext\\Assets\\Packages\\ThirdParty\\Enviro3\\Scripts\\Runtime\\Base\\Renderer\\EnviroURPRenderGraph.cs", 267))
			{
			...
			if (EnviroManager.instance.Fog != null && EnviroManager.instance.VolumetricClouds != null && flag && flag2)
			{
				...
				if (EnviroManager.instance.VolumetricClouds.settingsGlobal.cloudShadows && universalCameraData.camera.cameraType != CameraType.Reflection)
				{
					...
					EnviroManager.instance.VolumetricClouds.RenderVolumetricCloudsURP(this, renderGraph, universalResourceData, universalCameraData, textureHandle2, textureHandle3, cloudsRenderer, qualityForCamera);
					EnviroManager.instance.VolumetricClouds.RenderCloudsShadowsURP(this, renderGraph, universalResourceData, universalCameraData, textureHandle3, universalResourceData.activeColorTexture, cloudsRenderer);
				}
				else
				{
					EnviroManager.instance.VolumetricClouds.RenderVolumetricCloudsURP(this, renderGraph, universalResourceData, universalCameraData, textureHandle2, universalResourceData.activeColorTexture, cloudsRenderer, qualityForCamera);
				}
			}
			else if (EnviroManager.instance.VolumetricClouds != null && flag && !flag2)
			{
				...
				if (EnviroManager.instance.VolumetricClouds.settingsGlobal.cloudShadows && universalCameraData.camera.cameraType != CameraType.Reflection)
				{
					TextureHandle textureHandle4 = UniversalRenderer.CreateRenderGraphTexture(renderGraph, cameraTargetDescriptor, "Temp1", clear: false);
					EnviroManager.instance.VolumetricClouds.RenderVolumetricCloudsURP(this, renderGraph, universalResourceData, universalCameraData, textureHandle, textureHandle4, cloudsRenderer2, qualityForCamera);
					EnviroManager.instance.VolumetricClouds.RenderCloudsShadowsURP(this, renderGraph, universalResourceData, universalCameraData, textureHandle4, universalResourceData.activeColorTexture, cloudsRenderer2);
				}
				else
				{
					EnviroManager.instance.VolumetricClouds.RenderVolumetricCloudsURP(this, renderGraph, universalResourceData, universalCameraData, textureHandle, universalResourceData.activeColorTexture, cloudsRenderer2, qualityForCamera);
				}
			}
