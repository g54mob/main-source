		...
		public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
		{
			...
			if (EnviroManager.instance.Fog != null && EnviroManager.instance.VolumetricClouds != null && flag && flag2)
			{
				...
				if (EnviroManager.instance.VolumetricClouds.settingsGlobal.cloudShadows && renderingData.cameraData.camera.cameraType != CameraType.Reflection)
				{
					...
					EnviroManager.instance.VolumetricClouds.RenderVolumetricCloudsURP(renderingData, this, commandBuffer, temporary2, temporary3, cloudsRenderer, qualityForCamera);
					EnviroManager.instance.VolumetricClouds.RenderCloudsShadowsURP(this, renderingData.cameraData.camera, commandBuffer, temporary3, nameID, cloudsRenderer);
					RenderTexture.ReleaseTemporary(temporary3);
				}
				else
				{
					EnviroManager.instance.VolumetricClouds.RenderVolumetricCloudsURP(renderingData, this, commandBuffer, temporary2, nameID, cloudsRenderer, qualityForCamera);
				}
			...
			else if (EnviroManager.instance.VolumetricClouds != null && flag && !flag2)
			{
				...
				if (EnviroManager.instance.VolumetricClouds.settingsGlobal.cloudShadows && renderingData.cameraData.camera.cameraType != CameraType.Reflection)
				{
					...
					EnviroManager.instance.VolumetricClouds.RenderVolumetricCloudsURP(renderingData, this, commandBuffer, temporary, temporary4, cloudsRenderer2, qualityForCamera);
					EnviroManager.instance.VolumetricClouds.RenderCloudsShadowsURP(this, renderingData.cameraData.camera, commandBuffer, temporary4, nameID, cloudsRenderer2);
					RenderTexture.ReleaseTemporary(temporary4);
				}
				else
				{
					EnviroManager.instance.VolumetricClouds.RenderVolumetricCloudsURP(renderingData, this, commandBuffer, temporary, nameID, cloudsRenderer2, qualityForCamera);
				}
				context.ExecuteCommandBuffer(commandBuffer);
			}
