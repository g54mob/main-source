...
{
	[AddComponentMenu("")]
	public class OCCDQQQOQD : MonoBehaviour
	{
		public static void OOOQOCDODC(ERCrossings scr, ref float firstSegmentDistance)
		{
			...
			{
				Vector3 vector = OODOCQDDQD(j, cornerRadius, angle);
			...
			{
				Vector3 vector = OODOCQDDQD(k, cornerRadius, 0f - angle);
				Vector3 item = new Vector3(vector.x + num, 0f, vector.z + num2 + cornerRadius);
				vecs.Add(item);
			}
			OOQOOQQOQQ(ref vecs, 0f, 1f, 1f, 0f);
			...
			{
				Vector3 vector = OODOCQDDQD(l, cornerRadius, 0f - angle);
				Vector3 item = new Vector3(0f - vector.x - num, 0f, vector.z + num2 + cornerRadius);
				vecs.Add(item);
			}
			OOQOOQQOQQ(ref vecs, 0f, 1f, -1f, 0f);
		...
		public static void OOQQQOCCOQ(ERCrossings scr)
		{
			if (scr.startConnectionV3[0][0].z != scr.startConnectionV3[1][0].z)
			{
				if (scr.startConnectionV3[0][0].z > scr.startConnectionV3[1][0].z)
				{
					OOQQOOCDQC(scr.startConnectionV3[0], scr.startConnectionV3[1][0].z, 0f, -1f, 1f, 1);
				}
				else
				{
					OOQQOOCDQC(scr.startConnectionV3[1], scr.startConnectionV3[0][0].z, 0f, -1f, 1f, 1);
				}
			}
			if (scr.endConnectionV3[0][0].z != scr.endConnectionV3[1][0].z)
			{
				if (scr.endConnectionV3[0][0].z < scr.endConnectionV3[1][0].z)
				{
					OOQQOOCDQC(scr.endConnectionV3[0], scr.endConnectionV3[1][0].z, 0f, 1f, 1f, 1);
				}
				else
				{
					OOQQOOCDQC(scr.endConnectionV3[1], scr.endConnectionV3[0][0].z, 0f, 1f, 1f, 1);
				}
			}
			if (scr.leftConnectionV3[0][0].x != scr.leftConnectionV3[1][0].x)
			{
				if (scr.leftConnectionV3[0][0].x > scr.leftConnectionV3[1][0].x)
				{
					OOQQOOCDQC(scr.leftConnectionV3[0], scr.leftConnectionV3[1][0].x, -1f, 0f, 1f, 0);
				}
				else
				{
					OOQQOOCDQC(scr.leftConnectionV3[1], scr.leftConnectionV3[0][0].x, -1f, 0f, 1f, 0);
				}
			}
			if (scr.rightConnectionV3[0][0].x != scr.rightConnectionV3[1][0].x)
			{
				if (scr.rightConnectionV3[0][0].x < scr.rightConnectionV3[1][0].x)
				{
					OOQQOOCDQC(scr.rightConnectionV3[0], scr.rightConnectionV3[1][0].x, 1f, 0f, 1f, 0);
				}
				else
				{
					OOQQOOCDQC(scr.rightConnectionV3[1], scr.rightConnectionV3[0][0].x, 1f, 0f, 1f, 0);
				}
			}
		}
