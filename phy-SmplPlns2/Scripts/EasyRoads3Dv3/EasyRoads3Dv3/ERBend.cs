...
namespace EasyRoads3Dv3
{
	...
	public class ERBend : MonoBehaviour
	{
		...
		public void OCDOCDOODQ()
		{
			...
			{
				rightOuterSegments.Add(ERRoundabouts.OOQOCODQOO(vector, pivot, Quaternion.Euler(0f, num3 + (float)i * num2, 0f)));
				rightInnerSegments.Add(ERRoundabouts.OOQOCODQOO(vector2, pivot, Quaternion.Euler(0f, num3 + (float)i * num2, 0f)));
				leftOuterSegments.Add(ERRoundabouts.OOQOCODQOO(vector3, pivot, Quaternion.Euler(0f, num3 + (float)i * num2, 0f)));
				leftInnerSegments.Add(ERRoundabouts.OOQOCODQOO(vector4, pivot, Quaternion.Euler(0f, num3 + (float)i * num2, 0f)));
