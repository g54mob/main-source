...
namespace Mystery.Graphing
{
	public class StringGraphConsole : SingleGraphConsole
	{
		...
		public StringGraphConsole(string name, StringLineGraphOverTime graph)
			: base(name, graph)
		{
		}
		...
		public void Push(float time, string value)
		{
			...
			((StringLineGraphOverTime)base.Graph).AddPoint(time, value, nextColor);
			previous = value;
		}

		public void Push(float time, string value, Color color)
		{
			((StringLineGraphOverTime)base.Graph).AddPoint(time, value, color);
		}
	}
}
