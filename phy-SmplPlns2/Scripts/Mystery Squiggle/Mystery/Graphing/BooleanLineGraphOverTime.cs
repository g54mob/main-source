...
{
	public class BooleanLineGraphOverTime : LineGraphOverTime<bool>
	{
		private static BooleanValueTransformer defaultRangeTransformer;
		...
		public override ValueTransformer<bool> ValueTransformerY
		{
			get
			{
				if (defaultRangeTransformer == null)
				{
					defaultRangeTransformer = new BooleanValueTransformer();
				}
				return defaultRangeTransformer;
			}
		}

		public override ValueRange<bool> CreateRangeY()
		{
