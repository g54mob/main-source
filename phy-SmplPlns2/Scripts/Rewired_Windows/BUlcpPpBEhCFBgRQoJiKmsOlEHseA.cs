...
internal sealed class BUlcpPpBEhCFBgRQoJiKmsOlEHseA : IDisposable
{
	...
	private class kSHMsQvFhpFHhieDUaUGzTybMOUFb : IDisposable
	{
		...
		public XxZYEvApODnnZPrjCcHCiiChoiaH YxCAeXyJnSPeqRPeSkndOaPAcEhK()
		{
			if (!njrbcIUcjsDIIKjqvFhECgIEEZSx)
			{
				return default(XxZYEvApODnnZPrjCcHCiiChoiaH);
	...
	private const bool YxIgpSgQfqRVXMVdAVbgJJYXPtNcA = false;

	private const int caixRqWBCzmsOStSTnjJcPFiUhRj = 100;

	private const int DnTvLZOslSnjYeeQuewSLNgrqhXX = 10000;
