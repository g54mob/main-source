...
internal static class luYaFPaftNInTWGPWfCvgYuDUqDyA
{
	...
	[SuppressUnmanagedCodeSecurity]
	private unsafe static extern void* ZsSzfpEEKKMZjgWhTAJSfxGDykgg(void* P_0, int P_1, UIntPtr P_2);
	...
	private unsafe static void* eElPGzUTgZkfYxKhCqeKkaOBxTME(void* P_0, byte P_1, int P_2)
	{
		return ZsSzfpEEKKMZjgWhTAJSfxGDykgg(P_0, P_1, new UIntPtr((uint)P_2));
	}
	...
	public unsafe static bool BUzfRBZGHqtbgYeaNDvnAYeQoFsiA(IntPtr P_0, IntPtr P_1, int P_2)
	{
	...
	public unsafe static void RTrDIhhBlYFDfPPpvCPkbihSBsViA(IntPtr P_0, byte P_1, int P_2)
	{
		eElPGzUTgZkfYxKhCqeKkaOBxTME((void*)P_0, P_1, P_2);
	}
	...
	public static int zjJZizaFBmnAmfgcKedCdElHflLDA<_0001>(_0001[] P_0) where _0001 : struct
	{
		if (P_0 != null)
		{
	...
	public static void BQMuUyjawCefNEgpzCcvaHxhdatlA<_0001>(ref _0001 P_0, Action<IntPtr> P_1) where _0001 : struct
	{
	...
	public static void heLmLitUKXhIsvDtcDOOKntGxvkJA<_0001>(_0001[] P_0, Action<IntPtr> P_1) where _0001 : struct
	{
		if (P_0 == null)
		{
			P_1(IntPtr.Zero);
	...
	public unsafe static string msJEMZcglPiZgHTXQkdagGgJtMKZ(IntPtr P_0, int P_1)
	{
		byte* ptr = (byte*)(void*)P_0;
		for (int i = 0; i < P_1; i++)
		{
	...
	public static IntPtr egUVKHLlLhwRfMKoqAWZBrgwYfwOA(string P_0)
	{
	...
	public static string sGWYSYOBevYodeZGFSuDJldOiDLs(string P_0, IEnumerable P_1)
	{
	...
	public static string nsgxkxinCPRjeWoDEcmFEmopeMZoA(string P_0, IEnumerator P_1)
	{
		List<string> list = new List<string>();
		while (P_1.MoveNext())
		{
	...
	public static bool ojoXmaIhXuphPqEfuaVodnaFMlurA(Type P_0)
	{
		return P_0.IsEnum;
	}

	public static bool wkdJsSlseYwxWEXdxMXnfgfDapds(Type P_0)
	{
