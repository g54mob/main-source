...
namespace BCnEncoder.Shared
{
	internal static class ComponentHelper
	{
		public static ColorRgba32 ComponentToColor(ColorComponent component, byte componentValue)
		{
			...
			{
				ColorComponent.R => new ColorRgba32(componentValue, 0, 0, byte.MaxValue), 
				ColorComponent.G => new ColorRgba32(0, componentValue, 0, byte.MaxValue), 
				ColorComponent.B => new ColorRgba32(0, 0, componentValue, byte.MaxValue), 
				ColorComponent.A => new ColorRgba32(0, 0, 0, componentValue), 
				ColorComponent.Luminance => new ColorRgba32(componentValue, componentValue, componentValue, byte.MaxValue), 
		...
		public static byte ColorToComponent(ColorRgba32 color, ColorComponent component)
		{
			return component switch
			{
				...
				ColorComponent.Luminance => (byte)(new ColorYCbCr(color).y * 255f), 
				_ => throw new InvalidOperationException("Unsupported component."), 
			};
		}
	}
