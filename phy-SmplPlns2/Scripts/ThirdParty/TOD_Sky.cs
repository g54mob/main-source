...
public class TOD_Sky : MonoBehaviour
{
	...
	private void UpdateCelestials()
	{
		...
		Quaternion quaternion = Quaternion.Euler(90f - World.Latitude, 0f, 0f) * Quaternion.Euler(0f, World.Longitude, 0f) * Quaternion.Euler(0f, num59 * 57.29578f, 0f);
		...
		float num115 = 4f * Mathf.Tan(MathF.PI / 360f * Moon.MeshSize);
		...
		bool flag5 = Components.Rays != null;
