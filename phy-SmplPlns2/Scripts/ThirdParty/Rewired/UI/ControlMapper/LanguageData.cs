...
namespace Rewired.UI.ControlMapper
{
	...
	public class LanguageData : LanguageDataBase
	{
		...
		[SerializeField]
		private string _mouseAsJoystickSettingsWindowTitle = "Mouse As Joystick Settings";

		[SerializeField]
		private string _mouseAsJoystickSettingsButtonLabel = "Mouse As Joystick";

		[SerializeField]
		private string _advancedSettingsWindowTitle = "Advanced Settings";

		[SerializeField]
		private string _advancedSettingsButtonLabel = "Advanced";
		...
		public override string mouseAsJoystickSettingsWindowTitle => _mouseAsJoystickSettingsWindowTitle;

		public override string mouseAsJoystickSettingsButtonLabel => _mouseAsJoystickSettingsButtonLabel;

		public override string advancedSettingsWindowTitle => _advancedSettingsWindowTitle;

		public override string advancedSettingsButtonLabel => _advancedSettingsButtonLabel;
