...
namespace Rewired.UI.ControlMapper
{
	...
	public abstract class LanguageDataBase : ScriptableObject
	{
		...
		public abstract string mouseAsJoystickSettingsWindowTitle { get; }

		public abstract string mouseAsJoystickSettingsButtonLabel { get; }

		public abstract string advancedSettingsWindowTitle { get; }

		public abstract string advancedSettingsButtonLabel { get; }
