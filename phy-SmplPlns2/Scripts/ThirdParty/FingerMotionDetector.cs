	...
	protected override void ProcessFinger(FingerGestures.Finger finger)
	{
		...
		if (finger.Phase != finger.PreviousPhase)
		{
			...
			case FingerGestures.FingerPhase.Moving:
				flag |= FireEvent(e, EventType.Move, FingerMotionPhase.Ended, finger.Position, !flag);
				break;
			case FingerGestures.FingerPhase.Stationary:
				flag |= FireEvent(e, EventType.Stationary, FingerMotionPhase.Ended, finger.PreviousPosition, !flag);
				break;
			}
			switch (finger.Phase)
			{
			case FingerGestures.FingerPhase.Moving:
				flag |= FireEvent(e, EventType.Move, FingerMotionPhase.Started, finger.PreviousPosition, !flag);
				flag |= FireEvent(e, EventType.Move, FingerMotionPhase.Updated, finger.Position, !flag);
				break;
			case FingerGestures.FingerPhase.Stationary:
				flag |= FireEvent(e, EventType.Stationary, FingerMotionPhase.Started, finger.Position, !flag);
				flag |= FireEvent(e, EventType.Stationary, FingerMotionPhase.Updated, finger.Position, !flag);
				break;
			}
		}
		else
