	...
	public class AFPSCounter : MonoBehaviour
	{
		...
		public bool Background
		{
			...
			set
			{
				...
				background = value;
				if (operationMode != OperationMode.Disabled && labels != null)
				{
					for (int i = 0; i < anchorsCount; i++)
					{
		...
		public bool AutoScale
		{
			...
			set
			{
				...
				{
					autoScale = value;
					if (operationMode != OperationMode.Disabled && labels != null && !(canvasScaler == null))
					{
		...
		public float ScaleFactor
		{
			...
			set
			{
				...
				{
					scaleFactor = value;
					if (operationMode != OperationMode.Disabled && !(canvasScaler == null))
					{
		...
		public int SortingOrder
		{
			...
			set
			{
				...
				{
					sortingOrder = value;
					if (operationMode != OperationMode.Disabled && !(canvas == null))
					{
		...
		private static AFPSCounter GetOrCreateInstance(bool keepAlive)
		{
			...
			AFPSCounter aFPSCounter = UnityEngine.Object.FindFirstObjectByType<AFPSCounter>();
			if (aFPSCounter != null)
			{
		...
		{
			if (inited && operationMode != OperationMode.Disabled)
			{
				ActivateCounters();
