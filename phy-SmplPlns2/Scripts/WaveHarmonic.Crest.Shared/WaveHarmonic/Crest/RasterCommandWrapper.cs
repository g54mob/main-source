...
{
	internal readonly struct RasterCommandWrapper : ICommandWrapper, IPropertyWrapper
	{
		public RasterCommandBuffer Commands { get; }

		public RasterCommandWrapper(RasterCommandBuffer commands)
		{
			Commands = commands;
		}
		...
		{
			Commands.m_WrappedCommandBuffer.SetGlobalTexture(param, value);
		}
