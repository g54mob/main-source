...
namespace Shapes
{
	...
	public class Quad : ShapeRenderer
	{
		...
		{
			Vector3 rhs = (IsUsingAutoD ? DAuto : d);
			Vector3 vector = Vector3.Min(Vector3.Min(Vector3.Min(a, b), c), rhs);
			Vector3 vector2 = Vector3.Max(Vector3.Max(Vector3.Max(a, b), c), rhs);
