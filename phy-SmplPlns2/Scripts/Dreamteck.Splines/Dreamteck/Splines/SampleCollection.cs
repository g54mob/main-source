...
namespace Dreamteck.Splines
{
	...
	public class SampleCollection
	{
		...
		public double TravelUnclampedLoop(double start, float distance, Spline.Direction direction, out float moved)
		{
			moved = 0f;
			if (!hasSamples)
			{
			...
			double result = DMath.Lerp(num, samples[sampleIndex].percent, 1.0 - num6);
			moved -= num5;
			return result;
		}
