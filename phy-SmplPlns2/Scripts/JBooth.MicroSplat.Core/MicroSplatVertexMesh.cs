...
public class MicroSplatVertexMesh : MicroSplatObject
{
	...
	private static List<MicroSplatVertexMesh> sInstances = new List<MicroSplatVertexMesh>();
	...
	public static void ClearMaterialCache(bool sync = true)
	{
	...
	public new static void SyncAll()
	{
		...
		if (MicroSplatVertexMesh.OnMaterialSyncAll != null)
		{
			MicroSplatVertexMesh.OnMaterialSyncAll();
		}
	}
}
