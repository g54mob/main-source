	...
	public class TextureArrayConfig : ScriptableObject
	{
		...
		public class TextureEntry
		{
			...
			public bool HasTextures(PBRWorkflow wf)
			{
				...
				{
					if (!(splat != null) && !(diffuse != null) && !(height != null) && !(normal != null) && !(smoothness != null) && !(specular != null))
					{
						return ao != null;
					}
					return true;
				}
				if (!(splat != null) && !(diffuse != null) && !(height != null) && !(normal != null) && !(smoothness != null) && !(metal != null))
				{
					return ao != null;
				}
				return true;
