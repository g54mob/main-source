...
namespace JBooth.MicroSplat
{
	...
	public class MicroSplatObject : MonoBehaviour
	{
		...
		{
			long num = 3L;
			num *= ((propData == null) ? 3 : propData.GetHashCode()) * 3;
			num *= ((perPixelNormal == null) ? 7 : perPixelNormal.GetNativeTexturePtr().ToInt64()) * 7;
			num *= ((keywordSO == null) ? 11 : keywordSO.GetHashCode()) * 11;
			num *= ((clipMap == null) ? 5 : clipMap.GetNativeTexturePtr().ToInt64()) * 5;
			if (keywordSO != null && keywordSO.IsKeywordEnabled("_PROCTEX"))
			{
				num *= ((procBiomeMask == null) ? 13 : procBiomeMask.GetNativeTexturePtr().ToInt64()) * 13;
				num *= ((procBiomeMask2 == null) ? 81 : procBiomeMask2.GetNativeTexturePtr().ToInt64()) * 81;
				num *= ((cavityMap == null) ? 17 : cavityMap.GetNativeTexturePtr().ToInt64()) * 17;
				num *= ((procTexCfg == null) ? 19 : procTexCfg.GetHashCode()) * 19;
			}
			num *= ((streamTexture == null) ? 41 : streamTexture.GetNativeTexturePtr().ToInt64()) * 41;
			num *= ((geoTextureOverride == null) ? 47 : geoTextureOverride.GetNativeTexturePtr().ToInt64()) * 47;
			num *= ((globalNormalOverride == null) ? 53 : globalNormalOverride.GetNativeTexturePtr().ToInt64()) * 53;
			num *= ((globalSAOMOverride == null) ? 59 : globalSAOMOverride.GetNativeTexturePtr().ToInt64()) * 59;
			num *= ((globalEmisOverride == null) ? 61 : globalEmisOverride.GetNativeTexturePtr().ToInt64()) * 61;
			num *= ((tintMapOverride == null) ? 71 : tintMapOverride.GetNativeTexturePtr().ToInt64()) * 71;
			num *= ((scatterMapOverride == null) ? 79 : scatterMapOverride.GetNativeTexturePtr().ToInt64()) * 79;
			num *= ((snowMaskOverride == null) ? 73 : snowMaskOverride.GetNativeTexturePtr().ToInt64()) * 73;
			if (num == 0L)
			{
