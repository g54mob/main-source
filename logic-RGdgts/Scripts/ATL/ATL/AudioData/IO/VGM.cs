...
{
	internal class VGM : MetaDataIO, IAudioDataIO
	{
		private static readonly byte[] VGM_SIGNATURE;

		private static readonly byte[] GD3_SIGNATURE;

		private static int LOOP_COUNT_DEFAULT;

		private static int FADEOUT_DURATION_DEFAULT;

		private static int RECORDING_RATE_DEFAULT;
