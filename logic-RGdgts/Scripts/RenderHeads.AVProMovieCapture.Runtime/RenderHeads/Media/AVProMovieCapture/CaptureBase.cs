...
namespace RenderHeads.Media.AVProMovieCapture
{
	public class CaptureBase : MonoBehaviour
	{
		...
		private static bool _waitingForAudioCaptureDeviceAuthorisation;

		private static bool _hasCheckedAudioCaptureDeviceAuthorisationStatus;

		private static AudioCaptureDeviceAuthorisationStatus _audioCaptureDeviceAuthorisationStatus;

		private static bool _waitingForAuthorisationToAccessPhotos;

		private static bool _hasCheckedPhotoLibraryAuthorisationStatus;

		private static PhotoLibraryAuthorisationStatus _photoLibraryAuthorisation;
		...
		{
			return default(AudioCaptureDeviceAuthorisationStatus);
		}
		...
		{
			return default(PhotoLibraryAuthorisationStatus);
		}
