...
namespace Pathfinding
{
	...
	{
		public delegate void InterpolateEdge_0000076E_0024PostfixBurstDelegate(ref Int3 p1, ref Int3 p2, uint fractionAlongEdge, out Int3 pos);

		internal static class InterpolateEdge_0000076E_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(InterpolateEdge_0000076E_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static InterpolateEdge_0000076E_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		internal static class OpenSingleEdgeBurst_00000773_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(OpenSingleEdgeBurst_00000773_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static OpenSingleEdgeBurst_00000773_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		public delegate void CalculateBestEdgePosition_00000774_0024PostfixBurstDelegate(ref Int3 s1, ref Int3 s2, ref Int3 pos, out int3 closestPointAlongEdge, out uint quantizedFractionAlongEdge, out uint cost);

		internal static class CalculateBestEdgePosition_00000774_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(CalculateBestEdgePosition_00000774_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static CalculateBestEdgePosition_00000774_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		public int TileIndex => (v0 >> 20) & 0x7FF;
		...
		{
			InterpolateEdge_0000076E_0024BurstDirectCall.Invoke(ref p1, ref p2, fractionAlongEdge, out pos);
		}
				...
				if (connection.isOutgoing)
				{
								...
								if (path.CanTraverse(this, node))
								{
									...
									if (path.ShouldConsiderPathNode(num3))
									{
										if (connection.edgesAreIdentical)
										{
											...
											path.SkipOverNode(num3, pathNodeIndex, PathNode.ReverseFractionAlongEdge(pathNode.fractionAlongEdge), uint.MaxValue, gScore2);
											triangleMeshNode.OpenAtPoint(path, num3, pos, adjacentShapeEdge, gScore2);
										}
										else
										{
					...
					else if (!flag && path.CanTraverse(this, node) && path.ShouldConsiderPathNode(node.NodeIndex))
					{
						...
						else
						{
							...
							ref PathNode reference = ref pathHandler.pathNodes[num4];
		...
		{
			OpenSingleEdgeBurst_00000773_0024BurstDirectCall.Invoke(ref s1, ref s2, ref pos, pathID, pathNodeIndex, candidatePathNodeIndex, candidateNodeIndex, candidateG, ref pathNodes, ref heap, ref heuristicObjective);
		}
		...
		{
			CalculateBestEdgePosition_00000774_0024BurstDirectCall.Invoke(ref s1, ref s2, ref pos, out closestPointAlongEdge, out quantizedFractionAlongEdge, out cost);
		}
