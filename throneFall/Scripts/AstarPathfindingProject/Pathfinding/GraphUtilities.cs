...
namespace Pathfinding
{
	public static class GraphUtilities
	{
		public static List<Vector3> GetContours(NavGraph graph)
		{
			...
			{
				GetContours(navmesh, delegate(List<Int3> vertices, bool cycle)
				{
		...
		public static void GetContours(GridGraph grid, Action<Vector3[]> callback, float yMergeThreshold, GridNodeBase[] nodes = null, Func<GraphNode, GraphNode, bool> connectionFilter = null)
		{
			...
			foreach (GridNodeBase gridNodeBase in nodes)
			{
				...
				{
					int num2 = (int)(gridNodeBase.NodeIndex << 4) | j;
					GridNodeBase gridNodeBase2 = gridNodeBase.GetNeighbourAlongDirection(array[j]);
					...
					while (true)
					{
						int num4 = (int)(gridNodeBase3.NodeIndex << 4) | num3;
						if (num4 == num2 && list.Count > 0)
						{
							break;
						}
						hashSet2.Add(num4);
						GridNodeBase gridNodeBase4 = gridNodeBase3.GetNeighbourAlongDirection(array[num3]);
