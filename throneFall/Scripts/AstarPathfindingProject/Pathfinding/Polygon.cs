...
namespace Pathfinding
{
	...
	{
		public delegate bool ContainsPoint_000002D5_0024PostfixBurstDelegate(ref int3 aWorld, ref int3 bWorld, ref int3 cWorld, ref int3 pWorld, ref NativeMovementPlane movementPlane);

		internal static class ContainsPoint_000002D5_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(ContainsPoint_000002D5_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static ContainsPoint_000002D5_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		public delegate bool ClosestPointOnTriangleByRef_000002DC_0024PostfixBurstDelegate(in float3 a, in float3 b, in float3 c, in float3 p, [NoAlias] out float3 output);

		internal static class ClosestPointOnTriangleByRef_000002DC_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(ClosestPointOnTriangleByRef_000002DC_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static ClosestPointOnTriangleByRef_000002DC_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		public delegate void ClosestPointOnTriangleProjected_000002DF_0024PostfixBurstDelegate(ref Int3 vi1, ref Int3 vi2, ref Int3 vi3, ref BBTree.ProjectionParams projection, ref float3 point, [NoAlias] out float3 closest, [NoAlias] out float sqrDist, [NoAlias] out float distAlongProjection);

		internal static class ClosestPointOnTriangleProjected_000002DF_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(ClosestPointOnTriangleProjected_000002DF_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static ClosestPointOnTriangleProjected_000002DF_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		{
			return ContainsPoint_000002D5_0024BurstDirectCall.Invoke(ref aWorld, ref bWorld, ref cWorld, ref pWorld, ref movementPlane);
		}
		...
		{
			return ClosestPointOnTriangleByRef_000002DC_0024BurstDirectCall.Invoke(in a, in b, in c, in p, out output);
		}
		...
		{
			ClosestPointOnTriangleProjected_000002DF_0024BurstDirectCall.Invoke(ref vi1, ref vi2, ref vi3, ref projection, ref point, out closest, out sqrDist, out distAlongProjection);
		}
