...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMPaniniProjectionShakeEvent_HDRP
	{
		...
		{
			MMPaniniProjectionShakeEvent_HDRP.OnEvent?.Invoke(distance, duration, remapMin, remapMax, relativeDistance, attenuation, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
