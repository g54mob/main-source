...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMFilmGrainShakeEvent_HDRP
	{
		...
		{
			MMFilmGrainShakeEvent_HDRP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
