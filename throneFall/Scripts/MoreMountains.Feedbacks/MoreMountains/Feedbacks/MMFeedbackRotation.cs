	...
	public class MMFeedbackRotation : MMFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1f)
		{
			...
			if (Mode == Modes.Absolute || Mode == Modes.Additive)
			{
				...
				{
					_coroutine = StartCoroutine(AnimateRotation(AnimateRotationTarget, Vector3.zero, FeedbackDuration, AnimateRotationX, AnimateRotationY, AnimateRotationZ, RemapCurveZero * num, RemapCurveOne * num));
				}
			}
