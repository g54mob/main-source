...
namespace MoreMountains.Feedbacks
{
	...
	public class MMFeedbackDestinationTransform : MMFeedback
	{
		...
		public AnimationCurve GlobalAnimationCurve = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f));
		...
		public AnimationCurve AnimatePositionCurve = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f));
		...
		public AnimationCurve AnimateRotationCurve = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f));
		...
		public AnimationCurve AnimateScaleCurve = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f));
		...
		protected virtual IEnumerator AnimateToDestination()
		{
			...
			while (journey >= 0f && journey <= Duration && Duration > 0f)
			{
				...
				_newPosition = Vector3.LerpUnclamped(_pointAPosition, _pointBPosition, _animationCurve.Evaluate(time));
				_animationCurve = (SeparateRotationCurve ? AnimateRotationCurve : GlobalAnimationCurve);
				_newRotation = Quaternion.LerpUnclamped(_pointARotation, _pointBRotation, _animationCurve.Evaluate(time));
				_animationCurve = (SeparateScaleCurve ? AnimateScaleCurve : GlobalAnimationCurve);
				_newScale = Vector3.LerpUnclamped(_pointAScale, _pointBScale, _animationCurve.Evaluate(time));
