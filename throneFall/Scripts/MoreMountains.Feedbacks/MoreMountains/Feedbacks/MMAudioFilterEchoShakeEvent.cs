...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMAudioFilterEchoShakeEvent
	{
		...
		{
			MMAudioFilterEchoShakeEvent.OnEvent?.Invoke(echoCurve, duration, remapMin, remapMax, relativeEcho, feedbacksIntensity, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
