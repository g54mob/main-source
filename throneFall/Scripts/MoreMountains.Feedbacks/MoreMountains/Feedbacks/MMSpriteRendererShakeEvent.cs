...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMSpriteRendererShakeEvent
	{
		...
		{
			MMSpriteRendererShakeEvent.OnEvent?.Invoke(shakeDuration, modifyColor, colorOverTime, flipX, flipY, feedbacksIntensity, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, useRange, eventRange, eventOriginPosition);
		}
	}
}
