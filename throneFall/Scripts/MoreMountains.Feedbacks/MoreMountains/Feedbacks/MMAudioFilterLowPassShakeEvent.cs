...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMAudioFilterLowPassShakeEvent
	{
		...
		{
			MMAudioFilterLowPassShakeEvent.OnEvent?.Invoke(lowPassCurve, duration, remapMin, remapMax, relativeLowPass, feedbacksIntensity, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
