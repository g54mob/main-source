...
namespace MoreMountains.Feedbacks
{
	...
	public class MMCameraClippingPlanesShaker : MMShaker
	{
		...
		{
			base.Initialization();
			_targetCamera = base.gameObject.GetComponent<Camera>();
		}
		...
		{
			float nearClipPlane = ShakeFloat(ShakeNear, RemapNearZero, RemapNearOne, RelativeClippingPlanes, _initialNear);
			_targetCamera.nearClipPlane = nearClipPlane;
			float farClipPlane = ShakeFloat(ShakeFar, RemapFarZero, RemapFarOne, RelativeClippingPlanes, _initialFar);
			_targetCamera.farClipPlane = farClipPlane;
		}
