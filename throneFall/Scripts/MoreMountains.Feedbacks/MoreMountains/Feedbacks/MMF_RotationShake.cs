...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_RotationShake : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 rotation, float feedbacksIntensity = 1f)
		{
		...
		protected override void CustomStopFeedback(Vector3 rotation, float feedbacksIntensity = 1f)
		{
			if (Active && FeedbackTypeAuthorized)
			{
