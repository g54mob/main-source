...
namespace MoreMountains.Feedbacks
{
	...
	public class MMSpriteRendererShaker : MMShaker
	{
		...
		protected override void Initialization()
		{
			...
			{
				BoundSpriteRenderer = base.gameObject.GetComponent<SpriteRenderer>();
			}
		}
