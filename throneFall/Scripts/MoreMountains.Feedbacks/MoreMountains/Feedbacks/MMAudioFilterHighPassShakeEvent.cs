...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMAudioFilterHighPassShakeEvent
	{
		...
		{
			MMAudioFilterHighPassShakeEvent.OnEvent = null;
		}
		...
		{
			MMAudioFilterHighPassShakeEvent.OnEvent?.Invoke(highPassCurve, duration, remapMin, remapMax, relativeHighPass, feedbacksIntensity, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
