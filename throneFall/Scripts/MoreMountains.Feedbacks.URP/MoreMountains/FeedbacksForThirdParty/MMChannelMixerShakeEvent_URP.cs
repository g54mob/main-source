...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMChannelMixerShakeEvent_URP
	{
		...
		{
			MMChannelMixerShakeEvent_URP.OnEvent?.Invoke(shakeRed, remapRedZero, remapRedOne, shakeGreen, remapGreenZero, remapGreenOne, shakeBlue, remapBlueZero, remapBlueOne, duration, relativeValues, attenuation, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
