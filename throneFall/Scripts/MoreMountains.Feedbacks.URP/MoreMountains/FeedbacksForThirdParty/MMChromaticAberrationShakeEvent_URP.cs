...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMChromaticAberrationShakeEvent_URP
	{
		...
		{
			MMChromaticAberrationShakeEvent_URP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
