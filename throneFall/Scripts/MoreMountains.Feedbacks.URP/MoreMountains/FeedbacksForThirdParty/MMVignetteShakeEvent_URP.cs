...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMVignetteShakeEvent_URP
	{
		...
		{
			MMVignetteShakeEvent_URP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
