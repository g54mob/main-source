...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMFilmGrainShakeEvent_URP
	{
		...
		{
			MMFilmGrainShakeEvent_URP.OnEvent = null;
		}
		...
		{
			MMFilmGrainShakeEvent_URP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
