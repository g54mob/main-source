...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static readonly Guid[] JKMnuuHPtjRfeLZsdgszRlTTCFyb;

		internal static readonly ReadOnlyCollection<Guid> reservedHardwareTypeGuids;

		private static ControllerElementIdentifier.JJdeZvdjnivmGnZMnwtOMfIBzcAP[] TWpfbrIJWznTxaWPOJRMEPVEzVJwB;

		private static ReadOnlyCollection<ControllerElementIdentifier> yGzADeDOBTNCxZVavxZUNkMUtaET;

		private static ReadOnlyCollection<ControllerElementIdentifier> ZFSTbNglzyvyKmIRIYOpIJXAKSuG;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] RvZRThvwJOwNscjPTrUIMklUeZlT;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] YUCPdChRCPaZdCbhYIUhcMmtrNuAA;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] ILyVamEYvocrVrJZLFxsCeZzSVciA;

		internal static readonly IList<int> keyboardKeyValues;

		internal static readonly int[] _keyboardKeyValues;

		private static readonly IList<string> zPigqhKPAXqbgAzmcqwiDwPIgBLaA;

		private static readonly string[] hgLfvyhXUTDLSmvXsKfVtQbqAGFNA;

		private static readonly IList<string> MwuUHafSmeonmdqLgHxzfBZgDdlYA;

		private static readonly string[] FTtcflUigQVdiCluqnjUgmdBJDxS;
		...
		private static readonly PidVid[] HkXprbXJVyzmocAfQvvWRJuCFiPY;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] QNDoPlqJjyagkCemEeJCUIrFpdKfA;

		internal static readonly IList<PidVid> pidVids_sony_dualSense;

		private static readonly PidVid[] itpJHokFRuLsLLSdNhsjpQTvddHI;

		internal static readonly IList<string> productNames_sony_dualSense;

		private static readonly string[] MxZssTeJgGScPGOzwylNgToclhRw;

		private static readonly ControllerElementIdentifier[] XrnKDJCLZJYNJcKsOEAspuIkKFxN;
		...
		internal static ControllerElementIdentifier.JJdeZvdjnivmGnZMnwtOMfIBzcAP[] commonMouseElementIdentifierInitOptions
		{
			get
			{
				if (TWpfbrIJWznTxaWPOJRMEPVEzVJwB != null)
				{
					return TWpfbrIJWznTxaWPOJRMEPVEzVJwB;
				}
				TWpfbrIJWznTxaWPOJRMEPVEzVJwB = new ControllerElementIdentifier.JJdeZvdjnivmGnZMnwtOMfIBzcAP[11]
				{
					new ControllerElementIdentifier.JJdeZvdjnivmGnZMnwtOMfIBzcAP
					{
						id = 0,
		...
		internal static IList<ControllerElementIdentifier> unityUnifiedMouseElementIdentifiers => yGzADeDOBTNCxZVavxZUNkMUtaET ?? (yGzADeDOBTNCxZVavxZUNkMUtaET = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[11]
		{
		...
		internal static IList<ControllerElementIdentifier> rawInputUnifiedMouseElementIdentifiers => ZFSTbNglzyvyKmIRIYOpIJXAKSuG ?? (ZFSTbNglzyvyKmIRIYOpIJXAKSuG = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[9]
		{
			new ControllerElementIdentifier(commonMouseElementIdentifierInitOptions[0]),
			new ControllerElementIdentifier(commonMouseElementIdentifierInitOptions[1]),
			new ControllerElementIdentifier(commonMouseElementIdentifierInitOptions[2]),
		...
		public static IList<string> keyboardKeyKeys => zPigqhKPAXqbgAzmcqwiDwPIgBLaA;

		public static IList<string> keyboardModifierKeyKeys => MwuUHafSmeonmdqLgHxzfBZgDdlYA;

		internal static ControllerElementIdentifier[] unknownJoystickElementIdentifiers_orig => XrnKDJCLZJYNJcKsOEAspuIkKFxN;
		...
		static Consts()
		{
			...
			JKMnuuHPtjRfeLZsdgszRlTTCFyb = new Guid[3] { joystickGuid_unknownController, hardwareTypeGuid_universalKeyboard, hardwareTypeGuid_universalMouse };
			RvZRThvwJOwNscjPTrUIMklUeZlT = new string[3] { "MouseAxis1", "MouseAxis2", "MouseAxis3" };
			YUCPdChRCPaZdCbhYIUhcMmtrNuAA = new string[7] { "MouseButton0", "MouseButton1", "MouseButton2", "MouseButton3", "MouseButton4", "MouseButton5", "MouseButton6" };
			ILyVamEYvocrVrJZLFxsCeZzSVciA = new string[132]
			{
			...
			hgLfvyhXUTDLSmvXsKfVtQbqAGFNA = new string[132]
			{
				"", "a", "b", "c", "d", "e", "f", "g", "h", "i",
				"j", "k", "l", "m", "n", "o", "p", "q", "r", "s",
			...
			FTtcflUigQVdiCluqnjUgmdBJDxS = new string[5] { "", "control", "alt", "shift", "command" };
			...
			HkXprbXJVyzmocAfQvvWRJuCFiPY = new PidVid[3]
			{
				new PidVid(1476, 1356),
				new PidVid(2976, 1356),
				new PidVid(2508, 1356)
			};
			QNDoPlqJjyagkCemEeJCUIrFpdKfA = new string[5] { "Sony Computer Entertainment Wireless Controller", "Sony Interactive Entertainment DUALSHOCK®4 USB Wireless Adaptor", "Wireless Controller", "Sony Interactive Entertainment Wireless Controller", "Wireless Controller Touchpad" };
			itpJHokFRuLsLLSdNhsjpQTvddHI = new PidVid[2]
			{
				new PidVid(3302, 1356),
				new PidVid(3570, 1356)
			};
			MxZssTeJgGScPGOzwylNgToclhRw = new string[1] { "DualSense Wireless Controller" };
			mouseAxisUnityNames = new ReadOnlyCollection<string>(RvZRThvwJOwNscjPTrUIMklUeZlT);
			mouseButtonUnityNames = new ReadOnlyCollection<string>(YUCPdChRCPaZdCbhYIUhcMmtrNuAA);
			keyboardKeyNames = new ReadOnlyCollection<string>(ILyVamEYvocrVrJZLFxsCeZzSVciA);
			keyboardKeyValues = new ReadOnlyCollection<int>(_keyboardKeyValues);
			zPigqhKPAXqbgAzmcqwiDwPIgBLaA = new ReadOnlyCollection<string>(hgLfvyhXUTDLSmvXsKfVtQbqAGFNA);
			MwuUHafSmeonmdqLgHxzfBZgDdlYA = new ReadOnlyCollection<string>(FTtcflUigQVdiCluqnjUgmdBJDxS);
			pidVids_sony_dualShock4 = new ReadOnlyCollection<PidVid>(HkXprbXJVyzmocAfQvvWRJuCFiPY);
			productNames_sony_dualShock4 = new ReadOnlyCollection<string>(QNDoPlqJjyagkCemEeJCUIrFpdKfA);
			pidVids_sony_dualSense = new ReadOnlyCollection<PidVid>(itpJHokFRuLsLLSdNhsjpQTvddHI);
			productNames_sony_dualSense = new ReadOnlyCollection<string>(MxZssTeJgGScPGOzwylNgToclhRw);
			reservedHardwareTypeGuids = new ReadOnlyCollection<Guid>(JKMnuuHPtjRfeLZsdgszRlTTCFyb);
			...
			XrnKDJCLZJYNJcKsOEAspuIkKFxN = ksQcLsySIaoEmdoiKykOJoqSzKdN();
			if (132 != ILyVamEYvocrVrJZLFxsCeZzSVciA.Length)
			{
			...
			if (132 != hgLfvyhXUTDLSmvXsKfVtQbqAGFNA.Length)
			{
				Logger.LogError("Consts.keyboardKeyCount does not match _keyboardKeyStringKeys.Length!");
			}
		}

		private static ControllerElementIdentifier[] ksQcLsySIaoEmdoiKykOJoqSzKdN()
		{
			int num = 0;
			List<ControllerElementIdentifier> list = new List<ControllerElementIdentifier>(288);
			ControllerElementIdentifier.JJdeZvdjnivmGnZMnwtOMfIBzcAP jJdeZvdjnivmGnZMnwtOMfIBzcAP = new ControllerElementIdentifier.JJdeZvdjnivmGnZMnwtOMfIBzcAP();
			for (int i = 0; i < 32; i++)
			{
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.id = num;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.name = "Axis " + i;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.positiveName = string.Empty;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.negativeName = string.Empty;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.key = LocalizationManager.ConcatenateKeyStrings("axis", i.ToString());
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.positiveKey = string.Empty;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.negativeKey = string.Empty;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.elementType = ControllerElementType.Axis;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.compoundElementType = CompoundControllerElementType.Axis2D;
				list.Add(new ControllerElementIdentifier(jJdeZvdjnivmGnZMnwtOMfIBzcAP));
				num++;
			}
			for (int j = 0; j < 128; j++)
			{
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.id = num;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.name = "Button " + j;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.positiveName = string.Empty;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.negativeName = string.Empty;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.key = LocalizationManager.ConcatenateKeyStrings("button", j.ToString());
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.positiveKey = string.Empty;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.negativeKey = string.Empty;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.elementType = ControllerElementType.Button;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.compoundElementType = CompoundControllerElementType.Axis2D;
				list.Add(new ControllerElementIdentifier(jJdeZvdjnivmGnZMnwtOMfIBzcAP));
				num++;
			}
			int num2 = num;
			int num3 = num + 64;
			jJdeZvdjnivmGnZMnwtOMfIBzcAP = new ControllerElementIdentifier.JJdeZvdjnivmGnZMnwtOMfIBzcAP();
			jJdeZvdjnivmGnZMnwtOMfIBzcAP.elementType = ControllerElementType.Button;
			jJdeZvdjnivmGnZMnwtOMfIBzcAP.compoundElementType = CompoundControllerElementType.Axis2D;
			for (int k = 0; k < 16; k++)
			{
				string a = LocalizationManager.ConcatenateKeyStrings("hat", k.ToString());
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.id = num2++;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.name = "Hat " + k + " Up";
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.key = LocalizationManager.AppendToKeyAsPath(a, "up");
				list.Add(new ControllerElementIdentifier(jJdeZvdjnivmGnZMnwtOMfIBzcAP));
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.id = num3++;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.name = "Hat " + k + " Up Right";
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.key = LocalizationManager.AppendToKeyAsPath(a, "up_right");
				list.Add(new ControllerElementIdentifier(jJdeZvdjnivmGnZMnwtOMfIBzcAP));
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.id = num2++;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.name = "Hat " + k + " Right";
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.key = LocalizationManager.AppendToKeyAsPath(a, "right");
				list.Add(new ControllerElementIdentifier(jJdeZvdjnivmGnZMnwtOMfIBzcAP));
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.id = num3++;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.name = "Hat " + k + " Down Right";
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.key = LocalizationManager.AppendToKeyAsPath(a, "down_right");
				list.Add(new ControllerElementIdentifier(jJdeZvdjnivmGnZMnwtOMfIBzcAP));
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.id = num2++;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.name = "Hat " + k + " Down";
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.key = LocalizationManager.AppendToKeyAsPath(a, "down");
				list.Add(new ControllerElementIdentifier(jJdeZvdjnivmGnZMnwtOMfIBzcAP));
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.id = num3++;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.name = "Hat " + k + " Down Left";
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.key = LocalizationManager.AppendToKeyAsPath(a, "down_left");
				list.Add(new ControllerElementIdentifier(jJdeZvdjnivmGnZMnwtOMfIBzcAP));
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.id = num2++;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.name = "Hat " + k + " Left";
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.key = LocalizationManager.AppendToKeyAsPath(a, "left");
				list.Add(new ControllerElementIdentifier(jJdeZvdjnivmGnZMnwtOMfIBzcAP));
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.id = num3++;
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.name = "Hat " + k + " Up Left";
				jJdeZvdjnivmGnZMnwtOMfIBzcAP.key = LocalizationManager.AppendToKeyAsPath(a, "up_left");
				list.Add(new ControllerElementIdentifier(jJdeZvdjnivmGnZMnwtOMfIBzcAP));
			}
			return list.ToArray();
		}
