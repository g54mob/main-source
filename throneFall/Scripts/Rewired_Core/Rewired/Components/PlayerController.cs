...
namespace Rewired.Components
{
	...
	public class PlayerController : ComponentWrapper<Rewired.PlayerController>, IPlayerController
	{
		...
		protected override void OnAwakeFinished()
		{
			...
			if (base.initialized)
			{
				IMOGIFCeCAYAuWGlYyzBNtDHgAZoA(true);
			}
		}
		...
		protected override void Subscribe()
		{
			...
			if (base.source != null)
			{
				base.source.Rewired_002EIPlayerController_002EButtonStateChangedEvent += WEbInifgQpAnWQuNlanuKmTouipmA;
				base.source.Rewired_002EIPlayerController_002EAxisValueChangedEvent += rKPMrvylHhqLAfJZyxXSOLDIGEG;
				base.source.Rewired_002EIPlayerController_002EEnabledStateChangedEvent += IMOGIFCeCAYAuWGlYyzBNtDHgAZoA;
			}
		}
		...
		internal virtual List<ElementInfo> GBKAuiAThnHWfIddnHHwpXmiLaEhA()
		{
		...
		private void WEbInifgQpAnWQuNlanuKmTouipmA(int P_0, bool P_1)
		{
		...
		private void rKPMrvylHhqLAfJZyxXSOLDIGEG(int P_0, float P_1)
		{
			if (!base.isActiveAndEnabled)
			{
				return;
		...
		private void IMOGIFCeCAYAuWGlYyzBNtDHgAZoA(bool P_0)
		{
			try
			{
		...
		private void WNEvmiJrEXCtSZtYjqGDcGkULqkO()
		{
			if (_elements == null || _elements.Count <= 0)
			{
				_elements = GBKAuiAThnHWfIddnHHwpXmiLaEhA();
			}
		}
	}
}
