...
namespace Rewired
{
	...
	{
		private Pole ozjYdvInDtVloagxIayAeZIjRBtz;

		public Pole axisContribution => ozjYdvInDtVloagxIayAeZIjRBtz;
		...
		{
			ozjYdvInDtVloagxIayAeZIjRBtz = P_1.axisContribution;
		}
		...
		{
			ozjYdvInDtVloagxIayAeZIjRBtz = P_2;
		}

		internal void GLqddohbNfNLbCGKNlPQcbFawDEOb(SerializedObject P_0)
		{
			base.CmnfhwiyqiNdINILsJMpriXEkjSC(P_0);
			P_0.Add("axisContribution", ozjYdvInDtVloagxIayAeZIjRBtz);
		}

		internal void dshwmSOIKBYUZPNfBCJsTWDPAEQr(SerializedObject P_0)
		{
			base.TiARSBGHYwWRRTIpTBPKxkTBxqeX(P_0);
			P_0.TryGetDeserializedValueByRef("axisContribution", ref ozjYdvInDtVloagxIayAeZIjRBtz);
		}

		internal void cvaPVyuqimkQHZYpgnaXTTmDUHDt()
		{
			ozjYdvInDtVloagxIayAeZIjRBtz = Pole.Positive;
		}

		internal int HoNgwitwmgAEfiKBeYxiUnHAfZzw(IControllerTemplateElementSource P_0, List<ActionElementMap> P_1, bool P_2)
		{
			...
			int num = 0;
			ActionElementMap actionElementMap = jCxitvkjlMipuvvhTuLFZEHvjqmX(controllerTemplateButtonSource.target, ozjYdvInDtVloagxIayAeZIjRBtz);
		...
		private ActionElementMap jCxitvkjlMipuvvhTuLFZEHvjqmX(IControllerElementTarget P_0, Pole P_1)
		{
