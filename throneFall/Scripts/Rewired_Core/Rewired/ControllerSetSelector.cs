...
namespace Rewired
{
	...
	public sealed class ControllerSetSelector : ISerializationCallbackReceiver, IDeepCloneable
	{
		...
		[NonSerialized]
		private Guid VObSvNiMwQEPIKRSRfUpVgCZHTqNA;

		internal bool mrHnssKPqvnBfcJsxqpLsnPxOquq => _type != Type.All;
		...
		public Guid hardwareTypeGuid
		{
			get
			{
				...
				return VObSvNiMwQEPIKRSRfUpVgCZHTqNA;
			}
			set
			{
				...
				VObSvNiMwQEPIKRSRfUpVgCZHTqNA = value;
		...
		public ControllerSetSelector(ControllerSetSelector P_0)
		{
			...
			VObSvNiMwQEPIKRSRfUpVgCZHTqNA = P_0.VObSvNiMwQEPIKRSRfUpVgCZHTqNA;
		}
		...
		internal ControllerSetSelector(Type P_0, ControllerType P_1, string P_2, string P_3, int P_4)
		{
			...
			_controllerType = P_1;
			_guid = P_2;
			VObSvNiMwQEPIKRSRfUpVgCZHTqNA = StringTools.ToGuid(P_2);
		...
		public bool Matches(Controller controller)
		{
			...
			case Type.HardwareType:
				if (VObSvNiMwQEPIKRSRfUpVgCZHTqNA != Guid.Empty)
				{
					return VObSvNiMwQEPIKRSRfUpVgCZHTqNA == controller.hardwareTypeGuid;
				}
			...
			case Type.ControllerTemplateType:
				return controller.ImplementsTemplate(VObSvNiMwQEPIKRSRfUpVgCZHTqNA);
			case Type.PersistentControllerInstance:
				return controller.deviceInstanceGuid == VObSvNiMwQEPIKRSRfUpVgCZHTqNA;
		...
		private void meZqIpytqaRIUPQRdtJXjnhOFxAS()
		{
			_guid = string.Empty;
			VObSvNiMwQEPIKRSRfUpVgCZHTqNA = Guid.Empty;
		}

		void ISerializationCallbackReceiver.OnAfterDeserialize()
		{
			VObSvNiMwQEPIKRSRfUpVgCZHTqNA = StringTools.ToGuid(_guid);
		}
