...
namespace Rewired.Utils.Classes.Data
{
	...
	public class SerializableULong
	{
		...
		public ulong value
		{
			get
			{
				return zFkovzosCGHurfxcgihvDZDaOFlx(ulong_32BitLow, ulong_32BitHigh);
			}
			set
			{
				PvcyQGoSXySSJYUokjrNamgHgFWBA(value, out ulong_32BitLow, out ulong_32BitHigh);
			}
		}
		...
		private void PvcyQGoSXySSJYUokjrNamgHgFWBA(ulong P_0, out int P_1, out int P_2)
		{
			P_1 = (int)P_0;
			P_2 = (int)(P_0 >> 32);
		}

		private ulong zFkovzosCGHurfxcgihvDZDaOFlx(int P_0, int P_1)
		{
