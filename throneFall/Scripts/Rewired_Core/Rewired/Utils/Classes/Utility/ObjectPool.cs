...
namespace Rewired.Utils.Classes.Utility
{
	...
	internal class ObjectPool<T> : IObjectPool, IObjectPool<T> where T : class
	{
		...
		private ulong bdBDNPbmgNMLStKeZgYOCNncGGyYB;

		protected ulong InstanceCount => bdBDNPbmgNMLStKeZgYOCNncGGyYB;
		...
		private object BuEBSyeWPnaRkokYjOMzRYUvEeeE()
		{
			return Get();
		}
		...
		{
			//ILSpy generated this explicit interface implementation from .override directive in BuEBSyeWPnaRkokYjOMzRYUvEeeE
			return this.BuEBSyeWPnaRkokYjOMzRYUvEeeE();
		}

		private bool gbYHDEiGnSyrNQQLOzVVBRVIGmig(object P_0)
		{
		...
		{
			//ILSpy generated this explicit interface implementation from .override directive in gbYHDEiGnSyrNQQLOzVVBRVIGmig
			return this.gbYHDEiGnSyrNQQLOzVVBRVIGmig(P_0);
		}
		...
		{
			bdBDNPbmgNMLStKeZgYOCNncGGyYB = ((bdBDNPbmgNMLStKeZgYOCNncGGyYB < ulong.MaxValue) ? (bdBDNPbmgNMLStKeZgYOCNncGGyYB + 1) : 0);
			return bdBDNPbmgNMLStKeZgYOCNncGGyYB;
		}
	}
}
