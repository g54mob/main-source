...
namespace Rewired.Utils
{
	...
	{
		private static byte[] hfgwWiFuagBmkEfOYjvzzSMfjAKk;

		private static byte[] intToFloatBuffer => hfgwWiFuagBmkEfOYjvzzSMfjAKk ?? (hfgwWiFuagBmkEfOYjvzzSMfjAKk = new byte[4]);
