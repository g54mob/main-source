...
namespace Rewired.Utils
{
	...
	{
		private static string CXNPhmaCETjCPZATsMdpvuDMiPhi;
		...
		static StringTools()
		{
			CXNPhmaCETjCPZATsMdpvuDMiPhi = Regex.Escape(new string(Path.GetInvalidFileNameChars()));
		}

		public static string CleanUpFileName(string name)
		{
			name = name.Trim();
			string pattern = "[ ~`,:;'\\.\\$\\^\\{\\}\\[\\]\\(\\|\\)\\*\\+\\?\\\\" + CXNPhmaCETjCPZATsMdpvuDMiPhi + "]";
