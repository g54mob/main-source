...
namespace Pathfinding.Drawing
{
	public class DrawingData
	{
		...
		internal struct BuilderData : IDisposable
		{
			...
			public unsafe delegate bool AnyBuffersWrittenTo_000001E6_0024PostfixBurstDelegate(UnsafeAppendBuffer* buffers, int numBuffers);

			internal static class AnyBuffersWrittenTo_000001E6_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(AnyBuffersWrittenTo_000001E6_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static AnyBuffersWrittenTo_000001E6_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			public unsafe delegate void ResetAllBuffers_000001E7_0024PostfixBurstDelegate(UnsafeAppendBuffer* buffers, int numBuffers);

			internal static class ResetAllBuffers_000001E7_0024BurstDirectCall
			{
				private static IntPtr Pointer;
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(ResetAllBuffers_000001E7_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static ResetAllBuffers_000001E7_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				return AnyBuffersWrittenTo_000001E6_0024BurstDirectCall.Invoke(buffers, numBuffers);
			}
			...
			{
				ResetAllBuffers_000001E7_0024BurstDirectCall.Invoke(buffers, numBuffers);
			}
		...
		{
			foreach (KeyValuePair<Camera, Range> cameraVersion in cameraVersions)
			{
				if (cameraVersion.Value.end < lastTickVersion - 10)
				{
					cameraVersions.Remove(cameraVersion.Key);
					break;
				}
			}
		}
		...
		public static void Initialize_0024BuilderData_AnyBuffersWrittenTo_000001E6_0024BurstDirectCall()
		{
			BuilderData.AnyBuffersWrittenTo_000001E6_0024BurstDirectCall.Initialize();
		}

		public static void Initialize_0024BuilderData_ResetAllBuffers_000001E7_0024BurstDirectCall()
		{
			BuilderData.ResetAllBuffers_000001E7_0024BurstDirectCall.Initialize();
		}
	}
}
