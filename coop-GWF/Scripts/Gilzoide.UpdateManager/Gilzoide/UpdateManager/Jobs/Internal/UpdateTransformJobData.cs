...
{
	public class UpdateTransformJobData<TData, TDataProvider> : UpdateJobData<TData, TDataProvider> where TData : struct where TDataProvider : IInitialTransformJobDataProvider<TData>
	{
