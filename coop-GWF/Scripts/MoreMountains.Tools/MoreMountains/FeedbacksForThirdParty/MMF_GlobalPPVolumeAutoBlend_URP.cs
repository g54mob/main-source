...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public class MMF_GlobalPPVolumeAutoBlend_URP : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1f)
		{
			...
			{
				TargetAutoBlend.TimeScale = ((ComputedTimescaleMode != TimescaleModes.Scaled) ? MMGlobalPostProcessingVolumeAutoBlend_URP.TimeScales.Unscaled : MMGlobalPostProcessingVolumeAutoBlend_URP.TimeScales.Scaled);
