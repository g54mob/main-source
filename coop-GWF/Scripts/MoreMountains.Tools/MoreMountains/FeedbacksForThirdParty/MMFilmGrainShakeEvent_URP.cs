...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMFilmGrainShakeEvent_URP
	{
		...
		{
			MMFilmGrainShakeEvent_URP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
