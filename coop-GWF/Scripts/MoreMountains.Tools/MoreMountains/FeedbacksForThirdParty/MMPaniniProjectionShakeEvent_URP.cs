...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMPaniniProjectionShakeEvent_URP
	{
		...
		{
			MMPaniniProjectionShakeEvent_URP.OnEvent = null;
		}
		...
		{
			MMPaniniProjectionShakeEvent_URP.OnEvent?.Invoke(distance, duration, remapMin, remapMax, relativeDistance, attenuation, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
