...
namespace MoreMountains.Feedbacks
{
	...
	public class MMAudioFilterReverbShaker : MMShaker
	{
		...
		{
			base.Initialization();
			_targetAudioReverbFilter = base.gameObject.GetComponent<AudioReverbFilter>();
		}
		...
		{
			float reverbLevel = ShakeFloat(ShakeReverb, RemapReverbZero, RemapReverbOne, RelativeReverb, _initialReverb);
			_targetAudioReverbFilter.reverbLevel = reverbLevel;
		}
