...
namespace MoreMountains.Tools
{
	public abstract class MMObjectPooler : MonoBehaviour
	{
		...
		public virtual MMObjectPool ExistingPool(string poolName)
		{
			...
			if (_pools.Count == 0)
			{
				MMObjectPool[] array = Object.FindObjectsByType<MMObjectPool>(FindObjectsInactive.Exclude, FindObjectsSortMode.None);
				if (array.Length != 0)
				{
		...
		{
			if (!(this == null) && (_objectPool == null || _waitingPool == null) && this != null)
			{
				FillObjectPool();
			}
		}
