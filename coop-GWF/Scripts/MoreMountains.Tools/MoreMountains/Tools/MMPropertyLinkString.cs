	...
	public class MMPropertyLinkString : MMPropertyLink
	{
		...
		public override void CreateGettersAndSetters(MMProperty property)
		{
			...
			if (property.MemberType == MMProperty.MemberTypes.Property)
			{
				...
				{
					GetStringDelegate = (Func<string>)Delegate.CreateDelegate(typeof(Func<string>), firstArgument, property.MemberPropertyInfo.GetGetMethod());
				}
				if (property.MemberPropertyInfo.GetSetMethod() != null)
				{
					SetStringDelegate = (Action<string>)Delegate.CreateDelegate(typeof(Action<string>), firstArgument, property.MemberPropertyInfo.GetSetMethod());
				}
