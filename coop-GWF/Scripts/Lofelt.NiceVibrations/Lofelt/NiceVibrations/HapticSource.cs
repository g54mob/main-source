...
namespace Lofelt.NiceVibrations
{
	...
	public class HapticSource : MonoBehaviour
	{
		...
		static HapticSource()
		{
			HapticController.LoadedClipChanged = (Action)Delegate.Combine(HapticController.LoadedClipChanged, (Action)delegate
			{
				loadedHapticSource = null;
			});
			HapticController.PlaybackStarted = (Action)Delegate.Combine(HapticController.PlaybackStarted, (Action)delegate
			{
