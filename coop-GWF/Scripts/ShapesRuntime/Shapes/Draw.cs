...
namespace Shapes
{
	public static class Draw
	{
		...
		public static float TextCurvature
		{
			...
			get
			{
				return style.textStyle.curvature;
			}
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			set
			{
				style.textStyle.curvature = value;
			}
		}
		...
		public static Vector2 TextCurvaturePivot
		{
			...
			get
			{
				return style.textStyle.curvaturePivot;
			}
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			set
			{
				style.textStyle.curvaturePivot = value;
			}
		}
		...
		public static void Text(TextElement element, Vector3 pos)
		{
			PushMatrix();
			Translate(pos);
			Text_Internal(isRect: false, null, element, default(Vector2), default(Vector2), Font, FontSize, TextAlign, Color);
			PopMatrix();
		}
		...
		public static void Text(TextElement element, Vector3 pos, TextAlign align)
		{
			PushMatrix();
			Translate(pos);
			Text_Internal(isRect: false, null, element, default(Vector2), default(Vector2), Font, FontSize, align, Color);
			PopMatrix();
		}
		...
		public static void TextRect(TextElement element, Vector3 pos, Vector2 pivot, Vector2 size)
		{
			PushMatrix();
			Translate(pos);
			Text_Internal(isRect: true, null, element, pivot, size, Font, FontSize, TextAlign, Color);
			PopMatrix();
		}
		...
		public static void TextRect(TextElement element, Vector3 pos, Vector2 pivot, Vector2 size, TextAlign align)
		{
			PushMatrix();
			Translate(pos);
			Text_Internal(isRect: true, null, element, pivot, size, Font, FontSize, align, Color);
			PopMatrix();
		}
		...
		{
			TextRect_Internal(null, element, rect, Font, FontSize, TextAlign, Color);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void TextRect(TextElement element, Rect rect, TextAlign align)
		{
			TextRect_Internal(null, element, rect, Font, FontSize, align, Color);
		}
