...
namespace Febucci.UI
{
	...
	public class TextAnimatorPlayer : TAnimPlayerBase
	{
		...
		protected override float GetWaitAppearanceTimeOf(char character)
		{
			...
			if (!waitForNewLines && !base.textAnimator.latestCharacterShown.isVisible && base.textAnimator.latestCharacterShown.textElement != null && IsUnicodeNewLine(base.textAnimator.latestCharacterShown.textElement.unicode))
			{
				return 0f;
			}
			switch (character)
