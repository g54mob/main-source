...
namespace Dissonance
{
	...
	{
		private static readonly Log Log = Logs.Create(LogCategory.Core, "RemoteVoicePlayerState");
		...
		public override bool IsConnected
		{
			get
			{
				if ((UnityEngine.Object)_playback != null && _playback.IsActive)
				{
		...
		{
			Log.AssertAndThrowUserError(channels != null, "`channels` parameter is null", "Passing a null object when calling `GetSpeakingChannels`", "https://placeholder-software.co.uk/dissonance/docs/Reference/Other/VoicePlayerState.html#getspeakingchannelschannels-listremotechannel", "6F103E91-E8BD-40B0-8690-CFAE2FB801A5");
			channels.Clear();
			((IRemoteChannelProvider)base.Playback)?.GetRemoteChannels(channels);
		}
