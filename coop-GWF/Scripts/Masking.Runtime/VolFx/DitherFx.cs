	...
	public class DitherFx : ScriptableRendererFeature
	{
		public class PassExecution : ScriptableRenderPass
		{
			...
			public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
			{
				...
				PassData passData;
				using IUnsafeRenderGraphBuilder unsafeRenderGraphBuilder = renderGraph.AddUnsafePass<PassData>(base.passName, out passData, _profiler, "/github/workspace/Assets/ThirdParty/Dither/Runtime/DitheriFx.cs", 114);
