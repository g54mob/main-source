...
namespace Pushback.Components.Generated
{
	...
	public struct GhostComponentSerializerRegistrationSystem : ISystem, IGhostComponentSerializerRegistration
	{
		...
		internal delegate void __codegen__OnUpdate_00000025_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

		internal static class __codegen__OnUpdate_00000025_0024BurstDirectCall
		{
			...
			private static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnUpdate_00000025_0024PostfixBurstDelegate>(__codegen__OnUpdate).Value;
				}
				P_0 = Pointer;
			}
		...
		public void OnCreate(ref SystemState state)
		{
			...
			{
				DisplayName = "ReceivedPushbackCD",
				Component = ComponentType.ReadWrite<ReceivedPushbackCD>(),
				Hash = 8499533983993026014uL,
				SelfIndex = -1,
				SerializerIndex = -1,
			...
			valueRW.AddSerializer(ReceivedPushbackCDGhostComponentSerializer.GetState(ref state));
		}
		...
		{
			__codegen__OnUpdate_00000025_0024BurstDirectCall.Invoke(self, state);
		}
