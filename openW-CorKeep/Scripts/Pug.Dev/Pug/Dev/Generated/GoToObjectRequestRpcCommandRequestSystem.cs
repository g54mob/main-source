...
namespace Pug.Dev.Generated
{
	...
	[BurstCompile]
	internal struct GoToObjectRequestRpcCommandRequestSystem : ISystem
	{
		[BurstCompile]
		private struct SendRpc : IJobChunk
		{
			public RpcCommandRequest<GoToObjectRequestSerializer, GoToObjectRequest>.SendRpcData data;
		...
		private RpcCommandRequest<GoToObjectRequestSerializer, GoToObjectRequest> m_Request;
		...
		{
			((GoToObjectRequestRpcCommandRequestSystem*)self.ToPointer())->OnCreate(ref *(SystemState*)state.ToPointer());
		}
		...
		{
			((GoToObjectRequestRpcCommandRequestSystem*)self.ToPointer())->OnUpdate(ref *(SystemState*)state.ToPointer());
		}
	}
}
