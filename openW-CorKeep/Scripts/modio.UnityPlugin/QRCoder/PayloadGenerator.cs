...
namespace QRCoder
{
	public static class PayloadGenerator
	{
		...
		public class ContactData : Payload
		{
			...
			public override string ToString()
			{
				...
				if (outputType == ContactOutputType.MeCard)
				{
					...
					empty2 = ((addressOrder != AddressOrder.Default) ? ("ADR:,," + ((!string.IsNullOrEmpty(houseNumber)) ? (houseNumber + " ") : "") + ((!string.IsNullOrEmpty(street)) ? street : "") + "," + ((!string.IsNullOrEmpty(city)) ? city : "") + "," + ((!string.IsNullOrEmpty(stateRegion)) ? stateRegion : "") + "," + ((!string.IsNullOrEmpty(zipCode)) ? zipCode : "") + "," + ((!string.IsNullOrEmpty(country)) ? country : "") + "\r\n") : ("ADR:,," + ((!string.IsNullOrEmpty(street)) ? (street + " ") : "") + ((!string.IsNullOrEmpty(houseNumber)) ? houseNumber : "") + "," + ((!string.IsNullOrEmpty(zipCode)) ? zipCode : "") + "," + ((!string.IsNullOrEmpty(city)) ? city : "") + "," + ((!string.IsNullOrEmpty(stateRegion)) ? stateRegion : "") + "," + ((!string.IsNullOrEmpty(country)) ? country : "") + "\r\n"));
					empty += empty2;
				...
				empty3 = ((addressOrder != AddressOrder.Default) ? (";;" + ((!string.IsNullOrEmpty(houseNumber)) ? (houseNumber + " ") : "") + ((!string.IsNullOrEmpty(street)) ? street : "") + ";" + ((!string.IsNullOrEmpty(city)) ? city : "") + ";" + ((!string.IsNullOrEmpty(stateRegion)) ? stateRegion : "") + ";" + ((!string.IsNullOrEmpty(zipCode)) ? zipCode : "") + ";" + ((!string.IsNullOrEmpty(country)) ? country : "") + "\r\n") : (";;" + ((!string.IsNullOrEmpty(street)) ? (street + " ") : "") + ((!string.IsNullOrEmpty(houseNumber)) ? houseNumber : "") + ";" + ((!string.IsNullOrEmpty(zipCode)) ? zipCode : "") + ";" + ((!string.IsNullOrEmpty(city)) ? city : "") + ";" + ((!string.IsNullOrEmpty(stateRegion)) ? stateRegion : "") + ";" + ((!string.IsNullOrEmpty(country)) ? country : "") + "\r\n"));
				empty += empty3;
				if (birthday.HasValue)
				{
					empty = empty + "BDAY:" + birthday.Value.ToString("yyyyMMdd") + "\r\n";
		...
		public class OneTimePassword : Payload
		{
			...
			private void ProcessCommonFields(StringBuilder sb)
			{
				...
				if (!String40Methods.IsNullOrWhiteSpace(Issuer))
				{
					...
					text2 = Uri.EscapeDataString(Issuer);
				}
		...
		private static bool IsValidIban(string iban)
		{
			...
			int result = 0;
			for (int num = 0; num < (int)Math.Ceiling((double)(text2.Length - 2) / 7.0); num++)
			{
				int num2 = ((num != 0) ? 2 : 0);
				int num3 = num * 7 + num2;
				if (!int.TryParse(((num == 0) ? "" : result.ToString()) + text2.Substring(num3, Math.Min(9 - num2, text2.Length - num3)), NumberStyles.Any, CultureInfo.InvariantCulture, out result))
				{
					break;
				}
				result %= 97;
