...
namespace Rewired.Data
{
	public class UserDataStore_PlayerPrefs : UserDataStore
	{
		...
		private static string GetBasePlayerPrefsKey(string keyPrefix, Player player)
		{
			return keyPrefix + "|playerName=" + player.name;
		}

		public static bool InputBehaviourPlayerPrefsKeyExists(string keyPrefix)
		{
			Player player = ReInput.players.GetPlayer(0);
			return PlayerPrefs.HasKey(string.Concat(GetBasePlayerPrefsKey(keyPrefix, player) + "|dataType=InputBehavior", "|id=0"));
		}
