...
namespace RayAttackState.Components.Generated
{
	...
	public struct GhostComponentSerializerRegistrationSystem : ISystem, IGhostComponentSerializerRegistration
	{
		...
		public void OnCreate(ref SystemState state)
		{
			...
			{
				DisplayName = "RayAttackState.RayAttackStateCD",
				Component = ComponentType.ReadWrite<RayAttackStateCD>(),
				Hash = 4415356496440405886uL,
				SelfIndex = -1,
				SerializerIndex = -1,
			...
			valueRW.AddSerializer(RayAttackStateCDGhostComponentSerializer.GetState(ref state));
		}
