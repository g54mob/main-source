...
public class SignStateToggle : ButtonUIElement
{
	...
	internal const string hoverTitleHide = "toggleSignTextOff";

	internal const string hoverTitleSelected = "toggleSignTextTarget";

	internal const string hoverTitleAlways = "toggleSignTextOn";
