...
namespace Pug.Other.Generated
{
	...
	[BurstCompile]
	public struct PugLocalTransformDefaultVariantGhostComponentSerializer : IGhostSerializer
	{
		...
		internal static GhostComponentSerializer.State GetState(ref SystemState state)
		{
			if (!s_StateInitialized)
			{
				...
				{
					GhostFieldsHash = 223862969800728777uL,
					...
					VariantHash = 13293543278797930708uL,
				...
				s_StateInitialized = ComponentSerializationHelper<LocalTransform, Snapshot, PugLocalTransformDefaultVariantGhostComponentSerializer>.SetupFunctionPointers(ref s_State, ref state);
			}
			return s_State;
		}
