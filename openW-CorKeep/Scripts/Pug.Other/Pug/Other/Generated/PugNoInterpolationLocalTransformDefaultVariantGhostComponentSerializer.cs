...
namespace Pug.Other.Generated
{
	...
	[BurstCompile]
	public struct PugNoInterpolationLocalTransformDefaultVariantGhostComponentSerializer : IGhostSerializer
	{
		...
		{
			component.Position = new float3((float)snapshotBefore.Position_x * 0.001f, (float)snapshotBefore.Position_y * 0.001f, (float)snapshotBefore.Position_z * 0.001f);
		}
		...
		internal static GhostComponentSerializer.State GetState(ref SystemState state)
		{
			if (!s_StateInitialized)
			{
				...
				{
					GhostFieldsHash = 13443446722206522404uL,
					...
					VariantHash = 14199810116940403837uL,
				...
				s_StateInitialized = ComponentSerializationHelper<LocalTransform, Snapshot, PugNoInterpolationLocalTransformDefaultVariantGhostComponentSerializer>.SetupFunctionPointers(ref s_State, ref state);
			}
			return s_State;
		}
