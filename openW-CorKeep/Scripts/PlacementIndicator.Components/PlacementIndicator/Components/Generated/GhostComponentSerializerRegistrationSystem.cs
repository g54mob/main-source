...
namespace PlacementIndicator.Components.Generated
{
	...
	public struct GhostComponentSerializerRegistrationSystem : ISystem, IGhostComponentSerializerRegistration
	{
		...
		internal delegate void __codegen__OnUpdate_00000023_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

		internal static class __codegen__OnUpdate_00000023_0024BurstDirectCall
		{
			...
			private static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnUpdate_00000023_0024PostfixBurstDelegate>(__codegen__OnUpdate).Value;
				}
				P_0 = Pointer;
			}
		...
		public void OnCreate(ref SystemState state)
		{
			...
			{
				DisplayName = "PlacementIndicator.PlacementIndicatorCD",
				Component = ComponentType.ReadWrite<PlacementIndicatorCD>(),
				Hash = 17621861394228147054uL,
				SelfIndex = -1,
				SerializerIndex = -1,
			...
			valueRW.AddSerializer(PlacementIndicatorCDGhostComponentSerializer.GetState(ref state));
		}
		...
		{
			__codegen__OnUpdate_00000023_0024BurstDirectCall.Invoke(self, state);
		}
