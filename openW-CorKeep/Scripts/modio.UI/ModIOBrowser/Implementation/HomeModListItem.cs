...
{
	internal class HomeModListItem : ListItem, IDeselectHandler, IEventSystemHandler, ISelectHandler, IPointerEnterHandler
	{
		public Image image;
		...
		public void OpenModDetailsForThisProfile()
		{
			if (!isPlaceholder)
			{
				SelfInstancingMonoSingleton<Details>.Instance.Open(profile, SelfInstancingMonoSingleton<Home>.Instance.Open);
			}
		}
