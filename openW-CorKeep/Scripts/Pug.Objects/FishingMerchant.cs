...
public class FishingMerchant : NPC
{
	...
	public void AE_BubblesSound()
	{
		AudioManager.Sfx(SfxID.bubbleStream, base.transform.position, 0.2f, 1.55f, 0.15f, reuse: false, AudioManager.MixerGroupEnum.EFFECTS, ignoreAudioIfOutsideOfViewport: false, useSpatialSound: true, loop: false, 8f, 6f);
	}
}
