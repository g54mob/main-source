...
public class ElectricityGenerator : EntityMonoBehaviour
{
	...
	protected override void OnShow()
	{
		...
		AudioManager.Sfx(SfxTableID.electricityGeneratorSfx, base.transform.position, 1f, 1f, loop: true, freeAudioSourceAfterItStoppedPlaying: true, AudioManager.MixerGroupEnum.EFFECTS, reuseSfxs: false, playOnGamepad: false, loopingSfx);
		base.OnShow();
	}
