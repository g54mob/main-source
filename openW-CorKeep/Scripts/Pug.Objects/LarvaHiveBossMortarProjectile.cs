...
public class LarvaHiveBossMortarProjectile : EntityMonoBehaviour
{
	...
	protected void Explode()
	{
		...
		Manager.effects.PlayTempSprite(SpriteTempEffectID.AcidSplat, base.transform.position + new Vector3(0f, 0.3125f, -0.3125f));
	}
