...
public class WoodenDestructible : EntityMonoBehaviour
{
	protected override void HandleAnimationTrigger(int animID)
	{
		...
		if (animID == -414722770)
		{
			...
			AudioManager.Sfx(SfxID.wall, base.transform.position, 0.4f, 1f, 0.1f, reuse: false, AudioManager.MixerGroupEnum.EFFECTS, ignoreAudioIfOutsideOfViewport: false, useSpatialSound: true, loop: false, 16f, 10f, muteVolumeWhilePaused: true, freeAudioSourceAfterItStoppedPlaying: true, playOnGamepad: true);
			...
			case 0:
				...
				break;
			case 1:
				Manager.effects.PlayPuff(PuffID.WoodDebris, variationsParticleSpawnLocation.position, 20);
				Manager.effects.PlayPuff(PuffID.DirtBlockDebris, variationsParticleSpawnLocation.position, 15);
				Manager.effects.PlayPuff(PuffID.SmallDirtSmoke, variationsParticleSpawnLocation.position, 15);
				break;
			case 2:
				Manager.effects.PlayPuff(PuffID.WoodDebris, variationsParticleSpawnLocation.position, 30);
				Manager.effects.PlayPuff(PuffID.DirtBlockDebris, variationsParticleSpawnLocation.position, 25);
