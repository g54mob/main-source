...
namespace I2.Loc
{
	public static class LocalizationManager
	{
		...
		public static string[] GlobalSources = new string[2] { "EmptyI2Languages", "I2Languages" };
		...
		{
			LanguageSource[] array = (LanguageSource[])UnityEngine.Object.FindObjectsOfType(typeof(LanguageSource));
