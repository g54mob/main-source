...
namespace Rewired
{
	...
	public sealed class AxisCalibration
	{
		...
		{
			0,
			AxisCalibrationInfo.hobOJielcSEtQeTGTSXJytvfhqBn(AxisCalibrationData.Default)
		} };
		...
		private void CreateDefaultHardwareCalibration(AxisCalibrationData defaultData)
		{
			...
			{
				AxisCalibrationInfo value = AxisCalibrationInfo.hobOJielcSEtQeTGTSXJytvfhqBn(defaultData);
