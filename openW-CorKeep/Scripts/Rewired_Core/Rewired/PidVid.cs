...
namespace Rewired
{
	...
	{
		private const string mvqaynywjJqAMCDITIlvhBHMWxVg = "[^a-fA-F0-9]";
		...
		{
			if (string.IsNullOrEmpty(quaKniKaolDctnQGuXCUbQjlHfHE(P_0)))
			{
				productId = 0;
				vendorId = 0;
				return;
		...
		{
			return GIfINIHPmnstZOibpMbtoSVZSZsf(quaKniKaolDctnQGuXCUbQjlHfHE(pidVid));
		}
		...
		private bool GIfINIHPmnstZOibpMbtoSVZSZsf(string P_0)
		{
		...
		private static string quaKniKaolDctnQGuXCUbQjlHfHE(string P_0)
		{
