...
namespace Rewired
{
	...
	public sealed class InputMapCategory : InputCategory
	{
		...
		internal List<int> VsTsjCSqoYfzEfBboOJteWttoNhoA => _checkConflictsCategoryIds;
		...
		internal void vTXpUkrWOurLWbbFXcWstXgFbSFr()
		{
			base.ZzoVDiFcIzGOVDvNlITWKiMIFbjy();
		...
		internal void iEMfGtfvJNowKdnOKPKDkHLzBAED()
		{
			base.jBXBmBeKAZaSYPFvJNoUCmXvWKCW();
		}
	}
}
