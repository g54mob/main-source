...
namespace Rewired.Components
{
	...
	public class PlayerController : ComponentWrapper<Rewired.PlayerController>, IPlayerController
	{
		...
		protected override void OnAwakeFinished()
		{
			...
			if (base.initialized)
			{
				nGcjjmEmhIfTTAKKzUSXpccGZJYiA(true);
			}
		}
		...
		protected override void Subscribe()
		{
			...
			if (base.source != null)
			{
				base.source.Rewired_002EIPlayerController_002EButtonStateChangedEvent += tULGEHBBddduntWmMhEgvdqvmfchb;
				base.source.Rewired_002EIPlayerController_002EAxisValueChangedEvent += WoqgXWJxSTkfcSFgmAPPTDfQEHJFA;
				base.source.Rewired_002EIPlayerController_002EEnabledStateChangedEvent += nGcjjmEmhIfTTAKKzUSXpccGZJYiA;
			}
		}
		...
		internal virtual List<ElementInfo> dTgpXBhuEhLRKhhCMfokbMJxBbXKA()
		{
		...
		private void tULGEHBBddduntWmMhEgvdqvmfchb(int P_0, bool P_1)
		{
		...
		private void WoqgXWJxSTkfcSFgmAPPTDfQEHJFA(int P_0, float P_1)
		{
			if (!base.isActiveAndEnabled)
			{
				return;
		...
		private void nGcjjmEmhIfTTAKKzUSXpccGZJYiA(bool P_0)
		{
			try
			{
		...
		private void tFsnLFpFxDdwzTRnQIlFBbPHCnjrA()
		{
			if (_elements == null || _elements.Count <= 0)
			{
				_elements = dTgpXBhuEhLRKhhCMfokbMJxBbXKA();
			}
		}
	}
}
