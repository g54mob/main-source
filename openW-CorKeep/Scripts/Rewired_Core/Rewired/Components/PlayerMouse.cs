...
namespace Rewired.Components
{
	...
	public sealed class PlayerMouse : PlayerController, IPlayerMouse, IPlayerController, IMouseInputSource
	{
		...
		private Rewired.PlayerMouse ZCMEnDnbPcwHljTaqMidkAluFNEK => base.source as Rewired.PlayerMouse;
		...
		bool IPlayerMouse.defaultToCenter
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EdefaultToCenter;
			}
			set
			{
				if (ZCMEnDnbPcwHljTaqMidkAluFNEK == null)
				{
					_defaultToCenter = value;
					return;
				}
				ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EdefaultToCenter = value;
				_defaultToCenter = ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EdefaultToCenter;
			}
		}
		...
		public bool clampToMovementArea
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.clampToMovementArea;
			}
			set
			{
				if (ZCMEnDnbPcwHljTaqMidkAluFNEK == null)
				...
				ZCMEnDnbPcwHljTaqMidkAluFNEK.clampToMovementArea = value;
				_clampToMovementArea = ZCMEnDnbPcwHljTaqMidkAluFNEK.clampToMovementArea;
			}
		}
		...
		ScreenRect IPlayerMouse.movementArea
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EmovementArea;
			}
			set
			{
				if (ZCMEnDnbPcwHljTaqMidkAluFNEK == null)
				...
				ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EmovementArea = value;
				_movementArea = new Rect(ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EmovementArea.xMin, ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EmovementArea.yMin, ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EmovementArea.width, ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EmovementArea.height);
			}
		}
		...
		Rewired.PlayerMouse.MovementAreaUnit IPlayerMouse.movementAreaUnit
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EmovementAreaUnit;
			}
			set
			{
				if (ZCMEnDnbPcwHljTaqMidkAluFNEK == null)
				...
				ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EmovementAreaUnit = value;
				_movementAreaUnit = ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EmovementAreaUnit;
			}
		}
		...
		Vector2 IPlayerMouse.screenPosition
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EscreenPosition;
			}
			set
			{
				if (ZCMEnDnbPcwHljTaqMidkAluFNEK != null)
				{
					ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EscreenPosition = value;
				}
			}
		}
		...
		Vector2 IPlayerMouse.screenPositionPrev
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EscreenPositionPrev;
			}
		}
		...
		Vector2 IPlayerMouse.screenPositionDelta
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EscreenPositionDelta;
			}
		}
		...
		Rewired.PlayerController.MouseAxis IPlayerMouse.xAxis
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002ExAxis;
			}
		}
		...
		Rewired.PlayerController.MouseAxis IPlayerMouse.yAxis
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EyAxis;
			}
		}
		...
		Rewired.PlayerController.MouseWheel IPlayerMouse.wheel
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002Ewheel;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.leftButton
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EleftButton;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.rightButton
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002ErightButton;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.middleButton
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EmiddleButton;
			}
		}
		...
		float IPlayerMouse.pointerSpeed
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EpointerSpeed;
			}
			set
			{
				if (value < 0f)
				...
				if (base.initialized)
				{
					ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EpointerSpeed = value;
					_pointerSpeed = ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EpointerSpeed;
				}
			}
		}
		...
		bool IPlayerMouse.useHardwarePointerPosition
		{
			get
			{
				...
				return ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EuseHardwarePointerPosition;
			}
			set
			{
				...
				if (base.initialized)
				{
					ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EuseHardwarePointerPosition = value;
				}
			}
		}
		...
		bool IMouseInputSource.enabled
		{
			get
			{
				...
				return ((IMouseInputSource)ZCMEnDnbPcwHljTaqMidkAluFNEK).enabled;
			}
		}
		...
		Vector2 IMouseInputSource.screenPosition
		{
			get
			{
				...
				return ((IMouseInputSource)ZCMEnDnbPcwHljTaqMidkAluFNEK).screenPosition;
			}
		}
		...
		Vector2 IMouseInputSource.screenPositionDelta
		{
			get
			{
				...
				return ((IMouseInputSource)ZCMEnDnbPcwHljTaqMidkAluFNEK).screenPositionDelta;
			}
		}
		...
		Vector2 IMouseInputSource.wheelDelta
		{
			get
			{
				...
				return ((IMouseInputSource)ZCMEnDnbPcwHljTaqMidkAluFNEK).wheelDelta;
			}
		}
		...
		bool IMouseInputSource.locked
		{
			get
			{
				...
				return ((IMouseInputSource)ZCMEnDnbPcwHljTaqMidkAluFNEK).locked;
			}
		}
		...
		event Action<Vector2> IPlayerMouse.ScreenPositionChangedEvent
		{
			add
			{
				if (base.initialized)
				{
					ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EScreenPositionChangedEvent += value;
				}
			}
			remove
			{
		...
		protected override Rewired.PlayerController CreateSource(object args)
		{
			...
			if (list == null || list.Count == 0)
			{
				...
				list = dTgpXBhuEhLRKhhCMfokbMJxBbXKA();
			}
		...
		protected override void Subscribe()
		{
			...
			if (ZCMEnDnbPcwHljTaqMidkAluFNEK != null)
			{
				ZCMEnDnbPcwHljTaqMidkAluFNEK.Rewired_002EIPlayerMouse_002EScreenPositionChangedEvent += NfzfWeoEkyGtNniMKDqzADaPGeiGb;
			}
		}
		...
		internal List<ElementInfo> CFppruOgFeqfsEhSgWRBRXsToaju()
		{
		...
		private void NfzfWeoEkyGtNniMKDqzADaPGeiGb(Vector2 P_0)
		{
		...
		bool IMouseInputSource.GetButtonDown(int button)
		{
			...
			return ((IMouseInputSource)ZCMEnDnbPcwHljTaqMidkAluFNEK).GetButtonDown(button);
		}
		...
		bool IMouseInputSource.GetButtonUp(int button)
		{
			...
			return ((IMouseInputSource)ZCMEnDnbPcwHljTaqMidkAluFNEK).GetButtonUp(button);
		}
		...
		bool IMouseInputSource.GetButton(int button)
		{
			...
			return ((IMouseInputSource)ZCMEnDnbPcwHljTaqMidkAluFNEK).GetButton(button);
		}
	}
}
