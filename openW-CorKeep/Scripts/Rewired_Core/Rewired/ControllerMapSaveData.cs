...
namespace Rewired
{
	public abstract class ControllerMapSaveData
	{
		...
		internal readonly int YkHbQejdftCyPplYjVPXeEmJaEgt;
		...
		internal ControllerMapSaveData(Controller P_0, ControllerMap P_1)
		{
			_controller = P_0;
			_map = P_1;
			YkHbQejdftCyPplYjVPXeEmJaEgt = ReInput.id;
		}

		internal static _0001 RrBuWyaxyukNBkJrMOCMOLbBMZwV<_0001>(Controller P_0, ControllerMap P_1) where _0001 : ControllerMapSaveData
		{
			return (_0001)RrBuWyaxyukNBkJrMOCMOLbBMZwV(P_0, P_1);
		}

		internal static ControllerMapSaveData RrBuWyaxyukNBkJrMOCMOLbBMZwV(Controller P_0, ControllerMap P_1)
		{
