...
namespace Rewired.Utils
{
	...
	{
		private static byte[] GiGDSJfeJeYqDUgftkSpmTzikhJK;

		private static byte[] intToFloatBuffer => GiGDSJfeJeYqDUgftkSpmTzikhJK ?? (GiGDSJfeJeYqDUgftkSpmTzikhJK = new byte[4]);
