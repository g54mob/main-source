...
namespace Rewired.Utils
{
	...
	{
		private static string nqdyVFMdrZissPuuLjjfqluHhdou;
		...
		static StringTools()
		{
			nqdyVFMdrZissPuuLjjfqluHhdou = Regex.Escape(new string(Path.GetInvalidFileNameChars()));
		}

		public static string CleanUpFileName(string name)
		{
			name = name.Trim();
			string pattern = "[ ~`,:;'\\.\\$\\^\\{\\}\\[\\]\\(\\|\\)\\*\\+\\?\\\\" + nqdyVFMdrZissPuuLjjfqluHhdou + "]";
