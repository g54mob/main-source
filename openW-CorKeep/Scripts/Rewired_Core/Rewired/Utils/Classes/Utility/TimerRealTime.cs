...
namespace Rewired.Utils.Classes.Utility
{
	...
	internal class TimerRealTime
	{
		...
		[SerializeField]
		private double YQseucMIJPxJSJcSwczDUsnQMmXm;
		...
		{
			running = true;
			YQseucMIJPxJSJcSwczDUsnQMmXm = length + ReInput.realTime;
		}
		...
		public bool Update()
		{
			...
			if (ReInput.realTime >= YQseucMIJPxJSJcSwczDUsnQMmXm)
			{
				running = false;
				return true;
			}
		...
		{
			running = false;
			YQseucMIJPxJSJcSwczDUsnQMmXm = 0.0;
		}
