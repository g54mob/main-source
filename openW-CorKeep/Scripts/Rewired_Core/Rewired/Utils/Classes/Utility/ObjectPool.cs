...
namespace Rewired.Utils.Classes.Utility
{
	...
	internal class ObjectPool<T> : IObjectPool, IObjectPool<T> where T : class
	{
		...
		protected ulong InstanceCount => YureueQGJNfIxBGPaAjEgWAADNbSb;
		...
		{
			YureueQGJNfIxBGPaAjEgWAADNbSb = ((YureueQGJNfIxBGPaAjEgWAADNbSb < ulong.MaxValue) ? (YureueQGJNfIxBGPaAjEgWAADNbSb + 1) : 0);
			return YureueQGJNfIxBGPaAjEgWAADNbSb;
		}
	}
}
