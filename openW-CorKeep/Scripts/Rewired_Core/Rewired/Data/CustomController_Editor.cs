	...
	public sealed class CustomController_Editor
	{
		...
		private sealed class kvoRBbBSihqWmrRmvrFnLngoTzmB : IEnumerable<ControllerElementIdentifier>, IEnumerable, IEnumerator<ControllerElementIdentifier>, IEnumerator, IDisposable
		{
			...
			ControllerElementIdentifier IEnumerator<ControllerElementIdentifier>.Current
			{
				...
				get
				{
					return qqSyfbsPLwHemEDfHTvyFmiszqDsA;
				}
			}
			...
			{
				dcGtIPUdgoTLSVdSAwUtuqybBHZp = P_0;
				myTLRjuCXKLuSlChRODorLVQOhPB = Environment.CurrentManagedThreadId;
			}

			[DebuggerHidden]
			void IDisposable.Dispose()
			{
				dcGtIPUdgoTLSVdSAwUtuqybBHZp = -2;
			}

			private bool MoveNext()
			{
				int num = dcGtIPUdgoTLSVdSAwUtuqybBHZp;
				CustomController_Editor customController_Editor = clYkYcmwiUbyMuqOiFdNfgnZyxvt;
				switch (num)
				{
				default:
					return false;
				case 0:
					dcGtIPUdgoTLSVdSAwUtuqybBHZp = -1;
					if (customController_Editor._elementIdentifiers == null)
					{
						return false;
					}
					PpRAaSJmtJJaEFSYOLyJXetZlTZr = 0;
					break;
				case 1:
					dcGtIPUdgoTLSVdSAwUtuqybBHZp = -1;
					PpRAaSJmtJJaEFSYOLyJXetZlTZr++;
					break;
				}
				if (PpRAaSJmtJJaEFSYOLyJXetZlTZr < customController_Editor._elementIdentifiers.Count)
				{
					qqSyfbsPLwHemEDfHTvyFmiszqDsA = customController_Editor._elementIdentifiers[PpRAaSJmtJJaEFSYOLyJXetZlTZr];
					dcGtIPUdgoTLSVdSAwUtuqybBHZp = 1;
					return true;
				}
				return false;
			...
			{
				kvoRBbBSihqWmrRmvrFnLngoTzmB kvoRBbBSihqWmrRmvrFnLngoTzmB2;
				if (dcGtIPUdgoTLSVdSAwUtuqybBHZp == -2 && myTLRjuCXKLuSlChRODorLVQOhPB == Environment.CurrentManagedThreadId)
				{
					dcGtIPUdgoTLSVdSAwUtuqybBHZp = 0;
					kvoRBbBSihqWmrRmvrFnLngoTzmB2 = this;
				}
				else
				{
					kvoRBbBSihqWmrRmvrFnLngoTzmB2 = new kvoRBbBSihqWmrRmvrFnLngoTzmB(0);
					kvoRBbBSihqWmrRmvrFnLngoTzmB2.clYkYcmwiUbyMuqOiFdNfgnZyxvt = clYkYcmwiUbyMuqOiFdNfgnZyxvt;
				}
				return kvoRBbBSihqWmrRmvrFnLngoTzmB2;
			}
		...
		public IEnumerable<ControllerElementIdentifier> ElementIdentifiers
		{
			...
			get
			{
				return new kvoRBbBSihqWmrRmvrFnLngoTzmB(-2)
				{
					clYkYcmwiUbyMuqOiFdNfgnZyxvt = this
				};
			}
		}
		...
		public void AddAxis()
		{
			axes.Add((Axis)bvZqGkvVuLmjJfgKrgluQeAyQZhw(ControllerElementType.Axis));
		}

		public void AddButton()
		{
			buttons.Add((Button)bvZqGkvVuLmjJfgKrgluQeAyQZhw(ControllerElementType.Button));
		}
		...
		public void InsertAxis(int index)
		{
			...
			axes.Insert(index, (Axis)bvZqGkvVuLmjJfgKrgluQeAyQZhw(ControllerElementType.Axis));
		}
		...
		public void InsertButton(int index)
		{
			...
			buttons.Insert(index, (Button)bvZqGkvVuLmjJfgKrgluQeAyQZhw(ControllerElementType.Button));
		}
		...
		public void DuplicateElement(ControllerElementType type, int index)
		{
			...
			{
			case ControllerElementType.Axis:
				iGgykpylQgrtiXFHiwxwbFoiQxHh(index, axes);
				break;
			case ControllerElementType.Button:
				iGgykpylQgrtiXFHiwxwbFoiQxHh(index, buttons);
				break;
			default:
				throw new NotImplementedException();
			}
		...
		private void iGgykpylQgrtiXFHiwxwbFoiQxHh<_0001>(int P_0, List<_0001> P_1) where _0001 : Element
		{
			...
			ControllerElementIdentifier controllerElementIdentifier = wmcDWPHDBjRykmfXjTObvAQIdGQl(val.elementIdentifierId, text);
		...
		private Element bvZqGkvVuLmjJfgKrgluQeAyQZhw(ControllerElementType P_0)
		{
			...
			case ControllerElementType.Axis:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier2 = fkirjzCdYHnFikuKyDTWPgMuRSBI(P_0, text2, string.Empty, string.Empty, key, string.Empty, string.Empty);
			...
			case ControllerElementType.Button:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier = fkirjzCdYHnFikuKyDTWPgMuRSBI(P_0, text, string.Empty, string.Empty, key, string.Empty, string.Empty);
