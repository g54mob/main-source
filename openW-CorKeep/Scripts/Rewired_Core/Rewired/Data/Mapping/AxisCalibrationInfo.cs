...
namespace Rewired.Data.Mapping
{
	...
	public class AxisCalibrationInfo : IDeepCloneable
	{
		...
		internal static AxisCalibrationData tQhuXiCbsJBFxQOUQeLYcKcvrJi(AxisCalibrationInfo P_0)
		{
			if (P_0 == null)
			{
		...
		internal static AxisCalibrationInfo hobOJielcSEtQeTGTSXJytvfhqBn(AxisCalibrationData P_0)
		{
