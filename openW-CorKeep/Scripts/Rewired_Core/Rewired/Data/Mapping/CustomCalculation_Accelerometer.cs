...
namespace Rewired.Data.Mapping
{
	...
	public sealed class CustomCalculation_Accelerometer : CustomCalculation
	{
		...
		internal bool nuveXeExpPcUrNxizgmPSfhBEVEZ()
		{
			bool flag = false;
			ClearResult();
			if (base.DataCount >= 1)
			{
				...
				case CalculationType.Pitch:
					_result = AIsGJRbGrqEhbXqRKPrgwfPEBshJA();
					flag = true;
					break;
				case CalculationType.Roll:
					_result = aWrmaHQfRLRjRSEvvONPYnTpBFpp();
					flag = true;
					break;
				}
			}
		...
		private float AIsGJRbGrqEhbXqRKPrgwfPEBshJA()
		{
			...
			return _outputType switch
			{
				...
				OutputType.Axis => HZIxKhCGGfOkZYTelRdgMnTfYtqU(num2), 
				_ => 0f, 
			};
		}
