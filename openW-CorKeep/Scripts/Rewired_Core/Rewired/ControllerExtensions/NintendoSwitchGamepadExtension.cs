...
namespace Rewired.ControllerExtensions
{
	...
	public abstract class NintendoSwitchGamepadExtension : Controller.Extension, IControllerVibrator, IHIDControllerExtension
	{
		...
		private ExtSource_Base UdfJlmANoMjwGsXTXcjklrbTNIfW;

		private bool jnXGKGUosrAmCKdwNcCREqwACSGBb;

		protected bool isValid => jnXGKGUosrAmCKdwNcCREqwACSGBb;

		protected Joystick joystick => GetController<Joystick>();

		protected object source => UdfJlmANoMjwGsXTXcjklrbTNIfW;
		...
		int IControllerVibrator.vibrationMotorCount
		{
			get
			{
				...
				if (!jnXGKGUosrAmCKdwNcCREqwACSGBb)
				{
					return 0;
				}
				return UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.vibrationMotorCount;
			}
		}
		...
		ushort IHIDControllerExtension.vendorId
		{
			get
			{
				...
				return UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.vendorId;
			}
		}
		...
		ushort IHIDControllerExtension.productId
		{
			get
			{
				...
				return UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.productId;
			}
		}
		...
		string IHIDControllerExtension.productName
		{
			get
			{
				...
				return UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.productName;
			}
		}
		...
		string IHIDControllerExtension.manufacturer
		{
			get
			{
				...
				return UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.manufacturer;
			}
		}
		...
		ushort IHIDControllerExtension.usagePage
		{
			get
			{
				...
				return UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.usagePage;
			}
		}
		...
		ushort IHIDControllerExtension.usage
		{
			get
			{
				...
				return UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.usage;
			}
		}
		...
		public NintendoSwitchGamepadVibration GetVibration(int motorIndex)
		{
			...
			{
				ReInput.CheckInitialized(_reInputId);
				return NintendoSwitchGamepadVibration.RXbBjaKZpcAjacbaKHjRtvUdjpSMb;
			}
			if (!jnXGKGUosrAmCKdwNcCREqwACSGBb || !base.enabled)
			{
				return NintendoSwitchGamepadVibration.RXbBjaKZpcAjacbaKHjRtvUdjpSMb;
			}
			UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.GetVibration(motorIndex, out var amplitudeLow, out var frequencyLow, out var amplitudeHigh, out var frequencyHigh);
		...
		public void SetVibration(int motorIndex, float amplitudeLow, float frequencyLow, float amplitudeHigh, float frequencyHigh)
		{
			...
			else if (jnXGKGUosrAmCKdwNcCREqwACSGBb && base.enabled)
			{
				UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.SetVibration(motorIndex, amplitudeLow, frequencyLow, amplitudeHigh, frequencyHigh);
			}
		}
		...
		public void SetVibration(int motorIndex, float amplitudeLow, float frequencyLow, float amplitudeHigh, float frequencyHigh, bool stopOtherMotors)
		{
			...
			{
				UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.SetVibration(motorIndex, amplitudeLow, frequencyLow, amplitudeHigh, frequencyHigh, stopOtherMotors);
			}
		}
		...
		public void SetVibration(int motorIndex, float amplitudeLow, float frequencyLow, float amplitudeHigh, float frequencyHigh, float duration)
		{
			...
			{
				UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.SetVibration(motorIndex, amplitudeLow, frequencyLow, amplitudeHigh, frequencyHigh, duration);
			}
		}
		...
		public void SetVibration(int motorIndex, float amplitudeLow, float frequencyLow, float amplitudeHigh, float frequencyHigh, float duration, bool stopOtherMotors)
		{
			...
			{
				UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.SetVibration(motorIndex, amplitudeLow, frequencyLow, amplitudeHigh, frequencyHigh, duration, stopOtherMotors);
			}
		}
		...
		public void SetVibration(int motorIndex, NintendoSwitchGamepadVibration vibration)
		{
			...
			{
				UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.SetVibration(motorIndex, vibration.amplitudeLow, vibration.frequencyLow, vibration.amplitudeHigh, vibration.frequencyHigh);
			}
		}
		...
		public void SetVibration(int motorIndex, NintendoSwitchGamepadVibration vibration, float duration)
		{
			...
			{
				UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.SetVibration(motorIndex, vibration.amplitudeLow, vibration.frequencyLow, vibration.amplitudeHigh, vibration.frequencyHigh, duration);
			}
		}
		...
		public void SetVibration(int motorIndex, NintendoSwitchGamepadVibration vibration, float duration, bool stopOtherMotors)
		{
			...
			{
				UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.SetVibration(motorIndex, vibration.amplitudeLow, vibration.frequencyLow, vibration.amplitudeHigh, vibration.frequencyHigh, duration, stopOtherMotors);
			}
		}
		...
		public void SetVibration(int motorIndex, NintendoSwitchGamepadVibration vibration, bool stopOtherMotors)
		{
			...
			{
				UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.SetVibration(motorIndex, vibration.amplitudeLow, vibration.frequencyLow, vibration.amplitudeHigh, vibration.frequencyHigh, stopOtherMotors);
			}
		}
		...
		public void StopVibration(int motorIndex)
		{
			...
			else if (jnXGKGUosrAmCKdwNcCREqwACSGBb)
			{
				UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.StopVibration(motorIndex);
			}
		}
		...
		public void StopVibration()
		{
			...
			{
				UdfJlmANoMjwGsXTXcjklrbTNIfW.driver.StopVibration();
			}
		}
		...
		{
			UdfJlmANoMjwGsXTXcjklrbTNIfW = source as ExtSource_Base;
			jnXGKGUosrAmCKdwNcCREqwACSGBb = UdfJlmANoMjwGsXTXcjklrbTNIfW != null && UdfJlmANoMjwGsXTXcjklrbTNIfW.driver != null;
		}
	}
}
