...
namespace Rewired.Internal
{
	...
	internal sealed class StandaloneAxis
	{
		...
		[CompilerGenerated]
		private AxisValueChangedEventHandler BFeXoKOKcyVxIKRovLYTGIbotfDw;

		[CompilerGenerated]
		private AxisValueChangedEventHandler GaRcQnUZTlaJPCqcrFktSvdhfSYJ;

		[CompilerGenerated]
		private ButtonDownEventHandler tfYprYJuXJNCfvOdDDAeeIzDEQScb;

		[CompilerGenerated]
		private ButtonUpEventHandler ZLKYwSdjRZfOJhuYcKoycduZeSgfA;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler oseehBAAKUOUVROnjCKlVNAvhUPE;

		[CompilerGenerated]
		private ButtonDownEventHandler awcCKCSyqxPMoaRNXEXxqXoAutgw;

		[CompilerGenerated]
		private ButtonUpEventHandler oexFybDlObtTTjIvUJchCDtEeIjpA;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler bNRhiMNUqimcxeHaWyshHGGpWsiM;
		...
		private event AxisValueChangedEventHandler _AxisValueChangedEvent
		{
			...
			add
			{
				AxisValueChangedEventHandler axisValueChangedEventHandler = BFeXoKOKcyVxIKRovLYTGIbotfDw;
				...
				do
				{
					...
					axisValueChangedEventHandler = Interlocked.CompareExchange(ref BFeXoKOKcyVxIKRovLYTGIbotfDw, axisValueChangedEventHandler3, axisValueChangedEventHandler2);
				}
		...
		private event AxisValueChangedEventHandler _RawAxisValueChangedEvent
		{
			...
			add
			{
				AxisValueChangedEventHandler axisValueChangedEventHandler = GaRcQnUZTlaJPCqcrFktSvdhfSYJ;
				AxisValueChangedEventHandler axisValueChangedEventHandler2;
				do
				{
					axisValueChangedEventHandler2 = axisValueChangedEventHandler;
					AxisValueChangedEventHandler axisValueChangedEventHandler3 = (AxisValueChangedEventHandler)Delegate.Combine(axisValueChangedEventHandler2, b);
					axisValueChangedEventHandler = Interlocked.CompareExchange(ref GaRcQnUZTlaJPCqcrFktSvdhfSYJ, axisValueChangedEventHandler3, axisValueChangedEventHandler2);
				}
				while ((object)axisValueChangedEventHandler != axisValueChangedEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonDownEventHandler _ButtonDownEvent
		{
			...
			add
			{
				ButtonDownEventHandler buttonDownEventHandler = tfYprYJuXJNCfvOdDDAeeIzDEQScb;
				...
				do
				{
					...
					buttonDownEventHandler = Interlocked.CompareExchange(ref tfYprYJuXJNCfvOdDDAeeIzDEQScb, buttonDownEventHandler3, buttonDownEventHandler2);
				}
		...
		private event ButtonUpEventHandler _ButtonUpEvent
		{
			...
			add
			{
				ButtonUpEventHandler buttonUpEventHandler = ZLKYwSdjRZfOJhuYcKoycduZeSgfA;
				...
				do
				{
					...
					buttonUpEventHandler = Interlocked.CompareExchange(ref ZLKYwSdjRZfOJhuYcKoycduZeSgfA, buttonUpEventHandler3, buttonUpEventHandler2);
				}
		...
		private event ButtonValueChangedEventHandler _ButtonValueChangedEvent
		{
			...
			add
			{
				ButtonValueChangedEventHandler buttonValueChangedEventHandler = oseehBAAKUOUVROnjCKlVNAvhUPE;
				...
				do
				{
					...
					buttonValueChangedEventHandler = Interlocked.CompareExchange(ref oseehBAAKUOUVROnjCKlVNAvhUPE, buttonValueChangedEventHandler3, buttonValueChangedEventHandler2);
				}
		...
		private event ButtonDownEventHandler _RawButtonDownEvent
		{
			...
			add
			{
				ButtonDownEventHandler buttonDownEventHandler = awcCKCSyqxPMoaRNXEXxqXoAutgw;
				ButtonDownEventHandler buttonDownEventHandler2;
				do
				{
					buttonDownEventHandler2 = buttonDownEventHandler;
					ButtonDownEventHandler buttonDownEventHandler3 = (ButtonDownEventHandler)Delegate.Combine(buttonDownEventHandler2, b);
					buttonDownEventHandler = Interlocked.CompareExchange(ref awcCKCSyqxPMoaRNXEXxqXoAutgw, buttonDownEventHandler3, buttonDownEventHandler2);
				}
				while ((object)buttonDownEventHandler != buttonDownEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonUpEventHandler _RawButtonUpEvent
		{
			...
			add
			{
				ButtonUpEventHandler buttonUpEventHandler = oexFybDlObtTTjIvUJchCDtEeIjpA;
				ButtonUpEventHandler buttonUpEventHandler2;
				do
				{
					buttonUpEventHandler2 = buttonUpEventHandler;
					ButtonUpEventHandler buttonUpEventHandler3 = (ButtonUpEventHandler)Delegate.Combine(buttonUpEventHandler2, b);
					buttonUpEventHandler = Interlocked.CompareExchange(ref oexFybDlObtTTjIvUJchCDtEeIjpA, buttonUpEventHandler3, buttonUpEventHandler2);
				}
				while ((object)buttonUpEventHandler != buttonUpEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonValueChangedEventHandler _RawButtonValueChangedEvent
		{
			...
			add
			{
				ButtonValueChangedEventHandler buttonValueChangedEventHandler = bNRhiMNUqimcxeHaWyshHGGpWsiM;
				ButtonValueChangedEventHandler buttonValueChangedEventHandler2;
				do
				{
					buttonValueChangedEventHandler2 = buttonValueChangedEventHandler;
					ButtonValueChangedEventHandler buttonValueChangedEventHandler3 = (ButtonValueChangedEventHandler)Delegate.Combine(buttonValueChangedEventHandler2, b);
					buttonValueChangedEventHandler = Interlocked.CompareExchange(ref bNRhiMNUqimcxeHaWyshHGGpWsiM, buttonValueChangedEventHandler3, buttonValueChangedEventHandler2);
				}
				while ((object)buttonValueChangedEventHandler != buttonValueChangedEventHandler2);
			}
			[CompilerGenerated]
		...
		public void SetRawValue(float value)
		{
			...
			if (GaRcQnUZTlaJPCqcrFktSvdhfSYJ != null && _valueRaw != _valueRawPrev)
			{
				GaRcQnUZTlaJPCqcrFktSvdhfSYJ(_valueRaw);
			}
			if (BFeXoKOKcyVxIKRovLYTGIbotfDw != null)
			{
				float num = this.value;
				if (num != valuePrev)
				{
					BFeXoKOKcyVxIKRovLYTGIbotfDw(num);
				}
			}
			if (bNRhiMNUqimcxeHaWyshHGGpWsiM != null)
			{
				bool flag = rawButtonValue;
				if (flag != rawButtonValuePrev)
				{
					bNRhiMNUqimcxeHaWyshHGGpWsiM(flag);
				}
			}
			if (awcCKCSyqxPMoaRNXEXxqXoAutgw != null && rawButtonValue && !rawButtonValuePrev)
			{
				awcCKCSyqxPMoaRNXEXxqXoAutgw();
			}
			if (oexFybDlObtTTjIvUJchCDtEeIjpA != null && !rawButtonValue && rawButtonValuePrev)
			{
				oexFybDlObtTTjIvUJchCDtEeIjpA();
			}
			if (oseehBAAKUOUVROnjCKlVNAvhUPE != null)
			{
				bool flag2 = buttonValue;
				if (flag2 != buttonValuePrev)
				{
					oseehBAAKUOUVROnjCKlVNAvhUPE(flag2);
				}
			}
			if (tfYprYJuXJNCfvOdDDAeeIzDEQScb != null && buttonValue && !buttonValuePrev)
			{
				tfYprYJuXJNCfvOdDDAeeIzDEQScb();
			}
			if (ZLKYwSdjRZfOJhuYcKoycduZeSgfA != null && !buttonValue && buttonValuePrev)
			{
				ZLKYwSdjRZfOJhuYcKoycduZeSgfA();
			}
		}
