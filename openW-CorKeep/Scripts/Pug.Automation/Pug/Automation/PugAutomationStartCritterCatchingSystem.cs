...
namespace Pug.Automation
{
	...
	public struct PugAutomationStartCritterCatchingSystem : ISystem, ISystemCompilerGenerated
	{
		[BurstCompile]
		[WithAll(new Type[] { typeof(CritterCatcherCD) })]
		[WithChangeFilter(new Type[] { typeof(BigEntityCraftingDataChangedTriggerCD) })]
		private struct UpdateCritterCatchingTimerJob : IJobEntity, IJobChunk
		{
			public struct InternalCompilerQueryAndHandleData
			{
				...
				private void __AssignQueries(ref SystemState state)
				{
					...
					entityQueryBuilder2 = entityQueryBuilder2.WithAll<CritterCatcherCD>();
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public void Run(ref UpdateCritterCatchingTimerJob job, EntityQuery query)
				{
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public JobHandle Schedule(ref UpdateCritterCatchingTimerJob job, EntityQuery query, JobHandle dependency)
				{
					job.__TypeHandle = __TypeHandle;
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public JobHandle ScheduleParallel(ref UpdateCritterCatchingTimerJob job, EntityQuery query, JobHandle dependency)
				{
					job.__TypeHandle = __TypeHandle;
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public void UpdateBaseEntityIndexArray(ref UpdateCritterCatchingTimerJob job, EntityQuery query, ref SystemState state)
				{
				}

				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public JobHandle UpdateBaseEntityIndexArray(ref UpdateCritterCatchingTimerJob job, EntityQuery query, JobHandle dependency, ref SystemState state)
				{
					return dependency;
				}

				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public void AssignEntityManager(ref UpdateCritterCatchingTimerJob job, EntityManager entityManager)
				{
				}
			}
			...
			public ComponentLookup<CritterCatchingCD> CritterCatchingLookup;
			...
			private void Execute(Entity entity, in BigEntityRefCD bigEntityRefCD, in CrafterForSlotCD crafterForSlotCD, in PugTimerRefCD pugTimerRef)
			{
				...
				RefRW<CritterCatchingCD> refRWOptional = CritterCatchingLookup.GetRefRWOptional(value);
				if (!refRWOptional.IsValid)
				{
					return;
				}
				ref CritterCatchingCD valueRW = ref refRWOptional.ValueRW;
				...
				bool flag = InventoryUtility.CanCatchCritter(value, slotIndex, containedObjectsBufferLookup, objectCategoryTagsLookup, databaseBankCD);
		...
		private struct TypeHandle
		{
			...
			public ComponentLookup<CritterCatchingCD> __CritterCatchingCD_RW_ComponentLookup;
			...
			public UpdateCritterCatchingTimerJob.InternalCompilerQueryAndHandleData __Pug_Automation_PugAutomationStartCritterCatchingSystem_UpdateCritterCatchingTimerJob_WithDefaultQuery_JobEntityTypeHandle;
			...
			public void __AssignHandles(ref SystemState state)
			{
				...
				__CritterCatchingCD_RW_ComponentLookup = state.GetComponentLookup<CritterCatchingCD>();
				...
				__Pug_Automation_PugAutomationStartCritterCatchingSystem_UpdateCritterCatchingTimerJob_WithDefaultQuery_JobEntityTypeHandle.Init(ref state, assignDefaultQuery: true);
			}
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void __codegen__OnCreate_000001B9_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

		internal static class __codegen__OnCreate_000001B9_0024BurstDirectCall
		{
			...
			private static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnCreate_000001B9_0024PostfixBurstDelegate>(__codegen__OnCreate).Value;
				}
				P_0 = Pointer;
			}
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void __codegen__OnUpdate_000001BA_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

		internal static class __codegen__OnUpdate_000001BA_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnUpdate_000001BA_0024PostfixBurstDelegate>(__codegen__OnUpdate).Value;
				}
				P_0 = Pointer;
			}
		...
		private EntityQuery __query_171009743_0;

		private EntityQuery __query_171009743_1;

		private EntityQuery __query_171009743_2;

		private EntityQuery __query_171009743_3;
		...
		{
			__query_171009743_0.TryGetSingleton<ClientServerTickRate>(out var value);
			value.ResolveDefaults();
			int simulationTickRate = value.SimulationTickRate;
			EntityCommandBuffer ecb = __query_171009743_1.GetSingleton<BeginSimulationEntityCommandBufferSystem.Singleton>().CreateCommandBuffer(state.WorldUnmanaged);
			__query_171009743_2.TryGetSingleton<NetworkTime>(out var _);
			state.Dependency = __ScheduleViaJobChunkExtension_0(new UpdateCritterCatchingTimerJob
			{
				...
				CritterCatchingLookup = InternalCompilerInterface.GetComponentLookup(ref __TypeHandle.__CritterCatchingCD_RW_ComponentLookup, ref state),
				...
				ecb = ecb,
				databaseBankCD = __query_171009743_3.GetSingleton<PugDatabase.DatabaseBankCD>()
			}, __TypeHandle.__Pug_Automation_PugAutomationStartCritterCatchingSystem_UpdateCritterCatchingTimerJob_WithDefaultQuery_JobEntityTypeHandle.DefaultQuery, state.Dependency, ref state, hasUserDefinedQuery: false);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private JobHandle __ScheduleViaJobChunkExtension_0(UpdateCritterCatchingTimerJob job, EntityQuery query, JobHandle dependency, ref SystemState state, bool hasUserDefinedQuery)
		{
			dependency = __TypeHandle.__Pug_Automation_PugAutomationStartCritterCatchingSystem_UpdateCritterCatchingTimerJob_WithDefaultQuery_JobEntityTypeHandle.UpdateBaseEntityIndexArray(ref job, query, dependency, ref state);
			__TypeHandle.__Pug_Automation_PugAutomationStartCritterCatchingSystem_UpdateCritterCatchingTimerJob_WithDefaultQuery_JobEntityTypeHandle.AssignEntityManager(ref job, state.EntityManager);
			__TypeHandle.__Pug_Automation_PugAutomationStartCritterCatchingSystem_UpdateCritterCatchingTimerJob_WithDefaultQuery_JobEntityTypeHandle.__TypeHandle.Update(ref state);
			return __TypeHandle.__Pug_Automation_PugAutomationStartCritterCatchingSystem_UpdateCritterCatchingTimerJob_WithDefaultQuery_JobEntityTypeHandle.Schedule(ref job, query, dependency);
		}
		...
		private void __AssignQueries(ref SystemState state)
		{
			...
			__query_171009743_0 = entityQueryBuilder2.Build(ref state);
			entityQueryBuilder.Reset();
			entityQueryBuilder2 = entityQueryBuilder.WithAll<BeginSimulationEntityCommandBufferSystem.Singleton>();
			entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
			__query_171009743_1 = entityQueryBuilder2.Build(ref state);
			entityQueryBuilder.Reset();
			entityQueryBuilder2 = entityQueryBuilder.WithAll<NetworkTime>();
			entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
			__query_171009743_2 = entityQueryBuilder2.Build(ref state);
			entityQueryBuilder.Reset();
			entityQueryBuilder2 = entityQueryBuilder.WithAll<PugDatabase.DatabaseBankCD>();
			entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
			__query_171009743_3 = entityQueryBuilder2.Build(ref state);
			entityQueryBuilder.Reset();
			entityQueryBuilder.Dispose();
		}
		...
		{
			__codegen__OnCreate_000001B9_0024BurstDirectCall.Invoke(self, state);
		}
		...
		{
			__codegen__OnUpdate_000001BA_0024BurstDirectCall.Invoke(self, state);
		}

		[Unity.Entities.MonoPInvokeCallback(typeof(SystemBaseDelegates.Function))]
		internal unsafe static void __codegen__OnCreateForCompiler(IntPtr self, IntPtr state)
		{
			((PugAutomationStartCritterCatchingSystem*)self.ToPointer())->OnCreateForCompiler(ref *(SystemState*)state.ToPointer());
		}
		...
		{
			((PugAutomationStartCritterCatchingSystem*)self.ToPointer())->OnCreate(ref *(SystemState*)state.ToPointer());
		}
		...
		{
			((PugAutomationStartCritterCatchingSystem*)self.ToPointer())->OnUpdate(ref *(SystemState*)state.ToPointer());
		}
	}
}
