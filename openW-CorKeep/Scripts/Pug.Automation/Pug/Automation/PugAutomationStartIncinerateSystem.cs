...
namespace Pug.Automation
{
	...
	public struct PugAutomationStartIncinerateSystem : ISystem, ISystemCompilerGenerated
	{
		[BurstCompile]
		[WithAll(new Type[] { typeof(SmallIncineratorCD) })]
		[WithChangeFilter(new Type[] { typeof(BigEntityCraftingDataChangedTriggerCD) })]
		private struct UpdateIncinerationTimerJob : IJobEntity, IJobChunk
		{
			public struct InternalCompilerQueryAndHandleData
			{
				...
				private void __AssignQueries(ref SystemState state)
				{
					...
					entityQueryBuilder2 = entityQueryBuilder2.WithAll<SmallIncineratorCD>();
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public void Run(ref UpdateIncinerationTimerJob job, EntityQuery query)
				{
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public JobHandle Schedule(ref UpdateIncinerationTimerJob job, EntityQuery query, JobHandle dependency)
				{
					job.__TypeHandle = __TypeHandle;
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public JobHandle ScheduleParallel(ref UpdateIncinerationTimerJob job, EntityQuery query, JobHandle dependency)
				{
					job.__TypeHandle = __TypeHandle;
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public void UpdateBaseEntityIndexArray(ref UpdateIncinerationTimerJob job, EntityQuery query, ref SystemState state)
				{
				}

				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public JobHandle UpdateBaseEntityIndexArray(ref UpdateIncinerationTimerJob job, EntityQuery query, JobHandle dependency, ref SystemState state)
				{
					return dependency;
				}

				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public void AssignEntityManager(ref UpdateIncinerationTimerJob job, EntityManager entityManager)
				{
				}
			}
			...
			private void Execute(Entity entity, in BigEntityRefCD bigEntityRefCD, in CrafterForSlotCD crafterForSlotCD, in PugTimerRefCD pugTimerRef)
			{
				...
				bool flag = InventoryUtility.CanIncinerate(containedObjectsBufferLookup, value, slotIndex, incineratorLookup, overrideAlwaysAllowToBeIncineratedLookup, databaseBankCD);
		...
		private struct TypeHandle
		{
			...
			public UpdateIncinerationTimerJob.InternalCompilerQueryAndHandleData __Pug_Automation_PugAutomationStartIncinerateSystem_UpdateIncinerationTimerJob_WithDefaultQuery_JobEntityTypeHandle;
			...
			public void __AssignHandles(ref SystemState state)
			{
				...
				__Pug_Automation_PugAutomationStartIncinerateSystem_UpdateIncinerationTimerJob_WithDefaultQuery_JobEntityTypeHandle.Init(ref state, assignDefaultQuery: true);
			}
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void __codegen__OnCreate_00000243_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

		internal static class __codegen__OnCreate_00000243_0024BurstDirectCall
		{
			...
			private static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnCreate_00000243_0024PostfixBurstDelegate>(__codegen__OnCreate).Value;
				}
				P_0 = Pointer;
			}
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void __codegen__OnUpdate_00000244_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

		internal static class __codegen__OnUpdate_00000244_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnUpdate_00000244_0024PostfixBurstDelegate>(__codegen__OnUpdate).Value;
				}
				P_0 = Pointer;
			}
		...
		private EntityQuery __query_374868459_0;

		private EntityQuery __query_374868459_1;

		private EntityQuery __query_374868459_2;
		...
		{
			__query_374868459_0.TryGetSingleton<ClientServerTickRate>(out var value);
			value.ResolveDefaults();
			int simulationTickRate = value.SimulationTickRate;
			EntityCommandBuffer ecb = __query_374868459_1.GetSingleton<BeginSimulationEntityCommandBufferSystem.Singleton>().CreateCommandBuffer(state.WorldUnmanaged);
			state.Dependency = __ScheduleViaJobChunkExtension_0(new UpdateIncinerationTimerJob
			{
				...
				databaseBankCD = __query_374868459_2.GetSingleton<PugDatabase.DatabaseBankCD>(),
				ecb = ecb
			}, __TypeHandle.__Pug_Automation_PugAutomationStartIncinerateSystem_UpdateIncinerationTimerJob_WithDefaultQuery_JobEntityTypeHandle.DefaultQuery, state.Dependency, ref state, hasUserDefinedQuery: false);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private JobHandle __ScheduleViaJobChunkExtension_0(UpdateIncinerationTimerJob job, EntityQuery query, JobHandle dependency, ref SystemState state, bool hasUserDefinedQuery)
		{
			dependency = __TypeHandle.__Pug_Automation_PugAutomationStartIncinerateSystem_UpdateIncinerationTimerJob_WithDefaultQuery_JobEntityTypeHandle.UpdateBaseEntityIndexArray(ref job, query, dependency, ref state);
			__TypeHandle.__Pug_Automation_PugAutomationStartIncinerateSystem_UpdateIncinerationTimerJob_WithDefaultQuery_JobEntityTypeHandle.AssignEntityManager(ref job, state.EntityManager);
			__TypeHandle.__Pug_Automation_PugAutomationStartIncinerateSystem_UpdateIncinerationTimerJob_WithDefaultQuery_JobEntityTypeHandle.__TypeHandle.Update(ref state);
			return __TypeHandle.__Pug_Automation_PugAutomationStartIncinerateSystem_UpdateIncinerationTimerJob_WithDefaultQuery_JobEntityTypeHandle.Schedule(ref job, query, dependency);
		}
		...
		private void __AssignQueries(ref SystemState state)
		{
			...
			__query_374868459_0 = entityQueryBuilder2.Build(ref state);
			entityQueryBuilder.Reset();
			entityQueryBuilder2 = entityQueryBuilder.WithAll<BeginSimulationEntityCommandBufferSystem.Singleton>();
			entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
			__query_374868459_1 = entityQueryBuilder2.Build(ref state);
			entityQueryBuilder.Reset();
			entityQueryBuilder2 = entityQueryBuilder.WithAll<PugDatabase.DatabaseBankCD>();
			entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
			__query_374868459_2 = entityQueryBuilder2.Build(ref state);
			entityQueryBuilder.Reset();
			entityQueryBuilder.Dispose();
		}
		...
		{
			__codegen__OnCreate_00000243_0024BurstDirectCall.Invoke(self, state);
		}
		...
		{
			__codegen__OnUpdate_00000244_0024BurstDirectCall.Invoke(self, state);
		}

		[Unity.Entities.MonoPInvokeCallback(typeof(SystemBaseDelegates.Function))]
		internal unsafe static void __codegen__OnCreateForCompiler(IntPtr self, IntPtr state)
		{
			((PugAutomationStartIncinerateSystem*)self.ToPointer())->OnCreateForCompiler(ref *(SystemState*)state.ToPointer());
		}
		...
		{
			((PugAutomationStartIncinerateSystem*)self.ToPointer())->OnCreate(ref *(SystemState*)state.ToPointer());
		}
		...
		{
			((PugAutomationStartIncinerateSystem*)self.ToPointer())->OnUpdate(ref *(SystemState*)state.ToPointer());
		}
	}
}
