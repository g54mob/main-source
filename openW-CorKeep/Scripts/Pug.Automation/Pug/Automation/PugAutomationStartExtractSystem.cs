...
namespace Pug.Automation
{
	...
	public struct PugAutomationStartExtractSystem : ISystem, ISystemCompilerGenerated
	{
		[BurstCompile]
		[WithAll(new Type[] { typeof(SmallExtractorCD) })]
		[WithChangeFilter(new Type[] { typeof(BigEntityCraftingDataChangedTriggerCD) })]
		private struct UpdateExtractionTimerJob : IJobEntity, IJobChunk
		{
			public struct InternalCompilerQueryAndHandleData
			{
				...
				private void __AssignQueries(ref SystemState state)
				{
					...
					entityQueryBuilder2 = entityQueryBuilder2.WithAll<SmallExtractorCD>();
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public void Run(ref UpdateExtractionTimerJob job, EntityQuery query)
				{
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public JobHandle Schedule(ref UpdateExtractionTimerJob job, EntityQuery query, JobHandle dependency)
				{
					job.__TypeHandle = __TypeHandle;
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public JobHandle ScheduleParallel(ref UpdateExtractionTimerJob job, EntityQuery query, JobHandle dependency)
				{
					job.__TypeHandle = __TypeHandle;
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public void UpdateBaseEntityIndexArray(ref UpdateExtractionTimerJob job, EntityQuery query, ref SystemState state)
				{
				}

				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public JobHandle UpdateBaseEntityIndexArray(ref UpdateExtractionTimerJob job, EntityQuery query, JobHandle dependency, ref SystemState state)
				{
					return dependency;
				}

				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				public void AssignEntityManager(ref UpdateExtractionTimerJob job, EntityManager entityManager)
				{
				}
			}
			...
			private void Execute(Entity entity, in BigEntityRefCD bigEntityRefCD, in CrafterForSlotCD crafterForSlotCD, in PugTimerRefCD pugTimerRef)
			{
				...
				ExtractableCD extractableCD;
				bool flag = InventoryUtility.CanExtract(containedObjectsBufferLookup, value, slotIndex, out extractableCD, extractorLookup, objectCategoryTagsLookup, extractableLookup, databaseBankCD);
				...
				ContainedObjectsBuffer previousConsumedItem = reference2.previousConsumedItem;
				ContainedObjectsBuffer containedObjectsBuffer = bufferData[slotIndex];
				bool flag2 = ((previousConsumedItem.objectID == ObjectID.None) ? (!previousConsumedItem.EqualsExact(containedObjectsBuffer)) : (PugDatabase.GetEntityObjectInfo(previousConsumedItem.objectID, databaseBankCD.databaseBankBlob, previousConsumedItem.variation).isStackable ? (!previousConsumedItem.EqualsIgnoreAmount(containedObjectsBuffer)) : (!previousConsumedItem.EqualsExact(containedObjectsBuffer))));
				if (!flag)
				{
				...
				else if (flag2)
				{
					...
					ref ExtractableData value2 = ref extractableCD.extractableData.Value;
		...
		private struct TypeHandle
		{
			...
			[ReadOnly]
			public ComponentLookup<ExtractableCD> __ExtractableCD_RO_ComponentLookup;
			...
			public UpdateExtractionTimerJob.InternalCompilerQueryAndHandleData __Pug_Automation_PugAutomationStartExtractSystem_UpdateExtractionTimerJob_WithDefaultQuery_JobEntityTypeHandle;
			...
			public void __AssignHandles(ref SystemState state)
			{
				...
				__ExtractableCD_RO_ComponentLookup = state.GetComponentLookup<ExtractableCD>(isReadOnly: true);
				...
				__Pug_Automation_PugAutomationStartExtractSystem_UpdateExtractionTimerJob_WithDefaultQuery_JobEntityTypeHandle.Init(ref state, assignDefaultQuery: true);
			}
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void __codegen__OnCreate_000001E7_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

		internal static class __codegen__OnCreate_000001E7_0024BurstDirectCall
		{
			...
			private static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnCreate_000001E7_0024PostfixBurstDelegate>(__codegen__OnCreate).Value;
				}
				P_0 = Pointer;
			}
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void __codegen__OnUpdate_000001E8_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

		internal static class __codegen__OnUpdate_000001E8_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnUpdate_000001E8_0024PostfixBurstDelegate>(__codegen__OnUpdate).Value;
				}
				P_0 = Pointer;
			}
		...
		private EntityQuery __query_1347528492_0;

		private EntityQuery __query_1347528492_1;

		private EntityQuery __query_1347528492_2;
		...
		{
			__query_1347528492_0.TryGetSingleton<ClientServerTickRate>(out var value);
			value.ResolveDefaults();
			int simulationTickRate = value.SimulationTickRate;
			EntityCommandBuffer ecb = __query_1347528492_1.GetSingleton<BeginSimulationEntityCommandBufferSystem.Singleton>().CreateCommandBuffer(state.WorldUnmanaged);
			state.Dependency = __ScheduleViaJobChunkExtension_0(new UpdateExtractionTimerJob
			{
				...
				extractableLookup = InternalCompilerInterface.GetComponentLookup(ref __TypeHandle.__ExtractableCD_RO_ComponentLookup, ref state),
				...
				databaseBankCD = __query_1347528492_2.GetSingleton<PugDatabase.DatabaseBankCD>(),
				ecb = ecb
			}, __TypeHandle.__Pug_Automation_PugAutomationStartExtractSystem_UpdateExtractionTimerJob_WithDefaultQuery_JobEntityTypeHandle.DefaultQuery, state.Dependency, ref state, hasUserDefinedQuery: false);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private JobHandle __ScheduleViaJobChunkExtension_0(UpdateExtractionTimerJob job, EntityQuery query, JobHandle dependency, ref SystemState state, bool hasUserDefinedQuery)
		{
			dependency = __TypeHandle.__Pug_Automation_PugAutomationStartExtractSystem_UpdateExtractionTimerJob_WithDefaultQuery_JobEntityTypeHandle.UpdateBaseEntityIndexArray(ref job, query, dependency, ref state);
			__TypeHandle.__Pug_Automation_PugAutomationStartExtractSystem_UpdateExtractionTimerJob_WithDefaultQuery_JobEntityTypeHandle.AssignEntityManager(ref job, state.EntityManager);
			__TypeHandle.__Pug_Automation_PugAutomationStartExtractSystem_UpdateExtractionTimerJob_WithDefaultQuery_JobEntityTypeHandle.__TypeHandle.Update(ref state);
			return __TypeHandle.__Pug_Automation_PugAutomationStartExtractSystem_UpdateExtractionTimerJob_WithDefaultQuery_JobEntityTypeHandle.Schedule(ref job, query, dependency);
		}
		...
		private void __AssignQueries(ref SystemState state)
		{
			...
			__query_1347528492_0 = entityQueryBuilder2.Build(ref state);
			entityQueryBuilder.Reset();
			entityQueryBuilder2 = entityQueryBuilder.WithAll<BeginSimulationEntityCommandBufferSystem.Singleton>();
			entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
			__query_1347528492_1 = entityQueryBuilder2.Build(ref state);
			entityQueryBuilder.Reset();
			entityQueryBuilder2 = entityQueryBuilder.WithAll<PugDatabase.DatabaseBankCD>();
			entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
			__query_1347528492_2 = entityQueryBuilder2.Build(ref state);
			entityQueryBuilder.Reset();
			entityQueryBuilder.Dispose();
		}
		...
		{
			__codegen__OnCreate_000001E7_0024BurstDirectCall.Invoke(self, state);
		}
		...
		{
			__codegen__OnUpdate_000001E8_0024BurstDirectCall.Invoke(self, state);
		}

		[Unity.Entities.MonoPInvokeCallback(typeof(SystemBaseDelegates.Function))]
		internal unsafe static void __codegen__OnCreateForCompiler(IntPtr self, IntPtr state)
		{
			((PugAutomationStartExtractSystem*)self.ToPointer())->OnCreateForCompiler(ref *(SystemState*)state.ToPointer());
		}
		...
		{
			((PugAutomationStartExtractSystem*)self.ToPointer())->OnCreate(ref *(SystemState*)state.ToPointer());
		}
		...
		{
			((PugAutomationStartExtractSystem*)self.ToPointer())->OnUpdate(ref *(SystemState*)state.ToPointer());
		}
	}
}
