...
namespace Mono.CSharp
{
	public abstract class MetadataImporter
	{
		...
		private AParametersCollection CreateParameters(TypeSpec parent, ParameterInfo[] pi, MethodBase method)
		{
			...
			if (num != 0)
			{
				array2[^1] = new ArglistParameter(Location.Null);
				array[^1] = InternalType.Arglist;
			}
		...
		protected void ImportTypes(Type[] types, Namespace targetNamespace, bool importExtensionTypes)
		{
			...
			foreach (Type type in types)
			{
				...
				if (typeSpec != null)
				{
					...
					{
						obj = ((type.Namespace == null) ? targetNamespace : targetNamespace.GetNamespace(type.Namespace, create: true));
						text = type.Namespace;
					}
