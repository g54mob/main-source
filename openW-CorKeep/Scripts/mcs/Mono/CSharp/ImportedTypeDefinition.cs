		...
		public void LoadMembers(TypeSpec declaringType, bool onlyTypes, ref MemberCache cache)
		{
			...
			foreach (MemberInfo memberInfo3 in array)
			{
				...
				case MemberTypes.Property:
				{
					...
					if ((object)addMethod == null || !dictionary.TryGetValue(addMethod, out var value3))
					{
						value3 = null;
					}
					addMethod = propertyInfo.GetSetMethod(nonPublic: true);
					if ((object)addMethod == null || !dictionary.TryGetValue(addMethod, out var value4))
					{
						value4 = null;
					}
				...
				case MemberTypes.Event:
				{
					...
					if ((object)addMethod == null || !dictionary.TryGetValue(addMethod, out var value))
					{
						value = null;
					}
					addMethod = eventInfo.GetRemoveMethod(nonPublic: true);
					if ((object)addMethod == null || !dictionary.TryGetValue(addMethod, out var value2))
					{
						value2 = null;
					}
