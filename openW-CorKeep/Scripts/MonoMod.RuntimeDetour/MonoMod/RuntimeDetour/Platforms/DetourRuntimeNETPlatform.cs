			...
			while (true)
			{
				...
				if (IntPtr.Size == 4)
				{
					...
					if (*(byte*)num2 == 184 && *(byte*)(num2 + 5) == 144 && *(byte*)(num2 + 6) == 232 && *(byte*)(num2 + 11) == 233)
					{
						...
						intPtr = NotThePreStub(intPtr, (IntPtr)num4);
					...
					if (*(byte*)num2 == 233 && *(byte*)(num2 + 5) == 95)
					{
						...
						intPtr = NotThePreStub(intPtr, (IntPtr)num6);
				...
				{
					intPtr = NotThePreStub(intPtr, (IntPtr)(*(long*)(num7 + 25)));
					MonoMod.MMDbgLog.Log($"ngen: 0x{(long)intPtr:X16}");
					return intPtr;
				}
				if (*(byte*)num7 == 233 && *(byte*)(num7 + 5) == 95)
				{
					long num8 = num7;
					long num9 = *(int*)(num8 + 1) + (num8 + 1 + 4);
					intPtr = NotThePreStub(intPtr, (IntPtr)num9);
					for (int j = 0; j < 16; j++)
					{
						num7 = (long)intPtr + j;
				...
				flag = true;
				long num10 = *(int*)(num7 + 1) + (num7 + 1 + 4);
				MonoMod.MMDbgLog.Log($"PrecodeFixupThunk: 0x{num10:X16}");
				PrepareMethod(method, handle);
			}
			return intPtr;
			unsafe IntPtr WalkPrecode(IntPtr curr)
			{
				long num11 = (long)curr;
				if (*(uint*)num11 == 268435593 && *(uint*)(num11 + 4) == 2839556394u && *(uint*)(num11 + 8) == 3592356160u)
				{
					IntPtr ptrParsed = *(IntPtr*)(num11 + 16);
					return NotThePreStub(curr, ptrParsed);
				}
				if (*(uint*)num11 == 268435595 && *(uint*)(num11 + 4) == 2839556458u && *(uint*)(num11 + 8) == 3592356160u)
				{
					IntPtr ptrParsed2 = *(IntPtr*)(num11 + 16);
					return NotThePreStub(curr, ptrParsed2);
				}
				if (*(uint*)num11 == 268435468 && *(uint*)(num11 + 4) == 1476395115 && *(uint*)(num11 + 8) == 3592356192u)
				{
					IntPtr ptrParsed3 = *(IntPtr*)(num11 + 16);
					return NotThePreStub(curr, ptrParsed3);
				}
				if (*(uint*)num11 == 2432696336u && *(uint*)(num11 + 4) == 2432696352u && *(uint*)(num11 + 8) == 2432696833u && *(uint*)(num11 + 12) == 1476395120 && *(uint*)(num11 + 16) == 3592356352u)
				{
					IntPtr ptrParsed4 = *(IntPtr*)(num11 + 24);
					return NotThePreStub(curr, ptrParsed4);
				}
				return curr;
			}
		}
