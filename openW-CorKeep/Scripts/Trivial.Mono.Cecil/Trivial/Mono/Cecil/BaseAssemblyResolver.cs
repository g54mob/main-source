...
namespace Trivial.Mono.Cecil
{
	...
	{
		private static readonly bool on_mono = (object)Type.GetType("Mono.Runtime") != null;
		...
		{
			string[] array = (name.IsWindowsRuntime ? new string[2] { ".winmd", ".dll" } : new string[2] { ".exe", ".dll" });
