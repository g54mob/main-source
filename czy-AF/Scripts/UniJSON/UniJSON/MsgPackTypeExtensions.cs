namespace UniJSON
{
	public static class MsgPackTypeExtensions
	{
		...
		{
			if (formatType - 144 <= MsgPackType.POSITIVE_FIXNUM_0x0F || formatType - 220 <= MsgPackType.POSITIVE_FIXNUM_0x01)
			{
				return true;
			}
			return false;
		...
		{
			if (formatType - 128 <= MsgPackType.POSITIVE_FIXNUM_0x0F || formatType - 222 <= MsgPackType.POSITIVE_FIXNUM_0x01)
			{
				return true;
			}
			return false;
		...
		{
			if (formatType - 202 <= MsgPackType.POSITIVE_FIXNUM_0x01)
			{
				return true;
			}
			return false;
		...
		{
			if (formatType - 160 <= MsgPackType.POSITIVE_FIXNUM_0x1F || formatType - 217 <= MsgPackType.POSITIVE_FIXNUM_0x02)
			{
				return true;
			}
			return false;
		...
		{
			if (formatType - 199 <= MsgPackType.POSITIVE_FIXNUM_0x02 || formatType - 212 <= MsgPackType.POSITIVE_FIXNUM_0x04)
			{
				return true;
			}
			return false;
		...
		{
			if (formatType - 196 <= MsgPackType.POSITIVE_FIXNUM_0x02)
			{
				return true;
			}
			return false;
