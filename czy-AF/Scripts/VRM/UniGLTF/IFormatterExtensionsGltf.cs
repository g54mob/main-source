...
namespace UniGLTF
{
	public static class IFormatterExtensionsGltf
	{
		public static void GenSerialize(this IFormatter f, glTF value)
		{
			...
			{
				f.Key("asset");
				f.GenSerialize(value.asset);
			}
			if (value.buffers != null && value.buffers.Count > 0)
			{
				f.Key("buffers");
				f.GenSerialize(value.buffers);
			}
		...
		public static void GenSerialize(this IFormatter f, glTFAssets value)
		{
			...
			{
				f.Key("generator");
				f.GenSerialize(value.generator);
			}
			if (value.version != null)
			{
				f.Key("version");
				f.GenSerialize(value.version);
			}
			if (value.copyright != null)
			{
				f.Key("copyright");
				f.GenSerialize(value.copyright);
			}
			if (value.minVersion != null)
			{
				f.Key("minVersion");
				f.GenSerialize(value.minVersion);
			}
			f.EndMap();
		}
		...
		public static void GenSerialize(this IFormatter f, List<glTFBuffer> value)
		{
			...
			foreach (glTFBuffer item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFBuffer value)
		{
			...
			{
				f.Key("uri");
				f.GenSerialize(value.uri);
			}
			f.Key("byteLength");
			f.GenSerialize(value.byteLength);
			if (value.name != null)
			{
				f.Key("name");
				f.GenSerialize(value.name);
			}
			f.EndMap();
		}

		public static void GenSerialize(this IFormatter f, int value)
		{
			f.Value(value);
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTFBufferView item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFBufferView value)
		{
			f.BeginMap(0);
			f.Key("buffer");
			f.GenSerialize(value.buffer);
			f.Key("byteOffset");
			f.GenSerialize(value.byteOffset);
			f.Key("byteLength");
			f.GenSerialize(value.byteLength);
			if (value.target != glBufferTarget.NONE)
			{
				f.Key("target");
				f.GenSerialize(value.target);
			}
			if (value.name != null)
			{
				f.Key("name");
		...
		{
			f.BeginList(value.Count);
			foreach (glTFAccessor item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFAccessor value)
		{
			f.BeginMap(0);
			f.Key("bufferView");
			f.GenSerialize(value.bufferView);
			f.Key("byteOffset");
			f.GenSerialize(value.byteOffset);
			if (value.type != null)
			{
				f.Key("type");
				f.GenSerialize(value.type);
			}
			f.Key("componentType");
			f.GenSerialize(value.componentType);
			f.Key("count");
			f.GenSerialize(value.count);
			if (value.max != null && value.max.Length != 0)
			{
				f.Key("max");
				f.GenSerialize(value.max);
			}
			if (value.min != null && value.min.Length != 0)
			{
				f.Key("min");
				f.GenSerialize(value.min);
			}
			f.Key("normalized");
			f.GenSerialize(value.normalized);
			if (value.sparse != null && value.sparse.count > 0)
			{
				f.Key("sparse");
				f.GenSerialize(value.sparse);
			}
			if (value.name != null)
			{
				f.Key("name");
		...
		public static void GenSerialize(this IFormatter f, float[] value)
		{
			f.BeginList(value.Length);
			foreach (float value2 in value)
			{
				f.GenSerialize(value2);
			}
			f.EndList();
		}
		...
		public static void GenSerialize(this IFormatter f, bool value)
		{
			f.Value(value);
		}
		...
		public static void GenSerialize(this IFormatter f, glTFSparse value)
		{
			...
			{
				f.Key("indices");
				f.GenSerialize(value.indices);
			}
			if (value.values != null)
			{
				f.Key("values");
				f.GenSerialize(value.values);
			}
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTFTexture item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFTexture value)
		{
			f.BeginMap(0);
			f.Key("sampler");
			f.GenSerialize(value.sampler);
			f.Key("source");
			f.GenSerialize(value.source);
			if (value.name != null)
			{
				f.Key("name");
				f.GenSerialize(value.name);
		...
		{
			f.BeginList(value.Count);
			foreach (glTFTextureSampler item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFTextureSampler value)
		{
			f.BeginMap(0);
			f.Key("magFilter");
			f.GenSerialize(value.magFilter);
			f.Key("minFilter");
			f.GenSerialize(value.minFilter);
			f.Key("wrapS");
			f.GenSerialize(value.wrapS);
			f.Key("wrapT");
			f.GenSerialize(value.wrapT);
			if (value.name != null)
			{
				f.Key("name");
				f.GenSerialize(value.name);
		...
		{
			f.BeginList(value.Count);
			foreach (glTFImage item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		{
			f.BeginList(value.Count);
			foreach (glTFMaterial item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFMaterial value)
		{
			...
			if (value.pbrMetallicRoughness != null)
			{
				...
				f.GenSerialize(value.pbrMetallicRoughness);
			}
			if (value.normalTexture != null)
			{
				f.Key("normalTexture");
				f.GenSerialize(value.normalTexture);
			}
			if (value.occlusionTexture != null)
			{
				f.Key("occlusionTexture");
				f.GenSerialize(value.occlusionTexture);
			}
			if (value.emissiveTexture != null)
			{
				f.Key("emissiveTexture");
				f.GenSerialize(value.emissiveTexture);
			}
			if (value.emissiveFactor != null)
			{
				f.Key("emissiveFactor");
				f.GenSerialize(value.emissiveFactor);
			}
			if (value.alphaMode != null)
			{
				f.Key("alphaMode");
				f.GenSerialize(value.alphaMode);
			}
			if (!string.IsNullOrEmpty(value.alphaMode))
			{
				f.Key("alphaCutoff");
				f.GenSerialize(value.alphaCutoff);
			}
			f.Key("doubleSided");
			f.GenSerialize(value.doubleSided);
			if (value.extensions != null)
			{
				f.Key("extensions");
				f.GenSerialize(value.extensions);
		...
		public static void GenSerialize(this IFormatter f, glTFPbrMetallicRoughness value)
		{
			...
			if (value.baseColorTexture != null)
			{
				...
				f.GenSerialize(value.baseColorTexture);
			}
			if (value.baseColorFactor != null)
			{
				f.Key("baseColorFactor");
				f.GenSerialize(value.baseColorFactor);
			}
			if (value.metallicRoughnessTexture != null)
			{
				f.Key("metallicRoughnessTexture");
				f.GenSerialize(value.metallicRoughnessTexture);
			}
			f.Key("metallicFactor");
			f.GenSerialize(value.metallicFactor);
			f.Key("roughnessFactor");
			f.GenSerialize(value.roughnessFactor);
			f.EndMap();
		}
		...
		public static void GenSerialize(this IFormatter f, glTFMaterialBaseColorTextureInfo value)
		{
			f.BeginMap(0);
			f.Key("index");
			f.GenSerialize(value.index);
			f.Key("texCoord");
			f.GenSerialize(value.texCoord);
			if (value.extensions != null)
			{
				f.Key("extensions");
				f.GenSerialize(value.extensions);
		...
		public static void GenSerialize(this IFormatter f, glTFTextureInfo_extensions value)
		{
			...
			{
				f.Key("KHR_texture_transform");
				f.GenSerialize(value.KHR_texture_transform);
			}
			f.EndMap();
		}
		...
		public static void GenSerialize(this IFormatter f, glTF_KHR_texture_transform value)
		{
			...
			{
				f.Key("offset");
				f.GenSerialize(value.offset);
			}
			f.Key("rotation");
			f.GenSerialize(value.rotation);
			if (value.scale != null)
			{
				f.Key("scale");
				f.GenSerialize(value.scale);
			}
			f.Key("texCoord");
			f.GenSerialize(value.texCoord);
			f.EndMap();
		...
		public static void GenSerialize(this IFormatter f, glTFMaterial_extensions value)
		{
			...
			if (value.KHR_materials_unlit != null)
			{
				...
				f.GenSerialize(value.KHR_materials_unlit);
			}
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTFMesh item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFMesh value)
		{
			...
			{
				f.Key("primitives");
				f.GenSerialize(value.primitives);
			}
			if (value.weights != null && value.weights.Length != 0)
			{
				f.Key("weights");
				f.GenSerialize(value.weights);
			}
			if (value.extras != null)
			{
				f.Key("extras");
				f.GenSerialize(value.extras);
			}
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTFPrimitives item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFPrimitives value)
		{
			f.BeginMap(0);
			f.Key("mode");
			f.GenSerialize(value.mode);
			f.Key("indices");
			f.GenSerialize(value.indices);
			if (value.attributes != null)
			{
				f.Key("attributes");
				f.GenSerialize(value.attributes);
			}
			f.Key("material");
			f.GenSerialize(value.material);
			if (value.targets != null && value.targets.Count > 0)
			{
				f.Key("targets");
				f.GenSerialize(value.targets);
			}
		...
		public static void GenSerialize(this IFormatter f, glTFAttributes value)
		{
			...
			{
				f.Key("POSITION");
				f.GenSerialize(value.POSITION);
			}
			if (value.NORMAL != -1)
			{
				f.Key("NORMAL");
				f.GenSerialize(value.NORMAL);
			}
			if (value.TANGENT != -1)
			{
				f.Key("TANGENT");
				f.GenSerialize(value.TANGENT);
			}
			if (value.TEXCOORD_0 != -1)
			{
				f.Key("TEXCOORD_0");
				f.GenSerialize(value.TEXCOORD_0);
			}
			if (value.COLOR_0 != -1)
			{
				f.Key("COLOR_0");
				f.GenSerialize(value.COLOR_0);
			}
			if (value.JOINTS_0 != -1)
			{
				f.Key("JOINTS_0");
				f.GenSerialize(value.JOINTS_0);
			}
			if (value.WEIGHTS_0 != -1)
			{
				f.Key("WEIGHTS_0");
				f.GenSerialize(value.WEIGHTS_0);
			}
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (gltfMorphTarget item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFPrimitives_extras value)
		{
			...
			{
				f.Key("targetNames");
				f.GenSerialize(value.targetNames);
			}
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTFNode item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFNode value)
		{
			...
			{
				f.Key("children");
				f.GenSerialize(value.children);
			}
			if (value.matrix != null)
			{
				f.Key("matrix");
				f.GenSerialize(value.matrix);
			}
			if (value.translation != null)
			{
				f.Key("translation");
				f.GenSerialize(value.translation);
			}
			...
			{
				f.Key("mesh");
				f.GenSerialize(value.mesh);
			}
			if (value.skin != -1)
			{
				f.Key("skin");
				f.GenSerialize(value.skin);
			}
		...
		{
			f.BeginList(value.Count);
			foreach (glTFSkin item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFSkin value)
		{
			...
			f.GenSerialize(value.inverseBindMatrices);
			if (value.joints != null && value.joints.Length != 0)
			{
				f.Key("joints");
				f.GenSerialize(value.joints);
			}
			if (value.skeleton != -1)
			{
				f.Key("skeleton");
				f.GenSerialize(value.skeleton);
			}
			if (value.name != null)
			{
				f.Key("name");
		...
		{
			f.BeginList(value.Count);
			foreach (gltfScene item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		{
			f.BeginList(value.Count);
			foreach (glTFAnimation item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		{
			f.BeginList(value.Count);
			foreach (glTFAnimationChannel item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFAnimationTarget value)
		{
			f.BeginMap(0);
			f.Key("node");
			f.GenSerialize(value.node);
			if (value.path != null)
			{
				f.Key("path");
				f.GenSerialize(value.path);
			}
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTFAnimationSampler item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFAnimationSampler value)
		{
			f.BeginMap(0);
			f.Key("input");
			f.GenSerialize(value.input);
			if (value.interpolation != null)
			{
				f.Key("interpolation");
				f.GenSerialize(value.interpolation);
			}
			f.Key("output");
			f.GenSerialize(value.output);
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTFCamera item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTFCamera value)
		{
			...
			{
				f.Key("orthographic");
				f.GenSerialize(value.orthographic);
			}
			if (value.perspective != null)
			{
				f.Key("perspective");
				f.GenSerialize(value.perspective);
			}
			f.Key("type");
			f.GenSerialize(value.type);
			if (value.name != null)
		...
		public static void GenSerialize(this IFormatter f, glTFOrthographic value)
		{
			f.BeginMap(0);
			f.Key("xmag");
			f.GenSerialize(value.xmag);
			f.Key("ymag");
			f.GenSerialize(value.ymag);
			f.Key("zfar");
			f.GenSerialize(value.zfar);
			f.Key("znear");
			f.GenSerialize(value.znear);
			f.EndMap();
		}
		...
		public static void GenSerialize(this IFormatter f, glTFPerspective value)
		{
			f.BeginMap(0);
			f.Key("aspectRatio");
			f.GenSerialize(value.aspectRatio);
			f.Key("yfov");
			f.GenSerialize(value.yfov);
			f.Key("zfar");
			f.GenSerialize(value.zfar);
			f.Key("znear");
			f.GenSerialize(value.znear);
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_extensions value)
		{
			...
			if (value.exporterVersion != null)
			{
				...
				f.GenSerialize(value.exporterVersion);
			}
			if (value.specVersion != null)
			{
				f.Key("specVersion");
				f.GenSerialize(value.specVersion);
			}
			if (value.meta != null)
			{
				f.Key("meta");
				f.GenSerialize(value.meta);
			}
			if (value.humanoid != null)
			{
				f.Key("humanoid");
				f.GenSerialize(value.humanoid);
			}
			if (value.firstPerson != null)
			{
				f.Key("firstPerson");
				f.GenSerialize(value.firstPerson);
			}
			if (value.blendShapeMaster != null)
			{
				f.Key("blendShapeMaster");
				f.GenSerialize(value.blendShapeMaster);
			}
			if (value.secondaryAnimation != null)
			{
				f.Key("secondaryAnimation");
				f.GenSerialize(value.secondaryAnimation);
			}
			if (value.materialProperties != null)
			{
				f.Key("materialProperties");
				f.GenSerialize(value.materialProperties);
			}
			f.EndMap();
		}
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_Humanoid value)
		{
			...
			{
				f.Key("humanBones");
				f.GenSerialize(value.humanBones);
			}
			f.Key("armStretch");
			f.GenSerialize(value.armStretch);
			f.Key("legStretch");
			f.GenSerialize(value.legStretch);
			f.Key("upperArmTwist");
			f.GenSerialize(value.upperArmTwist);
			f.Key("lowerArmTwist");
			f.GenSerialize(value.lowerArmTwist);
			f.Key("upperLegTwist");
			f.GenSerialize(value.upperLegTwist);
			f.Key("lowerLegTwist");
			f.GenSerialize(value.lowerLegTwist);
			f.Key("feetSpacing");
			f.GenSerialize(value.feetSpacing);
			f.Key("hasTranslationDoF");
			f.GenSerialize(value.hasTranslationDoF);
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTF_VRM_HumanoidBone item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_HumanoidBone value)
		{
			...
			{
				f.Key("center");
				f.GenSerialize(value.center);
			}
			if (value.axisLength > 0f)
			{
				f.Key("axisLength");
				f.GenSerialize(value.axisLength);
			}
			f.EndMap();
		}
		...
		public static void GenSerialize(this IFormatter f, Vector3 value)
		{
			f.BeginMap(0);
			f.Key("x");
			f.GenSerialize(value.x);
			f.Key("y");
			f.GenSerialize(value.y);
			f.Key("z");
			f.GenSerialize(value.z);
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTF_VRM_MeshAnnotation item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_MeshAnnotation value)
		{
			...
			if (value.firstPersonFlag != null)
			{
				...
				f.GenSerialize(value.firstPersonFlag);
			}
			f.EndMap();
		}
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_DegreeMap value)
		{
			...
			{
				f.Key("curve");
				f.GenSerialize(value.curve);
			}
			f.Key("xRange");
			f.GenSerialize(value.xRange);
			f.Key("yRange");
			f.GenSerialize(value.yRange);
			f.EndMap();
		}
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_BlendShapeMaster value)
		{
			...
			if (value.blendShapeGroups != null)
			{
				...
				f.GenSerialize(value.blendShapeGroups);
			}
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTF_VRM_BlendShapeGroup item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_BlendShapeGroup value)
		{
			...
			{
				f.Key("presetName");
				f.GenSerialize(value.presetName);
			}
			if (value.binds != null)
			{
				f.Key("binds");
				f.GenSerialize(value.binds);
			}
			if (value.materialValues != null)
			{
				f.Key("materialValues");
				f.GenSerialize(value.materialValues);
			}
			f.Key("isBinary");
			f.GenSerialize(value.isBinary);
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTF_VRM_BlendShapeBind item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		{
			f.BeginList(value.Count);
			foreach (glTF_VRM_MaterialValueBind item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_MaterialValueBind value)
		{
			...
			{
				f.Key("materialName");
				f.GenSerialize(value.materialName);
			}
			if (value.propertyName != null)
			{
				f.Key("propertyName");
				f.GenSerialize(value.propertyName);
			}
			if (value.targetValue != null)
			{
				f.Key("targetValue");
				f.GenSerialize(value.targetValue);
			}
			f.EndMap();
		}
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_SecondaryAnimation value)
		{
			...
			{
				f.Key("boneGroups");
				f.GenSerialize(value.boneGroups);
			}
			if (value.colliderGroups != null)
			{
				f.Key("colliderGroups");
				f.GenSerialize(value.colliderGroups);
			}
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTF_VRM_SecondaryAnimationGroup item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_SecondaryAnimationGroup value)
		{
			...
			{
				f.Key("comment");
				f.GenSerialize(value.comment);
			}
			f.Key("stiffiness");
			f.GenSerialize(value.stiffiness);
			f.Key("gravityPower");
			f.GenSerialize(value.gravityPower);
			f.Key("gravityDir");
			f.GenSerialize(value.gravityDir);
			f.Key("dragForce");
			f.GenSerialize(value.dragForce);
			f.Key("center");
			f.GenSerialize(value.center);
			f.Key("hitRadius");
			f.GenSerialize(value.hitRadius);
			if (value.bones != null)
			{
				f.Key("bones");
				f.GenSerialize(value.bones);
			}
			if (value.colliderGroups != null)
			{
				f.Key("colliderGroups");
		...
		{
			f.BeginList(value.Count);
			foreach (glTF_VRM_SecondaryAnimationColliderGroup item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_SecondaryAnimationColliderGroup value)
		{
			...
			{
				f.Key("colliders");
				f.GenSerialize(value.colliders);
			}
			f.EndMap();
		}
		...
		{
			f.BeginList(value.Count);
			foreach (glTF_VRM_SecondaryAnimationCollider item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		{
			f.BeginList(value.Count);
			foreach (glTF_VRM_Material item in value)
			{
				f.GenSerialize(item);
			}
			f.EndList();
		...
		public static void GenSerialize(this IFormatter f, glTF_VRM_Material value)
		{
			...
			{
				f.Key("shader");
				f.GenSerialize(value.shader);
			}
			f.Key("renderQueue");
			f.GenSerialize(value.renderQueue);
			if (value.floatProperties != null)
			{
				f.Key("floatProperties");
				f.GenSerialize(value.floatProperties);
			}
			if (value.vectorProperties != null)
			{
				f.Key("vectorProperties");
				f.GenSerialize(value.vectorProperties);
			}
			if (value.textureProperties != null)
			{
				f.Key("textureProperties");
				f.GenSerialize(value.textureProperties);
			}
			if (value.keywordMap != null)
			{
				f.Key("keywordMap");
				f.GenSerialize(value.keywordMap);
			}
			if (value.tagMap != null)
			{
				f.Key("tagMap");
				f.GenSerialize(value.tagMap);
			}
			f.EndMap();
		}

		public static void GenSerialize(this IFormatter f, Dictionary<string, float> value)
		{
			f.BeginMap(value.Count);
			foreach (KeyValuePair<string, float> item in value)
			{
				f.Key(item.Key);
				f.GenSerialize(item.Value);
			}
			f.EndMap();
		}
		...
		public static void GenSerialize(this IFormatter f, Dictionary<string, int> value)
		{
			f.BeginMap(value.Count);
		...
		public static void GenSerialize(this IFormatter f, Dictionary<string, bool> value)
		{
			f.BeginMap(value.Count);
