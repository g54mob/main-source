...
namespace Febucci.UI
{
	...
	public class TypewriterByCharacter : TypewriterCore
	{
		...
		protected override float GetWaitAppearanceTimeOf(int charIndex)
		{
			...
			if (avoidMultiplePunctuationWait && char.IsPunctuation(character) && charIndex < base.TextAnimator.CharactersCount - 1 && char.IsPunctuation(base.TextAnimator.Characters[charIndex + 1].info.character))
			{
