...
{
	[CreateAssetMenu(fileName = "OutsideLightingBarRule", menuName = "Brewery/Bar Rules/Outside Lighting Rule")]
	public class OutsideLightingBarRule : BarRuleBase
	{
		...
		private static readonly string[] PatioTooBrightKeys;

		private static readonly string[] PatioTooDarkKeys;

		private const string FailTooBright = "PATIO_TOO_BRIGHT";

		private const string FailTooDark = "PATIO_TOO_DARK";
