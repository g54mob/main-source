...
{
	public class SpiritsStation2 : BaseBreweryStation
	{
		[Header("Tablet")]
		[Tooltip("The 3D tablet child attached to this station")]
		[SerializeField]
		private SpiritsTablet3D tablet;

		private const int SlotSugarCane = 0;
		...
		private const int SlotYeastNutrient = 4;

		private const int SlotEnzymePack = 5;

		private const int SlotRiceHulls = 6;

		private const int SugarCanePerBatch = 10;
		...
		private readonly NetworkVariable<int> minigameBonusBottles;
		...
		public int MinigameBonusBottles => 0;
		...
		private void HandleMinigameBonusChanged(int previous, int current)
		{
		}
		...
		public void AddMinigameBonusServerRpc(int bottles)
		{
		}
		...
		private static void __rpc_handler_210699748(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
		{
		}

		private static void __rpc_handler_61636707(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
		{
		}
