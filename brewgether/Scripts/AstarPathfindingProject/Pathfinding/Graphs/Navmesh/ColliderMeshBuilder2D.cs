...
namespace Pathfinding.Graphs.Navmesh
{
	...
	internal static class ColliderMeshBuilder2D
	{
		...
		internal delegate int GenerateMeshesFromShapes_00000A85_0024PostfixBurstDelegate(ref UnsafeSpan<PhysicsShape2D> shapes, ref UnsafeSpan<float2> vertices, ref UnsafeSpan<Matrix4x4> shapeMatrices, ref UnsafeSpan<int> groupIndices, ref UnsafeList<float3> outputVertices, ref UnsafeList<int3> outputIndices, ref UnsafeSpan<ShapeMesh> outputShapeMeshes, float maxError);

		internal static class GenerateMeshesFromShapes_00000A85_0024BurstDirectCall
		{
		...
		{
			outputVertices = default(NativeArray<float3>);
			outputIndices = default(NativeArray<int>);
			outputShapeMeshes = default(NativeArray<ShapeMesh>);
			return 0;
		}
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(GenerateMeshesFromShapes_00000A85_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		internal static int GenerateMeshesFromShapes_0024BurstManaged(ref UnsafeSpan<PhysicsShape2D> shapes, ref UnsafeSpan<float2> vertices, ref UnsafeSpan<Matrix4x4> shapeMatrices, ref UnsafeSpan<int> groupIndices, ref UnsafeList<float3> outputVertices, ref UnsafeList<int3> outputIndices, ref UnsafeSpan<ShapeMesh> outputShapeMeshes, float maxError)
		{
			return 0;
		}
	}
