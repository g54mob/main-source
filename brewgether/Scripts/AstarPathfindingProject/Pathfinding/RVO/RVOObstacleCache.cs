...
namespace Pathfinding.RVO
{
	...
	public static class RVOObstacleCache
	{
		...
		internal unsafe delegate void TraceContours_00000F7F_0024PostfixBurstDelegate(ref UnsafeSpan<ObstacleSegment> obstaclesSpan, ref NativeMovementPlane movementPlane, int obstacleId, UnmanagedObstacle* outputObstacles, ref SlabAllocator<float3> verticesAllocator, ref SlabAllocator<ObstacleVertexGroup> obstaclesAllocator, ref SpinLock spinLock, bool simplifyObstacles);

		internal static class TraceContours_00000F7F_0024BurstDirectCall
		{
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(TraceContours_00000F7F_0024PostfixBurstDelegate))]
