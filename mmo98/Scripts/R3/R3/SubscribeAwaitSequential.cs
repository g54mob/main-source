...
namespace R3
{
	...
	{
		public SubscribeAwaitSequential(Func<T, CancellationToken, ValueTask> onNextAsync, Action<Exception> onErrorResume, Action<Result> onCompleted, bool configureAwait, bool cancelOnCompleted)
		{
	...
	internal sealed class SubscribeAwaitSequential<T, TState> : AwaitOperationSequentialObserver<T>
	{
		public SubscribeAwaitSequential(TState state, Func<T, TState, CancellationToken, ValueTask> onNextAsync, Action<Exception, TState> onErrorResume, Action<Result, TState> onCompleted, bool configureAwait, bool cancelOnCompleted)
		{
