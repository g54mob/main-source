...
namespace R3
{
	internal sealed class MinAsync<T> : TaskObserverBase<T, T>
	{
		private T current;

		private bool hasValue;

		public MinAsync(IComparer<T> comparer, CancellationToken cancellation)
		{
	...
	internal sealed class MinAsync<TSource, TResult> : TaskObserverBase<TSource, TResult>
	{
		private TResult current;

		private bool hasValue;

		public MinAsync(Func<TSource, TResult> selector, IComparer<TResult> comparer, CancellationToken cancellation)
		{
