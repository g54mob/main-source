...
namespace ZLinq.Linq
{
	...
	public struct FromSortedDictionary<TKey, TValue> : IValueEnumerator<KeyValuePair<TKey, TValue>>, IDisposable where TKey : notnull
	{
		private bool isInit;

		private SortedDictionary<TKey, TValue>.Enumerator enumerator;

		public FromSortedDictionary(SortedDictionary<TKey, TValue> source)
		{
			_003Csource_003EP = source;
			enumerator = default(SortedDictionary<TKey, TValue>.Enumerator);
			isInit = false;
		}
