...
public class RebindUIv2 : MonoBehaviour
{
	[Serializable]
	public class UpdateBindingUIEvent : UnityEvent<RebindUIv2, string, string, string>
	{
	}

	[Serializable]
	public class InteractiveRebindEvent : UnityEvent<RebindUIv2, InputActionRebindingExtensions.RebindingOperation>
	{
	}
	...
	private static List<RebindUIv2> s_RebindActionUIs;
