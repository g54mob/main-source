...
public struct PacketSpawnerSystem : ISystem, ISystemCompilerGenerated
{
	...
	internal delegate void __codegen__OnCreate_00000027_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

	internal static class __codegen__OnCreate_00000027_0024BurstDirectCall
	{
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate void __codegen__OnUpdate_00000028_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

	internal static class __codegen__OnUpdate_00000028_0024BurstDirectCall
	{
		private static IntPtr Pointer;
