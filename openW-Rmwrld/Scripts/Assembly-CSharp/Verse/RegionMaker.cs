...
namespace Verse
{
	public class RegionMaker
	{
		...
		private void FloodFillAndAddCells(IntVec3 root)
		{
			...
			map.floodFiller.FloodFill(root, (Predicate<IntVec3>)((IntVec3 x) => newReg.extentsLimit.Contains(x) && x.GetExpectedRegionType(map) == newReg.type), (Action<IntVec3>)AddCell, int.MaxValue, false, (IEnumerable<IntVec3>)null);
		}
