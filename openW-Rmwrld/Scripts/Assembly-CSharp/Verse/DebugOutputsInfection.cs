...
namespace Verse
{
	public static class DebugOutputsInfection
	{
		...
		public static void Infections()
		{
			...
			Func<Func<InfectionLuck, float>, string> stringizeWithLuck = (Func<InfectionLuck, float> func2) => $"{func2(InfectionLuck.Bad):F2} / {func2(InfectionLuck.Good):F2}";
			...
			for (float tendquality = 0f; tendquality <= 1.01f; tendquality += 0.1f)
			{
				...
				Func<Pawn, Pawn, Pawn, string> func = delegate(Pawn low, Pawn exp, Pawn high)
				{
				...
				string text = func(arg, arg5, arg9);
				string text2 = func(arg2, arg6, arg10);
				string text3 = func(arg3, arg7, arg11);
				string text4 = func(arg4, arg8, arg12);
