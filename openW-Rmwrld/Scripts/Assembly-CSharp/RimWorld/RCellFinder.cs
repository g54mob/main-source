...
namespace RimWorld
{
	public static class RCellFinder
	{
		...
		{
			Predicate<Region> validator = (Region r) => r.Room.PsychologicallyOutdoors && !r.IsForbiddenEntirely(searcher) && r.TryFindRandomCellInRegionUnforbidden(searcher, Validator, out var _);
