...
namespace HSVPicker
{
	...
	public class ColorPicker : MonoBehaviour, ISelectHandler, IEventSystemHandler, IDeselectHandler
	{
		private float _hue;
		...
		public void Regenerate()
		{
			...
			Setup.colorPresets.gameObject.SetActive(Setup.ShowPresets);
			Setup.ButtonsLine.SetActive(Setup.ShowCancelAndSubmit);
		...
		public void UpdateColorPresets(List<Color> colors)
		{
			Setup.DefaultPresetColors = colors;
			Setup.colorPresets.SetColorPresets(colors);
		}
