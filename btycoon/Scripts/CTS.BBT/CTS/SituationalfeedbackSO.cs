...
namespace CTS
{
	[CreateAssetMenu(menuName = "BBT/Bark/SituationFeedBack", fileName = "SituationFeedBack")]
	public class SituationalfeedbackSO : ScriptableObject
	{
		[SerializeField]
		...
		public EActors FeedbacksActors { get; private set; }
