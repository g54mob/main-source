...
{
	[Serializable]
	public class BBTSmokedBloodQualityProductionGoal : BBTGoal<SmokedBloodQualityProductionGoal>
	{
		[SerializeField]
		[VariablePopup(false)]
		...
		{
			Goal = new SmokedBloodQualityProductionGoal(Quest, Entry, Variable, Target, _targetQuality);
		}
	}
}
