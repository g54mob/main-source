...
namespace CareBoo.Serially
{
	...
	public class TypeFilterAttribute : PropertyAttribute
	{
		...
		public Func<IEnumerable<Type>, IEnumerable<Type>> DerivedFromFilter => (IEnumerable<Type> sequence) => sequence;
		...
		{
			Filter = (Func<IEnumerable<Type>, IEnumerable<Type>>)Delegate.CreateDelegate(typeof(Func<IEnumerable<Type>, IEnumerable<Type>>), parent, FilterName);
			return Filter;
		}
	}
}
