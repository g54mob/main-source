...
namespace Rewired
{
	...
	{
		private const string fNETZcUVIjrIgidSQPnOraKuTaw = "USE_PROFILER must be set in Rewired Core to use the profiler.";

		public static bool enableBinaryLog
		{
			get
			{
				bVdYKJPwyeVsinZElsgwcIAXUsM();
				return false;
			}
			set
			{
		...
		private static void bVdYKJPwyeVsinZElsgwcIAXUsM()
		{
