...
namespace Rewired.Data.Mapping
{
	...
	public class AxisCalibrationInfo : IDeepCloneable
	{
		...
		internal static AxisCalibrationData HXrVcoLjzSPesnPgUEohLPNAhvF(AxisCalibrationInfo P_0)
		{
			if (P_0 == null)
			{
		...
		internal static AxisCalibrationInfo BNYbzazGtsWWlyXpclpCOdPuKOD(AxisCalibrationData P_0)
		{
