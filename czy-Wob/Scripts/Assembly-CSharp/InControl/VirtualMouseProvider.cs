...
namespace InControl
{
	public class VirtualMouseProvider : IMouseProvider
	{
		...
		private CursorController virtualCursorRef;
		...
		public void CustomSetup(CursorController newVirtualCursorRef)
		{
			Setup();
			virtualCursorRef = newVirtualCursorRef;
		}
		...
		public void Update()
		{
			if (virtualCursorRef != null)
			{
				...
				position = virtualCursorRef.GetVirtualMousePosition();
				delta = new Vector2(InputManager.ActiveDevice.LeftStickX, InputManager.ActiveDevice.LeftStickY);
