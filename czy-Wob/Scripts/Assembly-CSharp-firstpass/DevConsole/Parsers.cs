...
namespace DevConsole
{
	public static class Parsers
	{
		...
		private static Vector3 ParseVector3(string value)
		{
			...
			return new Vector3(array2[0], array2[1], (array.Length > 2) ? array2[2] : 0f);
		}
		...
		private static Vector4 ParseVector4(string value)
		{
			...
			return new Vector4(array2[0], array2[1], (array.Length > 2) ? array2[2] : 0f, (array.Length > 3) ? array2[3] : 0f);
		}
		...
		private static Color ParseColor(string value)
		{
			...
			return new Color(array2[0], array2[1], array2[2], (array.Length > 3) ? array2[3] : 1f);
		}
