...
public class ProfileUI : UIListElement
{
	...
	public override void LoadData()
	{
		...
		int num = 0;
		int num2 = LTFunctionLibrary.GetLevelsProgressionManager().LevelProgressionInfos.Length;
		...
		int num3 = 0;
		int num4 = LTFunctionLibrary.GetLevelsProgressionManager().LevelProgressionInfos.Length;
