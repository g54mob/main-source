...
public class NewGameMenuUI : HUDMenu, ISavable
{
	...
	{
		gameModeImage.sprite = MatchInfo.instance.CurrentMatchSettings.Icon;
		gameModeName.text = MatchInfo.instance.CurrentMatchSettings.DisplayName.GetLocalizedString();
	}
