...
public class UpgradesMenuUI : HUDMenu
{
	[SerializeField]
	...
	private void SelectPlayerUpgrade(PlayerUpgradeUI playerUpgradeUI)
	{
		...
		if (true && !playerUpgradeUI.availableInDemo)
		{
	...
	public void OnBuyUpgradeButtonPressed()
	{
		...
		{
			string localizedString = LocalizationSettings.StringDatabase.GetLocalizedString("UI_UpgradesMenu", "UI_UpgradesMenu_modalWindow_pendingSavedGame", null, FallbackBehavior.UseProjectSettings);
			...
			ltMainMenuHud.ShowModalWindowOneButton(localizedString, "", null, null, localizedString2);
		}
		else
		{
