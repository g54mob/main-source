...
public class LevelGenerator : MonoBehaviour, ISavable
{
	...
	public IEnumerator GenerateLevel(bool newGame, LevelData levelData)
	{
		...
		MapGenerator mapGenerator = Object.Instantiate(levelData.MapGeneratorPrefab, base.gameObject.transform).GetComponent<MapGenerator>();
