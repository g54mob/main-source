...
public class GameStatsManager : MonoBehaviour, ISavable
{
	...
	{
		if (storeSourceID != Storage_ResourceData.EStoreSource.Refund.ToString() && storeSourceID != Storage_ResourceData.EStoreSource.Trade.ToString() && storeSourceID != Storage_ResourceData.EStoreSource.LoadGame.ToString())
		{
