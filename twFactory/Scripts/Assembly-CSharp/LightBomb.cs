...
public class LightBomb : GameplayObject, ISelectable
{
			...
			else
			{
				...
				foreach (Collider item2 in list)
				{
					...
					if (!flag2)
					{
						...
						component2.Setup(placementComponent, component);
	...
	private void DestroyNearbySources()
	{
		...
		foreach (Collider collider in array)
		{
			...
			if ((object)attachedRigidbody != null && attachedRigidbody.CompareTag("Source"))
			{
				collider.attachedRigidbody.GetComponent<Source>()?.DestroySource();
			}
		}
	}
}
