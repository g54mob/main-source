...
[Serializable]
public class Task_PatchcordAndNetwork : ITask
{
	...
	public string GetLastSegment(string ipAddress)
	{
		return null;
	}

	public int GetLastSegmentAsInt(string ipAddress)
	{
		return 0;
	}
	...
	private void UninstallApplication(AppBase appBase, AppStore appStore, string name)
	{
	}
