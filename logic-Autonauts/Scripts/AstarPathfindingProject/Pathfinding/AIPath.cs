	...
	public class AIPath : AIBase, IAstarAI
	{
		...
		public bool reachedDestination
		{
			get
			{
				...
				if (remainingDistance + movementPlane.ToPlane(base.destination - interpolator.endPoint).magnitude > endReachedDistance)
				{
					return false;
				}
				...
				{
					float elevation;
					movementPlane.ToPlane(base.destination, out elevation);
