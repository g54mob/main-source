...
namespace Rewired.Libraries.SharpDX
{
	internal sealed class ResultDescriptor
	{
		...
		private static readonly Dictionary<hbpFHugbKyodFCJCiZcKFruzcGvs, ResultDescriptor> Descriptors = new Dictionary<hbpFHugbKyodFCJCiZcKFruzcGvs, ResultDescriptor>();

		public hbpFHugbKyodFCJCiZcKFruzcGvs Result { get; private set; }
		...
		public ResultDescriptor(hbpFHugbKyodFCJCiZcKFruzcGvs code, string module, string nativeApiCode, string apiCode, string description = null)
		{
			Result = code;
			Module = module;
		...
		public static implicit operator hbpFHugbKyodFCJCiZcKFruzcGvs(ResultDescriptor result)
		{
		...
		public static bool operator ==(ResultDescriptor left, hbpFHugbKyodFCJCiZcKFruzcGvs right)
		{
			if (left == null)
			{
				return false;
		...
		public static ResultDescriptor Find(hbpFHugbKyodFCJCiZcKFruzcGvs result)
		{
