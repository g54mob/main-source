...
namespace Rewired.Libraries.SharpDX
{
	internal struct RectangleF : IEquatable<RectangleF>
	{
		...
		public tHUXQUJruIoKJBkUPVSpWJpVAdj Location
		{
			get
			{
				return new tHUXQUJruIoKJBkUPVSpWJpVAdj(X, Y);
			}
			set
			{
				X = value.xEUKPyQaTfqoROGHJowSWeletXA;
				Y = value.VeUXJbtopZnzuPExHBOZDuueBov;
			}
		}

		public tHUXQUJruIoKJBkUPVSpWJpVAdj Center
		{
			get
			{
				return new tHUXQUJruIoKJBkUPVSpWJpVAdj(X + Width / 2f, Y + Height / 2f);
			}
		}
		...
		public tHUXQUJruIoKJBkUPVSpWJpVAdj TopLeft
		{
			get
			{
				return new tHUXQUJruIoKJBkUPVSpWJpVAdj(_left, _top);
			}
		}

		public tHUXQUJruIoKJBkUPVSpWJpVAdj TopRight
		{
			get
			{
				return new tHUXQUJruIoKJBkUPVSpWJpVAdj(_right, _top);
			}
		}

		public tHUXQUJruIoKJBkUPVSpWJpVAdj BottomLeft
		{
			get
			{
				return new tHUXQUJruIoKJBkUPVSpWJpVAdj(_left, _bottom);
			}
		}

		public tHUXQUJruIoKJBkUPVSpWJpVAdj BottomRight
		{
			get
			{
				return new tHUXQUJruIoKJBkUPVSpWJpVAdj(_right, _bottom);
			}
		}
		...
		public void Offset(tHUXQUJruIoKJBkUPVSpWJpVAdj amount)
		{
			Offset(amount.xEUKPyQaTfqoROGHJowSWeletXA, amount.VeUXJbtopZnzuPExHBOZDuueBov);
		}
		...
		public void Contains(ref tHUXQUJruIoKJBkUPVSpWJpVAdj value, out bool result)
		{
			result = X <= value.xEUKPyQaTfqoROGHJowSWeletXA && value.xEUKPyQaTfqoROGHJowSWeletXA < Right && Y <= value.VeUXJbtopZnzuPExHBOZDuueBov && value.VeUXJbtopZnzuPExHBOZDuueBov < Bottom;
		}
		...
		{
			if (HKbcmtHxGOxqoUgzpNGAGbrWhWL.nFEuCHuBTekQSfrBpWHSgxqSedw(other.Left, Left) && HKbcmtHxGOxqoUgzpNGAGbrWhWL.nFEuCHuBTekQSfrBpWHSgxqSedw(other.Right, Right) && HKbcmtHxGOxqoUgzpNGAGbrWhWL.nFEuCHuBTekQSfrBpWHSgxqSedw(other.Top, Top))
			{
				return HKbcmtHxGOxqoUgzpNGAGbrWhWL.nFEuCHuBTekQSfrBpWHSgxqSedw(other.Bottom, Bottom);
			}
			return false;
		}
