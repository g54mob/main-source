...
internal struct jDVybpHdwdUbDzuPJlChXABHpSo
{
	...
	static jDVybpHdwdUbDzuPJlChXABHpSo()
	{
		LSXKhNWqaYXRhGEFFUMCjrDtClE = IntPtr.Size == 8;
		jCrESXpCSpMEOgJbFAsGAKUQCWML = (LSXKhNWqaYXRhGEFFUMCjrDtClE ? 8 : 4);
	}

	public static jDVybpHdwdUbDzuPJlChXABHpSo TYlxuGmSJRngTlXtymyHFDIVxCx(byte[] P_0, int P_1)
	{
		jDVybpHdwdUbDzuPJlChXABHpSo result = default(jDVybpHdwdUbDzuPJlChXABHpSo);
	...
	public static implicit operator uint(jDVybpHdwdUbDzuPJlChXABHpSo obj)
	{
		if (LSXKhNWqaYXRhGEFFUMCjrDtClE)
		{
	...
	public static implicit operator ulong(jDVybpHdwdUbDzuPJlChXABHpSo obj)
	{
		if (LSXKhNWqaYXRhGEFFUMCjrDtClE)
		{
