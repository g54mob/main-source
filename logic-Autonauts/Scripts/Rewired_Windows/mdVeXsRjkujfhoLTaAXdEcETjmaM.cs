...
internal abstract class mdVeXsRjkujfhoLTaAXdEcETjmaM
{
	...
	public abstract MqFYeVKLxsquTeQxKQymlVUJzEo GetDigitalActionData(ulong P_0, ulong P_1);

	public abstract int GetDigitalActionOrigins(ulong P_0, ulong P_1, ulong P_2, ref uint P_3);

	public abstract int GetDigitalActionOrigins(ulong P_0, ulong P_1, ulong P_2, gFyhHihEVuYgAHLAzSttsEgFbLwf[] P_3);

	public abstract ulong GetAnalogActionHandle(string P_0);

	public abstract zquCGODUjNomfqDeknGuKrsjOHzX GetAnalogActionData(ulong P_0, ulong P_1);

	public abstract int GetAnalogActionOrigins(ulong P_0, ulong P_1, ulong P_2, ref uint P_3);

	public abstract int GetAnalogActionOrigins(ulong P_0, ulong P_1, ulong P_2, gFyhHihEVuYgAHLAzSttsEgFbLwf[] P_3);
