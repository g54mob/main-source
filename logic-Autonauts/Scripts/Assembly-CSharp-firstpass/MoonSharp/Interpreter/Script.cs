...
namespace MoonSharp.Interpreter
{
	public class Script : IScriptPrivateResource
	{
		...
		public DynValue LoadFunction(string code, Table globalTable = null, string funcFriendlyName = null)
		{
			...
			SourceCode sourceCode = new SourceCode(string.Format("libfunc_{0}", funcFriendlyName ?? m_Sources.Count.ToString()), code, m_Sources.Count, this);
		...
		public bool IsOwnership(IScriptPrivateResource containingResource, DynValue value)
		{
			if (value != null)
			{
				...
				{
					if (containingResource.OwnerScript != null && containingResource.OwnerScript != asPrivateResource.OwnerScript && asPrivateResource.OwnerScript != null)
					{
						return false;
					}
					if (containingResource.OwnerScript == null && asPrivateResource.OwnerScript != null)
					{
						return false;
					}
				}
