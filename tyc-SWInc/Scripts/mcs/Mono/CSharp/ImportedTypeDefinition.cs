		...
		public void LoadMembers(TypeSpec declaringType, bool onlyTypes, ref MemberCache cache)
		{
			...
			foreach (MemberInfo memberInfo3 in array)
			{
				...
				case MemberTypes.Property:
				{
					...
					MethodInfo addMethod = propertyInfo.GetGetMethod(true);
					MethodSpec value3;
					if ((object)addMethod == null || !dictionary.TryGetValue(addMethod, out value3))
					{
						value3 = null;
					}
					addMethod = propertyInfo.GetSetMethod(true);
					MethodSpec value4;
					if ((object)addMethod == null || !dictionary.TryGetValue(addMethod, out value4))
					{
						value4 = null;
					}
				...
				case MemberTypes.Event:
				{
					...
					MethodSpec value;
					if ((object)addMethod == null || !dictionary.TryGetValue(addMethod, out value))
					{
						value = null;
					}
					addMethod = eventInfo.GetRemoveMethod(true);
					MethodSpec value2;
					if ((object)addMethod == null || !dictionary.TryGetValue(addMethod, out value2))
					{
						value2 = null;
					}
