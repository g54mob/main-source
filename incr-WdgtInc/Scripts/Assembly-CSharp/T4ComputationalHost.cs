...
public class T4ComputationalHost : MonoBehaviour
{
	...
	public void ButtonClicked(int id)
	{
		...
		_parentFrame.ShowWarning(new WorldAnchor(WorldAnchorType.HandCraft, 0), "@T4ComputationalWidgetWarning");
		_newQuestionTimer = 1f;
		_mistakesInARow++;
		if (_mistakesInARow == 10)
		{
			SteamAchievement.Trigger("BadCalc");
		}
	}
}
