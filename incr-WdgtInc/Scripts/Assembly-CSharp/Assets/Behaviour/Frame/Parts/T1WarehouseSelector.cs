...
namespace Assets.Behaviour.Frame.Parts
{
	public class T1WarehouseSelector : MonoBehaviour
	{
		...
		{
			_statusText.TL("@T2WarehouseEffect", Frame.GetStorageAmount(), (Frame.StorageTier == 0) ? "@TooltipStorageAll" : Translation.Translate("@TooltipStorageTier", Frame.StorageTier));
		}
	}
}
