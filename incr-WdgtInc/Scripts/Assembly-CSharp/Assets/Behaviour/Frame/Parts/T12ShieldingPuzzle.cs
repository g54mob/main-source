	...
	public class T12ShieldingPuzzle : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			else if (_lever.Progress > 0.95f)
			{
				...
				{
					_parent.ShowWarning(new WorldAnchor(WorldAnchorType.HandCraft, 0), "@T12OmegaProjectShieldingWarning");
					_discharging = true;
				}
			}
			else if (_currentCharge > 0f)
			{
				...
				{
					_parent.ShowWarning(new WorldAnchor(WorldAnchorType.HandCraft, 0), "@T12OmegaProjectShieldingOvercharge");
				}
				else
				{
					_parent.ShowWarning(new WorldAnchor(WorldAnchorType.HandCraft, 0), "@T12OmegaProjectShieldingUndercharge");
				}
				_discharging = true;
			}
