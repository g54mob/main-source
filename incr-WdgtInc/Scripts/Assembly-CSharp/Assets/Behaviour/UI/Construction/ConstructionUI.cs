	...
	public class ConstructionUI : MonoBehaviour
	{
		...
		public void TogglePause()
		{
			...
			if (GamePlayer.Current.ConstructionPaused)
			{
				...
				component.Title = "@ConstructionMenuResume";
				component.BodyText = "@ConstructionMenuResumeDesc";
			}
			else
			{
				component2.sprite = SpriteLibrary.Get("Items_26");
				component.Title = "@ConstructionMenuPause";
				component.BodyText = "@ConstructionMenuPauseDesc";
			}
			_pauseBorder.gameObject.SetActive(GamePlayer.Current.ConstructionPaused);
			UITooltip.Refresh();
		}
