...
public class GameControls : IInputActionCollection2, IInputActionCollection, IEnumerable<InputAction>, IEnumerable, IDisposable
{
	public struct DefaultActions
	{
		...
		public InputAction TogglePicker => m_Wrapper.m_Default_TogglePicker;
		...
		public void AddCallbacks(IDefaultActions instance)
		{
			if (instance != null && !m_Wrapper.m_DefaultActionsCallbackInterfaces.Contains(instance))
			{
				...
				TogglePicker.started += instance.OnTogglePicker;
				TogglePicker.performed += instance.OnTogglePicker;
				TogglePicker.canceled += instance.OnTogglePicker;
	...
	public interface IDefaultActions
	{
		...
		void OnTogglePicker(InputAction.CallbackContext context);
	...
	private readonly InputAction m_Default_TogglePicker;
	...
	public GameControls()
	{
		...
		m_Default_TogglePicker = m_Default.FindAction("TogglePicker", throwIfNotFound: true);
