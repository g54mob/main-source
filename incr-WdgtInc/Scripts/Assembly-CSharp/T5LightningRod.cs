...
public class T5LightningRod : MonoBehaviour
{
	...
	public bool LightningActive => _line.gameObject.activeSelf;
	...
	public void DoLightning(float addTime = 0f)
	{
		_lightningTime += addTime;
		...
		if (_lightningUpdateTimer <= 0f)
		{
			...
			_line.SetPosition(3, new Vector3(0.19f - _line.transform.position.x, 0.77f - _line.transform.position.y + 7.5f, 0f));
