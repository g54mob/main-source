...
public class WorldManager : MonoBehaviour
{
	...
	private void Start()
	{
		...
		if (WorldMap.Current.GlitchLocation == Vector2Int.zero)
		{
			WorldMap.Current.CreateGlitchedFrame();
		}
		T1GlitchedFrame.UpdateReagents(force: true);
	...
	public void ShowFrame(WorldFrame frame, bool showUI)
	{
		...
		{
			FrameUI.Instance?.ShowFrame(frame);
