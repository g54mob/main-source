...
public class ActiveWorldFrame : MonoBehaviour
{
	...
	public static ActiveWorldFrame Current { get; private set; }

	public static bool Active
	{
		get
		{
			if ((bool)Current && Current.gameObject.activeInHierarchy)
			{
				return Current.ActiveFrame != null;
			}
			return false;
		}
	}
	...
	public void ShowNeedItem(WorldAnchor anchor, ItemType type, BigInteger count)
	{
	...
	public void ShowItemCrafted(WorldAnchor anchor, ItemType type, BigInteger count, float offset)
	{
		Transform anchor2 = GetAnchor(anchor, "ItemCrafted");
		FrameUI.Instance.ShowItemCrafted(anchor2, type, count, offset);
