	...
	public sealed class DualSenseExtension : Controller.Extension, IControllerVibrator, IDualShock4Extension
	{
		...
		public DualSenseMicrophoneLightMode microphoneLightMode
		{
			get
			{
				...
				return vPTVBGMeTSLLhqcGnbvGjLFkMncb.HASpVVHfbqNxqOWsgCqNVQzLcYFw.microphoneLightMode;
			}
			set
			{
				if (ReInput._id != _reInputId)
				...
				{
					vPTVBGMeTSLLhqcGnbvGjLFkMncb.HASpVVHfbqNxqOWsgCqNVQzLcYFw.microphoneLightMode = value;
				}
			}
		}
		...
		public DualSenseOtherLightBrightness otherLightBrightness
		{
			get
			{
				...
				return vPTVBGMeTSLLhqcGnbvGjLFkMncb.HASpVVHfbqNxqOWsgCqNVQzLcYFw.otherLightBrightness;
			}
			set
			{
				if (ReInput._id != _reInputId)
				...
				{
					vPTVBGMeTSLLhqcGnbvGjLFkMncb.HASpVVHfbqNxqOWsgCqNVQzLcYFw.otherLightBrightness = value;
				}
			}
		}
		...
		public DualSensePlayerLightFlags playerLights
		{
			get
			{
				...
				return vPTVBGMeTSLLhqcGnbvGjLFkMncb.HASpVVHfbqNxqOWsgCqNVQzLcYFw.playerLights;
			}
			set
			{
				if (ReInput._id != _reInputId)
				...
				{
					vPTVBGMeTSLLhqcGnbvGjLFkMncb.HASpVVHfbqNxqOWsgCqNVQzLcYFw.playerLights = value;
				}
			}
		}
		...
		public bool batteryCharging
		{
			get
			{
				...
				return vPTVBGMeTSLLhqcGnbvGjLFkMncb.HASpVVHfbqNxqOWsgCqNVQzLcYFw.BatteryCharging;
			}
		}

		internal DualSenseExtension(IDriver_DualSense P_0)
			: base(new cwwBxqgtNctnHyfLdAwngzRTxXIbA(P_0, P_0.VibrationMotorCount > 0, P_0.VibrationMotorCount))
		{
		...
		{
			vPTVBGMeTSLLhqcGnbvGjLFkMncb = P_0 as cwwBxqgtNctnHyfLdAwngzRTxXIbA;
