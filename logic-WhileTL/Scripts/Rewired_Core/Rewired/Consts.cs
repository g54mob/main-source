...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static ReadOnlyCollection<ControllerElementIdentifier> UnZHghYhzEILDVCJkJfKFqekycsw;

		private static ReadOnlyCollection<ControllerElementIdentifier> DNEeRjIaBGrOFiQNKlTRvjaEuqfXb;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] ZBLqSVgBEyawPMROwsThzmFChIwkA;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] aJoTJdzVCHvBiiRqoGWlHnpyKZJp;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] lcULpZMSNDwToEoJiAfBFfeXhWFRA;
		...
		private static readonly string[] GooeIIMUbDGApfKHdLLaTdDhAecdb;

		public const int vendorId_sony = 1356;

		internal static readonly IList<PidVid> pidVids_sony_dualShock4;

		private static readonly PidVid[] AQaTUGlJZyBpVifurBVOYnpMUJAMA;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] DIywsfTyjYUhrFKzLVjixSBzgaxC;

		private static readonly ControllerElementIdentifier[] ghxxLLMZtrkZXwgnyAGriwFMhBzO;
		...
		internal static IList<ControllerElementIdentifier> unityUnifiedMouseElementIdentifiers => UnZHghYhzEILDVCJkJfKFqekycsw ?? (UnZHghYhzEILDVCJkJfKFqekycsw = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[11]
		{
		...
		internal static IList<ControllerElementIdentifier> rawInputUnifiedMouseElementIdentifiers => DNEeRjIaBGrOFiQNKlTRvjaEuqfXb ?? (DNEeRjIaBGrOFiQNKlTRvjaEuqfXb = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[9]
		{
			new ControllerElementIdentifier(0, "Mouse Horizontal", "Mouse Right", "Mouse Left", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, true),
			new ControllerElementIdentifier(1, "Mouse Vertical", "Mouse Up", "Mouse Down", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, true),
			new ControllerElementIdentifier(2, "Mouse Wheel", "Mouse Wheel Up", "Mouse Wheel Down", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, true),
		...
		internal static ControllerElementIdentifier[] unknownJoystickElementIdentifiers_orig => ghxxLLMZtrkZXwgnyAGriwFMhBzO;
		...
		static Consts()
		{
			...
			ZBLqSVgBEyawPMROwsThzmFChIwkA = new string[3] { "MouseAxis1", "MouseAxis2", "MouseAxis3" };
			aJoTJdzVCHvBiiRqoGWlHnpyKZJp = new string[7] { "MouseButton0", "MouseButton1", "MouseButton2", "MouseButton3", "MouseButton4", "MouseButton5", "MouseButton6" };
			lcULpZMSNDwToEoJiAfBFfeXhWFRA = new string[132]
			{
			...
			GooeIIMUbDGApfKHdLLaTdDhAecdb = new string[5] { "", "Ctrl", "Alt", "Shift", "Cmd" };
			AQaTUGlJZyBpVifurBVOYnpMUJAMA = new PidVid[3]
			{
				new PidVid(1476, 1356),
				new PidVid(2976, 1356),
				new PidVid(2508, 1356)
			};
			DIywsfTyjYUhrFKzLVjixSBzgaxC = new string[4] { "Sony Computer Entertainment Wireless Controller", "Sony Interactive Entertainment DUALSHOCK®4 USB Wireless Adaptor", "Wireless Controller", "Sony Interactive Entertainment Wireless Controller" };
			mouseAxisUnityNames = new ReadOnlyCollection<string>(ZBLqSVgBEyawPMROwsThzmFChIwkA);
			mouseButtonUnityNames = new ReadOnlyCollection<string>(aJoTJdzVCHvBiiRqoGWlHnpyKZJp);
			keyboardKeyNames = new ReadOnlyCollection<string>(lcULpZMSNDwToEoJiAfBFfeXhWFRA);
			keyboardKeyValues = new ReadOnlyCollection<int>(_keyboardKeyValues);
			modifierKeyShortNames = new ReadOnlyCollection<string>(GooeIIMUbDGApfKHdLLaTdDhAecdb);
			pidVids_sony_dualShock4 = new ReadOnlyCollection<PidVid>(AQaTUGlJZyBpVifurBVOYnpMUJAMA);
			productNames_sony_dualShock4 = new ReadOnlyCollection<string>(DIywsfTyjYUhrFKzLVjixSBzgaxC);
			...
			ghxxLLMZtrkZXwgnyAGriwFMhBzO = dkvVCMmSHHIqleZtKmMuonCoftWS();
			if (132 != lcULpZMSNDwToEoJiAfBFfeXhWFRA.Length)
			{
		...
		private static ControllerElementIdentifier[] dkvVCMmSHHIqleZtKmMuonCoftWS()
		{
			int num = 0;
