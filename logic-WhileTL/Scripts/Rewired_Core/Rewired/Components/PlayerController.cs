...
namespace Rewired.Components
{
	...
	public class PlayerController : ComponentWrapper<Rewired.PlayerController>, IPlayerController
	{
		...
		protected override void OnAwakeFinished()
		{
			...
			if (base.initialized)
			{
				UkLQAalAElxoMUHFoBNzzGhnVlsp(true);
			}
		}
		...
		protected override void Subscribe()
		{
			...
			if (base.source != null)
			{
				base.source.ButtonStateChangedEvent += KOpbSpxJyuGAzPcGwbIgHpZsVVLn;
				base.source.AxisValueChangedEvent += lLFFKNPRhFapxntcuwlZTDsroWzC;
				base.source.EnabledStateChangedEvent += UkLQAalAElxoMUHFoBNzzGhnVlsp;
			}
		}
		...
		private void sxtSnKfDpcAAfEbOHFsQbecmqEcQA()
		{
			...
			{
				_elements = KNoWOpeWgdlxCnBGGhQMtQLkTkVM();
			}
		}
	}
}
