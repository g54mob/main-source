...
namespace Rewired
{
	public abstract class ControllerMapSaveData
	{
		...
		internal static _0001 goGesjEFofcTayLyzynfoITRPCBk<_0001>(Controller P_0, ControllerMap P_1) where _0001 : ControllerMapSaveData
		{
			return (_0001)goGesjEFofcTayLyzynfoITRPCBk(P_0, P_1);
		}

		internal static ControllerMapSaveData goGesjEFofcTayLyzynfoITRPCBk(Controller P_0, ControllerMap P_1)
		{
