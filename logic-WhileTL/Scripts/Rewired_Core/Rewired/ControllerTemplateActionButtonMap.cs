...
namespace Rewired
{
	public sealed class ControllerTemplateActionButtonMap : ControllerTemplateActionElementMap
	{
		...
		{
			xBLbApMnHgwbIBXRhstMIevzfxtFA = P_2;
		}
		...
		internal override int xeeUWXXmkCBeEkgKwamzOWDeUHkL(IControllerTemplateElementSource P_0, List<ActionElementMap> P_1, bool P_2)
		{
			...
			int num = 0;
			ActionElementMap actionElementMap = ccgHTlrhjZFTxskRTAsPAVmzYjxs(controllerTemplateButtonSource.target, xBLbApMnHgwbIBXRhstMIevzfxtFA);
		...
		private ActionElementMap ccgHTlrhjZFTxskRTAsPAVmzYjxs(IControllerElementTarget P_0, Pole P_1)
		{
