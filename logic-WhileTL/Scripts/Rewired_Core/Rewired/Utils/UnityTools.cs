...
namespace Rewired.Utils
{
	public static class UnityTools
	{
		internal struct dLTpFXVUEoYOHBezYpFOWYkDPuSf
		{
			...
			{
				lYXneBQNfIGyzfmqBblxyldQoJcKA = P_0;
				geTGwKSCgshpIWCyYNzgvHxtoWsl = P_1;
				GxfxplsGSVWklwQjsUpuwISbPoLs = P_2;
				pIdBQOkNJGMPjqZlYTFxCFbLHYjAA = P_3;
				tWllbFMSNSkPiGIJcoKhuYAgfmBp = P_4;
				pcdwRuLeYjjcBowqiciyjCrFaUJZ = P_5;
				pDCPpdgWjkcaLZvdyQQtPKIKGEIeA = P_6;
				wmaeplGklRdesjQiqSJnyTjNyoFJ = P_7;
			}
		}
		...
		internal class UnityVersionClass
		{
			...
			{
				type = ZZvCDfVQVmDjYvSRBlTTrpWdRoBV.Normal;
				...
				if (Regex.IsMatch(text, ".*[a-zA-Z]+.*"))
				{
					...
					{
						type = ZZvCDfVQVmDjYvSRBlTTrpWdRoBV.Beta;
					}
					else if (Regex.IsMatch(text, ".*[pP]+.*", RegexOptions.IgnoreCase))
					{
						type = ZZvCDfVQVmDjYvSRBlTTrpWdRoBV.Patch;
					}
			...
			public override string ToString()
			{
				...
				array[5] = NWFRqPyAlQuLKXlneJzVNDKjiQbJA(type);
				num = build;
			...
			private string NWFRqPyAlQuLKXlneJzVNDKjiQbJA(ZZvCDfVQVmDjYvSRBlTTrpWdRoBV P_0)
			{
				return P_0 switch
				{
					ZZvCDfVQVmDjYvSRBlTTrpWdRoBV.Normal => "f", 
					ZZvCDfVQVmDjYvSRBlTTrpWdRoBV.Beta => "b", 
					ZZvCDfVQVmDjYvSRBlTTrpWdRoBV.Patch => "p", 
			...
			public static int Comparison(UnityVersionClass a, UnityVersionClass b)
			{
				...
				if (qRMIitcCNkokmbGaTVFwianhXKER(a.type) > qRMIitcCNkokmbGaTVFwianhXKER(b.type))
				{
					return 1;
				}
				if (qRMIitcCNkokmbGaTVFwianhXKER(a.type) < qRMIitcCNkokmbGaTVFwianhXKER(b.type))
			...
			private static int qRMIitcCNkokmbGaTVFwianhXKER(ZZvCDfVQVmDjYvSRBlTTrpWdRoBV P_0)
			{
				return P_0 switch
				{
					ZZvCDfVQVmDjYvSRBlTTrpWdRoBV.Beta => 0, 
					ZZvCDfVQVmDjYvSRBlTTrpWdRoBV.Normal => 10, 
					ZZvCDfVQVmDjYvSRBlTTrpWdRoBV.Patch => 100, 
					_ => throw new NotImplementedException(), 
				};
			}
		}
		...
		private static UnityVersion jrBBOhVfxsitWUgsRgwseeMrSJyNA = UnityVersion.Unknown;
		...
		internal static UnityVersionClass unityVersionObj
		{
			get
			{
				...
				return DieETTMqyKKQyVzPwwRUCwDBCXJG;
			}
		}
		...
		public static UnityVersion unityVersion
		{
			get
			{
				...
				return jrBBOhVfxsitWUgsRgwseeMrSJyNA;
			}
		}
		...
		public static string unityVersionString
		{
			get
			{
				...
				return BStqolTMVxxrXNfDZbDElsbxGxhBA;
			}
		}
		...
		public static Platform platform
		{
			get
			{
				...
				return EwZNUhsHEkSEQzXSjizRWzvAXaEG;
			}
		}
		...
		public static EditorPlatform editorPlatform
		{
			get
			{
				...
				return vLtJrfESYPgDQDnGZPJTJqwWHIYlA;
			}
		}
		...
		public static bool isEditor
		{
			get
			{
				...
				return VEmVOZwlmzNaRcoxfWQVhXPjMSGF;
			}
		}

		public static bool isPlaying => ncdeijtAGZWOXJkaRjWdEzQdLQeX;
		...
		public static bool isDebugBuild
		{
			get
			{
				...
				return snmzewcLuxkolIkkgNycUopxYhML;
			}
		}
		...
		public static WebplayerPlatform webplayerPlatform
		{
			get
			{
				...
				return ZpqltcgNrXUHCRtunjsQsaPwjfOIA;
			}
		}
		...
		public static bool logToDebugLog
		{
			get
			{
				...
				if (VEmVOZwlmzNaRcoxfWQVhXPjMSGF || Application.isEditor)
				{
					return true;
				}
				...
				switch (EwZNUhsHEkSEQzXSjizRWzvAXaEG)
				{
				case Platform.Windows:
				case Platform.OSX:
				case Platform.Linux:
					if (!snmzewcLuxkolIkkgNycUopxYhML)
					{
						return dWiGkIGbgHjtTaNJmFNahblPHmnrA == ScriptingBackend.IL2CPP;
					}
					return true;
		...
		internal static bool editorPlatformMatchesBuildPlatform
		{
			get
			{
				...
				return vLtJrfESYPgDQDnGZPJTJqwWHIYlA switch
				{
					EditorPlatform.Windows => EwZNUhsHEkSEQzXSjizRWzvAXaEG == Platform.Windows, 
					EditorPlatform.OSX => EwZNUhsHEkSEQzXSjizRWzvAXaEG == Platform.OSX, 
					EditorPlatform.Linux => EwZNUhsHEkSEQzXSjizRWzvAXaEG == Platform.Linux, 
					_ => true, 
				};
			}
		}
		...
		public static bool isSupportedVersion3
		{
			get
			{
				...
				return ekFNPpApUoEFfogGmgmokYYdCbyl;
			}
		}
		...
		public static bool isSupportedVersion4
		{
			get
			{
				...
				return nshrWkIWwTHzfpTLYfapJKMExxBh;
			}
		}
		...
		public static bool supports2DColliders
		{
			get
			{
				...
				return jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_4_3;
			}
		}
		...
		public static bool supportsUnityUI
		{
			get
			{
				...
				return jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_4_6;
			}
		}
		...
		public static bool supportsTouchControls
		{
			get
			{
				...
				return jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_5_0;
			}
		}
		...
		public static bool isAndroidPlatform
		{
			get
			{
				...
				if (EwZNUhsHEkSEQzXSjizRWzvAXaEG != Platform.Android && EwZNUhsHEkSEQzXSjizRWzvAXaEG != Platform.Ouya && EwZNUhsHEkSEQzXSjizRWzvAXaEG != Platform.AmazonFireTV)
				{
					return EwZNUhsHEkSEQzXSjizRWzvAXaEG == Platform.RazerForgeTV;
				}
				return true;
			}
		}
		...
		public static bool isIOSPlatform
		{
			get
			{
				...
				if (EwZNUhsHEkSEQzXSjizRWzvAXaEG != Platform.iOS)
				{
					return EwZNUhsHEkSEQzXSjizRWzvAXaEG == Platform.tvOS;
				}
				return true;
			}
		}
		...
		public static bool isStandalonePlatform
		{
			get
			{
				...
				if (EwZNUhsHEkSEQzXSjizRWzvAXaEG != Platform.Windows && EwZNUhsHEkSEQzXSjizRWzvAXaEG != Platform.Linux)
				{
					return EwZNUhsHEkSEQzXSjizRWzvAXaEG == Platform.OSX;
				}
				return true;
			}
		}
		...
		public static bool windowsJoystickNamesReturnsEmptyStringsIfJoystickNull
		{
			get
			{
				...
				return bmVqNhiBruUMCqSlFnAKAdLrFgvkA;
			}
		}
		...
		public static bool supportsUnityUIGraphicRaycastTarget
		{
			get
			{
				...
				return jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_5_2;
			}
		}
		...
		public static bool supportsNestedPrefabs
		{
			get
			{
				...
				return jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_2018_3;
			}
		}
		...
		public static bool supportsWindowsAppStore
		{
			get
			{
				...
				if (jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_5_0)
				{
					return jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_5_0_1;
				}
				return true;
			}
		}
		...
		public static bool supportsWindowsUWP_IL2CPP
		{
			get
			{
				...
				return jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_5_3;
			}
		}
		...
		public static bool supportsXboxOne
		{
			get
			{
				...
				return jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_4_5;
			}
		}
		...
		public static bool supportsStadia
		{
			get
			{
				...
				return jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_2019_3;
			}
		}
		...
		public static bool windowsStandalone_supportsRawInputForwarding
		{
			get
			{
				...
				return qrPixgRnIGYbtEpCbycmnBMXvfSL;
			}
		}

		[CustomObfuscation(rename = false)]
		internal static ScriptingBackend scriptingBackend => dWiGkIGbgHjtTaNJmFNahblPHmnrA;

		[CustomObfuscation(rename = false)]
		internal static ScriptingAPILevel scriptingAPILevel => GWbDvPstOvsjzGUxpxEfGZypTyKe;
		...
		public static IExternalTools externalTools
		{
			get
			{
				...
				return JfWhSacvuCJQNqcsgDkJElRiGDARB;
			}
		}
		...
		internal static IAndroidFallbackPlatformHelper BCHkYYLGsLQnMmusVpqPohjqMrGH
		{
			...
			get
			{
				return ZhmbzvCBUagTvRUMtrvXpLhhpTrZA;
			}
			[CompilerGenerated]
			set
			{
				ZhmbzvCBUagTvRUMtrvXpLhhpTrZA = zhmbzvCBUagTvRUMtrvXpLhhpTrZA;
			}
		}

		[CustomObfuscation(rename = false)]
		internal static bool isInitialized => aUXXHTnRXRBcGTlEKEcFILtHKTWY;

		private static bool qumTafanxrjKbDduWdypwIzXqmiP => agOiHbKryzXgwDhxqoHiKfbcHuzR();

		private static bool agOiHbKryzXgwDhxqoHiKfbcHuzR()
		{
			if (aUXXHTnRXRBcGTlEKEcFILtHKTWY)
			{
				return true;
			}
			try
			{
				BStqolTMVxxrXNfDZbDElsbxGxhBA = Application.unityVersion;
				DieETTMqyKKQyVzPwwRUCwDBCXJG = new UnityVersionClass(BStqolTMVxxrXNfDZbDElsbxGxhBA);
				NHwqicmCCbjvvCVkzFOpFyzUegQbA();
				aUXXHTnRXRBcGTlEKEcFILtHKTWY = true;
			}
			catch
			{
				Logger.LogError("Could not determine Unity version.");
			}
			return aUXXHTnRXRBcGTlEKEcFILtHKTWY;
		}
		...
		internal static void gUxczTgMdKUcYRnCXamteWaCXJodc(dLTpFXVUEoYOHBezYpFOWYkDPuSf P_0)
		{
			if (qumTafanxrjKbDduWdypwIzXqmiP)
			{
				if (P_0.geTGwKSCgshpIWCyYNzgvHxtoWsl == Platform.Windows81Store)
				{
					P_0.geTGwKSCgshpIWCyYNzgvHxtoWsl = Platform.WindowsUWP;
				}
				EwZNUhsHEkSEQzXSjizRWzvAXaEG = P_0.geTGwKSCgshpIWCyYNzgvHxtoWsl;
				vLtJrfESYPgDQDnGZPJTJqwWHIYlA = P_0.GxfxplsGSVWklwQjsUpuwISbPoLs;
				VEmVOZwlmzNaRcoxfWQVhXPjMSGF = P_0.pIdBQOkNJGMPjqZlYTFxCFbLHYjAA;
				ZpqltcgNrXUHCRtunjsQsaPwjfOIA = P_0.tWllbFMSNSkPiGIJcoKhuYAgfmBp;
				dWiGkIGbgHjtTaNJmFNahblPHmnrA = P_0.pcdwRuLeYjjcBowqiciyjCrFaUJZ;
				GWbDvPstOvsjzGUxpxEfGZypTyKe = P_0.pDCPpdgWjkcaLZvdyQQtPKIKGEIeA;
				if (JfWhSacvuCJQNqcsgDkJElRiGDARB != null)
				{
					JfWhSacvuCJQNqcsgDkJElRiGDARB.Destroy();
				}
				JfWhSacvuCJQNqcsgDkJElRiGDARB = P_0.wmaeplGklRdesjQiqSJnyTjNyoFJ;
				snmzewcLuxkolIkkgNycUopxYhML = Debug.isDebugBuild;
				ncdeijtAGZWOXJkaRjWdEzQdLQeX = true;
				UQBPQWFxKxTixHtybQocrAinXvtv();
			}
		}
		...
		public static bool IsUnityVersionInRange(string minVersionStr, string maxVersionStr)
		{
			...
			mQZjkEcdunOcEKfriqWaBMLNnhoW(minVersionStr, out var num);
			mQZjkEcdunOcEKfriqWaBMLNnhoW(maxVersionStr, out var num2);
			if (num > 0)
			{
			...
			if (num3 && DieETTMqyKKQyVzPwwRUCwDBCXJG < new UnityVersionClass(minVersionStr))
			{
				return false;
			}
			if (num2 > 0)
			{
				if (flag && DieETTMqyKKQyVzPwwRUCwDBCXJG >= new UnityVersionClass(maxVersionStr))
				{
					return false;
				}
			}
			else if (flag && DieETTMqyKKQyVzPwwRUCwDBCXJG > new UnityVersionClass(maxVersionStr))
			{
				return false;
			}
			return true;
		...
		{
			jrBBOhVfxsitWUgsRgwseeMrSJyNA = xuBwJsBXyDceKRBggNHQymTUeyjp(Application.unityVersion);
			if (jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_3_5 && jrBBOhVfxsitWUgsRgwseeMrSJyNA < UnityVersion.UNITY_4_0)
			{
				ekFNPpApUoEFfogGmgmokYYdCbyl = true;
			}
			else if (jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_4_0)
			{
				nshrWkIWwTHzfpTLYfapJKMExxBh = true;
			}
		}
		...
		private static UnityVersion xuBwJsBXyDceKRBggNHQymTUeyjp(string P_0)
		{
			...
			if (num >= 2)
			{
				...
				if (num >= 3)
				{
					...
					{
						string[] array2 = empty.Split(new char[1] { 'p' });
						if (array2.Length != 0)
						{
		...
		private static void UQBPQWFxKxTixHtybQocrAinXvtv()
		{
			...
			case Platform.RazerForgeTV:
				hEdtrapSYXvJdPJePIZuYtWwsvyS = true;
				mWPGZaFXYgjwoyteGxcGQzoQoOnq = true;
				break;
			case Platform.PS4:
				hEdtrapSYXvJdPJePIZuYtWwsvyS = true;
				hjEITnUjcoVIHCHykIDmVYMEMUhX = "Empty";
				NqxAJFYlQGgwQbXeJkBzzufEUJEr = true;
				break;
			case Platform.Windows:
				if ((jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_4_6_3p1 && jrBBOhVfxsitWUgsRgwseeMrSJyNA < UnityVersion.UNITY_5_0) || jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_5_0_0p1)
				{
					bmVqNhiBruUMCqSlFnAKAdLrFgvkA = true;
					hEdtrapSYXvJdPJePIZuYtWwsvyS = true;
				}
				break;
			case Platform.Linux:
			...
			if (VEmVOZwlmzNaRcoxfWQVhXPjMSGF && vLtJrfESYPgDQDnGZPJTJqwWHIYlA == EditorPlatform.Windows && ((jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_4_6_3p1 && jrBBOhVfxsitWUgsRgwseeMrSJyNA < UnityVersion.UNITY_5_0) || jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_5_0_0p1))
			{
				bmVqNhiBruUMCqSlFnAKAdLrFgvkA = true;
				hEdtrapSYXvJdPJePIZuYtWwsvyS = true;
			}
			if ((!VEmVOZwlmzNaRcoxfWQVhXPjMSGF && EwZNUhsHEkSEQzXSjizRWzvAXaEG == Platform.Windows) || (VEmVOZwlmzNaRcoxfWQVhXPjMSGF && vLtJrfESYPgDQDnGZPJTJqwWHIYlA == EditorPlatform.Windows))
			{
				qrPixgRnIGYbtEpCbycmnBMXvfSL = jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_2021_2;
			}
		}
		...
		internal static Type RclgSAfSgvoqZtLRdFaBnpQbQHtjb(sbQPvoIRwSbcNrzTWEwweVgjXAmG P_0)
		{
			...
			if (jrBBOhVfxsitWUgsRgwseeMrSJyNA >= UnityVersion.UNITY_4_3)
			{
				return MztEclEGcHeCBJuZRjtjdDjIJJFp(P_0);
			}
			return null;
		}
		...
		private static Type MztEclEGcHeCBJuZRjtjdDjIJJFp(sbQPvoIRwSbcNrzTWEwweVgjXAmG P_0)
		{
			return P_0 switch
			{
				sbQPvoIRwSbcNrzTWEwweVgjXAmG.RigidbodyInterpolation2D => typeof(RigidbodyInterpolation2D), 
				sbQPvoIRwSbcNrzTWEwweVgjXAmG.RigidbodySleepMode2D => typeof(RigidbodySleepMode2D), 
				sbQPvoIRwSbcNrzTWEwweVgjXAmG.CollisionDetectionMode2D => typeof(CollisionDetectionMode2D), 
				sbQPvoIRwSbcNrzTWEwweVgjXAmG.PhysicsMaterial2D => typeof(PhysicsMaterial2D), 
				sbQPvoIRwSbcNrzTWEwweVgjXAmG.Collider2D => typeof(Collider2D), 
				_ => null, 
			};
		}
		...
		public static T GetComponent<T>(GameObject gameObject) where T : class
		{
			...
			return UxWvTfxsCedMKflZpBeTVayeGbxY(gameObject.GetComponent(typeof(T)) as T);
		}
		...
		public static T Instantiate<T>(UnityEngine.Object original, Vector3 position, Quaternion rotation, Transform parent, bool instantiateInWorldSpace) where T : UnityEngine.Object
		{
			...
			if (IsNullOrDestroyed(obj as T))
			{
				...
				{
					return UxWvTfxsCedMKflZpBeTVayeGbxY((obj as GameObject).GetComponent(typeof(T)) as T);
				}
				if (obj as Transform != null)
				{
					return UxWvTfxsCedMKflZpBeTVayeGbxY((obj as Transform).GetComponent(typeof(T)) as T);
				}
			}
			return UxWvTfxsCedMKflZpBeTVayeGbxY(obj as T);
		}
		...
		public static bool IsValidUnityJoystickName(string name)
		{
			...
			{
				if (ReInput.isWindowsStandaloneWebplayerOrEditorPlatform && bmVqNhiBruUMCqSlFnAKAdLrFgvkA)
				{
					return false;
				}
				if (hEdtrapSYXvJdPJePIZuYtWwsvyS)
				{
					return false;
				}
			}
			...
			{
				if (NqxAJFYlQGgwQbXeJkBzzufEUJEr && name.Equals(hjEITnUjcoVIHCHykIDmVYMEMUhX, StringComparison.OrdinalIgnoreCase))
				{
					return false;
				}
				if (mWPGZaFXYgjwoyteGxcGQzoQoOnq && name.IndexOf("keyboard", 0, StringComparison.OrdinalIgnoreCase) >= 0)
				{
					return false;
				}
			}
