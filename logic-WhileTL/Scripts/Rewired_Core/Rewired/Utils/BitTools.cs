...
namespace Rewired.Utils
{
	...
	{
		private static byte[] FlwgTZGMCwkJgyfGMWteuNGHRbsPA;

		private static byte[] intToFloatBuffer => FlwgTZGMCwkJgyfGMWteuNGHRbsPA ?? (FlwgTZGMCwkJgyfGMWteuNGHRbsPA = new byte[4]);
