...
namespace Rewired.Internal
{
	...
	internal sealed class StandaloneAxis
	{
		...
		private event AxisValueChangedEventHandler _AxisValueChangedEvent
		{
			...
			add
			{
				AxisValueChangedEventHandler axisValueChangedEventHandler = HLGKyrdafUQHhqdCIWgbSLWXcXmr;
				...
				do
				{
					...
					axisValueChangedEventHandler = Interlocked.CompareExchange(ref HLGKyrdafUQHhqdCIWgbSLWXcXmr, axisValueChangedEventHandler3, axisValueChangedEventHandler2);
				}
		...
		private event AxisValueChangedEventHandler _RawAxisValueChangedEvent
		{
			...
			add
			{
				AxisValueChangedEventHandler axisValueChangedEventHandler = vYAnFHWAArJwOhWLkEFntBmgpcLe;
				AxisValueChangedEventHandler axisValueChangedEventHandler2;
				do
				{
					axisValueChangedEventHandler2 = axisValueChangedEventHandler;
					AxisValueChangedEventHandler axisValueChangedEventHandler3 = (AxisValueChangedEventHandler)Delegate.Combine(axisValueChangedEventHandler2, b);
					axisValueChangedEventHandler = Interlocked.CompareExchange(ref vYAnFHWAArJwOhWLkEFntBmgpcLe, axisValueChangedEventHandler3, axisValueChangedEventHandler2);
				}
				while ((object)axisValueChangedEventHandler != axisValueChangedEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonDownEventHandler _ButtonDownEvent
		{
			...
			add
			{
				ButtonDownEventHandler buttonDownEventHandler = gAgpMStGFovyDpFwRgYebDIMuEuWA;
				...
				do
				{
					...
					buttonDownEventHandler = Interlocked.CompareExchange(ref gAgpMStGFovyDpFwRgYebDIMuEuWA, buttonDownEventHandler3, buttonDownEventHandler2);
				}
		...
		private event ButtonUpEventHandler _ButtonUpEvent
		{
			...
			add
			{
				ButtonUpEventHandler buttonUpEventHandler = SCJNWFEwnmGRZnuaqVAEXQKeraEo;
				...
				do
				{
					...
					buttonUpEventHandler = Interlocked.CompareExchange(ref SCJNWFEwnmGRZnuaqVAEXQKeraEo, buttonUpEventHandler3, buttonUpEventHandler2);
				}
		...
		private event ButtonValueChangedEventHandler _ButtonValueChangedEvent
		{
			...
			add
			{
				ButtonValueChangedEventHandler buttonValueChangedEventHandler = AkceaWMYCeXPJFaxFGzyTaxnqDqA;
				...
				do
				{
					...
					buttonValueChangedEventHandler = Interlocked.CompareExchange(ref AkceaWMYCeXPJFaxFGzyTaxnqDqA, buttonValueChangedEventHandler3, buttonValueChangedEventHandler2);
				}
		...
		private event ButtonDownEventHandler _RawButtonDownEvent
		{
			...
			add
			{
				ButtonDownEventHandler buttonDownEventHandler = MRyeeWMdbuxGaqXXEIqTolpmkfxc;
				ButtonDownEventHandler buttonDownEventHandler2;
				do
				{
					buttonDownEventHandler2 = buttonDownEventHandler;
					ButtonDownEventHandler buttonDownEventHandler3 = (ButtonDownEventHandler)Delegate.Combine(buttonDownEventHandler2, b);
					buttonDownEventHandler = Interlocked.CompareExchange(ref MRyeeWMdbuxGaqXXEIqTolpmkfxc, buttonDownEventHandler3, buttonDownEventHandler2);
				}
				while ((object)buttonDownEventHandler != buttonDownEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonUpEventHandler _RawButtonUpEvent
		{
			...
			add
			{
				ButtonUpEventHandler buttonUpEventHandler = HmjfsserMRiombxAoFCsEPMuodryA;
				ButtonUpEventHandler buttonUpEventHandler2;
				do
				{
					buttonUpEventHandler2 = buttonUpEventHandler;
					ButtonUpEventHandler buttonUpEventHandler3 = (ButtonUpEventHandler)Delegate.Combine(buttonUpEventHandler2, b);
					buttonUpEventHandler = Interlocked.CompareExchange(ref HmjfsserMRiombxAoFCsEPMuodryA, buttonUpEventHandler3, buttonUpEventHandler2);
				}
				while ((object)buttonUpEventHandler != buttonUpEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonValueChangedEventHandler _RawButtonValueChangedEvent
		{
			...
			add
			{
				ButtonValueChangedEventHandler buttonValueChangedEventHandler = FKUqUakHpdTSgRMvZRtUdFIMrlSA;
				ButtonValueChangedEventHandler buttonValueChangedEventHandler2;
				do
				{
					buttonValueChangedEventHandler2 = buttonValueChangedEventHandler;
					ButtonValueChangedEventHandler buttonValueChangedEventHandler3 = (ButtonValueChangedEventHandler)Delegate.Combine(buttonValueChangedEventHandler2, b);
					buttonValueChangedEventHandler = Interlocked.CompareExchange(ref FKUqUakHpdTSgRMvZRtUdFIMrlSA, buttonValueChangedEventHandler3, buttonValueChangedEventHandler2);
				}
				while ((object)buttonValueChangedEventHandler != buttonValueChangedEventHandler2);
			}
			[CompilerGenerated]
		...
		public void SetRawValue(float value)
		{
			...
			if (vYAnFHWAArJwOhWLkEFntBmgpcLe != null && _valueRaw != _valueRawPrev)
			{
				vYAnFHWAArJwOhWLkEFntBmgpcLe(_valueRaw);
			}
			if (HLGKyrdafUQHhqdCIWgbSLWXcXmr != null)
			{
				float num = this.value;
				if (num != valuePrev)
				{
					HLGKyrdafUQHhqdCIWgbSLWXcXmr(num);
				}
			}
			if (FKUqUakHpdTSgRMvZRtUdFIMrlSA != null)
			{
				bool flag = rawButtonValue;
				if (flag != rawButtonValuePrev)
				{
					FKUqUakHpdTSgRMvZRtUdFIMrlSA(flag);
				}
			}
			if (MRyeeWMdbuxGaqXXEIqTolpmkfxc != null && rawButtonValue && !rawButtonValuePrev)
			{
				MRyeeWMdbuxGaqXXEIqTolpmkfxc();
			}
			if (HmjfsserMRiombxAoFCsEPMuodryA != null && !rawButtonValue && rawButtonValuePrev)
			{
				HmjfsserMRiombxAoFCsEPMuodryA();
			}
			if (AkceaWMYCeXPJFaxFGzyTaxnqDqA != null)
			{
				bool flag2 = buttonValue;
				if (flag2 != buttonValuePrev)
				{
					AkceaWMYCeXPJFaxFGzyTaxnqDqA(flag2);
				}
			}
			if (gAgpMStGFovyDpFwRgYebDIMuEuWA != null && buttonValue && !buttonValuePrev)
			{
				gAgpMStGFovyDpFwRgYebDIMuEuWA();
			}
			if (SCJNWFEwnmGRZnuaqVAEXQKeraEo != null && !buttonValue && buttonValuePrev)
			{
				SCJNWFEwnmGRZnuaqVAEXQKeraEo();
			}
		}
