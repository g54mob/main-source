...
namespace Rewired
{
	...
	internal class HardwareControllerMap_Game
	{
			...
			: this(P_0)
		{
			...
			for (int k = 0; k < num; k++)
			{
				int num5 = nzzpPyVzWZzjGniOjGQKoNfbSbrM(P_1, P_2[k]);
				if (num5 < 0)
				{
			...
			{
				int num6 = nzzpPyVzWZzjGniOjGQKoNfbSbrM(P_1, P_3[l]);
				if (num6 < 0)
				{
					Logger.LogError("Invalid hardware element identifier id!");
				}
			...
			{
				int num7 = nzzpPyVzWZzjGniOjGQKoNfbSbrM(P_1, array[m]);
				if (num7 < 0)
				{
					Logger.LogError("Invalid hardware element identifier id!");
				}
			...
			{
				int num8 = nzzpPyVzWZzjGniOjGQKoNfbSbrM(P_1, array2[n]);
				if (num8 < 0)
				{
					Logger.LogError("Invalid hardware element identifier id!");
				}
