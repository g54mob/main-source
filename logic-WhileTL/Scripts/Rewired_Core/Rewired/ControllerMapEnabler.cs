...
namespace Rewired
{
	public sealed class ControllerMapEnabler
	{
		...
		public sealed class Rule : IDeepCloneable
		{
			...
			{
				if (_controllerSetSelector != null && !_controllerSetSelector.HRCOHrbICjYrmPufacvtvotxDTAp)
				{
		...
		internal class bfKxbNaTbdokMFkgReyogCBTNRVl
		{
			...
			public bfKxbNaTbdokMFkgReyogCBTNRVl(bool P_0, qmEcFrQmpjkfExHMGEuMliRmNVKH[] P_1)
			{
				...
				zcqaKwvyXhAGLtSnQTXsWmqKHjoD = P_1;
			}
		}
		...
		public void LoadDefaults()
		{
			...
			for (int i = 0; i < num; i++)
			{
				RuleSet controllerMapEnablerRuleSetInstance = ReInput.mapping.GetControllerMapEnablerRuleSetInstance(MhmCTAhiehkWjtxhLprkaiHIUdqTA.zcqaKwvyXhAGLtSnQTXsWmqKHjoD[i].ZamYCQxLHAGKChjEHxjlKOSnIhez);
				...
				controllerMapEnablerRuleSetInstance.enabled = MhmCTAhiehkWjtxhLprkaiHIUdqTA.zcqaKwvyXhAGLtSnQTXsWmqKHjoD[i].qrFAJzEnuAtGtkafVRuztFxWFLWaA;
