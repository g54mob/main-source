...
namespace Rewired
{
	...
	public sealed class AxisCalibration
	{
		...
		{
			0,
			AxisCalibrationInfo.lXFLkLZZxnwQOoaRYiDBbNEXjuCJ(AxisCalibrationData.Default)
		} };
		...
		private void CreateDefaultHardwareCalibration(AxisCalibrationData defaultData)
		{
			...
			{
				AxisCalibrationInfo value = AxisCalibrationInfo.lXFLkLZZxnwQOoaRYiDBbNEXjuCJ(defaultData);
