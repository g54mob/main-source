internal class ginnqTEfOGlVOxHMeZrVXOGhGSCb
{
	public static class UOmnJKATCyckujnQYJpikWoeriwP
	{
		public enum IWsDMhAKVDLzBUQMfLeoICluXkDo : ushort
		{
			Undefined = 0,
			Pointer = 1,
			Mouse = 2,
		...
		public static bool otKYAMVFCxQOzGRdAvmWPFZxgQto(ushort P_0)
		{
		...
		public static bool vwzmsbbtfvtOToGwoXbIjngkFUFFA(ushort P_0)
		{
			if (P_0 < 48 || P_0 > 70)
			{
				return false;
		...
		public static bool gZQQlKCPHjSibjhmhltVGoWNafUCA(ushort P_0)
		{
			if (P_0 < 61 || P_0 > 147)
			{
				return false;
	...
	public static class mUDXtguuCVKuiTtiyDEvtqvKlUlI
	{
		public enum ofstInYhAXqOqWmJYGIMKwQoBMIS : ushort
		{
			Aileron = 176,
			AileronTrim = 177,
	...
	public static class dqJsamhgnWcrUyCtLjXHfGrHSTy
	{
		public enum bWVWhEjLpUjaqyDSQIZdeKGtlUZv : ushort
		{
			ConsumerControl = 1,
			NumericKeyPad = 2,
	...
	public static class CdDyMnvpFjAuubQRzmLFXQmSisVJA
	{
		public enum cxsrBgdKcWIpfVcccKVuMIdpAKex : ushort
		{
			_3DGameController = 1,
			PinballDevice = 2,
			GunDevice = 3,
	...
	public const ushort tLhSVQDegRLzSFDlBUaVbjidssbL = 1;

	public const ushort IODrvtbpwkBLwOLAjKTQpRZAvdtA = 2;

	public const ushort fkhPanncRYAlTUgZhNvkxPSmBhpT = 5;

	public const ushort SBiTIRfHNotkexKmfGfIeKgBTyDY = 9;

	public const ushort nttTuDHKDZYuRFmtcjDZDFUCmbb = 12;

	public static bool vwzmsbbtfvtOToGwoXbIjngkFUFFA(ushort P_0, ushort P_1)
	{
		return P_0 switch
		{
			1 => UOmnJKATCyckujnQYJpikWoeriwP.vwzmsbbtfvtOToGwoXbIjngkFUFFA(P_1), 
			2 => mUDXtguuCVKuiTtiyDEvtqvKlUlI.vwzmsbbtfvtOToGwoXbIjngkFUFFA(P_1), 
			5 => CdDyMnvpFjAuubQRzmLFXQmSisVJA.vwzmsbbtfvtOToGwoXbIjngkFUFFA(P_1), 
			12 => dqJsamhgnWcrUyCtLjXHfGrHSTy.vwzmsbbtfvtOToGwoXbIjngkFUFFA(P_1), 
			_ => false, 
		};
	}

	public static bool ykjKnNYZdVUifmtSiSMenyWtIppX(ushort P_0, ushort P_1)
	{
		if (!vwzmsbbtfvtOToGwoXbIjngkFUFFA(P_0, P_1))
		{
			return gZQQlKCPHjSibjhmhltVGoWNafUCA(P_0, P_1);
		}
		return true;
	}

	public static bool gZQQlKCPHjSibjhmhltVGoWNafUCA(ushort P_0, ushort P_1)
	{
		return P_0 switch
		{
			1 => UOmnJKATCyckujnQYJpikWoeriwP.gZQQlKCPHjSibjhmhltVGoWNafUCA(P_1), 
			2 => mUDXtguuCVKuiTtiyDEvtqvKlUlI.gZQQlKCPHjSibjhmhltVGoWNafUCA(P_1), 
			5 => CdDyMnvpFjAuubQRzmLFXQmSisVJA.gZQQlKCPHjSibjhmhltVGoWNafUCA(P_1), 
			9 => true, 
			12 => dqJsamhgnWcrUyCtLjXHfGrHSTy.gZQQlKCPHjSibjhmhltVGoWNafUCA(P_1), 
			_ => false, 
		};
	}

	public static bool wSliKgQwHOVDWiPeQjaQgGkWFxxf(ushort P_0)
	{
		if (!kwddkDCboKsRpQpdFfOXPjjLzVegA(P_0))
		{
			return WGCKkWQWKHjFkWQvgxDxckKACdti(P_0);
		}
		return true;
	}

	public static bool kwddkDCboKsRpQpdFfOXPjjLzVegA(ushort P_0)
	{
	...
	public static bool WGCKkWQWKHjFkWQvgxDxckKACdti(ushort P_0)
	{
	...
	public static bool ykEnxDBGQKNblgKvGPPcfnlAuAeq(ushort P_0, ushort P_1)
	{
		if (P_0 != 1)
		{
			return false;
