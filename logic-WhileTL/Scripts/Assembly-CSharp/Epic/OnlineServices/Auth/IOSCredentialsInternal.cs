...
namespace Epic.OnlineServices.Auth
{
	...
	internal struct IOSCredentialsInternal : ISettable, IDisposable
	{
		...
		public IOSCredentialsSystemAuthCredentialsOptions SystemAuthCredentialsOptions
		{
			get
			{
				Helper.TryMarshalGet<IOSCredentialsSystemAuthCredentialsOptionsInternal, IOSCredentialsSystemAuthCredentialsOptions>(m_SystemAuthCredentialsOptions, out var target);
				return target;
			}
			set
			{
