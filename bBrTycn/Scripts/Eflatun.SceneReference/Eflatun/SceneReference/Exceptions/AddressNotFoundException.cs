...
namespace Eflatun.SceneReference.Exceptions
{
	...
	public class AddressNotFoundException : SceneReferenceException
	{
		...
		internal AddressNotFoundException(string address)
			: base(MakeExceptionMessage(address))
		{
		}

		internal AddressNotFoundException(string address, Exception inner)
			: base(MakeExceptionMessage(address), inner)
		{
		}

		private protected AddressNotFoundException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
	}
