	...
	public class ChartLabel : Image
	{
		...
		internal RectTransform objectRect
		{
			get
			{
				...
				{
					m_ObjectRect = base.gameObject.GetComponent<RectTransform>();
				}
				return m_ObjectRect;
			}
		}
		...
		public void UpdateIcon(IconStyle iconStyle, Sprite sprite = null, Color color = default(Color))
		{
			...
			if (iconStyle.show)
			{
				...
				{
					m_IconRect.SetSiblingIndex(base.transform.childCount - 1);
				}
			}
		}
		...
		{
			base.transform.localEulerAngles = new Vector3(0f, 0f, rotate);
		}
		...
		public void SetTextRotate(float rotate)
		{
			if (m_LabelText != null)
			{
				m_LabelText.SetLocalEulerAngles(new Vector3(0f, 0f, rotate));
			}
		}
		...
		{
			m_Active = flag;
			ChartHelper.SetActive(base.gameObject, flag);
		}
		...
		public bool SetText(string text)
		{
			...
			if (!m_LabelText.GetText().Equals(text))
			{
				...
				if (m_AutoSize)
				{
					Vector2 sizeDelta = (string.IsNullOrEmpty(text) ? Vector2.zero : new Vector2(m_LabelText.GetPreferredWidth(), m_LabelText.GetPreferredHeight()));
					bool num = sizeDelta.x != m_TextRect.sizeDelta.x || sizeDelta.y != m_TextRect.sizeDelta.y;
					m_Width = sizeDelta.x;
					m_Height = sizeDelta.y;
					if (num)
					{
		...
		private void UpdateSize()
		{
			if (m_AutoSize)
			{
				Vector2 sizeDelta = m_TextRect.sizeDelta;
		...
		private void UpdatePadding()
		{
			if (!(m_TextRect == null))
			{
				...
				case TextAnchor.UpperLeft:
					m_TextRect.anchoredPosition = new Vector2(m_PaddingLeft, 0f - m_PaddingTop);
					break;
				case TextAnchor.MiddleLeft:
					m_TextRect.anchoredPosition = new Vector2(m_PaddingLeft, m_Height / 2f - m_PaddingTop - m_TextRect.sizeDelta.y / 2f);
					break;
				case TextAnchor.LowerRight:
					m_TextRect.anchoredPosition = new Vector2(0f - m_PaddingRight, m_PaddingBottom);
					break;
				case TextAnchor.UpperRight:
					m_TextRect.anchoredPosition = new Vector2(0f - m_PaddingRight, 0f - m_PaddingTop);
					break;
				case TextAnchor.MiddleRight:
					m_TextRect.anchoredPosition = new Vector2(0f - m_PaddingRight, m_Height / 2f - m_PaddingTop - m_TextRect.sizeDelta.y / 2f);
					break;
				case TextAnchor.LowerCenter:
					m_TextRect.anchoredPosition = new Vector2(0f - (m_Width / 2f - m_PaddingLeft - m_TextRect.sizeDelta.x / 2f), m_PaddingBottom);
					break;
				case TextAnchor.UpperCenter:
					m_TextRect.anchoredPosition = new Vector2(0f - (m_Width / 2f - m_PaddingLeft - m_TextRect.sizeDelta.x / 2f), 0f - m_PaddingTop);
					break;
				case TextAnchor.MiddleCenter:
					m_TextRect.anchoredPosition = new Vector2(0f - (m_Width / 2f - m_PaddingLeft - m_TextRect.sizeDelta.x / 2f), m_Height / 2f - m_PaddingTop - m_TextRect.sizeDelta.y / 2f);
					break;
				}
			}
		}
		...
		private void AdjustIconPos()
		{
			...
			case Align.Left:
				...
				case TextAnchor.MiddleLeft:
				case TextAnchor.LowerLeft:
					x = (0f - m_TextRect.sizeDelta.x) / 2f - m_IconRect.sizeDelta.x / 2f;
					break;
				case TextAnchor.UpperRight:
				case TextAnchor.MiddleRight:
				case TextAnchor.LowerRight:
					x = m_TextRect.sizeDelta.x / 2f - m_LabelText.GetPreferredWidth() - m_IconRect.sizeDelta.x / 2f;
					break;
				case TextAnchor.UpperCenter:
				case TextAnchor.MiddleCenter:
				case TextAnchor.LowerCenter:
					x = (0f - m_LabelText.GetPreferredWidth()) / 2f - m_IconRect.sizeDelta.x / 2f;
					break;
				}
				break;
			case Align.Right:
				...
				case TextAnchor.MiddleLeft:
				case TextAnchor.LowerLeft:
					x = m_TextRect.sizeDelta.x / 2f + m_IconRect.sizeDelta.x / 2f;
					break;
				case TextAnchor.UpperRight:
				case TextAnchor.MiddleRight:
				case TextAnchor.LowerRight:
					x = m_IconRect.sizeDelta.x / 2f;
					break;
				case TextAnchor.UpperCenter:
				case TextAnchor.MiddleCenter:
				case TextAnchor.LowerCenter:
					x = m_LabelText.GetPreferredWidth() / 2f + m_IconRect.sizeDelta.x / 2f;
					break;
				}
				break;
			}
			m_IconRect.anchoredPosition = m_IconOffest + new Vector3(x, 0f);
		}
	}
}
