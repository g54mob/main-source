...
{
	[Serializable]
	internal sealed class ContextualActionPickUpItem : ContextualAction<Item>
	{
		private AgentActionPickUpItem _action;

		public override void Setup()
		{
			_action = new AgentActionPickUpItem(contextActor);
		}
