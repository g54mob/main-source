...
{
	[Serializable]
	public class BBTGranitasQualityProductionGoal : BBTGoal<GranitasQualityProductionGoal>
	{
		[SerializeField]
		[VariablePopup(false)]
		...
		{
			Goal = new GranitasQualityProductionGoal(Quest, Entry, Variable, Target, _targetQuality);
		}
	}
}
