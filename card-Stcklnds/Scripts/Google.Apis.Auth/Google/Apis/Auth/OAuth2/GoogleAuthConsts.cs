...
namespace Google.Apis.Auth.OAuth2
{
	public static class GoogleAuthConsts
	{
		...
		internal static readonly string IamAccessTokenEndpointFormatString = "https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/{0}:generateAccessToken";

		internal static readonly string IamSignEndpointFormatString = "https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/{0}:signBlob";

		internal static readonly string IamIdTokenEndpointFormatString = "https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/{0}:generateIdToken";
