...
namespace UnityWebSocketSharp.Net
{
	internal static class HttpUtility
	{
		...
		public static string HtmlAttributeEncode(string s)
		{
			...
			return htmlEncode(s, minimal: true);
		}
		...
		public static string HtmlEncode(string s)
		{
			...
			return htmlEncode(s, minimal: false);
		}
		...
		public static string UrlDecode(byte[] bytes, Encoding encoding)
		{
			...
			return (encoding ?? Encoding.UTF8).GetString(urlDecodeToBytes(bytes, 0, num));
		}
		...
		public static string UrlDecode(byte[] bytes, int offset, int count, Encoding encoding)
		{
			...
			return (encoding ?? Encoding.UTF8).GetString(urlDecodeToBytes(bytes, offset, count));
		}
		...
		public static byte[] UrlDecodeToBytes(byte[] bytes)
		{
			...
			return urlDecodeToBytes(bytes, 0, num);
		}
		...
		public static byte[] UrlDecodeToBytes(byte[] bytes, int offset, int count)
		{
			...
			return urlDecodeToBytes(bytes, offset, count);
		}
		...
		public static string UrlEncode(byte[] bytes)
		{
			...
			return Encoding.ASCII.GetString(urlEncodeToBytes(bytes, 0, num));
		}
		...
		public static byte[] UrlEncodeToBytes(byte[] bytes)
		{
			...
			return urlEncodeToBytes(bytes, 0, num);
		}
