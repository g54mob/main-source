...
namespace MoreMountains.Feedbacks
{
	...
	public class MMAudioFilterDistortionShaker : MMShaker
	{
		...
		{
			base.Initialization();
			_targetAudioDistortionFilter = base.gameObject.GetComponent<AudioDistortionFilter>();
		}
		...
		{
			float distortionLevel = ShakeFloat(ShakeDistortion, RemapDistortionZero, RemapDistortionOne, RelativeDistortion, _initialDistortion);
			_targetAudioDistortionFilter.distortionLevel = distortionLevel;
		}
