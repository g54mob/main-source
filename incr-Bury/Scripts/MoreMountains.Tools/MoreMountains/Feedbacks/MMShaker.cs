...
namespace MoreMountains.Feedbacks
{
	public class MMShaker : MMMonoBehaviour
	{
		...
		protected float _shakeStartedTimestampUnscaled = float.MinValue;
		...
		public virtual bool InCooldown
		{
			get
			{
				float num = ((TimescaleMode == TimescaleModes.Scaled) ? _shakeStartedTimestamp : _shakeStartedTimestampUnscaled);
				GetTime();
				return GetTime() - num < CooldownBetweenShakes;
			}
		}
