...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMSpriteRendererShakeEvent
	{
		...
		{
			MMSpriteRendererShakeEvent.OnEvent = null;
		}
		...
		{
			MMSpriteRendererShakeEvent.OnEvent?.Invoke(shakeDuration, modifyColor, colorOverTime, flipX, flipY, feedbacksIntensity, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, useRange, eventRange, eventOriginPosition);
		}
	}
}
