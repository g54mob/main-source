...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_TimescaleModifier : MMF_Feedback
	{
		...
		[Tooltip("in Duration mode, the curve to use to lerp the timescale")]
		public MMTweenType TimescaleLerpCurveOnReset = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(1f, 1f)), "", "TimescaleLerpMode", 1);
		...
		public override void OnValidate()
		{
			...
			if (!TimescaleLerpCurve.EnumConditions[1])
			{
				...
				TimescaleLerpCurveOnReset.EnumConditions[1] = true;
			}
		}
	}
}
