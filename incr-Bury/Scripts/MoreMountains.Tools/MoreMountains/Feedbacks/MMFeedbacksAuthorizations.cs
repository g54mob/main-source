...
namespace MoreMountains.Feedbacks
{
	public class MMFeedbacksAuthorizations : MMMonoBehaviour
	{
		...
		private void Start()
		{
			...
			MMF_FeedbackBase.FeedbackTypeAuthorized = Broadcast;
			...
			MMF_Pause.FeedbackTypeAuthorized = Looper;
			MMF_Pause.FeedbackTypeAuthorized = LooperStart;
			...
			MMF_Pause.FeedbackTypeAuthorized = HoldingPause;
			...
			MMF_FeedbackBase.FeedbackTypeAuthorized = CanvasGroup;
			...
			MMF_FeedbackBase.FeedbackTypeAuthorized = RectTransformAnchor;
			MMF_FeedbackBase.FeedbackTypeAuthorized = RectTransformOffset;
			MMF_FeedbackBase.FeedbackTypeAuthorized = RectTransformPivot;
			MMF_FeedbackBase.FeedbackTypeAuthorized = RectTransformSizeDelta;
			...
			MMF_FeedbackBase.FeedbackTypeAuthorized = TextFontSize;
			...
			MMF_FeedbackBase.FeedbackTypeAuthorized = TMPCharacterSpacing;
			...
			MMF_FeedbackBase.FeedbackTypeAuthorized = TMPFontSize;
			MMF_FeedbackBase.FeedbackTypeAuthorized = TMPLineSpacing;
			MMF_TMPOutlineColor.FeedbackTypeAuthorized = TMPOutlineColor;
			MMF_FeedbackBase.FeedbackTypeAuthorized = TMPOutlineWidth;
			MMF_FeedbackBase.FeedbackTypeAuthorized = TMPParagraphSpacing;
