	...
	public class MMF_CanvasGroup : MMF_FeedbackBase
	{
		...
		protected override void FillTargets()
		{
			if (!(TargetCanvasGroup == null))
			{
				...
				mMF_FeedbackBaseTarget.LevelCurve = AlphaCurve;
				mMF_FeedbackBaseTarget.RemapLevelZero = RemapZero;
				mMF_FeedbackBaseTarget.RemapLevelOne = RemapOne;
				mMF_FeedbackBaseTarget.InstantLevel = InstantAlpha;
				mMF_FeedbackBaseTarget.ToDestinationLevel = DestinationAlpha;
