...
namespace MoreMountains.Feedbacks
{
	public class MMFloatingTextSpawner : MMMonoBehaviour
	{
		...
		public virtual void Spawn(string value, Vector3 position, Vector3 direction, float intensity = 1f, bool forceLifetime = false, float lifetime = 1f, bool forceColor = false, Gradient animateColorGradient = null, Transform attachmentTransform = null)
		{
			if (CanSpawn)
			{
		...
		public virtual void OnMMFloatingTextSpawnEvent(MMChannelData channelData, Vector3 spawnPosition, string value, Vector3 direction, float intensity, bool forceLifetime = false, float lifetime = 1f, bool forceColor = false, Gradient animateColorGradient = null, bool useUnscaledTime = false, Transform attachmentTransform = null)
		{
