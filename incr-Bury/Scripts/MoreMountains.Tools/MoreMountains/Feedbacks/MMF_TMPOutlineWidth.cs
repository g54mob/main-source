...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_TMPOutlineWidth : MMF_FeedbackBase
	{
		...
		public MMTweenType OutlineWidthCurve = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f)), "", "");
		...
		protected override void FillTargets()
		{
			if (!(TargetTMPText == null))
			{
				...
				mMPropertyReceiver.TargetPropertyName = "outlineWidth";
				mMPropertyReceiver.RelativeValue = RelativeValues;
				mMF_FeedbackBaseTarget.Target = mMPropertyReceiver;
				mMF_FeedbackBaseTarget.LevelCurve = OutlineWidthCurve;
				mMF_FeedbackBaseTarget.RemapLevelZero = RemapZero;
				mMF_FeedbackBaseTarget.RemapLevelOne = RemapOne;
				mMF_FeedbackBaseTarget.InstantLevel = InstantOutlineWidth;
				mMF_FeedbackBaseTarget.ToDestinationLevel = DestinationOutlineWidth;
