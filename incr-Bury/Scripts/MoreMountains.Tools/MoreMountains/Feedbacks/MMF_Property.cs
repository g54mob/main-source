...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_Property : MMF_Feedback
	{
		...
		public MMTweenType LevelCurve = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f)), "", "Mode", 0, 2);
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1f)
		{
			...
			case Modes.Instant:
			{
				float level = (NormalPlayDirection ? InstantLevel : _initialIntensity);
		...
		public override void OnValidate()
		{
			...
			if (string.IsNullOrEmpty(LevelCurve.EnumConditionPropertyName))
			{
				...
				LevelCurve.EnumConditions[0] = true;
				LevelCurve.EnumConditions[2] = true;
			}
		}
	}
}
