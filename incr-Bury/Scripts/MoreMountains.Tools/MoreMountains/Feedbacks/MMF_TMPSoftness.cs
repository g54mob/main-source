...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_TMPSoftness : MMF_Feedback
	{
		...
		public MMTweenType SoftnessCurve = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f)), "", "Mode", default(int));
		...
		{
			if (TargetTMPText == null || !Active || !FeedbackTypeAuthorized)
			{
				return;
			}
			switch (Mode)
		...
		public override void OnValidate()
		{
			...
			if (string.IsNullOrEmpty(SoftnessCurve.EnumConditionPropertyName))
			{
				...
				SoftnessCurve.EnumConditions[0] = true;
			}
		}
	}
}
