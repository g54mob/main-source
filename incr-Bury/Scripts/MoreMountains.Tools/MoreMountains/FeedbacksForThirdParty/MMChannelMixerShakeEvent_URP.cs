...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMChannelMixerShakeEvent_URP
	{
		...
		{
			MMChannelMixerShakeEvent_URP.OnEvent = null;
		}
		...
		{
			MMChannelMixerShakeEvent_URP.OnEvent?.Invoke(shakeRed, remapRedZero, remapRedOne, shakeGreen, remapGreenZero, remapGreenOne, shakeBlue, remapBlueZero, remapBlueOne, duration, relativeValues, attenuation, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
