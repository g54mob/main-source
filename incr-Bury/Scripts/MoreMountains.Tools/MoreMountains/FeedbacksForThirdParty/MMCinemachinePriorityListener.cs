...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public class MMCinemachinePriorityListener : MonoBehaviour
	{
		...
		{
			StartCoroutine(OnMMCinemachinePriorityEventCo(channelData, forceMaxPriority, newPriority, forceTransition, blendDefinition, resetValuesAfterTransition, timescaleMode, restore));
		}
