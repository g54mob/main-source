...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMLensDistortionShakeEvent_HDRP
	{
		...
		{
			MMLensDistortionShakeEvent_HDRP.OnEvent = null;
		}
		...
		{
			MMLensDistortionShakeEvent_HDRP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
