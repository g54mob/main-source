...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMBloomShakeEvent_HDRP
	{
		...
		{
			MMBloomShakeEvent_HDRP.OnEvent = null;
		}
		...
		{
			MMBloomShakeEvent_HDRP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, threshold, remapThresholdMin, remapThresholdMax, relativeIntensity, attenuation, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
