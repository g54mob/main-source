...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMMotionBlurShakeEvent_HDRP
	{
		...
		{
			MMMotionBlurShakeEvent_HDRP.OnEvent = null;
		}
		...
		{
			MMMotionBlurShakeEvent_HDRP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
