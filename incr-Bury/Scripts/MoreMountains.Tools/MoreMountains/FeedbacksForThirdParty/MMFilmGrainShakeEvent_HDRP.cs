...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMFilmGrainShakeEvent_HDRP
	{
		...
		{
			MMFilmGrainShakeEvent_HDRP.OnEvent = null;
		}
		...
		{
			MMFilmGrainShakeEvent_HDRP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
