...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMChromaticAberrationShakeEvent_HDRP
	{
		...
		{
			MMChromaticAberrationShakeEvent_HDRP.OnEvent = null;
		}
		...
		{
			MMChromaticAberrationShakeEvent_HDRP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channelData, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore);
		}
	}
}
