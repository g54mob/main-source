...
namespace MoreMountains.Tools
{
	public class MMControlsTestInputManager : MonoBehaviour, MMEventListener<MMSwipeEvent>, MMEventListenerBase
	{
		...
		{
			MMDebug.DebugOnScreen("Follower joystick", movement);
		}
		...
		{
			Debug.LogFormat("On drag");
		}

		public virtual void StickPointerUp()
		{
			Debug.LogFormat("On pointer up");
		}

		public virtual void StickPointerDown()
		{
			Debug.LogFormat("On pointer down");
		}
		...
		public virtual void OnMMEvent(MMSwipeEvent swipeEvent)
		{
			...
			Vector2 swipeOrigin = swipeEvent.SwipeOrigin;
			string text = swipeOrigin.ToString();
			swipeOrigin = swipeEvent.SwipeDestination;
			Debug.LogFormat("Swipe origin : " + text + ", swipe end : " + swipeOrigin.ToString());
