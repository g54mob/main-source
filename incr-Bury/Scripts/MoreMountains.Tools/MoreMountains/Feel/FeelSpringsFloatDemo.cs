...
namespace MoreMountains.Feel
{
	...
	public class FeelSpringsFloatDemo : MonoBehaviour
	{
		...
		{
			FloatSpring.MoveTo(Random.Range(-1f, 1f));
		}

		public virtual void RandomBump()
		{
			float value = BumpAmountSlider.value;
			FloatSpring.BumpRandom(0f - value, value);
		}
		...
		protected virtual void Update()
		{
			...
			_newPosition.x = MMMaths.Remap(FloatSpring.CurrentValue, -1f, 1f, 0f - _range, _range);
