	...
	public class SplineProjector : SplineTracer
	{
		...
		protected override void OnSplineChanged()
		{
			if (base.spline != null)
			{
				if (_mode == Mode.Accurate)
				{
					base.spline.Project(_projectTarget.position, ref _result, base.clipFrom, base.clipTo, SplineComputer.EvaluateMode.Calculate, subdivide);
				}
				else
				{
					base.spline.Project(_projectTarget.position, ref _result, base.clipFrom, base.clipTo);
				}
