...
namespace UnluckSoftware
{
	public class ParticleSpawner : MonoBehaviour
	{
		...
		{
			Object.Instantiate(currentGO, currentGO.transform.position, currentGO.transform.rotation);
		}

		public void DestroyAll()
		{
			ParticleSystem[] array = (ParticleSystem[])Object.FindObjectsOfType(typeof(ParticleSystem));
		...
		public void OnGUI()
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				{
					DestroyAll();
					GameObject gameObject = Object.Instantiate(particles[i + page * maxButtons]);
		...
		public void ReplaceGO(GameObject _go)
		{
			...
			GameObject gameObject = Object.Instantiate(_go);
			currentGO = gameObject;
		}
