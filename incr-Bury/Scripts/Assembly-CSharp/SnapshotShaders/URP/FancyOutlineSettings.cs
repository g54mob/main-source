...
namespace SnapshotShaders.URP
{
	...
	public sealed class FancyOutlineSettings : VolumeComponent, IPostProcessComponent
	{
		...
		public ColorParameter outlineColor = new ColorParameter(Color.white, hdr: true, showAlpha: true, showEyeDropper: true);

		[Tooltip("Threshold for colour-based edge detection.")]
		public ClampedFloatParameter colorSensitivity = new ClampedFloatParameter(0.1f, 0f, 1f);

		[Tooltip("Strength of colour-based edges.")]
		public ClampedFloatParameter colorStrength = new ClampedFloatParameter(0.5f, 0f, 1f);

		[Tooltip("Threshold for depth-based edge detection.")]
		public ClampedFloatParameter depthSensitivity = new ClampedFloatParameter(0.01f, 0f, 1f);

		[Tooltip("Strength of depth-based edges.")]
		public ClampedFloatParameter depthStrength = new ClampedFloatParameter(0.75f, 0f, 1f);

		[Tooltip("Threshold for normal-based edge detection.")]
		public ClampedFloatParameter normalSensitivity = new ClampedFloatParameter(0.1f, 0f, 1f);

		[Tooltip("Strength of normal-based edges.")]
		public ClampedFloatParameter normalStrength = new ClampedFloatParameter(0.75f, 0f, 1f);

		[Tooltip("Pixels past this depth threshold will not be edge-detected.")]
		public ClampedFloatParameter depthThreshold = new ClampedFloatParameter(0.99f, 0f, 1f);
		...
		{
			base.displayName = "Fancy Outline";
		}
