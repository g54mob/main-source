...
{
	[Serializable]
	[VolumeComponentMenu("Snapshot Shaders Pro/Fancy Neon")]
	public sealed class FancyNeonSettings : VolumeComponent, IPostProcessComponent
	{
		...
		public ColorParameter emissiveEdgeColor = new ColorParameter(Color.white, hdr: true, showAlpha: true, showEyeDropper: true);
