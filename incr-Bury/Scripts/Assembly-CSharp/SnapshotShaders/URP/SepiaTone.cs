...
namespace SnapshotShaders.URP
{
	...
	{
		private class SepiaToneRenderPass : ScriptableRenderPass
		{
			...
			{
				base.profilingSampler = new ProfilingSampler("SepiaTone");
				base.requiresIntermediateTexture = true;
			}

			private void CreateMaterial()
			{
				Shader shader = Shader.Find("SnapshotProURP/SepiaTone");
				if (shader == null)
				{
			...
			public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
			{
				if (!renderingData.cameraData.isPreviewCamera)
				{
					...
					SepiaToneSettings component = VolumeManager.instance.stack.GetComponent<SepiaToneSettings>();
			...
			public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
			{
				...
				nullHandle = UniversalRenderer.CreateRenderGraphTexture(renderGraph, copyPassDescriptor, "_SepiaToneColorCopy", clear: false);
				CopyPassData passData;
				using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<CopyPassData>("SepiaTone_CopyColor", out passData, base.profilingSampler, "C:\\Users\\Trevo\\OneDrive\\Documents\\BerryBarry_Repo\\Assets\\Snapshot Shaders Pro\\URP\\Scripts\\SepiaTone.cs", 166))
				{
				...
				using IRasterRenderGraphBuilder rasterRenderGraphBuilder2 = renderGraph.AddRasterRenderPass<MainPassData>("SepiaTone_MainPass", out passData2, base.profilingSampler, "C:\\Users\\Trevo\\OneDrive\\Documents\\BerryBarry_Repo\\Assets\\Snapshot Shaders Pro\\URP\\Scripts\\SepiaTone.cs", 176);
		...
		private SepiaToneRenderPass pass;

		public override void Create()
		{
			pass = new SepiaToneRenderPass();
			base.name = "Sepia Tone";
		}
