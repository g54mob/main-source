...
namespace SnapshotShaders.URP
{
	...
	{
		private class ScanlinesRenderPass : ScriptableRenderPass
		{
			...
			{
				base.profilingSampler = new ProfilingSampler("Scanlines");
				base.requiresIntermediateTexture = true;
			}

			private void CreateMaterial()
			{
				Shader shader = Shader.Find("SnapshotProURP/Scanlines");
				if (shader == null)
				{
			...
			public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
			{
				if (!renderingData.cameraData.isPreviewCamera)
				{
					...
					ScanlinesSettings component = VolumeManager.instance.stack.GetComponent<ScanlinesSettings>();
					base.renderPassEvent = component.renderPassEvent.value;
					material.SetTexture("_ScanlineTex", component.scanlineTex.value);
					material.SetFloat("_Strength", component.strength.value);
					material.SetInt("_Size", component.size.value);
			...
			public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
			{
				...
				nullHandle = UniversalRenderer.CreateRenderGraphTexture(renderGraph, copyPassDescriptor, "_ScanlinesColorCopy", clear: false);
				CopyPassData passData;
				using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<CopyPassData>("Scanlines_CopyColor", out passData, base.profilingSampler, "C:\\Users\\Trevo\\OneDrive\\Documents\\BerryBarry_Repo\\Assets\\Snapshot Shaders Pro\\URP\\Scripts\\Scanlines.cs", 172))
				{
				...
				using IRasterRenderGraphBuilder rasterRenderGraphBuilder2 = renderGraph.AddRasterRenderPass<MainPassData>("Scanlines_MainPass", out passData2, base.profilingSampler, "C:\\Users\\Trevo\\OneDrive\\Documents\\BerryBarry_Repo\\Assets\\Snapshot Shaders Pro\\URP\\Scripts\\Scanlines.cs", 182);
		...
		private ScanlinesRenderPass pass;
