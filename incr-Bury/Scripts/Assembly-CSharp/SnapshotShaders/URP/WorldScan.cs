...
namespace SnapshotShaders.URP
{
	public class WorldScan : ScriptableRendererFeature
	{
		private class WorldScanRenderPass : ScriptableRenderPass
		{
			...
			{
				base.profilingSampler = new ProfilingSampler("WorldScan");
				base.requiresIntermediateTexture = true;
			}

			private void CreateMaterial()
			{
				Shader shader = Shader.Find("SnapshotProURP/WorldScan");
				if (shader == null)
				{
			...
			public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
			{
				if (!renderingData.cameraData.isPreviewCamera)
				{
					...
					WorldScanSettings component = VolumeManager.instance.stack.GetComponent<WorldScanSettings>();
					base.renderPassEvent = component.renderPassEvent.value;
					material.SetVector("_ScanOrigin", component.scanOrigin.value);
					material.SetFloat("_ScanDist", component.scanDistance.value);
					material.SetFloat("_ScanWidth", component.scanWidth.value);
					material.SetTexture("_OverlayRampTex", component.overlayRampTex.value);
			...
			public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
			{
				...
				nullHandle = UniversalRenderer.CreateRenderGraphTexture(renderGraph, copyPassDescriptor, "_WorldScanColorCopy", clear: false);
				CopyPassData passData;
				using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<CopyPassData>("WorldScan_CopyColor", out passData, base.profilingSampler, "C:\\Users\\Trevo\\OneDrive\\Documents\\BerryBarry_Repo\\Assets\\Snapshot Shaders Pro\\URP\\Scripts\\WorldScan.cs", 175))
				{
				...
				using IRasterRenderGraphBuilder rasterRenderGraphBuilder2 = renderGraph.AddRasterRenderPass<MainPassData>("WorldScan_MainPass", out passData2, base.profilingSampler, "C:\\Users\\Trevo\\OneDrive\\Documents\\BerryBarry_Repo\\Assets\\Snapshot Shaders Pro\\URP\\Scripts\\WorldScan.cs", 185);
