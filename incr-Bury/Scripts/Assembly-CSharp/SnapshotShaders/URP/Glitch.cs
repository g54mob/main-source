...
namespace SnapshotShaders.URP
{
	public class Glitch : ScriptableRendererFeature
	{
		private class GlitchRenderPass : ScriptableRenderPass
		{
			...
			{
				base.profilingSampler = new ProfilingSampler("Glitch");
				base.requiresIntermediateTexture = true;
			}

			private void CreateMaterial()
			{
				Shader shader = Shader.Find("SnapshotProURP/Glitch");
				if (shader == null)
				{
			...
			public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
			{
				if (!renderingData.cameraData.isPreviewCamera)
				{
					...
					GlitchSettings component = VolumeManager.instance.stack.GetComponent<GlitchSettings>();
					base.renderPassEvent = component.renderPassEvent.value;
					material.SetTexture("_OffsetTex", component.offsetTexture.value);
					material.SetFloat("_OffsetStrength", component.offsetStrength.value);
					material.SetFloat("_VerticalTiling", component.verticalTiling.value);
			...
			public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
			{
				...
				nullHandle = UniversalRenderer.CreateRenderGraphTexture(renderGraph, copyPassDescriptor, "_GlitchColorCopy", clear: false);
				CopyPassData passData;
				using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<CopyPassData>("Glitch_CopyColor", out passData, base.profilingSampler, "C:\\Users\\Trevo\\OneDrive\\Documents\\BerryBarry_Repo\\Assets\\Snapshot Shaders Pro\\URP\\Scripts\\Glitch.cs", 170))
				{
				...
				using IRasterRenderGraphBuilder rasterRenderGraphBuilder2 = renderGraph.AddRasterRenderPass<MainPassData>("Glitch_MainPass", out passData2, base.profilingSampler, "C:\\Users\\Trevo\\OneDrive\\Documents\\BerryBarry_Repo\\Assets\\Snapshot Shaders Pro\\URP\\Scripts\\Glitch.cs", 180);
