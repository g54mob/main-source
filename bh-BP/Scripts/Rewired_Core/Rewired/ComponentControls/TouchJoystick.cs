...
namespace Rewired.ComponentControls
{
	...
	public sealed class TouchJoystick : TouchInteractable
	{
		...
		{
			public static readonly OjoeFRcnkovVlsPiLQHEdwWfAMgxA _003C_003E9;
		...
		private FXeWxvuoejNrJnpUgQhgaqksVhEA _imageRaycastHelper;
		...
		private bool wGnmitNNwIuOGAGSGDjsnrsqDAjw => false;

		internal StandaloneAxis2D FiudARHzvDeFOkHgzXzwhLuKvVbt => null;

		private Action<wqniaqGdJiSkJuPHmrxqssnAjCct> fLgrEAXlhQEDWoCpZUPwVeXhFELk => null;

		private Action<wqniaqGdJiSkJuPHmrxqssnAjCct> ivVCURABsyODAacSNRuWaeMKgAPAA => null;

		private int oCrRekHdOTGKbEQgxYVAnSgorTBn => 0;

		private RectTransform bfcUZrtrocGbIYScVjBcrcdwVQud => null;

		private float DKxJefRzqlabXhLSEFjBdHlZsTfF => 0f;

		internal static IOTRuZUhpblgmuwMViwnrZiSkgDF.EventFunction<IValueChangedHandler, Vector2> eqoiWNztFWdmJewzDmGyybLgiidf => null;

		internal static IOTRuZUhpblgmuwMViwnrZiSkgDF.EventFunction<IStickPositionChangedHandler, Vector2> xLPmgHSdeUgjUjCeDnDhbOBFdwEZ => null;
		...
		internal override void DhnkarFdLNbxthygTakzNjfHljXY()
		{
		}

		internal override void tRUIvEemdCHZwaLBzjeyJKBqGxexA()
		{
		}
		...
		internal override void tKEdjOKSEgjEZYzXhFqUMeyYYOhKA()
		{
		}
		...
		internal override bool ZTjjQbCwTEpJusDmINexytzShkGP()
		{
			return false;
		}

		internal override bool hFzAHiRfaqYGcaauuljcWQStfGUP(GameObject P_0)
		{
			return false;
		}
