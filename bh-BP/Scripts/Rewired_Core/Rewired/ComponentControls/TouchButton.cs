...
namespace Rewired.ComponentControls
{
	...
	public sealed class TouchButton : TouchInteractable
	{
		...
		private int dCCFlpDFGtyifjbuWJzVypbNYMwX;

		private int CqWCFhYkCUjtiJMaGBtvYzVpCpfy;
		...
		private FXeWxvuoejNrJnpUgQhgaqksVhEA jEKaaKpIpYYeTUNkvKMubTGPuuet;
		...
		private Action<dGdpPQRPsAEdjFoYSiXxawbSMBnXA> moveStartedDelegate => null;

		private Action<dGdpPQRPsAEdjFoYSiXxawbSMBnXA> moveEndedDelegate => null;
		...
		internal override bool hFzAHiRfaqYGcaauuljcWQStfGUP(GameObject gameObject)
		{
			return false;
		}
