...
namespace Rewired.ComponentControls
{
	...
	public sealed class TouchPad : TouchInteractable, IPointerDownHandler, IEventSystemHandler, IPointerUpHandler
	{
		...
		private class bugmEXMvAjAGEUHToFMrZbAWjyRB
		{
			...
			private int stgoIVDjoakexbJWMjesOawZeayfA;
		...
		private bugmEXMvAjAGEUHToFMrZbAWjyRB _smoothDelta;
		...
		internal StandaloneAxis2D PGQaVAiEcXyYRXIOyIbUiRhJuSfW => null;

		private int pRmdQSfDGGqZkgEibveAbVchNPGbE => 0;

		private bool ozpTRenLDPIlIJKEBPBGIwYhdxEUB => false;
