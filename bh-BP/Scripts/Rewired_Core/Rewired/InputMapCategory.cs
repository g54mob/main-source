...
namespace Rewired
{
	...
	public sealed class InputMapCategory : InputCategory
	{
		...
		internal List<int> VsTsjCSqoYfzEfBboOJteWttoNhoA => null;
		...
		internal override void ZzoVDiFcIzGOVDvNlITWKiMIFbjy()
		{
		}

		internal override void jBXBmBeKAZaSYPFvJNoUCmXvWKCW()
		{
		}
	}
}
