...
namespace Rewired.Data.Mapping
{
	...
	internal interface IHardwareControllerTemplateMap_Internal
	{
		...
		eyXePMBLHAVdDBzdXMjLzHNfDAjcA GetAxisTarget(Controller controller, int elementIdentifierId);

		eyXePMBLHAVdDBzdXMjLzHNfDAjcA GetButtonTarget(Controller controller, int elementIdentifierId);
	}
}
