...
namespace Rewired
{
	public sealed class FlightYokeTemplate : ControllerTemplate, IFlightYokeTemplate, IControllerTemplate
	{
		...
		IControllerTemplateButton IFlightYokeTemplate.leftPaddle => null;

		IControllerTemplateButton IFlightYokeTemplate.rightPaddle => null;

		IControllerTemplateButton IFlightYokeTemplate.leftGripButton1 => null;

		IControllerTemplateButton IFlightYokeTemplate.leftGripButton2 => null;

		IControllerTemplateButton IFlightYokeTemplate.leftGripButton3 => null;

		IControllerTemplateButton IFlightYokeTemplate.leftGripButton4 => null;

		IControllerTemplateButton IFlightYokeTemplate.leftGripButton5 => null;

		IControllerTemplateButton IFlightYokeTemplate.leftGripButton6 => null;

		IControllerTemplateButton IFlightYokeTemplate.rightGripButton1 => null;

		IControllerTemplateButton IFlightYokeTemplate.rightGripButton2 => null;

		IControllerTemplateButton IFlightYokeTemplate.rightGripButton3 => null;

		IControllerTemplateButton IFlightYokeTemplate.rightGripButton4 => null;

		IControllerTemplateButton IFlightYokeTemplate.rightGripButton5 => null;

		IControllerTemplateButton IFlightYokeTemplate.rightGripButton6 => null;

		IControllerTemplateButton IFlightYokeTemplate.centerButton1 => null;

		IControllerTemplateButton IFlightYokeTemplate.centerButton2 => null;

		IControllerTemplateButton IFlightYokeTemplate.centerButton3 => null;

		IControllerTemplateButton IFlightYokeTemplate.centerButton4 => null;

		IControllerTemplateButton IFlightYokeTemplate.centerButton5 => null;

		IControllerTemplateButton IFlightYokeTemplate.centerButton6 => null;

		IControllerTemplateButton IFlightYokeTemplate.centerButton7 => null;

		IControllerTemplateButton IFlightYokeTemplate.centerButton8 => null;

		IControllerTemplateButton IFlightYokeTemplate.wheel1Up => null;

		IControllerTemplateButton IFlightYokeTemplate.wheel1Down => null;

		IControllerTemplateButton IFlightYokeTemplate.wheel1Press => null;

		IControllerTemplateButton IFlightYokeTemplate.wheel2Up => null;

		IControllerTemplateButton IFlightYokeTemplate.wheel2Down => null;

		IControllerTemplateButton IFlightYokeTemplate.wheel2Press => null;

		IControllerTemplateButton IFlightYokeTemplate.consoleButton1 => null;

		IControllerTemplateButton IFlightYokeTemplate.consoleButton2 => null;

		IControllerTemplateButton IFlightYokeTemplate.consoleButton3 => null;

		IControllerTemplateButton IFlightYokeTemplate.consoleButton4 => null;

		IControllerTemplateButton IFlightYokeTemplate.consoleButton5 => null;

		IControllerTemplateButton IFlightYokeTemplate.consoleButton6 => null;

		IControllerTemplateButton IFlightYokeTemplate.consoleButton7 => null;

		IControllerTemplateButton IFlightYokeTemplate.consoleButton8 => null;

		IControllerTemplateButton IFlightYokeTemplate.consoleButton9 => null;

		IControllerTemplateButton IFlightYokeTemplate.consoleButton10 => null;

		IControllerTemplateButton IFlightYokeTemplate.mode1 => null;

		IControllerTemplateButton IFlightYokeTemplate.mode2 => null;

		IControllerTemplateButton IFlightYokeTemplate.mode3 => null;

		IControllerTemplateYoke IFlightYokeTemplate.yoke => null;

		IControllerTemplateThrottle IFlightYokeTemplate.lever1 => null;

		IControllerTemplateThrottle IFlightYokeTemplate.lever2 => null;

		IControllerTemplateThrottle IFlightYokeTemplate.lever3 => null;

		IControllerTemplateThrottle IFlightYokeTemplate.lever4 => null;

		IControllerTemplateThrottle IFlightYokeTemplate.lever5 => null;

		IControllerTemplateHat IFlightYokeTemplate.leftGripHat => null;

		IControllerTemplateHat IFlightYokeTemplate.rightGripHat => null;
