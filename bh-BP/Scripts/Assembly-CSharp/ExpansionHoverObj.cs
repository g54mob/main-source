...
public class ExpansionHoverObj : MonoBehaviour
{
	[CompilerGenerated]
	private sealed class _003C_FadeOut_003Ed__11 : IEnumerator<float>, IEnumerator, IDisposable
	{
		...
		public ExpansionHoverObj _003C_003E4__this;
	...
	public Sprite SprBorderNormal;

	public Sprite SprBorderHover;

	public int TgtChunkX;

	public int TgtChunkY;
