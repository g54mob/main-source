...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static ReadOnlyCollection<ControllerElementIdentifier> MzJMiSAlsaWvkPxjfZVLHDVrVtD;

		private static ReadOnlyCollection<ControllerElementIdentifier> JyQjEecEXmjEbWYtsCpMrcRrMBu;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] FMVxeSgCBWaCnSjijphqvtuBplx;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] svynCirqEnTUCwjGjCsgLcOnbmSd;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] tqAEyUSLVxWHGUbzlTRQvpLIgzQ;
		...
		private static readonly string[] IZkjBFKBntbUVhApiEdlvnguPLpT;

		internal static readonly IList<PidVid> pidVids_sony_dualShock4;

		private static readonly PidVid[] ScgsHNpeJIrjtlPYalxFjhAHRoN;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] ZxwvJyLQckCNFJaeCbwopGfkXAk;

		private static readonly ControllerElementIdentifier[] mTlmQEEqzTwPhseBhEigcVcXhyi;
		...
		private static ControllerElementIdentifier[] lwdsJHezFdmiBkrLVtefwxbnbGR()
		{
			return null;
		}
	}
