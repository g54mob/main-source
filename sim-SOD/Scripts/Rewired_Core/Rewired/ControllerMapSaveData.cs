...
namespace Rewired
{
	public abstract class ControllerMapSaveData
	{
		...
		internal static T ocIbkoMmgHsnOyMMcObcgEoKEsQ<T>(Controller P_0, ControllerMap P_1) where T : ControllerMapSaveData
		{
			return null;
		}

		internal static ControllerMapSaveData ocIbkoMmgHsnOyMMcObcgEoKEsQ(Controller P_0, ControllerMap P_1)
		{
			return null;
		}
	}
