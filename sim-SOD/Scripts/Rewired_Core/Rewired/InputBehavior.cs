...
namespace Rewired
{
	...
	public sealed class InputBehavior
	{
		...
		internal SerializedObject xHpyvUhRBbQgNWKQSYxIZmhVJfc()
		{
			return null;
		}

		internal void KCFiWMtXJavdVbRSXmSDTQUBCbt(SerializedObject P_0)
		{
		}

		private static void dQicSPHhIyMymHVtrafIeOiyUDyF(InputBehavior P_0, InputBehavior P_1, bool P_2)
		{
		}
	}
}
