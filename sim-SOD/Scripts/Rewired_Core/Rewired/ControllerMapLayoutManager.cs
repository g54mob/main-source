...
namespace Rewired
{
	...
	{
		internal class dGekYATeRfbafeJJnlCUjUizAMIw
		{
			public bool bncPgdmRtwpPAGrKmCTitEoJCNS;

			public bool GDMWoRPssprZFMAhYhBFykkeIlL;

			public acSAziGagXRkcjooVPiFpvmdfmV[] jsipkrvEsJAOlhPkRMnzQnNJjgz;

			public dGekYATeRfbafeJJnlCUjUizAMIw(bool enabled, bool loadFromUserDataStore, acSAziGagXRkcjooVPiFpvmdfmV[] startingRuleSets)
			{
			}
		}
		...
		private bool dooeeigPKgIECRxusuGsWejlyIl;

		private Player GvbAEQGJJPtOgFdmijEOTtulCyiG;

		private dGekYATeRfbafeJJnlCUjUizAMIw CRgkCFsPwXTYZhZZWRMlyiuPCSf;

		private readonly int RSGBQYfltigFuhDMRviugFIbvohH;

		private List<RuleSet> TojRulwzrXbMvLzqXprsUvmWGcS;

		private Action NmGigRfYhRMaQYAdEHaZFOkIMPXl;
		...
		internal ControllerMapLayoutManager(Player player, dGekYATeRfbafeJJnlCUjUizAMIw startingSettings)
		{
		}
