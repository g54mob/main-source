...
namespace Rewired.ComponentControls
{
	...
	public sealed class TouchJoystick : TouchInteractable
	{
		...
		private enum QSXafKbIEssuPhPmhuKztHdHEpo
		{
		...
		private enum ReleJRBhXYLQcVPDOnNTwxlpMpTU
		{
		...
		private sealed class sqnqgYQHYPAAFvuqXjwWuvwAmIZ : IEnumerator<object>, IDisposable, IEnumerator
		{
			private object YDjDCBVmlkHQnKMyHwfXVborvEXS;

			private int KjzQtaNmLSFADNQocZpcbdUSqwW;

			public TouchJoystick OLVemnFdjzUkQSlFFFIOsrknazt;
			...
			public QSXafKbIEssuPhPmhuKztHdHEpo dzDHtyuFrCketmFXvmZpIfivvaR;

			public RectTransform oGqNDOOvqttzxjdCEGjdnFrLEeAc;

			public Vector2 KyTBipIcfgpYvMFWrcRcJCmrBQk;

			public float wrLJrCKgCtGiSbXDydGoDboAmPZl;

			public float TdnwCkJovmfBpPozKeziWVhZbhr;

			public float jXnGdKtHOECKqwpJsAPfgAyesZM;
			...
			[DebuggerHidden]
			public sqnqgYQHYPAAFvuqXjwWuvwAmIZ(int _003C_003E1__state)
			{
			}
		}
		...
		private stlYYrlogjOzidIPUgNgkVVVmZH.HierarchyEventHelper<IValueChangedHandler, Vector2> _hierarchyValueChangedHandlers;

		private stlYYrlogjOzidIPUgNgkVVVmZH.HierarchyEventHelper<IStickPositionChangedHandler, Vector2> _hierarchyStickPositionChangedHandlers;
		...
		private QSXafKbIEssuPhPmhuKztHdHEpo _moveDirection;
		...
		private ReleJRBhXYLQcVPDOnNTwxlpMpTU _lastClaimSource;
		...
		private jylERTQxpaiRjkKARAhcjpqGxaxX _imageRaycastHelper;
		...
		private Action<QSXafKbIEssuPhPmhuKztHdHEpo> __moveStartedDelegate;

		private Action<QSXafKbIEssuPhPmhuKztHdHEpo> __moveEndedDelegate;
		...
		private static stlYYrlogjOzidIPUgNgkVVVmZH.EventFunction<IValueChangedHandler, Vector2> __valueChangedHandlerDelegate;

		private static stlYYrlogjOzidIPUgNgkVVVmZH.EventFunction<IStickPositionChangedHandler, Vector2> __stickPositionChangedHandlerDelegate;
		...
		private Action<QSXafKbIEssuPhPmhuKztHdHEpo> moveStartedDelegate => null;

		private Action<QSXafKbIEssuPhPmhuKztHdHEpo> moveEndedDelegate => null;
		...
		internal static stlYYrlogjOzidIPUgNgkVVVmZH.EventFunction<IValueChangedHandler, Vector2> valueChangedHandlerDelegate => null;

		internal static stlYYrlogjOzidIPUgNgkVVVmZH.EventFunction<IStickPositionChangedHandler, Vector2> stickPositionChangedHandlerDelegate => null;
		...
		internal override bool xlXQBhwolTgrrjPRJxnvItTggCjf(GameObject P_0)
		{
			return false;
		}
		...
		private void cjlgHfaqFHAAcWDYfGbTIBcurrGB(Vector2 P_0, bool P_1, float P_2, QSXafKbIEssuPhPmhuKztHdHEpo P_3)
		{
		}

		private void aVLsCIcObIbNHyLDoDTDyrRZFGh(Vector2 P_0, PositionType P_1, bool P_2, float P_3, QSXafKbIEssuPhPmhuKztHdHEpo P_4)
		{
		}

		private IEnumerator cxAExRZyplelZsbrSIuHSpGECzgg(Vector2 P_0, PositionType P_1, float P_2, QSXafKbIEssuPhPmhuKztHdHEpo P_3)
		{
			return null;
		}

		private void AcJYRrKmXpLRHfxuBLJUYLineAj(QSXafKbIEssuPhPmhuKztHdHEpo P_0, Vector2 P_1, PositionType P_2)
		{
		}

		private void QVvIjJKIFCPcYTJYcfXRDjktCKBI(QSXafKbIEssuPhPmhuKztHdHEpo P_0)
		{
		}

		private void ZRGJYtigfXYhaClokSUsncTCBzW(QSXafKbIEssuPhPmhuKztHdHEpo P_0)
		{
		}
		...
		private void TYDILUlWIIDcktJLpqsKiTpzJxS(int P_0, Vector2 P_1, PositionType P_2)
		{
		}
		...
		private void NlmbASBSxDncAHtXhGRQtZKhQGyl(PointerEventData P_0, ReleJRBhXYLQcVPDOnNTwxlpMpTU P_1)
		{
		}
		...
		private void rwILpGMLcDAnggJJPjnFKJmjkkV(PointerEventData P_0, ReleJRBhXYLQcVPDOnNTwxlpMpTU P_1)
		{
		}

		private void KGnHQyTRRAYZywAdMqcQwDPfPo(PointerEventData P_0, ReleJRBhXYLQcVPDOnNTwxlpMpTU P_1)
		{
		}

		private void KPfYwTlNHSewjMThVCToyjhHCFha(PointerEventData P_0, ReleJRBhXYLQcVPDOnNTwxlpMpTU P_1)
		{
		}

		private void oPNajkGScOUePgaQHAZNNGaQujNJ(PointerEventData P_0, ReleJRBhXYLQcVPDOnNTwxlpMpTU P_1)
		{
		}

		private void pQnbRvJUWEnGaMTugPWmgmAJuflL(PointerEventData P_0, ReleJRBhXYLQcVPDOnNTwxlpMpTU P_1)
		{
		}

		private void GxKOCYdRdJKnPhTHQpAgQLjgeXBG(PointerEventData P_0, ReleJRBhXYLQcVPDOnNTwxlpMpTU P_1)
		{
		}

		private void AzMmQIlwXTPnneDielwHRxOMzGn(PointerEventData P_0, ReleJRBhXYLQcVPDOnNTwxlpMpTU P_1)
		{
		}

		private void UTotXmLEdaIKmhEhaohsrCOmSKj(int P_0, Vector2 P_1, ReleJRBhXYLQcVPDOnNTwxlpMpTU P_2)
		{
		}
		...
		private void ZWqbUQAXdtgKzAZAbOCZMtexJFq(PointerEventData P_0)
		{
		}

		private void pYAABHUTfschDIFuJTsfQucfrkjc(PointerEventData P_0)
		{
		}

		private void cuKgpSdKNlNGXkapFHhdBhMIriOa(PointerEventData P_0)
		{
		}

		private void jaLAWOFyRlcwDvbTjWRIBekgFAk(Vector2 P_0)
		{
		}

		[CompilerGenerated]
		private static void ZELwihWRHTZmbCaqqzLqacmTkdF(IValueChangedHandler P_0, Vector2 P_1)
		{
		}

		[CompilerGenerated]
		private static void YgwcyrFHfBLaEHOHIOFXysEDVUeP(IStickPositionChangedHandler P_0, Vector2 P_1)
		{
		}
	}
}
