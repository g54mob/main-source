...
namespace Rewired.Data.Mapping
{
	...
	internal interface IHardwareControllerTemplateMap_Internal
	{
		...
		WEjbSeiFAGihJGQWKjQAhkLgezjp GetAxisTarget(Controller controller, int elementIdentifierId);

		WEjbSeiFAGihJGQWKjQAhkLgezjp GetButtonTarget(Controller controller, int elementIdentifierId);
	}
}
