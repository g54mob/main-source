...
namespace Rewired
{
	...
	{
		private readonly ControllerMap rAbbicgqWKQOAQlOWnWEeduwIaQG;

		private readonly ControllerElementType KBXbDLkLbEVjqjnHFWngPgnQczYe;

		private readonly int kdoqysyprYlwoNFzFDQbXlDaNGV;

		private readonly int YcDcbHqQMwtgQxoISZasthfuQlm;

		private readonly AxisRange cABCOnvRSkGcigODbszHBBdAJzQM;

		private readonly KeyCode LqYzeknTZrTxyuRrNGrSguecMLt;

		private readonly ModifierKeyFlags gvUmwPTqhvWmgTUEohkItzJVUmh;

		private readonly int CijfVweIqbvViXAEzqkELDhcHIR;

		private readonly Pole zJDZegKBEylmTufyxXBEpUosAk;

		private readonly bool BGMqqEuRVgwTmFNpxwYAfFxSbFL;
