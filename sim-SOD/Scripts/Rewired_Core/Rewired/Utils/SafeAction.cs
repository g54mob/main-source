...
namespace Rewired.Utils
{
	...
	{
		private static Action<object, Action> jNfpUwxdPKfILfIJHLmdMoTQnyh;
		...
		private static void VNpVwfskInIXZQqomLEEuDcfHKiG(object P_0, Action P_1)
		{
		}
	...
	internal sealed class SafeAction<T> : SafeDelegate<Action<T>>
	{
		...
		private static Action<object, Action<T>> jNfpUwxdPKfILfIJHLmdMoTQnyh;
		...
		private static void VNpVwfskInIXZQqomLEEuDcfHKiG(object P_0, Action<T> P_1)
		{
		}
	...
	internal sealed class SafeAction<T, T2> : SafeDelegate<Action<T, T2>>
	{
		...
		private T2 QPhTRaFUfwsTxHuloHkgcTwQkhD;

		private static Action<object, Action<T, T2>> jNfpUwxdPKfILfIJHLmdMoTQnyh;
		...
		private static void VNpVwfskInIXZQqomLEEuDcfHKiG(object P_0, Action<T, T2> P_1)
		{
		}
