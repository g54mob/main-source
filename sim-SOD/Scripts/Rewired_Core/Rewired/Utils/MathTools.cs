...
namespace Rewired.Utils
{
	...
	{
		private const float akBinIPIORyrXaVYrRIjURanXVE = 1E-10f;

		private const double TEfTBnMJtRYIFHNjAJAwQzLLFyK = 1E-10;

		private const float sKRWwlcePHrddopNzWaOrVtYHaI = 0.0001f;
		...
		internal static bool jOpbOuxsyZnFIkxntSLLaUDmooo(int P_0, int P_1)
		{
			return false;
		}
		...
		private static bool QiWRkkUqqiFDHKxshNapSeJFlfzo(Vector2 P_0, Vector2 P_1, Vector2 P_2, Vector2 P_3, out Vector2 P_4)
		{
			P_4 = default(Vector2);
			return false;
		}
