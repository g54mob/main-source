...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class ghuqbYoVlStjjodigCeadoAYwDv : IControllerExtensionSource
		{
			public readonly IDriver_DualSense RoGyCOLKdQfbMICWzOACeDQIYzWc;

			public readonly bool KTfrJbQBKhaUMbjHRbtMzWYUXDE;

			public readonly int ZHjjBLxDSwIULZUgnbCMHwanPkf;

			public ghuqbYoVlStjjodigCeadoAYwDv(IDriver_DualSense driver, bool supportsVibration, int vibrationMotorCount)
			{
			}
		}

		private ghuqbYoVlStjjodigCeadoAYwDv tfTCEMKNedpBjaNONhTolgkIZhi;
