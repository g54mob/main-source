...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class aytMMHcLFRcDXGTALXrghJCBwJN : IControllerExtensionSource
		{
			public readonly ISteamControllerInternal ducdhZIuxLZCRdgIsgbjMTvFfmWz;

			public aytMMHcLFRcDXGTALXrghJCBwJN(ISteamControllerInternal internalController)
			{
			}
		}

		private aytMMHcLFRcDXGTALXrghJCBwJN ottLIBaLKUdMBBqnPedZdrrIelx;
