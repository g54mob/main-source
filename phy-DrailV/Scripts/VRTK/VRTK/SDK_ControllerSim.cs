...
namespace VRTK
{
	public class SDK_ControllerSim : MonoBehaviour
	{
		...
		protected virtual void SetCaches()
		{
			...
			{
				cachedVelocityEstimator = ((GetComponent<VRTK_VelocityEstimator>() != null) ? GetComponent<VRTK_VelocityEstimator>() : base.gameObject.AddComponent<VRTK_VelocityEstimator>());
			}
		}
	}
}
