...
namespace VRTK
{
	...
	public class VRTK_Wheel : VRTK_Control
	{
		...
		protected virtual void ConfigureHingeSpring()
		{
			...
			{
				spring = springStrengthValue,
				damper = springDamperValue,
				targetPosition = springAngle + wheelHinge.limits.min
			};
		...
		protected virtual void CalculateValue()
		{
			...
			(base.transform.localRotation * Quaternion.Inverse(initialLocalRotation)).ToAngleAxis(out var angle, out var _);
