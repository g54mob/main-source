		...
		protected override bool DetectSetup()
		{
			if (leverHingeJointCreated)
			{
				...
				case LeverDirection.x:
					leverHingeJoint.anchor = ((bounds.extents.y > bounds.extents.z) ? new Vector3(0f, bounds.extents.y / base.transform.lossyScale.y, 0f) : new Vector3(0f, 0f, bounds.extents.z / base.transform.lossyScale.z));
					break;
				case LeverDirection.y:
					leverHingeJoint.axis = new Vector3(0f, 1f, 0f);
					leverHingeJoint.anchor = ((bounds.extents.x > bounds.extents.z) ? new Vector3(bounds.extents.x / base.transform.lossyScale.x, 0f, 0f) : new Vector3(0f, 0f, bounds.extents.z / base.transform.lossyScale.z));
					break;
				case LeverDirection.z:
					leverHingeJoint.axis = new Vector3(0f, 0f, 1f);
					leverHingeJoint.anchor = ((bounds.extents.y > bounds.extents.x) ? new Vector3(0f, bounds.extents.y / base.transform.lossyScale.y, 0f) : new Vector3(bounds.extents.x / base.transform.lossyScale.x, 0f));
					break;
				}
