...
namespace VRTK
{
	public abstract class VRTK_ObjectControl : MonoBehaviour
	{
		...
		protected virtual void OnEnable()
		{
			...
			{
				SetControlledObject();
				bodyPhysics = (controlOverrideObject ? null : ((bodyPhysics != null) ? bodyPhysics : Object.FindObjectOfType<VRTK_BodyPhysics>()));
		...
		protected virtual void SetControlledObject()
		{
			...
			controlledGameObject = (controlOverrideObject ? controlOverrideObject : ((transform != null) ? transform.gameObject : null));
		...
		protected virtual Transform GetDirectionDevice()
		{
			...
			case DirectionDevices.LeftController:
				return VRTK_DeviceFinder.GetControllerLeftHand(getActual: true).transform;
			case DirectionDevices.RightController:
				return VRTK_DeviceFinder.GetControllerRightHand(getActual: true).transform;
			default:
				return null;
			}
		}
