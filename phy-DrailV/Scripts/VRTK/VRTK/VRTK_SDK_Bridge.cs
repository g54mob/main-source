...
namespace VRTK
{
	public static class VRTK_SDK_Bridge
	{
		...
		{
			UnityEngine.Object.Destroy(systemSDK);
			UnityEngine.Object.Destroy(headsetSDK);
			UnityEngine.Object.Destroy(controllerSDK);
			UnityEngine.Object.Destroy(boundariesSDK);
			systemSDK = null;
			headsetSDK = null;
			controllerSDK = null;
			boundariesSDK = null;
