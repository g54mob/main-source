...
namespace VRTK.Examples
{
	public class VRTKExample_ControllerEventsDelegateListeners : MonoBehaviour
	{
		...
		{
			VRTK_Logger.Info(string.Concat("Controller on index '", index, "' ", button, " has been ", action, " with a pressure of ", e.buttonPressure, " / Primary Touchpad axis at: ", e.touchpadAxis, " (", e.touchpadAngle, " degrees) / Secondary Touchpad axis at: ", e.touchpadTwoAxis, " (", e.touchpadTwoAngle, " degrees)"));
		}
