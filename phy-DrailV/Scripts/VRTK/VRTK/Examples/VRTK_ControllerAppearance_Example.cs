...
namespace VRTK.Examples
{
	public class VRTK_ControllerAppearance_Example : MonoBehaviour
	{
		...
		private void OnEnable()
		{
			...
			tooltips.ToggleTips(state: false);
		}
		...
		{
			tooltips.ToggleTips(state: true, VRTK_ControllerTooltips.TooltipButtons.TriggerTooltip);
		...
		{
			tooltips.ToggleTips(state: false, VRTK_ControllerTooltips.TooltipButtons.TriggerTooltip);
		...
		{
			tooltips.ToggleTips(state: true, VRTK_ControllerTooltips.TooltipButtons.ButtonOneTooltip);
		...
		{
			tooltips.ToggleTips(state: false, VRTK_ControllerTooltips.TooltipButtons.ButtonOneTooltip);
		...
		{
			tooltips.ToggleTips(state: true, VRTK_ControllerTooltips.TooltipButtons.ButtonTwoTooltip);
		...
		{
			tooltips.ToggleTips(state: false, VRTK_ControllerTooltips.TooltipButtons.ButtonTwoTooltip);
		...
		{
			tooltips.ToggleTips(state: true, VRTK_ControllerTooltips.TooltipButtons.StartMenuTooltip);
		...
		{
			tooltips.ToggleTips(state: false, VRTK_ControllerTooltips.TooltipButtons.StartMenuTooltip);
		...
		{
			tooltips.ToggleTips(state: true, VRTK_ControllerTooltips.TooltipButtons.GripTooltip);
		...
		{
			tooltips.ToggleTips(state: false, VRTK_ControllerTooltips.TooltipButtons.GripTooltip);
		...
		{
			tooltips.ToggleTips(state: true, VRTK_ControllerTooltips.TooltipButtons.TouchpadTooltip);
		...
		{
			tooltips.ToggleTips(state: false, VRTK_ControllerTooltips.TooltipButtons.TouchpadTooltip);
