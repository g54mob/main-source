...
{
	public class JobBookletTest_EmptyHaul : ABookletTest
	{
		...
		public JobLicenses requiredLicenses = JobLicenses.Hazmat3 | JobLicenses.LogisticalHaul;
		...
		protected Job_data CreateJobData()
		{
			...
			return new Job_data("SL-01", JobType.EmptyHaul, JobState.Available, 0f, 0f, 50f, 34500f, 23000f, 58982f, requiredLicenses, new Task_data[1] { task_data }, originStationInfo, destinationStationInfo);
		}
	}
}
