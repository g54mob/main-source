	...
	public class SplineInterpolator : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			if (mState != "Stopped")
			{
				...
				t = SplineMathUtils.Ease(t, mNodes[mCurrentIdx].EaseIO.x, mNodes[mCurrentIdx].EaseIO.y);
		...
		private Quaternion GetSquad(int idxFirstPoint, float t)
		{
			...
			Quaternion squadIntermediate = SplineMathUtils.GetSquadIntermediate(rot, rot2, rot3);
			Quaternion squadIntermediate2 = SplineMathUtils.GetSquadIntermediate(rot2, rot3, rot4);
			return SplineMathUtils.GetQuatSquad(t, rot2, rot3, squadIntermediate, squadIntermediate2);
		}
		...
		public Vector3 GetHermiteAtTime(float timeParam)
		{
			...
			t = SplineMathUtils.Ease(t, mNodes[num].EaseIO.x, mNodes[num].EaseIO.y);
