...
namespace Obi
{
	...
	public class ObiPinConstraints : ObiBatchedConstraints
	{
		...
		private List<ObiConstraintBatch> genericBatches = new List<ObiConstraintBatch>();

		private void Awake()
		{
			genericBatches = batches.ConvertAll((Converter<ObiPinConstraintBatch, ObiConstraintBatch>)((ObiPinConstraintBatch x) => x));
		}
