namespace Crosstales.Ude.Core
{
	public class SJISSMModel : SMModel
	{
		...
		private static readonly int[] SJISCharLenTable = new int[6] { 0, 1, 1, 2, 0, 0 };

		public SJISSMModel()
			: base(new BitPackage(BitPackage.INDEX_SHIFT_4BITS, BitPackage.SHIFT_MASK_4BITS, BitPackage.BIT_SHIFT_4BITS, BitPackage.UNIT_MASK_4BITS, SJIS_cls), 6, new BitPackage(BitPackage.INDEX_SHIFT_4BITS, BitPackage.SHIFT_MASK_4BITS, BitPackage.BIT_SHIFT_4BITS, BitPackage.UNIT_MASK_4BITS, SJIS_st), SJISCharLenTable, "Shift_JIS")
		{
		}
	}
}
