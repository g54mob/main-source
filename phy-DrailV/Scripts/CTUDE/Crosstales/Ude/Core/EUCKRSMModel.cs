namespace Crosstales.Ude.Core
{
	public class EUCKRSMModel : SMModel
	{
		...
		private static readonly int[] EUCKRCharLenTable = new int[4] { 0, 1, 2, 0 };

		public EUCKRSMModel()
			: base(new BitPackage(BitPackage.INDEX_SHIFT_4BITS, BitPackage.SHIFT_MASK_4BITS, BitPackage.BIT_SHIFT_4BITS, BitPackage.UNIT_MASK_4BITS, EUCKR_cls), 4, new BitPackage(BitPackage.INDEX_SHIFT_4BITS, BitPackage.SHIFT_MASK_4BITS, BitPackage.BIT_SHIFT_4BITS, BitPackage.UNIT_MASK_4BITS, EUCKR_st), EUCKRCharLenTable, "EUC-KR")
		{
		}
	}
}
