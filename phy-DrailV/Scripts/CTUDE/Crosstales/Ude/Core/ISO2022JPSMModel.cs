namespace Crosstales.Ude.Core
{
	...
	{
		private static readonly int[] ISO2022JP_cls = new int[32]
		{
		...
		private static readonly int[] ISO2022JP_st = new int[9]
		{
		...
		private static readonly int[] ISO2022JPCharLenTable = new int[10];
