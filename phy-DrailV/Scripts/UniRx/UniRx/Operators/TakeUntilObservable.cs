	...
	internal class TakeUntilObservable<T, TOther> : OperatorObservableBase<T>
	{
		private class TakeUntil : OperatorObserverBase<T, T>
		{
			...
			public IDisposable Run()
			{
				...
				TakeUntilOther takeUntilOther = new TakeUntilOther(this, singleAssignmentDisposable);
				singleAssignmentDisposable.Disposable = parent.other.Subscribe(takeUntilOther);
