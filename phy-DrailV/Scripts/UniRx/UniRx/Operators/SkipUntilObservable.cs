	...
	internal class SkipUntilObservable<T, TOther> : OperatorObservableBase<T>
	{
		private class SkipUntilOuterObserver : OperatorObserverBase<T, T>
		{
			...
			public IDisposable Run()
			{
				...
				SkipUntil sourceObserver = new SkipUntil(this, singleAssignmentDisposable);
				SingleAssignmentDisposable singleAssignmentDisposable2 = new SingleAssignmentDisposable();
				SkipUntilOther skipUntilOther = new SkipUntilOther(this, sourceObserver, singleAssignmentDisposable2);
				singleAssignmentDisposable.Disposable = parent.source.Subscribe(sourceObserver);
				singleAssignmentDisposable2.Disposable = parent.other.Subscribe(skipUntilOther);
