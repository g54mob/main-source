	...
	internal class SelectManyObservable<TSource, TResult> : OperatorObservableBase<TResult>
	{
		private class SelectManyOuterObserver : OperatorObserverBase<TSource, TResult>
		{
			...
			public override void OnNext(TSource value)
			{
				...
				SelectMany selectMany = new SelectMany(this, singleAssignmentDisposable);
				singleAssignmentDisposable.Disposable = observable.Subscribe(selectMany);
			}
	...
	internal class SelectManyObservable<TSource, TCollection, TResult> : OperatorObservableBase<TResult>
	{
		private class SelectManyOuterObserver : OperatorObserverBase<TSource, TResult>
		{
			...
			public override void OnNext(TSource value)
			{
				...
				SingleAssignmentDisposable singleAssignmentDisposable = new SingleAssignmentDisposable();
				collectionDisposable.Add(singleAssignmentDisposable);
				SelectMany selectMany = new SelectMany(this, value, singleAssignmentDisposable);
				singleAssignmentDisposable.Disposable = observable.Subscribe(selectMany);
			}
		...
		private class SelectManyObserverWithIndex : OperatorObserverBase<TSource, TResult>
		{
			...
			public override void OnNext(TSource value)
			{
				...
				SingleAssignmentDisposable singleAssignmentDisposable = new SingleAssignmentDisposable();
				collectionDisposable.Add(singleAssignmentDisposable);
				SelectManyObserver selectManyObserver = new SelectManyObserver(this, value, arg, singleAssignmentDisposable);
				singleAssignmentDisposable.Disposable = observable.Subscribe(selectManyObserver);
			}
