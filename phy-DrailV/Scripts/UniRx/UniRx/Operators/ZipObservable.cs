...
namespace UniRx.Operators
{
	...
	internal class ZipObservable<T> : OperatorObservableBase<IList<T>>
	{
		private class Zip : OperatorObserverBase<IList<T>, IList<T>>
		{
			...
			public IDisposable Run()
			{
				...
				{
					IObservable<T> observable = parent.sources[j];
	...
	internal class ZipObservable<T1, T2, T3, TR> : OperatorObservableBase<TR>
	{
		private class Zip : NthZipObserverBase<TR>
		{
			...
			public IDisposable Run()
			{
				SetQueue(new ICollection[3] { q1, q2, q3 });
		...
		public ZipObservable(IObservable<T1> source1, IObservable<T2> source2, IObservable<T3> source3, ZipFunc<T1, T2, T3, TR> resultSelector)
			: base(source1.IsRequiredSubscribeOnCurrentThread() || source2.IsRequiredSubscribeOnCurrentThread() || source3.IsRequiredSubscribeOnCurrentThread())
		{
	...
	internal class ZipObservable<T1, T2, T3, T4, TR> : OperatorObservableBase<TR>
	{
		private class Zip : NthZipObserverBase<TR>
		{
			...
			public IDisposable Run()
			{
				SetQueue(new ICollection[4] { q1, q2, q3, q4 });
				IDisposable disposable = parent.source1.Subscribe(new ZipObserver<T1>(gate, this, 0, q1));
				IDisposable disposable2 = parent.source2.Subscribe(new ZipObserver<T2>(gate, this, 1, q2));
				IDisposable disposable3 = parent.source3.Subscribe(new ZipObserver<T3>(gate, this, 2, q3));
		...
		public ZipObservable(IObservable<T1> source1, IObservable<T2> source2, IObservable<T3> source3, IObservable<T4> source4, ZipFunc<T1, T2, T3, T4, TR> resultSelector)
			: base(source1.IsRequiredSubscribeOnCurrentThread() || source2.IsRequiredSubscribeOnCurrentThread() || source3.IsRequiredSubscribeOnCurrentThread() || source4.IsRequiredSubscribeOnCurrentThread())
		{
			this.source1 = source1;
			this.source2 = source2;
			this.source3 = source3;
	...
	internal class ZipObservable<T1, T2, T3, T4, T5, TR> : OperatorObservableBase<TR>
	{
		private class Zip : NthZipObserverBase<TR>
		{
			...
			public IDisposable Run()
			{
				SetQueue(new ICollection[5] { q1, q2, q3, q4, q5 });
				IDisposable disposable = parent.source1.Subscribe(new ZipObserver<T1>(gate, this, 0, q1));
				IDisposable disposable2 = parent.source2.Subscribe(new ZipObserver<T2>(gate, this, 1, q2));
				IDisposable disposable3 = parent.source3.Subscribe(new ZipObserver<T3>(gate, this, 2, q3));
				IDisposable disposable4 = parent.source4.Subscribe(new ZipObserver<T4>(gate, this, 3, q4));
		...
		public ZipObservable(IObservable<T1> source1, IObservable<T2> source2, IObservable<T3> source3, IObservable<T4> source4, IObservable<T5> source5, ZipFunc<T1, T2, T3, T4, T5, TR> resultSelector)
			: base(source1.IsRequiredSubscribeOnCurrentThread() || source2.IsRequiredSubscribeOnCurrentThread() || source3.IsRequiredSubscribeOnCurrentThread() || source4.IsRequiredSubscribeOnCurrentThread() || source5.IsRequiredSubscribeOnCurrentThread())
		{
			this.source1 = source1;
			this.source2 = source2;
			this.source3 = source3;
	...
	internal class ZipObservable<T1, T2, T3, T4, T5, T6, TR> : OperatorObservableBase<TR>
	{
		private class Zip : NthZipObserverBase<TR>
		{
			...
			public IDisposable Run()
			{
				SetQueue(new ICollection[6] { q1, q2, q3, q4, q5, q6 });
				IDisposable disposable = parent.source1.Subscribe(new ZipObserver<T1>(gate, this, 0, q1));
				IDisposable disposable2 = parent.source2.Subscribe(new ZipObserver<T2>(gate, this, 1, q2));
				IDisposable disposable3 = parent.source3.Subscribe(new ZipObserver<T3>(gate, this, 2, q3));
				IDisposable disposable4 = parent.source4.Subscribe(new ZipObserver<T4>(gate, this, 3, q4));
		...
		public ZipObservable(IObservable<T1> source1, IObservable<T2> source2, IObservable<T3> source3, IObservable<T4> source4, IObservable<T5> source5, IObservable<T6> source6, ZipFunc<T1, T2, T3, T4, T5, T6, TR> resultSelector)
			: base(source1.IsRequiredSubscribeOnCurrentThread() || source2.IsRequiredSubscribeOnCurrentThread() || source3.IsRequiredSubscribeOnCurrentThread() || source4.IsRequiredSubscribeOnCurrentThread() || source5.IsRequiredSubscribeOnCurrentThread() || source6.IsRequiredSubscribeOnCurrentThread())
		{
			this.source1 = source1;
			this.source2 = source2;
			this.source3 = source3;
	...
	internal class ZipObservable<T1, T2, T3, T4, T5, T6, T7, TR> : OperatorObservableBase<TR>
	{
		private class Zip : NthZipObserverBase<TR>
		{
			...
			public IDisposable Run()
			{
				SetQueue(new ICollection[7] { q1, q2, q3, q4, q5, q6, q7 });
				IDisposable disposable = parent.source1.Subscribe(new ZipObserver<T1>(gate, this, 0, q1));
				IDisposable disposable2 = parent.source2.Subscribe(new ZipObserver<T2>(gate, this, 1, q2));
				IDisposable disposable3 = parent.source3.Subscribe(new ZipObserver<T3>(gate, this, 2, q3));
				IDisposable disposable4 = parent.source4.Subscribe(new ZipObserver<T4>(gate, this, 3, q4));
