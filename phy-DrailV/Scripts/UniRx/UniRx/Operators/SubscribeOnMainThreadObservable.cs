...
namespace UniRx.Operators
{
	internal class SubscribeOnMainThreadObservable<T> : OperatorObservableBase<T>
	{
		...
		protected override IDisposable SubscribeCore(IObserver<T> observer, IDisposable cancel)
		{
			...
			singleAssignmentDisposable.Disposable = subscribeTrigger.SubscribeWithState3(observer, serialDisposable, source, delegate(long _, IObserver<T> o, SerialDisposable disp, IObservable<T> s)
			{
