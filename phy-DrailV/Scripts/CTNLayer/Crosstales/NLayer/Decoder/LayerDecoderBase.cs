...
namespace Crosstales.NLayer.Decoder
{
	internal abstract class LayerDecoderBase
	{
		...
		private static readonly float[] DEWINDOW_TABLE = new float[512]
		{
		...
		private static readonly float[] SYNTH_COS64_TABLE = new float[31]
		{
		...
		private readonly List<float[]> _synBuf = new List<float[]>(2);

		private readonly List<int> _bufOffset = new List<int>(2);

		private float[] _eq;

		private readonly float[] ippuv = new float[512];

		private readonly float[] ei32 = new float[16];

		private readonly float[] eo32 = new float[16];

		private readonly float[] oi32 = new float[16];

		private readonly float[] oo32 = new float[16];

		private readonly float[] ei16 = new float[8];

		private readonly float[] eo16 = new float[8];

		private readonly float[] oi16 = new float[8];

		private readonly float[] oo16 = new float[8];

		private readonly float[] ei8 = new float[4];

		private readonly float[] tmp8 = new float[6];

		private readonly float[] oi8 = new float[4];

		private readonly float[] oo8 = new float[4];
