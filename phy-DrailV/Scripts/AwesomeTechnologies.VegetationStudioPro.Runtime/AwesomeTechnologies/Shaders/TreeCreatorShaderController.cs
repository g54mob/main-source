...
namespace AwesomeTechnologies.Shaders
{
	...
	{
		private static readonly string[] FoliageShaderNames = new string[9] { "Hidden/Nature/Tree Creator Albedo Rendertex", "Hidden/Nature/Tree Creator Leaves Rendertex", "Hidden/Nature/Tree Creator Leaves Optimized", "Hidden/Nature/Tree Creator Leaves Fast Optimized", "Nature/Tree Creator Leaves Fast", "Nature/Tree Creator Leaves", "Hidden/Nature/Tree Creator Bark Rendertex", "Hidden/Nature/Tree Creator Bark Optimized", "Nature/Tree Creator Bark" };
		...
		public bool MatchShader(string shaderName)
		{
			...
			if (shaderName.Contains("Tree Creator"))
			{
				return true;
			}
			return false;
