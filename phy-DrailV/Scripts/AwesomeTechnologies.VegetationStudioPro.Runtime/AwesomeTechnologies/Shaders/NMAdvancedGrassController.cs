...
namespace AwesomeTechnologies.Shaders
{
	...
	{
		private static readonly string[] FoliageShaderNames = new string[3] { "NatureManufacture Shaders/Grass/Advanced Grass Light", "NatureManufacture Shaders/Grass/Advanced Grass Specular", "NatureManufacture Shaders/Grass/Advanced Grass Standard" };
		...
		public void CreateDefaultSettings(Material[] materials)
		{
			...
			Settings.AddFloatProperty("CullFarPercentageDV", "Distance Fade Percentage (DV)", "", ShaderControllerSettings.GetFloatFromMaterials(materials, "_CullFarPercentage"), 0f, 1f);
		}
		...
		public void UpdateMaterial(Material material, EnvironmentSettings environmentSettings)
		{
			...
			try
			{
				material.SetFloat("_CullFarPercentage", Settings.GetFloatPropertyValue("CullFarPercentageDV"));
