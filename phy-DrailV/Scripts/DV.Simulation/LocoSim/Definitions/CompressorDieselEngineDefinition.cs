...
{
	public class CompressorDieselEngineDefinition : SimComponentDefinition
	{
		...
		public readonly PortReferenceDefinition engineIdleRpmNormalizedReader = new PortReferenceDefinition(PortValueType.RPM, "ENGINE_IDLE_RPM_NORMALIZED");
		...
		{
			return new CompressorDieselEngine(this);
		}
	}
}
