...
namespace Rewired.Utils
{
	public static class EnumTools
	{
		...
		public static bool ConvertByName<TEnumFrom, TEnumTo>(TEnumFrom convertFrom, out TEnumTo value) where TEnumFrom : struct, IFormattable, IComparable where TEnumTo : struct, IComparable, IFormattable
		{
