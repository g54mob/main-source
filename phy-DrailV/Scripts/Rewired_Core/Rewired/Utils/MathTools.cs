...
namespace Rewired.Utils
{
	...
	{
		private const float FUVxaQxlcxjRFFdRZXXAVYBdSaZx = 1E-10f;

		private const double qCbyFfetJxkdBmHluSBDFjTFTaPw = 1E-10;

		private const float HbNmsjAelpYjnHXTXoIhuXjAFwZH = 0.0001f;
		...
		internal static bool IjhDMiBzAbbqETDrZFRybpPkwDpLA(int P_0, int P_1)
		{
			if (P_0 == 0 && P_1 == 0)
			{
				return false;
		...
		private static bool jLGePukrKKgbZCycDaaOlzLXGtog(Vector2 P_0, Vector2 P_1, Vector2 P_2, Vector2 P_3, out Vector2 P_4)
		{
