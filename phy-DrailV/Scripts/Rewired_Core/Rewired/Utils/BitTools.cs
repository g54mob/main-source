...
namespace Rewired.Utils
{
	...
	{
		private static byte[] qBaeYAgpwcUqMOqapgFUFMjOUhajA;

		private static byte[] intToFloatBuffer => qBaeYAgpwcUqMOqapgFUFMjOUhajA ?? (qBaeYAgpwcUqMOqapgFUFMjOUhajA = new byte[4]);
