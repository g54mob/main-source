...
namespace Rewired
{
	...
	public sealed class AxisCalibration
	{
		...
		{
			0,
			AxisCalibrationInfo.KhZBUUarFrRZcHDnnPQpcsbfMtUaB(AxisCalibrationData.Default)
		} };
		...
		private void CreateDefaultHardwareCalibration(AxisCalibrationData defaultData)
		{
			...
			{
				AxisCalibrationInfo value = AxisCalibrationInfo.KhZBUUarFrRZcHDnnPQpcsbfMtUaB(defaultData);
