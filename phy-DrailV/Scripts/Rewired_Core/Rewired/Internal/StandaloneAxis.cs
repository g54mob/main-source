...
namespace Rewired.Internal
{
	...
	internal sealed class StandaloneAxis
	{
		...
		[CompilerGenerated]
		private AxisValueChangedEventHandler qOAraJNLsScTmDedlGfRPjzQFgad;

		[CompilerGenerated]
		private AxisValueChangedEventHandler IiUKiOaaulAeiCOwLaqJoqgpGhXib;

		[CompilerGenerated]
		private ButtonDownEventHandler ZDwXMNPrHuLcbQFQeoHGGPxNAAcm;

		[CompilerGenerated]
		private ButtonUpEventHandler dgPRqQaZUyaSxMYNRanqQzhrmTKD;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler vMmgjbwXwMpyrguYGPeJWBFiFyFW;

		[CompilerGenerated]
		private ButtonDownEventHandler jbkkxjwpZaYKKNxlnkirlZInoMtI;

		[CompilerGenerated]
		private ButtonUpEventHandler gCpfhhEsyFNPYWqoPXqESCftHlneA;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler yFGhbHWXbfnmskqmMnwBwBwFCrxO;
		...
		private event AxisValueChangedEventHandler _AxisValueChangedEvent
		{
			...
			add
			{
				AxisValueChangedEventHandler axisValueChangedEventHandler = qOAraJNLsScTmDedlGfRPjzQFgad;
				...
				do
				{
					...
					axisValueChangedEventHandler = Interlocked.CompareExchange(ref qOAraJNLsScTmDedlGfRPjzQFgad, axisValueChangedEventHandler3, axisValueChangedEventHandler2);
				}
		...
		private event AxisValueChangedEventHandler _RawAxisValueChangedEvent
		{
			...
			add
			{
				AxisValueChangedEventHandler axisValueChangedEventHandler = IiUKiOaaulAeiCOwLaqJoqgpGhXib;
				AxisValueChangedEventHandler axisValueChangedEventHandler2;
				do
				{
					axisValueChangedEventHandler2 = axisValueChangedEventHandler;
					AxisValueChangedEventHandler axisValueChangedEventHandler3 = (AxisValueChangedEventHandler)Delegate.Combine(axisValueChangedEventHandler2, b);
					axisValueChangedEventHandler = Interlocked.CompareExchange(ref IiUKiOaaulAeiCOwLaqJoqgpGhXib, axisValueChangedEventHandler3, axisValueChangedEventHandler2);
				}
				while ((object)axisValueChangedEventHandler != axisValueChangedEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonDownEventHandler _ButtonDownEvent
		{
			...
			add
			{
				ButtonDownEventHandler buttonDownEventHandler = ZDwXMNPrHuLcbQFQeoHGGPxNAAcm;
				...
				do
				{
					...
					buttonDownEventHandler = Interlocked.CompareExchange(ref ZDwXMNPrHuLcbQFQeoHGGPxNAAcm, buttonDownEventHandler3, buttonDownEventHandler2);
				}
		...
		private event ButtonUpEventHandler _ButtonUpEvent
		{
			...
			add
			{
				ButtonUpEventHandler buttonUpEventHandler = dgPRqQaZUyaSxMYNRanqQzhrmTKD;
				...
				do
				{
					...
					buttonUpEventHandler = Interlocked.CompareExchange(ref dgPRqQaZUyaSxMYNRanqQzhrmTKD, buttonUpEventHandler3, buttonUpEventHandler2);
				}
		...
		private event ButtonValueChangedEventHandler _ButtonValueChangedEvent
		{
			...
			add
			{
				ButtonValueChangedEventHandler buttonValueChangedEventHandler = vMmgjbwXwMpyrguYGPeJWBFiFyFW;
				...
				do
				{
					...
					buttonValueChangedEventHandler = Interlocked.CompareExchange(ref vMmgjbwXwMpyrguYGPeJWBFiFyFW, buttonValueChangedEventHandler3, buttonValueChangedEventHandler2);
				}
		...
		private event ButtonDownEventHandler _RawButtonDownEvent
		{
			...
			add
			{
				ButtonDownEventHandler buttonDownEventHandler = jbkkxjwpZaYKKNxlnkirlZInoMtI;
				ButtonDownEventHandler buttonDownEventHandler2;
				do
				{
					buttonDownEventHandler2 = buttonDownEventHandler;
					ButtonDownEventHandler buttonDownEventHandler3 = (ButtonDownEventHandler)Delegate.Combine(buttonDownEventHandler2, b);
					buttonDownEventHandler = Interlocked.CompareExchange(ref jbkkxjwpZaYKKNxlnkirlZInoMtI, buttonDownEventHandler3, buttonDownEventHandler2);
				}
				while ((object)buttonDownEventHandler != buttonDownEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonUpEventHandler _RawButtonUpEvent
		{
			...
			add
			{
				ButtonUpEventHandler buttonUpEventHandler = gCpfhhEsyFNPYWqoPXqESCftHlneA;
				ButtonUpEventHandler buttonUpEventHandler2;
				do
				{
					buttonUpEventHandler2 = buttonUpEventHandler;
					ButtonUpEventHandler buttonUpEventHandler3 = (ButtonUpEventHandler)Delegate.Combine(buttonUpEventHandler2, b);
					buttonUpEventHandler = Interlocked.CompareExchange(ref gCpfhhEsyFNPYWqoPXqESCftHlneA, buttonUpEventHandler3, buttonUpEventHandler2);
				}
				while ((object)buttonUpEventHandler != buttonUpEventHandler2);
			}
			[CompilerGenerated]
		...
		private event ButtonValueChangedEventHandler _RawButtonValueChangedEvent
		{
			...
			add
			{
				ButtonValueChangedEventHandler buttonValueChangedEventHandler = yFGhbHWXbfnmskqmMnwBwBwFCrxO;
				ButtonValueChangedEventHandler buttonValueChangedEventHandler2;
				do
				{
					buttonValueChangedEventHandler2 = buttonValueChangedEventHandler;
					ButtonValueChangedEventHandler buttonValueChangedEventHandler3 = (ButtonValueChangedEventHandler)Delegate.Combine(buttonValueChangedEventHandler2, b);
					buttonValueChangedEventHandler = Interlocked.CompareExchange(ref yFGhbHWXbfnmskqmMnwBwBwFCrxO, buttonValueChangedEventHandler3, buttonValueChangedEventHandler2);
				}
				while ((object)buttonValueChangedEventHandler != buttonValueChangedEventHandler2);
			}
			[CompilerGenerated]
		...
		public void SetRawValue(float value)
		{
			...
			if (IiUKiOaaulAeiCOwLaqJoqgpGhXib != null && _valueRaw != _valueRawPrev)
			{
				IiUKiOaaulAeiCOwLaqJoqgpGhXib(_valueRaw);
			}
			if (qOAraJNLsScTmDedlGfRPjzQFgad != null)
			{
				float num = this.value;
				if (num != valuePrev)
				{
					qOAraJNLsScTmDedlGfRPjzQFgad(num);
				}
			}
			if (yFGhbHWXbfnmskqmMnwBwBwFCrxO != null)
			{
				bool flag = rawButtonValue;
				if (flag != rawButtonValuePrev)
				{
					yFGhbHWXbfnmskqmMnwBwBwFCrxO(flag);
				}
			}
			if (jbkkxjwpZaYKKNxlnkirlZInoMtI != null && rawButtonValue && !rawButtonValuePrev)
			{
				jbkkxjwpZaYKKNxlnkirlZInoMtI();
			}
			if (gCpfhhEsyFNPYWqoPXqESCftHlneA != null && !rawButtonValue && rawButtonValuePrev)
			{
				gCpfhhEsyFNPYWqoPXqESCftHlneA();
			}
			if (vMmgjbwXwMpyrguYGPeJWBFiFyFW != null)
			{
				bool flag2 = buttonValue;
				if (flag2 != buttonValuePrev)
				{
					vMmgjbwXwMpyrguYGPeJWBFiFyFW(flag2);
				}
			}
			if (ZDwXMNPrHuLcbQFQeoHGGPxNAAcm != null && buttonValue && !buttonValuePrev)
			{
				ZDwXMNPrHuLcbQFQeoHGGPxNAAcm();
			}
			if (dgPRqQaZUyaSxMYNRanqQzhrmTKD != null && !buttonValue && buttonValuePrev)
			{
				dgPRqQaZUyaSxMYNRanqQzhrmTKD();
			}
		}
