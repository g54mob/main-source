...
namespace Rewired
{
	...
	{
		private const string fMRkcWrLnRGjyKxosFrGgvLoglTeA = "[^a-fA-F0-9]";
		...
		{
			if (string.IsNullOrEmpty(nkmcilNiaHxjCmLbZHCrFQsGLkvSA(P_0)))
			{
				productId = 0;
				vendorId = 0;
				return;
		...
		{
			return QjIEGkOakvryRtnSySaEsSYZRcTl(nkmcilNiaHxjCmLbZHCrFQsGLkvSA(pidVid));
		}
		...
		private bool QjIEGkOakvryRtnSySaEsSYZRcTl(string P_0)
		{
		...
		private static string nkmcilNiaHxjCmLbZHCrFQsGLkvSA(string P_0)
		{
