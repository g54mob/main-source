	...
	public class RotateAroundAxis : MonoBehaviour
	{
		...
		private void Update()
		{
			if (_speed != Speed.Stopped)
			{
				...
				base.transform.Rotate(yXoFDEtNtmJIEBbCXeeHYToGidQf(_rotateAroundAxis), num * Time.deltaTime, _relativeTo);
			}
		}

		private static Vector3 yXoFDEtNtmJIEBbCXeeHYToGidQf(RotationAxis P_0)
		{
			switch (P_0)
			{
			case RotationAxis.X:
