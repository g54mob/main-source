...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class LfIyRKeekpFxRxbxppWxWtnPTSdH : IControllerExtensionSource
		{
			public readonly IDriver_DualShock4 yDAUNClHHiAuOvIuDIwdGGkWSXRe;

			public readonly bool rPrsppgJoLZNESoZrflzwqCEQiFO;

			public readonly int gExXpPJRmQHjBkMeRNtbKgelRgwx;

			public LfIyRKeekpFxRxbxppWxWtnPTSdH(IDriver_DualShock4 P_0, bool P_1, int P_2)
			{
		...
		private LfIyRKeekpFxRxbxppWxWtnPTSdH CLFHWOuPSRLahPSSrSHZoiqMbYrk;
		...
		internal DualShock4Extension(IDriver_DualShock4 P_0)
			: base(new LfIyRKeekpFxRxbxppWxWtnPTSdH(P_0, P_0.VibrationMotorCount > 0, P_0.VibrationMotorCount))
		{
		...
		public void SetLightFlash(float onDuration, float offDuration)
		{
			...
			{
				CLFHWOuPSRLahPSSrSHZoiqMbYrk.yDAUNClHHiAuOvIuDIwdGGkWSXRe.LightFlashOnDuration = onDuration;
				CLFHWOuPSRLahPSSrSHZoiqMbYrk.yDAUNClHHiAuOvIuDIwdGGkWSXRe.LightFlashOffDuration = offDuration;
			}
		}
		...
		public void StopLightFlash()
		{
			...
			{
				CLFHWOuPSRLahPSSrSHZoiqMbYrk.yDAUNClHHiAuOvIuDIwdGGkWSXRe.StopLightFlash();
			}
		}
		...
		{
			CLFHWOuPSRLahPSSrSHZoiqMbYrk = source as LfIyRKeekpFxRxbxppWxWtnPTSdH;
