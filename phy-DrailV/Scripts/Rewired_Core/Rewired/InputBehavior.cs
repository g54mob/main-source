...
namespace Rewired
{
	...
	public sealed class InputBehavior
	{
		...
		public InputBehavior(InputBehavior P_0)
			: this()
		{
			OfkYXSZaaSReachpLzirDCqwmkvh(P_0, this, true);
		}
		...
		public string ToXmlString()
		{
			try
			{
				return EJxtACRHfDNsXlhCcxXfUczVKMbH().ToXmlString(writeDocumentTag: true);
			}
			catch (Exception ex)
			{
		...
		public bool ImportXmlString(string xmlString)
		{
			try
			{
				fXJhwIZKtELGREjQzTciWYEPtzom(SerializedObject.FromXml(GetType(), xmlString));
				return true;
			}
			catch (Exception ex)
			{
		...
		public string ToJsonString()
		{
			try
			{
				return EJxtACRHfDNsXlhCcxXfUczVKMbH().ToJsonString();
			}
			catch (Exception ex)
			{
		...
		public bool ImportJsonString(string jsonString)
		{
			try
			{
				fXJhwIZKtELGREjQzTciWYEPtzom(SerializedObject.FromJson(GetType(), jsonString));
				return true;
			}
			catch (Exception ex)
			{
		...
		public bool ImportData(InputBehavior inputBehavior)
		{
			...
			OfkYXSZaaSReachpLzirDCqwmkvh(inputBehavior, this, false);
			return true;
		}
		...
		public void Reset()
		{
			InputBehavior inputBehavior = ReInput.mapping.CKWdEEaYCOciRYXzWzDAiIAPSDMgb(_id);
			if (inputBehavior != null)
			{
				OfkYXSZaaSReachpLzirDCqwmkvh(inputBehavior, this, true);
			}
		}

		internal SerializedObject EJxtACRHfDNsXlhCcxXfUczVKMbH()
		{
			...
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.FTFUnSdjCkoGMcOadgOCoYMlThuL
			{
				...
				ANnyYrpgRHgHrBXsbJxMFrsUzupD = 5.ToString()
			});
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.FTFUnSdjCkoGMcOadgOCoYMlThuL
			{
				uEkKFXXRykNWeZGsmzkXBCXWCSXG = "id",
				ANnyYrpgRHgHrBXsbJxMFrsUzupD = _id.ToString()
			});
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.FTFUnSdjCkoGMcOadgOCoYMlThuL
			{
			...
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.FTFUnSdjCkoGMcOadgOCoYMlThuL
			{
				...
				bQsOsCQXaUMzqJWgNvgeirDgvXAS = null,
				ANnyYrpgRHgHrBXsbJxMFrsUzupD = string.Format("{0} {1}{2}{3}{4}{5}", "http://guavaman.com/rewired", "http://guavaman.com/schemas/rewired/", "1.4", "/", GetType().Name, ".xsd")
			});
		...
		internal void fXJhwIZKtELGREjQzTciWYEPtzom(SerializedObject P_0)
		{
			Reset();
		...
		private static void OfkYXSZaaSReachpLzirDCqwmkvh(InputBehavior P_0, InputBehavior P_1, bool P_2)
		{
			if (P_2)
			{
				P_1._id = P_0._id;
