...
namespace Rewired.Data.Mapping
{
	...
	public class AxisCalibrationInfo : IDeepCloneable
	{
		...
		internal static AxisCalibrationData YdsLNQNMXXhRpOwrHHjQvjlcCcAI(AxisCalibrationInfo P_0)
		{
			if (P_0 == null)
			{
		...
		internal static AxisCalibrationInfo KhZBUUarFrRZcHDnnPQpcsbfMtUaB(AxisCalibrationData P_0)
		{
