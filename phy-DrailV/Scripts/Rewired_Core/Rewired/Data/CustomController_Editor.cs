...
namespace Rewired.Data
{
	...
	public sealed class CustomController_Editor
	{
		...
		private sealed class vlNIbeClmFRAsTwuKQdbNrGtRyQc : IDisposable, IEnumerable, IEnumerator, IEnumerable<ControllerElementIdentifier>, IEnumerator<ControllerElementIdentifier>
		{
			...
			public CustomController_Editor zITtixdgVFWlEnpDnrTdnZsdTFkt;
			...
			[DebuggerHidden]
			public vlNIbeClmFRAsTwuKQdbNrGtRyQc(int P_0)
			{
			...
			private bool MoveNext()
			{
				...
				CustomController_Editor customController_Editor = zITtixdgVFWlEnpDnrTdnZsdTFkt;
				switch (num)
				{
				default:
					return false;
				...
				if (XFqmAWzGaybkkIOLbVBNhzaWDOgGA < customController_Editor._elementIdentifiers.Count)
				{
					vjnbYLtrPMftzpjohNfommerCnGo = customController_Editor._elementIdentifiers[XFqmAWzGaybkkIOLbVBNhzaWDOgGA];
					hMnbMujJvihgLcBmOvURwCGCKZDT = 1;
					return true;
				}
				return false;
			...
			{
				vlNIbeClmFRAsTwuKQdbNrGtRyQc vlNIbeClmFRAsTwuKQdbNrGtRyQc2;
				if (hMnbMujJvihgLcBmOvURwCGCKZDT == -2 && AyagikQIJAatoHzFlyaifyWyaTktA == Thread.CurrentThread.ManagedThreadId)
				{
					...
					vlNIbeClmFRAsTwuKQdbNrGtRyQc2 = this;
				}
				else
				{
					vlNIbeClmFRAsTwuKQdbNrGtRyQc2 = new vlNIbeClmFRAsTwuKQdbNrGtRyQc(0);
					vlNIbeClmFRAsTwuKQdbNrGtRyQc2.zITtixdgVFWlEnpDnrTdnZsdTFkt = zITtixdgVFWlEnpDnrTdnZsdTFkt;
				}
				return vlNIbeClmFRAsTwuKQdbNrGtRyQc2;
			}
		...
		public IEnumerable<ControllerElementIdentifier> ElementIdentifiers => new vlNIbeClmFRAsTwuKQdbNrGtRyQc(-2)
		{
		...
		public void AddAxis()
		{
			axes.Add((Axis)MQhrMCUcQgERNLamJWYXYaLtOMnO(ControllerElementType.Axis));
		}

		public void AddButton()
		{
			buttons.Add((Button)MQhrMCUcQgERNLamJWYXYaLtOMnO(ControllerElementType.Button));
		}
		...
		public void InsertAxis(int index)
		{
			...
			axes.Insert(index, (Axis)MQhrMCUcQgERNLamJWYXYaLtOMnO(ControllerElementType.Axis));
		}
		...
		public void InsertButton(int index)
		{
			...
			buttons.Insert(index, (Button)MQhrMCUcQgERNLamJWYXYaLtOMnO(ControllerElementType.Button));
		}
		...
		public void DuplicateElement(ControllerElementType type, int index)
		{
			...
			{
			case ControllerElementType.Axis:
				FuacpajmemlzXaUWmlcmqBTGXwvq(index, axes);
				break;
			case ControllerElementType.Button:
				FuacpajmemlzXaUWmlcmqBTGXwvq(index, buttons);
				break;
			default:
				throw new NotImplementedException();
			}
		...
		private void FuacpajmemlzXaUWmlcmqBTGXwvq<_0001>(int P_0, List<_0001> P_1) where _0001 : Element
		{
			...
			ControllerElementIdentifier controllerElementIdentifier = KeSBEdUtATLCdeYnNjWBZnpFcKKx(val.elementIdentifierId, text);
		...
		private ControllerElementIdentifier KeSBEdUtATLCdeYnNjWBZnpFcKKx(int P_0, string P_1)
		{
			...
			ControllerElementIdentifier controllerElementIdentifier = new ControllerElementIdentifier(new ControllerElementIdentifier.tFlDtgfYnOzWvNSCbItkRRpZbpCKA
			{
				...
				name = P_1,
				positiveName = _elementIdentifiers[num].positiveName,
				negativeName = _elementIdentifiers[num].negativeName,
		...
		private Element MQhrMCUcQgERNLamJWYXYaLtOMnO(ControllerElementType P_0)
		{
			switch (P_0)
			{
			case ControllerElementType.Axis:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier2 = HutFTrgdVYtoAsBuuFBMkuUciFrvA(P_0, text2, string.Empty, string.Empty, key, string.Empty, string.Empty);
			...
			case ControllerElementType.Button:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier = HutFTrgdVYtoAsBuuFBMkuUciFrvA(P_0, text, string.Empty, string.Empty, key, string.Empty, string.Empty);
		...
		private ControllerElementIdentifier HutFTrgdVYtoAsBuuFBMkuUciFrvA(ControllerElementType P_0, string P_1, string P_2, string P_3, string P_4, string P_5, string P_6)
		{
			int elementIdentifierIdCounter = _elementIdentifierIdCounter;
			_elementIdentifierIdCounter++;
			ControllerElementIdentifier controllerElementIdentifier = new ControllerElementIdentifier(new ControllerElementIdentifier.tFlDtgfYnOzWvNSCbItkRRpZbpCKA
