...
namespace Rewired.Data
{
	...
	{
		private static class oyAsVMmuKXPvYvflRFHBHneEPqBvA
		{
			public const string duvdeoIMbviHBoTTDYZbkoEpbLKZA = "updateLoop";

			public const string wLUqueEIEqnAcHBlsmTFbRsCOdtN = "alwaysUseUnityInput";

			public const string XlPAjjBpWRyJpoRFDxHMKdsJWBJsA = "windowsStandalonePrimaryInputSource";

			public const string MVNrpBvTHXFYjjnuFNQxlySmPpcj = "osx_primaryInputSource";

			public const string DdEgQtEWZzbOwydDMNKIbQkKloLtb = "linux_primaryInputSource";

			public const string oINXiBHZYzIVRXeSxCZgRxxtIWES = "windowsUWP_primaryInputSource";

			public const string pdIsitFxZYpYkMuqQQHBqRcXpbbJ = "xboxOne_primaryInputSource";

			public const string OqqHQjyhYFWczbaCJDpXDPeXdKZs = "gameCoreXboxOne_primaryInputSource";

			public const string eqJtKcvMniixzABdasLLcJMmGYun = "gameCoreScarlett_primaryInputSource";

			public const string LCtiWdklCOGiSbvJrpOVfqWiNiNxB = "ps4_primaryInputSource";

			public const string JhUhhGkpJVMXKdJglQentBpxBQwd = "ps5_primaryInputSource";

			public const string OUSgkJBejKhKPipJtIWAIfKdekZz = "webGL_primaryInputSource";

			public const string azmCkVhHJlFkCcJeQbPxVzKpndmo = "useXInput";

			public const string JgQXPJUDENVXEDvbRyHIeWJfsmDJ = "windowsStandalone_useSteamRawInputControllerWorkaround";

			public const string cGWYPCBCPeduHiiaIpfwWtovcHUeb = "osxStandalone_useEnhancedDeviceSupport";

			public const string AYPnQBCFknJOyYFlSQymxWaXAKXr = "android_supportUnknownGamepads";

			public const string kSvdhHgkXkGtgzgZsSufmIdMwWiT = "ps4_assignJoysticksByPS4JoyId";

			public const string QqJtNpgIjGEWyKbUCFcWhkjRfEHeb = "useSteamControllerSupport";

			public const string yUokfNACzSxBuEicbBiKkZNULqQPA = "logToScreen";

			public const string LGPFyrBspBYtCqJfyaxnSFGrfCSz = "runInEditMode";

			public const string GNNdjdbYZtnKUEQfZFaxHeDcgEif = "allowInputInEditorSceneView";

			public const string rnJCunHMEpmBfkieGOfPKivoXNBdA = "maxJoysticksPerPlayer";

			public const string tSQbQnGvHjSyYKUezdMYIfcIMjEkc = "autoAssignJoysticks";

			public const string lSPaZmhtYkWoVKhZWDqwCHUuMbPh = "assignJoysticksToPlayingPlayersOnly";

			public const string SClluHwnVIDGGDvNCoCIgSdMlvNN = "distributeJoysticksEvenly";

			public const string PWHfNKorsinneTJMOoozoFTxMKMe = "reassignJoystickToPreviousOwnerOnReconnect";

			public const string rksphxWHvtCRDluLLjcjKEGQsoOc = "defaultJoystickAxis2DDeadZoneType";

			public const string wNHWSYwfyoTNTrEnppPiWCWscwiy = "defaultJoystickAxis2DSensitivityType";

			public const string MFrdNJaYKKvktSgWJiNBwMbzjKLG = "defaultAxisSensitivityType";

			public const string tuXGRnSEWKrjbyYbEoGDdugrIahd = "force4WayHats";

			public const string hVBdfBzwqtGLCivkvVwVXBBVzpuQ = "throttleCalibrationMode";

			public const string jCiuVdHGODilvQPjlbaYDlQdSVuC = "activateActionButtonsOnNegativeValue";

			public const string fizRzcCrvNjNRVgKOORRnKXSVLcu = "deferControllerConnectedEventsOnStart";

			public const string VKYwaRAvPwlQLsamJGZtFfCWmggEA = "logLevel";

			public const string KxrZuoATYlgFVtajzuOLAnbluTTq = "disableKeyboard";

			public const string CNVaHLQRlDdBtcXJDcbaErjLxruNA = "disableMouse";

			public const string GKAfSEPYEtuHTHkqpTipMTdQUPEA = "ignoreInputWhenAppNotInFocus";

			public const string HphLTiGePEoqitSHpAiMpENLZNTu = "useEnhancedDeviceSupport";

			public const string ZJgduhBtrtCcjgRgVRnHGcqEfuvH = "useNativeMouse";

			public const string wvEHlWbFixfaXMwSlwFwRYTXxYq = "useNativeKeyboard";

			public const string kSiAsNSMLcSdorefloEXBeQVkHHe = "joystickRefreshRate";

			public const string MYKQbAMnRGTqyhPMCBPkaebvdNut = "assignJoysticksBySystemId";
		}
		...
		private class kxZgnzQjJndijpKnVlTIIinoLSxU
		{
			public Func<PlatformVars> oqlolmCmAQLFmcoeHHpkaPdJXFIT;

			public string EErZvFSgDsGKabIdkgAFZbZoPZVaA;

			public kxZgnzQjJndijpKnVlTIIinoLSxU(Func<PlatformVars> P_0, string P_1)
			{
				oqlolmCmAQLFmcoeHHpkaPdJXFIT = P_0;
				EErZvFSgDsGKabIdkgAFZbZoPZVaA = P_1;
			}
		}

		private class hBMLFZZvdRjWtHjLTdLjAfxnMDUo
		{
			public Func<Platform, object> oqlolmCmAQLFmcoeHHpkaPdJXFIT;

			public Action<Platform, object> yfUsYmajIGGvBIOoIGlhrvLXpjQX;

			public hBMLFZZvdRjWtHjLTdLjAfxnMDUo(Func<Platform, object> P_0, Action<Platform, object> P_1)
			{
				oqlolmCmAQLFmcoeHHpkaPdJXFIT = P_0;
				yfUsYmajIGGvBIOoIGlhrvLXpjQX = P_1;
			}
		}
		...
		private Dictionary<int, kxZgnzQjJndijpKnVlTIIinoLSxU> __platformVarsDict;

		private Dictionary<int, hBMLFZZvdRjWtHjLTdLjAfxnMDUo> __getSetPlatformVariableDict;

		private KeyedGetSetValueStore<string> __configVarsValues;

		private Dictionary<string, object> __valueDelegates;

		private Dictionary<int, kxZgnzQjJndijpKnVlTIIinoLSxU> platformVarsDict
		{
			get
			{
				Dictionary<int, kxZgnzQjJndijpKnVlTIIinoLSxU> dictionary = __platformVarsDict;
				if (dictionary == null)
				{
					Dictionary<int, kxZgnzQjJndijpKnVlTIIinoLSxU> obj = new Dictionary<int, kxZgnzQjJndijpKnVlTIIinoLSxU>
					{
						{
							1,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_windowsStandalone), "platformVars_windowsStandalone")
						},
						{
							29,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_windowsUWP), "platformVars_windowsUWP")
						},
						{
							6,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_linuxStandalone), "platformVars_linuxStandalone")
						},
						{
							4,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_osxStandalone), "platformVars_osxStandalone")
						},
						{
							5,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_iOS), "platformVars_iOS")
						},
						{
							28,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_tvOS), "platformVars_tvOS")
						},
						{
							13,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_ps4), "platformVars_ps4")
						},
						{
							106,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_ps5), "platformVars_ps5")
						},
						{
							15,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_psVita), "platformVars_psVita")
						},
						{
							14,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_psVita), "platformVars_psVita")
						...
						{
							32,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_switch), "platformVars_switch")
						},
						{
							11,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_xboxOne), "platformVars_xboxOne")
						},
						{
							104,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_gameCoreXboxOne), "platformVars_gameCoreXboxOne")
						},
						{
							105,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_gameCoreScarlett), "platformVars_gameCoreScarlett")
						},
						{
							19,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_webGL), "platformVars_webGL")
						},
						{
							7,
							new kxZgnzQjJndijpKnVlTIIinoLSxU(() => GetOrCreatePlatformVars(ref platformVars_android), "platformVars_android")
						}
					};
					Dictionary<int, kxZgnzQjJndijpKnVlTIIinoLSxU> dictionary2 = obj;
		...
		private Dictionary<int, hBMLFZZvdRjWtHjLTdLjAfxnMDUo> getSetPlatformVariableDict
		{
			get
			{
				Dictionary<int, hBMLFZZvdRjWtHjLTdLjAfxnMDUo> dictionary = __getSetPlatformVariableDict;
				if (dictionary == null)
				{
					Dictionary<int, hBMLFZZvdRjWtHjLTdLjAfxnMDUo> obj = new Dictionary<int, hBMLFZZvdRjWtHjLTdLjAfxnMDUo>
					{
						{
							0,
							new hBMLFZZvdRjWtHjLTdLjAfxnMDUo((Platform p) => GetPlatformVars(p).disableKeyboard, delegate(Platform platform, object value)
							{
						...
						{
							2,
							new hBMLFZZvdRjWtHjLTdLjAfxnMDUo((Platform p) => GetPlatformVars(p).disableMouse, delegate(Platform platform, object value)
							{
						...
						{
							1,
							new hBMLFZZvdRjWtHjLTdLjAfxnMDUo((Platform platform) => GetPlatformVars(platform).ignoreInputWhenAppNotInFocus, delegate(Platform platform, object value)
							{
								GetPlatformVars(platform).ignoreInputWhenAppNotInFocus = (bool)value;
							})
						}
					};
					Dictionary<int, hBMLFZZvdRjWtHjLTdLjAfxnMDUo> dictionary2 = obj;
		...
		internal string GetPlatformVarsRelPath(Platform platform)
		{
			...
			{
				return platformVarsDict[(int)platform].EErZvFSgDsGKabIdkgAFZbZoPZVaA;
			}
		...
		{
			PlatformVars platformVars = ((platform == Platform.Custom && xfQMULbDolNOSljfhItZwOwIzFQO.SYETLKcbFhUFoZVjYnuOpkJSSgOW) ? xfQMULbDolNOSljfhItZwOwIzFQO.uhvilvmvTTcLTABDCbwhEqTsDJNb() : ((!platformVarsDict.ContainsKey((int)platform)) ? GetOrCreatePlatformVars(ref platformVars_unknown) : platformVarsDict[(int)platform].oqlolmCmAQLFmcoeHHpkaPdJXFIT()));
		...
		{
			foreach (KeyValuePair<int, kxZgnzQjJndijpKnVlTIIinoLSxU> item in platformVarsDict)
			{
				if (getSetPlatformVariableDict.ContainsKey((int)var))
				{
					getSetPlatformVariableDict[(int)var].yfUsYmajIGGvBIOoIGlhrvLXpjQX((Platform)item.Key, value);
				}
			}
		}
		...
		internal bool SetPlatformVar_useNativeMouse(bool value)
		{
			...
			case Platform.Custom:
				...
				{
					xfQMULbDolNOSljfhItZwOwIzFQO.uhvilvmvTTcLTABDCbwhEqTsDJNb().useNativeMouse = value;
					return true;
				}
				return false;
			default:
		...
		internal bool SetPlatformVar_useNativeKeyboard(bool value)
		{
			...
			case Platform.Custom:
				if (xfQMULbDolNOSljfhItZwOwIzFQO.SYETLKcbFhUFoZVjYnuOpkJSSgOW)
				{
					xfQMULbDolNOSljfhItZwOwIzFQO.uhvilvmvTTcLTABDCbwhEqTsDJNb().useNativeKeyboard = value;
					return true;
				}
				return false;
			default:
		...
		private MultiBoolValue GetAllSerializedPlatformVar_multiBool(AllPlatformVar var)
		{
			...
			foreach (KeyValuePair<int, kxZgnzQjJndijpKnVlTIIinoLSxU> item in platformVarsDict)
			{
				...
				object obj = getSetPlatformVariableDict[(int)var].oqlolmCmAQLFmcoeHHpkaPdJXFIT((Platform)item.Key);
				if (obj == null)
				{
					continue;
				}
