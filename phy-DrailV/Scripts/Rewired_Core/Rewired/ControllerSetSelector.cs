...
namespace Rewired
{
	...
	public sealed class ControllerSetSelector : ISerializationCallbackReceiver, IDeepCloneable
	{
		...
		[NonSerialized]
		private Guid ETEgHfDBaawBVnWppIFUeMrRdcWeA;

		internal bool kiIGvaThynAiCmqTBXVLsLCgVYKH => _type != Type.All;
		...
		public Guid hardwareTypeGuid
		{
			get
			{
				...
				return ETEgHfDBaawBVnWppIFUeMrRdcWeA;
			}
			set
			{
				...
				ETEgHfDBaawBVnWppIFUeMrRdcWeA = value;
		...
		public ControllerSetSelector(ControllerSetSelector P_0)
		{
			...
			ETEgHfDBaawBVnWppIFUeMrRdcWeA = P_0.ETEgHfDBaawBVnWppIFUeMrRdcWeA;
		}
		...
		internal ControllerSetSelector(Type P_0, ControllerType P_1, string P_2, string P_3, int P_4)
		{
			...
			_controllerType = P_1;
			_guid = P_2;
			ETEgHfDBaawBVnWppIFUeMrRdcWeA = StringTools.ToGuid(P_2);
		...
		public bool Matches(Controller controller)
		{
			...
			case Type.HardwareType:
				if (ETEgHfDBaawBVnWppIFUeMrRdcWeA != Guid.Empty)
				{
					return ETEgHfDBaawBVnWppIFUeMrRdcWeA == controller.hardwareTypeGuid;
				}
			...
			case Type.ControllerTemplateType:
				return controller.ImplementsTemplate(ETEgHfDBaawBVnWppIFUeMrRdcWeA);
			case Type.PersistentControllerInstance:
				return controller.deviceInstanceGuid == ETEgHfDBaawBVnWppIFUeMrRdcWeA;
		...
		private void HWqDJCjqhEusgQOSLhEuhxXXcmEmA()
		{
			_guid = string.Empty;
			ETEgHfDBaawBVnWppIFUeMrRdcWeA = Guid.Empty;
		}

		void ISerializationCallbackReceiver.OnAfterDeserialize()
		{
			ETEgHfDBaawBVnWppIFUeMrRdcWeA = StringTools.ToGuid(_guid);
		}
