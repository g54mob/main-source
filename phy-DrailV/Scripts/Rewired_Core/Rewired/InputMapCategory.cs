...
namespace Rewired
{
	...
	public sealed class InputMapCategory : InputCategory
	{
		...
		internal List<int> wCAilTYMKtKpdaHmwnpOyjsEQggr => _checkConflictsCategoryIds;
		...
		internal override void zweOkwOYzJmmdPKMUZyDxJxHpxON()
		{
			base.zweOkwOYzJmmdPKMUZyDxJxHpxON();
		...
		internal override void vjLugohvsLblZuxYcbzfaOVaQPnA()
		{
			base.vjLugohvsLblZuxYcbzfaOVaQPnA();
		}
	}
}
