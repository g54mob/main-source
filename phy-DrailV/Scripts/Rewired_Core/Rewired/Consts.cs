...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static readonly Guid[] bGMDbORRTMGyfAKBcoyyhTlgHcThA;

		internal static readonly ReadOnlyCollection<Guid> reservedHardwareTypeGuids;

		private static ControllerElementIdentifier.tFlDtgfYnOzWvNSCbItkRRpZbpCKA[] wqzhJKJapOszECcLKUmCifcJuyzH;

		private static ReadOnlyCollection<ControllerElementIdentifier> pkRDIeIgJQQrbbapJaVsOMJpwgaBA;

		private static ReadOnlyCollection<ControllerElementIdentifier> uQQWikSjhEftfnUzKbpzixLpNedv;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] mlZAhShOgaMFzarkeLbTaqeTLSozB;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] BawUHoVTyZoCCXNGXqTZAHKdVoFf;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] YfIkKUoxkBiXUjbQPFAlqVrQMvRD;

		internal static readonly IList<int> keyboardKeyValues;

		internal static readonly int[] _keyboardKeyValues;

		private static readonly IList<string> OXYlpxZqzAOreongxGTyaLGpRaGOA;

		private static readonly string[] kzSFzYBtvjgEgDfytNHNvgOtuXJU;

		private static readonly IList<string> wAgGAXhAXapMlBJqaHByMKZDPhOPb;

		private static readonly string[] DwRwwOIcYsSiLlbmwtfxSDrItqWP;
		...
		private static readonly PidVid[] jhcHTJXPvqWjdOeUWaraqsANLRMS;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] ofkorcpgYCpvVwaeqbrFKkjmpytUA;

		internal static readonly IList<PidVid> pidVids_sony_dualSense;

		private static readonly PidVid[] uCKQFpKjMynFPoPQIpfYibmViCyv;

		internal static readonly IList<string> productNames_sony_dualSense;

		private static readonly string[] aIfvGGjAHsYKYkGqeAzKhtjayJOl;

		private static readonly ControllerElementIdentifier[] PXjGZGaRFdiMpRpBXkBZzbwZfFhu;
		...
		internal static ControllerElementIdentifier.tFlDtgfYnOzWvNSCbItkRRpZbpCKA[] commonMouseElementIdentifierInitOptions
		{
			get
			{
				if (wqzhJKJapOszECcLKUmCifcJuyzH != null)
				{
					return wqzhJKJapOszECcLKUmCifcJuyzH;
				}
				wqzhJKJapOszECcLKUmCifcJuyzH = new ControllerElementIdentifier.tFlDtgfYnOzWvNSCbItkRRpZbpCKA[11]
				{
					new ControllerElementIdentifier.tFlDtgfYnOzWvNSCbItkRRpZbpCKA
					{
						id = 0,
		...
		internal static IList<ControllerElementIdentifier> unityUnifiedMouseElementIdentifiers => pkRDIeIgJQQrbbapJaVsOMJpwgaBA ?? (pkRDIeIgJQQrbbapJaVsOMJpwgaBA = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[11]
		{
		...
		internal static IList<ControllerElementIdentifier> rawInputUnifiedMouseElementIdentifiers => uQQWikSjhEftfnUzKbpzixLpNedv ?? (uQQWikSjhEftfnUzKbpzixLpNedv = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[9]
		{
			new ControllerElementIdentifier(commonMouseElementIdentifierInitOptions[0]),
			new ControllerElementIdentifier(commonMouseElementIdentifierInitOptions[1]),
			new ControllerElementIdentifier(commonMouseElementIdentifierInitOptions[2]),
		...
		public static IList<string> keyboardKeyKeys => OXYlpxZqzAOreongxGTyaLGpRaGOA;

		public static IList<string> keyboardModifierKeyKeys => wAgGAXhAXapMlBJqaHByMKZDPhOPb;

		internal static ControllerElementIdentifier[] unknownJoystickElementIdentifiers_orig => PXjGZGaRFdiMpRpBXkBZzbwZfFhu;
		...
		static Consts()
		{
			...
			bGMDbORRTMGyfAKBcoyyhTlgHcThA = new Guid[3] { joystickGuid_unknownController, hardwareTypeGuid_universalKeyboard, hardwareTypeGuid_universalMouse };
			mlZAhShOgaMFzarkeLbTaqeTLSozB = new string[3] { "MouseAxis1", "MouseAxis2", "MouseAxis3" };
			BawUHoVTyZoCCXNGXqTZAHKdVoFf = new string[7] { "MouseButton0", "MouseButton1", "MouseButton2", "MouseButton3", "MouseButton4", "MouseButton5", "MouseButton6" };
			YfIkKUoxkBiXUjbQPFAlqVrQMvRD = new string[132]
			{
			...
			kzSFzYBtvjgEgDfytNHNvgOtuXJU = new string[132]
			{
				"", "a", "b", "c", "d", "e", "f", "g", "h", "i",
				"j", "k", "l", "m", "n", "o", "p", "q", "r", "s",
			...
			DwRwwOIcYsSiLlbmwtfxSDrItqWP = new string[5] { "", "control", "alt", "shift", "command" };
			...
			jhcHTJXPvqWjdOeUWaraqsANLRMS = new PidVid[3]
			{
				new PidVid(1476, 1356),
				new PidVid(2976, 1356),
				new PidVid(2508, 1356)
			};
			ofkorcpgYCpvVwaeqbrFKkjmpytUA = new string[5] { "Sony Computer Entertainment Wireless Controller", "Sony Interactive Entertainment DUALSHOCK®4 USB Wireless Adaptor", "Wireless Controller", "Sony Interactive Entertainment Wireless Controller", "Wireless Controller Touchpad" };
			uCKQFpKjMynFPoPQIpfYibmViCyv = new PidVid[2]
			{
				new PidVid(3302, 1356),
				new PidVid(3570, 1356)
			};
			aIfvGGjAHsYKYkGqeAzKhtjayJOl = new string[1] { "DualSense Wireless Controller" };
			mouseAxisUnityNames = new ReadOnlyCollection<string>(mlZAhShOgaMFzarkeLbTaqeTLSozB);
			mouseButtonUnityNames = new ReadOnlyCollection<string>(BawUHoVTyZoCCXNGXqTZAHKdVoFf);
			keyboardKeyNames = new ReadOnlyCollection<string>(YfIkKUoxkBiXUjbQPFAlqVrQMvRD);
			keyboardKeyValues = new ReadOnlyCollection<int>(_keyboardKeyValues);
			OXYlpxZqzAOreongxGTyaLGpRaGOA = new ReadOnlyCollection<string>(kzSFzYBtvjgEgDfytNHNvgOtuXJU);
			wAgGAXhAXapMlBJqaHByMKZDPhOPb = new ReadOnlyCollection<string>(DwRwwOIcYsSiLlbmwtfxSDrItqWP);
			pidVids_sony_dualShock4 = new ReadOnlyCollection<PidVid>(jhcHTJXPvqWjdOeUWaraqsANLRMS);
			productNames_sony_dualShock4 = new ReadOnlyCollection<string>(ofkorcpgYCpvVwaeqbrFKkjmpytUA);
			pidVids_sony_dualSense = new ReadOnlyCollection<PidVid>(uCKQFpKjMynFPoPQIpfYibmViCyv);
			productNames_sony_dualSense = new ReadOnlyCollection<string>(aIfvGGjAHsYKYkGqeAzKhtjayJOl);
			reservedHardwareTypeGuids = new ReadOnlyCollection<Guid>(bGMDbORRTMGyfAKBcoyyhTlgHcThA);
			...
			PXjGZGaRFdiMpRpBXkBZzbwZfFhu = QnjFGPKmbBPnHTLJfydWbXhllFKI();
			if (132 != YfIkKUoxkBiXUjbQPFAlqVrQMvRD.Length)
			{
			...
			if (132 != kzSFzYBtvjgEgDfytNHNvgOtuXJU.Length)
			{
				Logger.LogError("Consts.keyboardKeyCount does not match _keyboardKeyStringKeys.Length!");
			}
		}

		private static ControllerElementIdentifier[] QnjFGPKmbBPnHTLJfydWbXhllFKI()
		{
			int num = 0;
			List<ControllerElementIdentifier> list = new List<ControllerElementIdentifier>(288);
			ControllerElementIdentifier.tFlDtgfYnOzWvNSCbItkRRpZbpCKA tFlDtgfYnOzWvNSCbItkRRpZbpCKA = new ControllerElementIdentifier.tFlDtgfYnOzWvNSCbItkRRpZbpCKA();
			for (int i = 0; i < 32; i++)
			{
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.id = num;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.name = "Axis " + i;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.positiveName = string.Empty;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.negativeName = string.Empty;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.key = LocalizationManager.ConcatenateKeyStrings("axis", i.ToString());
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.positiveKey = string.Empty;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.negativeKey = string.Empty;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.elementType = ControllerElementType.Axis;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.compoundElementType = CompoundControllerElementType.Axis2D;
				list.Add(new ControllerElementIdentifier(tFlDtgfYnOzWvNSCbItkRRpZbpCKA));
				num++;
			}
			for (int j = 0; j < 128; j++)
			{
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.id = num;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.name = "Button " + j;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.positiveName = string.Empty;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.negativeName = string.Empty;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.key = LocalizationManager.ConcatenateKeyStrings("button", j.ToString());
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.positiveKey = string.Empty;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.negativeKey = string.Empty;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.elementType = ControllerElementType.Button;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.compoundElementType = CompoundControllerElementType.Axis2D;
				list.Add(new ControllerElementIdentifier(tFlDtgfYnOzWvNSCbItkRRpZbpCKA));
				num++;
			}
			int num2 = num;
			int num3 = num + 64;
			tFlDtgfYnOzWvNSCbItkRRpZbpCKA = new ControllerElementIdentifier.tFlDtgfYnOzWvNSCbItkRRpZbpCKA();
			tFlDtgfYnOzWvNSCbItkRRpZbpCKA.elementType = ControllerElementType.Button;
			tFlDtgfYnOzWvNSCbItkRRpZbpCKA.compoundElementType = CompoundControllerElementType.Axis2D;
			for (int k = 0; k < 16; k++)
			{
				string a = LocalizationManager.ConcatenateKeyStrings("hat", k.ToString());
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.id = num2++;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.name = "Hat " + k + " Up";
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.key = LocalizationManager.AppendToKeyAsPath(a, "up");
				list.Add(new ControllerElementIdentifier(tFlDtgfYnOzWvNSCbItkRRpZbpCKA));
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.id = num3++;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.name = "Hat " + k + " Up Right";
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.key = LocalizationManager.AppendToKeyAsPath(a, "up_right");
				list.Add(new ControllerElementIdentifier(tFlDtgfYnOzWvNSCbItkRRpZbpCKA));
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.id = num2++;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.name = "Hat " + k + " Right";
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.key = LocalizationManager.AppendToKeyAsPath(a, "right");
				list.Add(new ControllerElementIdentifier(tFlDtgfYnOzWvNSCbItkRRpZbpCKA));
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.id = num3++;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.name = "Hat " + k + " Down Right";
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.key = LocalizationManager.AppendToKeyAsPath(a, "down_right");
				list.Add(new ControllerElementIdentifier(tFlDtgfYnOzWvNSCbItkRRpZbpCKA));
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.id = num2++;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.name = "Hat " + k + " Down";
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.key = LocalizationManager.AppendToKeyAsPath(a, "down");
				list.Add(new ControllerElementIdentifier(tFlDtgfYnOzWvNSCbItkRRpZbpCKA));
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.id = num3++;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.name = "Hat " + k + " Down Left";
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.key = LocalizationManager.AppendToKeyAsPath(a, "down_left");
				list.Add(new ControllerElementIdentifier(tFlDtgfYnOzWvNSCbItkRRpZbpCKA));
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.id = num2++;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.name = "Hat " + k + " Left";
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.key = LocalizationManager.AppendToKeyAsPath(a, "left");
				list.Add(new ControllerElementIdentifier(tFlDtgfYnOzWvNSCbItkRRpZbpCKA));
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.id = num3++;
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.name = "Hat " + k + " Up Left";
				tFlDtgfYnOzWvNSCbItkRRpZbpCKA.key = LocalizationManager.AppendToKeyAsPath(a, "up_left");
				list.Add(new ControllerElementIdentifier(tFlDtgfYnOzWvNSCbItkRRpZbpCKA));
			}
			return list.ToArray();
		}
