...
namespace Cysharp.Threading.Tasks
{
	...
	public readonly struct UniTask
	{
		...
		public static UniTask Delay(TimeSpan delayTimeSpan, DelayType delayType, PlayerLoopTiming delayTiming = PlayerLoopTiming.Update, CancellationToken cancellationToken = default(CancellationToken), bool cancelImmediately = false)
		{
			...
			{
				short num3;
				return new UniTask(DelayIgnoreTimeScalePromise.Create(delayTimeSpan, delayTiming, cancellationToken, cancelImmediately, out num3), num3);
			}
			case DelayType.Realtime:
			{
				short num2;
				return new UniTask(DelayRealtimePromise.Create(delayTimeSpan, delayTiming, cancellationToken, cancelImmediately, out num2), num2);
			}
			default:
			{
				short num;
				return new UniTask(DelayPromise.Create(delayTimeSpan, delayTiming, cancellationToken, cancelImmediately, out num), num);
			}
			}
		}
		...
		public override string ToString()
		{
			...
			return string.Concat("(", source.UnsafeGetStatus(), ")");
		}
