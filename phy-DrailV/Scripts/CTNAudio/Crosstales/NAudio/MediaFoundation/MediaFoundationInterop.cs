...
namespace Crosstales.NAudio.MediaFoundation
{
	public static class MediaFoundationInterop
	{
		...
		public static extern void MFStartup(int version, int dwFlags);
		...
		[DllImport("mfplat.dll", ExactSpelling = true, PreserveSig = false)]
		internal static extern void MFCreateWaveFormatExFromMFMediaType(IMFMediaType pMFType, ref IntPtr ppWF, ref int pcbSize, int flags);
