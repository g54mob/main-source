...
namespace Crosstales.NAudio.Dsp
{
	internal class WdlResampler
	{
		...
		public void SetMode(bool interp, int filtercnt, bool sinc, int sinc_size, int sinc_interpsize)
		{
		...
		public void SetFilterParms(float filterpos, float filterq)
		{
		...
		public void Reset(double fracpos)
		{
			m_last_requested = 0;
			m_filtlatency = 0;
			m_fracpos = fracpos;
