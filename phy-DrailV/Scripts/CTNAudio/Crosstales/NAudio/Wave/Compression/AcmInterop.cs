...
namespace Crosstales.NAudio.Wave.Compression
{
	internal class AcmInterop
	{
		...
		[DllImport("Msacm32.dll")]
		public static extern MmResult acmFormatSuggest(IntPtr hAcmDriver, [In][MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Crosstales.NAudio.Wave.WaveFormatCustomMarshaler")] WaveFormat sourceFormat, [In][Out][MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Crosstales.NAudio.Wave.WaveFormatCustomMarshaler")] WaveFormat destFormat, int sizeDestFormat, AcmFormatSuggestFlags suggestFlags);
		...
		[DllImport("Msacm32.dll")]
		public static extern MmResult acmStreamOpen(out IntPtr hAcmStream, IntPtr hAcmDriver, [In][MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Crosstales.NAudio.Wave.WaveFormatCustomMarshaler")] WaveFormat sourceFormat, [In][MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Crosstales.NAudio.Wave.WaveFormatCustomMarshaler")] WaveFormat destFormat, [In] WaveFilter waveFilter, IntPtr callback, IntPtr instance, AcmStreamOpenFlags openFlags);
