...
namespace I2.Loc
{
	...
	public class Localize : MonoBehaviour
	{
		...
		[NonSerialized]
		public readonly Dictionary<string, UnityEngine.Object> mAssetDictionary = new Dictionary<string, UnityEngine.Object>(StringComparer.Ordinal);
		...
		{
			UnityEngine.Object.Destroy(mLocalizeTarget);
		}
		...
		public void OnLocalize(bool Force = false)
		{
			...
			if (MainTranslation != null)
			{
				...
				case TermModification.ToUpperFirst:
					MainTranslation = I2Utils.UppercaseFirst(MainTranslation);
					break;
				case TermModification.ToTitle:
					MainTranslation = I2Utils.TitleCase(MainTranslation);
					break;
				}
			...
			if (SecondaryTranslation != null)
			{
				...
				case TermModification.ToLower:
					...
					break;
				case TermModification.ToUpperFirst:
					SecondaryTranslation = I2Utils.UppercaseFirst(SecondaryTranslation);
					break;
				case TermModification.ToTitle:
					SecondaryTranslation = I2Utils.TitleCase(SecondaryTranslation);
					break;
				}
		...
		public void UpdateAssetDictionary()
		{
			...
			for (int num = 0; num < TranslatedObjects.Count; num++)
			{
				UnityEngine.Object obj = TranslatedObjects[num];
		...
		public T FindTranslatedObject<T>(string value) where T : UnityEngine.Object
		{
			...
			if (mAssetDictionary.Count != TranslatedObjects.Count)
			{
				UpdateAssetDictionary();
			}
