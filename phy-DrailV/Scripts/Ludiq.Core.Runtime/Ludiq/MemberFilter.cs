...
namespace Ludiq
{
	...
	public sealed class MemberFilter : Attribute, ICloneable
	{
		...
		{
			int num = 17;
			num = num * 23 + Fields.GetHashCode();
			num = num * 23 + Properties.GetHashCode();
			num = num * 23 + Methods.GetHashCode();
			num = num * 23 + Constructors.GetHashCode();
			num = num * 23 + Gettable.GetHashCode();
			num = num * 23 + Settable.GetHashCode();
			num = num * 23 + Inherited.GetHashCode();
			num = num * 23 + Targeted.GetHashCode();
			num = num * 23 + NonTargeted.GetHashCode();
			num = num * 23 + Public.GetHashCode();
			num = num * 23 + NonPublic.GetHashCode();
			num = num * 23 + ReadOnly.GetHashCode();
			num = num * 23 + WriteOnly.GetHashCode();
			num = num * 23 + Extensions.GetHashCode();
			num = num * 23 + Operators.GetHashCode();
			num = num * 23 + Conversions.GetHashCode();
			num = num * 23 + Parameters.GetHashCode();
			num = num * 23 + Obsolete.GetHashCode();
			num = num * 23 + OpenConstructedGeneric.GetHashCode();
			num = num * 23 + TypeInitializers.GetHashCode();
			return num * 23 + ClsNonCompliant.GetHashCode();
		}
		...
		public bool ValidateMember(MemberInfo member, TypeFilter typeFilter = null)
		{
			...
			else if (member is PropertyInfo)
			{
				...
				bool flag4 = !WriteOnly || (!Properties && Gettable);
				bool flag5 = !ReadOnly || (!Properties && Settable);
				bool flag6 = propertyInfo.CanRead && (NonPublic || getMethod.IsPublic);
				bool flag7 = propertyInfo.CanWrite && (NonPublic || setMethod.IsPublic);
				if (flag4 && !flag6)
				{
					return false;
				}
			...
			else if (member is MethodBase)
			{
				...
				if (!Parameters && methodBase.GetParameters().Length > (flag9 ? 1 : 0))
				{
					return false;
				}
				...
				if (member is MethodInfo)
				{
					...
					bool flag14 = false;
					if (!Methods && !(Gettable && flag13) && !(Settable && flag14))
					{
						return false;
					}
					if (!Targeted && flag10)
				...
				else if (member is ConstructorInfo)
				{
					...
					bool flag15 = true;
					bool flag16 = false;
					if (!Constructors && !(Gettable && flag15) && !(Settable && flag16))
					{
						return false;
					}
