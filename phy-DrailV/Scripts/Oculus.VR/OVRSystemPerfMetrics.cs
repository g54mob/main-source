...
public class OVRSystemPerfMetrics
{
	public class PerfMetrics
	{
		...
		public bool LoadFromJSON(string json)
		{
			...
			compositorDroppedFrameCount = (compositorDroppedFrameCount_IsValid ? jSONObject["ompositorDroppedFrameCount"].AsInt : 0);
	...
	public class OVRSystemPerfMetricsTcpServer : MonoBehaviour
	{
		...
		{
			PerfMetrics obj = new PerfMetrics
			{
			...
			obj.appCpuTime_IsValid = perfMetricsFloat.HasValue;
			obj.appCpuTime = perfMetricsFloat.GetValueOrDefault();
			perfMetricsFloat = OVRPlugin.GetPerfMetricsFloat(OVRPlugin.PerfMetrics.App_GpuTime_Float);
			obj.appGpuTime_IsValid = perfMetricsFloat.HasValue;
			obj.appGpuTime = perfMetricsFloat.GetValueOrDefault();
			perfMetricsFloat = OVRPlugin.GetPerfMetricsFloat(OVRPlugin.PerfMetrics.Compositor_CpuTime_Float);
			obj.compositorCpuTime_IsValid = perfMetricsFloat.HasValue;
			obj.compositorCpuTime = perfMetricsFloat.GetValueOrDefault();
			perfMetricsFloat = OVRPlugin.GetPerfMetricsFloat(OVRPlugin.PerfMetrics.Compositor_GpuTime_Float);
			obj.compositorGpuTime_IsValid = perfMetricsFloat.HasValue;
			obj.compositorGpuTime = perfMetricsFloat.GetValueOrDefault();
			int? perfMetricsInt = OVRPlugin.GetPerfMetricsInt(OVRPlugin.PerfMetrics.Compositor_DroppedFrameCount_Int);
			obj.compositorDroppedFrameCount_IsValid = perfMetricsInt.HasValue;
			obj.compositorDroppedFrameCount = perfMetricsInt.GetValueOrDefault();
			perfMetricsFloat = OVRPlugin.GetPerfMetricsFloat(OVRPlugin.PerfMetrics.System_GpuUtilPercentage_Float);
			obj.systemGpuUtilPercentage_IsValid = perfMetricsFloat.HasValue;
			obj.systemGpuUtilPercentage = perfMetricsFloat.GetValueOrDefault();
			perfMetricsFloat = OVRPlugin.GetPerfMetricsFloat(OVRPlugin.PerfMetrics.System_CpuUtilAveragePercentage_Float);
			obj.systemCpuUtilAveragePercentage_IsValid = perfMetricsFloat.HasValue;
			obj.systemCpuUtilAveragePercentage = perfMetricsFloat.GetValueOrDefault();
			perfMetricsFloat = OVRPlugin.GetPerfMetricsFloat(OVRPlugin.PerfMetrics.System_CpuUtilWorstPercentage_Float);
			obj.systemCpuUtilWorstPercentage_IsValid = perfMetricsFloat.HasValue;
			obj.systemCpuUtilWorstPercentage = perfMetricsFloat.GetValueOrDefault();
			perfMetricsFloat = OVRPlugin.GetPerfMetricsFloat(OVRPlugin.PerfMetrics.Device_CpuClockFrequencyInMHz_Float);
			obj.deviceCpuClockFrequencyInMHz_IsValid = perfMetricsFloat.HasValue;
			obj.deviceCpuClockFrequencyInMHz = perfMetricsFloat.GetValueOrDefault();
			perfMetricsFloat = OVRPlugin.GetPerfMetricsFloat(OVRPlugin.PerfMetrics.Device_GpuClockFrequencyInMHz_Float);
			obj.deviceGpuClockFrequencyInMHz_IsValid = perfMetricsFloat.HasValue;
			obj.deviceGpuClockFrequencyInMHz = perfMetricsFloat.GetValueOrDefault();
			perfMetricsInt = OVRPlugin.GetPerfMetricsInt(OVRPlugin.PerfMetrics.Device_CpuClockLevel_Int);
			obj.deviceCpuClockLevel_IsValid = perfMetricsInt.HasValue;
			obj.deviceCpuClockLevel = perfMetricsInt.GetValueOrDefault();
			perfMetricsInt = OVRPlugin.GetPerfMetricsInt(OVRPlugin.PerfMetrics.Device_GpuClockLevel_Int);
			obj.deviceGpuClockLevel_IsValid = perfMetricsInt.HasValue;
			obj.deviceGpuClockLevel = perfMetricsInt.GetValueOrDefault();
			return obj;
		}
	}
