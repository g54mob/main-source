...
namespace PlaceholderSoftware.WetStuff
{
	...
	{
		public static readonly SemanticVersion Version = new SemanticVersion(4, 1, 2);
		...
		public WetStuffParametersScriptableObject parameters;
		...
		protected virtual void OnPreRender()
		{
			if (_initialized)
			{
				...
				OnAfterDecalRender();
				_gbufferModifier.RecordCommandBuffer(_cmd, this);
			}
		}
