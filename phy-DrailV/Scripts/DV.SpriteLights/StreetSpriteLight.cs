...
public class StreetSpriteLight : SpriteLight
{
	[Header("Spotlight")]
	...
	{
		frontColor = new Color(0.94f, 0.9f, 0.82f),
		size = 0.5f,
		brightness = 1f,
		rotation = Quaternion.Euler(-90f, 0f, 0f)
	};

	public override SpriteLightType LightType => SpriteLightType.StreetSpriteLight;
	...
	public override Color LightColor => new Color(1f, 0.9f, 0.75f);
	...
	public override void FillLights(LightBakeContainer container)
	{
		...
		container.streetLights.Add(sTREET_LAMP_LIGHT);
	}
