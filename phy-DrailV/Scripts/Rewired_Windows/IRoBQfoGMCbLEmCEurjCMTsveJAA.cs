...
internal struct IRoBQfoGMCbLEmCEurjCMTsveJAA
{
	...
	static IRoBQfoGMCbLEmCEurjCMTsveJAA()
	{
		hWQcuKIWAfUxKlnIaMbrWrthBhKC = IntPtr.Size == 8;
		TnbqoUvYgoTtgZoGauUtjgKQTcti = (hWQcuKIWAfUxKlnIaMbrWrthBhKC ? 8 : 4);
	}

	public static IRoBQfoGMCbLEmCEurjCMTsveJAA roxDXNunuWegdGGVJoHuwBGRcdSk(byte[] P_0, int P_1)
	{
		IRoBQfoGMCbLEmCEurjCMTsveJAA result = default(IRoBQfoGMCbLEmCEurjCMTsveJAA);
	...
	[SpecialName]
	public static uint bPhBTDiXwPSGeHgqUdzKHurTqKRxA(IRoBQfoGMCbLEmCEurjCMTsveJAA P_0)
	{
		if (hWQcuKIWAfUxKlnIaMbrWrthBhKC)
		{
	...
	[SpecialName]
	public static ulong bPhBTDiXwPSGeHgqUdzKHurTqKRxA(IRoBQfoGMCbLEmCEurjCMTsveJAA P_0)
	{
		if (hWQcuKIWAfUxKlnIaMbrWrthBhKC)
		{
