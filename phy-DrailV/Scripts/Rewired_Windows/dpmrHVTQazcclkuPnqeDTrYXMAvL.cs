...
[DefaultMember("Item")]
internal struct dpmrHVTQazcclkuPnqeDTrYXMAvL : IDisposable
{
	...
	public unsafe dpmrHVTQazcclkuPnqeDTrYXMAvL(int P_0)
	{
	...
	[SpecialName]
	public unsafe static IntPtr bPhBTDiXwPSGeHgqUdzKHurTqKRxA(dpmrHVTQazcclkuPnqeDTrYXMAvL P_0)
	{
		return (IntPtr)P_0.UPGvMgRDWwlhHHpXHBIuibQSseTK;
	}

	[SpecialName]
	public unsafe static void* bPhBTDiXwPSGeHgqUdzKHurTqKRxA(dpmrHVTQazcclkuPnqeDTrYXMAvL P_0)
	{
		return P_0.UPGvMgRDWwlhHHpXHBIuibQSseTK;
	}

	public unsafe static bool ChDifTIOotSZLIgZsKvZAqJrlqkg(dpmrHVTQazcclkuPnqeDTrYXMAvL P_0, dpmrHVTQazcclkuPnqeDTrYXMAvL P_1)
	{
