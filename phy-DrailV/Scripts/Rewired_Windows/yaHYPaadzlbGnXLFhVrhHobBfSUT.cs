internal class yaHYPaadzlbGnXLFhVrhHobBfSUT
{
	public static class RQaMvOjEvZqMKuvzJDSSxAxvXBTu
	{
		public enum QfCydduHNwlIpklYooWqWLErnqBr : ushort
		{
			Undefined = 0,
			Pointer = 1,
			Mouse = 2,
		...
		public static bool gDethEvBSYCpTuypZEHQLmeiwWfq(ushort P_0)
		{
		...
		public static bool pfJGRbNuvKcfhaIknxFOvhFnCYHTA(ushort P_0)
		{
			if (P_0 < 48 || P_0 > 70)
			{
				return false;
		...
		public static bool orqcYKoQXWCDFGTugmTPgOxQKzQy(ushort P_0)
		{
			if (P_0 < 61 || P_0 > 147)
			{
				return false;
	...
	public static class SgdVGUEJFLOVYRXdYLYhpkzFDoBv
	{
		public enum mUPXeYipZMMhqIECXgRQbUvJBbpbA : ushort
		{
			Aileron = 176,
			AileronTrim = 177,
	...
	public static class AWyjDBdqooCIngsdfFGlPEqmVxgtA
	{
		public enum plnKULthfCDEQZEPhwliqtkOPHh : ushort
		{
			ConsumerControl = 1,
			NumericKeyPad = 2,
	...
	public static class DSsbtIvsSXyYncpxtRJohGKHaCkkA
	{
		public enum vaulioigzCowzMEVCPNXmRRWyJTC : ushort
		{
			_3DGameController = 1,
			PinballDevice = 2,
			GunDevice = 3,
	...
	public const ushort rDLtCOhiWiwaebzdKgPFvVDaccnh = 1;

	public const ushort GZyMjhBTtPcpdgBXVgXPrhsSzodH = 2;

	public const ushort jPScvHJJruOpBqRIyHoXhdlAjfVA = 5;

	public const ushort GkCErZHBJRoXAWZmkeHQdSDCDaPbb = 9;

	public const ushort tVHSJXrRPsgjwhDVjbKpDykWKQom = 12;

	public static bool pfJGRbNuvKcfhaIknxFOvhFnCYHTA(ushort P_0, ushort P_1)
	{
		switch (P_0)
		{
		case 1:
			return RQaMvOjEvZqMKuvzJDSSxAxvXBTu.pfJGRbNuvKcfhaIknxFOvhFnCYHTA(P_1);
		case 2:
			return SgdVGUEJFLOVYRXdYLYhpkzFDoBv.pfJGRbNuvKcfhaIknxFOvhFnCYHTA(P_1);
		case 5:
			return DSsbtIvsSXyYncpxtRJohGKHaCkkA.pfJGRbNuvKcfhaIknxFOvhFnCYHTA(P_1);
		case 12:
			return AWyjDBdqooCIngsdfFGlPEqmVxgtA.pfJGRbNuvKcfhaIknxFOvhFnCYHTA(P_1);
		default:
			return false;
		}
	}

	public static bool cfJwYRgangJZDGISxqoerSvsmjdw(ushort P_0, ushort P_1)
	{
		if (!pfJGRbNuvKcfhaIknxFOvhFnCYHTA(P_0, P_1))
		{
			return orqcYKoQXWCDFGTugmTPgOxQKzQy(P_0, P_1);
		}
		return true;
	}

	public static bool orqcYKoQXWCDFGTugmTPgOxQKzQy(ushort P_0, ushort P_1)
	{
		switch (P_0)
		{
		case 1:
			return RQaMvOjEvZqMKuvzJDSSxAxvXBTu.orqcYKoQXWCDFGTugmTPgOxQKzQy(P_1);
		case 2:
			return SgdVGUEJFLOVYRXdYLYhpkzFDoBv.orqcYKoQXWCDFGTugmTPgOxQKzQy(P_1);
		case 5:
			return DSsbtIvsSXyYncpxtRJohGKHaCkkA.orqcYKoQXWCDFGTugmTPgOxQKzQy(P_1);
		case 9:
			return true;
		case 12:
			return AWyjDBdqooCIngsdfFGlPEqmVxgtA.orqcYKoQXWCDFGTugmTPgOxQKzQy(P_1);
		default:
			return false;
		}
	}

	public static bool mKLZNwysijeHgGmFVXWWuOJHTTvi(ushort P_0)
	{
		if (!gNRlLDXKejyeZPpjSWaNrAUSBPseA(P_0))
		{
			return MWmtzWeMCeUEQwCzvFsfihjRQJxH(P_0);
		}
		return true;
	}

	public static bool gNRlLDXKejyeZPpjSWaNrAUSBPseA(ushort P_0)
	{
	...
	public static bool MWmtzWeMCeUEQwCzvFsfihjRQJxH(ushort P_0)
	{
	...
	public static bool kteDCTIhShzONfIpPWjgSfARLAkeb(ushort P_0, ushort P_1)
	{
		if (P_0 != 1)
		{
			return false;
