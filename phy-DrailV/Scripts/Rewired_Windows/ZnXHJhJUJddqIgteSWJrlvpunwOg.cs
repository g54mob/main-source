...
internal struct ZnXHJhJUJddqIgteSWJrlvpunwOg
{
	...
	static ZnXHJhJUJddqIgteSWJrlvpunwOg()
	{
		hWQcuKIWAfUxKlnIaMbrWrthBhKC = IntPtr.Size == 8;
		TnbqoUvYgoTtgZoGauUtjgKQTcti = (hWQcuKIWAfUxKlnIaMbrWrthBhKC ? 8 : 4);
	}

	public static ZnXHJhJUJddqIgteSWJrlvpunwOg roxDXNunuWegdGGVJoHuwBGRcdSk(byte[] P_0, int P_1)
	{
		ZnXHJhJUJddqIgteSWJrlvpunwOg result = default(ZnXHJhJUJddqIgteSWJrlvpunwOg);
	...
	[SpecialName]
	public static int bPhBTDiXwPSGeHgqUdzKHurTqKRxA(ZnXHJhJUJddqIgteSWJrlvpunwOg P_0)
	{
		if (hWQcuKIWAfUxKlnIaMbrWrthBhKC)
		{
	...
	[SpecialName]
	public static long bPhBTDiXwPSGeHgqUdzKHurTqKRxA(ZnXHJhJUJddqIgteSWJrlvpunwOg P_0)
	{
		if (hWQcuKIWAfUxKlnIaMbrWrthBhKC)
		{
