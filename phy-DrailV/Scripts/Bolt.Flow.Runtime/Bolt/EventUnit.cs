...
namespace Bolt
{
	...
	[SpecialUnit]
	public abstract class EventUnit<TArgs> : Unit, IEventUnit, IUnit, IGraphElementWithDebugData, IGraphElement, IGraphItem, INotifiedCollectionItem, IDisposable, IPrewarmable, IAotStubbable, IIdentifiable, IGraphEventListener, IGraphElementWithData, IGraphEventHandler<TArgs>
	{
		...
		public override void Uninstantiate(GraphReference instance)
		{
			...
			HashSet<Flow> activeCoroutines = elementData.activeCoroutines.ToHashSetPooled();
			StopAllCoroutines(activeCoroutines);
