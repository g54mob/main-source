	...
	public class NCalcLexer : Lexer
	{
		...
		public void mFLOAT()
		{
			...
			if (num != 1)
			{
				if (num == 2)
				{
					...
					if (num2 < 1)
					{
						EarlyExitException ex = new EarlyExitException(6, input);
						throw ex;
					}
					mE();
				}
			...
			else
			{
				...
				if (num7 < 1)
				{
					EarlyExitException ex2 = new EarlyExitException(4, input);
					throw ex2;
				}
				int num10 = 2;
		...
		public void mE()
		{
			...
			if (input.LA(1) == 69 || input.LA(1) == 101)
			{
				...
				if (num3 < 1)
				{
					EarlyExitException ex2 = new EarlyExitException(12, input);
					throw ex2;
				}
				state.type = type;
				state.channel = channel;
