...
namespace Bolt.Dependencies.NCalc
{
	public class EvaluationVisitor : LogicalExpressionVisitor
	{
		...
		public override void Visit(FunctionExpression function)
		{
			...
			{
				functionArgs2.Parameters[i] = new Expression(function.Expressions[i], options);
			...
			OnEvaluateFunction(IgnoreCase ? function.Identifier.Name.ToLower() : function.Identifier.Name, functionArgs2);
