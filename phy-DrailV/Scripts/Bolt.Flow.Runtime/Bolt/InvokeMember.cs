...
namespace Bolt
{
	public sealed class InvokeMember : MemberUnit
	{
		...
		[DoNotSerialize]
		[Ludiq.MemberFilter(Methods = true, Constructors = true)]
		...
		private object Invoke(object target, Flow flow)
		{
			if (useExpandedParameters)
			{
				...
				case 1:
					return base.member.Invoke(target, flow.GetConvertedValue(inputParameters[0]));
				case 2:
					return base.member.Invoke(target, flow.GetConvertedValue(inputParameters[0]), flow.GetConvertedValue(inputParameters[1]));
				case 3:
					return base.member.Invoke(target, flow.GetConvertedValue(inputParameters[0]), flow.GetConvertedValue(inputParameters[1]), flow.GetConvertedValue(inputParameters[2]));
				case 4:
					return base.member.Invoke(target, flow.GetConvertedValue(inputParameters[0]), flow.GetConvertedValue(inputParameters[1]), flow.GetConvertedValue(inputParameters[2]), flow.GetConvertedValue(inputParameters[3]));
				case 5:
					return base.member.Invoke(target, flow.GetConvertedValue(inputParameters[0]), flow.GetConvertedValue(inputParameters[1]), flow.GetConvertedValue(inputParameters[2]), flow.GetConvertedValue(inputParameters[3]), flow.GetConvertedValue(inputParameters[4]));
				default:
