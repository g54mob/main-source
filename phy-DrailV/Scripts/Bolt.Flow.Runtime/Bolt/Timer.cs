...
namespace Bolt
{
	[UnitCategory("Time")]
	[UnitOrder(7)]
	public sealed class Timer : Unit, IGraphElementWithData, IGraphElement, IGraphItem, INotifiedCollectionItem, IDisposable, IPrewarmable, IAotStubbable, IIdentifiable, IGraphEventListener
	{
		...
		public void StopListening(GraphStack stack)
		{
			...
			{
				EventHook hook = new EventHook("Update", stack.machine);
				EventBus.Unregister(hook, elementData.update);
