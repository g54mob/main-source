...
namespace EasyRoads3Dv3
{
	...
	public struct ERSplatmap
	{
		...
		public ERSplatmap(int m_x, int m_y, int m_index, int m_layer, float m_value, ERModularRoad scr, float tv1, float tv2, float tv3, float tv4, float tv5, float tv6, float tv7, float tv8)
		{
			x = m_x;
			y = m_y;
			index = m_index;
