...
{
	public class OCODOCOOCO : MonoBehaviour
	{
		public static void OOQCCCODOD(ERCrossings scr, ref float firstSegmentDistance)
		{
			...
			else
			{
				...
				for (int i = 0; i <= num; i++)
				{
					Vector3 item = new Vector3(0f - num4, 0f, 0f - num3 + (float)i * num2);
					vecs.Add(item);
				}
			}
			...
			else
			{
				...
				for (int i = 0; i <= num; i++)
				{
					Vector3 item = new Vector3(num4, 0f, 0f - num3 + (float)i * num2);
					vecs.Add(item);
				}
			}
			scr.startConnectionV3.Add(new List<Vector3>());
			...
			else
			{
				...
				for (int i = 0; i <= num; i++)
				{
					Vector3 item = new Vector3(num4, 0f, num3 - (float)i * num2);
					vecs.Add(item);
				}
			}
			...
			else
			{
				...
				for (int i = 0; i <= num; i++)
				{
					Vector3 item = new Vector3(0f - num4, 0f, num3 - (float)i * num2);
					vecs.Add(item);
				}
			}
			scr.endConnectionV3.Add(new List<Vector3>());
			...
			if (scr.tCrossingLeftRight == 0)
			{
				int num6 = Mathf.RoundToInt(Mathf.Ceil((float)scr.endConnectionV3[1].Count * 0.5f));
				vecs.Clear();
				vecs.AddRange(scr.endConnectionV3[1]);
				vecs.RemoveRange(0, num6 - 1);
				scr.leftConnectionV3.Add(new List<Vector3>());
				vecs.Reverse();
				scr.leftConnectionV3[0].AddRange(vecs);
				scr.endConnectionV3[1].RemoveRange(num6, scr.endConnectionV3[1].Count - num6);
				num6 = Mathf.RoundToInt(Mathf.Ceil((float)scr.startConnectionV3[0].Count * 0.5f));
				vecs.Clear();
				...
				scr.startConnectionV3[0].RemoveRange(num6, scr.startConnectionV3[0].Count - num6);
			}
			if (scr.tCrossingLeftRight == 1)
			{
				int num6 = Mathf.RoundToInt(Mathf.Ceil((float)scr.startConnectionV3[1].Count * 0.5f));
				vecs.Clear();
				...
				scr.startConnectionV3[1].RemoveRange(num6, scr.startConnectionV3[1].Count - num6);
				num6 = Mathf.RoundToInt(Mathf.Ceil((float)scr.endConnectionV3[0].Count * 0.5f));
				vecs.Clear();
				...
				scr.endConnectionV3[0].RemoveRange(num6, scr.endConnectionV3[0].Count - num6);
			}
		}
		...
		public static void OODDQDCQQC(ERCrossings scr)
		{
			if (scr.startConnectionV3[0][0].z != scr.startConnectionV3[1][0].z)
			{
				if (scr.startConnectionV3[0][0].z > scr.startConnectionV3[1][0].z)
				{
					OQCQQQDDDD(scr.startConnectionV3[0], scr.startConnectionV3[1][0].z, 0f, -1f, scr.resolution, 1);
				}
				else
				{
					OQCQQQDDDD(scr.startConnectionV3[1], scr.startConnectionV3[0][0].z, 0f, -1f, scr.resolution, 1);
				}
			}
			if (scr.endConnectionV3[0][0].z != scr.endConnectionV3[1][0].z)
			{
				if (scr.endConnectionV3[0][0].z < scr.endConnectionV3[1][0].z)
				{
					OQCQQQDDDD(scr.endConnectionV3[0], scr.endConnectionV3[1][0].z, 0f, 1f, scr.resolution, 1);
				}
				else
				{
					OQCQQQDDDD(scr.endConnectionV3[1], scr.endConnectionV3[0][0].z, 0f, 1f, scr.resolution, 1);
				}
			}
			if (scr.tCrossingLeftRight == 0 && scr.leftConnectionV3[0][0].x != scr.leftConnectionV3[1][0].x)
			{
				...
				{
					OQCQQQDDDD(scr.leftConnectionV3[0], scr.leftConnectionV3[1][0].x, -1f, 0f, scr.resolution, 0);
				}
				else
				{
					OQCQQQDDDD(scr.leftConnectionV3[1], scr.leftConnectionV3[0][0].x, -1f, 0f, scr.resolution, 0);
				}
			}
			if (scr.tCrossingLeftRight == 1 && scr.rightConnectionV3[0][0].x != scr.rightConnectionV3[1][0].x)
			{
				...
				{
					OQCQQQDDDD(scr.rightConnectionV3[0], scr.rightConnectionV3[1][0].x, 1f, 0f, scr.resolution, 0);
				}
				else
				{
					OQCQQQDDDD(scr.rightConnectionV3[1], scr.rightConnectionV3[0][0].x, 1f, 0f, scr.resolution, 0);
				}
			}
		}
