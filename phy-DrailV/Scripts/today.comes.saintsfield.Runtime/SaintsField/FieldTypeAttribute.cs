...
namespace SaintsField
{
	...
	public class FieldTypeAttribute : PropertyAttribute, ISaintsAttribute
	{
		...
		public FieldTypeAttribute(Type compType, bool customPicker)
			: this(compType, EPick.Assets | EPick.Scene, customPicker)
		{
		}

		public FieldTypeAttribute(EPick editorPick = EPick.Assets | EPick.Scene, bool customPicker = true)
			: this(null, editorPick, customPicker)
		{
		}
	}
}
