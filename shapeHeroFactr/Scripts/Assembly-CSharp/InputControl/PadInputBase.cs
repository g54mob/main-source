...
{
	public class PadInputBase : MonoBehaviour, InputActionController.IUIControlActions
	{
		[HideInInspector]
		public CursorUIBase CurrentSelect;
		...
		protected virtual void OnSelectItem(CursorUIBase cursorUIItem)
		{
		}
