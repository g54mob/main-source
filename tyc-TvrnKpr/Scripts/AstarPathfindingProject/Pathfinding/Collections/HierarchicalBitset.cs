...
namespace Pathfinding.Collections
{
	...
	public struct HierarchicalBitset
	{
		...
		public struct Iterator : IEnumerator<UnsafeSpan<int>>, IEnumerator, IDisposable, IEnumerable<UnsafeSpan<int>>, IEnumerable
		{
			...
			public delegate bool MoveNextBurst_00000EA6_0024PostfixBurstDelegate(ref Iterator iter);

			internal static class MoveNextBurst_00000EA6_0024BurstDirectCall
			{
			...
			[BurstCompile]
			[MonoPInvokeCallback(typeof(MoveNextBurst_00000EA6_0024PostfixBurstDelegate))]
