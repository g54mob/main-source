...
namespace Pathfinding
{
	...
	public static class Polygon
	{
		...
		public delegate bool ContainsPoint_000003D6_0024PostfixBurstDelegate(ref int3 aWorld, ref int3 bWorld, ref int3 cWorld, ref int3 pWorld, ref NativeMovementPlane movementPlane);

		internal static class ContainsPoint_000003D6_0024BurstDirectCall
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate bool ClosestPointOnTriangleByRef_000003DC_0024PostfixBurstDelegate(in float3 a, in float3 b, in float3 c, in float3 p, [NoAlias] out float3 output);

		internal static class ClosestPointOnTriangleByRef_000003DC_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void ClosestPointOnTriangleProjected_000003DF_0024PostfixBurstDelegate(ref Int3 vi1, ref Int3 vi2, ref Int3 vi3, ref BBTree.ProjectionParams projection, ref float3 point, [NoAlias] out float3 closest, [NoAlias] out float sqrDist, [NoAlias] out float distAlongProjection);

		internal static class ClosestPointOnTriangleProjected_000003DF_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(ContainsPoint_000003D6_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(ClosestPointOnTriangleByRef_000003DC_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(ClosestPointOnTriangleProjected_000003DF_0024PostfixBurstDelegate))]
