...
namespace Pathfinding.ECS
{
	...
	public struct DestinationMoveInCircleSystem : ISystem, ISystemCompilerGenerated
	{
		[BurstCompile]
		private struct UpdateDestinationJob : IJobEntity, IJobChunk
		{
			public struct InternalCompilerQueryAndHandleData
			{
				public struct TypeHandle
				{
					...
					[ReadOnly]
					public ComponentTypeHandle<MoveInCircle.DestinationMoveInCircle> __Pathfinding_MoveInCircle_DestinationMoveInCircle_RO_ComponentTypeHandle;
		...
		private struct TypeHandle
		{
			...
			public UpdateDestinationJob.InternalCompilerQueryAndHandleData __Pathfinding_ECS_DestinationMoveInCircleSystem_UpdateDestinationJob_WithDefaultQuery_JobEntityTypeHandle;
		...
		public delegate void __codegen__OnUpdate_0000149E_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

		internal static class __codegen__OnUpdate_0000149E_0024BurstDirectCall
		{
