...
namespace Pathfinding
{
	...
	public static class Funnel
	{
		...
		public struct FunnelState
		{
			...
			public delegate void PushStart_00000AB5_0024PostfixBurstDelegate(ref NativeCircularBuffer<float3> leftPortals, ref NativeCircularBuffer<float3> rightPortals, ref NativeCircularBuffer<float4> unwrappedPortals, ref float3 newLeftPortal, ref float3 newRightPortal, ref float3 projectionAxis);

			internal static class PushStart_00000AB5_0024BurstDirectCall
			{
			...
			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			public delegate void ConvertCornerIndicesToPathProjected_00000ABF_0024PostfixBurstDelegate(ref FunnelState funnelState, ref UnsafeSpan<int> indices, bool splitAtEveryPortal, in float3 startPoint, in float3 endPoint, bool lastCorner, in float3 projectionAxis, ref UnsafeSpan<float3> result, in float3 up);

			internal static class ConvertCornerIndicesToPathProjected_00000ABF_0024BurstDirectCall
			{
				private static IntPtr Pointer;
			...
			[BurstCompile]
			[MonoPInvokeCallback(typeof(PushStart_00000AB5_0024PostfixBurstDelegate))]
			...
			[BurstCompile]
			[MonoPInvokeCallback(typeof(ConvertCornerIndicesToPathProjected_00000ABF_0024PostfixBurstDelegate))]
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate int Calculate_00000AA7_0024PostfixBurstDelegate(ref NativeCircularBuffer<float4> unwrappedPortals, ref NativeCircularBuffer<float3> leftPortals, ref NativeCircularBuffer<float3> rightPortals, ref float3 startPoint, ref float3 endPoint, ref UnsafeSpan<int> funnelPath, int maxCorners, ref float3 projectionAxis, out bool lastCorner);

		internal static class Calculate_00000AA7_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(Calculate_00000AA7_0024PostfixBurstDelegate))]
