...
namespace Pathfinding
{
	...
	public struct BinaryHeap
	{
		...
		public delegate void Add_000003F2_0024PostfixBurstDelegate(ref BinaryHeap binaryHeap, ref UnsafeSpan<PathNode> nodes, uint pathNodeIndex, uint g, uint h, uint insertionOrder, TieBreaking tieBreaking);

		internal static class Add_000003F2_0024BurstDirectCall
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate uint Remove_000003F5_0024PostfixBurstDelegate(ref UnsafeSpan<PathNode> nodes, ref BinaryHeap binaryHeap, [NoAlias] out uint removedTieBreaker, [NoAlias] out uint removedF);

		internal static class Remove_000003F5_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(Add_000003F2_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(Remove_000003F5_0024PostfixBurstDelegate))]
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		[BurstCompile]
		public static void Add_0024BurstManaged(ref BinaryHeap binaryHeap, ref UnsafeSpan<PathNode> nodes, uint pathNodeIndex, uint g, uint h, uint insertionOrder, TieBreaking tieBreaking)
		{
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		[BurstCompile]
		public static uint Remove_0024BurstManaged(ref UnsafeSpan<PathNode> nodes, ref BinaryHeap binaryHeap, [NoAlias] out uint removedTieBreaker, [NoAlias] out uint removedF)
		{
			removedTieBreaker = default(uint);
			removedF = default(uint);
			return 0u;
