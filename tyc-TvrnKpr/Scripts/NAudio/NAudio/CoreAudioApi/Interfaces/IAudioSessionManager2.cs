...
namespace NAudio.CoreAudioApi.Interfaces
{
	...
	{
		[PreserveSig]
		new int GetAudioSessionControl([Optional][In] Guid sessionId, [In] uint streamFlags, out IAudioSessionControl sessionControl);

		[PreserveSig]
		new int GetSimpleAudioVolume([Optional][In] Guid sessionId, [In] uint streamFlags, out ISimpleAudioVolume audioVolume);
