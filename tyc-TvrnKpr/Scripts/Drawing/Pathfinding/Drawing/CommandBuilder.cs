...
namespace Pathfinding.Drawing
{
	...
	public struct CommandBuilder : IDisposable
	{
		...
		private class JobWireMesh
		{
			...
			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			public unsafe delegate void WireMesh_000000C9_0024PostfixBurstDelegate(float3* verts, int* indices, int vertexCount, int indexCount, ref CommandBuilder draw);

			internal static class WireMesh_000000C9_0024BurstDirectCall
			{
			...
			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			public delegate void Execute_000000CA_0024PostfixBurstDelegate(ref Mesh.MeshData rawMeshData, ref CommandBuilder draw);

			internal static class Execute_000000CA_0024BurstDirectCall
			{
				private static IntPtr Pointer;
			...
			[BurstCompile]
			[MonoPInvokeCallback(typeof(WireMesh_000000C9_0024PostfixBurstDelegate))]
			...
			[BurstCompile]
			[MonoPInvokeCallback(typeof(JobWireMeshDelegate))]
			public static void Execute_0024BurstManaged(ref Mesh.MeshData rawMeshData, ref CommandBuilder draw)
			{
			}
		}
