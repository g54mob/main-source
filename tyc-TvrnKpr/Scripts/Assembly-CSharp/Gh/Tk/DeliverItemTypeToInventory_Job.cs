...
namespace Gh.Tk
{
	public class DeliverItemTypeToInventory_Job : StaffJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__5 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public DeliverItemTypeToInventory_Job _003C_003E4__this;
		...
		private DeliverItemTypeToInventory_Job()
		{
		}

		public DeliverItemTypeToInventory_Job(GameObjectX source, GameObjectX target, string itemType)
		{
		}
