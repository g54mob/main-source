...
{
	[NodeTint("#0094FF")]
	public class SelectStaffTargetXNode : ConnectedStoryNode, IStaffFilterNode
	{
		[Header("Staff Config")]
		...
		[Tooltip("if no targets are found the node wont complete, if the target is required an error is logged")]
