...
namespace Gh.Tk
{
	public class StaffEntertainInBedJob : StaffJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__4 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public StaffEntertainInBedJob _003C_003E4__this;
		...
		[PersistenceOptIn]
		private string _restAnimParam;

		[PersistenceOptIn]
		private string _animation;

		private StaffEntertainInBedJob()
		{
		}

		public StaffEntertainInBedJob(Actor owner, Bed target, ActorBehaviour behaviour = null, string usageKeyOverride = null)
		{
		}
