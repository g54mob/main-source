...
namespace Gh.Tk
{
	public class EndOfFightJob : ActorJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__3 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public EndOfFightJob _003C_003E4__this;
		...
		private EndOfFightJob()
		{
		}

		public EndOfFightJob(Actor source, bool flyout, int priority = 1020)
		{
		}
