...
namespace Gh.Tk
{
	public class RemoveLuggageFromStorage_Job : StaffJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__3 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public RemoveLuggageFromStorage_Job _003C_003E4__this;
		...
		private RemoveLuggageFromStorage_Job()
		{
		}

		public RemoveLuggageFromStorage_Job(GameObjectX source, GameItem luggage)
		{
		}
