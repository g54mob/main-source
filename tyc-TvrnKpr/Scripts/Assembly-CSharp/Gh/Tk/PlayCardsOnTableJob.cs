...
namespace Gh.Tk
{
	public class PlayCardsOnTableJob : PatronJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__2 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public PlayCardsOnTableJob _003C_003E4__this;
		...
		private PlayCardsOnTableJob()
		{
		}

		public PlayCardsOnTableJob(GameObjectX source, CardTable target, ActorBehaviour behaviour = null, string usageKeyOverride = null)
		{
		}
