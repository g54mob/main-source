...
namespace Gh.Tk
{
	public class PlayBoardGameJob : PatronJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__4 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public PlayBoardGameJob _003C_003E4__this;
		...
		private PlayBoardGameJob()
		{
		}

		public PlayBoardGameJob(GameObjectX source, BoardGameTable target, ActorBehaviour behaviour = null, string usageKeyOverride = null)
		{
		}
