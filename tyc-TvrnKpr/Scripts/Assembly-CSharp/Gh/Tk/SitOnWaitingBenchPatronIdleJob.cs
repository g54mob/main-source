...
namespace Gh.Tk
{
	public class SitOnWaitingBenchPatronIdleJob : PatronIdleBaseJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__2 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public SitOnWaitingBenchPatronIdleJob _003C_003E4__this;
		...
		protected SitOnWaitingBenchPatronIdleJob()
		{
		}

		public SitOnWaitingBenchPatronIdleJob(Patron source, WaitingBench target)
		{
		}
