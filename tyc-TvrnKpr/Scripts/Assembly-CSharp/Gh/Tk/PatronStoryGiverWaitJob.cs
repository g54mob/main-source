...
namespace Gh.Tk
{
	public class PatronStoryGiverWaitJob : PatronJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__3 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public PatronStoryGiverWaitJob _003C_003E4__this;
		...
		[Preserve]
		protected PatronStoryGiverWaitJob()
		{
		}

		public PatronStoryGiverWaitJob(Patron patron)
		{
		}
