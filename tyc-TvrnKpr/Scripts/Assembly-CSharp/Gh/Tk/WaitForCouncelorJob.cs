...
namespace Gh.Tk
{
	public class WaitForCouncelorJob : PatronJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__2 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public WaitForCouncelorJob _003C_003E4__this;
		...
		protected WaitForCouncelorJob()
		{
		}

		public WaitForCouncelorJob(Patron owner, CouncelorCouch target, ActorBehaviour behaviour, string usageKeyOverride = null)
		{
		}
