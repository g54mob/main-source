...
namespace Gh.Tk
{
	public class StaffTakeTimeOffJob : StaffJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__4 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public StaffTakeTimeOffJob _003C_003E4__this;
		...
		[PersistenceOptIn]
		private float _durationInDaysF;

		[PersistenceOptIn]
		private float _endsAt;

		protected StaffTakeTimeOffJob()
		{
		}

		public StaffTakeTimeOffJob(Staff owner, float durationInDays)
		{
		}
