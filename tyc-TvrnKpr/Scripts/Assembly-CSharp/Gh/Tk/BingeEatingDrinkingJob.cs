...
namespace Gh.Tk
{
	public class BingeEatingDrinkingJob : ActorJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__4 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public BingeEatingDrinkingJob _003C_003E4__this;
		...
		protected BingeEatingDrinkingJob()
		{
		}

		public BingeEatingDrinkingJob(Actor owner, bool drinking)
		{
		}
