...
namespace Gh.Tk
{
	public class VandalismRampageJob : ActorJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__2 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public VandalismRampageJob _003C_003E4__this;
		...
		protected VandalismRampageJob()
		{
		}

		public VandalismRampageJob(Actor owner)
		{
		}
