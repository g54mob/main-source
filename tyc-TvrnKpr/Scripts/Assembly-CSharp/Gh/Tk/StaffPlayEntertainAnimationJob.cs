...
namespace Gh.Tk
{
	public class StaffPlayEntertainAnimationJob : StaffJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__4 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public StaffPlayEntertainAnimationJob _003C_003E4__this;
		...
		private StaffPlayEntertainAnimationJob()
		{
		}

		public StaffPlayEntertainAnimationJob(GameObjectX source, float duration)
		{
		}
