...
namespace Gh.Tk
{
	public class PatronIdleGoNearPropJob : PatronIdleBaseJob
	{
		[CompilerGenerated]
		private sealed class _003CGetActivities_003Ed__2 : IEnumerable<Activity>, IEnumerable, IEnumerator<Activity>, IEnumerator, IDisposable
		{
			...
			public PatronIdleGoNearPropJob _003C_003E4__this;
		...
		protected PatronIdleGoNearPropJob()
		{
		}

		public PatronIdleGoNearPropJob(Patron source, Prop target)
		{
		}
