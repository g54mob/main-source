...
namespace FIMSpace.RagdollAnimatorDemo
{
	public class Demo_Ragd_BaloonForce : MonoBehaviour
	{
		...
		{
			LineEnd.SetParent(target.transform, worldPositionStays: true);
			...
			Joint component = TransportJoint.GetComponent<Joint>();
			component.autoConfigureConnectedAnchor = false;
			component.anchor = target.transform.InverseTransformPoint(hitPoint);
			TransportJoint.gameObject.SetActive(value: true);
		}
	}
}
