...
namespace ES3Types
{
	...
	public class ES3Type_Rigidbody : ES3ComponentType
	{
		...
		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			...
			writer.WriteProperty("velocity", rigidbody.linearVelocity, ES3Type_Vector3.Instance);
			writer.WriteProperty("drag", rigidbody.linearDamping, ES3Type_float.Instance);
			writer.WriteProperty("angularDrag", rigidbody.angularDamping, ES3Type_float.Instance);
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach (string property in reader.Properties)
			{
				...
				{
				case "velocity":
					rigidbody.linearVelocity = reader.Read<Vector3>(ES3Type_Vector3.Instance);
					break;
				case "drag":
					rigidbody.linearDamping = reader.Read<float>(ES3Type_float.Instance);
					break;
				case "angularDrag":
					rigidbody.angularDamping = reader.Read<float>(ES3Type_float.Instance);
					break;
