...
namespace RainbowArt.CleanFlatUI
{
	...
	public class NotificationContentFitterWithButton : MonoBehaviour
	{
		...
		[SerializeField]
		private NotificationEvent onFirst = new NotificationEvent();

		[SerializeField]
		private NotificationEvent onSecond = new NotificationEvent();

		[SerializeField]
		private NotificationEvent onThird = new NotificationEvent();
		...
		private void UpdateHeight()
		{
			if (description != null)
			{
				...
				if (buttonBar != null)
				{
					...
					num = num + height + spacing;
				}
				GetComponent<RectTransform>().SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, num);
			}
		}
	}
}
