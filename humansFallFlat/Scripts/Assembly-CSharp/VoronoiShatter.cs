	...
	protected override void Shatter(Vector3 contactPoint, Vector3 adjustedImpulse, float impactMagnitude, uint seed, uint netId)
	{
		...
		for (int n = 0; n < num7; n++)
		{
			...
			for (int num26 = 0; num26 < count2; num26++)
			{
				...
				array4[num26 * 6] = (array4[num26 * 6 + 1] = (array4[num26 * 6 + 2] = To3D(new Vector3(vector16.x, vector16.y, z2) - zero2)));
				array4[num26 * 6 + 3] = (array4[num26 * 6 + 4] = (array4[num26 * 6 + 5] = To3D(new Vector3(vector16.x, vector16.y, z3) - zero2)));
			...
			gameObject2.transform.SetParent(shardParent.transform, false);
		...
		shardParent.StartNetwork(false);
