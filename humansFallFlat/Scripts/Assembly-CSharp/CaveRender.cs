...
public class CaveRender : MonoBehaviour
{
	...
	private Color creditsFogColor = new Color(0.5568628f, 0.6039216f, 32f / 51f);
	...
	public static float defaultFogDensity
	{
		get
		{
			return fogDensityMultiplier * ((!(Game.currentLevel != null)) ? _defaultFogDensity : Game.currentLevel.fogDensity);
		}
	}
	...
	public static Color defaultFogColor
	{
		get
		{
			return (!(Game.currentLevel != null)) ? _defaultFogColor : Game.currentLevel.fogColor;
		}
	}
