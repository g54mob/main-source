	...
	public class GrainOverlay
	{
		...
		private void ShowGrains()
		{
			...
			for (int i = 0; i < activeSounds.sounds.Count; i++)
			{
				...
				GUILayout.Label("freq", AudioUI.style, GUILayout.ExpandWidth(false));
				...
				GUILayout.Label("slow", AudioUI.style, GUILayout.ExpandWidth(false));
				...
				GUILayout.Label("jitter", AudioUI.style, GUILayout.ExpandWidth(false));
				rect2 = GUILayoutUtility.GetRect(75f, rect.height, GUILayout.ExpandWidth(false));
