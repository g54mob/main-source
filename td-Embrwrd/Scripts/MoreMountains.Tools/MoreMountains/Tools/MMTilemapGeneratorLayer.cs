...
namespace MoreMountains.Tools
{
	...
	public class MMTilemapGeneratorLayer
	{
		...
		public MMTilemapGenerator.GenerateMethods GenerateMethod;
		...
		public bool FullGenerationFilled;
		...
		[MMEnumCondition("GenerateMethod", new int[] { 4 })]
		public int RandomWalkMaxIterations;
		...
		public int RandomWalkAvoiderPercent;
		...
		[MMEnumCondition("GenerateMethod", new int[] { 7 })]
		public MMGridGeneratorPath.Directions PathDirection;

		[Tooltip("in path mode, the minimum width of the path")]
		[MMEnumCondition("GenerateMethod", new int[] { 7 })]
		public int PathMinWidth;
