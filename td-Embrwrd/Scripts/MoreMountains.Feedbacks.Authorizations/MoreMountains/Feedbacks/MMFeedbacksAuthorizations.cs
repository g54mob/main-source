...
namespace MoreMountains.Feedbacks
{
	public class MMFeedbacksAuthorizations : MMMonoBehaviour
	{
		...
		[MMInspectorGroup("Audio", true, 17)]
		...
		[MMInspectorGroup("Camera", true, 18)]
		...
		[MMInspectorGroup("Debug", true, 19)]
		...
		[MMInspectorGroup("Events", true, 20)]
		...
		[MMInspectorGroup("GameObject", true, 47)]
		...
		[MMInspectorGroup("Haptics", true, 22)]
		...
		[MMInspectorGroup("Light", true, 23)]
		[MMInspectorButton("ToggleLight")]
		public bool ToggleLightButton;

		public bool Light;

		[MMInspectorGroup("Loop", true, 24)]
		...
		[MMInspectorGroup("Particles", true, 25)]
		...
		[MMInspectorGroup("Pause", true, 26)]
		...
		[MMInspectorGroup("Post Process", true, 27)]
		...
		[MMInspectorGroup("Flicker", true, 28)]
		...
		[MMInspectorGroup("Scene", true, 29)]
		...
		[MMInspectorGroup("Transform", true, 32)]
		...
		[MMInspectorGroup("TextMesh Pro", true, 30)]
