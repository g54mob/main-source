...
namespace Drawing
{
	public static class Draw
	{
		...
		[BurstDiscard]
		public static void CircleXZ(float3 center, float radius, float startAngle = 0f, float endAngle = (float)Math.PI * 2f)
		{
		}

		[BurstDiscard]
		[Obsolete("Use Draw.xy.Circle instead")]
		public static void CircleXY(float3 center, float radius, float startAngle = 0f, float endAngle = (float)Math.PI * 2f)
		{
		}
		...
		public static void SolidCircleXZ(float3 center, float radius, float startAngle = 0f, float endAngle = (float)Math.PI * 2f)
		{
		}

		[BurstDiscard]
		[Obsolete("Use Draw.xy.SolidCircle instead")]
		public static void SolidCircleXY(float3 center, float radius, float startAngle = 0f, float endAngle = (float)Math.PI * 2f)
		{
		}
