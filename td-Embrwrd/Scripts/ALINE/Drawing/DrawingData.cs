...
namespace Drawing
{
	public class DrawingData
	{
		...
		internal struct BuilderData : IDisposable
		{
			...
			internal unsafe delegate bool AnyBuffersWrittenTo_000002FC_0024PostfixBurstDelegate(UnsafeAppendBuffer* buffers, int numBuffers);

			internal static class AnyBuffersWrittenTo_000002FC_0024BurstDirectCall
			{
			...
			internal unsafe delegate void ResetAllBuffers_000002FD_0024PostfixBurstDelegate(UnsafeAppendBuffer* buffers, int numBuffers);

			internal static class ResetAllBuffers_000002FD_0024BurstDirectCall
			{
				private static IntPtr Pointer;
			...
			[MonoPInvokeCallback(typeof(AnyBuffersWrittenToDelegate))]
			[BurstCompile]
			internal unsafe static bool AnyBuffersWrittenTo_0024BurstManaged(UnsafeAppendBuffer* buffers, int numBuffers)
			{
				return false;
			}
			...
			[BurstCompile]
			[MonoPInvokeCallback(typeof(AnyBuffersWrittenToDelegate))]
			internal unsafe static void ResetAllBuffers_0024BurstManaged(UnsafeAppendBuffer* buffers, int numBuffers)
			{
			}
		}
		...
		private static readonly MeshCompareByDrawingOrder meshSorter;
		...
		public static void Initialize_0024BuilderData_AnyBuffersWrittenTo_000002FC_0024BurstDirectCall()
		{
		}

		public static void Initialize_0024BuilderData_ResetAllBuffers_000002FD_0024BurstDirectCall()
		{
		}
	}
}
