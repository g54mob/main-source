...
namespace Rewired.ComponentControls
{
	...
	public class CustomController : ComponentController
	{
		...
		private struct TNGRGSVBeJwjvLreUPzxRmvDwxZI
		{
			public CustomControllerElementSelector.ElementType FEfPpUzDkGxiFsQCqoHBBGbcySrb;

			public int FbPouuwpjGvHicSDEOcRHytQozMq;

			public float lsFGJoGinpucwSUPqzoZsqZtCLVbb;

			public TNGRGSVBeJwjvLreUPzxRmvDwxZI(CustomControllerElementSelector.ElementType P_0, int P_1, float P_2)
			{
				FEfPpUzDkGxiFsQCqoHBBGbcySrb = default(CustomControllerElementSelector.ElementType);
				FbPouuwpjGvHicSDEOcRHytQozMq = 0;
				lsFGJoGinpucwSUPqzoZsqZtCLVbb = 0f;
			}

			public TNGRGSVBeJwjvLreUPzxRmvDwxZI(CustomControllerElementSelector.ElementType P_0, int P_1, bool P_2)
			{
				FEfPpUzDkGxiFsQCqoHBBGbcySrb = default(CustomControllerElementSelector.ElementType);
				FbPouuwpjGvHicSDEOcRHytQozMq = 0;
				lsFGJoGinpucwSUPqzoZsqZtCLVbb = 0f;
			...
			public bool lQYowlePinUwRrBXvJcMcKBJJsNM(CustomControllerElementSelector.ElementType P_0, int P_1)
			{
				return false;
			}

			public void EixksJCDAMIRMJTDiUAsRAzZlWRjA(float P_0)
			{
			}

			public void haKdZaziOwghccAyspePhychtfqKc(bool P_0)
			{
			}
		}
		...
		private List<TNGRGSVBeJwjvLreUPzxRmvDwxZI> aBNbtMCIhbbwegqobiyCbepektPq;

		[NonSerialized]
		private int ycIsKGsEaxTwARBsiFrajCRFojds;

		private Action zMTJKwldThefrGRpLOCmjzhhdyKeb;
		...
		internal override void DrSuGCehGQihuvuqiFHElgOUyoEl()
		{
		}

		internal override void VJbZDNIelbgIwWhdWvrEgWPiKZeL()
		{
		}
		...
		private void MNzIHVRlKWlWQCLRvOAlvzeRiBEk()
		{
		}

		private bool snVCmMMhDMvuwyTVhdIKvIpWXKUj()
		{
			return false;
		}

		private void rkfBnqChCHQQLcfMFbJvvcfjwGfmb()
		{
		}

		private Rewired.CustomController EuZCxlpphdAQUJIaDgRwXeOJPGgZA(bool P_0)
		{
			return null;
		}

		private void fFNbJuDlVdfiyyldAVUbqxduokry(Rewired.CustomController P_0)
		{
		}

		private void lNdTnDvdljsjFgUqQIJdjEWrGVzF()
		{
		}

		private void lMiPQAQYbOMSMTDkcISKgEUDYDgJ()
		{
		}
	}
}
