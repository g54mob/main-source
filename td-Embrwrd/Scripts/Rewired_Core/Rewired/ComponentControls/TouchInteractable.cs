...
namespace Rewired.ComponentControls
{
	...
	public abstract class TouchInteractable : TouchControl, IPointerDownHandler, IEventSystemHandler, IPointerUpHandler, IPointerEnterHandler, IPointerExitHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
		...
		{
			private TouchInteractable FBwfORVgVqpRtDdPMqkfFnaXPTBE;

			private InteractionState EgxJLEjqLslulsQjeqjQkolEeLaC;

			private float LxSnJqAocujiAIAbNdbVBehfqPkac;
			...
			internal void oTPGgkXOjjaUQfPVnDUYgzqbhiEDc(TouchInteractable P_0, InteractionState P_1, float P_2)
			{
			}
		}
		...
		[Serializable]
		private sealed class ZshLKeCnlYtvOXBQKnrmFYBlTnbV
		{
			public static readonly ZshLKeCnlYtvOXBQKnrmFYBlTnbV _003C_003E9;

			public static SRtajoXrNhbTDeRsLSkJRLdbaRxDb.EventFunction<IInteractionStateTransitionHandler, InteractionStateTransitionArgs> _003C_003E9__152_0;

			internal void nSSCJgllxJvIPeKCaoXPeXHEFlty(IInteractionStateTransitionHandler P_0, InteractionStateTransitionArgs P_1)
			{
			}
		}
		...
		[NonSerialized]
		private bool hsPKpqkIepCnugNAlDtLhhCVCYkA;

		[NonSerialized]
		private bool bSqhIispsCweJALVwHoSNLHblrZV;
		...
		private SRtajoXrNhbTDeRsLSkJRLdbaRxDb.HierarchyEventHelper<IVisibilityChangedHandler, bool> __hierarchyVisibilityChangedHandlers;

		private SRtajoXrNhbTDeRsLSkJRLdbaRxDb.HierarchyEventHelper<IInteractionStateTransitionHandler, InteractionStateTransitionArgs> __hierarchyInteractionStateTransitionHandlers;

		private static SRtajoXrNhbTDeRsLSkJRLdbaRxDb.EventFunction<IInteractionStateTransitionHandler, InteractionStateTransitionArgs> __interactionStateTransitionHandlerDelegate;

		private SRtajoXrNhbTDeRsLSkJRLdbaRxDb.HierarchyEventHelper<IVisibilityChangedHandler, bool> QuMgLMfclcNHEeriIoQWXwmaKVcTb => null;

		private SRtajoXrNhbTDeRsLSkJRLdbaRxDb.HierarchyEventHelper<IInteractionStateTransitionHandler, InteractionStateTransitionArgs> IRCbPriqDJiwnXhbEGhcdWyqKTAI => null;
		...
		internal static SRtajoXrNhbTDeRsLSkJRLdbaRxDb.EventFunction<IInteractionStateTransitionHandler, InteractionStateTransitionArgs> aSVPAunVMXHQPDJgJLCTNIGsgYrT => null;
		...
		private void GXQiLrOaJPsyOsDFNPSQEMZOJyKu()
		{
		}

		private void DhdOOoKiuQTnuQPRxcqXEsmzXZgy(InteractionState P_0, bool P_1)
		{
		}

		private void ITpoJdxVMiXXUWXiKcPjsituefPb(Color P_0, bool P_1)
		{
		}

		private void JgwdqyHeItDLxETQJPMkPVbgMFSN(Sprite P_0)
		{
		}

		private void tyilUvChdTogkeFOZyayRsejEbbq(string P_0)
		{
		}

		private void IkJesJeXxIXdaatSwggkAuBdzAStA(bool P_0)
		{
		}
		...
		internal virtual bool LQDwBUFVjYdMXZIuYqvBOPLxVful()
		{
			return false;
		}

		internal void wQGLSociiEVAiQMgfNqlKorVfWfP(BaseEventData P_0)
		{
		}

		internal virtual bool rFFOtJAlAcasBPbwsddQAooGmbaDb(GameObject P_0)
		{
			return false;
		}

		private bool yZygJmAoVygoqREhsjqELbnhCoxaA(BaseEventData P_0)
		{
			return false;
		}

		private bool UJuAhBErsykFFAzdbMmyrOjMUXrab(bool P_0, GameObject P_1)
		{
			return false;
		}

		private InteractionState OVSKGGMgaMOtUvyeWFrQVApTRaGX(BaseEventData P_0)
		{
			return default(InteractionState);
		}

		private bool dJUapSxlYWCFcvFSUsmbsrffAlQi(InteractionState P_0)
		{
			return false;
		}

		private void RgGIdTJICzIhssTFuSQeWJXsRkUG()
		{
		}

		private void fgPBIYOljisOTYyijlfhnsvMYDFK()
		{
		}

		private void spRlOmsJvrnQCJgGIOwknVgUQSmV(bool P_0, bool P_1)
		{
		}

		private void oCssMTKAmAilXFrbBagSzENfoCtDA()
		{
		}

		private void MFseLYeDAcDiBYuFIxPLWlaRgnugA()
		{
		}

		private void bPIYRkDbiyklYOPrVcdwPeeormEG()
		{
		}

		private void ziBbvVSclMqegKbnSSscJsIVUYeO()
		{
		}
		...
		internal static bool DCHbCGBtToBMUuyaQyNyejzbDARj(int P_0)
		{
			return false;
		}

		internal static Vector3 CTWfMWnKErKZBXYXIrYLiGLVkdZv(int P_0)
		{
			return default(Vector3);
		}

		internal static bool EsKWfSTAhoSoScWdismEtDCNxrMQ(int P_0)
		{
			return false;
		}

		internal static bool twtmEheroSfLdzyYEfcfTnDxKGmi(int P_0)
		{
			return false;
		}

		private static int OAVGGOQyiLSfOKahWoQlKlBPsBqi(int P_0)
		{
			return 0;
		}

		internal static bool XyxPHcjJpXQKNPKeTJslDOyIEHcM(MouseButtonFlags P_0, int P_1)
		{
			return false;
		}

		private static bool tFRcYmJzbWSaSXCkVfylThgIdtWG(MouseButtonFlags P_0, int P_1)
		{
			return false;
		}

		private static int JeUiRpietThnKYRVRAJKjTbUlMpbb(int P_0)
		{
			return 0;
		}

		internal static bool cLDfuJFPVqHjMvDyrBfcToJqHCQE(MouseButtonFlags P_0, out int P_1)
		{
			P_1 = default(int);
			return false;
		}

		internal static bool ZhxdMxFPkJwOueyEXUPOQpoFKraZA(int P_0, MouseButtonFlags P_1, EventTriggerType P_2)
		{
			return false;
		}

		internal static bool fJHXwnYvoWovaYKvfzKZnelgRWQe(MouseButtonFlags P_0)
		{
			return false;
		}

		[CompilerGenerated]
		private void UhKNnhaXPBwifZOMhBzqfgoqSNAC(bool P_0)
		{
		}
	}
}
