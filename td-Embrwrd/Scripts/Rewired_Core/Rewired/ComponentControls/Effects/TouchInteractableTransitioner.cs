...
namespace Rewired.ComponentControls.Effects
{
	...
	public sealed class TouchInteractableTransitioner : MonoBehaviour, IVisibilityChangedHandler, TouchInteractable.IInteractionStateTransitionHandler
	{
		...
		private TouchInteractable.InteractionState OWdBANSegXoHJQIuIrGOgUOCWVkp;
		...
		private void fXPstKbqNgShFrCPFsMFpHAawNFO()
		{
		}

		private void PsrkdVqkZVMdbRbgxbaXgMCQPMkUA()
		{
		}

		private void GToyQfqDZzPkJKZozNmaBqHQiNjH(bool P_0)
		{
		}

		private void bCWQADXMIYEaJZCqsDloHeEYDakLA(bool P_0, bool P_1)
		{
		}

		private bool zQSIaXIMrhlKgQuzfLNIdzevHpLL()
		{
			return false;
		}

		private void kckjTveaRCneYCbMcurbhlHlkVDsb()
		{
		}

		private void VUWFKVowVMijsAdkIHrSKMkURLfpA(TouchInteractable.InteractionState P_0, bool P_1)
		{
		}

		private void pQynPwvdPPiRKQJaWpHXVkpHAcKgA(Color P_0, bool P_1)
		{
		}

		private void MhcJANOGTffyuGnILrgzZTFPuldV(Sprite P_0)
		{
		}

		private void bsaDwMxJDyYTNoqDxRkqGBTMuXch(string P_0)
		{
		}
