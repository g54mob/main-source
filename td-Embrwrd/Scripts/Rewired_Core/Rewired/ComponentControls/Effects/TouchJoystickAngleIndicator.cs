...
namespace Rewired.ComponentControls.Effects
{
	...
	public sealed class TouchJoystickAngleIndicator : MonoBehaviour, IVisibilityChangedHandler, TouchJoystick.IStickPositionChangedHandler
	{
		...
		private Image jmwQoKRtdSbIEnARdAxuyWLQQpdw;

		private RectTransform asWqHVbQBBBevnrcRdbMgggTBFaJ;

		private Vector2 mohgrdHugdqumgWQCGmjCZexIRIXb;

		private bool ZbRaUNWcDHFcdIDwhBkkqFnFmFjPA;

		private IRegistrar<TouchJoystickAngleIndicator> aJEEgNNYvuFmECfEaEBSoocCUNSX;
		...
		internal Image PrhGVhXKgiUVXYPNdtQgRJtPdjkt => null;

		internal Sprite JsBMfJzkruGHqFYDBlAnKqrSSkfl => null;

		internal RectTransform jZhSUkvPdtjRsdmYtJEVxndBiiKeb => null;
		...
		internal bool SgetPUdHNkfTtLxMAGdSyfKiRBep(out Vector2 P_0)
		{
			P_0 = default(Vector2);
			return false;
		}
		...
		private void MGMDWOdMPwYpysrTjMxwigisCRiqA(bool P_0, bool P_1)
		{
		}

		private void XBvcZOUrqxZtqyjxcuGIKJaDJEyO(Vector2 P_0)
		{
		}

		private void liOIuwUxqyLjOCcOaIEEATilAqKXA()
		{
		}

		private void wCmdWrutJpHMlFhEYRfziOYBUgsXb()
		{
		}

		private void OaZGLRFtxtOkcGYUBaynTHemYJmKB()
		{
		}

		private void TBZBIGxHvHglAKVuVJkadmdjhmknc()
		{
		}

		private void oyjouWuvOZPkKIAwytRXKcKzReeV()
		{
		}
