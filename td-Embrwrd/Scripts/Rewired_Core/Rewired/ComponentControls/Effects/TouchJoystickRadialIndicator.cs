...
namespace Rewired.ComponentControls.Effects
{
	...
	public sealed class TouchJoystickRadialIndicator : MonoBehaviour, IRegistrar<TouchJoystickAngleIndicator>
	{
		...
		private static readonly Vector2 QYdLnYXMMCHmBdrfnPkebWOwSphh;

		private RectTransform yDONsNbigNZlnMHAJllBSdoheEFfA;

		private List<TouchJoystickAngleIndicator> jCxfecfTITGEYELIKWaDIgGaJiWib;
		...
		private RectTransform cwfDjErRlJxiYnXRJhfEMjfahqhj => null;
		...
		private void VcxQNdkApxeBSDQFLonMByrboGdF()
		{
		}

		private void rjfbTKKzqOXOpudNACLOuuAsWKMR(TouchJoystickAngleIndicator P_0)
		{
		}

		private void BHnVbCxwYjnczimLcxKDRmkleqVi()
		{
		}

		private void TEYjJXLXCkkiHWKKugnONKKiPJRH()
		{
		}
	}
}
