...
namespace Rewired.Utils
{
	...
	{
		private static Action<object, Action> jxdRXFEtsoPHKefPEhBEBVVMsTmh;
		...
		private static void TIMUcGDBGodJXSbzFoNGluWCeFGr(object P_0, Action P_1)
		{
		}
	...
	{
		private T ilKxHeuKzMRHACDEyDOKKKgzkSZO;

		private static Action<object, Action<T>> ANaFETCHQCHwtjEUxJZkkNoXXlBRA;
		...
		private static void UzBWkheSfigKOwXgqjeSTiGNgVBEA(object P_0, Action<T> P_1)
		{
		}
	...
	{
		private T mZPpbqepfHxylfLyubvBWfBGMOSB;

		private T2 VENhAEJfnXblhjOtkelmPwVexNTQ;

		private static Action<object, Action<T, T2>> OSFTcgQMXKaYebKhqjdeKKyrERUj;
		...
		private static void vJfDERAzapeoYvulzgwrYDxhDRZqA(object P_0, Action<T, T2> P_1)
		{
		}
