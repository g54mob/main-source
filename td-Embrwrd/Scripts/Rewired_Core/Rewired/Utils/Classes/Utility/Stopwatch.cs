...
namespace Rewired.Utils.Classes.Utility
{
	...
	{
		private const long vHNcibrMvuhWwXCYLHzkBIaNmnvw = 10000000L;

		public static readonly Stopwatch Global;

		private static long IuuzYimafzCRbITEYIhLyfxPaayQ;

		private System.Diagnostics.Stopwatch axjiCIijPAZRHtOcNcjCSkxfjifF;

		private long AakjyVDdXvnfhftaPbTpwhjssWom;
