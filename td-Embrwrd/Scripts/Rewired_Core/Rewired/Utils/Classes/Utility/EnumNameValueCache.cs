...
namespace Rewired.Utils.Classes.Utility
{
	...
	{
		private static EnumNameValueCache<TEnum> HjMTOSoGHzMHBLzbiNHnSwocEPtU;

		private readonly ADictionary<string, TEnum> aGeKvcqPQziMjvKAyZmyKsmPJOru;

		private readonly string[] ySHrlBIHcvSXpoGzNfLJgerkHXbL;

		private readonly long[] VeEliiFfjdUYCfHlpmmSxEPDTjNV;
