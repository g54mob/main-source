...
namespace Rewired.Data.Mapping
{
	...
	internal interface IHardwareControllerTemplateMap_Internal
	{
		...
		qVrtDhCppSFJeqDjDfvjFKbIExZx GetAxisTarget(Controller controller, int elementIdentifierId);

		qVrtDhCppSFJeqDjDfvjFKbIExZx GetButtonTarget(Controller controller, int elementIdentifierId);
	}
}
