...
namespace Rewired.Data.Mapping
{
	public sealed class HardwareJoystickTemplateMap : HardwareControllerTemplateMap, IHardwareControllerTemplateMap, IHardwareControllerTemplateMap_Internal, IHardwareControllerMap, IHardwareControllerMap_Internal
	{
		...
		private sealed class rZVBtTplhTFKdtdTKRvKNhFmJqyU : IEnumerable<IControllerElementIdentifierCommon_Internal>, IEnumerable, IEnumerator<IControllerElementIdentifierCommon_Internal>, IEnumerator, IDisposable
		{
			private int mpuBkssLrwEqoLFYSEjaaPJrqgaEA;

			private IControllerElementIdentifierCommon_Internal EksFXAtwaUmabuHsOhpZQIxQAlIBA;

			private int ojozmCZvjphpJxORtJMiqgwLhRvX;

			public HardwareJoystickTemplateMap QoJVngAJdDJNRBvxfCItxsapqVHu;

			private int PrRpmCwYxUtbBRxTzWrOTEgHSyWG;
			...
			[DebuggerHidden]
			public rZVBtTplhTFKdtdTKRvKNhFmJqyU(int P_0)
			{
			}
		...
		private sealed class HYHTqFIQOsfOhfwnDCqJfLXLygljA : IEnumerable<ControllerTemplateElementIdentifier>, IEnumerable, IEnumerator<ControllerTemplateElementIdentifier>, IEnumerator, IDisposable
		{
			private int EUKMJUbquWhlnaEszOvefsxKQaLP;

			private ControllerTemplateElementIdentifier THcacTTMZPiMPTcTMdJfunqEaKBE;

			private int GjnFYZcvaxlZesCDPKEHdghaPMmj;

			public HardwareJoystickTemplateMap BforQVPgITgPdcrqQvfELadomvbAA;

			private int FFKemcepzPbDpybLIGRVzwcNScvE;
			...
			[DebuggerHidden]
			public HYHTqFIQOsfOhfwnDCqJfLXLygljA(int P_0)
			{
			}
		...
		[NonSerialized]
		private Func<Guid, Entry> KzTyfVsiDHkGSeDUIkkRXQEgWMqu;
		...
		{
			[IteratorStateMachine(typeof(HYHTqFIQOsfOhfwnDCqJfLXLygljA))]
			get
			{
				return null;
			}
		...
		{
			[IteratorStateMachine(typeof(rZVBtTplhTFKdtdTKRvKNhFmJqyU))]
			get
			{
				return null;
			}
		...
		private Func<Guid, Entry> QNxIZalQZVqHjvcJyEvVfBuYVIIV => null;
		...
		internal bool lcLrrObeNqkKQFHVKFJSirFcJSyo(ControllerMap_Editor P_0, HardwareJoystickMap P_1, Guid P_2, out string P_3)
		{
			P_3 = null;
			return false;
		}

		internal BRZfXhCCXgmnPhcExxqIrBLyAiOAA HmSDPsTtPtcuADvhAKecMRQVkToPA()
		{
			return null;
		}

		private Entry wRoFFGIXCfJmXqayxipqDwLhMBfSc(Guid P_0)
		{
			return null;
		}
		...
		qVrtDhCppSFJeqDjDfvjFKbIExZx IHardwareControllerTemplateMap_Internal.GetAxisTarget(Controller controller, int elementIdentifierId)
		{
			return null;
		}

		qVrtDhCppSFJeqDjDfvjFKbIExZx IHardwareControllerTemplateMap_Internal.GetButtonTarget(Controller controller, int elementIdentifierId)
		{
			return null;
		}

		internal static qVrtDhCppSFJeqDjDfvjFKbIExZx UVFYiymFPwSBdNcQHcilkAwThLYT(IHardwareControllerTemplateMap_Internal P_0, Controller P_1, int P_2, Func<Guid, Entry> P_3)
		{
			return null;
		}

		internal static qVrtDhCppSFJeqDjDfvjFKbIExZx lnCaKmGvIiZgFBZyLkNtwFGtxgQwA(IHardwareControllerTemplateMap_Internal P_0, Controller P_1, int P_2, Func<Guid, Entry> P_3)
		{
			return null;
		}

		internal static ControllerTemplateElementIdentifier vFtWArxPvzRtoAxCtEdWfRXVoeHL(ControllerTemplateElementIdentifier[] P_0, int P_1)
		{
			return null;
		}

		internal static int OlSLWdyOdMPlkuDAOdkcvNQmmdYy(ControllerTemplateElementIdentifier[] P_0, int P_1)
		{
			return 0;
		}

		internal static bool zbpSpyYLGQgcDBUDmxheJcIYaZjhA(ControllerTemplateElementIdentifier[] P_0, int P_1)
		{
			return false;
		}
	}
