...
namespace Rewired.Data
{
	...
	public sealed class CustomController_Editor
	{
		...
		private sealed class kBJwhsKagpHMxjQPrubtDjHFwgHBA : IEnumerable<ControllerElementIdentifier>, IEnumerable, IEnumerator<ControllerElementIdentifier>, IEnumerator, IDisposable
		{
			private int pYkdkeJuCwTzteLQAFYHWTKUCgxS;

			private ControllerElementIdentifier sksJIIpdjsEcBkhjDtLCAtQRXZlf;

			private int yDrydgvwwQlhZSvSRkMlFUpjNlZy;

			public CustomController_Editor sKcyyXbnOWGvjVCMkrqpPBJyIIJf;

			private int LPxoWvGWFBVMfyhAQEazErTqhczuA;
			...
			[DebuggerHidden]
			public kBJwhsKagpHMxjQPrubtDjHFwgHBA(int P_0)
			{
			}
		...
		{
			[IteratorStateMachine(typeof(kBJwhsKagpHMxjQPrubtDjHFwgHBA))]
			get
			{
				return null;
			}
		...
		private void oGCHAUrvawcHFyLXotoIXcSZbbpgA<_0001>(int P_0, List<_0001> P_1) where _0001 : Element
		{
		}

		private ControllerElementIdentifier apYElsYplzLlHBMXlRXJPmsvhAex(int P_0, string P_1)
		{
			return null;
		}

		private Element txvhONgdCZHIaEMCrHjCbimeJwLoc(ControllerElementType P_0)
		{
			return null;
		}

		private ControllerElementIdentifier hqQdNQJTwFBLZeJQkCXawnwBKsdbb(ControllerElementType P_0, string P_1, string P_2, string P_3, string P_4, string P_5, string P_6)
		{
			return null;
		}
