...
namespace Rewired
{
	...
	{
		private tXJirrlXlZzKdnLNAQCbtbqqcbwL OFwUtxIbAiGraOttpVbNKDqInjLE;

		private InputActionEventType cTQiAOhOQvgmwaMQfgLtsTLkHRMVA;
		...
		internal InputActionEventData(tXJirrlXlZzKdnLNAQCbtbqqcbwL P_0, int P_1, int P_2, UpdateLoopType P_3)
		{
			OFwUtxIbAiGraOttpVbNKDqInjLE = null;
			cTQiAOhOQvgmwaMQfgLtsTLkHRMVA = default(InputActionEventType);
			playerId = 0;
			actionId = 0;
			updateLoop = default(UpdateLoopType);
		}
	}
}
