...
namespace Rewired.Platforms.Custom
{
	public abstract class CustomPlatformUnifiedKeyboardSource : CustomPlatformUnifiedControllerSource
	{
		public sealed class KeyPropertyMap
		{
			...
			private IndexedDictionary<int, string> OvYCBljymuZFAofZLTPqqWrCGUNP;

			private bool ZPIBJoxzOZsrUTupuhVlTKbzjcBw;

			internal bool xFZBgoxvNsdPfLDxQzwlmLisTVSu
			{
				get
				{
					return false;
		...
		private KeyPropertyMap XESvYQKBfbEvfgJXrIgRaYfgqyZQB;
		...
		internal override void uHCGieECfKYBsHDnkLDeavbafxAIA()
		{
		}

		private void YMBppCdFJKBgGZWLxGlsFGduQQsVA()
		{
		}
	}
}
