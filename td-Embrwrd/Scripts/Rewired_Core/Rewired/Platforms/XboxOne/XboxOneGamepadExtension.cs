...
namespace Rewired.Platforms.XboxOne
{
	...
	{
		private class QBvrbXnwokTFUXlZBbfoBuFUjZuH : IControllerExtensionSource
		{
			public const int uoTtzQHQYQIEmMMTykbbHBkLJzyl = 4;

			public vkILuKPvdHIKCqiXEDJbDuPsYCTd YJHAZsHEJeEvDjdRaBzhrNKLYKfB;

			public readonly IXboxOneInputSource qezLHaFVewUROVXcVWGtOpFCatmo;

			public readonly bool nkeuxhXxUqbwhOTgwyWtrFTDVsAF;

			public QBvrbXnwokTFUXlZBbfoBuFUjZuH(bool P_0, IXboxOneInputSource P_1, vkILuKPvdHIKCqiXEDJbDuPsYCTd P_2)
			{
			}
		}

		private QBvrbXnwokTFUXlZBbfoBuFUjZuH pzsfYhKgSGtidfEekNFTLuzMKZGB;

		private TimerAbs[] SjBBXQfKXorOcQnODhyvWKbdubty;
		...
		private void DfCFiWMqrIgmxeqvFfKBacXkUcXlB()
		{
		}

		private void ctycJHqJamIsCSwbSSBqqFMCSjug(XboxOneGamepadMotorType P_0, float P_1, float P_2)
		{
		}

		private void VzfRKUBasZEBLJCvtnOPCEvxIWjf()
		{
		}
	}
}
