...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class QZUeilEkhbpsQmYBaJmQLhQXgFZyA : IControllerExtensionSource
		{
			public readonly IDriver_RailDriver vZgWICXpcZjWkCTcUJRtKazTXBbh;

			public QZUeilEkhbpsQmYBaJmQLhQXgFZyA(IDriver_RailDriver P_0)
			{
			}
		}

		private QZUeilEkhbpsQmYBaJmQLhQXgFZyA DCcDFDlKdCgMBqGLmCZrFGErocCH;
