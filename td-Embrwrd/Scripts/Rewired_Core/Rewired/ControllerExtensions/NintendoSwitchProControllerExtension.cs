...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class QYkQXYpAoriRxwXpUinQqQdndDMC : ExtSource_Base
		{
			public IDriver_NintendoSwitchProController DHGpdipbVdrvMNtcxNgJKigOdNIG => null;

			public QYkQXYpAoriRxwXpUinQqQdndDMC(IDriver_NintendoSwitchProController P_0)
				: base(null)
			{
			}
		}
		...
		private new QYkQXYpAoriRxwXpUinQqQdndDMC source => null;
