...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class GknarWKBiPpKsauxUTaXMMsvHifp : IControllerExtensionSource
		{
			public readonly ISteamControllerInternal YkfbCEelxPXFAFgdJjyZHMCrDtWt;

			public GknarWKBiPpKsauxUTaXMMsvHifp(ISteamControllerInternal P_0)
			{
			}
		}

		private GknarWKBiPpKsauxUTaXMMsvHifp mYYHmsBwvtnjbXaZDdrmKvoAicWe;
		...
		private void FkeOajMxWGpRzlmZqcXXZFhxNHse()
		{
		}
	}
}
