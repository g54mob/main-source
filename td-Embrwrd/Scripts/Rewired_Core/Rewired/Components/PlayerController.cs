...
namespace Rewired.Components
{
	...
	public class PlayerController : ComponentWrapper<Rewired.PlayerController>, IPlayerController
	{
		...
		internal virtual List<ElementInfo> tqKtTocfcpjWbSHMMmrMmbfMiWlO()
		{
			return null;
		}

		private void trfsnkCAZtQqIfUsAWuANqSQSQWh(int P_0, bool P_1)
		{
		}

		private void KQMPGnGJeRIEJfLgcDBrhpHnPcxbA(int P_0, float P_1)
		{
		}

		private void feWRZHXRBOjTspMCtGyjQRAzmHoJ(bool P_0)
		{
		}

		private void pdOxkygFNDhKGiGtEchdcVniaCLFb()
		{
		}
	}
}
