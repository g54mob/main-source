...
namespace Rewired
{
	public sealed class ControllerMapEnabler
	{
		...
		internal class HpMfZZSHWRqWPbtnBAbCZKOmVmyU
		{
			public bool AQKofbBOBFKdRYYtnVOYYdMhENXj;

			public YZMWkhowTJMPHPNFMJYgSFWZmkzE[] iOqeQRraGNimOdKKRJJpGLFixWlnB;

			public HpMfZZSHWRqWPbtnBAbCZKOmVmyU(bool P_0, YZMWkhowTJMPHPNFMJYgSFWZmkzE[] P_1)
			{
			}
		}

		private bool PkAASbDFTzZxOgNQBQelUVUJyZjQ;

		private Player zrxGWDOpArgGqkepGMgcuEXQhgbv;

		private HpMfZZSHWRqWPbtnBAbCZKOmVmyU obhYUOJEDLSomFiVRLvcIQLpfkvHA;

		private readonly int pdOERQPACMkRFXodOUzFeiOZzufH;

		private List<RuleSet> uiYVqDNdNQREVfbYgfvLDxOdyANiA;
		...
		internal ControllerMapEnabler(Player P_0, HpMfZZSHWRqWPbtnBAbCZKOmVmyU P_1)
		{
		}
		...
		private SerializedObject qniaijoFBrdrxeRiFbTUoQWzMgei()
		{
			return null;
		}

		private void xgoJFfFQZVnUtUzsZiPABMPyvnpn(SerializedObject P_0)
		{
		}

		private bool rjppjIikkuxojwzqNkObniGNZOue(SerializedObject P_0)
		{
			return false;
		}
	}
