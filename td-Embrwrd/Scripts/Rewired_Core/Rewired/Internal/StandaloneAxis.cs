...
namespace Rewired.Internal
{
	...
	internal sealed class StandaloneAxis
	{
		...
		[CompilerGenerated]
		private AxisValueChangedEventHandler HBEGGfXGFgHNhnmqrUlVkDgPUJfC;

		[CompilerGenerated]
		private AxisValueChangedEventHandler UcxPsSZIvtmvsjkerwoHuYVAaOaY;

		[CompilerGenerated]
		private ButtonDownEventHandler tEuJtvUxfJajCYlnPIpSuZNgdqkh;

		[CompilerGenerated]
		private ButtonUpEventHandler LIeAbputKRcIqWWPsgfOCUAorbQF;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler ewEXMaXFsICiuFmAhlOPgnfIqSvsA;

		[CompilerGenerated]
		private ButtonDownEventHandler iYAqixFLMvqyXVgHDnBJQPMvhQAIA;

		[CompilerGenerated]
		private ButtonUpEventHandler myTSwCukqfpikzehKoXLnWJflpZk;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler jlnSGjKnYaORMTDkKqIZnraOZGYL;
