...
namespace Rewired.Internal.Localization
{
	...
	internal sealed class DeviceLocalizationInfo
	{
		...
		private readonly ReadOnlyList<string> hIZhFcgAYEGkTbjjdBksEKocaxOaA;

		private readonly IList<string> BEHSXymzhlrDmbqGmUQOoVBeuJsO;

		private readonly ReadOnlyList<Guid> tNpdYWizsiyBDQfvNdQpvDwAVwfN;

		private string bPTEwkjTpqIhcDFbFwgiAvFxsCAGb;

		private Bytes20 qZpRwqzybMrwLFbzseacoPqKbKEEA;

		private bool rXaddqGifKWGkQIPgJGzavHFIwRL;
		...
		private void nIxKHsLEWlQjeWprMIMvZtBwQWuq()
		{
		}

		private void rVqoWeHBIVmAQumHFmSabsaJgEzR()
		{
		}
