...
public class UI_MapScene_SecretVault_Popup : APopupWindow
{
	private enum eStep
	{
		SELECT_TOWERS = 0,
	...
	private UI_Obj_AcademyCardSet_SecretVault displayCardSet;
	...
	private eStep curStep;

	private readonly List<eItemType> selectedTowers;

	private readonly List<TetrisCardData> selectedTetris;

	private List<eItemType> selectedRelics;

	private readonly List<UI_Obj_ShopCard> towerListCards;

	private readonly List<UI_Obj_ShopCard> tetrisListCards;

	private readonly List<UI_Obj_ShopCard> relicListCards;

	private List<eItemType> list_startingRunes;

	private const int MAX_TOWER_CHOOSE_COUNT = 8;
	...
	public void UpdateSelectableTowers()
	{
	}
