...
namespace Rewired.Glyphs.UnityUI
{
	...
	public class UnityUITextMeshProGlyphHelper : MonoBehaviour
	{
		...
		private RewiredElementHelper rewiredElementHelper => null;
		...
		private static Dictionary<string, DisplayType> s_displayTypeTerms => null;

		private static Dictionary<string, AxisRange> s_axisRangeTerms => null;

		private static Dictionary<string, Pole> s_poleTerms => null;
