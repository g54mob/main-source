...
namespace Assets.Scripts.Levels.LevelScripts
{
	public class LowFlyer : Level
	{
		...
		{
			_distanceRequirement = new SurfaceDistanceTravelRequirement(this, 50000.0);
			...
			AddLevelRequirement(new BelowAltitudeRequirement(this, 5000f));
		}
