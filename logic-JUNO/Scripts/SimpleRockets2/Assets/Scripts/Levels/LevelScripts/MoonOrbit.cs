...
namespace Assets.Scripts.Levels.LevelScripts
{
	public class MoonOrbit : Level
	{
		...
		public override void InitializeRequirements()
		{
			...
			ILevelRequirement dependency = AddLevelRequirement(new ParentRequirement(this, "Luna"));
			AddLevelRequirement(new ApsisRequirement(this, ApsisRequirement.ApsisType.Apoapsis, 25000.0)).AddDependency(dependency);
			AddLevelRequirement(new ApsisRequirement(this, ApsisRequirement.ApsisType.Periapsis, 25000.0)).AddDependency(dependency);
