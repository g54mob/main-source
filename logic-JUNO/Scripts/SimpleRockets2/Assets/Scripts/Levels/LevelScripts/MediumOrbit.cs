...
{
	public class MediumOrbit : Level
	{
		...
		{
			AddLevelRequirement(new FuelRequirement(this, 200000f));
			...
			AddLevelRequirement(new ApsisRequirement(this, ApsisRequirement.ApsisType.Apoapsis, 5000000.0)).AddDependency(levelRequirement);
			AddLevelRequirement(new ApsisRequirement(this, ApsisRequirement.ApsisType.Periapsis, 5000000.0)).AddDependency(levelRequirement);
