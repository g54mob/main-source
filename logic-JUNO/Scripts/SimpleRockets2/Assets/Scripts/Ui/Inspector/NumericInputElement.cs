...
{
	public class NumericInputElement : ItemElement
	{
		private TMP_InputField _input;

		private TextMeshProUGUI _labelText;

		private NumericInputModel _model;

		private double? _value;

		public NumericInputElement(XmlElement xmlElement, NumericInputModel model, GroupModel group)
		...
		public override void Update()
		{
			...
			if (!_input.isFocused && _value != value)
			{
				_value = value;
				try
				{
		...
		private void OnValueChanged(string s)
		{
			try
			{
				double value = _model.InputParser(s);
