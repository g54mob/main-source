...
namespace Rewired.Components
{
	...
	public sealed class PlayerMouse : PlayerController, IPlayerMouse, IPlayerController, IMouseInputSource
	{
		...
		private Rewired.PlayerMouse ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb => base.source as Rewired.PlayerMouse;
		...
		bool IPlayerMouse.defaultToCenter
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EdefaultToCenter;
			}
			set
			{
				if (ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb == null)
				{
					_defaultToCenter = value;
					return;
				}
				ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EdefaultToCenter = value;
				_defaultToCenter = ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EdefaultToCenter;
			}
		}
		...
		public bool clampToMovementArea
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.clampToMovementArea;
			}
			set
			{
				if (ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb == null)
				...
				ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.clampToMovementArea = value;
				_clampToMovementArea = ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.clampToMovementArea;
			}
		}
		...
		ScreenRect IPlayerMouse.movementArea
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EmovementArea;
			}
			set
			{
				if (ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb == null)
				...
				ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EmovementArea = value;
				_movementArea = new Rect(ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EmovementArea.xMin, ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EmovementArea.yMin, ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EmovementArea.width, ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EmovementArea.height);
			}
		}
		...
		Rewired.PlayerMouse.MovementAreaUnit IPlayerMouse.movementAreaUnit
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EmovementAreaUnit;
			}
			set
			{
				if (ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb == null)
				...
				ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EmovementAreaUnit = value;
				_movementAreaUnit = ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EmovementAreaUnit;
			}
		}
		...
		Vector2 IPlayerMouse.screenPosition
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EscreenPosition;
			}
			set
			{
				if (ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb != null)
				{
					ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EscreenPosition = value;
				}
			}
		}
		...
		Vector2 IPlayerMouse.screenPositionPrev
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EscreenPositionPrev;
			}
		}
		...
		Vector2 IPlayerMouse.screenPositionDelta
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EscreenPositionDelta;
			}
		}
		...
		Rewired.PlayerController.MouseAxis IPlayerMouse.xAxis
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002ExAxis;
			}
		}
		...
		Rewired.PlayerController.MouseAxis IPlayerMouse.yAxis
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EyAxis;
			}
		}
		...
		Rewired.PlayerController.MouseWheel IPlayerMouse.wheel
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002Ewheel;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.leftButton
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EleftButton;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.rightButton
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002ErightButton;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.middleButton
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EmiddleButton;
			}
		}
		...
		float IPlayerMouse.pointerSpeed
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EpointerSpeed;
			}
			set
			{
				if (value < 0f)
				...
				if (base.initialized)
				{
					ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EpointerSpeed = value;
					_pointerSpeed = ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EpointerSpeed;
				}
			}
		}
		...
		bool IPlayerMouse.useHardwarePointerPosition
		{
			get
			{
				...
				return ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EuseHardwarePointerPosition;
			}
			set
			{
				...
				if (base.initialized)
				{
					ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EuseHardwarePointerPosition = value;
				}
			}
		}
		...
		bool IMouseInputSource.enabled
		{
			get
			{
				...
				return ((IMouseInputSource)ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb).enabled;
			}
		}
		...
		Vector2 IMouseInputSource.screenPosition
		{
			get
			{
				...
				return ((IMouseInputSource)ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb).screenPosition;
			}
		}
		...
		Vector2 IMouseInputSource.screenPositionDelta
		{
			get
			{
				...
				return ((IMouseInputSource)ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb).screenPositionDelta;
			}
		}
		...
		Vector2 IMouseInputSource.wheelDelta
		{
			get
			{
				...
				return ((IMouseInputSource)ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb).wheelDelta;
			}
		}
		...
		bool IMouseInputSource.locked
		{
			get
			{
				...
				return ((IMouseInputSource)ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb).locked;
			}
		}
		...
		event Action<Vector2> IPlayerMouse.ScreenPositionChangedEvent
		{
			add
			{
				if (base.initialized)
				{
					ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EScreenPositionChangedEvent += value;
				}
			}
			remove
			{
		...
		protected override Rewired.PlayerController CreateSource(object args)
		{
			...
			if (list == null || list.Count == 0)
			{
				...
				list = rFmLfaTexIEhWsBcEfIsAmWRWsAI();
			}
		...
		protected override void Subscribe()
		{
			...
			if (ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb != null)
			{
				ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb.Rewired_002EIPlayerMouse_002EScreenPositionChangedEvent += JLdhtPGKUBVcJqXgEBrbdTrtkPlDb;
			}
		}
		...
		internal List<ElementInfo> QFdrrPujvNoZgNLqoGbTVAzpTRaK()
		{
		...
		private void JLdhtPGKUBVcJqXgEBrbdTrtkPlDb(Vector2 P_0)
		{
		...
		bool IMouseInputSource.GetButtonDown(int button)
		{
			...
			return ((IMouseInputSource)ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb).GetButtonDown(button);
		}
		...
		bool IMouseInputSource.GetButtonUp(int button)
		{
			...
			return ((IMouseInputSource)ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb).GetButtonUp(button);
		}
		...
		bool IMouseInputSource.GetButton(int button)
		{
			...
			return ((IMouseInputSource)ZdCNAmXmbVHlvAsCgpZnvsuCNcHHb).GetButton(button);
		}
	}
}
