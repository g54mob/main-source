...
namespace Rewired.Data
{
	...
	{
		private static class luyOuBPHuSLcWUeCelchhFvrDfLI
		{
			public const string KuuzGQUHDWJBFKSdQEgClnnZDblBA = "updateLoop";

			public const string isOCDWAeOshGxXlHQFnssGKEJgWWA = "alwaysUseUnityInput";

			public const string VjLKyEEboOyYIsNpldHoGUgbEEjx = "windowsStandalonePrimaryInputSource";

			public const string maDWSXNWSvQMRKqNRtUubHqDgudp = "osx_primaryInputSource";

			public const string rCWlOYmtteyjnXXLruAsQfEWJlnQ = "linux_primaryInputSource";

			public const string lpdNuLdyWTEAlAvlaFQxMAnAyPhr = "windowsUWP_primaryInputSource";

			public const string ksSbshAKEXPnigAOzixpoJrLitmtA = "xboxOne_primaryInputSource";

			public const string hkWTDabxbaQwscOHmBhNIAnbgTkiA = "gameCoreXboxOne_primaryInputSource";

			public const string ZvTEuMcHNrnNZUJKgFFKSirkNXKn = "gameCoreScarlett_primaryInputSource";

			public const string rJtlxfnXOuYDHiOayRqkbJwCDylL = "ps4_primaryInputSource";

			public const string kkiiuomUIsEQESvAEjdOORXYmgVk = "ps5_primaryInputSource";

			public const string ddBNXOTpbfhDoioTUesCIIUBEgQCA = "webGL_primaryInputSource";

			public const string UuENDVlsmXPCzCpqRxqcITDRrXiD = "stadia_primaryInputSource";

			public const string yWKGSbXxyBbgZDDnvveathqmDpkvA = "useXInput";

			public const string JRQotiAsqTAzKUhgPwOkqAAFgeueA = "windowsStandalone_useSteamRawInputControllerWorkaround";

			public const string wKAzhlUwyemuwreUYuFPbVFeVmDF = "osxStandalone_useEnhancedDeviceSupport";

			public const string iZaqvHnkvhpomipfqWfRFelUJEIl = "android_supportUnknownGamepads";

			public const string tUSaGkHburHsCtOIJgfHTOTFbbKQ = "ps4_assignJoysticksByPS4JoyId";

			public const string geHysfQPwIWdZTqsRmHYUmCvDSedA = "useSteamControllerSupport";

			public const string LHJKGtNRToHpERvxIKQlnmscYFCR = "logToScreen";

			public const string CQzcZwkKPDQOGKEtuGJQYEBMrjPb = "runInEditMode";

			public const string PjUHqlIIbMhUkBITJCRdwAFCiwReb = "allowInputInEditorSceneView";

			public const string kZhwVRuTnAVWhiyJHhKKVeTgulxX = "maxJoysticksPerPlayer";

			public const string wQXALHgqllRmlmsChLOPzlbsnWsl = "autoAssignJoysticks";

			public const string kxnGVTbBDOhJSipkpDVlPhTvxXdFA = "assignJoysticksToPlayingPlayersOnly";

			public const string lotKkJhcHyYGMYgvSUeCrtatKXyH = "distributeJoysticksEvenly";

			public const string qVKsdbvOoAVjilDgQECRELFrslCEA = "reassignJoystickToPreviousOwnerOnReconnect";

			public const string uHFmaxanjOeZbMSlqjUFBKNkMiAU = "defaultJoystickAxis2DDeadZoneType";

			public const string ooorKAIqvtpVYKonJeCqJrSlvSxoA = "defaultJoystickAxis2DSensitivityType";

			public const string KMUfLveIrcCoiIPtegXTmwnRsmtic = "defaultAxisSensitivityType";

			public const string UGqeiAutBsRCbgyGyJgiFhjYeCIv = "force4WayHats";

			public const string RMtKLdxzmcOwqKtLTpJmqRnJKnMw = "throttleCalibrationMode";

			public const string UYlRvaWAxzZHrIOLwkSXZezNGSDbA = "activateActionButtonsOnNegativeValue";

			public const string JIWANGNEDVcYtHsMNCrNyIoFneteb = "deferControllerConnectedEventsOnStart";

			public const string VgJbrYGqFmBYDWrCNLNIADjGCHPtB = "logLevel";

			public const string BMekDDwuGgajMgzUOmdlpbxFhKxE = "disableKeyboard";

			public const string FYZKfvazLmZqUkdxEjotVkfADCcm = "disableMouse";

			public const string CJNLryFBlpFOaHXbYiAIxYuPrXkj = "ignoreInputWhenAppNotInFocus";

			public const string cFGMVJLEnDqCihgsZtSOgXOtcNtI = "useEnhancedDeviceSupport";

			public const string SHJhtTOQomncEeZTLlVIGkyJunEw = "useNativeMouse";

			public const string daWmvkeIrBhVjXqIxeXjjCGPNfSA = "useNativeKeyboard";

			public const string AklcULBzHzxNpDnMqfpliOiavirU = "joystickRefreshRate";

			public const string otvVCtLutqgOgdqbTGLVxaKnkSBi = "assignJoysticksBySystemId";
		}
		...
		private class ldUgslzIydOrJMscpnuMScFcjbqA
		{
			public Func<PlatformVars> ydecmUQqVEzMVQIBsyNAffIWRlsP;

			public string iJxOUrSILXwsHFSwoqMTHpNNzrVB;

			public ldUgslzIydOrJMscpnuMScFcjbqA(Func<PlatformVars> P_0, string P_1)
			{
				ydecmUQqVEzMVQIBsyNAffIWRlsP = P_0;
				iJxOUrSILXwsHFSwoqMTHpNNzrVB = P_1;
			}
		}

		private class kaPEYbwcAkknieUudpHvIgMMcUab
		{
			public Func<Platform, object> YMwzpMfIAAeiTEUVUKROtNavIyxF;

			public Action<Platform, object> WpCUvtMEEtOvJukbIeNJNvqlZguS;

			public kaPEYbwcAkknieUudpHvIgMMcUab(Func<Platform, object> P_0, Action<Platform, object> P_1)
			{
				YMwzpMfIAAeiTEUVUKROtNavIyxF = P_0;
				WpCUvtMEEtOvJukbIeNJNvqlZguS = P_1;
			}
		}
		...
		private Dictionary<int, ldUgslzIydOrJMscpnuMScFcjbqA> __platformVarsDict;

		private Dictionary<int, kaPEYbwcAkknieUudpHvIgMMcUab> __getSetPlatformVariableDict;

		private KeyedGetSetValueStore<string> __configVarsValues;

		private Dictionary<string, object> __valueDelegates;

		private Dictionary<int, ldUgslzIydOrJMscpnuMScFcjbqA> platformVarsDict
		{
			get
			{
				Dictionary<int, ldUgslzIydOrJMscpnuMScFcjbqA> dictionary = __platformVarsDict;
				if (dictionary == null)
				{
					Dictionary<int, ldUgslzIydOrJMscpnuMScFcjbqA> obj = new Dictionary<int, ldUgslzIydOrJMscpnuMScFcjbqA>
					{
						{
							1,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_windowsStandalone), "platformVars_windowsStandalone")
						},
						{
							29,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_windowsUWP), "platformVars_windowsUWP")
						},
						{
							6,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_linuxStandalone), "platformVars_linuxStandalone")
						},
						{
							4,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_osxStandalone), "platformVars_osxStandalone")
						},
						{
							5,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_iOS), "platformVars_iOS")
						},
						{
							28,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_tvOS), "platformVars_tvOS")
						},
						{
							13,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_ps4), "platformVars_ps4")
						},
						{
							106,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_ps5), "platformVars_ps5")
						},
						{
							15,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_psVita), "platformVars_psVita")
						},
						{
							14,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_psVita), "platformVars_psVita")
						...
						{
							32,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_switch), "platformVars_switch")
						},
						{
							11,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_xboxOne), "platformVars_xboxOne")
						},
						{
							104,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_gameCoreXboxOne), "platformVars_gameCoreXboxOne")
						},
						{
							105,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_gameCoreScarlett), "platformVars_gameCoreScarlett")
						},
						{
							19,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_webGL), "platformVars_webGL")
						},
						{
							103,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_stadia), "platformVars_stadia")
						},
						{
							7,
							new ldUgslzIydOrJMscpnuMScFcjbqA(() => GetOrCreatePlatformVars(ref platformVars_android), "platformVars_android")
						}
					};
					Dictionary<int, ldUgslzIydOrJMscpnuMScFcjbqA> dictionary2 = obj;
		...
		private Dictionary<int, kaPEYbwcAkknieUudpHvIgMMcUab> getSetPlatformVariableDict
		{
			get
			{
				Dictionary<int, kaPEYbwcAkknieUudpHvIgMMcUab> dictionary = __getSetPlatformVariableDict;
				if (dictionary == null)
				{
					Dictionary<int, kaPEYbwcAkknieUudpHvIgMMcUab> obj = new Dictionary<int, kaPEYbwcAkknieUudpHvIgMMcUab>
					{
						{
							0,
							new kaPEYbwcAkknieUudpHvIgMMcUab((Platform p) => GetPlatformVars(p).disableKeyboard, delegate(Platform platform, object value)
							{
						...
						{
							2,
							new kaPEYbwcAkknieUudpHvIgMMcUab((Platform p) => GetPlatformVars(p).disableMouse, delegate(Platform platform, object value)
							{
						...
						{
							1,
							new kaPEYbwcAkknieUudpHvIgMMcUab((Platform platform) => GetPlatformVars(platform).ignoreInputWhenAppNotInFocus, delegate(Platform platform, object value)
							{
								GetPlatformVars(platform).ignoreInputWhenAppNotInFocus = (bool)value;
							})
						}
					};
					Dictionary<int, kaPEYbwcAkknieUudpHvIgMMcUab> dictionary2 = obj;
		...
		internal string GetPlatformVarsRelPath(Platform platform)
		{
			...
			{
				return platformVarsDict[(int)platform].iJxOUrSILXwsHFSwoqMTHpNNzrVB;
			}
		...
		{
			PlatformVars platformVars = ((!platformVarsDict.ContainsKey((int)platform)) ? GetOrCreatePlatformVars(ref platformVars_unknown) : platformVarsDict[(int)platform].ydecmUQqVEzMVQIBsyNAffIWRlsP());
		...
		{
			foreach (KeyValuePair<int, ldUgslzIydOrJMscpnuMScFcjbqA> item in platformVarsDict)
			{
				if (getSetPlatformVariableDict.ContainsKey((int)var))
				{
					getSetPlatformVariableDict[(int)var].WpCUvtMEEtOvJukbIeNJNvqlZguS((Platform)item.Key, value);
				}
			}
		}
		...
		private MultiBoolValue GetAllSerializedPlatformVar_multiBool(AllPlatformVar var)
		{
			...
			foreach (KeyValuePair<int, ldUgslzIydOrJMscpnuMScFcjbqA> item in platformVarsDict)
			{
				...
				object obj = getSetPlatformVariableDict[(int)var].YMwzpMfIAAeiTEUVUKROtNavIyxF((Platform)item.Key);
				if (obj == null)
				{
					continue;
				}
