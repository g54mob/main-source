...
namespace Rewired.Data
{
	...
	public sealed class CustomController_Editor
	{
		...
		private sealed class BCOOinmsnXoQGoxkwYbpWEVussy : IEnumerable<ControllerElementIdentifier>, IEnumerable, IEnumerator<ControllerElementIdentifier>, IEnumerator, IDisposable
		{
			private int LavqOBHcnlxKUlztxnywKblcnOST;

			private ControllerElementIdentifier woTtkGpKnsWuMyFYMChyauXooeNyA;

			private int XVGItEqHBXoyCKXuXicjQkJaONux;

			public CustomController_Editor KjKQwOCOlovpvjbSXmYkDzfHCnZG;

			private int ZarDDMITezYHkTqaktMWEsgoALkAb;
			...
			ControllerElementIdentifier IEnumerator<ControllerElementIdentifier>.Current
			{
				...
				get
				{
					return woTtkGpKnsWuMyFYMChyauXooeNyA;
				}
			}
			...
			[DebuggerHidden]
			public BCOOinmsnXoQGoxkwYbpWEVussy(int P_0)
			{
				LavqOBHcnlxKUlztxnywKblcnOST = P_0;
				XVGItEqHBXoyCKXuXicjQkJaONux = Environment.CurrentManagedThreadId;
			}
			...
			{
				int lavqOBHcnlxKUlztxnywKblcnOST = LavqOBHcnlxKUlztxnywKblcnOST;
				CustomController_Editor kjKQwOCOlovpvjbSXmYkDzfHCnZG = KjKQwOCOlovpvjbSXmYkDzfHCnZG;
				switch (lavqOBHcnlxKUlztxnywKblcnOST)
				{
				default:
					return false;
				case 0:
					LavqOBHcnlxKUlztxnywKblcnOST = -1;
					if (kjKQwOCOlovpvjbSXmYkDzfHCnZG._elementIdentifiers == null)
					{
						return false;
					}
					ZarDDMITezYHkTqaktMWEsgoALkAb = 0;
					break;
				case 1:
					LavqOBHcnlxKUlztxnywKblcnOST = -1;
					ZarDDMITezYHkTqaktMWEsgoALkAb++;
					break;
				}
				if (ZarDDMITezYHkTqaktMWEsgoALkAb < kjKQwOCOlovpvjbSXmYkDzfHCnZG._elementIdentifiers.Count)
				{
					woTtkGpKnsWuMyFYMChyauXooeNyA = kjKQwOCOlovpvjbSXmYkDzfHCnZG._elementIdentifiers[ZarDDMITezYHkTqaktMWEsgoALkAb];
					LavqOBHcnlxKUlztxnywKblcnOST = 1;
					return true;
				}
				return false;
			...
			{
				BCOOinmsnXoQGoxkwYbpWEVussy bCOOinmsnXoQGoxkwYbpWEVussy;
				if (LavqOBHcnlxKUlztxnywKblcnOST == -2 && XVGItEqHBXoyCKXuXicjQkJaONux == Environment.CurrentManagedThreadId)
				{
					LavqOBHcnlxKUlztxnywKblcnOST = 0;
					bCOOinmsnXoQGoxkwYbpWEVussy = this;
				}
				else
				{
					bCOOinmsnXoQGoxkwYbpWEVussy = new BCOOinmsnXoQGoxkwYbpWEVussy(0);
					bCOOinmsnXoQGoxkwYbpWEVussy.KjKQwOCOlovpvjbSXmYkDzfHCnZG = KjKQwOCOlovpvjbSXmYkDzfHCnZG;
				}
				return bCOOinmsnXoQGoxkwYbpWEVussy;
			}
		...
		{
			[IteratorStateMachine(typeof(BCOOinmsnXoQGoxkwYbpWEVussy))]
			get
			{
				return new BCOOinmsnXoQGoxkwYbpWEVussy(-2)
				{
					KjKQwOCOlovpvjbSXmYkDzfHCnZG = this
				};
			}
		}
		...
		public void AddAxis()
		{
			axes.Add((Axis)pnPVyVVsEwprXwqarCyoAMJSVmoJA(ControllerElementType.Axis));
		}

		public void AddButton()
		{
			buttons.Add((Button)pnPVyVVsEwprXwqarCyoAMJSVmoJA(ControllerElementType.Button));
		}
		...
		public void InsertAxis(int index)
		{
			...
			axes.Insert(index, (Axis)pnPVyVVsEwprXwqarCyoAMJSVmoJA(ControllerElementType.Axis));
		}
		...
		public void InsertButton(int index)
		{
			...
			buttons.Insert(index, (Button)pnPVyVVsEwprXwqarCyoAMJSVmoJA(ControllerElementType.Button));
		}
		...
		public void DuplicateElement(ControllerElementType type, int index)
		{
			...
			{
			case ControllerElementType.Axis:
				wTgVoMKeoVPeqOsloezmjBxIVnEv(index, axes);
				break;
			case ControllerElementType.Button:
				wTgVoMKeoVPeqOsloezmjBxIVnEv(index, buttons);
				break;
			default:
				throw new NotImplementedException();
			}
		...
		private void wTgVoMKeoVPeqOsloezmjBxIVnEv<_0001>(int P_0, List<_0001> P_1) where _0001 : Element
		{
			...
			ControllerElementIdentifier controllerElementIdentifier = kLoyNidklSeOaKtbdGMlavHHeIRRB(val.elementIdentifierId, text);
		...
		private ControllerElementIdentifier kLoyNidklSeOaKtbdGMlavHHeIRRB(int P_0, string P_1)
		{
		...
		private Element pnPVyVVsEwprXwqarCyoAMJSVmoJA(ControllerElementType P_0)
		{
			switch (P_0)
			{
			case ControllerElementType.Axis:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier2 = qSkCsUIGkrNknSAqAbdBVYkVsQepA(P_0, text2, string.Empty, string.Empty);
			...
			case ControllerElementType.Button:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier = qSkCsUIGkrNknSAqAbdBVYkVsQepA(P_0, text, string.Empty, string.Empty);
		...
		private ControllerElementIdentifier qSkCsUIGkrNknSAqAbdBVYkVsQepA(ControllerElementType P_0, string P_1, string P_2, string P_3)
		{
			int elementIdentifierIdCounter = _elementIdentifierIdCounter;
			_elementIdentifierIdCounter++;
