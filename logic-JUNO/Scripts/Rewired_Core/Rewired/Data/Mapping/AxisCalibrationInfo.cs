...
namespace Rewired.Data.Mapping
{
	...
	public class AxisCalibrationInfo : IDeepCloneable
	{
		...
		internal static AxisCalibrationData jwQjxTEswBnUDsAgCeTFEIRODAWhb(AxisCalibrationInfo P_0)
		{
			if (P_0 == null)
			{
		...
		internal static AxisCalibrationInfo fvvZwRGIgrkXSpsePCoVesVXBICd(AxisCalibrationData P_0)
		{
