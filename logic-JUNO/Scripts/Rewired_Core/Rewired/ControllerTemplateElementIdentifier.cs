...
namespace Rewired
{
	...
	public class ControllerTemplateElementIdentifier : IControllerElementIdentifierCommon_Internal, IControllerTemplateElementIdentifier
	{
		...
		{
			return new ControllerElementIdentifier(_id, _name, _positiveName, _negativeName, tqmHLUqTfYnnflPJaWxRPIPYjlrx.ccBNSPSUbYbUedNeQGskfxKLPcwY(_elementType), CompoundControllerElementType.Axis2D, isMappableOnPlatform);
		}
	}
}
