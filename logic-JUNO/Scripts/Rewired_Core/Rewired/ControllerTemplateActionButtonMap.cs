...
namespace Rewired
{
	...
	{
		private Pole HMVWydOOrKjPZvaFnIuAOcJSvdhF;

		public Pole axisContribution => HMVWydOOrKjPZvaFnIuAOcJSvdhF;
		...
		{
			HMVWydOOrKjPZvaFnIuAOcJSvdhF = P_1.axisContribution;
		}
		...
		{
			HMVWydOOrKjPZvaFnIuAOcJSvdhF = P_2;
		}

		internal void nAWUTqtMDGJQOBBoifZQsxHBjhAf(SerializedObject P_0)
		{
			base.nbRcGqFmdPBFbvAHNvzlHgGflOMSA(P_0);
			P_0.Add("axisContribution", HMVWydOOrKjPZvaFnIuAOcJSvdhF);
		}

		internal void SHLFnUSPGwMqmSatuzbcCdjqiZEC(SerializedObject P_0)
		{
			base.cLonVRMJRJDDsWpsmpAImCfajIgS(P_0);
			P_0.TryGetDeserializedValueByRef("axisContribution", ref HMVWydOOrKjPZvaFnIuAOcJSvdhF);
		}

		internal void XJSgYamDpLObuCWkVSTRAwOstLLG()
		{
			HMVWydOOrKjPZvaFnIuAOcJSvdhF = Pole.Positive;
		}

		internal int qhtVwYprTgAGuPQLtTmcPbhLlbCb(IControllerTemplateElementSource P_0, List<ActionElementMap> P_1, bool P_2)
		{
			...
			int num = 0;
			ActionElementMap actionElementMap = IwJMFtwQknUaJcleyqEBELxIkIoS(controllerTemplateButtonSource.target, HMVWydOOrKjPZvaFnIuAOcJSvdhF);
		...
		private ActionElementMap IwJMFtwQknUaJcleyqEBELxIkIoS(IControllerElementTarget P_0, Pole P_1)
		{
