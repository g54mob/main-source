...
namespace Rewired.HID.Drivers
{
	...
	internal abstract class HIDDeviceDriver : IControllerDriver, IDisposable
	{
		...
		private bool wOVCBgAuZmWmqDpaTzFGUOPviHsI;
		...
		protected bool disposed => wOVCBgAuZmWmqDpaTzFGUOPviHsI;
		...
		{
			if (!wOVCBgAuZmWmqDpaTzFGUOPviHsI)
			{
				wOVCBgAuZmWmqDpaTzFGUOPviHsI = true;
			}
		}
	}
}
