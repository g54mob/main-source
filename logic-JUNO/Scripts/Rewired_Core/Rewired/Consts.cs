...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static ReadOnlyCollection<ControllerElementIdentifier> XSTyeoSMIiMEGYfYGfIsQyczMFOE;

		private static ReadOnlyCollection<ControllerElementIdentifier> azynwLqvaXBfhdPKlhoxZTxxGwmo;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] gmrcMlzUMzHALlXEsmMOFgXfhBxh;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] tJaSyWbCReRCGHWcnkilNQSMbvih;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] vaONDiIuwJrogmjEaTAohozUxvye;
		...
		private static readonly string[] LjyIzLEgCyovPlZzpDAJcYTfzLtG;

		public const int vendorId_sony = 1356;

		internal static readonly IList<PidVid> pidVids_sony_dualShock4;

		private static readonly PidVid[] mcrGLhFDYDdoVjUezfZIQLUhMSXr;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] hTxoedoGwPyJRdfllCdOHfDcDTEkA;

		private static readonly ControllerElementIdentifier[] iwPqIFCfGqaLwfJbluwgshaJtubL;
		...
		internal static IList<ControllerElementIdentifier> unityUnifiedMouseElementIdentifiers => XSTyeoSMIiMEGYfYGfIsQyczMFOE ?? (XSTyeoSMIiMEGYfYGfIsQyczMFOE = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[11]
		{
		...
		internal static IList<ControllerElementIdentifier> rawInputUnifiedMouseElementIdentifiers => azynwLqvaXBfhdPKlhoxZTxxGwmo ?? (azynwLqvaXBfhdPKlhoxZTxxGwmo = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[9]
		{
			new ControllerElementIdentifier(0, "Mouse Horizontal", "Mouse Right", "Mouse Left", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, true),
			new ControllerElementIdentifier(1, "Mouse Vertical", "Mouse Up", "Mouse Down", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, true),
			new ControllerElementIdentifier(2, "Mouse Wheel", "Mouse Wheel Up", "Mouse Wheel Down", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, true),
		...
		internal static ControllerElementIdentifier[] unknownJoystickElementIdentifiers_orig => iwPqIFCfGqaLwfJbluwgshaJtubL;
		...
		static Consts()
		{
			...
			gmrcMlzUMzHALlXEsmMOFgXfhBxh = new string[3] { "MouseAxis1", "MouseAxis2", "MouseAxis3" };
			tJaSyWbCReRCGHWcnkilNQSMbvih = new string[7] { "MouseButton0", "MouseButton1", "MouseButton2", "MouseButton3", "MouseButton4", "MouseButton5", "MouseButton6" };
			vaONDiIuwJrogmjEaTAohozUxvye = new string[132]
			{
			...
			LjyIzLEgCyovPlZzpDAJcYTfzLtG = new string[5] { "", "Ctrl", "Alt", "Shift", "Cmd" };
			mcrGLhFDYDdoVjUezfZIQLUhMSXr = new PidVid[3]
			{
				new PidVid(1476, 1356),
				new PidVid(2976, 1356),
				new PidVid(2508, 1356)
			};
			hTxoedoGwPyJRdfllCdOHfDcDTEkA = new string[4] { "Sony Computer Entertainment Wireless Controller", "Sony Interactive Entertainment DUALSHOCK®4 USB Wireless Adaptor", "Wireless Controller", "Sony Interactive Entertainment Wireless Controller" };
			mouseAxisUnityNames = new ReadOnlyCollection<string>(gmrcMlzUMzHALlXEsmMOFgXfhBxh);
			mouseButtonUnityNames = new ReadOnlyCollection<string>(tJaSyWbCReRCGHWcnkilNQSMbvih);
			keyboardKeyNames = new ReadOnlyCollection<string>(vaONDiIuwJrogmjEaTAohozUxvye);
			keyboardKeyValues = new ReadOnlyCollection<int>(_keyboardKeyValues);
			modifierKeyShortNames = new ReadOnlyCollection<string>(LjyIzLEgCyovPlZzpDAJcYTfzLtG);
			pidVids_sony_dualShock4 = new ReadOnlyCollection<PidVid>(mcrGLhFDYDdoVjUezfZIQLUhMSXr);
			productNames_sony_dualShock4 = new ReadOnlyCollection<string>(hTxoedoGwPyJRdfllCdOHfDcDTEkA);
			...
			iwPqIFCfGqaLwfJbluwgshaJtubL = RawgmigDVNVCBgPjdgMEeEOtdohrA();
			if (132 != vaONDiIuwJrogmjEaTAohozUxvye.Length)
			{
		...
		private static ControllerElementIdentifier[] RawgmigDVNVCBgPjdgMEeEOtdohrA()
		{
			int num = 0;
