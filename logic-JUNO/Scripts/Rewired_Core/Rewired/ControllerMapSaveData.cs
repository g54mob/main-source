...
namespace Rewired
{
	public abstract class ControllerMapSaveData
	{
		...
		internal readonly int OeVIlDcZHUtpXGqefDKFgcjJbzzic;
		...
		internal ControllerMapSaveData(Controller P_0, ControllerMap P_1)
		{
			_controller = P_0;
			_map = P_1;
			OeVIlDcZHUtpXGqefDKFgcjJbzzic = ReInput.id;
		}

		internal static _0001 NLDSCPAAMFhCZlkXEsBGSMkfdojX<_0001>(Controller P_0, ControllerMap P_1) where _0001 : ControllerMapSaveData
		{
			return (_0001)NLDSCPAAMFhCZlkXEsBGSMkfdojX(P_0, P_1);
		}

		internal static ControllerMapSaveData NLDSCPAAMFhCZlkXEsBGSMkfdojX(Controller P_0, ControllerMap P_1)
		{
