...
namespace Rewired.Utils
{
	...
	{
		private static byte[] OOUMFoZMlJcBZVSNjaTveJoKBFGM;

		private static byte[] intToFloatBuffer => OOUMFoZMlJcBZVSNjaTveJoKBFGM ?? (OOUMFoZMlJcBZVSNjaTveJoKBFGM = new byte[4]);
