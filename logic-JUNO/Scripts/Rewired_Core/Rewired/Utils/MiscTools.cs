...
namespace Rewired.Utils
{
	...
	{
		private static uint vyDNkybxmvUvpdXwwDEncBMjShzj = 0u;

		private static uint EJsqfKJmvqXKHZjumbqtQCJIkgcA = 1u;

		private static uint IfibCwhKezFOvjhSStmzcHCXjjZEb = uint.MaxValue;

		private static int GZGNVQEAsMuFMBiTDZCwjQDhFAzR = 0;

		private static int sTyRNDruzckMgnIwNYPmtzUOBTIS = int.MaxValue;

		private static int mSaeOvhIRzqIbIGOVFqSAcJHsqxDb = -1;
		...
		{
			counter = ((counter != IfibCwhKezFOvjhSStmzcHCXjjZEb) ? (counter + 1) : EJsqfKJmvqXKHZjumbqtQCJIkgcA);
			return counter;
		}

		public static int Tick(int counter)
		{
			counter = ((counter != sTyRNDruzckMgnIwNYPmtzUOBTIS) ? (counter + 1) : GZGNVQEAsMuFMBiTDZCwjQDhFAzR);
			return counter;
		}

		public static uint TickPrev(uint counter)
		{
			counter = ((counter != EJsqfKJmvqXKHZjumbqtQCJIkgcA) ? (counter - 1) : IfibCwhKezFOvjhSStmzcHCXjjZEb);
			return counter;
		}

		public static int TickPrev(int counter)
		{
			if (counter <= mSaeOvhIRzqIbIGOVFqSAcJHsqxDb)
			{
				return sTyRNDruzckMgnIwNYPmtzUOBTIS;
			}
			counter = ((counter != GZGNVQEAsMuFMBiTDZCwjQDhFAzR) ? (counter - 1) : sTyRNDruzckMgnIwNYPmtzUOBTIS);
			return counter;
		}

		public static bool IsTickValid(uint tick)
		{
			return tick != vyDNkybxmvUvpdXwwDEncBMjShzj;
		}

		public static bool IsTickValid(int tick)
		{
			return tick > mSaeOvhIRzqIbIGOVFqSAcJHsqxDb;
		}
		...
		public static bool IsTickNewer(uint tick1, uint tick2)
		{
			...
			if (tick1 == vyDNkybxmvUvpdXwwDEncBMjShzj)
			{
				return false;
			}
			if (tick2 == vyDNkybxmvUvpdXwwDEncBMjShzj)
			{
				return true;
			}
			if (tick1 < tick2)
		...
		public static bool IsTickNewer(int tick1, int tick2)
		{
			...
			if (tick1 <= mSaeOvhIRzqIbIGOVFqSAcJHsqxDb)
			{
				return false;
			}
			if (tick2 <= mSaeOvhIRzqIbIGOVFqSAcJHsqxDb)
			{
				return true;
			}
			if (tick1 < tick2)
		...
		public static long TickDifference(uint tick1, uint tick2)
		{
			...
			uint num3 = IfibCwhKezFOvjhSStmzcHCXjjZEb - num + num2;
			uint eJsqfKJmvqXKHZjumbqtQCJIkgcA = EJsqfKJmvqXKHZjumbqtQCJIkgcA;
			uint num4 = num3 - eJsqfKJmvqXKHZjumbqtQCJIkgcA;
			if (tick1 >= tick2)
			{
				return 0L - (long)num4;
			}
		...
		public static int TickDifference(int tick1, int tick2)
		{
			...
			int num3 = sTyRNDruzckMgnIwNYPmtzUOBTIS - num + num2;
			int gZGNVQEAsMuFMBiTDZCwjQDhFAzR = GZGNVQEAsMuFMBiTDZCwjQDhFAzR;
			int num4 = num3 - gZGNVQEAsMuFMBiTDZCwjQDhFAzR;
			if (tick1 >= tick2)
			{
				return -num4;
			}
