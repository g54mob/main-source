...
namespace Rewired.Utils.Classes.Utility
{
	...
	internal class TimerRealTime
	{
		...
		[SerializeField]
		private double AruymLuhhiBmYHEoqpgNWCykNBMcA;
		...
		{
			running = true;
			AruymLuhhiBmYHEoqpgNWCykNBMcA = length + ReInput.realTime;
		}
		...
		public bool Update()
		{
			...
			if (ReInput.realTime >= AruymLuhhiBmYHEoqpgNWCykNBMcA)
			{
				running = false;
				return true;
			}
		...
		{
			running = false;
			AruymLuhhiBmYHEoqpgNWCykNBMcA = 0.0;
		}
