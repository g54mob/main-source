	...
	public class RotateAroundAxis : MonoBehaviour
	{
		...
		private void Update()
		{
			if (_speed != Speed.Stopped)
			{
				...
				base.transform.Rotate(amKCJqNBaGvuRYAyNhXQhreOKKoS(_rotateAroundAxis), num * Time.deltaTime, _relativeTo);
			}
		}

		private static Vector3 amKCJqNBaGvuRYAyNhXQhreOKKoS(RotationAxis P_0)
		{
			return P_0 switch
			{
