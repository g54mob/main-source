...
namespace Rewired
{
	...
	{
		private T SFuWtFuKRqvRDgoFLtmracQcxHkg;

		private bool aAzCbIGKAbXNROsJPOzpSeZOhhxH;

		public T source => SFuWtFuKRqvRDgoFLtmracQcxHkg;
		...
		{
			SFuWtFuKRqvRDgoFLtmracQcxHkg = P_0;
		}
		...
		{
			if (!aAzCbIGKAbXNROsJPOzpSeZOhhxH)
			{
				aAzCbIGKAbXNROsJPOzpSeZOhhxH = true;
			}
		}
	}
}
