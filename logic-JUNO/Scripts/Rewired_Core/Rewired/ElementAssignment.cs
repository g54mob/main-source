...
namespace Rewired
{
	public struct ElementAssignment
	{
		...
		{
			type = tqmHLUqTfYnnflPJaWxRPIPYjlrx.otoebBGKhmXybGnjjgyQdfdKwrLRb(P_0, P_1, P_3);
		...
		public ElementAssignment(KeyCode P_0, ModifierKeyFlags P_1, int P_2, Pole P_3)
		{
			...
			elementIdentifierId = Keyboard.PYvDBmmVmdPzOqnzaqMoZHAQEYJs(Keyboard.SkWJKaKQzacnGBhlAhZVBZAnpnsQA(P_0));
			axisRange = AxisRange.Positive;
			keyboardKey = P_0;
