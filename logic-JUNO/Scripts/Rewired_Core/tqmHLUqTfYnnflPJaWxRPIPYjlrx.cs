...
internal static class tqmHLUqTfYnnflPJaWxRPIPYjlrx
{
	public static ControllerElementType puzVnKjbWWaKIdOxIXdDkfWaAHYeA(ElementAssignmentType P_0)
	{
		switch (P_0)
		{
	...
	public static ElementAssignmentType otoebBGKhmXybGnjjgyQdfdKwrLRb(ControllerType P_0, ControllerElementType P_1, AxisRange P_2)
	{
	...
	public static AxisRange zGEENYHHdPOMKJRPcLsIevhNYnLJA(Pole P_0)
	{
		return P_0 switch
		{
	...
	public static Type VBJOxARoDrVVtuVhqZaWieYyGSUU<_0001>() where _0001 : Controller
	{
		return CcQcqAlfzMPSogvFZCxphByEMGCc(typeof(_0001));
	}

	public static Type CcQcqAlfzMPSogvFZCxphByEMGCc(Type P_0)
	{
	...
	public static Type MwKwRhOdmFAcvDDAlHNnvhvTKZxnA(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static Type HbzrCDBzXfsDStWcHGJrJYmlFcoj(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerType IPXNaTgGWJWlsptkPocDXigWhTms(Type P_0)
	{
		if (P_0 == null)
		{
	...
	public static ControllerType zezCNvguhRVTLYWJVarLuiAoqPgT<_0001>()
	{
		return IPXNaTgGWJWlsptkPocDXigWhTms(typeof(_0001));
	}

	public static ControllerType CKvIJlNdPesniZjPEcCWncarXXBV(Type P_0)
	{
		if (!gTHZzzebyEYOeIxmgeTvojpIvqrj(P_0, out var result))
		{
			throw new Exception(P_0.Name + " is not an allowed type.");
		}
		return result;
	...
	public static ControllerType EhYajDcncZtdTdZJzpoLzPeXMuoJ<_0001>() where _0001 : ControllerMap
	{
		return CKvIJlNdPesniZjPEcCWncarXXBV(typeof(_0001));
	}

	public static bool gTHZzzebyEYOeIxmgeTvojpIvqrj(Type P_0, out ControllerType P_1)
	{
		if (P_0 == null)
		{
	...
	public static bool PHxVWnJlHnLFvnawqSOhGVCaoXJu<_0001>(out ControllerType P_0) where _0001 : ControllerMap
	{
		return gTHZzzebyEYOeIxmgeTvojpIvqrj(typeof(_0001), out P_0);
	}

	public static ControllerType LhqTbgAOiBEKVCFeyGQUIFESRRKP(Type P_0)
	{
		if (P_0 == null)
		{
	...
	public static ControllerType qRUQwprVePmeJDbCizBoafPRrzvk<_0001>() where _0001 : ControllerMapSaveData
	{
		return LhqTbgAOiBEKVCFeyGQUIFESRRKP(typeof(_0001));
	}

	public static bool BKYdbhlvGNWRVJPfaVZTWMNnecZV(ControllerTemplateElementType P_0, ControllerElementType P_1)
	{
		return P_1 switch
		{
	...
	public static ControllerElementType kIdanrEQgoqhtYbKMrksbOXKKFid(object P_0)
	{
		if (P_0 == null)
		{
		...
		{
			return ccBNSPSUbYbUedNeQGskfxKLPcwY((ControllerTemplateElementType)P_0);
		}
		throw new NotImplementedException();
	}

	public static ControllerElementType ccBNSPSUbYbUedNeQGskfxKLPcwY(ControllerTemplateElementType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerTemplateElementSourceType uVGtRDnnhCsBeprNVAHmNnysXHJm(ControllerTemplateElementType P_0, bool P_1)
	{
		switch (P_0)
		{
	...
	public static ControllerTemplateElementType JvBigfIhtPNrGARcJUTouJqnanOt(ControllerElementType P_0, bool P_1)
	{
		switch (P_0)
		{
		case ControllerElementType.Axis:
