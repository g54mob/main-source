...
namespace ModApi.Settings
{
	public class EnabledMod
	{
		...
		{
			return new XElement("EnabledMod", new XAttribute("name", Name), new XAttribute("version", Version), new XAttribute("lastUpdated", LastUpdated), new XAttribute("path", Path));
		}
