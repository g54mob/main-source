...
namespace Jundroo.ModTools.Core
{
	public class ModHeader
	{
		...
		static ModHeader()
		{
			Default = new ModHeader(0L, 0L, 0L, 0L);
			_HeaderTagV1 = "SimpleRockets 2".Replace(" ", string.Empty) + "ModHeaderV001";
		...
		public ModHeader(long? windowsOffset, long? macOSOffset, long? linuxOffset, long? androidOffset)
		{
		...
		public ModHeader(FileInfo windowsBundle, FileInfo macOSBundle, FileInfo linuxBundle, FileInfo androidBundle)
		{
			long num = _HeaderTagV1Bytes.Length + 32;
		...
		public static ModHeader Read(string filePath)
		{
			...
			return new ModHeader(windowsOffset, macOSOffset, linuxOffset, androidOffset);
		}
