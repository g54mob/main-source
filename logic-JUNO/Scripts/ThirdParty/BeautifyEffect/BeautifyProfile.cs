...
namespace BeautifyEffect
{
	...
	public class BeautifyProfile : ScriptableObject
	{
		...
		[Range(0.01f, 5f)]
		public float sharpenMotionRestoreSpeed = 0.5f;
		...
		[Range(0.1f, 8f)]
		public float antialiasMaxSpread = 3f;

		[Range(0f, 0.05f)]
		public float antialiasDepthThreshold = 1E-06f;
		...
		[Range(0f, 0.5f)]
		public float frameBandVerticalSize = 0.1f;
