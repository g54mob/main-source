...
[ExecuteInEditMode]
public class ObjectCentricColorization : ImageEffectBase
{
	...
	private void OnRenderImage(RenderTexture src, RenderTexture dest)
	{
		...
		if (gameObject != null && (bool)gameObject.transform)
		{
			...
			base.material.SetColor("_NearColor", NearColor);
			base.material.SetColor("_FarColor", FarColor);
			base.material.SetFloat("_ColorBandSize", Mathf.Clamp(ColorBandSize, 0f, 1f));
