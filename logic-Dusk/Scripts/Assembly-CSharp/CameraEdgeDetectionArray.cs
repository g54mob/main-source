...
[ExecuteInEditMode]
public class CameraEdgeDetectionArray : ImageEffectBase
{
	public RenderTexture pixelRT;

	public RenderTexture lightMaskRT;

	public RenderTexture feedBackRT;
	...
	private void OnPreCull()
	{
		...
		if (DroneManager.Instance != null && DroneManager.Instance.CurrentDrone != null)
		{
			...
			{
				DroneManager.Instance.CurrentDrone.transform.Find("SpotlightTestCameraArray").gameObject.SetActive(true);
			}
			else
			{
				DroneManager.Instance.CurrentDrone.Swival.transform.Find("SpotlightTest").gameObject.SetActive(true);
			}
		}
	}
	...
	private void OnRenderImage(RenderTexture src, RenderTexture dest)
	{
		...
		if (feedBackRT != null)
		{
			base.material.SetTexture("_FeedBackTex", feedBackRT);
		}
