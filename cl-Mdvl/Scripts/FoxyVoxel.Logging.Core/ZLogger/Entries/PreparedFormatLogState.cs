...
namespace ZLogger.Entries
{
	public struct PreparedFormatLogState<TPayload, T1> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1> self, LogInfo logInfo)
		{
		...
		{
			return PreparedFormatLogEntry<TPayload, T1>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4, T5>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4, T5, T6>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4, T5, T6, T7>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4, T5, T6, T7, T8>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>.Create(in logInfo, in this);
		}
	}
	public struct PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> : IZLoggerState
	{
		...
		private static IZLoggerEntry factory(PreparedFormatLogState<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> self, LogInfo logInfo)
		{
			return self.CreateLogEntry(logInfo);
		}
		...
		public IZLoggerEntry CreateLogEntry(LogInfo logInfo)
		{
			return PreparedFormatLogEntry<TPayload, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>.Create(in logInfo, in this);
		}
	}
}
