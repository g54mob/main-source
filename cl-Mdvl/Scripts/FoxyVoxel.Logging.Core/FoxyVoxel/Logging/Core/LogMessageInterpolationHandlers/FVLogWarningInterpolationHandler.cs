...
namespace FoxyVoxel.Logging.Core.LogMessageInterpolationHandlers
{
	...
	public readonly ref struct FVLogWarningInterpolationHandler
	{
		...
		public FVLogWarningInterpolationHandler(int literalLength, int formattedCount, out bool isEnabled, [CallerFilePath] string filePath = "?")
		{
		...
		public void LogMessage()
		{
			if (IsEnabled)
			{
				Logger.LogNoCheck(LogLevel.Warning, GetFormattedText());
			}
		}
