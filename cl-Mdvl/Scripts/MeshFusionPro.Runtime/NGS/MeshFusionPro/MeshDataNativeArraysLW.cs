...
namespace NGS.MeshFusionPro
{
	public class MeshDataNativeArraysLW : CombinedMeshDataInternal
	{
		...
		private List<Color32> _tempColors;

		private List<Vector2> _tempUV;

		private List<Vector2> _tempUV2;

		public NativeArray<LightweightVertex> Vertices => _vertices.NativeListToArray();

		public NativeArray<Bounds> PartsBounds => _partsBounds.NativeListToArray();

		public NativeArray<Bounds> Bounds => _bounds;

		public NativeArray<LightweightVertex> VerticesLocal => _verticesLocal.NativeListToArray();
