...
namespace NGS.MeshFusionPro
{
	public class CombineTreeNode : BinaryTreeNode<ICombineSource>
	{
		...
		public override void Add(ICombineSource source)
		{
			if (_combiner == null)
			{
				_combiner = new UniversalObjectsCombiner(_tree.CombinedMeshFactory, _tree.VertexLimit, _tree.BonesLimit);
				...
				_combiner.onSkinnedCombinedObjectCreated += this.onSkinnedCombinedObjectCreated;
			}
