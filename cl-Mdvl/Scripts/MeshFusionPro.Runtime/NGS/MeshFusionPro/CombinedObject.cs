...
{
	public class CombinedObject : BaseCombinedObject, ICombinedObject<CombinedObjectPart, CombineSource>, ICombinedObject
	{
		...
		public Bounds LocalBounds => CombinedMesh.MeshData.GetBounds();

		public int VertexCount => CombinedMesh.MeshData.VertexCount;

		public CombinedMesh CombinedMesh { get; private set; }
		...
		private void Construct(CombinedMesh combinedMesh, RendererSettings settings)
		{
			...
			_meshData = (CombinedMeshDataInternal)CombinedMesh.MeshData;
			...
			CreateMeshFilter(CombinedMesh.Mesh);
		...
		public void ForceUpdate()
		{
			...
			{
				CombinedMesh.Cut(_destroyedMeshParts);
		...
		public void Combine(IEnumerable<CombineSource> sources)
		{
			...
			try
			{
				CombinedMeshPart[] array2 = CombinedMesh.Combine(array);
				num2 = 0;
		...
		{
			MeshRenderer renderer = base.gameObject.AddComponent<MeshRenderer>();
