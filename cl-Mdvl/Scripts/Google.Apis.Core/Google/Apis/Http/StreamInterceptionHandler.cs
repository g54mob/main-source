...
namespace Google.Apis.Http
{
	internal sealed class StreamInterceptionHandler : DelegatingHandler
	{
		...
		{
			Func<HttpResponseMessage, StreamInterceptor> value = null;
			request.TryGetOption<Func<HttpResponseMessage, StreamInterceptor>>("__ResponseStreamInterceptorProviderKey", out value);
			return value;
		}
	}
}
