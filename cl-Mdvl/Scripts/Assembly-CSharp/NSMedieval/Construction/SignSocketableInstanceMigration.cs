...
{
	[FVSerializableKey("SignSocketableInstance", "")]
	public class SignSocketableInstanceMigration : WorldObject, IFVMigrated
	{
		public override List<Vec3Int> Positions { get; }

		public override bool BlueprintExists => true;

		public SignSocketableInstanceMigration(FVDeserializer deserializer)
		{
