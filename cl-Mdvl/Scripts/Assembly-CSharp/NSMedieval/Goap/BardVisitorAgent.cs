...
{
	public class BardVisitorAgent : Agent
	{
		private HumanoidInstance humanoid;

		public BardVisitorAgent(HumanoidInstance humanoid)
			: base(humanoid, new NPCGoalExecutionManager(humanoid))
		{
			...
			base.GoalScheduler.AddToPool(new BardVisitorGoal(this), enableGoal: true);
		}
