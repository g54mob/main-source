...
{
	public class TrainingEventGoalRanged : EventBaseGoal
	{
		...
		public TrainingEventGoalRanged(Agent selfAgent)
			: base("TrainingEventGoalRanged", selfAgent)
		{
		}
		...
		private GoapAction EventAction()
		{
			...
			{
				AnimationTrigger = "RangeTraining";
		...
		protected void EquipProp(bool equipped)
		{
			...
			{
				bool isEnabled;
				FVLogErrorInterpolationHandler messageBuilder = new FVLogErrorInterpolationHandler(43, 1, out isEnabled, "C:\\GIT\\dev\\Assets\\Scripts\\GOAP\\Goal\\TrainingEventGoalRanged.cs");
				if (isEnabled)
				{
			...
			{
				humanoidView.BodyPreview.SetRangedPropEnabled(equipped);
			}
		}
	}
}
