...
{
	[FVSerializableKey("GameEvents.AmbushEvent", "")]
	public class AmbushEvent : GameEventInstance, IRaidPhaseDataHolder
	{
		...
		protected override bool ShouldUnlockAchievement()
		{
			return cachedRaidInfo.Won;
		}
		...
		public AmbushEvent(FVDeserializer deserializer)
			: base(deserializer)
		{
