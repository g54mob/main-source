...
{
	public class CommandSpawnDomesticAnimals : ConsoleCommand
	{
		private bool active;
		...
		public CommandSpawnDomesticAnimals()
		{
			Command = "spawnDomesticAnimal";
			Description = "Spawns domestic animal(s) on mouse click";
