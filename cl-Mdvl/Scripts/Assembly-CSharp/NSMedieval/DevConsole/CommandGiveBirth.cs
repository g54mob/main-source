...
{
	public class CommandGiveBirth : ConsoleCommand
	{
		...
		public CommandGiveBirth()
		{
			Command = "giveBirth";
			Description = "Completes pregnancy on selected female animal";
			Help = "Use this to force animal to give birth";
		}
