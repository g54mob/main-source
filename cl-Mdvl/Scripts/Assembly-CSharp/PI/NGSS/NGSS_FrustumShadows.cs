...
namespace PI.NGSS
{
	...
	public class NGSS_FrustumShadows : MonoBehaviour
	{
		...
		private void Init()
		{
			int num = (XRSettings.enabled ? XRSettings.eyeTextureWidth : mCamera.scaledPixelWidth);
			int num2 = (XRSettings.enabled ? XRSettings.eyeTextureHeight : mCamera.scaledPixelHeight);
			...
			computeShadowsCB.GetTemporaryRT(num3, num / _downGrade, num2 / _downGrade, 0, FilterMode.Bilinear, RenderTextureFormat.RG16);
			computeShadowsCB.GetTemporaryRT(num4, num / _downGrade, num2 / _downGrade, 0, FilterMode.Bilinear, RenderTextureFormat.RG16);
