			...
			if (array.Length > 1 && ArrayContains(array[0], texts))
			{
				...
				for (int count2 = CSV.Count; k < count2; k++)
				{
					...
					if (num2 > 0)
					{
						...
						{
							Debug.LogError("TypeColumnIdx=" + num2 + " Tokens.Length=" + array.Length + " Tokens[0]=" + array[0]);
							continue;
						}
					...
					if (num3 > 0)
					{
						...
						{
							Debug.LogError("DescColumnIdx=" + num3 + " Tokens.Length=" + array.Length + " Tokens[0]=" + array[0]);
							continue;
						}
