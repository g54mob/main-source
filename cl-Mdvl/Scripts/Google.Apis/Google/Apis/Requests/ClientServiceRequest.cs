...
namespace Google.Apis.Requests
{
	...
	public abstract class ClientServiceRequest<TResponse> : ClientServiceRequest, IClientServiceRequest<TResponse>, IClientServiceRequest
	{
		...
		public HttpRequestMessage CreateRequest(bool? overrideGZipEnabled = null)
		{
			...
			if (_unsuccessfulResponseHandlers != null)
			{
				httpRequestMessage.SetOption("__UnsuccessfulResponseHandlerKey", _unsuccessfulResponseHandlers);
			}
			if (_exceptionHandlers != null)
			{
				httpRequestMessage.SetOption("__ExceptionHandlerKey", _exceptionHandlers);
			}
			if (_executeInterceptors != null)
			{
				httpRequestMessage.SetOption("__ExecuteInterceptorKey", _executeInterceptors);
			}
			if (base.Credential != null)
			{
				httpRequestMessage.SetOption("__CredentialKey", base.Credential);
			}
			string apiVersion = ApiVersion;
			if (apiVersion != null)
			{
				httpRequestMessage.Headers.Add("x-goog-api-version", apiVersion);
			}
