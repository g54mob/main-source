...
namespace MalbersAnimations.PathCreation
{
	public class GlobalDisplaySettings : ScriptableObject
	{
		...
		public Color anchorHighlighted = new Color(1f, 0.57f, 0.4f);

		public Color anchorSelected = Color.white;

		[Header("Control Colours")]
		public Color control = new Color(0.35f, 0.6f, 1f, 0.85f);

		public Color controlHighlighted = new Color(0.8f, 0.67f, 0.97f);

		public Color controlSelected = Color.white;

		public Color handleDisabled = new Color(1f, 1f, 1f, 0.2f);

		public Color controlLine = new Color(0f, 0f, 0f, 0.35f);

		[Header("Bezier Path Colours")]
		public Color bezierPath = Color.green;

		public Color highlightedPath = new Color(1f, 0.6f, 0f);

		public Color bounds = new Color(1f, 1f, 1f, 0.4f);

		public Color segmentBounds = new Color(1f, 1f, 1f, 0.4f);
