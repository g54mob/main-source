...
namespace ZLinq.Linq
{
	...
	public struct Join<TEnumerator, TEnumerator2, TOuter, TInner, TKey, TResult> : IValueEnumerator<TResult>, IDisposable where TEnumerator : struct, IValueEnumerator<TOuter> where TEnumerator2 : struct, IValueEnumerator<TInner> where TOuter : notnull where TInner : notnull where TKey : notnull where TResult : notnull
	{
