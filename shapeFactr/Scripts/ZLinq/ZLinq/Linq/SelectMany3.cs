...
namespace ZLinq.Linq
{
	...
	[StructLayout((LayoutKind)3)]
	[EditorBrowsable(EditorBrowsableState.Never)]
	public struct SelectMany3<TEnumerator, TSource, TCollection, TResult> : IValueEnumerator<TResult>, IDisposable where TEnumerator : struct, IValueEnumerator<TSource> where TSource : notnull where TCollection : notnull where TResult : notnull
	{
		private TEnumerator source;
