	...
	public sealed class UIPointer : UIBehaviour
	{
		...
		public void OnScreenPositionChanged(Vector2 screenPosition)
		{
			if (!(_canvasRectTransform == null))
			{
				...
				anchoredPosition.x = anchoredPosition.x * rect.width - _canvasRectTransform.pivot.x * rect.width;
				anchoredPosition.y = anchoredPosition.y * rect.height - _canvasRectTransform.pivot.y * rect.height;
