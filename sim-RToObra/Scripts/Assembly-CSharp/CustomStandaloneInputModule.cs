...
public class CustomStandaloneInputModule : CustomPointerInputModule
{
	...
	private GameObject mouseHoverGo;
	...
	public override void UpdateModule()
	{
		...
		if (!recompiling && ReInput.isReady && isMouseSupported)
		{
			...
			m_MousePosition = RInput.physicalMousePosition;
		}
	}
	...
	public override void ActivateModule()
	{
		...
		{
			m_MousePosition = RInput.physicalMousePosition;
			m_LastMousePosition = RInput.physicalMousePosition;
		}
	...
	protected bool SendMoveEventToSelectedObject()
	{
		...
		bool flag4 = mouseHoverGo != null && currentSelectedGameObject == mouseHoverGo;
		if (flag4)
		{
			ClearSelection();
		}
		...
		if (flag4)
		{
			if (base.eventSystem.currentSelectedGameObject == null)
			{
				base.eventSystem.SetSelectedGameObject(mouseHoverGo);
			}
			mouseHoverGo = null;
		}
		if (!flag)
	...
	private void SetupRewiredVars()
	{
		...
		{
			IList<Rewired.Player> list = ((!useRewiredSystemPlayer) ? ReInput.players.Players : ReInput.players.AllPlayers);
	...
	private Selectable GetSelectable(GameObject go)
	{
		if (go == null)
		{
			return null;
		...
		if (selectable == null)
		{
			selectable = go.GetComponentInParent<Selectable>();
		}
		return selectable;
	}
	...
	protected override void ProcessMove(PointerEventData pointerEvent)
	{
		GameObject gameObject = pointerEvent.pointerCurrentRaycast.gameObject;
		HandlePointerExitAndEnter(pointerEvent, gameObject);
		Selectable selectable = GetSelectable(gameObject);
		if (selectable != null)
		{
			mouseHoverGo = selectable.gameObject;
