...
public class CFX_Demo_New : MonoBehaviour
{
	...
	private sealed class _003CCheckForDeletedParticles_003Ed__25 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		private bool MoveNext()
		{
			...
			CFX_Demo_New cFX_Demo_New = _003C_003E4__this;
			if (num != 0)
			{
				if (num != 1)
				{
				...
				for (int num2 = cFX_Demo_New.onScreenParticles.Count - 1; num2 >= 0; num2--)
				{
					if (cFX_Demo_New.onScreenParticles[num2] == null)
					{
						cFX_Demo_New.onScreenParticles.RemoveAt(num2);
					}
				}
			}
			else
	...
	{
		return new _003CCheckForDeletedParticles_003Ed__25(0)
		{
