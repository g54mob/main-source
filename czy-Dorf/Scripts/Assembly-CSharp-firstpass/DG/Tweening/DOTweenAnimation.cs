...
namespace DG.Tweening
{
	public class DOTweenAnimation : ABSAnimationComponent
	{
		...
		public void CreateTween(bool regenerateIfExists = false, bool andPlay = true)
		{
			...
			case AnimationType.Move:
				...
				case TargetType.RectTransform:
					tween = DOTweenModuleUI.DOAnchorPos3D((RectTransform)target, endValueV3, duration, optionalBool0);
					break;
				case TargetType.Rigidbody:
					tween = DOTweenModulePhysics.DOMove((Rigidbody)target, endValueV3, duration, optionalBool0);
					break;
				case TargetType.Rigidbody2D:
					tween = DOTweenModulePhysics2D.DOMove((Rigidbody2D)target, endValueV3, duration, optionalBool0);
					break;
				}
				break;
			case AnimationType.LocalMove:
				tween = ShortcutExtensions.DOLocalMove(tweenGO.transform, endValueV3, duration, optionalBool0);
				break;
			case AnimationType.Rotate:
				...
				case TargetType.Transform:
					...
					break;
				case TargetType.Rigidbody:
					tween = DOTweenModulePhysics.DORotate((Rigidbody)target, endValueV3, duration, optionalRotationMode);
					break;
				case TargetType.Rigidbody2D:
					tween = DOTweenModulePhysics2D.DORotate((Rigidbody2D)target, endValueFloat, duration);
					break;
				}
				break;
			case AnimationType.LocalRotate:
				tween = ShortcutExtensions.DOLocalRotate(tweenGO.transform, endValueV3, duration, optionalRotationMode);
				break;
			case AnimationType.Scale:
				_ = targetType;
				tween = ShortcutExtensions.DOScale(tweenGO.transform, optionalBool0 ? new Vector3(endValueFloat, endValueFloat, endValueFloat) : endValueV3, duration);
				break;
			case AnimationType.UIWidthHeight:
				tween = DOTweenModuleUI.DOSizeDelta((RectTransform)target, optionalBool0 ? new Vector2(endValueFloat, endValueFloat) : endValueV2, duration);
				break;
			case AnimationType.Color:
				...
				case TargetType.SpriteRenderer:
					tween = DOTweenModuleSprite.DOColor((SpriteRenderer)target, endValueColor, duration);
					break;
				case TargetType.Image:
					tween = DOTweenModuleUI.DOColor((Graphic)target, endValueColor, duration);
					break;
				case TargetType.Text:
					tween = DOTweenModuleUI.DOColor((Text)target, endValueColor, duration);
					break;
				case TargetType.TextMeshProUGUI:
					tween = ShortcutExtensionsTMPText.DOColor((TextMeshProUGUI)target, endValueColor, duration);
					break;
				case TargetType.TextMeshPro:
					tween = ShortcutExtensionsTMPText.DOColor((TextMeshPro)target, endValueColor, duration);
					break;
				}
				break;
			case AnimationType.Fade:
				...
				case TargetType.Light:
					...
					break;
				case TargetType.SpriteRenderer:
					tween = DOTweenModuleSprite.DOFade((SpriteRenderer)target, endValueFloat, duration);
					break;
				case TargetType.Image:
					tween = DOTweenModuleUI.DOFade((Graphic)target, endValueFloat, duration);
					break;
				case TargetType.Text:
					tween = DOTweenModuleUI.DOFade((Text)target, endValueFloat, duration);
					break;
				case TargetType.CanvasGroup:
					tween = DOTweenModuleUI.DOFade((CanvasGroup)target, endValueFloat, duration);
					break;
				case TargetType.TextMeshProUGUI:
					tween = ShortcutExtensionsTMPText.DOFade((TextMeshProUGUI)target, endValueFloat, duration);
					break;
				case TargetType.TextMeshPro:
					tween = ShortcutExtensionsTMPText.DOFade((TextMeshPro)target, endValueFloat, duration);
					break;
				}
				break;
			case AnimationType.Text:
				...
				{
					tween = DOTweenModuleUI.DOText((Text)target, endValueString, duration, optionalBool0, optionalScrambleMode, optionalString);
				}
				switch (targetType)
				{
				case TargetType.TextMeshProUGUI:
					tween = ShortcutExtensionsTMPText.DOText((TextMeshProUGUI)target, endValueString, duration, optionalBool0, optionalScrambleMode, optionalString);
					break;
				case TargetType.TextMeshPro:
					tween = ShortcutExtensionsTMPText.DOText((TextMeshPro)target, endValueString, duration, optionalBool0, optionalScrambleMode, optionalString);
					break;
				}
				break;
			case AnimationType.PunchPosition:
				...
				case TargetType.Transform:
					...
					break;
				case TargetType.RectTransform:
					tween = DOTweenModuleUI.DOPunchAnchorPos((RectTransform)target, endValueV3, duration, optionalInt0, optionalFloat0, optionalBool0);
					break;
				}
				break;
			case AnimationType.PunchScale:
				tween = ShortcutExtensions.DOPunchScale(tweenGO.transform, endValueV3, duration, optionalInt0, optionalFloat0);
				break;
			case AnimationType.PunchRotation:
				tween = ShortcutExtensions.DOPunchRotation(tweenGO.transform, endValueV3, duration, optionalInt0, optionalFloat0);
				break;
			case AnimationType.ShakePosition:
				switch (targetType)
				{
				case TargetType.Transform:
					tween = ShortcutExtensions.DOShakePosition((Transform)target, duration, endValueV3, optionalInt0, optionalFloat0, optionalBool0, optionalBool1);
					break;
				case TargetType.RectTransform:
					tween = DOTweenModuleUI.DOShakeAnchorPos((RectTransform)target, duration, endValueV3, optionalInt0, optionalFloat0, optionalBool0, optionalBool1);
					break;
				}
				break;
			case AnimationType.ShakeScale:
				tween = ShortcutExtensions.DOShakeScale(tweenGO.transform, duration, endValueV3, optionalInt0, optionalFloat0, optionalBool1);
				break;
			case AnimationType.ShakeRotation:
				tween = ShortcutExtensions.DOShakeRotation(tweenGO.transform, duration, endValueV3, optionalInt0, optionalFloat0, optionalBool1);
				break;
			...
			TweenSettingsExtensions.OnKill(TweenSettingsExtensions.SetAutoKill(TweenSettingsExtensions.SetLoops(TweenSettingsExtensions.SetDelay(TweenSettingsExtensions.SetTarget(tween, tweenTarget), delay), loops, loopType), autoKill), delegate
			{
				tween = null;
			});
			if (isSpeedBased)
		...
		private void _003CCreateTween_003Eb__53_0()
		{
			tween = null;
		}
	}
