...
namespace HorizonBasedAmbientOcclusion.Universal
{
	public class HBAORendererFeature : ScriptableRendererFeature
	{
		private class HBAORenderPass : ScriptableRenderPass
		{
			...
			{
				private CameraData _003CcameraData_003Ek__BackingField;

				private BufferedRTHandleSystem _003ChistoryRTSystem_003Ek__BackingField;

				private int _003CframeCount_003Ek__BackingField;

				private int _003ClastRenderedFrame_003Ek__BackingField;

				public CameraData cameraData
				{
					get
					{
						return _003CcameraData_003Ek__BackingField;
					}
					set
					{
						_003CcameraData_003Ek__BackingField = value;
					}
				}
				...
				public BufferedRTHandleSystem historyRTSystem
				{
					get
					{
						return _003ChistoryRTSystem_003Ek__BackingField;
					}
					set
					{
						_003ChistoryRTSystem_003Ek__BackingField = value;
					}
				}
				...
				public int lastRenderedFrame
				{
					get
					{
						return _003ClastRenderedFrame_003Ek__BackingField;
					}
					set
					{
						_003ClastRenderedFrame_003Ek__BackingField = value;
					}
				}
			}
			...
			private RenderTextureDescriptor _003CsourceDesc_003Ek__BackingField;

			private RenderTextureDescriptor _003CaoDesc_003Ek__BackingField;

			private RenderTextureDescriptor _003CdeinterleavedDepthDesc_003Ek__BackingField;

			private RenderTextureDescriptor _003CdeinterleavedNormalsDesc_003Ek__BackingField;

			private RenderTextureDescriptor _003CdeinterleavedAoDesc_003Ek__BackingField;

			private RenderTextureDescriptor _003CreinterleavedAoDesc_003Ek__BackingField;

			private RenderTextureFormat _003CcolorFormat_003Ek__BackingField;

			private GraphicsFormat _003CgraphicsColorFormat_003Ek__BackingField;

			private RenderTextureFormat _003CdepthFormat_003Ek__BackingField;

			private RenderTextureFormat _003CnormalsFormat_003Ek__BackingField;

			private bool _003CmotionVectorsSupported_003Ek__BackingField;

			private Texture2D _003CnoiseTex_003Ek__BackingField;
			...
			private Material material
			{
				get
				{
					return _003Cmaterial_003Ek__BackingField;
				}
				set
				{
			...
			private RenderTextureDescriptor sourceDesc
			{
				get
				{
					return _003CsourceDesc_003Ek__BackingField;
				}
				set
				{
					_003CsourceDesc_003Ek__BackingField = value;
				}
			}
			...
			private RenderTextureDescriptor aoDesc
			{
				get
				{
					return _003CaoDesc_003Ek__BackingField;
				}
				set
				{
					_003CaoDesc_003Ek__BackingField = value;
				}
			}
			...
			private RenderTextureDescriptor deinterleavedDepthDesc
			{
				get
				{
					return _003CdeinterleavedDepthDesc_003Ek__BackingField;
				}
				set
				{
					_003CdeinterleavedDepthDesc_003Ek__BackingField = value;
				}
			}
			...
			private RenderTextureDescriptor deinterleavedNormalsDesc
			{
				get
				{
					return _003CdeinterleavedNormalsDesc_003Ek__BackingField;
				}
				set
				{
					_003CdeinterleavedNormalsDesc_003Ek__BackingField = value;
				}
			}
			...
			private RenderTextureDescriptor deinterleavedAoDesc
			{
				get
				{
					return _003CdeinterleavedAoDesc_003Ek__BackingField;
				}
				set
				{
					_003CdeinterleavedAoDesc_003Ek__BackingField = value;
				}
			}
			...
			private RenderTextureDescriptor reinterleavedAoDesc
			{
				get
				{
					return _003CreinterleavedAoDesc_003Ek__BackingField;
				}
				set
				{
					_003CreinterleavedAoDesc_003Ek__BackingField = value;
				}
			}
			...
			private RenderTextureFormat colorFormat
			{
				get
				{
					return _003CcolorFormat_003Ek__BackingField;
				}
				set
				{
					_003CcolorFormat_003Ek__BackingField = value;
				}
			}
			...
			private GraphicsFormat graphicsColorFormat
			{
				get
				{
					return _003CgraphicsColorFormat_003Ek__BackingField;
				}
				set
				{
					_003CgraphicsColorFormat_003Ek__BackingField = value;
				}
			}
			...
			private RenderTextureFormat depthFormat
			{
				get
				{
					return _003CdepthFormat_003Ek__BackingField;
				}
				set
				{
					_003CdepthFormat_003Ek__BackingField = value;
				}
			}
			...
			private RenderTextureFormat normalsFormat
			{
				get
				{
					return _003CnormalsFormat_003Ek__BackingField;
				}
				set
				{
					_003CnormalsFormat_003Ek__BackingField = value;
				}
			}
			...
			private bool motionVectorsSupported
			{
				get
				{
					return _003CmotionVectorsSupported_003Ek__BackingField;
				}
				set
				{
					_003CmotionVectorsSupported_003Ek__BackingField = value;
				}
			}
			...
			private Texture2D noiseTex
			{
				get
				{
					return _003CnoiseTex_003Ek__BackingField;
				}
				set
				{
					_003CnoiseTex_003Ek__BackingField = value;
				}
			}
			...
			private int numberOfEyes
			{
				get
				{
					return _003CnumberOfEyes_003Ek__BackingField;
				}
				set
				{
					_003CnumberOfEyes_003Ek__BackingField = value;
				}
			}
			...
			{
				return rtHandleSystem.Alloc(Vector2.one, 1, DepthBits.None, graphicsColorFormat, FilterMode.Point, TextureWrapMode.Repeat, TextureDimension.Tex2D, enableRandomWrite: false, useMipMap: false, autoGenerateMips: true, isShadowMap: false, 1, 0f, MSAASamples.None, bindTextureMS: false, useDynamicScale: true, RenderTextureMemoryless.None, "HBAO_HistoryBuffer_" + frameIndex);
			}
			...
			private CameraHistoryBuffers GetCurrentCameraHistoryBuffers()
			{
				...
				if (hbao.temporalFilterEnabled.value && !renderingInSceneView)
				{
					...
					if ((m_PreviousColorBleedingEnabled != hbao.colorBleedingEnabled.value || m_PreviousResolution != hbao.resolution.value) && buffers != null)
					{
						ReleaseCameraHistoryBuffers(ref buffers);
			...
			{
				BlitFullscreenMesh(cmd, source, ShaderProperties.inputTex, material, 8);
			}

			private void AO(CommandBuffer cmd)
			{
				BlitFullscreenMeshWithClear(cmd, (hbao.mode.value == HBAO.Mode.LitAO) ? source : ((RenderTargetIdentifier)ShaderProperties.inputTex), ShaderProperties.hbaoTex, material, new Color(0f, 0f, 0f, 1f));
			}
			...
			private void DeinterleavedAO(CommandBuffer cmd)
			{
				...
				for (int i = 0; i < 4; i++)
				{
					...
					BlitFullscreenMesh(cmd, BuiltinRenderTextureType.CameraTarget, m_RtsDepth, material, 2);
					BlitFullscreenMesh(cmd, BuiltinRenderTextureType.CameraTarget, m_RtsNormals, material, 3);
				}
				...
				for (int k = 0; k < 16; k++)
				{
					...
					BlitFullscreenMeshWithClear(cmd, (hbao.mode.value == HBAO.Mode.LitAO) ? source : ((RenderTargetIdentifier)ShaderProperties.inputTex), ShaderProperties.aoSliceTex[k], material, new Color(0f, 0f, 0f, 1f), 1);
				...
				for (int l = 0; l < 16; l++)
				{
					...
					BlitFullscreenMesh(cmd, ShaderProperties.aoSliceTex[l], ShaderProperties.tempTex, material, 4);
					cmd.ReleaseTemporaryRT(ShaderProperties.aoSliceTex[l]);
				}
				BlitFullscreenMesh(cmd, ShaderProperties.tempTex, ShaderProperties.hbaoTex, material, 5);
			...
			private void Blur(CommandBuffer cmd)
			{
				if (hbao.blurType.value != HBAO.BlurType.None)
				{
					...
					cmd.SetGlobalVector(ShaderProperties.blurDeltaUV, new Vector2(1f / (float)sourceDesc.width, 0f));
					BlitFullscreenMesh(cmd, ShaderProperties.hbaoTex, ShaderProperties.tempTex, material, 6);
					cmd.SetGlobalVector(ShaderProperties.blurDeltaUV, new Vector2(0f, 1f / (float)sourceDesc.height));
					BlitFullscreenMesh(cmd, ShaderProperties.tempTex, ShaderProperties.hbaoTex, material, 6);
					cmd.ReleaseTemporaryRT(ShaderProperties.tempTex);
				}
			}
			...
			private void TemporalFilter(CommandBuffer cmd, CameraHistoryBuffers buffers)
			{
				if (hbao.temporalFilterEnabled.value && !renderingInSceneView)
				{
					...
					{
						cmd.SetRenderTarget(buffers.historyRTSystem.GetFrameRT(0, 1));
						cmd.ClearRenderTarget(clearDepth: false, clearColor: true, Color.white);
						if (hbao.colorBleedingEnabled.value)
						{
							cmd.SetRenderTarget(buffers.historyRTSystem.GetFrameRT(1, 1));
					...
					if (hbao.colorBleedingEnabled.value)
					{
						...
						BlitFullscreenMesh(cmd, frameRT3, destinations, viewportRect, material, 7);
						cmd.SetViewProjectionMatrices(cameraData.camera.worldToCameraMatrix, cameraData.camera.projectionMatrix);
					...
					else
					{
						...
						BlitFullscreenMesh(cmd, frameRT6, frameRT5, viewportRect, material, 7);
			...
			{
				BlitFullscreenMesh(cmd, (hbao.mode.value == HBAO.Mode.LitAO) ? source : ((RenderTargetIdentifier)ShaderProperties.inputTex), (hbao.mode.value == HBAO.Mode.LitAO && hbao.debugMode.value == HBAO.DebugMode.Disabled) ? ((RenderTargetIdentifier)ShaderProperties.ssaoTex) : source, material, (hbao.debugMode.value == HBAO.DebugMode.ViewNormals) ? 10 : 9);
				if (hbao.mode.value == HBAO.Mode.LitAO)
				{
			...
			private void UpdateMaterialProperties()
			{
				...
				float num = 1f / cameraData.camera.projectionMatrix.m00;
				float num2 = 1f / cameraData.camera.projectionMatrix.m11;
				float num3 = Mathf.Max(16f, hbao.maxRadiusPixels.value * Mathf.Sqrt((float)(width * numberOfEyes * height) / 2073600f));
				num3 /= (float)((hbao.deinterleaving.value != HBAO.Deinterleaving.x4) ? 1 : 4);
				...
				material.SetVector(ShaderProperties.uvToView, new Vector4(2f * num, -2f * num2, -1f * num, 1f * num2));
				material.SetMatrix(ShaderProperties.worldToCameraMatrix, cameraData.camera.worldToCameraMatrix);
				material.SetFloat(ShaderProperties.radius, hbao.radius.value * 0.5f * ((float)(height / ((hbao.deinterleaving.value != HBAO.Deinterleaving.x4) ? 1 : 4)) / (num2 * 2f)));
				material.SetFloat(ShaderProperties.maxRadiusPixels, num3);
