...
namespace Jobberwocky.MIConvexHull
{
	internal class ConvexHullAlgorithm
	{
		private sealed class _003C_003Ec__DisplayClass4_0
		{
			...
			public ConvexHullAlgorithm _003C_003E4__this;
		}
		...
		private sealed class _003C_003Ec__DisplayClass4_1
		{
			...
			public Predicate<int> _003C_003E9__1;

			internal bool _003CFindBoundingBoxPoints_003Eb__0(int index)
			{
				return min - CS_0024_003C_003E8__locals1._003C_003E4__this.GetCoordinate(index, CS_0024_003C_003E8__locals1.i) > CS_0024_003C_003E8__locals1._003C_003E4__this.PlaneDistanceTolerance;
			}

			internal bool _003CFindBoundingBoxPoints_003Eb__1(int index)
			{
				return min - CS_0024_003C_003E8__locals1._003C_003E4__this.GetCoordinate(index, CS_0024_003C_003E8__locals1.i) > CS_0024_003C_003E8__locals1._003C_003E4__this.PlaneDistanceTolerance;
			}
		}
		...
		private sealed class _003C_003Ec
		{
			...
			public static Func<double, double> _003C_003E9__5_0;

			public static Func<double, double> _003C_003E9__5_1;

			public static Func<List<int>, IEnumerable<int>> _003C_003E9__7_0;

			internal double _003CShiftAndScalePositions_003Eb__5_0(double x)
			{
				return Math.Abs(x);
			}

			internal double _003CShiftAndScalePositions_003Eb__5_1(double x)
			{
				return Math.Abs(x);
			}

			internal IEnumerable<int> _003CFindInitialPoints_003Eb__7_0(List<int> x)
			{
				return x;
			}
		}
		...
		internal ConvexHullAlgorithm(IVertex[] vertices, bool lift, double PlaneDistanceTolerance)
		{
			...
			if (NumOfDimensions == 2)
			{
				throw new ConvexHullGenerationException(ConvexHullCreationResultOutcome.DimensionTwoWrongMethod, "Dimension of the input is 2. Thus you should use the Create2D method instead of the Create.");
			}
			if (NumberOfVertices <= NumOfDimensions)
			{
				throw new ConvexHullGenerationException(ConvexHullCreationResultOutcome.NotEnoughVerticesForDimension, "There are too few vertices (m) for the n-dimensional space. (m must be greater than the n, but m is " + NumberOfVertices + " and n is " + NumOfDimensions);
			}
		...
		private void FindBoundingBoxPoints()
		{
			...
			_003C_003Ec__DisplayClass4_2.i = 0;
			while (_003C_003Ec__DisplayClass4_2.i < NumOfDimensions)
			{
				_003C_003Ec__DisplayClass4_1 CS_0024_003C_003E8__locals19 = new _003C_003Ec__DisplayClass4_1();
				CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1 = _003C_003Ec__DisplayClass4_2;
				List<int> list = new List<int>();
				List<int> list2 = new List<int>();
				CS_0024_003C_003E8__locals19.min = double.PositiveInfinity;
				double num2 = double.NegativeInfinity;
				for (int i = 0; i < NumberOfVertices; i++)
				{
					double coordinate = GetCoordinate(i, CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1.i);
					double num3 = CS_0024_003C_003E8__locals19.min - coordinate;
					if (num3 >= PlaneDistanceTolerance)
					{
						CS_0024_003C_003E8__locals19.min = coordinate;
						list.Clear();
						list.Add(i);
					}
					else if (num3 > 0.0)
					{
						CS_0024_003C_003E8__locals19.min = coordinate;
						list.RemoveAll((int index) => CS_0024_003C_003E8__locals19.min - CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1._003C_003E4__this.GetCoordinate(index, CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1.i) > CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1._003C_003E4__this.PlaneDistanceTolerance);
						list.Add(i);
					}
					...
					{
						num2 = coordinate;
						list2.RemoveAll((int index) => CS_0024_003C_003E8__locals19.min - CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1._003C_003E4__this.GetCoordinate(index, CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1.i) > CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1._003C_003E4__this.PlaneDistanceTolerance);
						list2.Add(i);
					}
					else if (num3 > 0.0 - PlaneDistanceTolerance)
					{
				...
				minima[CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1.i] = CS_0024_003C_003E8__locals19.min;
				maxima[CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1.i] = num2;
				list.AddRange(list2);
				if (list.Count < num)
				{
					num = list.Count;
					indexOfDimensionWithLeastExtremes = CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1.i;
				}
				boundingBoxPoints[CS_0024_003C_003E8__locals19.CS_0024_003C_003E8__locals1.i] = list;
				_003C_003Ec__DisplayClass4_2.i++;
			}
		}
		...
		private void ShiftAndScalePositions()
		{
			...
			if (IsLifted)
			{
				...
				double num3 = 2.0 / (Enumerable.Sum(minima, (double x) => Math.Abs(x)) + Enumerable.Sum(maxima, (double x) => Math.Abs(x)) - Math.Abs(maxima[num2]) - Math.Abs(minima[num2]));
				minima[num2] *= num3;
				maxima[num2] *= num3;
				for (int num4 = num2; num4 < num; num4 += NumOfDimensions)
				{
					Positions[num4] *= num3;
				}
			}
			double[] array = new double[NumOfDimensions];
			for (int num5 = 0; num5 < NumOfDimensions; num5++)
			{
				if (maxima[num5] == minima[num5])
				{
					array[num5] = 0.0;
				}
				else
				{
					array[num5] = maxima[num5] - minima[num5] - minima[num5];
				}
			}
			for (int num6 = 0; num6 < num; num6++)
			{
				Positions[num6] += array[num6 % NumOfDimensions];
			}
		}
		...
		private void CreateInitialSimplex()
		{
			...
			{
				ConvexFaceInternal convexFaceInternal2 = FacePool[num2];
		...
		{
			double bigNumber = Enumerable.Sum(maxima) * (double)NumOfDimensions * (double)NumberOfVertices;
			int num = Enumerable.First(boundingBoxPoints[indexOfDimensionWithLeastExtremes]);
			int num2 = Enumerable.Last(boundingBoxPoints[indexOfDimensionWithLeastExtremes]);
			...
			List<int> list2 = Enumerable.ToList(Enumerable.SelectMany(boundingBoxPoints, (List<int> x) => x));
			int num3 = 1;
			while (num3 < NumOfDimensions && Enumerable.Any(list2))
			{
				int num4 = -1;
			...
			{
				List<int> list3 = Enumerable.ToList(Enumerable.Range(0, NumberOfVertices));
				while (num3 < NumOfDimensions && Enumerable.Any(list3))
				{
					int num8 = -1;
			...
			if (list.Count <= NumOfDimensions && IsLifted)
			{
				List<int> list4 = Enumerable.ToList(Enumerable.Range(0, NumberOfVertices));
				while (num3 < NumOfDimensions && Enumerable.Any(list4))
				{
					int num12 = -1;
					...
					for (int num14 = list4.Count - 1; num14 >= 0; num14--)
					{
						...
						{
							mathHelper.RandomOffsetToLift(num15, Enumerable.Last(maxima) - Enumerable.Last(minima));
			...
			if (list.Count <= NumOfDimensions && IsLifted)
			{
				throw new ConvexHullGenerationException(ConvexHullCreationResultOutcome.DegenerateData, "The input data is degenerate. It appears to exist in " + NumOfDimensions + " dimensions, but it is a " + (NumOfDimensions - 1) + " dimensional set (i.e. the point of collinear, coplanar, or co-hyperplanar.)");
			}
			return list;
		}
		...
		internal TFace[] GetConvexFaces<TVertex, TFace>() where TVertex : IVertex where TFace : ConvexFace<TVertex, TFace>, new()
		{
		...
		internal static TCell[] GetDelaunayTriangulation<TVertex, TCell>(IList<TVertex> data, double PlaneDistanceTolerance) where TVertex : IVertex where TCell : TriangulationCell<TVertex, TCell>, new()
		{
			ConvexHullAlgorithm convexHullAlgorithm = new ConvexHullAlgorithm(Enumerable.ToArray(Enumerable.Cast<IVertex>(data)), lift: true, PlaneDistanceTolerance);
