...
namespace Microsoft.CSharp
{
	internal sealed class CSharpCodeGenerator : ICodeCompiler, ICodeGenerator
	{
		private sealed class _003C_003Ec__DisplayClass180_0
		{
			...
			internal void _003CFromFileBatch_003Eb__0(object sender, DataReceivedEventArgs args)
			{
				if (args.Data != null)
				{
			...
			internal void _003CFromFileBatch_003Eb__1(object sender, DataReceivedEventArgs args)
			{
				if (args.Data == null)
				{
		...
		private CompilerResults FromSourceBatch(CompilerParameters options, string[] sources)
		{
			...
			{
				string text = options.TempFiles.AddExtension(i + ".cs");
		...
		{
			_003C_003Ec__DisplayClass180_0 CS_0024_003C_003E8__locals18 = new _003C_003Ec__DisplayClass180_0();
			if (options == null)
			{
				throw new ArgumentNullException("options");
			}
			...
			CS_0024_003C_003E8__locals18.results = new CompilerResults(options.TempFiles);
			...
			CS_0024_003C_003E8__locals18.stderr_completed = new ManualResetEvent(initialState: false);
			CS_0024_003C_003E8__locals18.stdout_completed = new ManualResetEvent(initialState: false);
			...
			process.ErrorDataReceived += delegate(object sender, DataReceivedEventArgs args)
			{
				if (args.Data != null)
				{
					CS_0024_003C_003E8__locals18.results.Output.Add(args.Data);
				}
				else
				{
					CS_0024_003C_003E8__locals18.stderr_completed.Set();
				}
			};
			process.OutputDataReceived += delegate(object sender, DataReceivedEventArgs args)
			{
				if (args.Data == null)
				{
					CS_0024_003C_003E8__locals18.stdout_completed.Set();
				}
			};
			...
			try
			{
				...
				process.WaitForExit();
				CS_0024_003C_003E8__locals18.results.NativeCompilerReturnValue = process.ExitCode;
			}
			finally
			{
				CS_0024_003C_003E8__locals18.stderr_completed.WaitOne(TimeSpan.FromSeconds(30.0));
				CS_0024_003C_003E8__locals18.stdout_completed.WaitOne(TimeSpan.FromSeconds(30.0));
				process.Close();
			}
			bool flag = true;
			StringEnumerator enumerator = CS_0024_003C_003E8__locals18.results.Output.GetEnumerator();
			try
			{
				while (enumerator.MoveNext())
				{
					...
					{
						CS_0024_003C_003E8__locals18.results.Errors.Add(compilerError);
			...
			if (CS_0024_003C_003E8__locals18.results.Output.Count > 0)
			{
				CS_0024_003C_003E8__locals18.results.Output.Insert(0, process.StartInfo.FileName + " " + process.StartInfo.Arguments + Environment.NewLine);
			}
			if (flag)
			{
				if (!File.Exists(options.OutputAssembly))
				{
					...
					enumerator = CS_0024_003C_003E8__locals18.results.Output.GetEnumerator();
					try
					{
						while (enumerator.MoveNext())
						{
				...
				if (options.GenerateInMemory)
				{
					...
					CS_0024_003C_003E8__locals18.results.CompiledAssembly = Assembly.Load(array, null);
					fileStream.Close();
				}
				else
				{
					CS_0024_003C_003E8__locals18.results.PathToAssembly = options.OutputAssembly;
				}
			}
			else
			{
				CS_0024_003C_003E8__locals18.results.CompiledAssembly = null;
			}
			return CS_0024_003C_003E8__locals18.results;
		}
