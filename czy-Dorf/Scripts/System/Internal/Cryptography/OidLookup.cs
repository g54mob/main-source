...
namespace Internal.Cryptography
{
	internal static class OidLookup
	{
		...
		private sealed class _003C_003Ec
		{
			...
			internal string _003C_002Ecctor_003Eb__10_0(KeyValuePair<string, string> kvp)
			{
				return kvp.Value;
			}

			internal string _003C_002Ecctor_003Eb__10_1(KeyValuePair<string, string> kvp)
			{
				return kvp.Key;
			}
		}
		...
		private static readonly Dictionary<string, string> s_oidToFriendlyName = Enumerable.ToDictionary(s_friendlyNameToOid, (KeyValuePair<string, string> kvp) => kvp.Value, (KeyValuePair<string, string> kvp) => kvp.Key);
