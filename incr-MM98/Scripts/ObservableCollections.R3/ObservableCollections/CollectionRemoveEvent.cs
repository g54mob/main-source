...
namespace ObservableCollections
{
	public readonly struct CollectionRemoveEvent<T>
	{
		...
		public override string ToString()
		{
			...
			stringBuilder.Append("CollectionRemoveEvent");
		...
		[CompilerGenerated]
		public static bool operator !=(CollectionRemoveEvent<T> left, CollectionRemoveEvent<T> right)
		{
			return !(left == right);
		}
		...
		{
			if (obj is CollectionRemoveEvent<T>)
			{
				return Equals((CollectionRemoveEvent<T>)obj);
			}
			return false;
		}
