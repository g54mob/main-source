...
namespace RetroShadersPro.URP
{
	...
	public class CRTSettings : VolumeComponent, IPostProcessComponent
	{
		...
		public ColorParameter tintColor = new ColorParameter(Color.white, hdr: true, showAlpha: false, showEyeDropper: true);
		...
		public ClampedFloatParameter scrollSpeed = new ClampedFloatParameter(0f, -10f, 10f);
		...
		public BoolParameter useTracking = new BoolParameter(value: false);
		...
		public ClampedFloatParameter brightness = new ClampedFloatParameter(1f, 0f, 5f);
