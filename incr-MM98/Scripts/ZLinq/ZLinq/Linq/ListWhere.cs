...
namespace ZLinq.Linq
{
	...
	public struct ListWhere<TSource> : IValueEnumerator<TSource>, IDisposable
	{
		...
		{
			return new ListWhereSelect<TSource, TResult>(source, _003Cpredicate_003EP, selector);
		}
	}
}
