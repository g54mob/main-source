...
namespace R3
{
	internal sealed class MinByAsync<T, TKey> : TaskObserverBase<T, T>
	{
		...
		public MinByAsync(Func<T, TKey> keySelector, IComparer<TKey> comparer, CancellationToken cancellationToken)
		{
