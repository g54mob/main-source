...
public class Missile : Projectile
{
	...
	[Header("Sound")]
	[SerializeField]
	private SoundData flightSound;

	private new SoundBuilder soundBuilder;

	[NonSerialized]
	public bool muteFlightSound;
	...
	private new void Awake()
	{
		...
		if (muteFlightSound)
		{
			PersistentSingleton<SoundEmitterManager>.Instance.CreateSoundBuilder().Play(flightSound);
		}
	}
	...
	private new void Update()
	{
		...
		if (targetUnit == null || targetUnit.IsEnemy == isEnemyProjectile || targetUnit.ignoreProjectiles)
		{
			FindTrackingTarget();
		}
	}
	...
	protected override void Move()
	{
		...
		if (targetUnit == null && CanWaitForTarget)
		{
	...
	public override void DestroyProjectile()
	{
		...
		component.Initialize(sourceUnit, radius, damage, trainDamage);
