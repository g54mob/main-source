public class E3_B_DisruptorBombardment : StateBaseEnemy
{
	private E3_B_Phase1Plane bossPlane;

	public override string Key => "Bombardment";

	public E3_B_DisruptorBombardment(StateMachine sm, EnemyBase enemy)
		: base(sm, enemy)
	{
		transitionStates = new string[1] { "Idle" };
	}

	public E3_B_DisruptorBombardment(StateMachine sm, EnemyBase enemy, string[] transitionStates)
