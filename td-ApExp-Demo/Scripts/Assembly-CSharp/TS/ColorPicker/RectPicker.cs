...
namespace TS.ColorPicker
{
	...
	public class RectPicker : MonoBehaviour
	{
		...
		public Vector2 Value
		{
			get
			{
				return _handle.transform.localPosition;
			}
			set
			{
				_handle.transform.localPosition = value;
			}
		}
		...
		public Vector2 NormalizedValue
		{
			get
			{
				return _tracker.Normalize(Value);
			}
			set
			{
				Value = (_tracker ? _tracker.DeNormalize(value) : Vector2.zero);
			}
		}
