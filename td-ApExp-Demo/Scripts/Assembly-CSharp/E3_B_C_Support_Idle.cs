...
public class E3_B_C_Support_Idle : StateBaseEnemy
{
	private E3_B_C_SecondaryWeapon secondary;

	public override string Key => "Idle";

	public E3_B_C_Support_Idle(StateMachine sm, EnemyBase enemy)
		: base(sm, enemy)
	{
		transitionStates = new string[1] { "Attack" };
	}

	public E3_B_C_Support_Idle(StateMachine sm, EnemyBase enemy, string[] transitionStates)
