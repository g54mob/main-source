...
[CreateAssetMenu(fileName = "FactoryReduceCooldowns1", menuName = "Upgrade/Factory/ReduceCooldowns1")]
public class UpgradeFactoryLowerCooldowns1 : EnhancementUpgrade
{
	[SerializeField]
