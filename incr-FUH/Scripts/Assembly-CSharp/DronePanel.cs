...
public class DronePanel : BaseBuildingPanel
{
	...
	private void Start()
	{
		Title.Initialize(base.gameObject, LanguageText.GetText("Cloud Seeder"));
		...
		Title.SetDynamicTooltip((TooltipPanel.TooltipInfo a) => a.Update(LanguageText.GetText("Cloud Seeder"), "Lvl " + Building.GetLevel() + "/10", GetTooltip(Building), ""));
