		...
		if (Buildings != null && Buildings.IsUnstable())
		{
			...
			if (!CharDisplay.HasRelax)
			{
				...
				case BaseBuilding.BuildingTypeEnum.Catapult:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("CatapultLowDur"));
					break;
				case BaseBuilding.BuildingTypeEnum.Helicopter:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("HelicopterLowDur"));
					break;
				case BaseBuilding.BuildingTypeEnum.House:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("HouseLowDur"));
					break;
				case BaseBuilding.BuildingTypeEnum.Research:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("ResearchLowDur"));
					break;
				case BaseBuilding.BuildingTypeEnum.HotAirBaloon:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("HotAirBaloonLowDur"));
					break;
				case BaseBuilding.BuildingTypeEnum.Training:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("TrainingLowDur"));
					break;
				case BaseBuilding.BuildingTypeEnum.Industry:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("IndustryLowDur"));
					break;
				case BaseBuilding.BuildingTypeEnum.Power:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("PowerLowDur"));
					break;
				case BaseBuilding.BuildingTypeEnum.Compressor:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("CompressorLowDur"));
					break;
				case BaseBuilding.BuildingTypeEnum.Drone:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("DroneLowDur"));
					break;
				default:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("GenericLowDur"));
					break;
				}
			}
			else
			{
				...
				{
				case BaseBuilding.BuildingTypeEnum.Catapult:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("CatapultLowDurRelax"));
					break;
				case BaseBuilding.BuildingTypeEnum.Helicopter:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("HelicopterLowDurRelax"));
					break;
				case BaseBuilding.BuildingTypeEnum.House:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("HouseLowDurRelax"));
					break;
				case BaseBuilding.BuildingTypeEnum.Research:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("ResearchLowDurRelax"));
					break;
				case BaseBuilding.BuildingTypeEnum.HotAirBaloon:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("HotAirBaloonLowDurRelax"));
					break;
				case BaseBuilding.BuildingTypeEnum.Training:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("TrainingLowDurRelax"));
					break;
				case BaseBuilding.BuildingTypeEnum.Industry:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("IndustryLowDurRelax"));
					break;
				case BaseBuilding.BuildingTypeEnum.Power:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("PowerLowDurRelax"));
					break;
				case BaseBuilding.BuildingTypeEnum.Compressor:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("CompressorLowDurRelax"));
					break;
				case BaseBuilding.BuildingTypeEnum.Drone:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("DroneLowDurRelax"));
					break;
				default:
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("GenericLowDurRelax"));
					break;
				}
			}
		...
		if (Buildings == null)
		{
			...
			case BaseBuilding.BuildingTypeEnum.House:
				if (!Industry.GlobalInfo.LevelUpAttribute.IsEnabled)
				{
					...
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("FactoryBuildHelp"));
				}
			...
			case BaseBuilding.BuildingTypeEnum.Industry:
				if (!Catapult.GlobalInfo.LevelUpAttribute.IsEnabled)
				{
					...
					GameController.Instance.ToastPanel.AddItem(LanguageText.GetText("CatapultBuildHelp"));
				}
