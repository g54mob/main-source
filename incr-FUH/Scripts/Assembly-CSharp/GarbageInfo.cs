...
public class GarbageInfo
{
	...
	public int GetWidth()
	{
		if (IsEvil)
		{
			...
			if (GarbageType == GarbageTypeEnum.ShardBlue)
			{
				return 2;
			}
			if (GarbageType == GarbageTypeEnum.ShardRed)
			{
				return 2;
			}
			if (GarbageType == GarbageTypeEnum.ShardYellow)
			{
				return 2;
			}
			if (GarbageType == GarbageTypeEnum.Book)
			...
			if (GarbageType == GarbageTypeEnum.Golem)
			{
				return 8;
			}
		}
