...
public class RockPanel : BaseBuildingPanel
{
	...
	{
		return 0 + (OverflowRow.gameObject.activeSelf ? 1 : 0) + (AmountRow.gameObject.activeSelf ? 1 : 0) + (ScafoldingRow.gameObject.activeSelf ? 1 : 0) + (ThrowFurtherRow.gameObject.activeSelf ? 1 : 0) + (WorkerRow.gameObject.activeSelf ? 1 : 0);
	}
}
