...
public class BaseResearchLevelAttribute : BaseSavableAttribute
{
	protected Func<int, int> _getLevelCostAction;

	public BaseResearchLevelAttribute(string name, int maxLevel, Func<int, int> getCost, Func<bool> canHave)
	{
		_name = name;
		_maxLevel = maxLevel;
