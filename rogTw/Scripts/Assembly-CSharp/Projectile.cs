...
public class Projectile : MonoBehaviour
{
	...
	{
		if (Physics.Raycast(base.transform.position, base.transform.forward, out var hitInfo, speed * Time.fixedDeltaTime + 0.25f, layermask, QueryTriggerInteraction.Collide))
		{
			OnHit(hitInfo);
		}
	}
