...
public class UpgradeManager : MonoBehaviour
{
	...
	public void ResetUpgrades()
	{
		...
		PlayerPrefs.SetInt("Record4", 0);
		PlayerPrefs.SetInt("Class11", 0);
		PlayerPrefs.SetInt("Class21", 0);
		PlayerPrefs.SetInt("Class22", 0);
		PlayerPrefs.SetInt("Class23", 0);
		PlayerPrefs.SetInt("Class31", 0);
		PlayerPrefs.SetInt("Class32", 0);
		PlayerPrefs.SetInt("Class33", 0);
		PlayerPrefs.SetInt("Class41", 0);
		PlayerPrefs.SetInt("Class42", 0);
		PlayerPrefs.SetInt("Class43", 0);
