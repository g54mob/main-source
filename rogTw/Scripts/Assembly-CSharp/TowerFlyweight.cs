...
public class TowerFlyweight : MonoBehaviour
{
	...
	[SerializeField]
	public int heightRangeBonusMultiplier;
	...
	public void AddHeightRangeBonusMultiplier(int bonus)
	{
		heightRangeBonusMultiplier += bonus;
		foreach (Tower tower in towers)
		{
			tower.SetStats();
		}
	...
	public void AddSpecial1(int bonus)
	{
		special1 += bonus;
		foreach (Tower tower in towers)
		{
	...
	public void AddSpecial2(int bonus)
	{
		special2 += bonus;
		foreach (Tower tower in towers)
		{
	...
	public void AddSpecial3(int bonus)
	{
		special3 += bonus;
		foreach (Tower tower in towers)
		{
