...
public class AchievementManager : MonoBehaviour
{
	...
	public void EnemyHealthScale(float amt)
	{
		if (amt >= 1f)
		{
			UnlockAchievement("MonsterHealth100");
		}
		if ((double)amt >= 2.5)
		{
			UnlockAchievement("MonsterHealth250");
		}
		if (amt >= 5f)
		{
			UnlockAchievement("MonsterHealth500");
		}
		if (amt >= 10f)
		{
			UnlockAchievement("MonsterHealth1000");
		}
	}

	public void EnemyArmorScale(float amt)
	{
		if (amt >= 1f)
		{
			UnlockAchievement("MonsterArmor100");
		}
		if ((double)amt >= 2.5)
		{
			UnlockAchievement("MonsterArmor250");
		}
		if (amt >= 5f)
		{
			UnlockAchievement("MonsterArmor500");
		}
		if (amt >= 10f)
		{
			UnlockAchievement("MonsterArmor1000");
		}
	}

	public void EnemyShieldScale(float amt)
	{
		if (amt >= 1f)
		{
			UnlockAchievement("MonsterShield100");
		}
		if ((double)amt >= 2.5)
		{
			UnlockAchievement("MonsterShield250");
		}
		if (amt >= 5f)
		{
			UnlockAchievement("MonsterShield500");
		}
		if (amt >= 10f)
		{
			UnlockAchievement("MonsterShield1000");
		}
	}
	...
	public void BeatLevel(int level)
	{
		...
		if (level == 15)
		{
			...
			case 1:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel15MonsterMode1");
				}
				break;
			case 2:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel15MonsterMode2");
				}
				break;
			case 3:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel15MonsterMode3");
				}
				break;
			case 4:
				UnlockAchievement("BeatLevel15Mode4");
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel15MonsterMode4");
				}
				break;
			}
		}
		if (level == 25)
		{
			...
			case 1:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel25MonsterMode1");
				}
				break;
			case 2:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel25MonsterMode2");
				}
				break;
			case 3:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel25MonsterMode3");
				}
				break;
			case 4:
				UnlockAchievement("BeatLevel25Mode4");
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel25MonsterMode4");
				}
				break;
			}
		}
		if (level == 35)
		{
			...
			case 1:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel35MonsterMode1");
				}
				break;
			case 2:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel35MonsterMode2");
				}
				break;
			case 3:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel35MonsterMode3");
				}
				break;
			case 4:
				UnlockAchievement("BeatLevel35Mode4");
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel35MonsterMode4");
				}
				break;
			}
			if (!shrineSpawned)
		...
		if (level == 45)
		{
			...
			case 1:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel45MonsterMode1");
				}
				if (TileManager.instance.splitMode)
				{
					UnlockAchievement("BeatAlwaysSplits1");
				}
				break;
			case 2:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel45MonsterMode2");
				}
				if (TileManager.instance.splitMode)
				{
					UnlockAchievement("BeatAlwaysSplits2");
				}
				break;
			case 3:
				...
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel45MonsterMode3");
				}
				if (TileManager.instance.splitMode)
				{
					UnlockAchievement("BeatAlwaysSplits3");
				}
				break;
			case 4:
				UnlockAchievement("BeatLevel45Mode4");
				if (SpawnManager.instance.monsterMode)
				{
					UnlockAchievement("BeatLevel45MonsterMode4");
				}
				if (TileManager.instance.splitMode)
				{
					UnlockAchievement("BeatAlwaysSplits4");
				}
				break;
			}
			if (CameraController.instance.firstPersonMode)
			{
				UnlockAchievement("FoolsGold");
			}
		}
		if (level == 50)
		{
			...
			{
			case 1:
				UnlockAchievement("BeatLevel50Mode1");
				break;
			case 2:
				UnlockAchievement("BeatLevel50Mode2");
				break;
			case 3:
				UnlockAchievement("BeatLevel50Mode3");
				break;
			case 4:
				UnlockAchievement("BeatLevel50Mode4");
				break;
			}
		}
	}
	...
	public void CheckTowerTypesVictory()
	{
		...
		if (TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Count <= 1)
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallista4");
			}
		}
		if (!TowerManager.instance.towersUsed.Contains(TowerType.Crossbow))
		{
			...
			if (gameMode >= 2)
			{
				UnlockAchievement("NoBallista2");
			}
			if (gameMode >= 3)
			{
				UnlockAchievement("NoBallista3");
			}
			if (gameMode >= 4)
			{
				UnlockAchievement("NoBallista4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.Morter) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.Morter) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaMortar4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.TeslaCoil) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.TeslaCoil) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaTesla4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.Frost) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.Frost) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaFrost4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.FlameThrower) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.FlameThrower) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaFlameThrower4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.PoisonSprayer) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.PoisonSprayer) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaPoisonSprayer4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.Shredder) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.Shredder) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaShredder4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.Encampment) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.Encampment) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaEncampment4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.Lookout) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.Lookout) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaLookout4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.Radar) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.Radar) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaRadar4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.Obelisk) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.Obelisk) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaObelisk4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.ParticleCannon) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.ParticleCannon) && TowerManager.instance.towersUsed.Count <= 1))
		{
			...
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaParticleCannon4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.VampireLair) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.VampireLair) && TowerManager.instance.towersUsed.Count <= 1))
		{
			UnlockAchievement("OnlyBallistaVampireLair");
			if (gameMode >= 2)
			{
				UnlockAchievement("OnlyBallistaVampireLair2");
			}
			if (gameMode >= 3)
			{
				UnlockAchievement("OnlyBallistaVampireLair3");
			}
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaVampireLair4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.Cannon) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.Cannon) && TowerManager.instance.towersUsed.Count <= 1))
		{
			UnlockAchievement("OnlyBallistaCannon");
			if (gameMode >= 2)
			{
				UnlockAchievement("OnlyBallistaCannon2");
			}
			if (gameMode >= 3)
			{
				UnlockAchievement("OnlyBallistaCannon3");
			}
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaCannon4");
			}
		}
		if ((TowerManager.instance.towersUsed.Contains(TowerType.Crossbow) && TowerManager.instance.towersUsed.Contains(TowerType.Monument) && TowerManager.instance.towersUsed.Count <= 2) || (TowerManager.instance.towersUsed.Contains(TowerType.Monument) && TowerManager.instance.towersUsed.Count <= 1))
		{
			UnlockAchievement("OnlyBallistaMonument");
			if (gameMode >= 2)
			{
				UnlockAchievement("OnlyBallistaMonument2");
			}
			if (gameMode >= 3)
			{
				UnlockAchievement("OnlyBallistaMonument3");
			}
			if (gameMode >= 4)
			{
				UnlockAchievement("OnlyBallistaMonument4");
			}
		}
	}
	...
	public bool CheckAllTowers()
	{
		...
		if (!TowerManager.instance.towersUsed.Contains(TowerType.VampireLair))
		{
			return false;
		}
		if (!TowerManager.instance.towersUsed.Contains(TowerType.Cannon))
		{
			return false;
		}
		if (!TowerManager.instance.towersUsed.Contains(TowerType.Monument))
		{
			return false;
		}
