...
public class TowerUI : MonoBehaviour
{
	...
	{
		SFXManager.instance.ButtonClick();
		myTower.CopyPriorities();
	}

	public void PastePriorities()
	{
		SFXManager.instance.ButtonClick();
		myTower.PastePriorities();
		priorityTexts[0].text = myTower.priorities[0].ToString();
		priorityTexts[1].text = myTower.priorities[1].ToString();
		priorityTexts[2].text = myTower.priorities[2].ToString();
	}
