...
public class BuildButtonUI : MonoBehaviour
{
	...
	public void UpdateModifiersText()
	{
		...
		if (TowerManager.instance.GetHeightRangeBonusMultiplier(myTowerType) > 0f)
		{
			text = text + "\nx" + (1f + TowerManager.instance.GetHeightRangeBonusMultiplier(myTowerType)) + "height range bonus";
		}
