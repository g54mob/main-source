...
public class HealthBar : MonoBehaviour
{
	...
	[SerializeField]
	private GameObject BleedImmuneImage;

	[SerializeField]
	private GameObject BurnImmuneImage;

	[SerializeField]
	private GameObject PoisonImmuneImage;
	...
	public void SetImmunities(bool bleedImmune, bool burnImmune, bool poisonImmune)
	{
		BleedImmuneImage.SetActive(bleedImmune);
		BurnImmuneImage.SetActive(burnImmune);
		PoisonImmuneImage.SetActive(poisonImmune);
	}
