	...
	public class BE2_DragTrigger : MonoBehaviour, I_BE2_Drag
	{
		...
		public void OnPointerUp()
		{
			if (_dragDropManager.ConnectionPoint.block != null)
			{
				...
				I_BE2_ProgrammingEnv componentInParent = Transform.GetComponentInParent<I_BE2_ProgrammingEnv>();
				if (componentInParent != null)
				{
					_executionManager.AddToBlocksStackArray(Block.Instruction.InstructionBase.BlocksStack, componentInParent.TargetObject);
				}
			}
			else
			{
				...
				if (spotAtPosition != null)
				{
					I_BE2_ProgrammingEnv componentInParent2 = spotAtPosition.Transform.GetComponentInParent<I_BE2_ProgrammingEnv>();
					if (componentInParent2 == null && spotAtPosition.Transform.GetChild(0) != null)
					{
						componentInParent2 = spotAtPosition.Transform.GetChild(0).GetComponentInParent<I_BE2_ProgrammingEnv>();
					}
					if (componentInParent2 != null)
					{
						Transform.SetParent(componentInParent2.Transform);
						_executionManager.AddToBlocksStackArray(Block.Instruction.InstructionBase.BlocksStack, componentInParent2.TargetObject);
					}
					else
					{
