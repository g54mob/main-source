...
namespace MG_BlocksEngine2.Block.Instruction
{
	public class BE2_Ins_ReplaceIndexOfList : BE2_InstructionBase, I_BE2_Instruction
	{
		...
		{
			if (!base.Section0Inputs[0].InputValues.isText)
			{
				_variablesManager.ReplaceValueInList(base.Section0Inputs[1].StringValue, base.Section0Inputs[2].StringValue, (int)base.Section0Inputs[0].FloatValue);
			}
