...
namespace MG_BlocksEngine2.Block.Instruction
{
	public class BE2_Ins_InsertAtList : BE2_InstructionBase, I_BE2_Instruction
	{
		...
		{
			if (!base.Section0Inputs[1].InputValues.isText)
			{
				_variablesManager.InsertValueInList(base.Section0Inputs[2].StringValue, base.Section0Inputs[0].StringValue, (int)base.Section0Inputs[1].FloatValue);
			}
