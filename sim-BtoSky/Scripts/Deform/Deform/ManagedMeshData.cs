...
namespace Deform
{
	...
	public class ManagedMeshData
	{
		...
		{
			if (Vertices != null && Normals != null && Tangents != null && UVs != null && Colors != null && Triangles != null && Vertices.Length == Normals.Length && Normals.Length == Tangents.Length && Tangents.Length == UVs.Length)
			{
				return UVs.Length == Colors.Length;
			}
			return false;
		}
	}
