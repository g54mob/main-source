...
namespace Enviro
{
	public class EnviroURPRenderGraph : ScriptableRenderPass
	{
		...
		{
			PassData passData;
			using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PassData>(passName, out passData, "C:\\Users\\orang\\HouseBuilderSimulator\\Assets\\Enviro 3 - Sky and Weather\\Scripts\\Runtime\\Base\\Renderer\\EnviroURPRenderGraph.cs", 52);
			passData.src = src;
		...
		{
			PassData passData;
			using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PassData>(passName, out passData, "C:\\Users\\orang\\HouseBuilderSimulator\\Assets\\Enviro 3 - Sky and Weather\\Scripts\\Runtime\\Base\\Renderer\\EnviroURPRenderGraph.cs", 76);
			passData.src = src;
			passData.target = target;
		...
		{
			PassData passData;
			using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PassData>(passName, out passData, "C:\\Users\\orang\\HouseBuilderSimulator\\Assets\\Enviro 3 - Sky and Weather\\Scripts\\Runtime\\Base\\Renderer\\EnviroURPRenderGraph.cs", 109);
			passData.src = src;
			passData.target = target;
			passData.read1 = read1;
			passData.read1Name = read1Name;
		...
		public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
		{
			...
			PassData passData;
			using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PassData>("Enviro 3 Copy Texture", out passData, "C:\\Users\\orang\\HouseBuilderSimulator\\Assets\\Enviro 3 - Sky and Weather\\Scripts\\Runtime\\Base\\Renderer\\EnviroURPRenderGraph.cs", 267))
			{
