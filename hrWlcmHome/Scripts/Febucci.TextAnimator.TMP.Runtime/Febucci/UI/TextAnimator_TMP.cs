...
namespace Febucci.UI
{
	...
	public sealed class TextAnimator_TMP : TAnimCore
	{
		...
		{
			if (TMProComponent.overflowMode == TextOverflowModes.Overflow)
			{
				return base.GetRenderedCharactersCountInsidePage();
			}
			return TMProComponent.firstOverflowCharacterIndex;
		}
