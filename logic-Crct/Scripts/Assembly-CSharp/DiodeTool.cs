...
public class DiodeTool : ToolBase
{
	[Header("Creator Box")]
	public InputField cre_zInput;

	public InputField cre_fVInput;
	...
	[Header("Editor Box")]
	public InputField edit_zInput;

	public InputField edit_fVInput;
