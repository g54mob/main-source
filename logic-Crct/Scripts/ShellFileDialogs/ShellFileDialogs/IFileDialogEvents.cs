...
namespace ShellFileDialogs
{
	...
	internal interface IFileDialogEvents
	{
		...
		void OnShareViolation([In] IFileDialog pfd, [In] IShellItem psi, out FileDialogEventShareViolationResponse pResponse);

		void OnTypeChange([In] IFileDialog pfd);

		void OnOverwrite([In] IFileDialog pfd, [In] IShellItem psi, out FileDialogEventOverwriteResponse pResponse);
	}
}
