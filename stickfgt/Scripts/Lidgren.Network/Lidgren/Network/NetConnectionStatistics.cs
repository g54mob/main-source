...
namespace Lidgren.Network
{
	public sealed class NetConnectionStatistics
	{
		...
		public long ResentMessages
		{
			get
			{
				return m_resentMessagesDueToHole + m_resentMessagesDueToDelay;
			}
		}
		...
		public override string ToString()
		{
			...
			{
				NetReliableOrderedReceiver netReliableOrderedReceiver = receiveChannels[i] as NetReliableOrderedReceiver;
