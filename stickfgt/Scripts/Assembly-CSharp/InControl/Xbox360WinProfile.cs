	...
	public class Xbox360WinProfile : UnityInputDeviceProfile
	{
		public Xbox360WinProfile()
		{
			...
			JoystickNames = new string[29]
			{
				...
				"MadCatz GamePad (Controller)", "Saitek P990 Dual Analog Pad", "SL-6566 (Controller)", "USB Gamepad ", "WingMan RumblePad", "XBOX 360 For Windows (Controller)", "XEOX Gamepad (Controller)", "XEQX Gamepad SL-6556-BK", "Controller (<BETOP GAME FOR WINDOWS>)"
			};
