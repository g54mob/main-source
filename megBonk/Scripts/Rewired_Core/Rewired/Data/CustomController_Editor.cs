...
namespace Rewired.Data
{
	...
	public sealed class CustomController_Editor
	{
		...
		private sealed class toElyePGjyrApiHOKRXXzTPriKCh : IEnumerable<ControllerElementIdentifier>, IEnumerable, IEnumerator<ControllerElementIdentifier>, IEnumerator, IDisposable
		{
			private int qUteicGdgnTIlKZRrMktKjMycgeP;

			private ControllerElementIdentifier lFrADUJoHbGfTPOewqDitGEdXRmsA;

			private int vimhiqkdOBUlHcGFkiENDUrNvXGf;

			public CustomController_Editor rHxMyZqXiBBxdfuZBfNRTnBQXWIT;

			private int UDuUBvFZvMnkjYDFvARPlABUwWuJ;
			...
			[DebuggerHidden]
			public toElyePGjyrApiHOKRXXzTPriKCh(int P_0)
			{
			}
		...
		{
			[IteratorStateMachine(typeof(toElyePGjyrApiHOKRXXzTPriKCh))]
			get
			{
				return null;
			}
		...
		private void zCZbOSslKxYuFORSNAQeeDKjKrcEb<_0001>(int P_0, List<_0001> P_1) where _0001 : Element
		{
		}

		private ControllerElementIdentifier txTbjsBFXkLALtTKCAnzTQuRHKxx(int P_0, string P_1)
		{
			return null;
		}

		private Element ifsMRXdDsUjbiirTAEHueLgrpySV(ControllerElementType P_0)
		{
			return null;
		}

		private ControllerElementIdentifier egNLKAISWQyiTtVvJnNErwGbgtyd(ControllerElementType P_0, string P_1, string P_2, string P_3, string P_4, string P_5, string P_6)
		{
			return null;
		}
