...
namespace Rewired.Internal.Localization
{
	...
	internal sealed class DeviceLocalizationInfo
	{
		...
		private readonly ReadOnlyList<string> mTEkfqzWuBgZPJNkQvSAUaqOZdBn;

		private readonly IList<string> CRURAmzWXwwpaNRDJiVschHGBAhm;

		private readonly ReadOnlyList<Guid> iEeEUWfWAfxPXaHycUmFnhykVemn;

		private string kSimSoHnpGeThuTgSSJjBbTEVnB;

		private Bytes20 xTuaXkiPQDMBTxjmLUoUsaucUgNg;

		private bool kEfxvyBpPTsvamlEZoyXyDDhLIGR;
