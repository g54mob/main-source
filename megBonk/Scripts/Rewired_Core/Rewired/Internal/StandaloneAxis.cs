...
namespace Rewired.Internal
{
	...
	internal sealed class StandaloneAxis
	{
		...
		[CompilerGenerated]
		private AxisValueChangedEventHandler MKBCMbeQqnpsvDThbOwJQoBadOwNc;

		[CompilerGenerated]
		private AxisValueChangedEventHandler ZJyylSCLVwGOgRIrUWBduuZgUSff;

		[CompilerGenerated]
		private ButtonDownEventHandler iXfiRvBUXCNFUiNgmBeeCoVUFrncb;

		[CompilerGenerated]
		private ButtonUpEventHandler YJjbUvztNCePoEsHTxMmeYMABrHRA;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler rNDUtkCQQZBImARhCeUlfhluAckh;

		[CompilerGenerated]
		private ButtonDownEventHandler dNNaCbAmuoXFFhuCmnelWXUPKgBm;

		[CompilerGenerated]
		private ButtonUpEventHandler jLEwASbPSsuSyNFajyEpfgDZWnSq;

		[CompilerGenerated]
		private ButtonValueChangedEventHandler eIirInRzqpmfErIxpXYdxzwchTTM;
