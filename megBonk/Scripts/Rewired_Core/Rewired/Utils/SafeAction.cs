...
namespace Rewired.Utils
{
	...
	{
		private static Action<object, Action> sfowRRXNBzguQgOAxGBaqFFywahlA;
		...
		private static void ShRLOYSggpBuFguiycroxjIgZFBqA(object P_0, Action P_1)
		{
		}
	...
	{
		private T nYZPBydCNRqjCwjTDeUaOwgFCRIm;

		private static Action<object, Action<T>> LtOsTChgNHUrkJTSdmYHyevvJEi;
		...
		private static void BAWmzxzHbpjzSIbjJKPoROwjXrKD(object P_0, Action<T> P_1)
		{
		}
	...
	{
		private T bkODlfdbVANOstJULKTTZQlujWJMA;

		private T2 SOONjIIDHGNAnZmkDnXCFqXOLpWk;

		private static Action<object, Action<T, T2>> NZUsFgNkoRhXqNlNDDFObEoRQIZIA;
		...
		private static void sZmUTsgKfmZEAYmkKQFfXrGZPOnc(object P_0, Action<T, T2> P_1)
		{
		}
