...
namespace Rewired.ComponentControls
{
	...
	public sealed class TiltControl : CustomControllerControl
	{
		...
		internal StandaloneAxis2D muyEXkjhAFpcxBveIAEqqVPQmLxo => null;

		private Vector3 qVWWasgvCgeMAOOpIqvCvuvdIxgO => default(Vector3);
		...
		private void yjBKUqTvtMfxTSljbQJPaxGOWdgR(TiltDirection P_0)
		{
		}
	}
}
