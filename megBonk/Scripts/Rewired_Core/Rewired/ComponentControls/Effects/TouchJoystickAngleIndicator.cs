...
namespace Rewired.ComponentControls.Effects
{
	...
	public sealed class TouchJoystickAngleIndicator : MonoBehaviour, IVisibilityChangedHandler, TouchJoystick.IStickPositionChangedHandler
	{
		...
		private Image uJvqIMWeNXtWCTUSUfHYulLsCjkDA;

		private RectTransform nRBBiJhmiYDgttPiaPZmekohjTjfb;

		private Vector2 xuhsvdUAcVryowDvSQZPFqgPjLK;

		private bool EYCGYXDCdQGRxlCdKLCKNdvxbDgDA;

		private IRegistrar<TouchJoystickAngleIndicator> lGBmCFWLFfwgSeuPTtfioZcuHZBU;
		...
		internal Image OYeDppMXGhacZqzIUmiWLUxltDpH => null;

		internal Sprite SaGvOLyOJtVfetMEqCZJhQbefCiAb => null;

		internal RectTransform atyICacHVimqcWZZAaMhdIvzkqVf => null;
		...
		internal bool JmvJtEuDthiptbrZxVxuwWiQFDte(out Vector2 P_0)
		{
			P_0 = default(Vector2);
			return false;
		}
		...
		private void RtVSUPFbhnOaITGGIBDCsuPOFkte(bool P_0, bool P_1)
		{
		}

		private void OosDWSDEOqAalGcEPoywMuWtYhAB(Vector2 P_0)
		{
		}
