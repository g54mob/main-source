...
namespace Mirror
{
	...
	public static class GeneratedNetworkCode
	{
		...
		public static void _Write_UnityEngine_002EGameObject(NetworkWriter writer, GameObject value)
		{
		...
		public static GameObject _Read_UnityEngine_002EGameObject(NetworkReader reader)
		{
			if (!reader.ReadBool())
			{
				return null;
		...
		public static void InitReadWriters()
		{
			...
			Writer<GameObject>.write = _Write_UnityEngine_002EGameObject;
			...
			Reader<GameObject>.read = _Read_UnityEngine_002EGameObject;
