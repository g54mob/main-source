...
namespace PlayFab.Multiplayer
{
	internal sealed class PlayFabMultiplayerEventTracer : SingletonMonoBehaviour<PlayFabMultiplayerEventTracer>
	{
		...
		public void OnPlayFabMultiPlayerInitialize()
		{
			...
			eventContents.Name = "unity_multiplayer_client_initialization_completed";
			eventContents.EventNamespace = "playfab.multiplayer.internal";
			...
			dictionary["MultiplayerVersion"] = Version.MultiplayerNativeVersion;
			dictionary["MultiplayerUnityVersion"] = Version.MultiplayerUnityVersion;
