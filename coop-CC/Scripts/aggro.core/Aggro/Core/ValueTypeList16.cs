...
{
	public struct ValueTypeList16<T> : IValueTypeList<T>, IEnumerable where T : struct
	{
		private T _value0;
		...
		public ValueTypeList16(T[] arr)
		{
			this = default(ValueTypeList16<T>);
			AddRange(arr);
		}

		public ValueTypeList16(List<T> list)
		{
			this = default(ValueTypeList16<T>);
			AddRange(list);
		}
