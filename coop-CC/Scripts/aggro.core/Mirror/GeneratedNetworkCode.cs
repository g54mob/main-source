...
namespace Mirror
{
	...
	public static class GeneratedNetworkCode
	{
		...
		public static void InitReadWriters()
		{
			...
			Writer<Entity>.write = NetworkSerialization.WriteEntity;
			Writer<NetScrobId>.write = NetworkSerialization.WriteNetworkScrob;
			Writer<NetBehaviourId>.write = NetworkSerialization.WriteNetworkBehaviour;
			Writer<GameObject>.write = NetworkSerialization.WriteGameObject;
			Writer<ValueTypeList4<Vector3>>.write = NetworkSerialization.WriteVector3ValueTypeList4;
			Writer<ValueTypeList4<Quaternion>>.write = NetworkSerialization.WriteQuaternionValueTypeList4;
			Writer<ValueTypeList4<Entity>>.write = NetworkSerialization.WriteEntityValueTypeList4;
			Writer<EventReference>.write = NetworkSerialization.WriteEventReference;
			...
			Reader<Entity>.read = NetworkSerialization.ReadEntity;
			Reader<NetScrobId>.read = NetworkSerialization.ReadNetworkScrob;
			Reader<NetBehaviourId>.read = NetworkSerialization.ReadNetworkBehaviour;
			Reader<GameObject>.read = NetworkSerialization.ReadGameObject;
			Reader<ValueTypeList4<Vector3>>.read = NetworkSerialization.ReadVector3ValueTypeList4;
			Reader<ValueTypeList4<Quaternion>>.read = NetworkSerialization.ReadQuaternionValueTypeList4;
			Reader<ValueTypeList4<Entity>>.read = NetworkSerialization.ReadValueTypeList4;
			Reader<EventReference>.read = NetworkSerialization.ReadEventReference;
		}
	}
}
