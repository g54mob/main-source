...
{
	unsafe void IMoveHandler.OnMove(AxisEventData eventData)
	{
	...
	public unsafe UniTask<AxisEventData> OnMoveAsync()
	{
		//IL_0047: Expected O, but got I
		//IL_0013: Expected O, but got Ref
		IntPtr intPtr = default(IntPtr);
		AsyncTriggerHandler<AxisEventData> asyncTriggerHandler = (AsyncTriggerHandler<AxisEventData>)(object)new AsyncTriggerHandler<object>((AsyncTriggerBase<object>)(nint)intPtr, callOnce: true);
		if (asyncTriggerHandler != null)
		{
			object obj = default(object);
			UniTask<AxisEventData> uniTask = ((IAsyncOnMoveHandler)(&obj)).OnMoveAsync();
			AsyncMoveTrigger asyncMoveTrigger = (AsyncMoveTrigger)uniTask;
			_ = uniTask.source;
			return (UniTask<AxisEventData>)this;
		}
		return (UniTask<AxisEventData>)new NullReferenceException();
	}

	public unsafe UniTask<AxisEventData> OnMoveAsync(CancellationToken cancellationToken)
	{
		//IL_004b: Expected O, but got I
		//IL_0013: Expected O, but got Ref
		IntPtr intPtr = default(IntPtr);
		AsyncTriggerHandler<AxisEventData> asyncTriggerHandler = (AsyncTriggerHandler<AxisEventData>)(object)new AsyncTriggerHandler<object>((AsyncTriggerBase<object>)cancellationToken, (CancellationToken)(nint)intPtr, callOnce: true);
		if (asyncTriggerHandler != null)
		{
			object obj = default(object);
			UniTask<AxisEventData> uniTask = ((IAsyncOnMoveHandler)(&obj)).OnMoveAsync();
