...
{
	private unsafe void OnParticleTrigger()
	{
	...
	public unsafe UniTask OnParticleTriggerAsync()
	{
	...
	public unsafe UniTask OnParticleTriggerAsync(CancellationToken cancellationToken)
	{
		//IL_0017: Expected native int or pointer, but got O
