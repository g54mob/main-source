...
{
	unsafe void IPointerUpHandler.OnPointerUp(PointerEventData eventData)
	{
	...
	public unsafe UniTask<PointerEventData> OnPointerUpAsync()
	{
		...
		if (asyncTriggerHandler != null)
		{
			...
			UniTask<PointerEventData> uniTask = ((IAsyncOnPointerUpHandler)(&obj)).OnPointerUpAsync();
			AsyncPointerUpTrigger asyncPointerUpTrigger = (AsyncPointerUpTrigger)uniTask;
			_ = uniTask.source;
	...
	public unsafe UniTask<PointerEventData> OnPointerUpAsync(CancellationToken cancellationToken)
	{
