...
{
	unsafe void IDropHandler.OnDrop(PointerEventData eventData)
	{
	...
	public unsafe UniTask<PointerEventData> OnDropAsync()
	{
		...
		if (asyncTriggerHandler != null)
		{
			...
			UniTask<PointerEventData> uniTask = ((IAsyncOnDropHandler)(&obj)).OnDropAsync();
			AsyncDropTrigger asyncDropTrigger = (AsyncDropTrigger)uniTask;
			_ = uniTask.source;
	...
	public unsafe UniTask<PointerEventData> OnDropAsync(CancellationToken cancellationToken)
	{
