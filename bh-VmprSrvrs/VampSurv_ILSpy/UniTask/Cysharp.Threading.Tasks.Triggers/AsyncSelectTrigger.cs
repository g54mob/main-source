...
{
	unsafe void ISelectHandler.OnSelect(BaseEventData eventData)
	{
	...
	public unsafe UniTask<BaseEventData> OnSelectAsync()
	{
		...
		if (asyncTriggerHandler != null)
		{
			...
			UniTask<BaseEventData> uniTask = ((IAsyncOnSelectHandler)(&obj)).OnSelectAsync();
			AsyncSelectTrigger asyncSelectTrigger = (AsyncSelectTrigger)uniTask;
			_ = uniTask.source;
	...
	public unsafe UniTask<BaseEventData> OnSelectAsync(CancellationToken cancellationToken)
	{
