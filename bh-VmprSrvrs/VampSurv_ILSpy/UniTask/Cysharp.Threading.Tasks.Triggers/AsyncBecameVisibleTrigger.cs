...
{
	private unsafe void OnBecameVisible()
	{
	...
	public unsafe UniTask OnBecameVisibleAsync()
	{
	...
	public unsafe UniTask OnBecameVisibleAsync(CancellationToken cancellationToken)
	{
		//IL_0017: Expected native int or pointer, but got O
