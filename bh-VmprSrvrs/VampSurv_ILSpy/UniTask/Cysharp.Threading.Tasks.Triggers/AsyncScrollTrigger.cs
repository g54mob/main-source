...
{
	unsafe void IScrollHandler.OnScroll(PointerEventData eventData)
	{
	...
	public unsafe UniTask<PointerEventData> OnScrollAsync()
	{
		...
		if (asyncTriggerHandler != null)
		{
			...
			UniTask<PointerEventData> uniTask = ((IAsyncOnScrollHandler)(&obj)).OnScrollAsync();
			AsyncScrollTrigger asyncScrollTrigger = (AsyncScrollTrigger)uniTask;
			_ = uniTask.source;
	...
	public unsafe UniTask<PointerEventData> OnScrollAsync(CancellationToken cancellationToken)
	{
