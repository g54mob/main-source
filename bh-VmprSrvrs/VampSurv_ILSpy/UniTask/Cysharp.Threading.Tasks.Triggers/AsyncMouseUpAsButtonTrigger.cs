...
{
	private unsafe void OnMouseUpAsButton()
	{
	...
	public unsafe UniTask OnMouseUpAsButtonAsync()
	{
	...
	public unsafe UniTask OnMouseUpAsButtonAsync(CancellationToken cancellationToken)
	{
		//IL_0017: Expected native int or pointer, but got O
