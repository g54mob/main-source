...
{
	unsafe void IEndDragHandler.OnEndDrag(PointerEventData eventData)
	{
	...
	public unsafe UniTask<PointerEventData> OnEndDragAsync()
	{
		...
		if (asyncTriggerHandler != null)
		{
			...
			UniTask<PointerEventData> uniTask = ((IAsyncOnEndDragHandler)(&obj)).OnEndDragAsync();
			AsyncEndDragTrigger asyncEndDragTrigger = (AsyncEndDragTrigger)uniTask;
			_ = uniTask.source;
	...
	public unsafe UniTask<PointerEventData> OnEndDragAsync(CancellationToken cancellationToken)
	{
