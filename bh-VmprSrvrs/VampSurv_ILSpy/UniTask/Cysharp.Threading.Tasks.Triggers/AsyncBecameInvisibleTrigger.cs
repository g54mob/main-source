...
{
	private unsafe void OnBecameInvisible()
	{
	...
	public unsafe UniTask OnBecameInvisibleAsync()
	{
	...
	public unsafe UniTask OnBecameInvisibleAsync(CancellationToken cancellationToken)
	{
		//IL_0017: Expected native int or pointer, but got O
