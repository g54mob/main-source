...
{
	unsafe void IDeselectHandler.OnDeselect(BaseEventData eventData)
	{
	...
	public unsafe UniTask<BaseEventData> OnDeselectAsync()
	{
		...
		if (asyncTriggerHandler != null)
		{
			...
			UniTask<BaseEventData> uniTask = ((IAsyncOnDeselectHandler)(&obj)).OnDeselectAsync();
			AsyncDeselectTrigger asyncDeselectTrigger = (AsyncDeselectTrigger)uniTask;
			_ = uniTask.source;
	...
	public unsafe UniTask<BaseEventData> OnDeselectAsync(CancellationToken cancellationToken)
	{
