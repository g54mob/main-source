...
{
	unsafe void IInitializePotentialDragHandler.OnInitializePotentialDrag(PointerEventData eventData)
	{
	...
	public unsafe UniTask<PointerEventData> OnInitializePotentialDragAsync()
	{
		...
		if (asyncTriggerHandler != null)
		{
			...
			UniTask<PointerEventData> uniTask = ((IAsyncOnInitializePotentialDragHandler)(&obj)).OnInitializePotentialDragAsync();
			AsyncInitializePotentialDragTrigger asyncInitializePotentialDragTrigger = (AsyncInitializePotentialDragTrigger)uniTask;
			_ = uniTask.source;
	...
	public unsafe UniTask<PointerEventData> OnInitializePotentialDragAsync(CancellationToken cancellationToken)
	{
