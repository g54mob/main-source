...
{
	unsafe void IDragHandler.OnDrag(PointerEventData eventData)
	{
	...
	public unsafe UniTask<PointerEventData> OnDragAsync()
	{
		...
		if (asyncTriggerHandler != null)
		{
			...
			UniTask<PointerEventData> uniTask = ((IAsyncOnDragHandler)(&obj)).OnDragAsync();
			AsyncDragTrigger asyncDragTrigger = (AsyncDragTrigger)uniTask;
			_ = uniTask.source;
	...
	public unsafe UniTask<PointerEventData> OnDragAsync(CancellationToken cancellationToken)
	{
