...
public sealed class AsyncTriggerExitTrigger : AsyncTriggerBase<Collider>
{
	...
	public unsafe UniTask<Collider> OnTriggerExitAsync()
	{
		...
		if (asyncTriggerHandler != null)
		{
			...
			UniTask<Collider> uniTask = ((IAsyncOnTriggerExitHandler)(&obj)).OnTriggerExitAsync();
			AsyncTriggerExitTrigger asyncTriggerExitTrigger = (AsyncTriggerExitTrigger)uniTask;
			_ = uniTask.source;
	...
	public unsafe UniTask<Collider> OnTriggerExitAsync(CancellationToken cancellationToken)
	{
