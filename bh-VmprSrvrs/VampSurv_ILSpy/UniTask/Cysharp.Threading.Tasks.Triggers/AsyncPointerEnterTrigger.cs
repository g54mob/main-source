...
{
	unsafe void IPointerEnterHandler.OnPointerEnter(PointerEventData eventData)
	{
	...
	public unsafe UniTask<PointerEventData> OnPointerEnterAsync()
	{
		...
		if (asyncTriggerHandler != null)
		{
			...
			UniTask<PointerEventData> uniTask = ((IAsyncOnPointerEnterHandler)(&obj)).OnPointerEnterAsync();
			AsyncPointerEnterTrigger asyncPointerEnterTrigger = (AsyncPointerEnterTrigger)uniTask;
			_ = uniTask.source;
	...
	public unsafe UniTask<PointerEventData> OnPointerEnterAsync(CancellationToken cancellationToken)
	{
