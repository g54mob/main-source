...
internal sealed class DeltaTimePlayerLoopTimer : PlayerLoopTimer
{
	...
	public unsafe DeltaTimePlayerLoopTimer(TimeSpan interval, bool periodic, PlayerLoopTiming playerLoopTiming, CancellationToken cancellationToken, Action<object> timerCallback, object state)
	{
	...
	protected override bool MoveNextCore()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 0000000185D4F1B6h\"");
		if (elapsed == 0f)
		{
