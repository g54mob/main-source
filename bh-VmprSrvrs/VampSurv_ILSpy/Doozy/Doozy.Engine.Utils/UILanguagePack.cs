...
public class UILanguagePack : LanguagePack
{
	...
	public unsafe static UILanguagePack Instance
	{
		get
		{
			...
			UILanguagePack uILanguagePack = s_instance;
			if ((object)s_instance != null && ((UnityEngine.Object)uILanguagePack).m_CachedPtr != (IntPtr)0)
			{
				Language currentLanguage = LanguagePack.CurrentLanguage;
				if (s_loadedLanguage == currentLanguage)
				{
					goto IL_015e;
				}
			}
			...
			{
				object obj4 = obj3;
				Cpp2ILHelpers.NoteDecompilerIssue("Indirect call: [v303 @ rdx_v4+1B8] (should have been resolved before IL gen)");
				Language currentLanguage2 = LanguagePack.CurrentLanguage;
				IntPtr intPtr = default(IntPtr);
				string text = ((Enum)(&intPtr)).ToString();
				string text2 = default(string);
				string path = text2 + text;
				UILanguagePack uILanguagePack2 = Resources.Load<UILanguagePack>(path);
				s_instance = uILanguagePack2;
				Language currentLanguage3 = LanguagePack.CurrentLanguage;
				s_loadedLanguage = currentLanguage3;
				goto IL_015e;
			}
			return (UILanguagePack)(object)new NullReferenceException();
			IL_015e:
			return s_instance;
		}
	}
