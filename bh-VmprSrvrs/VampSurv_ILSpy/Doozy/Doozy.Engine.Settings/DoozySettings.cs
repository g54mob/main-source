...
public class DoozySettings : ScriptableObject
{
	...
	public static DoozySettings Instance
	{
		get
		{
			DoozySettings doozySettings = s_instance;
			if ((object)s_instance == null || ((UnityEngine.Object)doozySettings).m_CachedPtr == (IntPtr)0)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @182EF8950");
				DoozySettings doozySettings2 = default(DoozySettings);
				s_instance = doozySettings2;
			}
			return s_instance;
		}
	}
