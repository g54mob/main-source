...
public class UIViewBehavior
{
	...
	public bool AutoStartLoopAnimation = true;
	...
	public static string DefaultPresetCategory
	{
		get
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899807B4]");
			if ((nint)0 == 0)
			{
				_ = 1;
			}
	...
	public static string DefaultPresetName
	{
		get
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899807B5]");
			if ((nint)0 == 0)
			{
				_ = 1;
			}
