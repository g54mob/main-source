...
public class Unused_TP_SimonCurse1Explosion_Projectile : Projectile
{
	...
	public override void InitProjectile(BulletPool pool, Weapon weapon, int index)
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 128 Invalid \"Jump target not found in method: 0x1871BA520\"");
			...
			if (_explosionCircle != null)
			{
				...
				if ((object)_weapon != null)
				{
					...
					if ((object)_weapon != null)
					{
						...
						((Unused_TP_SimonCurse1Explosion_Projectile)(object)dOSetter)._003CExplode_003Eb__16_2(0f);
				...
				if ((object)_pfxEmitter2 != null)
				{
					...
					if ((object)_GroundFx != null)
					{
						...
						if ((object)_particlesManager != null)
						{
							...
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v534 @ r8_v12 (Il2CppClass<VampireSurvivors.Objects.Projectiles.Unused_TP_SimonCurse1Explosion_Projectile>)+370]");
