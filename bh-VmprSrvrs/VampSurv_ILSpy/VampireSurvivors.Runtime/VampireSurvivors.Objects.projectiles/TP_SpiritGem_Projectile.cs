...
public class TP_SpiritGem_Projectile : Projectile
{
	...
	public override void InternalUpdate()
	{
		...
		//IL_0382->IL0308: Incompatible stack heights: 1 vs 0
		//IL_0174->IL0308: Incompatible stack heights: 1 vs 0
		//IL_01c6->IL0308: Incompatible stack heights: 1 vs 0
		//IL_0203->IL0308: Incompatible stack heights: 1 vs 0
		//IL_007d->IL0308: Incompatible stack heights: 1 vs 0
		//IL_00a9->IL0308: Incompatible stack heights: 1 vs 0
		//IL_03c8->IL0308: Incompatible stack heights: 1 vs 0
		//IL_029e->IL0308: Incompatible stack heights: 1 vs 0
		//IL_00f8->IL0308: Incompatible stack heights: 1 vs 0
		//IL_02d5->IL0308: Incompatible stack heights: 1 vs 0
		...
		{
			nint num = (nint)typeof(TP_SpiritTornado_Weapon);
			nint num2 = (nint)weapon;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v87 @ rdx_v11 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_SpiritTornado_Weapon>)+130]");
			object obj = 0;
			...
			if (num3 >= 0)
			{
				...
				if (0 == (nint)typeof(TP_SpiritTornado_Weapon))
				{
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v87 @ rdx_v11 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_SpiritTornado_Weapon>)+130]");
					object obj3 = 0;
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v118 @ rax_v24+FFFFFFF8+v570 @ rcx_v20*8]");
					object obj4 = 0 - typeof(TP_SpiritTornado_Weapon);
					...
					if ((object)((Equipment)weapon2)._003COwner_003Ek__BackingField != null)
					{
						...
						if ((object)((Equipment)weapon2)._003COwner_003Ek__BackingField != null)
						{
							...
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v81 @ rdi_v9 (VampireSurvivors.Objects.Weapons.Weapon)+178]");
							if ((nint)0 != 0)
							{
								Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v81 @ rdi_v9 (VampireSurvivors.Objects.Weapons.Weapon)+178]");
