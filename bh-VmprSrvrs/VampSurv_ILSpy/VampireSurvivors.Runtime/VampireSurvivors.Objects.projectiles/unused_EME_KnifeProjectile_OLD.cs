...
public class unused_EME_KnifeProjectile_OLD : Projectile
{
	...
	public unsafe override void InternalUpdate()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (VampireSurvivors.Objects.Projectiles.unused_EME_KnifeProjectile_OLD)+104]");
		object obj3 = default(object);
		object obj2 = obj3 - 0;
	...
	{
		_expired = true;
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 2 Invalid \"Jump target not found in method: 0x187247AB0\"");
	}
