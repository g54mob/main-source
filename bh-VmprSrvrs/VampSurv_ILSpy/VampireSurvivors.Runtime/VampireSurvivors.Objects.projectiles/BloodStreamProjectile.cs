...
public class BloodStreamProjectile : Projectile
{
	private sealed class _003C_003Ec__DisplayClass12_0
	{
		public bool dieOnStop;

		public BloodStreamProjectile _003C_003E4__this;

		internal void _003COverrideWeaponData_003Eb__1()
		{
			if (dieOnStop)
			{
		...
		internal void _003COverrideWeaponData_003Eb__2()
		{
			//IL_0015: Expected O, but got I4
			ArcadeSprite arcadeSprite = _003C_003E4__this.setScale(1f, (float?)(object)0);
		}

		internal void _003COverrideWeaponData_003Eb__0()
		{
			_003C_003E4__this.Despawn();
		}

		internal void _003COverrideWeaponData_003Eb__3()
		{
			BloodStreamProjectile bloodStreamProjectile = _003C_003E4__this;
			bloodStreamProjectile.Deceleration = 2f;
		}
	}
	...
	protected unsafe override void Awake()
	{
		...
		//IL_06d5: Expected native int or pointer, but got O
		//IL_06ef: Expected O, but got I
		//IL_070f: Expected O, but got Ref
		//IL_0729: Expected native int or pointer, but got O
		//IL_0929: Expected O, but got I
		//IL_0761: Expected O, but got Ref
		//IL_077b: Expected native int or pointer, but got O
	...
	public unsafe override void InitProjectile(BulletPool pool, Weapon weapon, int index)
	{
		...
		//IL_0083: Expected Ref, but got Unknown
		...
		baseBody3._velocity = _aimVec;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (VampireSurvivors.Objects.Projectiles.BloodStreamProjectile)+104]");
		_ = 0;
	}
	...
	public void OverrideWeaponData(Weapon weapon)
	{
		...
		//IL_0577: Expected F4, but got I4
		_003C_003Ec__DisplayClass12_0 CS_0024_003C_003E8__locals8 = new _003C_003Ec__DisplayClass12_0();
		...
		if ((nint)obj != 2139095040)
		{
			...
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 0000000186FFAA33h\"");
				if (num == -1f / 0f)
				{
					num = -3.4028235E+38f;
				}
		...
		if (num > num3)
		{
			...
			bool flag = _setDuration < num3;
			float num5 = _setDuration - num3;
			bool flag2 = num5 == 0f;
			bool flag3 = !flag;
			bool flag4 = !flag2;
			...
			{
				//IL_0015: Expected O, but got I4
				ArcadeSprite arcadeSprite = CS_0024_003C_003E8__locals8._003C_003E4__this.setScale(1f, (float?)(object)0);
			};
			...
			if (!flag5)
			{
				...
				Timer durationTween = Timers.Register(duration, onComplete2, null, isLooped: false, flag7, autoDestroyOwner, repeat, type, isOnlineTimer: false, canPause: false);
			...
			if (obj4 != null)
			{
				...
				{
					BloodStreamProjectile bloodStreamProjectile = CS_0024_003C_003E8__locals8._003C_003E4__this;
					bloodStreamProjectile.Deceleration = 2f;
				};
