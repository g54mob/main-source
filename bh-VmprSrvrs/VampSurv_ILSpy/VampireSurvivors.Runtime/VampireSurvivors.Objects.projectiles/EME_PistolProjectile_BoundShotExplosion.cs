...
public class EME_PistolProjectile_BoundShotExplosion : Projectile
{
	...
	public override void InitProjectile(BulletPool pool, Weapon weapon, int index)
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v425 @ r8_v9 (Il2CppClass<VampireSurvivors.Objects.Projectiles.EME_PistolProjectile_BoundShotExplosion>)+370]");
