...
public class EME_BloodProjectile_Special_BloodRage : Projectile
{
	...
	protected string FrameName
	{
		get
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A47DD]");
			if ((nint)0 == 0)
			{
				_ = 1;
			}
			return "eme_fx_sanguine2";
		}
	}

	protected float ExpireTime => 1500f;

	protected override void Awake()
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A47DE]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
		...
		if ((object)instance != null)
		{
			...
			PhaserSprite displaySprite = instance.AddPhaserSprite(pos, "Emeralds_VFX", "eme_fx_sanguine2");
	...
	protected unsafe void MakeEmitter()
	{
		...
		_ = 0;
		_ = 0;
		System.Runtime.CompilerServices.Unsafe.Write((void*)(nint)minMaxCurve3, new ParticleSystem.MinMaxCurve(245f, 285f));
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v8 @ rbp_v1+8]");
		...
		_ = 0;
		_ = 0;
		System.Runtime.CompilerServices.Unsafe.Write((void*)(nint)minMaxCurve4, new ParticleSystem.MinMaxCurve(300f, 400f));
		_ = 0;
		...
		ParticleSystem damageVfx = _particlesManager.CreateEmitter(particleSystemConfig, null, "EMEBloodEmitter2");
	...
	private void LateUpdate()
	{
		...
		{
			isFirstUpdate = false;
			Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 13 Invalid \"Jump target not found in method: 0x1871CC000\"");
		}
	}
	...
	public void Activate()
	{
		...
		//IL_04e9: Expected F4, but got I4
		//IL_0509: Expected O, but got I4
		//IL_0556: Expected F4, but got I4
		//IL_0266->IL0560: Incompatible stack heights: 1 vs 0
		//IL_02b8->IL0560: Incompatible stack heights: 2 vs 0
						...
						if (_tints != null)
						{
							...
							if (array != null)
							{
								...
								if (tweenConfig != null)
								{
									...
									Timer timer2 = Timers.Register(1.5000001f, onComplete3, null, isLooped: false, flag3, autoDestroyOwner, repeat, type, isOnlineTimer: false, canPause: false);
									expireTimer = timer2;
	...
	public EME_BloodProjectile_Special_BloodRage()
	{
