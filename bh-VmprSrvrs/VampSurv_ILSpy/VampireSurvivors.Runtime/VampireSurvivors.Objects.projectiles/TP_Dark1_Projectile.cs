...
public class TP_Dark1_Projectile : TP_Light1_Projectile
{
	...
	public override void MakeSpriteAnimation()
	{
		...
		int num = default(int);
		List<Sprite> animationFrames = SpriteManager.GetAnimationFrames("TP_VFX_Umbra", 1, 24, "ThosePeople", num);
		bool startRandomFrame = default(bool);
		Action onComplete = default(Action);
		bool autoSetAnimation = default(bool);
		_spriteAnimator.AddAnimation("loop", animationFrames, 24, (byte)num != 0, startRandomFrame, onComplete, autoSetAnimation);
	...
	protected override void PlayFiringSfx()
	{
		...
		PlaySoundResult playSoundResult = SoundManager.PlaySound(SfxType.TP_sfx_Umbra, soundConfig, 50f, 1, time);
	}
	...
	public void createGravityWell(float2 pos, float radius)
	{
		...
		while (true)
		{
			...
			if ((nint)0 == 0)
			{
				...
				float6 = obj3 - obj4;
				Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001870C3C2Ch\"");
				if (num == 0f)
				{
