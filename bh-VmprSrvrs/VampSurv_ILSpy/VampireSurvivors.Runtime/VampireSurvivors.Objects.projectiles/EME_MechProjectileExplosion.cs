...
public class EME_MechProjectileExplosion : Projectile
{
					...
					if (body != null)
					{
						...
						if ((object)_GroundVFX != null)
						{
							...
							if (tweenerCore != null)
							{
								...
								PlaySoundResult playSoundResult = SoundManager.PlaySound(SfxType.Sfx_eme_mechexplosion, soundConfig, 200f, 3, time);
								return;
							}
						}
					}
	...
	private void FadeOut()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v64 @ r8_v2 (Il2CppClass<VampireSurvivors.Objects.Projectiles.EME_MechProjectileExplosion>)+370]");
