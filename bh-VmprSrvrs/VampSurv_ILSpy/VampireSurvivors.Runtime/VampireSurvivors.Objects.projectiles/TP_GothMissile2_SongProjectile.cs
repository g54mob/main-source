...
public class TP_GothMissile2_SongProjectile : Projectile
{
	...
	{
		//IL_01f3: Invalid comparison between O and F4
		//IL_02ea->IL0256: Incompatible stack heights: 1 vs 0
		//IL_015e->IL015e: Incompatible stack heights: 1 vs 0
		if (other != null)
		{
				...
				if ((object)_weapon != null)
				{
					...
					if ((object)_weapon != null)
					{
						...
						if ((object)weapon._gameMan != null)
						{
							...
							Transform.get_position_Injected(((UnityEngine.Object)component).m_CachedPtr, out Vector3 _);
		...
		if ((object)gameObject2 != null)
		{
			...
			object obj2 = default(object);
			if ((object)component2 != null && ((UnityEngine.Object)component2).m_CachedPtr != (IntPtr)0 && ((object)component2._003CResDebuffs_003Ek__BackingField == null || System.Runtime.CompilerServices.Unsafe.As<object, UIntPtr>(ref obj2) < System.Runtime.CompilerServices.Unsafe.As<object, UIntPtr>(ref (object)1f)) && component2._003CSlow_003Ek__BackingField > 0.2f)
			{
				float num = component2._003CSlow_003Ek__BackingField - 0.05f;
				component2._003CSlow_003Ek__BackingField = num;
			}
			return;
		}
		goto IL_0256;
	...
	private void Shoot()
	{
		...
		UpdateBlitter(_blitter, 0.015f);
		UpdateBlitterBG(_blitterBg, 0.015f);
		_blitter.UpdateBobs();
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1027 @ r8_v18 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_GothMissile2_SongProjectile>)+370]");
	...
	private void UpdateBlitterBG(Blitter blitter, float factor = 0.01f)
	{
	...
	private void MakeBlitters()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [18999FA12]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
		Sprite sprite = SpriteManager.GetSprite("PfxDarkRed", "vfx");
		Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180A97420");
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [18999FA1F]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
		Sprite sprite2 = SpriteManager.GetSprite("PfxRed", "vfx");
		Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180A97420");
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [18999FA20]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
		Sprite sprite3 = SpriteManager.GetSprite("PfxYellow", "vfx");
		Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180A97420");
	...
	public TP_GothMissile2_SongProjectile()
	{
	...
	static TP_GothMissile2_SongProjectile()
	{
