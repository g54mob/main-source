...
public class FireExplosionProjectile : Projectile
{
	...
	private bool _003Cretaliate_003Ek__BackingField;

	public bool retaliate
	{
		get
		{
			return _003Cretaliate_003Ek__BackingField;
		}
		set
		{
			_003Cretaliate_003Ek__BackingField = value;
		}
	}
	...
	public override void InitProjectile(BulletPool pool, Weapon weapon, int index)
	{
		...
		_003Cretaliate_003Ek__BackingField = false;
		PlayerOptionsData config = weapon2._playerOptions.Config;
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 129 Invalid \"Jump target not found in method: 0x187275490\"");
			...
			if (_explosionCircle != null)
			{
				...
				if ((object)_weapon != null)
				{
					...
					if ((object)_weapon != null)
					{
						...
						((FireExplosionProjectile)(object)dOSetter)._003CExplode_003Eb__20_2(0f);
				...
				if ((object)_pfxEmitter2 != null)
				{
					...
					if ((object)_GroundFx != null)
					{
						...
						if ((object)_particlesManager != null)
						{
							...
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v534 @ r8_v12 (Il2CppClass<VampireSurvivors.Objects.Projectiles.FireExplosionProjectile>)+370]");
	...
	private void _003CExplode_003Eb__20_0()
	{
		BaseBody baseBody = body;
		baseBody._enable = true;
	}

	private float _003CExplode_003Eb__20_1()
	{
		BaseBody baseBody = body;
		return baseBody._radius;
	}

	private void _003CExplode_003Eb__20_2(float r)
	{
