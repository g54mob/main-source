...
public class TP_HolyWhip1_Projectile : TP_WhipCore_Projectile
{
	[NonSerialized]
	...
	protected override Projectile CreateNodeProjectile(float2 pos)
	{
		...
		{
			nint num = (nint)typeof(TP_HolyWhip1_Weapon);
			nint num2 = (nint)weapon;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v44 @ rdx_v2 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_HolyWhip1_Weapon>)+130]");
			object obj = 0;
	...
	private unsafe void OnWhipStart()
	{
		...
		//IL_0762: Invalid comparison between F4 and I4
		...
		//IL_07cd->IL06bc: Incompatible stack heights: 1 vs 0
		//IL_033b->IL06bc: Incompatible stack heights: 1 vs 0
		//IL_0414->IL06bc: Incompatible stack heights: 1 vs 0
		//IL_0461->IL0461: Incompatible stack heights: 2 vs 1
		//IL_0519->IL06bc: Incompatible stack heights: 1 vs 0
		//IL_04e1->IL04e1: Incompatible stack heights: 2 vs 1
		//IL_054b->IL06bc: Incompatible stack heights: 1 vs 0
		//IL_0826->IL06bc: Incompatible stack heights: 2 vs 0
		//IL_0577->IL06bc: Incompatible stack heights: 2 vs 0
		//IL_061f->IL061f: Incompatible stack heights: 3 vs 2
		//IL_0664->IL06e5: Incompatible stack heights: 2 vs 0
			...
			if ((object)GM.Core != null)
			{
				...
				if ((object)_weapon != null && (object)((Equipment)weapon2)._003COwner_003Ek__BackingField != null)
				{
					...
					if ((object)core._stage != null)
					{
						...
						Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v640 @ rax_v40 (VampireSurvivors.Objects.Characters.EnemyController)+48]");
						if ((nint)0 != 0)
						{
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v640 @ rax_v40 (VampireSurvivors.Objects.Characters.EnemyController)+48]");
										...
										if ((nint)0 != 0)
										{
											...
											if ((object)transform2 != null)
											{
												...
												if ((object)_weapon != null && (object)((Equipment)weapon4)._003COwner_003Ek__BackingField != null)
												{
													...
													Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1305 @ rcx_v55 (Il2CppClass<Unity.Mathematics.float2>)+B8]");
													nint num5 = 0;
													WhipVerletNode whipVerletNode = null;
													whipVerletNode.position = float2.zero;
													Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v185 @ rdx_v33 (Il2CppStaticFields<Unity.Mathematics.float2>)+4]");
													_ = 0;
	...
	private void OnWhipComplete()
	{
		...
		nint num = (nint)typeof(TP_HolyWhip1_Weapon);
		nint num2 = (nint)weapon;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v105 @ r8_v4 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_HolyWhip1_Weapon>)+130]");
		object obj2 = 0;
		...
		if (num3 >= 0)
		{
			...
			if (0 == (nint)typeof(TP_HolyWhip1_Weapon))
			{
				...
				object obj5 = 0 - typeof(TP_HolyWhip1_Weapon);
				bool flag = obj5 == null;
				bool flag2 = !flag;
				TP_HolyWhip1_Weapon tP_HolyWhip1_Weapon = null;
				if (!flag2)
				{
					tP_HolyWhip1_Weapon = (TP_HolyWhip1_Weapon)weapon;
				}
				Vector2 pos = default(Vector2);
				tP_HolyWhip1_Weapon.FireSmokeProjectiles(pos);
				if (_attackCount >= _attackAmount)
				{
					Projectile[] nodeProjectiles = _nodeProjectiles;
					_applyNodeControl = false;
					TP_HolyWhip1_Weapon tP_HolyWhip1_Weapon2 = null;
					TP_HolyWhip1_Weapon tP_HolyWhip1_Weapon3 = null;
					while ((nint)tP_HolyWhip1_Weapon3 < nodeProjectiles.Length)
					{
						Projectile[] nodeProjectiles2 = _nodeProjectiles;
						Projectile projectile = nodeProjectiles2[(object)tP_HolyWhip1_Weapon2];
						BaseBody baseBody = projectile.body;
						tP_HolyWhip1_Weapon2 = (TP_HolyWhip1_Weapon)(tP_HolyWhip1_Weapon2 + 1);
						baseBody._enable = false;
						nodeProjectiles = _nodeProjectiles;
						tP_HolyWhip1_Weapon3 = tP_HolyWhip1_Weapon2;
					}
					if (_lineTween != null)
					{
						_lineTween.Kill();
	...
	private void ApplyManualNodeControl()
	{
		...
		float num = num2;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (VampireSurvivors.Objects.Projectiles.TP_HolyWhip1_Projectile)+100]");
		float num3 = num + 0f;
	...
	public TP_HolyWhip1_Projectile()
	{
