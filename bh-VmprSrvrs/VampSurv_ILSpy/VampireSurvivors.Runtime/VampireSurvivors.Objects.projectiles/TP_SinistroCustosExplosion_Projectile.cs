...
public class TP_SinistroCustosExplosion_Projectile : Projectile
{
	...
	public override void InitProjectile(BulletPool pool, Weapon weapon, int index)
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 128 Invalid \"Jump target not found in method: 0x187166110\"");
			...
			if (_explosionCircle != null)
			{
				...
				if ((object)_weapon != null)
				{
					...
					if ((object)_weapon != null)
					{
						...
						((TP_SinistroCustosExplosion_Projectile)(object)dOSetter)._003CExplode_003Eb__15_2(0f);
				...
				if ((object)_pfxEmitter2 != null)
				{
					...
					if ((object)_GroundFx != null)
					{
						...
						if ((object)_particlesManager != null)
						{
							...
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v534 @ r8_v12 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_SinistroCustosExplosion_Projectile>)+370]");
	...
	private unsafe void GenerateParticleSystems()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v2728 @ rax_v102 (UnityEngine.Transform)+10]");
		bool flag3 = (nint)0 == 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v2728 @ rax_v102 (UnityEngine.Transform)+10]");
