...
public class TP_Shuriken_Explosion_Projectile : Projectile
{
	...
	public override void InitProjectile(BulletPool pool, Weapon weapon, int index)
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 128 Invalid \"Jump target not found in method: 0x187163410\"");
			...
			if (_explosionCircle != null)
			{
				...
				if ((object)_weapon != null)
				{
					...
					if ((object)_weapon != null)
					{
						...
						((TP_Shuriken_Explosion_Projectile)(object)dOSetter)._003CExplode_003Eb__16_2(0f);
						...
						PlaySoundResult playSoundResult = SoundManager.PlaySound(SfxType.Victory1, soundConfig, 150f, 3, time);
						return;
					}
				}
			}
				...
				if ((object)_pfxEmitter2 != null)
				{
					...
					if ((object)_GroundFx != null)
					{
						...
						if ((object)_particlesManager != null)
						{
							...
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v534 @ r8_v12 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shuriken_Explosion_Projectile>)+370]");
	...
	private unsafe void GenerateParticleSystems()
	{
		...
		{
			((List<object>)(object)list2).AddWithResize((object)"HitStarWhite1");
		}
		else
		{
		...
		{
			((List<object>)(object)list2).AddWithResize((object)"HitStarWhite2");
		}
		else
		{
	...
	private float _003CExplode_003Eb__16_1()
	{
		BaseBody baseBody = body;
		return baseBody._radius;
	}

	private void _003CExplode_003Eb__16_2(float r)
	{
