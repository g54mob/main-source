...
public class Misspell2Projectile : Projectile
{
	...
	public unsafe override void InitProjectile(BulletPool pool, Weapon weapon, int index)
	{
		...
		//IL_096f: Expected I, but got O
		//IL_09c1: Unknown result type (might be due to invalid IL or missing references)
		//IL_09c6: Expected O, but got Unknown
		//IL_060e: Expected I, but got O
		//IL_06ca: Expected O, but got F4
		//IL_0855->IL0712: Incompatible stack heights: 4 vs 0
		//IL_0248->IL0712: Incompatible stack heights: 4 vs 0
		//IL_01d2->IL0712: Incompatible stack heights: 4 vs 0
		//IL_03f6->IL0712: Incompatible stack heights: 4 vs 0
		//IL_0425->IL0712: Incompatible stack heights: 4 vs 0
		//IL_046f->IL0712: Incompatible stack heights: 4 vs 0
		//IL_049e->IL0712: Incompatible stack heights: 4 vs 0
		//IL_052d->IL0712: Incompatible stack heights: 8 vs 0
		//IL_05fc->IL0712: Incompatible stack heights: 8 vs 0
		//IL_0581->IL0581: Incompatible stack heights: 9 vs 8
		//IL_05da->IL05da: Incompatible stack heights: 9 vs 8
		//IL_064c->IL0712: Incompatible stack heights: 8 vs 0
		//IL_06a9->IL0712: Incompatible stack heights: 8 vs 0
						...
						if ((object)_cachedTransform != null)
						{
							...
							if (!weapon2.IsHoming)
							{
								...
								if (!isPlayerFacing)
								{
									...
									Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v194 @ rcx_v98 (VampireSurvivors.Objects.Characters.CharacterController)+184]");
									float num2 = 0f;
									Vector3 playerDirection = (Vector3)(obj2 - 32);
									_ = 0;
									ApplyInversePlayerFacingVelocity(playerDirection);
									int num3 = 0;
									bool flag5 = true;
									Misspell2Projectile misspell2Projectile = this;
								}
								else
								{
									if ((object)((Equipment)weapon2)._003COwner_003Ek__BackingField == null)
									...
									Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v194 @ rcx_v98 (VampireSurvivors.Objects.Characters.CharacterController)+184]");
									float num2 = 0f;
									Vector3 playerDirection2 = (Vector3)(obj2 - 32);
									_ = 0;
									ApplyPlayerFacingVelocity(playerDirection2);
									...
									int num3 = 1;
									Vector3 playerDirection = (Vector3)soundConfig;
									bool flag5 = true;
									Misspell2Projectile misspell2Projectile = (Misspell2Projectile)28;
								}
							}
							else
							{
								nint num4 = (nint)this;
								Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1086 @ rax_v127 (Il2CppClass<VampireSurvivors.Objects.Projectiles.Misspell2Projectile>)+3B0]");
								bool flag5 = false;
							...
							if (body != null)
							{
								...
								Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v220 @ rsi_v21 (UnityEngine.SpriteRenderer)+70]");
								float2 velocity = (float2)((nint)indexInWeapon + (nint)0);
								Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180B6E6F0");
								ArcadeSprite sprite = _sprite;
								int indexInWeapon2 = _indexInWeapon;
								Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v220 @ rsi_v21 (UnityEngine.SpriteRenderer)+74]");
								object obj4 = (nint)indexInWeapon2 + (nint)0;
								if ((object)_sprite != null)
								{
									...
									if (sprite.body != null)
									{
										...
										SpriteRenderer spriteRenderer3 = RenderingExtensions.SetAlpha(_GroundFx, 0.5f);
										if ((object)_GroundFx != null)
										{
											_GroundFx.enabled = true;
											if ((object)_GroundFx != null)
											{
												...
												Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1328 @ rcx_v53 (Il2CppClass<UnityEngine.Vector3>)+B8]");
												nint num6 = 0;
												object obj5 = default(object);
												float num7 = (float)obj5 * 2f;
												float num8 = (float)Vector3.oneVector * 2f;
												_ = Vector3.oneVector;
												Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v542 @ rdx_v37 (Il2CppStaticFields<UnityEngine.Vector3>)+14]");
												float num9 = 0f * 2f;
												float num10 = num8 * 0.01f;
												float num11 = num7 * 0.01f;
												...
												Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1424 @ rax_v75 (Il2CppClass<UnityEngine.Vector3>)+B8]");
												nint num14 = 0;
												bool flag8 = (object)_cachedTransform == null;
												_ = Vector3.zeroVector;
												Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1219 @ rax_v76 (Il2CppStaticFields<UnityEngine.Vector3>)+8]");
												_ = 0;
												bool flag9 = ((UnityEngine.Object)cachedTransform3).m_CachedPtr == (IntPtr)0;
												object obj7 = obj2 - 48;
												Transform.set_localScale_Injected(((UnityEngine.Object)cachedTransform3).m_CachedPtr, ref *(Vector3*)obj7);
												if (_scaleTween != null)
												{
													_scaleTween.Kill();
												}
												...
												if (array != null)
												{
													...
													if (tweenConfig != null)
													{
														...
														if ((object)_weapon != null)
														{
															...
															if ((object)_weapon != null)
															{
																float num17 = _weapon.PDuration();
																((SpriteRenderer)(object)tweenConfig).m_SpriteChangeEvent = (UnityEvent<SpriteRenderer>)num16;
																_ = 1;
	...
	private unsafe void GenerateParticleSystems()
	{
		...
		{
			((List<object>)(object)list2).AddWithResize((object)"Flame3");
		}
		else
		{
		...
		{
			((List<object>)(object)list2).AddWithResize((object)"PfxGray");
		}
		else
		{
