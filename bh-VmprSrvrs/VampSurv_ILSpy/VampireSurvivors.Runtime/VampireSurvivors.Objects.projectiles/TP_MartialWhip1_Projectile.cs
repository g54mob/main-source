...
public class TP_MartialWhip1_Projectile : TP_WhipCore_Projectile
{
	[NonSerialized]
	...
	protected override Projectile CreateNodeProjectile(float2 pos)
	{
		...
		{
			nint num = (nint)typeof(TP_MartialWhip1_Weapon);
			nint num2 = (nint)weapon;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v44 @ rdx_v2 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_MartialWhip1_Weapon>)+130]");
			object obj = 0;
	...
	private void OnWhipComplete()
	{
		...
		nint num = (nint)typeof(TP_MartialWhip1_Weapon);
		nint num2 = (nint)weapon;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v105 @ r8_v4 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_MartialWhip1_Weapon>)+130]");
		object obj2 = 0;
		...
		if (num3 >= 0)
		{
			...
			if (0 == (nint)typeof(TP_MartialWhip1_Weapon))
			{
				...
				object obj5 = 0 - typeof(TP_MartialWhip1_Weapon);
				bool flag = obj5 == null;
				bool flag2 = !flag;
				TP_MartialWhip1_Weapon tP_MartialWhip1_Weapon = null;
				if (!flag2)
				{
					tP_MartialWhip1_Weapon = (TP_MartialWhip1_Weapon)weapon;
				}
				Vector2 pos = default(Vector2);
				tP_MartialWhip1_Weapon.FireImpactProjectiles(pos);
				if (_attackCount >= _attackAmount)
				{
					Projectile[] nodeProjectiles = _nodeProjectiles;
					_applyNodeControl = false;
					TP_MartialWhip1_Weapon tP_MartialWhip1_Weapon2 = null;
					TP_MartialWhip1_Weapon tP_MartialWhip1_Weapon3 = null;
					while ((nint)tP_MartialWhip1_Weapon3 < nodeProjectiles.Length)
					{
						Projectile[] nodeProjectiles2 = _nodeProjectiles;
						Projectile projectile = nodeProjectiles2[(object)tP_MartialWhip1_Weapon2];
						BaseBody baseBody = projectile.body;
						tP_MartialWhip1_Weapon2 = (TP_MartialWhip1_Weapon)(tP_MartialWhip1_Weapon2 + 1);
						baseBody._enable = false;
						nodeProjectiles = _nodeProjectiles;
						tP_MartialWhip1_Weapon3 = tP_MartialWhip1_Weapon2;
					}
					if (_lineTween != null)
					{
						_lineTween.Kill();
	...
	private void ApplyManualNodeControl()
	{
		...
		float num = num2;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (VampireSurvivors.Objects.Projectiles.TP_MartialWhip1_Projectile)+100]");
		float num3 = num + 0f;
	...
	public TP_MartialWhip1_Projectile()
	{
