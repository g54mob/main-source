...
public class TP_SinistroCustos_Projectile : TP_Custos_Projectile
{
	...
	public override void InitProjectile(BulletPool pool, Weapon weapon, int index)
	{
		...
		if (_003C_003Ec._003C_003E9__3_0 == null)
		{
			match = (_003C_003Ec._003C_003E9__3_0 = delegate(Equipment x)
			{
				...
				object obj4 = x._equipmentType - 1438;
				return obj4 == null;
			});
		}
		...
		nint num4 = (nint)typeof(TP_SinistroCustos_Weapon);
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v351 @ rdx_v18 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_SinistroCustos_Weapon>)+130]");
		object obj = 0;
		...
		if (num5 >= 0)
		{
			...
			if (0 == (nint)typeof(TP_SinistroCustos_Weapon))
			{
				obj3 = 1;
				goto IL_02aa;
			}
		...
		goto IL_02aa;
		IL_029b:
		_baseWeapon = (TP_SinistroCustos_Weapon)flag;
		TP_SinistroCustos_Weapon baseWeapon = _baseWeapon;
	...
	public override void InternalUpdate()
	{
		...
		if ((object)_baseWeapon != null && ((UnityEngine.Object)baseWeapon).m_CachedPtr != (IntPtr)0)
		{
			...
			float yOffsetFinal = _baseWeapon.YOffsetFinal;
	...
	public override void Bite()
	{
		...
		Projectile projectile = _custosWeapon.AddIceExplosionAt(pos);
