...
public class EME_BloodProjectile_ScarletHarbinger : EME_BloodProjectile
{
	public override void OnTargetHit()
	{
		...
		if ((object)eME_Blood1Weapon != null)
		{
			...
			eME_Blood1Weapon.SpawnSpecialProjectiles(float5, eME_Blood1Weapon._scarletPool, 1f, areaMul);
		}
	}
}
