...
public class ProjectileFactory : SerializedScriptableObject, IValidateReferences
{
	...
	public unsafe Projectile GetProjectilePrefab(WeaponType weaponType)
	{
		...
		if (!flag)
		{
			List<ProjectileFactory>.Enumerator enumerator = default(List<ProjectileFactory>.Enumerator);
			...
			if (!flag2)
			{
				...
				while (enumerator2.MoveNext())
				{
					...
					if (!flag3)
					{
						Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v916 @ stack_-68+68]");
						object obj3 = 0;
						Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v916 @ stack_-68+68]");
						if ((nint)0 == 0)
						{
								...
								if (!flag6)
								{
									...
									if (!flag6)
									{
										...
										if (!flag7)
										{
											...
											{
												Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v448 @ rax_v52+58]");
												return (Projectile)((Dictionary<System.Int32Enum, object>)0).get_Item((System.Int32Enum)weaponType);
											}
				...
				bool flag8 = _Projectiles == null;
				dictionary = (Dictionary<System.Int32Enum, object>)(object)_Projectiles;
				if (!flag8)
				{
					int num2 = ((Dictionary<System.Int32Enum, object>)(object)_Projectiles).FindEntry((System.Int32Enum)weaponType);
					if (num2 < 0)
					{
						return null;
					}
					...
					{
						return (Projectile)((Dictionary<System.Int32Enum, object>)(object)_Projectiles).get_Item((System.Int32Enum)weaponType);
					}
				}
			}
		}
	...
	public unsafe List<string> ValidateReferences()
	{
		...
		if (_Projectiles != null)
		{
			Dictionary<WeaponType, Projectile>.Enumerator enumerator = default(Dictionary<WeaponType, Projectile>.Enumerator);
			...
			{
				List<ProjectileFactory>.Enumerator enumerator2 = default(List<ProjectileFactory>.Enumerator);
				while (enumerator2.MoveNext())
				{
	...
	{
		ProjectilesDictionary projectiles = (ProjectilesDictionary)(object)new UnitySerializedDictionary<System.Int32Enum, object>();
