...
public class AppAchievementsState : AppStateMachineState
{
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A4276]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A4277]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A4278]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
