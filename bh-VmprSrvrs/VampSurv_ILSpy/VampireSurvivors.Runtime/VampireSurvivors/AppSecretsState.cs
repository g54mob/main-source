...
public class AppSecretsState : AppStateMachineState
{
	...
	public override void OnEnter()
	{
		...
		object obj = null;
		Action<object> action2 = ((SignalBus._003C_003Ec__DisplayClass35_0<UISignals.LaunchGameplaySignal>)obj)._003CSubscribeId_003Eb__0;
		((SignalBus._003C_003Ec__DisplayClass35_0<UISignals.LaunchGameplaySignal>)0)._003CSubscribeId_003Eb__0((object)1);
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A42DB]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
		MultiplayerManager.s_instance.EnsurePlayableCharacters();
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A42DC]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
