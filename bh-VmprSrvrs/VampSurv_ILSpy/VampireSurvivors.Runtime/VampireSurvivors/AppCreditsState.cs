...
public class AppCreditsState : AppStateMachineState
{
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A4288]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A4289]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A428A]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
