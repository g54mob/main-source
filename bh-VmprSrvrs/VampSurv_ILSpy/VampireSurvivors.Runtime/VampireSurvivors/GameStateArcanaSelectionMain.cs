...
public class GameStateArcanaSelectionMain : GameStateMachineState
{
	private sealed class _003CWaitDelay_003Ed__4(int _003C_003E1__state) : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		public GameStateArcanaSelectionMain _003C_003E4__this;
				...
				if ((object)_003C_003E4__this != null)
				{
					...
					if ((nint)0 != 0)
					{
						...
						if ((nint)0 != 0)
						{
							...
							if ((nint)0 != 0)
							{
								Action<UISignals.ArcanaSelectedSignal> action = null;
								Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180AA87D0");
								...
								if ((nint)0 != 0)
								{
									...
									if (obj4 != null)
									{
										Action<object> action2 = ((SignalBus._003C_003Ec__DisplayClass37_0<UISignals.ArcanaSelectedSignal>)obj4)._003CSubscribeId_003Eb__0;
										((SignalBus._003C_003Ec__DisplayClass37_0<UISignals.ArcanaSelectedSignal>)0)._003CSubscribeId_003Eb__0((object)1);
										...
										if ((nint)0 != 0)
										{
											...
											if ((nint)0 != 0)
											{
												...
												if (obj8 != null)
												{
													Action<object> action4 = ((SignalBus._003C_003Ec__DisplayClass35_0<UISignals.ArcanaSkippedSignal>)obj8)._003CSubscribeId_003Eb__0;
													((SignalBus._003C_003Ec__DisplayClass35_0<UISignals.ArcanaSkippedSignal>)0)._003CSubscribeId_003Eb__0((object)1);
													...
													if ((nint)0 != 0)
													{
														...
														((GameStateArcanaSelectionMain)(object)action5).OnConnectionError((GameplaySignals.ConnectionErrorSignal)_003C_003E4__this);
														Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v318 @ rbx_v12+60]");
														if ((nint)0 != 0)
														{
															Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v318 @ rbx_v12+60]");
															((GameStateArcanaSelectionMain)0).OnConnectionError((GameplaySignals.ConnectionErrorSignal)action5);
															Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v35 @ rdi_v1 (System.Object)+28]");
															object obj12 = 0;
															Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v35 @ rdi_v1 (System.Object)+28]");
															if ((nint)0 != 0)
	...
	public override void OnExit()
	{
		...
		Action<UISignals.ArcanaSelectedSignal> token = null;
		Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180AA87D0");
		...
		((GameStateArcanaSelectionMain)(object)action).OnConnectionError((GameplaySignals.ConnectionErrorSignal)this);
		((GameStateArcanaSelectionMain)(object)gameStateMachine3.SignalBus).OnConnectionError((GameplaySignals.ConnectionErrorSignal)action);
	...
	private void AddArcana(UISignals.ArcanaSelectedSignal sig)
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v73 @ rcx_v6 (System.Collections.Generic.List`1<System.Int32Enum>)+1C]");
		_ = (nint)0 + (nint)1;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v73 @ rcx_v6 (System.Collections.Generic.List`1<System.Int32Enum>)+10]");
		object obj = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v73 @ rcx_v6 (System.Collections.Generic.List`1<System.Int32Enum>)+18]");
		nint num = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v63 @ r8_v3+18]");
		if (num >= 0)
		{
		...
		gameManager2._arcanaManager.TriggerArcana((ArcanaType)sig);
	...
	private void Skip()
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A42FC]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A42FE]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	public GameStateArcanaSelectionMain()
	{
