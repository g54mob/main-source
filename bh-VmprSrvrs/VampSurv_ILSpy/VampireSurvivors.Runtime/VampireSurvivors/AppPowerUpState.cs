...
public class AppPowerUpState : AppStateMachineState
{
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A42D6]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A42D7]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A42D8]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
