...
public class CharSelectionCheatCodeManager : CheatCodeManager
{
	...
	private void Tflag()
	{
		Debug.Log("Character selection cheat completed!");
		if ((int)GameManager.Tflag > 0)
		{
			uint tflag = GameManager.Tflag + 2;
