...
public class Clover : Pickup
{
	...
	public unsafe override void GetTaken()
	{
		...
		if (!base._003CDisableGet_003Ek__BackingField)
		{
			...
			core._gizmoManager.DisplayIconOverhead("Clover", "10", (Color?)(object)(&obj), characterController, displayTimeMultiplier, vOffset, textureName);
