...
public class Pickup_TP_HeartRefresh : NetworkPickup
{
	...
	protected virtual void OnRecycle()
	{
		...
		int num = default(int);
		List<Sprite> animationFrames = SpriteManager.GetAnimationFrames("TP_HEART_REFRESH", 1, 3, _textureName, num);
	...
	public override void GetTaken()
	{
		...
		if (!((Pickup)this)._003CDisableGet_003Ek__BackingField)
		{
			...
			targetPlayer._classSupport.AddActiveHeartRefresh(5f, 0f, 10000f);
