...
public class ExplosionStar2 : PoolableMonoBehaviour
{
	...
	public unsafe void Init(float damage, float radius)
	{
		...
		//IL_0f36: Expected O, but got F4
		//IL_03a1: Expected F4, but got I4
		//IL_03f4: Expected O, but got I8
		//IL_0f74: Expected I, but got O
		...
		//IL_04fe: Expected F4, but got I
		//IL_067e: Expected O, but got I4
		//IL_06ad: Expected F4, but got I4
		//IL_06b6: Expected O, but got I4
		//IL_073d: Expected I4, but got I8
		...
		//IL_0cc5->IL0bd1: Incompatible stack heights: 1 vs 0
		//IL_0114->IL0bd1: Incompatible stack heights: 1 vs 0
		//IL_047b->IL047b: Incompatible stack heights: 21 vs 20
		//IL_0507->IL0507: Incompatible stack heights: 22 vs 21
						...
						if ((object)_GroundWarning != null)
						{
							...
							if ((object)_GroundWarning != null)
							{
								...
								if ((object)transform != null)
								{
									...
									Sprite sprite2 = SpriteManager.GetSprite("Star_0", vector, "vfx");
									...
									SpriteRenderer spriteRenderer3 = RenderingExtensions.SetTint(_StarSprite, 16711680u);
									...
									List<Sprite> animationFrames = SpriteManager.GetAnimationFrames("Star_", 0, 18, "vfx", num6);
									...
									Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v2877 @ rcx_v129 (Il2CppClass<UnityEngine.Vector3>)+B8]");
									nint num8 = 0;
									_ = Vector3.oneVector;
									Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v2880 @ rax_v144 (Il2CppStaticFields<UnityEngine.Vector3>)+14]");
									_ = 0;
									...
									Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v2930 @ rcx_v136 (Il2CppClass<UnityEngine.Vector3>)+B8]");
									nint num10 = 0;
									_ = Vector3.zeroVector;
									Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v2933 @ rax_v152 (Il2CppStaticFields<UnityEngine.Vector3>)+8]");
									_ = 0;
									...
									((ExplosionStar2)(object)dOSetter)._003CInit_003Eb__35_1(_003CRadius_003Ek__BackingField);
									...
									{
										//IL_00c0->IL0073: Incompatible stack heights: 1 vs 0
									...
									if (tweenerCore != null)
									{
										Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v3372 @ rax_v182 (DG.Tweening.Core.TweenerCore`3<System.Single, System.Single, DG.Tweening.Plugins.Options.FloatOptions>)+E8]");
										if ((nint)0 != 0)
										{
											...
											if ((nint)0 != 0)
											{
												...
												do
												{
													...
													Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1114 @ r14_v21+462E0+v3431 @ rdx_v133*8]");
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1405 @ rax_v191 (UnityEngine.Bounds)+10]");
		_ = 0;
		...
		_ = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v2676 @ rax_v192 (UnityEngine.Transform)+10]");
	...
	{
		//IL_023c->IL01b2: Incompatible stack heights: 1 vs 0
		//IL_00e4->IL01b2: Incompatible stack heights: 2 vs 0
		//IL_0142->IL01b2: Incompatible stack heights: 2 vs 0
	...
	private void AssignRandomColor()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v35 @ rax_v2 (System.Collections.Generic.List`1<System.UInt32>)+18]");
		nint num3 = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v230 @ rdx_v9 (System.UInt32)+18]");
		if (num3 >= 0)
		{
			list.AddWithResize(10027520u);
			item = 10027520u;
		}
		else
		{
	...
	{
		//IL_0042->IL00ab: Incompatible stack heights: 1 vs 0
		Transform transform = base.transform;
		if ((object)transform != null)
		{
			bool flag = ((UnityEngine.Object)transform).m_CachedPtr == (IntPtr)0;
			...
			TrailRenderer trailRenderer = RenderingExtensions.SetScale(_Trail, -1f, 1f);
			if ((object)_Trail != null)
			{
	...
	private unsafe void GenerateParticleSystems()
	{
		...
		//IL_0402: Expected native int or pointer, but got O
		...
		//IL_0694: Expected native int or pointer, but got O
		//IL_06ae: Expected O, but got I
		//IL_06ce: Expected O, but got Ref
		//IL_06e8: Expected native int or pointer, but got O
		...
		//IL_0a40->IL08dd: Incompatible stack heights: 2 vs 0
		object obj2 = default(object);
		...
		if ((object)_particlesManager == null || ((UnityEngine.Object)particlesManager).m_CachedPtr == (IntPtr)0)
		{
			...
			_ = 0;
			ParticleEmitterManager particlesManager2;
			if (gameObject.TryGetComponent<ParticleEmitterManager>(out System.Runtime.CompilerServices.Unsafe.As<object, ParticleEmitterManager>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref obj2, 400))))
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v6 @ rbp_v1+190]");
				particlesManager2 = (ParticleEmitterManager)0;
			}
			else
			{
				particlesManager2 = gameObject.AddComponent<ParticleEmitterManager>();
			}
			...
			{
				((List<object>)(object)list).AddWithResize((object)"Star_0");
			}
			else
			{
			...
			{
				((List<object>)(object)list).AddWithResize((object)"Star_2");
			}
			else
			{
			...
			{
				((List<object>)(object)list2).AddWithResize((object)"_blur");
			}
			else
			{
