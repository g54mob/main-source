...
public class ExplosionStar : PoolableMonoBehaviour
{
						...
						if ((object)_GroundWarning != null)
						{
							...
							if ((object)_GroundWarning != null)
							{
								...
								if ((object)transform != null)
								{
									...
									((ExplosionStar)(object)dOSetter)._003CInit_003Eb__35_1(_003CRadius_003Ek__BackingField);
	...
	private unsafe void GenerateParticleSystems()
	{
		...
		//IL_062a: Expected native int or pointer, but got O
		//IL_0644: Expected O, but got I
		//IL_0664: Expected O, but got Ref
		//IL_067e: Expected native int or pointer, but got O
		...
		{
			((List<object>)(object)list2).AddWithResize((object)"HitCloud2");
		}
		else
		{
