...
public class AccountErrorPopup : BasePopup
{
	...
	private sealed class _003CWaitAndSelect_003Ed__9(int _003C_003E1__state) : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		private bool MoveNext()
		{
			...
			AccountErrorPopup accountErrorPopup = _003C_003E4__this;
			...
			if (_003C_003E1__state == 1)
			{
				...
				{
					accountErrorPopup._previouslySelected = current.m_CurrentSelected;
					if ((object)accountErrorPopup._OkButton != null)
					{
						Selectable componentInChildren = accountErrorPopup._OkButton.GetComponentInChildren<Selectable>();
	...
	public void Initialize(PopupManager manager, string id, string title, string description, string helpText, Action callback, bool titleIsLocalizationTerm = true, bool descriptionIsLocalizationTerm = true, bool helpTextIsLocalizationTerm = true)
	{
		...
		_003C_003Ec__DisplayClass8_0 CS_0024_003C_003E8__locals10 = new _003C_003Ec__DisplayClass8_0();
		CS_0024_003C_003E8__locals10._003C_003E4__this = this;
		CS_0024_003C_003E8__locals10.id = id;
		Action callback2 = default(Action);
		CS_0024_003C_003E8__locals10.callback = callback2;
		_manager = manager;
		_ID = CS_0024_003C_003E8__locals10.id;
		...
		if (obj2 != null)
		{
			string translation2 = LocalizationManager.GetTranslation((string)helpTextIsLocalizationTerm, FixForRTL: true, 0, ignoreRTLnumbers: true, applyParameters, localParametersRoot, overrideLanguage, allowLocalizedParameters);
			text2 = translation2;
		}
		else
		{
			text2 = (string)helpTextIsLocalizationTerm;
		}
		...
		if (obj3 != null)
		{
			string translation3 = LocalizationManager.GetTranslation((string)(nint)intPtr, FixForRTL: true, 0, ignoreRTLnumbers: true, applyParameters, localParametersRoot, overrideLanguage, allowLocalizedParameters);
			num = (nint)translation3;
		}
		else
		{
			num = intPtr;
		...
		_HelpText.text = (string)num;
		_HelpButtonText.text = "https://poncle.games/account-help";
		Button okButton = _OkButton;
		UnityAction call = delegate
		{
			CS_0024_003C_003E8__locals10._003C_003E4__this.Hide();
			PopupManager.ClosePopup(CS_0024_003C_003E8__locals10.id);
			Action callback3 = CS_0024_003C_003E8__locals10.callback;
			if (CS_0024_003C_003E8__locals10.callback != null)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Indirect call: v28.invoke_impl (System.IntPtr) (should have been resolved before IL gen)");
			}
		};
