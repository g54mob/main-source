	...
	protected override void Apply()
	{
		...
		if (_playerOptions != null)
		{
			...
			if (playerOptions._003CIsInitialized_003Ek__BackingField && _IsPortrait)
			{
				...
				bool flag2 = config2.HasCollectedItem(ItemType.RELIC_TRISECTION);
				if (flag)
				{
					...
					if (!flag2)
					{
						_ShouldForceRectTransformSize = flag2;
					...
					else
					{
						...
						_ = 1121020805;
						_RelativeAnchorPosition = (Vector2)1053369489;
		...
		if (_IsPortrait)
		{
			...
			if (config3.HasCollectedItem(ItemType.RELIC_BANGER))
			{
				return;
			}
		}
