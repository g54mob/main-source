...
public class GameStateCharacterFound : GameStateMachineState
{
	public override void OnEnter()
	{
		...
		Action<UISignals.CharacterCollectedSignal> action = null;
		Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180AB21C0");
		nint num = 0;
		...
		object obj = null;
		Action<object> action2 = ((SignalBus._003C_003Ec__DisplayClass37_0<UISignals.CharacterCollectedSignal>)obj)._003CSubscribeId_003Eb__0;
		((SignalBus._003C_003Ec__DisplayClass37_0<UISignals.CharacterCollectedSignal>)0)._003CSubscribeId_003Eb__0((object)1);
		...
		((GameStateCharacterFound)(object)action3).OnConnectionError((GameplaySignals.ConnectionErrorSignal)this);
		((GameStateCharacterFound)(object)gameStateMachine2.SignalBus).OnConnectionError((GameplaySignals.ConnectionErrorSignal)action3);
	...
	public override void OnExit()
	{
		...
		GameStateMachine gameStateMachine = _gameStateMachine;
		Action<UISignals.CharacterCollectedSignal> token = null;
		Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180AB21C0");
		...
		((GameStateCharacterFound)(object)action).OnConnectionError((GameplaySignals.ConnectionErrorSignal)this);
		((GameStateCharacterFound)(object)gameStateMachine2.SignalBus).OnConnectionError((GameplaySignals.ConnectionErrorSignal)action);
		GameStateMachine gameStateMachine3 = _gameStateMachine;
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A5D5D]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A5D5E]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	public GameStateCharacterFound()
	{
