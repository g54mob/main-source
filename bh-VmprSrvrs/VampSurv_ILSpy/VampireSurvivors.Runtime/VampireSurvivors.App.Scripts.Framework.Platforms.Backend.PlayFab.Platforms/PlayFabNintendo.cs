...
public class PlayFabNintendo : IPlatform, IPlatformAuthentication
{
	private sealed class _003C_003Ec__DisplayClass3_0
	{
		...
		internal void _003CLoginOrRegisterInternal_003Eb__0(PlatformAuthToken authToken)
		{
			...
			LoginWithNintendoServiceAccountRequest loginWithNintendoServiceAccountRequest = new LoginWithNintendoServiceAccountRequest();
			loginWithNintendoServiceAccountRequest.CreateAccount = (bool?)(object)1;
			loginWithNintendoServiceAccountRequest.IdentityToken = authToken._003CToken_003Ek__BackingField;
			Dictionary<string, string> customTags = PlayFabUtils.GetCustomTags();
			loginWithNintendoServiceAccountRequest.CustomTags = customTags;
			...
			if (_003C_003E9__3 == null)
			{
				...
				{
					Debug.Log("PlayFab: Successfully logged in with Nintendo Service Account");
			...
			if (_003C_003E9__4 == null)
			{
				...
				{
					Debug.LogWarning("PlayFab: Encountered error whilst trying to log in with Nintendo Service Account");
			...
			if (loginWithNintendoServiceAccountRequest.AuthenticationContext == null)
			{
			}
			string titleId = loginWithNintendoServiceAccountRequest.TitleId;
			if (loginWithNintendoServiceAccountRequest.TitleId == null)
			{
				titleId = PlayFabSettings.staticSettings.TitleId;
			}
			loginWithNintendoServiceAccountRequest.TitleId = titleId;
	...
	private sealed class _003C_003Ec__DisplayClass4_0
	{
		...
		{
			//IL_0013: Expected O, but got I4
			LinkNintendoServiceAccountRequest linkNintendoServiceAccountRequest = new LinkNintendoServiceAccountRequest();
			linkNintendoServiceAccountRequest.ForceLink = (bool?)(object)1;
			linkNintendoServiceAccountRequest.IdentityToken = authToken._003CToken_003Ek__BackingField;
			Dictionary<string, string> customTags = PlayFabUtils.GetCustomTags();
			linkNintendoServiceAccountRequest.CustomTags = customTags;
			Action<EmptyResult> action = _003C_003E9__3;
			if (_003C_003E9__3 == null)
			{
				action = (_003C_003E9__3 = delegate
				{
					Debug.Log("PlayFab: Successfully linked Nintendo Service Account");
			...
			if (_003C_003E9__4 == null)
			{
				action2 = (_003C_003E9__4 = delegate(PlayFabError error)
				{
					Debug.LogWarning("PlayFab: Encountered error whilst trying to link Nintendo Service Account");
					string message = error.GenerateErrorReport();
					Debug.LogWarning(message);
					TaskCompletionSource<ILinkResult> taskCompletionSource = t;
			...
			PlayFabAuthenticationContext playFabAuthenticationContext = linkNintendoServiceAccountRequest.AuthenticationContext;
			if (linkNintendoServiceAccountRequest.AuthenticationContext == null)
			{
	...
	private sealed class _003C_003Ec__DisplayClass5_0
	{
		...
		{
			Debug.Log("PlayFab: Successfully unlinked Nintendo Service Account");
		...
		internal void _003CUnlinkAccount_003Eb__1(PlayFabError error)
		{
			...
			Debug.LogWarning("PlayFab: Encountered error whilst trying to unlink Nintendo Service Account");
			string message = error.GenerateErrorReport();
			Debug.LogWarning(message);
			TaskCompletionSource<bool> taskCompletionSource = t;
			PlayFabApiException ex = PlayFabApiException.FromPlayFabError(error);
	...
	{
		return PlatformType.NINTENDO_SWITCH;
	}
	...
	private unsafe Task<ILoginResult> LoginOrRegisterInternal(bool createAccount = false)
	{
	...
	public Task<bool> UnlinkAccount()
	{
		...
		UnlinkNintendoServiceAccountRequest unlinkNintendoServiceAccountRequest = new UnlinkNintendoServiceAccountRequest();
		Dictionary<string, string> customTags = PlayFabUtils.GetCustomTags();
		unlinkNintendoServiceAccountRequest.CustomTags = customTags;
		...
		PlayFabAuthenticationContext playFabAuthenticationContext = unlinkNintendoServiceAccountRequest.AuthenticationContext;
		if (unlinkNintendoServiceAccountRequest.AuthenticationContext == null)
		{
			playFabAuthenticationContext = PlayFabSettings.staticPlayer;
		}
		string clientSessionTicket = playFabAuthenticationContext.ClientSessionTicket;
