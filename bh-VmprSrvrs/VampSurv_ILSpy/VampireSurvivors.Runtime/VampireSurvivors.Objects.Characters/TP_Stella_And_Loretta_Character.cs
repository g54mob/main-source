...
public class TP_Stella_And_Loretta_Character : TP_Character
{
	...
	protected override void OnUpdate()
	{
		...
		if (_spawnFollowerNextFrame)
		{
			...
			CharacterController characterController = GM.Core.AddFollower(CharacterType.TP_LORETTA, this, AIType.Defensive, manualLevelups, everyXLevels, spawnWithoutAuthority);
