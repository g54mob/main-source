...
public class TP_Charlotte_And_Jonhathan_Character : TP_Charlotte_Character
{
	...
	protected override void OnUpdate()
	{
		...
		if (_spawnFollowerNextFrame)
		{
			...
			CharacterController characterController = GM.Core.AddFollower(CharacterType.TP_JONATHAN, this, AIType.Defensive, manualLevelups, everyXLevels, spawnWithoutAuthority);
