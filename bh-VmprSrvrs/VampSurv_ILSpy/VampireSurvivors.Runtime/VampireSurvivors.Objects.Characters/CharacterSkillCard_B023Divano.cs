...
public class CharacterSkillCard_B023Divano : CharacterSkillCard_Base
{
	public override ArcanaType GalaType => ArcanaType.SUB_SKIP_ROSARY;

	public CharacterSkillCard_B023Divano(ArcanaType type)
		: base(type)
	{
		Rarity = 2;
		...
		{
			_003CArmor_003Ek__BackingField = 1f
		...
		{
			_003CCurse_003Ek__BackingField = 0.2f,
			_003CLuck_003Ek__BackingField = 0.2f
		};
		AddSubCard(ArcanaType.SUB_XLEVEL_BANISH1);
	}
}
