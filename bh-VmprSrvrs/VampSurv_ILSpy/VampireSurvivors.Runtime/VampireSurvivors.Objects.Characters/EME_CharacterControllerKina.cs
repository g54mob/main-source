...
public class EME_CharacterControllerKina : EME_CharacterControllerShowstopper
{
	...
	protected unsafe override void OnShowStopperStarted()
	{
		...
		if (_MaxBonus > _ShowstopperStatBonus)
		{
			...
			core._gizmoManager.DisplayWeaponIconOverhead(WeaponType.REGEN, value2, (Color?)(object)(&obj2), character, displayTimeMultiplier, vOffset);
		}
	}
	...
	private void CheckHiddenWeaponLevelUp(WeaponType weaponType)
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp near ptr 0000000187653D7Ah\"");
	...
	public EME_CharacterControllerKina()
	{
