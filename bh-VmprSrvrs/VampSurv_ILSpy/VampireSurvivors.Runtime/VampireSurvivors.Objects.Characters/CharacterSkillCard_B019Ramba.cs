...
public class CharacterSkillCard_B019Ramba : CharacterSkillCard_Base
{
	public override ArcanaType GalaType => ArcanaType.SUB_ADDWEAPON_CART2EVO;

	public CharacterSkillCard_B019Ramba(ArcanaType type)
		: base(type)
	{
