...
public class CharacterSkillCard_A002EndlessScroll : CharacterSkillCard_Base
{
	public CharacterSkillCard_A002EndlessScroll(ArcanaType type)
		: base(type)
	{
		...
		float num2 = num * -0.2f;
		float num3 = num * -0.5f;
		modifierStats._003CCooldown_003Ek__BackingField = num2;
		modifierStats._003CArea_003Ek__BackingField = num3;
