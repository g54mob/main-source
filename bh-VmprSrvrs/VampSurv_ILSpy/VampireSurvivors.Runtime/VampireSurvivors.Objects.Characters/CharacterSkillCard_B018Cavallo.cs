...
public class CharacterSkillCard_B018Cavallo : CharacterSkillCard_Base
{
	public override ArcanaType GalaType => ArcanaType.SUB_ADDWEAPON_CHERRY2;

	public CharacterSkillCard_B018Cavallo(ArcanaType type)
		: base(type)
	{
