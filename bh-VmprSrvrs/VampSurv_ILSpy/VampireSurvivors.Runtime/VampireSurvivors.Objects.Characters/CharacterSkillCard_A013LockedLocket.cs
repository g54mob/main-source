...
public class CharacterSkillCard_A013LockedLocket : CharacterSkillCard_Base
{
	public CharacterSkillCard_A013LockedLocket(ArcanaType type)
		: base(type)
	{
		...
		float num2 = num * 0.5f;
		float num3 = num * -0.3f;
		modifierStats._003CGreed_003Ek__BackingField = num2;
		modifierStats._003CGrowth_003Ek__BackingField = num3;
