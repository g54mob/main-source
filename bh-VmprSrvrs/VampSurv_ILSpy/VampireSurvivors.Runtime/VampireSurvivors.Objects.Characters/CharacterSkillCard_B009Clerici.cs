...
public class CharacterSkillCard_B009Clerici : CharacterSkillCard_Base
{
	public override ArcanaType GalaType => ArcanaType.SUB_OVERHEAL_ICEBREATH;

	public CharacterSkillCard_B009Clerici(ArcanaType type)
		: base(type)
	{
		Rarity = 3;
		...
		{
			_003CMoveSpeed_003Ek__BackingField = 0.1f
		...
		{
			_003CArea_003Ek__BackingField = -1f
		}, System.Collections.Generic.InsertionBehavior.ThrowOnExisting);
		...
		{
			_003CRegen_003Ek__BackingField = 0.4f,
			_003CArea_003Ek__BackingField = 4f
		};
	}
}
