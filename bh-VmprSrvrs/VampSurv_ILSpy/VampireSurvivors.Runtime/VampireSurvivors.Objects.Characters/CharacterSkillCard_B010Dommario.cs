...
public class CharacterSkillCard_B010Dommario : CharacterSkillCard_Base
{
	public override ArcanaType GalaType => ArcanaType.SUB_GOLDCOUNT_THORNSUP;

	public CharacterSkillCard_B010Dommario(ArcanaType type)
		: base(type)
	{
		...
		{
			_003CGreed_003Ek__BackingField = 0.1f
		...
		InitialBonus = new ModifierStats
		{
			...
			_003CSpeed_003Ek__BackingField = 0.3f,
