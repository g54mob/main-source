...
public class TP_Christopher_Character : TP_Character
{
						...
						if (playerStats._003CPower_003Ek__BackingField != null)
						{
							...
							if (eggFloat2 != null)
							{
								...
								if ((nint)obj2 != 2139095040)
								{
									...
									{
										Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 0000000187625C15h\"");
										if (num5 == -1f / 0f)
										{
											num5 = -3.4028235E+38f;
										}
					...
					if (_playerStats != null)
					{
						...
						if (playerStats._003CArmor_003Ek__BackingField != null)
						{
							...
							if ((nint)obj2 != 2139095040)
							{
								...
								if ((nint)obj3 <= 2139095040)
								{
									Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 0000000187625D67h\"");
									if (num4 == -1f / 0f)
									{
										num4 = -3.4028235E+38f;
									}
