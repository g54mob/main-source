...
public class CharacterSkillCard_B022Gallo : CharacterSkillCard_Base
{
	public override ArcanaType GalaType => ArcanaType.SUB_SKIP_TIMEFREEZE;

	public CharacterSkillCard_B022Gallo(ArcanaType type)
		: base(type)
	{
		Rarity = 2;
		...
		{
			_003CGreed_003Ek__BackingField = 0.2f,
			_003CGrowth_003Ek__BackingField = 0.2f
		};
		AddSubCard(ArcanaType.SUB_XLEVEL_REROLL1);
	}
}
