...
public class CharacterSkillCard_A006WhiteCandy : CharacterSkillCard_Base
{
	public CharacterSkillCard_A006WhiteCandy(ArcanaType type)
		: base(type)
	{
		...
		float num2 = num * 200f;
		float num3 = num * -0.5f;
		modifierStats._003CMaxHp_003Ek__BackingField = num2;
		modifierStats._003CRegen_003Ek__BackingField = num3;
