...
public class TP_Isaac_Character : CharacterController
{
	...
	public override void LevelUp()
	{
		...
		if (base._level == 10)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v43 @ rax_v20 (System.Collections.Generic.List`1<VampireSurvivors.Data.CharacterType>)+18]");
			if ((nint)0 > (nint)0)
			{
				AddRandomFollower();
			}
		...
		if (base._level == 20)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v102 @ rax_v18 (System.Collections.Generic.List`1<VampireSurvivors.Data.CharacterType>)+18]");
			if ((nint)0 > (nint)0)
			{
				AddRandomFollower();
			}
		...
		if (base._level == 30)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v103 @ rax_v16 (System.Collections.Generic.List`1<VampireSurvivors.Data.CharacterType>)+18]");
			if ((nint)0 > (nint)0)
			{
				AddRandomFollower();
			}
		...
		if (base._level == 40)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v104 @ rax_v14 (System.Collections.Generic.List`1<VampireSurvivors.Data.CharacterType>)+18]");
			if ((nint)0 > (nint)0)
			{
				AddRandomFollower();
			}
		...
		if (base._level == 50)
		{
			List<CharacterType> list5 = possibleFollowers;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v105 @ rax_v12 (System.Collections.Generic.List`1<VampireSurvivors.Data.CharacterType>)+18]");
			if ((nint)0 > (nint)0)
			{
				AddRandomFollower();
			}
		...
		if (base._level == 60)
		{
			List<CharacterType> list6 = possibleFollowers;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v106 @ rax_v11 (System.Collections.Generic.List`1<VampireSurvivors.Data.CharacterType>)+18]");
			if ((nint)0 > (nint)0)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 271 Invalid \"Jump target not found in method: 0x187634C30\"");
			}
		}
	}
	...
	private void AddRandomFollower()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 57 Invalid \"Jump target not found in method: 0x187634F36\"");
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 72 Invalid \"Jump target not found in method: 0x187634F36\"");
		...
		object obj = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 87 Invalid \"Jump target not found in method: 0x187634F36\"");
		...
		else
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 121 Invalid \"Jump target not found in method: 0x187634F3C\"");
		}
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 170 Invalid \"Jump target not found in method: 0x187634E35\"");
	}

	public TP_Isaac_Character()
	{
