...
public class CharacterSkillCard_A018PureDove : CharacterSkillCard_Base
{
	public CharacterSkillCard_A018PureDove(ArcanaType type)
	{
		//IL_0025: Expected I4, but got I8
		base._002Ector(type);
		InitialBonus = new ModifierStats
		{
			_003CFever_003Ek__BackingField = -0.3f,
