...
public class CharacterSkillCard_A003HeadCandle : CharacterSkillCard_Base
{
	public CharacterSkillCard_A003HeadCandle(ArcanaType type)
		: base(type)
	{
		...
		modifierStats._003CPower_003Ek__BackingField = num3;
