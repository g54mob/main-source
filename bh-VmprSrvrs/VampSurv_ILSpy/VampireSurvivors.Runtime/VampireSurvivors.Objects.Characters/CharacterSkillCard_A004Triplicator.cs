...
public class CharacterSkillCard_A004Triplicator : CharacterSkillCard_Base
{
	public CharacterSkillCard_A004Triplicator(ArcanaType type)
		: base(type)
	{
		...
		float num2 = num * 3f;
		float num3 = num * 0.6f;
		modifierStats._003CAmount_003Ek__BackingField = num2;
		modifierStats._003CCooldown_003Ek__BackingField = num3;
