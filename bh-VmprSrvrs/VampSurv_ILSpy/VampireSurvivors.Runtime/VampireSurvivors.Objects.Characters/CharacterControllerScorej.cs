...
public class CharacterControllerScorej : CharacterController
{
	...
	public override void LevelUp()
	{
		...
		CharacterController characterController = (CharacterController)base._level;
		WeaponsFacade weaponsFacade = (WeaponsFacade)(base._level & 0x80000007L);
		...
		if (!flag5)
		{
			float num3 = (float)base._level / 12f;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180B6F7E8");
			float num4 = num3 + 1f;
			object obj10 = 0;
			object obj11 = 0;
