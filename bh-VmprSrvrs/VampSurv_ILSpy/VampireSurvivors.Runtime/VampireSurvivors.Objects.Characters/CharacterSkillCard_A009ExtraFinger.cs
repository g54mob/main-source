...
public class CharacterSkillCard_A009ExtraFinger : CharacterSkillCard_Base
{
	public CharacterSkillCard_A009ExtraFinger(ArcanaType type)
		: base(type)
	{
		...
		float num2 = num * 0.5f;
		float num3 = num * -0.3f;
		modifierStats._003CSpeed_003Ek__BackingField = num2;
		modifierStats._003CDuration_003Ek__BackingField = num3;
