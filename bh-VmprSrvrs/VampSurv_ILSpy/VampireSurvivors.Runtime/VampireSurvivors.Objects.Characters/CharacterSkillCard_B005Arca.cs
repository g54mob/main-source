...
public class CharacterSkillCard_B005Arca : CharacterSkillCard_Base
{
	public override ArcanaType GalaType => ArcanaType.SUB_HPCRITICAL_FIREBREATH;

	public CharacterSkillCard_B005Arca(ArcanaType type)
		: base(type)
	{
		...
		{
			_003CCooldown_003Ek__BackingField = -0.05f
