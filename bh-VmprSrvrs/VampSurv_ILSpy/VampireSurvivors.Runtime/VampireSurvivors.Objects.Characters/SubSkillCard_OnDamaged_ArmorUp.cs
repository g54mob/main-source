...
public class SubSkillCard_OnDamaged_ArmorUp(ArcanaType type) : CharacterSkillCard_Base(type)
{
	private float armorDelay = 10000f;

	private float currentBonusStacks;

	public override void OnOwnerGetDamaged(float damageAmount)
	{
		if (currentBonusStacks < 50f)
		{
