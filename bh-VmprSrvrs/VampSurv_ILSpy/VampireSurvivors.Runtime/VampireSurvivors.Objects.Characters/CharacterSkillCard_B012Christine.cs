...
public class CharacterSkillCard_B012Christine : CharacterSkillCard_Base
{
	public override ArcanaType GalaType => ArcanaType.SUB_PASSIVE_DEFANGUP;

	public CharacterSkillCard_B012Christine(ArcanaType type)
		: base(type)
	{
		Rarity = 2;
		...
		{
			_003CLuck_003Ek__BackingField = 0.1f
		...
		InitialBonus = new ModifierStats
		{
			...
			_003CCooldown_003Ek__BackingField = -0.1f
		};
		AddSubCard(ArcanaType.SUB_XLEVEL_SKIP1);
	}
}
