...
public class CharacterSkillCard_B001Antonio : CharacterSkillCard_Base
{
	public override ArcanaType GalaType => ArcanaType.SUB_XLEVEL_MAXHP5;

	public CharacterSkillCard_B001Antonio(ArcanaType type)
		: base(type)
	{
		...
		{
			_003CPower_003Ek__BackingField = 0.1f
		...
		{
			_003CMaxHp_003Ek__BackingField = 80f
		};
		AvailableSlots = 3;
	}
}
