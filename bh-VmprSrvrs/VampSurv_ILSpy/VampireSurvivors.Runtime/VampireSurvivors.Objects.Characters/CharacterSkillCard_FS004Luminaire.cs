...
public class CharacterSkillCard_FS004Luminaire : CharacterSkillCard_Base
{
	...
	public override void InitialActivate()
	{
		...
		float num = LinkedCharacter.PMoveSpeed();
		float originalMoveSpeed = default(float);
		_originalMoveSpeed = originalMoveSpeed;
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 28 Invalid \"Jump target not found in method: 0x187572D80\"");
		throw new NullReferenceException();
	}

	public unsafe void SetupGraphics()
	{
		...
		do
		{
			...
			string name = string.FormatHelper((IFormatProvider)null, "Doilie_{0}", (System.ParamsArray)(&obj));
	...
	public unsafe override void OnOwnerRevived(float percentage = 1f, bool instantRevival = false)
	{
		...
		_morphVFX.PlaySparkle(LinkedCharacter);
		...
		LinkedCharacter.IsInvul = true;
		float num2 = _timesRevived * 2000f;
		float num3 = num2 + 4000f;
		float num4 = num3 * 0.001f;
		if (num4 > linkedCharacter._invincibilityTimer)
		{
			linkedCharacter._invincibilityTimer = num4;
		}
		...
		if (!flag3)
		{
			...
			_mightBonus = 2f;
			_cooldownBonus = -1f;
			float num6 = LinkedCharacter.PMoveSpeed();
			float num7 = 2f - num;
			bool flag4 = 0f > num7;
			float moveBonus = 0f;
			if (!flag4)
			...
			PlayerModifierStats playerStats2 = linkedCharacter3._playerStats;
			...
			PlayerModifierStats playerStats3 = linkedCharacter4._playerStats;
		...
		CharacterWeaponsManager weaponsManager = linkedCharacter5._weaponsManager;
	...
	{
		//IL_01a8: Invalid comparison between F4 and O
		...
		CharacterController linkedCharacter3 = LinkedCharacter;
		PlayerModifierStats playerStats3 = linkedCharacter3._playerStats;
		...
		CharacterController linkedCharacter4 = LinkedCharacter;
		PlayerModifierStats playerStats4 = linkedCharacter4._playerStats;
		...
		if ((nint)obj2 != 2139095040)
		{
			...
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001875742D4h\"");
	...
	private void RosaryDamage()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 45 Invalid \"Jump target not found in method: 0x187574390\"");
		throw new NullReferenceException();
	}
	...
	private void _003CPlayRosaryAnim_003Eb__20_0()
	{
		//IL_00bf: Expected O, but got I4
		//IL_00c8: Expected O, but got I4
		//IL_0066: Expected O, but got I4
