...
{
	protected override int[] bonusTresholds => new int[3] { 1000, 3000, 5000 };
			...
			if ((object)GM.Core != null)
			{
				...
				if (core._gameSessionData != null && (object)gameSessionData._activeCharacter != null)
				{
					...
					if ((object)transform != null)
					{
						...
						if (GM.Core.IsStageHost || !NetworkItems.IsNetworkItem(ItemType.GILDED))
						{
							Vector2 pos = default(Vector2);
							Pickup pickup = PickupManager.CreatePickup(pos, ItemType.GILDED);
						}
