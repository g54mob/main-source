...
public class CharacterSkillCard_A008Skelewing : CharacterSkillCard_Base
{
	public CharacterSkillCard_A008Skelewing(ArcanaType type)
		: base(type)
	{
		float num = ((Edition == SkillCardEdition.Poly) ? 2f : ((Edition != SkillCardEdition.Inve) ? 1f : (-0.5f)));
		InitialBonus = new ModifierStats
		{
			_003CMoveSpeed_003Ek__BackingField = num,
			_003CMaxHp_003Ek__BackingField = num * -100f
		};
		AvailableSlots = 3;
	}
