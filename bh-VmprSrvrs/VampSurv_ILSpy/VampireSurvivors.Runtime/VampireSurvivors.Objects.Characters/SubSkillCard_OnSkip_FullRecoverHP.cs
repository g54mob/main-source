...
public class SubSkillCard_OnSkip_FullRecoverHP : CharacterSkillCard_Base
{
	...
	public override void OnOwnerLevelUpSkipped()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 233 Invalid \"Jump target not found in method: 0x18757D400\"");
	...
	private void CriticalAnim()
	{
		...
		PlaySoundResult playSoundResult = SoundManager.PlaySound(SfxType.Ophion1, soundConfig, 200f, 4, time);
		float2 position = LinkedCharacter.position;
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 81 Invalid \"Jump target not found in method: 0x18757D400\"");
		throw new NullReferenceException();
	}
	...
	private unsafe void _003CShowHighlightAt_003Eb__9_0()
	{
		//IL_0058: Expected O, but got Ref
	...
	private void _003CShowHighlightAt_003Eb__9_1()
	{
		//IL_002c: Expected I, but got O
		//IL_0090: Expected O, but got I4
		TweenConfig tweenConfig = new TweenConfig();
	...
	private void _003CShowHighlightAt_003Eb__9_2()
	{
		PhaserSprite phaserSprite = _highlight.setVisible(visible: false);
	}

	private unsafe void _003CShowHighlightAt_003Eb__9_3()
	{
		//IL_0058: Expected O, but got Ref
	...
	private void _003CShowHighlightAt_003Eb__9_4()
	{
		//IL_002c: Expected I, but got O
		//IL_0090: Expected O, but got I4
		//IL_009e: Expected O, but got I4
	...
	private void _003CShowHighlightAt_003Eb__9_5()
	{
		PhaserSprite phaserSprite = _rainbow.setVisible(visible: false);
	}
}
