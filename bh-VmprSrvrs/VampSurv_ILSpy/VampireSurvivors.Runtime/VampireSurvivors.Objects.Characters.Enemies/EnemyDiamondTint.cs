...
public class EnemyDiamondTint : EnemyDiamond
{
	...
	public override void InitEnemy(EnemyType enemyType, bool asRemote)
	{
		...
		if (IsAxe)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v134 @ rax_v38 (BaseBody)+74]");
			float num5 = 0f * -1f;
			BaseBody baseBody4 = body;
			_initialVelocity = baseBody4._velocity;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v135 @ rax_v39 (BaseBody)+74]");
			_ = 0;
		}
		if (WEIGHTEDSTORE == null)
		{
			GameManager gameManager = _gameManager;
			ItemType[] items = new ItemType[8]
			{
				ItemType.CLOVER,
				ItemType.COIN,
				ItemType.COINBAG1,
	...
	protected override void OnUpdate()
	{
		...
		if (IsAxe && !((EnemyController)this)._003CIsDead_003Ek__BackingField)
		{
			...
			if (!((EnemyController)this)._003CIsTimeStopped_003Ek__BackingField)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (VampireSurvivors.Objects.Characters.Enemies.EnemyDiamondTint)+2AC]");
				float num5 = 0f - num4;
