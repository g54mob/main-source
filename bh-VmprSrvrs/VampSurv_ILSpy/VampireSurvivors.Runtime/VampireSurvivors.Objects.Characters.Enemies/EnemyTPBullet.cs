...
public class EnemyTPBullet : EnemyController
{
	...
	public unsafe override void InitEnemy(EnemyType enemyType, bool asRemote)
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001876ACFA7h\"");
		...
		else
		{
			...
			((EnemyTPBullet)(object)dOSetter)._003CInitEnemy_003Eb__7_1(val);
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v632 @ r8_v11 (Il2CppClass<VampireSurvivors.Objects.Characters.Enemies.EnemyTPBullet>)+390]");
	...
	private unsafe void DeathTween()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v178 @ r8_v1 (Il2CppClass<VampireSurvivors.Objects.Characters.Enemies.EnemyTPBullet>)+3A0]");
		TweenCallback tweenCallback = new TweenCallback(this, (IntPtr)0);
		nint num = (nint)this;
		if (tweenerCore != null)
		{
