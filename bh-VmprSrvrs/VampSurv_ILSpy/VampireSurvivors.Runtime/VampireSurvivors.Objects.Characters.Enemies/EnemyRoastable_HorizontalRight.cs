...
public class EnemyRoastable_HorizontalRight : EnemyController
{
	...
	public unsafe override void GetDamaged(float value, HitVfxType showHitVfx = HitVfxType.Default, float damageKb = 1f, WeaponType damageType = WeaponType.VOID, bool hasKb = true)
	{
		...
		if (EnemyController.FireDamageTypes != null)
		{
			...
			{
				nint num3 = (nint)this;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v487 @ rax_v91 (Il2CppClass<VampireSurvivors.Objects.Characters.Enemies.EnemyRoastable_HorizontalRight>)+460]");
				itemType = ItemType.VOID;
				base.Die();
			}
	...
	protected override void OnUpdate()
	{
		...
		if (!base._003CIsTimeStopped_003Ek__BackingField)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (VampireSurvivors.Objects.Characters.Enemies.EnemyRoastable_HorizontalRight)+1E4]");
			float num8 = 0f * num6;
