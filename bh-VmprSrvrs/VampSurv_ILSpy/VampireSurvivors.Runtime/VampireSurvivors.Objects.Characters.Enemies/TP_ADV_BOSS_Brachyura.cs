...
public class TP_ADV_BOSS_Brachyura : EnemyControllerBoss
{
	...
	public override void InitEnemy(EnemyType enemyType, bool asRemote = false)
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Invalid instruction: 208 Invalid \"Jump target not found in method: 0x1876D2070\"");
		...
		if ((object)_EnemyRenderer != null)
		{
			...
			if ((object)transform != null)
			{
				...
				if ((object)_pincerSpriteL != null && ((UnityEngine.Object)pincerSpriteL).m_CachedPtr != (IntPtr)0)
				{
					...
					nint num = 0;
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (VampireSurvivors.Objects.Characters.Enemies.TP_ADV_BOSS_Brachyura)+42C]");
					object obj4 = num * 0;
				...
				if ((object)_pincerSpriteR != null)
				{
					...
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v5 @ rsp-3C]");
					nint num2 = 0;
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (VampireSurvivors.Objects.Characters.Enemies.TP_ADV_BOSS_Brachyura)+434]");
					object obj8 = num2 * 0;
					...
					TP_ADV_BOSS_Brachyura cachedTransform2 = (TP_ADV_BOSS_Brachyura)(object)_cachedTransform;
