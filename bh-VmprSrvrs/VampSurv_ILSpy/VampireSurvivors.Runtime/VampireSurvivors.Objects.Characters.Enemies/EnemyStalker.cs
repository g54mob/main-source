...
public class EnemyStalker : EnemyController
{
	...
	{
		//IL_02ed: Expected I4, but got I8
		...
		((EnemyStalker)(object)dOSetter)._003CInitEnemy_003Eb__5_1(0.8f);
		TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(getter, dOSetter, 0.1f, 2f);
		if (tweenerCore != null)
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v360 @ rax_v17 (DG.Tweening.Core.TweenerCore`3<System.Single, System.Single, DG.Tweening.Plugins.Options.FloatOptions>)+E8]");
			if ((nint)0 != 0)
			{
				_ = 4;
				_ = 0;
		...
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v454 @ rax_v21 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+E8]");
			if ((nint)0 != 0)
			{
				_ = 4;
				_ = 0;
	...
	public override void Disappear()
	{
		...
		((EnemyStalker)(object)dOSetter)._003CDisappear_003Eb__7_1(x);
	...
	public override void GetDamaged(float value, HitVfxType showHitVfx = HitVfxType.Default, float damageKb = 1f, WeaponType damageType = WeaponType.VOID, bool hasKb = true)
	{
		...
		//IL_03e4->IL03e4: Incompatible stack heights: 1 vs 0
		//IL_0218->IL03c6: Incompatible stack heights: 0 vs 1
		if (_hasLostTreasure)
		{
			return;
		}
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v456 @ rbx_v7 (System.Object)+10]");
		bool flag = (nint)0 == 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v456 @ rbx_v7 (System.Object)+10]");
