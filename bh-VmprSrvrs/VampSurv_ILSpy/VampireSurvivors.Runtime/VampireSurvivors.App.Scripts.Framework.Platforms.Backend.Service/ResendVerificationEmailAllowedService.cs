...
public class ResendVerificationEmailAllowedService
{
	...
	public unsafe void DisableUntil(DateTime dob)
	{
	...
	public ResendVerificationEmailAllowedService()
	{
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A303A]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
		key = "resend_verification_blocked_until";
	}
}
