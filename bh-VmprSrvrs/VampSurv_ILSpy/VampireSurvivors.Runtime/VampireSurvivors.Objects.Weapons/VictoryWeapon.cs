...
public class VictoryWeapon : Weapon
{
	private sealed class _003C_003Ec__DisplayClass14_0
	{
		...
		public VictoryWeapon _003C_003E4__this;
				...
				if ((object)gameObject != null)
				{
					...
					if ((object)_003C_003E4__this != null)
					{
						...
						if ((nint)0 != 0)
						{
							...
							VictoryWeapon victoryWeapon = _003C_003E4__this;
							if ((object)_003C_003E4__this != null)
							{
	...
	public int[] _FireAngles = new int[6] { 20, -20, -70, 30, -30, 0 };
	...
	public override void InitWeapon(VampireSurvivors.Objects.Characters.CharacterController characterController, WeaponType weaponType)
	{
		...
		((VictoryWeapon)(object)action).ExplodeOnPlayerDamage((GameplaySignals.CharacterReceivedDamageSignal)this);
		((VictoryWeapon)(object)_signalBus).ExplodeOnPlayerDamage((GameplaySignals.CharacterReceivedDamageSignal)action);
		Action<GameplaySignals.CharacterLostShieldSignal> action2 = null;
		((VictoryWeapon)(object)action2).ExplodeOnPlayerShield((GameplaySignals.CharacterLostShieldSignal)this);
		((VictoryWeapon)(object)_signalBus).ExplodeOnPlayerShield((GameplaySignals.CharacterLostShieldSignal)action2);
		_canExplode = true;
		_explosionType = WeaponType.VICTORY;
								...
								if ((object)gameObject != null)
								{
									...
									if ((object)CS_0024_003C_003E8__locals8._003C_003E4__this != null)
									{
										...
										if ((nint)0 != 0)
										{
											...
											VictoryWeapon victoryWeapon = CS_0024_003C_003E8__locals8._003C_003E4__this;
											if ((object)CS_0024_003C_003E8__locals8._003C_003E4__this != null)
											{
	...
	public unsafe void ExplodeOnPlayer()
	{
		...
		//IL_039b: Expected I, but got I8
		//IL_02da: Expected I, but got I8
		//IL_047b->IL0303: Incompatible stack heights: 1 vs 0
		//IL_01fa->IL0303: Incompatible stack heights: 1 vs 0
		//IL_0419->IL041e: Incompatible stack heights: 1 vs 0
		//IL_041e->IL0444: Incompatible stack heights: 1 vs 0
		if (!_canExplode)
		{
			return;
		}
		...
		if (_currentWeaponData != null)
		{
			...
			float num = currentWeaponData._003CrepeatInterval_003Ek__BackingField * 6f;
			...
			if ((object)((Equipment)this)._003COwner_003Ek__BackingField != null)
			{
				...
				while (true)
				{
					...
					Action action = null;
					nint num3 = 0;
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v77 @ r10_v7 (Il2CppMethodInfo)+8]");
					((Delegate)action).method_ptr = (IntPtr)0;
					((Delegate)action).method = (nint)__ldftn(_003C_003Ec__DisplayClass14_0._003CExplodeOnPlayer_003Eb__1);
					((Delegate)action).m_target = obj;
					((Delegate)action).method_code = (IntPtr)action;
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v77 @ r10_v7 (Il2CppMethodInfo)+4C]");
					object obj2 = (nint)0 >> 4;
					object obj3 = obj2 & 1;
					nint num4;
					if (obj3 != null)
					{
						Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v77 @ r10_v7 (Il2CppMethodInfo)+52]");
						if ((nint)0 == 0)
						{
					...
					float num5 = (float)(flag ? 1 : 0) * currentWeaponData2._003CrepeatInterval_003Ek__BackingField;
					num2 = num5 * 0.001f;
			...
			if ((object)GM.Core != null)
			{
				...
				if (ArcadePhysics.s_scene != null)
				{
					...
					if ((object)s_scene.physics != null)
					{
						...
						if ((object)GM.Core != null)
						{
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v575 @ r8_v9 (Il2CppClass<VampireSurvivors.Objects.Weapons.VictoryWeapon>)+390]");
									...
									if (ArcadePhysics.s_scene != null)
									{
										...
										if ((object)s_scene2.physics != null)
										{
											...
											if ((object)GM.Core != null)
											{
												...
												{
													Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v599 @ r8_v12 (Il2CppClass<VampireSurvivors.Objects.Weapons.VictoryWeapon>)+3A0]");
	...
	private void _003CExplodeOnPlayer_003Eb__14_0()
	{
		_canExplode = true;
	}
}
