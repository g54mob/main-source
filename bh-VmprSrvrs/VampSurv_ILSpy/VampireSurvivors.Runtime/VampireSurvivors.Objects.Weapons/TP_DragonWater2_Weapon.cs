...
public class TP_DragonWater2_Weapon : TP_DragonWater1_Weapon
{
	...
	protected override void OnStart()
	{
		...
		Weapon weapon = core._weaponsFacade.CreateDetachedWeapon(WeaponType.TP_HYDROSTORM_WATERDRAGONWHIP, ((Equipment)this)._003COwner_003Ek__BackingField);
		...
		nint num2 = (nint)typeof(TP_Hydrostorm_Weapon);
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v120 @ rdx_v6 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_Hydrostorm_Weapon>)+130]");
		object obj = 0;
		...
		if (num3 >= 0)
		{
			...
			if (0 == (nint)typeof(TP_Hydrostorm_Weapon))
			{
				obj3 = 1;
				goto IL_0123;
			}
		...
		goto IL_0123;
		IL_0114:
		_subWeapon = (TP_Hydrostorm_Weapon)subWeapon;
		return;
		IL_0123:
	...
	{
		TP_Hydrostorm_Weapon subWeapon = _subWeapon;
	...
	public override void Cleanup()
	{
		...
		if (base._tailPool != null)
		{
			base._tailPool.Cleanup();
		}
	}
	...
	public TP_DragonWater2_Weapon()
	{
		_specialCounter = 7;
		_subWeaponCounter = 13;
