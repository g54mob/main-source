...
public class CarnageWeapon : Weapon
{
	...
	public override void InitWeapon(VampireSurvivors.Objects.Characters.CharacterController characterController, WeaponType weaponType)
	{
		...
		((CarnageWeapon)(object)action).ExplodeOnPlayerShield((GameplaySignals.CharacterLostShieldSignal)this);
		((CarnageWeapon)(object)_signalBus).ExplodeOnPlayerShield((GameplaySignals.CharacterLostShieldSignal)action);
		Action<GameplaySignals.CharacterReceivedDamageSignal> action2 = null;
		((CarnageWeapon)(object)action2).ExplodeOnPlayerDamage((GameplaySignals.CharacterReceivedDamageSignal)this);
		((CarnageWeapon)(object)_signalBus).ExplodeOnPlayerDamage((GameplaySignals.CharacterReceivedDamageSignal)action2);
	}
	...
	public override void Cleanup()
	{
		...
		if (_tvExplosionPool != null)
		{
			_tvExplosionPool.Cleanup();
		}
		if (_onGetHitExplosionPool != null)
		{
	...
	protected override void OnStart()
	{
		...
		if (!_generatedPools)
		{
			Projectile projectilePrefab = _projectileFactory.GetProjectilePrefab(WeaponType.ROCHEREXP);
		...
		GameManager core = GM.Core;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v605 @ r8_v2 (Il2CppClass<VampireSurvivors.Objects.Weapons.CarnageWeapon>)+350]");
		...
		if ((object)GM.Core != null)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v687 @ r8_v5 (Il2CppClass<VampireSurvivors.Objects.Weapons.CarnageWeapon>)+3A0]");
			ArcadePhysicsCallback collideCallback2 = new ArcadePhysicsCallback(this, (IntPtr)0);
			nint num2 = (nint)this;
			Collider collider2 = physics2.add.overlap(_tvExplosionPool, physicsManager._destructiblesGroup, collideCallback2, processCallback, callbackContext);
			if ((object)GM.Core != null)
			{
				PhaserScene s_scene3 = ArcadePhysics.s_scene;
				ArcadePhysics physics3 = s_scene3.physics;
				GameManager core3 = GM.Core;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v709 @ r8_v8 (Il2CppClass<VampireSurvivors.Objects.Weapons.CarnageWeapon>)+390]");
				...
				if ((object)GM.Core != null)
				{
					...
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v731 @ r8_v11 (Il2CppClass<VampireSurvivors.Objects.Weapons.CarnageWeapon>)+3A0]");
	...
	private void _003CExplodeOnPlayer_003Eb__16_0()
	{
		_canExplode = true;
	}
}
