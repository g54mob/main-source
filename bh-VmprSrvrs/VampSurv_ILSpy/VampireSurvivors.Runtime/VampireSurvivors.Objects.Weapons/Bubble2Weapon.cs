...
public class Bubble2Weapon : Weapon
{
	...
	public override Projectile FireOneProjectile(Vector2 pos, int index, Transform target = null, BulletPool pool = null)
	{
		...
		if ((object)GM.Core != null && (object)core._stage != null)
		{
			...
			if (_projectilePool != null)
			{
				...
				if (!flag)
				{
					...
					nint num2 = (nint)typeof(Bubble2Projectile);
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v199 @ rdx_v10 (Il2CppClass<VampireSurvivors.Objects.Projectiles.Bubble2Projectile>)+130]");
					object obj = 0;
					...
					if (num3 >= 0)
					{
						...
						if (0 == (nint)typeof(Bubble2Projectile))
						{
							obj3 = 1;
							goto IL_024e;
						}
		...
		IL_02b4:
		((Bubble2Projectile)projectile2).SetColor(16777215u);
		goto IL_020d;
		IL_024e:
	...
	private void _003CParadoxFire_003Eb__2_0()
	{
		base.Fire(skipTriggers: true);
	}

	private void _003CParadoxFire_003Eb__2_1()
	{
		base.Fire(skipTriggers: true);
	}
}
