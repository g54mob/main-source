					...
					if ((object)GM.Core != null)
					{
						...
						if (ArcadePhysics.s_scene != null)
						{
							...
							if ((object)s_scene.physics != null)
							{
								...
								if ((object)GM.Core != null)
								{
									Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v460 @ r8_v7 (Il2CppClass<VampireSurvivors.Objects.Weapons.Unused_TP_WindWhip1_Weapon>)+350]");
											...
											if (ArcadePhysics.s_scene != null)
											{
												...
												if ((object)s_scene2.physics != null)
												{
													...
													if ((object)GM.Core != null)
													{
														...
														{
															Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v484 @ r8_v10 (Il2CppClass<VampireSurvivors.Objects.Weapons.Unused_TP_WindWhip1_Weapon>)+3A0]");
			...
			if ((object)GM.Core != null)
			{
				...
				if (ArcadePhysics.s_scene != null)
				{
					...
					if ((object)s_scene.physics != null)
					{
						...
						if ((object)GM.Core != null)
						{
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v443 @ r8_v7 (Il2CppClass<VampireSurvivors.Objects.Weapons.Unused_TP_WindWhip1_Weapon>)+370]");
							ArcadePhysicsCallback collideCallback = new ArcadePhysicsCallback(this, (IntPtr)0);
							nint num = (nint)this;
							if (physics.add != null)
							{
									...
									if (ArcadePhysics.s_scene != null)
									{
										...
										if ((object)s_scene2.physics != null)
										{
											...
											if ((object)GM.Core != null)
											{
												...
												if (core2._physicsManager != null)
												{
													Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v467 @ r8_v10 (Il2CppClass<VampireSurvivors.Objects.Weapons.Unused_TP_WindWhip1_Weapon>)+3A0]");
													ArcadePhysicsCallback collideCallback2 = new ArcadePhysicsCallback(this, (IntPtr)0);
													nint num2 = (nint)this;
													if (physics2.add != null)
													{
