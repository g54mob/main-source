...
public class TP_WindWhip2_Weapon : TP_WindWhip1_Weapon
{
	private TP_SpiritTornado_Weapon _subWeapon;
	...
	protected override void OnStart()
	{
		...
		Weapon weapon = core._weaponsFacade.CreateDetachedWeapon(WeaponType.TP_SPIRITTORNADO_WINDWHIP, ((Equipment)this)._003COwner_003Ek__BackingField);
		...
		nint num2 = (nint)typeof(TP_SpiritTornado_Weapon);
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v134 @ rdx_v7 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_SpiritTornado_Weapon>)+130]");
		object obj = 0;
		...
		goto IL_018b;
		IL_017c:
		_subWeapon = (TP_SpiritTornado_Weapon)subWeapon;
		TP_SpiritTornado_Weapon subWeapon2 = _subWeapon;
	...
	{
		TP_SpiritTornado_Weapon subWeapon = _subWeapon;
