...
public class TP_HolyWhip2_Weapon : TP_HolyWhip1_Weapon
{
	...
	protected override void OnStart()
	{
		...
		Weapon weapon = core._weaponsFacade.CreateDetachedWeapon(WeaponType.TP_GOTH_MISSILE_HOLYWHIP2, ((Equipment)this)._003COwner_003Ek__BackingField);
		...
		nint num2 = (nint)typeof(TP_GothMissile_Weapon);
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v120 @ rdx_v6 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_GothMissile_Weapon>)+130]");
		object obj = 0;
		...
		if (num3 >= 0)
		{
			...
			if (0 == (nint)typeof(TP_GothMissile_Weapon))
			{
				obj3 = 1;
				goto IL_0123;
			}
		...
		goto IL_0123;
		IL_0114:
		_subWeapon = (TP_GothMissile_Weapon)subWeapon;
		return;
		IL_0123:
	...
	{
		TP_GothMissile_Weapon subWeapon = _subWeapon;
