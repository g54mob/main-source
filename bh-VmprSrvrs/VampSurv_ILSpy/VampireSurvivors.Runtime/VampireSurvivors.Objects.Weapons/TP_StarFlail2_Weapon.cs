...
public class TP_StarFlail2_Weapon : Weapon
{
	...
	public TP_StarFlail2_Blade_Projectile SpawnBladeAt(float2 pos, int enemiesHit = 0, int damage = 1, float area = 1f)
	{
		...
		{
			Projectile projectilePrefab = _projectileFactory.GetProjectilePrefab(WeaponType.TP_STARFLAIL2_BLADE);
			...
			if ((object)GM.Core != null)
			{
				...
				if (ArcadePhysics.s_scene != null)
				{
					...
					if ((object)s_scene.physics != null)
					{
						...
						if ((object)GM.Core != null)
						{
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v538 @ r8_v8 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_StarFlail2_Weapon>)+350]");
									...
									if (ArcadePhysics.s_scene != null)
									{
										...
										if ((object)s_scene2.physics != null)
										{
											...
											if ((object)GM.Core != null)
											{
												...
												{
													Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v562 @ r8_v11 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_StarFlail2_Weapon>)+3A0]");
		...
		goto IL_0376;
		IL_03f4:
		TP_StarFlail2_Blade_Projectile result;
		return result;
		IL_0265:
		if (_bladePool == null)
		{
		...
		nint num4 = (nint)typeof(TP_StarFlail2_Blade_Projectile);
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v386 @ rdx_v5 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_StarFlail2_Blade_Projectile>)+130]");
		object obj = 0;
		...
		if (num5 >= 0)
		{
			...
			if (0 == (nint)typeof(TP_StarFlail2_Blade_Projectile))
			{
				obj3 = 1;
				goto IL_03f9;
			}
		...
		goto IL_03f9;
		IL_0376:
		return (TP_StarFlail2_Blade_Projectile)(object)new NullReferenceException();
		IL_03f9:
		bool flag2 = obj3 == null;
		result = null;
		if (!flag2)
		{
			result = (TP_StarFlail2_Blade_Projectile)projectile;
		}
		goto IL_03f4;
	}
