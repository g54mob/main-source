...
public class TP_Shield1_Weapon : Weapon
{
	private sealed class _003C_003Ec__DisplayClass14_0
	{
		public TP_Shield1_Weapon _003C_003E4__this;
	...
	private sealed class _003C_003Ec__DisplayClass14_1
	{
		...
		internal void _003CFireProjectiles_003Eb__0()
		{
			...
			TP_Shield1_Blade_Projectile tP_Shield1_Blade_Projectile;
			object obj6;
			if (CS_0024_003C_003E8__locals1 != null && (object)obj._003C_003E4__this != null)
			{
				...
				if ((object)gameObject != null)
				{
					...
					{
						TP_Shield1_Weapon tP_Shield1_Weapon = obj3._003C_003E4__this;
						if ((object)obj3._003C_003E4__this != null && (object)obj3._003C_003E4__this != null)
						{
							Vector2 pos = default(Vector2);
							tP_Shield1_Blade_Projectile = (TP_Shield1_Blade_Projectile)obj3._003C_003E4__this.FireOneProjectile(pos, localIndex, tP_Shield1_Weapon._targetTransform);
							if ((object)tP_Shield1_Blade_Projectile == null)
							{
								return;
							}
							nint num = (nint)typeof(TP_Shield1_Blade_Projectile);
							nint num2 = (nint)tP_Shield1_Blade_Projectile;
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v77 @ r8_v6 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shield1_Blade_Projectile>)+130]");
							object obj4 = 0;
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v90 @ r9_v7 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shield1_Blade_Projectile>)+130]");
							nint num3 = 0;
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v77 @ r8_v6 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shield1_Blade_Projectile>)+130]");
							if (num3 >= 0)
							{
								Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v90 @ r9_v7 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shield1_Blade_Projectile>)+C8]");
								object obj5 = 0;
								Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v419 @ rcx_v20+FFFFFFF8+v405 @ rcx_v14*8]");
								if (0 == (nint)typeof(TP_Shield1_Blade_Projectile))
								{
									obj6 = 1;
									goto IL_02b6;
								}
			...
			TP_Shield1_Blade_Projectile tP_Shield1_Blade_Projectile2 = null;
			if (!flag2)
			{
				tP_Shield1_Blade_Projectile2 = tP_Shield1_Blade_Projectile;
			}
			if ((object)tP_Shield1_Blade_Projectile2 != null)
			{
				...
				if (CS_0024_003C_003E8__locals1 != null)
				{
					...
					tP_Shield1_Blade_Projectile2.SetAngleVelocity(angleVelocity);
					return;
				}
				goto IL_0239;
			}
	...
	public override void InitWeapon(VampireSurvivors.Objects.Characters.CharacterController characterController, WeaponType weaponType)
	{
		...
		((TP_Shield1_Weapon)(object)action).OnPlayerHitShield((GameplaySignals.CharacterLostShieldSignal)this);
		((TP_Shield1_Weapon)(object)_signalBus).OnPlayerHitShield((GameplaySignals.CharacterLostShieldSignal)action);
		Action<GameplaySignals.CharacterReceivedDamageSignal> action2 = null;
		((TP_Shield1_Weapon)(object)action2).OnPlayerHitDamage((GameplaySignals.CharacterReceivedDamageSignal)this);
		((TP_Shield1_Weapon)(object)_signalBus).OnPlayerHitDamage((GameplaySignals.CharacterReceivedDamageSignal)action2);
		VampireSurvivors.Objects.Characters.CharacterController characterController2 = ((Equipment)this)._003COwner_003Ek__BackingField;
		_canRetaliate = true;
		((TP_Shield1_Weapon)(object)characterController2.HeldShieldSlots).OnPlayerHitDamage((GameplaySignals.CharacterReceivedDamageSignal)this);
	...
	protected override void OnStart()
	{
		...
		Projectile projectilePrefab = _projectileFactory.GetProjectilePrefab(WeaponType.TP_SHIELD1_BLADE);
		...
		if ((object)GM.Core != null)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v725 @ r8_v20 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_Shield1_Weapon>)+3A0]");
			...
			if ((object)GM.Core != null)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v771 @ r8_v23 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_Shield1_Weapon>)+390]");
		...
		Projectile projectilePrefab2 = _projectileFactory.GetProjectilePrefab(WeaponType.TP_SHIELD1_BLADE);
		...
		if ((object)GM.Core != null)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v728 @ r8_v7 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_Shield1_Weapon>)+3A0]");
			...
			if ((object)GM.Core != null)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v774 @ r8_v10 (Il2CppClass<VampireSurvivors.Objects.Weapons.TP_Shield1_Weapon>)+350]");
	...
	public void FireProjectiles(BulletPool pool, Vector2 position, bool allDirections = false)
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 000000018746737Eh\"");
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180B6FB44");
		bool flag2 = num3 == 0f;
		Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001874673B7h\"");
		bool flag3 = false;
		if (!flag2)
		{
			flag3 = true;
		...
		float num8 = num9;
		TP_Shield1_Blade_Projectile tP_Shield1_Blade_Projectile = default(TP_Shield1_Blade_Projectile);
		bool useRealTime = default(bool);
		MonoBehaviour autoDestroyOwner = default(MonoBehaviour);
		int repeat = default(int);
		TimerType type = default(TimerType);
		do
		{
			...
			if (!(num10 > 0f))
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v159 @ rdx_v14 (VampireSurvivors.Objects.Weapons.TP_Shield1_Weapon+<>c__DisplayClass14_0)+1C]");
				num8 = 0f;
				object obj5 = (flag3 ? 1 : 0) + (flag4 ? 1 : 0);
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @180AA68F0");
				if ((object)tP_Shield1_Blade_Projectile != null)
				{
					nint num11 = (nint)typeof(TP_Shield1_Blade_Projectile);
					nint num12 = (nint)tP_Shield1_Blade_Projectile;
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v165 @ r8_v13 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shield1_Blade_Projectile>)+130]");
					object obj6 = 0;
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v135 @ r9_v8 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shield1_Blade_Projectile>)+130]");
					nint num13 = 0;
					Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v165 @ r8_v13 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shield1_Blade_Projectile>)+130]");
					if (num13 >= 0)
					{
						Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v135 @ r9_v8 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shield1_Blade_Projectile>)+C8]");
						object obj7 = 0;
			...
			else
			{
				Action onComplete = delegate
				{
					...
					TP_Shield1_Blade_Projectile tP_Shield1_Blade_Projectile3;
					object obj16;
					if (CS_0024_003C_003E8__locals13.CS_0024_003C_003E8__locals1 != null && (object)obj11._003C_003E4__this != null)
					{
						...
						if ((object)gameObject != null)
						{
							...
							{
								TP_Shield1_Weapon tP_Shield1_Weapon = obj13._003C_003E4__this;
								if ((object)obj13._003C_003E4__this != null && (object)obj13._003C_003E4__this != null)
								{
									Vector2 pos = default(Vector2);
									tP_Shield1_Blade_Projectile3 = (TP_Shield1_Blade_Projectile)obj13._003C_003E4__this.FireOneProjectile(pos, CS_0024_003C_003E8__locals13.localIndex, tP_Shield1_Weapon._targetTransform);
									if ((object)tP_Shield1_Blade_Projectile3 == null)
									{
										return;
									}
									nint num15 = (nint)typeof(TP_Shield1_Blade_Projectile);
									nint num16 = (nint)tP_Shield1_Blade_Projectile3;
									Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v77 @ r8_v6 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shield1_Blade_Projectile>)+130]");
									object obj14 = 0;
									Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v90 @ r9_v7 (Il2CppClass<VampireSurvivors.Objects.Projectiles.TP_Shield1_Blade_Projectile>)+130]");
									nint num17 = 0;
					...
					TP_Shield1_Blade_Projectile tP_Shield1_Blade_Projectile4 = null;
					if (!flag7)
					{
						tP_Shield1_Blade_Projectile4 = tP_Shield1_Blade_Projectile3;
					}
					if ((object)tP_Shield1_Blade_Projectile4 == null)
					{
						return;
					}
					...
					if (CS_0024_003C_003E8__locals13.CS_0024_003C_003E8__locals1 != null)
					{
						...
						tP_Shield1_Blade_Projectile4.SetAngleVelocity(angleVelocity);
						return;
					}
					goto IL_0239;
					IL_0239:
			...
			if ((object)tP_Shield1_Blade_Projectile2 != null)
			{
				...
				tP_Shield1_Blade_Projectile2.SetAngleVelocity(num8);
			}
			goto IL_03a4;
		}
