...
public class NewAchievementData
{
	...
	public virtual string GetLocalizedName()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [1899A2CDE]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
	...
	{
		//IL_0b07: Expected F4, but got I4
		...
		if (_003CcharactersToUnlock_003Ek__BackingField != null)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v959 @ rax_v46 (System.Collections.Generic.List`1<VampireSurvivors.Data.CharacterType>)+18]");
			if ((nint)0 > (nint)0)
			{
				...
				while (true)
				{
					if (obj4 != null)
					{
						...
						Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1633 @ rcx_v40 (System.Collections.Generic.List`1<VampireSurvivors.Data.CharacterType>)+18]");
						bool flag6 = (nint)0 == 0;
						nint num4 = num5;
						nint num6 = num3;
						nint num7 = 0;
						if (!flag6)
						{
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1633 @ rcx_v40 (System.Collections.Generic.List`1<VampireSurvivors.Data.CharacterType>)+18]");
							num6 = 0;
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v1633 @ rcx_v40 (System.Collections.Generic.List`1<VampireSurvivors.Data.CharacterType>)+10]");
							text2 = (string)0;
	...
	public virtual void FixUnlock(PlayerOptions playerOptions, DataManager dataManager, AchievementType type, Dictionary<PowerUpType, int> powerUpCounts)
	{
		...
		//IL_0730: Expected F4, but got I4
		...
		{
			_003C_003Ec__DisplayClass95_0 CS_0024_003C_003E8__locals10 = new _003C_003Ec__DisplayClass95_0();
			PowerUpType unlock = Enum.Parse<PowerUpType>(_003CpowerUpToUnlock_003Ek__BackingField);
			CS_0024_003C_003E8__locals10.unlock = unlock;
			...
			int num = dictionary.FindEntry(CS_0024_003C_003E8__locals10.unlock);
			if (num >= 0)
			{
				int num2 = ((Dictionary<System.Int32Enum, object>)(object)convertedPowerUpData).FindEntry((System.Int32Enum)CS_0024_003C_003E8__locals10.unlock);
				if (num2 >= 0)
				{
					int num3 = dictionary.get_Item(CS_0024_003C_003E8__locals10.unlock);
					object obj6 = ((Dictionary<System.Int32Enum, object>)(object)convertedPowerUpData).get_Item((System.Int32Enum)CS_0024_003C_003E8__locals10.unlock);
					bool flag4 = CS_0024_003C_003E8__locals10.unlock == PowerUpType.SEAL;
					int num4 = 1;
					if (!flag4)
					{
						bool flag5 = CS_0024_003C_003E8__locals10.unlock == PowerUpType.SEAL2;
						num4 = 1;
						if (!flag5)
						{
							bool flag6 = CS_0024_003C_003E8__locals10.unlock != PowerUpType.SEAL3;
							int num5 = num3;
							if (!flag6)
							{
								num5 = 1;
					...
					{
						//IL_000f: Expected O, but got I4
						object obj7 = x - CS_0024_003C_003E8__locals10.unlock;
						return obj7 == null;
					};
					...
					if (num6 < num4)
					{
						Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v471 @ rax_v47 (System.Object)+18]");
						if ((nint)num6 < (nint)0)
						{
							PlayerOptionsData config9 = playerOptions.Config;
							int num7 = Enumerable.Count(config9._003CUnlockedPowerUpRanks_003Ek__BackingField, (Func<PowerUpType, bool>)CS_0024_003C_003E8__locals10.unlock);
							obj = 1;
						}
					}
				}
