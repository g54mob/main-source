...
namespace Rewired
{
	...
	public sealed class InputMapCategory : InputCategory
	{
		...
		internal List<int> LNPCqXcFbdENtXUiwBTgNRHVgoTH => null;
		...
		internal override void HGeLutjHBYTxyNqAvbZVRrowdGRX()
		{
		}

		internal override void bEVHTAIzHkzShVEaTgmFVkxZGdojA()
		{
		}
	}
}
