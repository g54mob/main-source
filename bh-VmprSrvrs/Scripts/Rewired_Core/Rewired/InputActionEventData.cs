...
namespace Rewired
{
	...
	{
		private fCrdDPKymmoGzWfQSQgIAuuziIqF CuOViLpGQHZeivgOrPlwrTIJnoBD;

		private InputActionEventType wmePTqGdrWStedeJfALMhoRrfLMjb;
		...
		internal InputActionEventData(fCrdDPKymmoGzWfQSQgIAuuziIqF P_0, int P_1, int P_2, UpdateLoopType P_3)
		{
			CuOViLpGQHZeivgOrPlwrTIJnoBD = null;
			wmePTqGdrWStedeJfALMhoRrfLMjb = default(InputActionEventType);
			playerId = 0;
			actionId = 0;
