...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class CeYAKdvTgrQUXpHVnzoatYEpmCfe : IControllerExtensionSource
		{
			public readonly IDriver_DualSense iHylIcQlObvxliJrpXdLJxuIzGbH;

			public readonly bool BDZsJwTbeLgtyStMVrLlDGrkVzmd;

			public readonly int BgccWUJvWUiHhGLLkNAVrnjEOnCb;

			public CeYAKdvTgrQUXpHVnzoatYEpmCfe(IDriver_DualSense P_0, bool P_1, int P_2)
			{
			}
		}

		private CeYAKdvTgrQUXpHVnzoatYEpmCfe CeytRCcDPiGPLYDDcgIGCOcbaYwH;

		private bool MQsQbfVJlSzgLAaQDPhJQfVADvRhA;

		private TimerAbs[] HhTabWsIncAgDQcNtNAwuXBPDOlJ;
		...
		private void vfvgflRtvVGOWvdCsmwnobepdUKj()
		{
		}

		private void wIQcgpBPkwMEpbeYtdPEPgnlwMPT(DualShock4MotorType P_0, float P_1, float P_2)
		{
		}
	}
}
