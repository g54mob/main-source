...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class SRyUQpZhKslXsJkHUOUWNRTqEeGN : IControllerExtensionSource
		{
			public readonly IDriver_DualShock4 UyJvMIpklfjPEXntBRideIzZlrSh;

			public readonly bool FsHtyWTObZIjakJOqMRQsFssfbSv;

			public readonly int bQEMVdtZYRlXBItWgBnVxJXDMqfC;

			public SRyUQpZhKslXsJkHUOUWNRTqEeGN(IDriver_DualShock4 P_0, bool P_1, int P_2)
			{
			}
		}

		private SRyUQpZhKslXsJkHUOUWNRTqEeGN ySJEFPevyscQRfKQVgsgqASoXauG;

		private bool YBqtYqQwJEKGKtVEbGtBLVdIiwao;

		private TimerAbs[] IcesTKlzaEaJTjRmkEzfSzFHFjQd;
		...
		private void cOsHoNlowRJApWNORzgzyoJWtoDK()
		{
		}

		private void iSjQbGibMugCwhLXNmjhdPOsoizGb(DualShock4MotorType P_0, float P_1, float P_2)
		{
		}
	}
}
