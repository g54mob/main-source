...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class IwDcRuvTPsHWwPCoMcPkxWqaepbG : IControllerExtensionSource
		{
			public readonly ISteamControllerInternal StZHUsDcAiGuYuikRgIqcxWqdOQi;

			public IwDcRuvTPsHWwPCoMcPkxWqaepbG(ISteamControllerInternal P_0)
			{
			}
		}

		private IwDcRuvTPsHWwPCoMcPkxWqaepbG yeqYAOeTXYupNuvfDpBxjphLkEId;
		...
		private void FVWPlNfBxheezMLQmBqcmSLyjPqu()
		{
		}
	}
}
