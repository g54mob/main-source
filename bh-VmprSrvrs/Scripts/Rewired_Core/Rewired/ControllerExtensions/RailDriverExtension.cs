...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class AmkxdTNHSAebUfQYgZovIRSWjHTm : IControllerExtensionSource
		{
			public readonly IDriver_RailDriver xDKJvuuxBquzozupWZbAvsnIRqnK;

			public AmkxdTNHSAebUfQYgZovIRSWjHTm(IDriver_RailDriver P_0)
			{
			}
		}

		private AmkxdTNHSAebUfQYgZovIRSWjHTm PxCWvdOSxlpBBTUxgEEpqKfkmUPb;
