...
namespace Rewired.Internal.Localization
{
	...
	internal class LocalizedString
	{
		...
		private uint SjUsOrGzkatHUZFfKCWlFHWMENfNA;

		private uint DpPWoaeYLuQlnxiYENzfIAcqsswm;

		private string eXWbgXKajxBrUurZzhSOoqxYdklEA;

		private bool BJTEPGHnOPfBsCmxUvqQUMiTJrju;
