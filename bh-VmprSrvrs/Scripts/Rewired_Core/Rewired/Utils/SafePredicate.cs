...
namespace Rewired.Utils
{
	...
	{
		private T NtVvJudyzOSgluShvtvBqbKQSCIl;

		private bool PVPqlJtjRUsgWDAziuSuZHUIAahf;

		private static Action<object, Predicate<T>> xBAxtNObWBLmniihCcwbgenmMFrZ;
		...
		private static void QwbKraBArrmgIiGRrWcpjngvpAim(object P_0, Predicate<T> P_1)
		{
		}
