...
namespace Rewired.Utils
{
	...
	{
		private const float QiJcNmIgSzBunfsubSLYbvDVOlJzA = 1E-10f;

		private const double FaNnOOfkxXmWIrXqETdajPykyWNM = 1E-10;

		private const float FycJLEqdgMASgtBceccBlHXxMFdI = 0.0001f;
		...
		internal static bool GdamKElOPYLhhscBMFAVENpAQYyFb(int P_0, int P_1)
		{
			return false;
		}
		...
		private static bool SzsloxVkkLXGIAwGrtHWWCqGFsYGA(Vector2 P_0, Vector2 P_1, Vector2 P_2, Vector2 P_3, out Vector2 P_4)
		{
			P_4 = default(Vector2);
			return false;
		}
