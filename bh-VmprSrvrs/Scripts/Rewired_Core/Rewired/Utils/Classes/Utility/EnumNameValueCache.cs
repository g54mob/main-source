...
namespace Rewired.Utils.Classes.Utility
{
	...
	{
		private static EnumNameValueCache<TEnum> LCqiXmZKgIXILkxkgJwEfgsfdLhw;

		private readonly ADictionary<string, TEnum> wBQpcGBfpYjBpESFmykPvmkEQUnL;

		private readonly string[] umpkXvnsDAJOhNhqRlVcDxxpHGrf;

		private readonly long[] BCyKrYwzKYsRIIOensojEYRItUHK;
