...
namespace Rewired.ComponentControls.Data
{
	...
	public sealed class CustomControllerElementSelector
	{
		...
		[HideInInspector]
		private int bxZWDzDcyuLhVGihxFuTBNSmnlEFA;

		[HideInInspector]
		private int XLzKeAKEaJTkdsIOtjFxnirsdDKj;
		...
		private IList<ControllerElementIdentifier> HJBXqKnfLzmuzWBjqmdNODLzbRkj(Rewired.CustomController P_0, ElementType P_1)
		{
			return null;
		}
