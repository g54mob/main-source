...
namespace Rewired.ComponentControls.Effects
{
	...
	public sealed class TouchInteractableTransitioner : MonoBehaviour, IVisibilityChangedHandler, TouchInteractable.IInteractionStateTransitionHandler
	{
		...
		private TouchInteractable.InteractionState ChHDXhlHJkOcLnNrGWFhXgGHHRyl;
		...
		private void bjpFkaOtqFiaBCgQHgMkcEKlIFXLA()
		{
		}

		private void LNZMslHhumXefqhbpMaqpZIZOUuU()
		{
		}

		private void CmOthRPVyWAbTdfXlNINokVBiItI(bool P_0)
		{
		}

		private void ngyGRlmJjvQhBwdpkupPNWINPaso(bool P_0, bool P_1)
		{
		}

		private bool zraLjjzeMAZVynjktBZfHGoqkZNBA()
		{
			return false;
		}

		private void yhMuMJLJchhxKMWPoAfWWiRbkZBw()
		{
		}

		private void BmgsTpLWqzsombbbAtvthJiZXTpp(TouchInteractable.InteractionState P_0, bool P_1)
		{
		}

		private void lpUocWOfqkgYYrXlIaJisglMeyWEA(Color P_0, bool P_1)
		{
		}

		private void EWGQLhzEqUehobQZLUeIqaNQAnjGA(Sprite P_0)
		{
		}

		private void poKbYeYNwDsTJHuMfBPTjEFHTeax(string P_0)
		{
		}
