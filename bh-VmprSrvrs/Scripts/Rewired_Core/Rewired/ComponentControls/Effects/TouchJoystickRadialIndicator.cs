...
namespace Rewired.ComponentControls.Effects
{
	...
	public sealed class TouchJoystickRadialIndicator : MonoBehaviour, IRegistrar<TouchJoystickAngleIndicator>
	{
		...
		private static readonly Vector2 EeHaMssihbRGTYFodLDFYjQpEMbcA;

		private RectTransform oEcjdtQILqPwxdaJXojmxUcyQCFR;

		private List<TouchJoystickAngleIndicator> vgVvxAWMjysZAwsBOqeaXmInDqCIA;
		...
		private RectTransform eeNAWaAyDwoVEQSaRpSxljhvzIxC => null;
		...
		private void BADXrFDllOtRQiNpNudzgcaeinte()
		{
		}

		private void luFmJmznPbAIhNjAOAJdLaQjyOWS(TouchJoystickAngleIndicator P_0)
		{
		}

		private void BwXcUkUavKAgleHOyoliYcqwzuVAA()
		{
		}

		private void DykyAzeZfJlRRroHqyubieAjHOBj()
		{
		}
	}
}
