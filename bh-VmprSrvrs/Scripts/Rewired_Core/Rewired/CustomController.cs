...
namespace Rewired
{
	...
	{
		private int vQNhWqEixtdFOyigdSNLSeLDEhAf;

		private Func<int, float> uMfTBQsPWMmNjpGejeMKRUWuNVhw;

		private Func<int, bool> pkmghINKvkdbakkCvASInAaNgEkI;

		private bool ugMkYhSvUxFbcpvZdhwRianmBgHC;

		private Guid hRewDfsIoQpxRdMocoUZHQEprvRw;

		public int sourceControllerId => 0;

		public override Guid deviceInstanceGuid => default(Guid);

		internal CustomController(wtNyKdoNzlxXaKkjvqFftQBPMwlT P_0)
		...
		internal void bvRswqKqVWzAXnzjRPKvhZAOfIuj()
		{
		}
