...
namespace Rewired
{
	...
	{
		private const int VICHxBzpbGXHisWEPYDzgpgsBBpB = 132;

		private static HardwareControllerMap_Game KuuWQiIkzLLYzqNhxtuYYUXxsTdt;

		private bool jGUWFtUSiBtkXWtjgZaEJivubyfu;

		private bool zTsPWYNWSXoMVMUpdtdjslkmHXZF;
