...
namespace Rewired
{
	...
	{
		private AxisCalibration[] UHfulKQBZkPwACArloaydJbioNao;

		private MappedArray<AxisCalibration> eRygbfWbCnmPMQNEkQOtXYRlhVPW;

		private IList<AxisCalibration> gsNBUFvmikDrzNchwIblAMmcRbDDA;

		private readonly int TMuNQtYIoRFzuEYDrckArWxJolHEA;
		...
		private SerializedObject VBzRYHPlXTNtQzxwAFtFtQGCjNAN()
		{
			return null;
		}

		private void PtzbjlCUpoAulZVZmTYuWJsEoRuf(SerializedObject P_0)
		{
		}
