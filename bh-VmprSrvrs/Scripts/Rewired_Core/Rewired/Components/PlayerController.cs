...
namespace Rewired.Components
{
	...
	public class PlayerController : ComponentWrapper<Rewired.PlayerController>, IPlayerController
	{
		...
		internal virtual List<ElementInfo> dMgmkGDUDCsPvbeJUolzXsfDSYhg()
		{
			return null;
		}

		private void nRCzEtjqACJSHQlArOfxmWDLGErA(int P_0, bool P_1)
		{
		}

		private void MRiiXBfMFuWBXQUbiKBQStTyNirq(int P_0, float P_1)
		{
		}

		private void xzkOnpshariiyUxRfIGMhGGuresx(bool P_0)
		{
		}

		private void naeeLURDkwhNCLcuOmlWkehhPMDw()
		{
		}
	}
}
