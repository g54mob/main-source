...
namespace Rewired.Components
{
	...
	public sealed class PlayerMouse : PlayerController, IPlayerMouse, IPlayerController, IMouseInputSource
	{
		...
		private Rewired.PlayerMouse LdKxxCVJGXbRAhJrsSWsbEXWmogW => null;
		...
		internal override List<ElementInfo> dMgmkGDUDCsPvbeJUolzXsfDSYhg()
		{
			return null;
		}

		private void TAhIUfMTbJHYmxoPSOygQKOtILSS(Vector2 P_0)
		{
		}
