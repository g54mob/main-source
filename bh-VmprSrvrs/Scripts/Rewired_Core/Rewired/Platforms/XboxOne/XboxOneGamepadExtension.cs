...
namespace Rewired.Platforms.XboxOne
{
	...
	{
		private class AcLaevKzLHbQUeHSFzpRmUDZnjao : IControllerExtensionSource
		{
			public const int qOlskeaIzbBDgnMSqRmCqCsQvdmM = 4;

			public vRiOjWoGMaJiCNohERMEeCehFWPV GVfRRrTangJJpUpyVLuCGtZKSjGF;

			public readonly IXboxOneInputSource eCFmQKkNFLKQUghnHHIIxLTVIpcn;

			public readonly bool hvQrlRupxZcarbhjeiuASXTQVtIj;

			public AcLaevKzLHbQUeHSFzpRmUDZnjao(bool P_0, IXboxOneInputSource P_1, vRiOjWoGMaJiCNohERMEeCehFWPV P_2)
			{
			}
		}

		private AcLaevKzLHbQUeHSFzpRmUDZnjao rdCsAqjhRhcmmGKVmPlegTeDMVXE;

		private TimerAbs[] WWrAwcGBcNRYujnZZihQhwhubVtF;
		...
		private void VdkubgtnQjtbfFJcNNSsTBLTlsPQ()
		{
		}

		private void oGCpyfDohBPNgvrjGWJuTZwTYaDB(XboxOneGamepadMotorType P_0, float P_1, float P_2)
		{
		}

		private void TbNYVkkFJmJqTkaszngclpssSjzD()
		{
		}
	}
}
