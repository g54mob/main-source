...
namespace Rewired.Platforms.Custom
{
	public abstract class CustomPlatformUnifiedKeyboardSource : CustomPlatformUnifiedControllerSource
	{
		public sealed class KeyPropertyMap
		{
			...
			private IndexedDictionary<int, string> ONuvMNNXPTdCIFDGTeLVCVfLVUDPA;

			private bool BqiUwAQkrwiDYmZywXPCiSzqeSDg;

			internal bool nZzrXGKDmZMuncHuWocCTWobLXOG
			{
				get
				{
					return false;
		...
		private KeyPropertyMap BHafPgdzEEOqlqWYrwoivefpvgRw;
		...
		internal override void oBuWdYzjKfdEcmeyqODFALpfbfCN()
		{
		}

		private void AtrHygGpkzbpQiGSxdjJEbxphKwjb()
		{
		}
	}
}
