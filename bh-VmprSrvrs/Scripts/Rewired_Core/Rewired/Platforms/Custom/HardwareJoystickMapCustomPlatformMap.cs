...
namespace Rewired.Platforms.Custom
{
	...
	{
		private sealed class cJKAwzQIfPbITFtKvdfPjdUamZXyA : IEnumerable<HardwareJoystickMap.Platform_Custom.Axis>, IEnumerable, IEnumerator<HardwareJoystickMap.Platform_Custom.Axis>, IEnumerator, IDisposable
		{
			private int ExGKmbzFnwAYQzJrPbEnLRTSkGJT;

			private HardwareJoystickMap.Platform_Custom.Axis ogYWQanbTsinBfqdcoYGhXdoOFkE;

			private int EfpCtDXFfvyrORnoHrtaypmSmYEf;

			public HardwareJoystickMapCustomPlatformMap<TMatchingCriteria> oJIMafJcJVFXuFHSJCspCpZqMpCy;

			private int vkOaJUfEwuqSuseeKKjGEQLlLkbib;
			...
			[DebuggerHidden]
			public cJKAwzQIfPbITFtKvdfPjdUamZXyA(int P_0)
			{
			}
		...
		private sealed class NowBnxtIbIySqqDCxuaXzDQHNIFQ : IEnumerable<HardwareJoystickMap.Platform_Custom.Button>, IEnumerable, IEnumerator<HardwareJoystickMap.Platform_Custom.Button>, IEnumerator, IDisposable
		{
			private int JvIwOiDWbWbQnlPfUnSettXXTTxv;

			private HardwareJoystickMap.Platform_Custom.Button VwlQDnythAoiDcbeYuMSWcnIJnTb;

			private int xFabEZSNTrAaxgyjboSTXvOjJFls;

			public HardwareJoystickMapCustomPlatformMap<TMatchingCriteria> wBXOgiAbiWoeQibvgSBIGmTaYbQB;

			private int lsMfARdAHqjmViZRhfpvCBgpMBVqB;
			...
			[DebuggerHidden]
			public NowBnxtIbIySqqDCxuaXzDQHNIFQ(int P_0)
			{
			}
		...
		[IteratorStateMachine(typeof(HardwareJoystickMapCustomPlatformMap<>.cJKAwzQIfPbITFtKvdfPjdUamZXyA))]
		internal override IEnumerable<HardwareJoystickMap.Platform_Custom.Axis> IterateAxes()
		{
			return null;
		}

		[IteratorStateMachine(typeof(HardwareJoystickMapCustomPlatformMap<>.NowBnxtIbIySqqDCxuaXzDQHNIFQ))]
