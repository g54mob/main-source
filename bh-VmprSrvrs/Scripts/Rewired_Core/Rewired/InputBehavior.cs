...
namespace Rewired
{
	...
	public sealed class InputBehavior
	{
		...
		internal SerializedObject FwYmlbWhbrzbtYViapEFYueeFft()
		{
			return null;
		}

		internal void AUXbIkzuiKXdvQhRXejIDODghnkib(SerializedObject P_0)
		{
		}

		private static void zgstFBXZWAkQKmVhsYTRJxlmHsEb(InputBehavior P_0, InputBehavior P_1, bool P_2)
		{
		}
	}
}
