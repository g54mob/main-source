...
namespace Rewired.Data.Mapping
{
	...
	internal interface IHardwareControllerTemplateMap_Internal
	{
		...
		aiXCuJzvMdwQePgyTGrMKoxTlbNY GetAxisTarget(Controller controller, int elementIdentifierId);

		aiXCuJzvMdwQePgyTGrMKoxTlbNY GetButtonTarget(Controller controller, int elementIdentifierId);
	}
}
