...
namespace Rewired.Data.Mapping
{
	public sealed class HardwareJoystickTemplateMap : HardwareControllerTemplateMap, IHardwareControllerTemplateMap, IHardwareControllerTemplateMap_Internal, IHardwareControllerMap, IHardwareControllerMap_Internal
	{
		...
		private sealed class zgjYgfSBGmJYrITAMeNnclZtvukT : IEnumerable<IControllerElementIdentifierCommon_Internal>, IEnumerable, IEnumerator<IControllerElementIdentifierCommon_Internal>, IEnumerator, IDisposable
		{
			private int ooUnxEFBUNpKaisLOvKFomVwwzeh;

			private IControllerElementIdentifierCommon_Internal EVKKluEdBlGpjVZrIsrirptHepSCA;

			private int axOmwsaDEUewLUlCvHVRHwaYCVhW;

			public HardwareJoystickTemplateMap IRbWZOvqCyYKDeewtAKGGAqeDPHHA;

			private int XLzgbsRASlGsRanCzEWvwhcIiEGn;
			...
			[DebuggerHidden]
			public zgjYgfSBGmJYrITAMeNnclZtvukT(int P_0)
			{
			}
		...
		private sealed class DlhghpErjFDLpEOcdTkkbcVwKchHB : IEnumerable<ControllerTemplateElementIdentifier>, IEnumerable, IEnumerator<ControllerTemplateElementIdentifier>, IEnumerator, IDisposable
		{
			private int SNgkYqAQRttexFBvnztRKmhDPwBO;

			private ControllerTemplateElementIdentifier PsKhPnknxuftVqnMKjEORbGNaPNd;

			private int EuDQdvHGcOwcRHHsPQaSAnTlVqOc;

			public HardwareJoystickTemplateMap NDMhJlkKjctOzCTjSlhjDSzhfbvp;

			private int HXwxAEJKBweqrHmxYGcwOaiIGwhD;
			...
			[DebuggerHidden]
			public DlhghpErjFDLpEOcdTkkbcVwKchHB(int P_0)
			{
			}
		...
		[NonSerialized]
		private Func<Guid, Entry> OKhAkjEFsceXUrHJKaimQcSdUGuHA;
		...
		{
			[IteratorStateMachine(typeof(DlhghpErjFDLpEOcdTkkbcVwKchHB))]
			get
			{
				return null;
			}
		...
		{
			[IteratorStateMachine(typeof(zgjYgfSBGmJYrITAMeNnclZtvukT))]
			get
			{
				return null;
			}
		...
		private Func<Guid, Entry> EtPlOKWsukkpdItAwWxkIvgJWMUu => null;
		...
		internal bool jdzsTgQUqLLjAyCQWhHfNNDdAOon(ControllerMap_Editor P_0, HardwareJoystickMap P_1, Guid P_2, out string P_3)
		{
			P_3 = null;
			return false;
		}

		internal NrzRMZtpwBYsRYBDroszOSHvSgOn XWswGIcWoGslAWpaErgNsJWOGBws()
		{
			return null;
		}

		private Entry csStYqkzpIdWBXbblAtHTjPJQVtW(Guid P_0)
		{
			return null;
		}
		...
		aiXCuJzvMdwQePgyTGrMKoxTlbNY IHardwareControllerTemplateMap_Internal.GetAxisTarget(Controller controller, int elementIdentifierId)
		{
			return null;
		}

		aiXCuJzvMdwQePgyTGrMKoxTlbNY IHardwareControllerTemplateMap_Internal.GetButtonTarget(Controller controller, int elementIdentifierId)
		{
			return null;
		}

		internal static aiXCuJzvMdwQePgyTGrMKoxTlbNY CEvVYfHgYPPnggDMHaUCPuSYHUsb(IHardwareControllerTemplateMap_Internal P_0, Controller P_1, int P_2, Func<Guid, Entry> P_3)
		{
			return null;
		}

		internal static aiXCuJzvMdwQePgyTGrMKoxTlbNY zwkXXOGlpLchXuWdZmPYseKeDeQIA(IHardwareControllerTemplateMap_Internal P_0, Controller P_1, int P_2, Func<Guid, Entry> P_3)
		{
			return null;
		}

		internal static ControllerTemplateElementIdentifier zzPCXZARSAUAyxLRvpQbAhJGyqNW(ControllerTemplateElementIdentifier[] P_0, int P_1)
		{
			return null;
		}

		internal static int WRwKHVJyEzKJkHjTYcmTEiMpSzQU(ControllerTemplateElementIdentifier[] P_0, int P_1)
		{
			return 0;
		}

		internal static bool vHVDgEhRlbtlZgjCqAdHGqAPRBlxA(ControllerTemplateElementIdentifier[] P_0, int P_1)
		{
			return false;
		}
	}
