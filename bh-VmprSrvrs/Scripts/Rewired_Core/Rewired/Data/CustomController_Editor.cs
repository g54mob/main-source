...
namespace Rewired.Data
{
	...
	public sealed class CustomController_Editor
	{
		...
		private sealed class yHvFoGAtZMrFllbIbYdGfIFKPyDzA : IEnumerable<ControllerElementIdentifier>, IEnumerable, IEnumerator<ControllerElementIdentifier>, IEnumerator, IDisposable
		{
			private int heKrdKkqfZywbHpXYSZaprONetvH;

			private ControllerElementIdentifier oPGOwwAQpPHqFXgEJbYtbGvYDHxD;

			private int sHHdsUKtXnzaNfYXFROUwAdkgfFJA;

			public CustomController_Editor gvUjhbYZnbZgvcnFyhfAyWTpSnTl;

			private int VQJhHPlwekkDhVmNUjeUAgDxUcjU;
			...
			[DebuggerHidden]
			public yHvFoGAtZMrFllbIbYdGfIFKPyDzA(int P_0)
			{
			}
		...
		{
			[IteratorStateMachine(typeof(yHvFoGAtZMrFllbIbYdGfIFKPyDzA))]
			get
			{
				return null;
			}
		...
		private void aZgpJoCxXDmYDXkKaqmvsVISPhjv<_0001>(int P_0, List<_0001> P_1) where _0001 : Element
		{
		}

		private ControllerElementIdentifier mTercSbROCawHwxSlkZwgSoaKvcm(int P_0, string P_1)
		{
			return null;
		}

		private Element flJOZxFpfckXclxDpDntRTaUGiVx(ControllerElementType P_0)
		{
			return null;
		}

		private ControllerElementIdentifier bwqVEksWBwqUBsXJyDFTKHwIButO(ControllerElementType P_0, string P_1, string P_2, string P_3, string P_4, string P_5, string P_6)
		{
			return null;
		}
