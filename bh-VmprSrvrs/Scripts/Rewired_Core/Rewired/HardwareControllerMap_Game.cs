...
namespace Rewired
{
	...
	{
		private enum SEHYmXqYvbGUKYMPeaRZpwjCBPiS
		{
			Error = 0,
			FoundIndex = 1,
			IsWholeElement = 2
		...
		private readonly DeviceLocalizationInfo DeSVkzbEbskEpqApVsaeGfpWkwGH;
		...
		private int RkAEepJsXPJldHRpxvOsqvGWaTXfb(ControllerElementIdentifier[] P_0, int P_1)
		{
			return 0;
		}

		private static SEHYmXqYvbGUKYMPeaRZpwjCBPiS novOGeiMhDWtQQHqjFekTEjZiaKu(HardwareJoystickMap.CompoundElement P_0, ControllerElementIdentifier P_1, IList<ActionElementMap> P_2, out int P_3)
		{
			P_3 = default(int);
			return default(SEHYmXqYvbGUKYMPeaRZpwjCBPiS);
		}
	}
}
