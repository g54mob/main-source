...
{
	public class CreateEntityRequest : RequestInfo
	{
		private ICoherenceComponentData[] comps;

		public CreateEntityRequest(Entity entity, uint participant, FloatingOrigin origin, EntityMeta meta, bool isInternal, ICoherenceComponentData[] comps)
