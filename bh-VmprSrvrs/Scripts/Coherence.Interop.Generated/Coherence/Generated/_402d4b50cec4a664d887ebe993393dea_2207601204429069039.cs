...
{
	public struct _402d4b50cec4a664d887ebe993393dea_2207601204429069039 : ICoherenceComponentData
	{
		...
		public unsafe static _402d4b50cec4a664d887ebe993393dea_2207601204429069039 FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(_402d4b50cec4a664d887ebe993393dea_2207601204429069039);
		}
		...
		public static uint Serialize(_402d4b50cec4a664d887ebe993393dea_2207601204429069039 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Coherence.Log.Logger logger)
		{
			return 0u;
		}

		public static _402d4b50cec4a664d887ebe993393dea_2207601204429069039 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
		{
			return default(_402d4b50cec4a664d887ebe993393dea_2207601204429069039);
		}
