...
{
	public struct _d9e670cbbae31d541a45dd148cc1cfff_4788220166898907604 : ICoherenceComponentData
	{
		...
		public unsafe static _d9e670cbbae31d541a45dd148cc1cfff_4788220166898907604 FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(_d9e670cbbae31d541a45dd148cc1cfff_4788220166898907604);
		}
		...
		public static uint Serialize(_d9e670cbbae31d541a45dd148cc1cfff_4788220166898907604 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Coherence.Log.Logger logger)
		{
			return 0u;
		}

		public static _d9e670cbbae31d541a45dd148cc1cfff_4788220166898907604 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
		{
			return default(_d9e670cbbae31d541a45dd148cc1cfff_4788220166898907604);
		}
