...
namespace Coherence.Generated
{
	public struct ArchetypeComponent : ICoherenceComponentData
	{
		...
		private static readonly int _index_Min;

		private static readonly int _index_Max;

		public static uint indexMask => 0u;
		...
		public unsafe static ArchetypeComponent FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(ArchetypeComponent);
		}
