...
{
	public struct _ea0b5d709666b184698de4af947a8def_3806321953852711517 : ICoherenceComponentData
	{
		...
		public AbsoluteSimulationFrame ContainerRotationSimulationFrame;
		...
		public static uint ContainerRotationMask => 0u;
		...
		public unsafe static _ea0b5d709666b184698de4af947a8def_3806321953852711517 FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(_ea0b5d709666b184698de4af947a8def_3806321953852711517);
		}
		...
		public static uint Serialize(_ea0b5d709666b184698de4af947a8def_3806321953852711517 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Coherence.Log.Logger logger)
		{
			return 0u;
		}

		public static _ea0b5d709666b184698de4af947a8def_3806321953852711517 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
		{
			return default(_ea0b5d709666b184698de4af947a8def_3806321953852711517);
		}
