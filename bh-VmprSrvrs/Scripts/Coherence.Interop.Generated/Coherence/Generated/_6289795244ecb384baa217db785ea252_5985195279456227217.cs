...
{
	public struct _6289795244ecb384baa217db785ea252_5985195279456227217 : ICoherenceComponentData
	{
		...
		public AbsoluteSimulationFrame LegionBossSimulationFrame;
		...
		public static uint LegionBossMask => 0u;
		...
		public unsafe static _6289795244ecb384baa217db785ea252_5985195279456227217 FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(_6289795244ecb384baa217db785ea252_5985195279456227217);
		}
		...
		public static uint Serialize(_6289795244ecb384baa217db785ea252_5985195279456227217 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
		{
			return 0u;
		}

		public static _6289795244ecb384baa217db785ea252_5985195279456227217 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
		{
			return default(_6289795244ecb384baa217db785ea252_5985195279456227217);
		}
