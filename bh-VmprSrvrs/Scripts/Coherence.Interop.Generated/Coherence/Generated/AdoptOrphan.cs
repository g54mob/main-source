...
{
	public struct AdoptOrphan : IEntityCommand, IEntityMessage, IBaseRequest
	{
		...
		public static AdoptOrphan FromInterop(IntPtr data, int dataSize)
		{
			return default(AdoptOrphan);
		}
