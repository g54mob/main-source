...
namespace Coherence.Generated
{
	public struct WorldPosition : ICoherenceComponentData
	{
		...
		public unsafe static WorldPosition FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(WorldPosition);
		}
		...
		public static uint Serialize(WorldPosition data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Coherence.Log.Logger logger)
		{
			return 0u;
		}
