...
{
	public struct _e4dddf95fdbf66f4385e3ab9ece2db40_4868635461600400376 : ICoherenceComponentData
	{
		...
		public unsafe static _e4dddf95fdbf66f4385e3ab9ece2db40_4868635461600400376 FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(_e4dddf95fdbf66f4385e3ab9ece2db40_4868635461600400376);
		}
		...
		public static uint Serialize(_e4dddf95fdbf66f4385e3ab9ece2db40_4868635461600400376 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
		{
			return 0u;
		}

		public static _e4dddf95fdbf66f4385e3ab9ece2db40_4868635461600400376 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
		{
			return default(_e4dddf95fdbf66f4385e3ab9ece2db40_4868635461600400376);
		}
