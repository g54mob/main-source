...
namespace Coherence.Generated
{
	public struct GenericScale : ICoherenceComponentData
	{
		...
		public unsafe static GenericScale FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(GenericScale);
		}
		...
		public static uint Serialize(GenericScale data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Coherence.Log.Logger logger)
		{
			return 0u;
		}
