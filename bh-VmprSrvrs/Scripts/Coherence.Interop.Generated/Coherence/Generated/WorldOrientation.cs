...
namespace Coherence.Generated
{
	public struct WorldOrientation : ICoherenceComponentData
	{
		...
		public unsafe static WorldOrientation FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(WorldOrientation);
		}
		...
		public static uint Serialize(WorldOrientation data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Coherence.Log.Logger logger)
		{
			return 0u;
		}
