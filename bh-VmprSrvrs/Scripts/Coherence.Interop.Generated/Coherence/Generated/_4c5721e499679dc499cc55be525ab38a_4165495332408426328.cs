...
{
	public struct _4c5721e499679dc499cc55be525ab38a_4165495332408426328 : ICoherenceComponentData
	{
		...
		public AbsoluteSimulationFrame NameIndexSimulationFrame;

		public int NameIndex;

		public AbsoluteSimulationFrame InitializationSeedSimulationFrame;
		...
		private static readonly int _NameIndex_Min;

		private static readonly int _NameIndex_Max;

		private static readonly uint _InitializationSeed_Min;

		private static readonly uint _InitializationSeed_Max;
		...
		public static uint NameIndexMask => 0u;

		public static uint InitializationSeedMask => 0u;
		...
		public unsafe static _4c5721e499679dc499cc55be525ab38a_4165495332408426328 FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(_4c5721e499679dc499cc55be525ab38a_4165495332408426328);
		}
		...
		public static uint Serialize(_4c5721e499679dc499cc55be525ab38a_4165495332408426328 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Coherence.Log.Logger logger)
		{
			return 0u;
		}

		public static _4c5721e499679dc499cc55be525ab38a_4165495332408426328 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
		{
			return default(_4c5721e499679dc499cc55be525ab38a_4165495332408426328);
		}
