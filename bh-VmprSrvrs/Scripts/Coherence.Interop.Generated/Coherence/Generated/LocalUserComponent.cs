...
namespace Coherence.Generated
{
	public struct LocalUserComponent : ICoherenceComponentData
	{
		...
		private static readonly int _localIndex_Min;

		private static readonly int _localIndex_Max;

		public static uint localIndexMask => 0u;
		...
		public unsafe static LocalUserComponent FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(LocalUserComponent);
		}
