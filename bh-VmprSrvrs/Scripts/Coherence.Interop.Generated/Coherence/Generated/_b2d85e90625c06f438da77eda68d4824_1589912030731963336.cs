...
{
	public struct _b2d85e90625c06f438da77eda68d4824_1589912030731963336 : ICoherenceComponentData
	{
		...
		public unsafe static _b2d85e90625c06f438da77eda68d4824_1589912030731963336 FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(_b2d85e90625c06f438da77eda68d4824_1589912030731963336);
		}
		...
		public static uint Serialize(_b2d85e90625c06f438da77eda68d4824_1589912030731963336 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
		{
			return 0u;
		}

		public static _b2d85e90625c06f438da77eda68d4824_1589912030731963336 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
		{
			return default(_b2d85e90625c06f438da77eda68d4824_1589912030731963336);
		}
