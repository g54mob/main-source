...
{
	public struct _5e3e58d5412a64640aa3c145df0b642b_7160516005762501834 : ICoherenceComponentData
	{
		...
		public unsafe static _5e3e58d5412a64640aa3c145df0b642b_7160516005762501834 FromInterop(IntPtr data, int dataSize, InteropAbsoluteSimulationFrame* simFrames, int simFramesCount)
		{
			return default(_5e3e58d5412a64640aa3c145df0b642b_7160516005762501834);
		}
		...
		public static uint Serialize(_5e3e58d5412a64640aa3c145df0b642b_7160516005762501834 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Coherence.Log.Logger logger)
		{
			return 0u;
		}

		public static _5e3e58d5412a64640aa3c145df0b642b_7160516005762501834 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
		{
			return default(_5e3e58d5412a64640aa3c145df0b642b_7160516005762501834);
		}
