...
namespace Rewired.HID.Drivers
{
	...
	internal abstract class HIDDeviceDriver : IControllerDriver, IDisposable
	{
		...
		internal interface IHIDDevice
		{
			...
			bool WriteSync(kotbTAfQioNEwLHSkuVgCDNCKFGrA outputReport, int timeoutMs);

			void WriteAsync(kotbTAfQioNEwLHSkuVgCDNCKFGrA outputReport, int timeoutMs);
		...
		internal class InitArgs
		{
			...
			public readonly UGTokEHpGHxdrwhYtrRotjdnHkVm connectionType;
			...
			public InitArgs(UpdateLoopSetting P_0, UGTokEHpGHxdrwhYtrRotjdnHkVm P_1, int P_2, int P_3, int P_4, int P_5, IHIDDevice P_6)
			{
			}
		}

		public yUpmddYZxByfYuymhaMOQvhogGlH[] axes;

		public RcrZanYwzmrXefXHYHqIESnojeKG[] buttons;

		public CAqpMOqcVrmWxGjvEEUtRVKepEjD[] hats;

		public vwKWZKGHIrUPHDbcupgKaBrjLBLK[] accelerometers;

		public xWLdBqQUVoBsyEoHRMNAPSsWHYdgb[] gyroscopes;

		public ZgmSdKScSeDYiGUNgbCGiBZRFYxC[] touchpads;

		public icJskIjKvcpxXLDpPSZxPfQTKoDM[] vibrationMotors;

		public xWZdekXxSTqoxGRbaQvEqPeLwGCw[] lights;

		private bool ZpTfzDbcWCNqHELTyNmCrmqifRPwA;
