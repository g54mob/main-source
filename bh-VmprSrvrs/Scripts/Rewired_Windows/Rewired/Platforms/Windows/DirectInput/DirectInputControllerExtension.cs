...
namespace Rewired.Platforms.Windows.DirectInput
{
	...
	{
		private class thJMPHgDXqylNeIJvpECpntMeMXu : IControllerExtensionSource
		{
			private SlQHoauNubwsefElKGcPhZbhwDwPA NmCqJSTJPVAwrIHZwbAMvdPFmPzF;

			private tagSHrTMjnJCYXrGQJFNbveiUKgJ ansZNYPpQrHYwOfDoPxnOIMCffPG;

			public SlQHoauNubwsefElKGcPhZbhwDwPA jGKSayYktEXwhrOsSseGgDbswimM => null;

			public tagSHrTMjnJCYXrGQJFNbveiUKgJ yhBCjmmzPUUUvaXzhlyqDuTzVyKC => null;

			public thJMPHgDXqylNeIJvpECpntMeMXu(SlQHoauNubwsefElKGcPhZbhwDwPA P_0, tagSHrTMjnJCYXrGQJFNbveiUKgJ P_1)
			{
			}
		}

		private thJMPHgDXqylNeIJvpECpntMeMXu ZvSfGhAjXUpsCcYTECYhNWZHdvEjA;

		private bool vVBEgbBqaVAkNSOGDYIeHZNMCHJEA;
		...
		internal DirectInputControllerExtension(SlQHoauNubwsefElKGcPhZbhwDwPA P_0, tagSHrTMjnJCYXrGQJFNbveiUKgJ P_1)
		{
		}
