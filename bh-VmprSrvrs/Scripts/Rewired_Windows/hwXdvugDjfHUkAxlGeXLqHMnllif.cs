internal class hwXdvugDjfHUkAxlGeXLqHMnllif
{
	public static class PkCANGikGHCOXqEmuuICmPmDERONA
	{
		public enum JKGTUxqIRgIJipuaPIDQlQfPeXbO : ushort
		{
			Undefined = 0,
			Pointer = 1,
			Mouse = 2,
		...
		public static bool KCRtpJfetnTmyCEdDOZGQbsajdJM(ushort P_0)
		{
			return false;
		}

		public static bool yUmslIKsjFaOOOuroWmvuCasCbEFA(ushort P_0)
		{
			return false;
		}

		public static bool jBfxdopKBiJkvHYZFMkYfRaWVxUn(ushort P_0)
		{
			return false;
		}
	}

	public static class VwfYzSICRBRAZESJzsDJOcQrgZphA
	{
		public enum tJZWXEgZFWJodNNgoMMoMBSxVOBp : ushort
		{
			Aileron = 176,
			AileronTrim = 177,
		...
		public static bool mfobWuAEsDiuGQvojPhmeEhayrfqA(ushort P_0)
		{
			return false;
		}

		public static bool AVmffmhcjWkWvADIaizHJEKplJNGA(ushort P_0)
		{
			return false;
		}
	}

	public static class gpPTBIwGpDEBngrTKPvxgTXaHvuwB
	{
		public enum eDlOgWXjifDKBLmjyqXXVAWOpAlE : ushort
		{
			ConsumerControl = 1,
			NumericKeyPad = 2,
		...
		public static bool WosqIMEtVgVVIxDMOBZNvXgyBqVP(ushort P_0)
		{
			return false;
		}

		public static bool mWejzCRLjdsRxojIHzzXmjOBOfjJ(ushort P_0)
		{
			return false;
		}
	}

	public static class TvxiKvLZBCwMZKqxVHidmEylrBdy
	{
		public enum nEWCfeBrenMgGeqICzqYrijGPrIu : ushort
		{
			_3DGameController = 1,
			PinballDevice = 2,
			GunDevice = 3,
		...
		public static bool LnwiZxuRsNAveQryRQFGLopucMVL(ushort P_0)
		{
			return false;
		}

		public static bool shIKUuwMbRGuWSEKlSbDPaLOCOaQ(ushort P_0)
		{
			return false;
		}
	}

	public const ushort KknbTLWuXjwkmpBZmIYMYZQPKpGu = 1;

	public const ushort tqJJiPSyyfiGLqpTdkvoMkcfxtNo = 2;

	public const ushort HqIVencPGUGfpWqMKAbbVQkYpVPH = 5;

	public const ushort WlKATkCFYzKMyoLWKdnSuqOuhwFdb = 9;

	public const ushort pRLGpNbstXFoEdgZAuwkUXBmKzTq = 12;

	public static bool ZklkcfRwMumIpgevuUdHIkqHqUjb(ushort P_0, ushort P_1)
	{
		return false;
	}

	public static bool OIDbmFABjcwDxxOhYhFwHXFacesAA(ushort P_0, ushort P_1)
	{
		return false;
	}

	public static bool AHIaYWhhwzpnXNCKcUJupdqCjFGZA(ushort P_0, ushort P_1)
	{
		return false;
	}

	public static bool dztZROQPqwfGIBsphKcLxSrsrnGN(ushort P_0)
	{
		return false;
	}

	public static bool CikELPxgixCcgnZKqdYKElkmxfHB(ushort P_0)
	{
		return false;
	}

	public static bool iRobaUnOQXmVHbhOFXWsAhYvyBHB(ushort P_0)
	{
		return false;
	}

	public static bool ouYOrNptAKWMElOWUeAebdZBNaXx(ushort P_0, ushort P_1)
	{
		return false;
	}
}
