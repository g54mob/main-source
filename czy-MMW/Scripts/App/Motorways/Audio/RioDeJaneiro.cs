...
namespace Motorways.Audio
{
	public class RioDeJaneiro : MusicData
	{
		...
		{
			SetQualities(Liszt.Flatten<Quality>(QualityDatabase.Gather("Min7", "Min7b5", "Maj6", "Maj7", "7", "Min9", "b7sus", "7#9", "11", "13", "Min11"), Liszt.From<Quality>(QualityDatabase.PENTA.Chromatic(), QualityDatabase.PENTA_DOM.Chromatic())));
