...
namespace Rewired
{
	...
	public sealed class AxisCalibration
	{
		...
		{
			0,
			AxisCalibrationInfo.fRwACZPkPJFFPHdznyjATMKUJxsdb(AxisCalibrationData.Default)
		} };
		...
		private void CreateDefaultHardwareCalibration(AxisCalibrationData defaultData)
		{
			...
			{
				AxisCalibrationInfo value = AxisCalibrationInfo.fRwACZPkPJFFPHdznyjATMKUJxsdb(defaultData);
