...
namespace Rewired.Data.Mapping
{
	...
	public class AxisCalibrationInfo : IDeepCloneable
	{
		...
		internal static AxisCalibrationData rCTbaTGXlxjlUompujsOBctDPsgjB(AxisCalibrationInfo P_0)
		{
			if (P_0 == null)
			{
		...
		internal static AxisCalibrationInfo fRwACZPkPJFFPHdznyjATMKUJxsdb(AxisCalibrationData P_0)
		{
