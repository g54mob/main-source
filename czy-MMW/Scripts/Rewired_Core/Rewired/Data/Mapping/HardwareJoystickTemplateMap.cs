...
namespace Rewired.Data.Mapping
{
	public sealed class HardwareJoystickTemplateMap : HardwareControllerTemplateMap, IHardwareControllerTemplateMap, IHardwareControllerTemplateMap_Internal, IHardwareControllerMap, IHardwareControllerMap_Internal
	{
		...
		private sealed class vQVBkhuUFhAGrBHXHhsBXIvSqrekA : IEnumerable<IControllerElementIdentifierCommon_Internal>, IEnumerable, IEnumerator<IControllerElementIdentifierCommon_Internal>, IEnumerator, IDisposable
		{
			private int SZaXJPUJjKctdyOQdsijGqVsdDIk;

			private IControllerElementIdentifierCommon_Internal ureAEZaOXZRwmFBOiQwmpmnvlXxvA;

			private int YefiZFPgiVxHAXSQgHMhJtHzHYVg;

			public HardwareJoystickTemplateMap IAYZxXJcAIfTYHGxKNEnSuAyuiaZ;

			private int ZCHbzbVyDRZmksvtQSZLLlQiHWWi;
			...
			IControllerElementIdentifierCommon_Internal IEnumerator<IControllerElementIdentifierCommon_Internal>.Current
			{
				...
				get
				{
					return ureAEZaOXZRwmFBOiQwmpmnvlXxvA;
				}
			}
			...
			[DebuggerHidden]
			public vQVBkhuUFhAGrBHXHhsBXIvSqrekA(int P_0)
			{
				SZaXJPUJjKctdyOQdsijGqVsdDIk = P_0;
				YefiZFPgiVxHAXSQgHMhJtHzHYVg = Environment.CurrentManagedThreadId;
			}
			...
			{
				int sZaXJPUJjKctdyOQdsijGqVsdDIk = SZaXJPUJjKctdyOQdsijGqVsdDIk;
				HardwareJoystickTemplateMap iAYZxXJcAIfTYHGxKNEnSuAyuiaZ = IAYZxXJcAIfTYHGxKNEnSuAyuiaZ;
				switch (sZaXJPUJjKctdyOQdsijGqVsdDIk)
				{
				default:
					return false;
				case 0:
					SZaXJPUJjKctdyOQdsijGqVsdDIk = -1;
					if (iAYZxXJcAIfTYHGxKNEnSuAyuiaZ.elementIdentifiers == null)
					{
						return false;
					}
					ZCHbzbVyDRZmksvtQSZLLlQiHWWi = 0;
					break;
				case 1:
					SZaXJPUJjKctdyOQdsijGqVsdDIk = -1;
					ZCHbzbVyDRZmksvtQSZLLlQiHWWi++;
					break;
				}
				if (ZCHbzbVyDRZmksvtQSZLLlQiHWWi < iAYZxXJcAIfTYHGxKNEnSuAyuiaZ.elementIdentifiers.Length)
				{
					ureAEZaOXZRwmFBOiQwmpmnvlXxvA = iAYZxXJcAIfTYHGxKNEnSuAyuiaZ.elementIdentifiers[ZCHbzbVyDRZmksvtQSZLLlQiHWWi];
					SZaXJPUJjKctdyOQdsijGqVsdDIk = 1;
					return true;
				}
				return false;
			...
			{
				vQVBkhuUFhAGrBHXHhsBXIvSqrekA vQVBkhuUFhAGrBHXHhsBXIvSqrekA2;
				if (SZaXJPUJjKctdyOQdsijGqVsdDIk == -2 && YefiZFPgiVxHAXSQgHMhJtHzHYVg == Environment.CurrentManagedThreadId)
				{
					SZaXJPUJjKctdyOQdsijGqVsdDIk = 0;
					vQVBkhuUFhAGrBHXHhsBXIvSqrekA2 = this;
				}
				else
				{
					vQVBkhuUFhAGrBHXHhsBXIvSqrekA2 = new vQVBkhuUFhAGrBHXHhsBXIvSqrekA(0);
					vQVBkhuUFhAGrBHXHhsBXIvSqrekA2.IAYZxXJcAIfTYHGxKNEnSuAyuiaZ = IAYZxXJcAIfTYHGxKNEnSuAyuiaZ;
				}
				return vQVBkhuUFhAGrBHXHhsBXIvSqrekA2;
			}
		...
		private sealed class qqcRrQEwqCwOfmrfmmUeYqUXAYhhA : IEnumerable<ControllerTemplateElementIdentifier>, IEnumerable, IEnumerator<ControllerTemplateElementIdentifier>, IEnumerator, IDisposable
		{
			private int OxFckugmVTEtPCPLKnhMytNUyyKKB;

			private ControllerTemplateElementIdentifier UFlyaoFXivqtnLmawqawqFXhSYQT;

			private int HcFjnZCWFRxoiWxRhTxwFEdIpALDA;

			public HardwareJoystickTemplateMap ITegSsHpEUcciSawKUoaUulAouqeA;

			private int wEcTEdTZuGJrIUNpExslbLesSMZG;
			...
			ControllerTemplateElementIdentifier IEnumerator<ControllerTemplateElementIdentifier>.Current
			{
				...
				get
				{
					return UFlyaoFXivqtnLmawqawqFXhSYQT;
				}
			}
			...
			[DebuggerHidden]
			public qqcRrQEwqCwOfmrfmmUeYqUXAYhhA(int P_0)
			{
				OxFckugmVTEtPCPLKnhMytNUyyKKB = P_0;
				HcFjnZCWFRxoiWxRhTxwFEdIpALDA = Environment.CurrentManagedThreadId;
			}
			...
			private bool MoveNext()
			{
				int oxFckugmVTEtPCPLKnhMytNUyyKKB = OxFckugmVTEtPCPLKnhMytNUyyKKB;
				HardwareJoystickTemplateMap iTegSsHpEUcciSawKUoaUulAouqeA = ITegSsHpEUcciSawKUoaUulAouqeA;
				switch (oxFckugmVTEtPCPLKnhMytNUyyKKB)
				{
				default:
					return false;
				case 0:
					OxFckugmVTEtPCPLKnhMytNUyyKKB = -1;
					if (iTegSsHpEUcciSawKUoaUulAouqeA.elementIdentifiers == null)
					{
						return false;
					}
					wEcTEdTZuGJrIUNpExslbLesSMZG = 0;
					break;
				case 1:
					OxFckugmVTEtPCPLKnhMytNUyyKKB = -1;
					wEcTEdTZuGJrIUNpExslbLesSMZG++;
					break;
				}
				if (wEcTEdTZuGJrIUNpExslbLesSMZG < iTegSsHpEUcciSawKUoaUulAouqeA.elementIdentifiers.Length)
				{
					UFlyaoFXivqtnLmawqawqFXhSYQT = iTegSsHpEUcciSawKUoaUulAouqeA.elementIdentifiers[wEcTEdTZuGJrIUNpExslbLesSMZG];
					OxFckugmVTEtPCPLKnhMytNUyyKKB = 1;
					return true;
				}
				return false;
			...
			{
				qqcRrQEwqCwOfmrfmmUeYqUXAYhhA qqcRrQEwqCwOfmrfmmUeYqUXAYhhA2;
				if (OxFckugmVTEtPCPLKnhMytNUyyKKB == -2 && HcFjnZCWFRxoiWxRhTxwFEdIpALDA == Environment.CurrentManagedThreadId)
				{
					OxFckugmVTEtPCPLKnhMytNUyyKKB = 0;
					qqcRrQEwqCwOfmrfmmUeYqUXAYhhA2 = this;
				}
				else
				{
					qqcRrQEwqCwOfmrfmmUeYqUXAYhhA2 = new qqcRrQEwqCwOfmrfmmUeYqUXAYhhA(0);
					qqcRrQEwqCwOfmrfmmUeYqUXAYhhA2.ITegSsHpEUcciSawKUoaUulAouqeA = ITegSsHpEUcciSawKUoaUulAouqeA;
				}
				return qqcRrQEwqCwOfmrfmmUeYqUXAYhhA2;
			}
		...
		{
			[IteratorStateMachine(typeof(qqcRrQEwqCwOfmrfmmUeYqUXAYhhA))]
			get
			{
				return new qqcRrQEwqCwOfmrfmmUeYqUXAYhhA(-2)
				{
					ITegSsHpEUcciSawKUoaUulAouqeA = this
				};
			}
		}
		...
		{
			[IteratorStateMachine(typeof(vQVBkhuUFhAGrBHXHhsBXIvSqrekA))]
			get
			{
				return new vQVBkhuUFhAGrBHXHhsBXIvSqrekA(-2)
				{
					IAYZxXJcAIfTYHGxKNEnSuAyuiaZ = this
				};
			}
		}
		...
		{
			int num = XDtatwIUeZRKxKuOGQWafVHdKoRI(id);
		...
		{
			return XDtatwIUeZRKxKuOGQWafVHdKoRI(id) >= 0;
		}
		...
		internal bool nagbKCPyMpbOktJuaXntqFEuRujR(ControllerMap_Editor P_0, HardwareJoystickMap P_1, Guid P_2, out string P_3)
		{
			if (P_0 == null)
			{
			...
			Entry entry = eRRAgWJdZcXsjoADFfVVVsSCCdkZA(P_2);
			if (entry == null)
			{
				Guid guid = P_2;
				...
				using (TempListPool.TList<ElementIdentifierMap> tList2 = TempListPool.GetTList<ElementIdentifierMap>())
				{
					...
					for (int i = 0; i < actionElementMaps.Count; i++)
					{
						...
						for (int j = 0; j < list2.Count; j++)
						{
							...
							bool flag = false;
							int num = XDtatwIUeZRKxKuOGQWafVHdKoRI(elementIdentifierId);
							if (num >= 0 && num < elementIdentifiers.Length)
							{
								...
								if (elementIdentifier != null && controllerTemplateElementIdentifier_Editor != null)
								{
									...
									if (!pMvvECjJycyKibKKCAXEnFbBPTVk.LNXajvkdHdsLUXViOuqAckfqMFdj(effectiveElementType, elementIdentifier.elementType))
									{
		...
		internal ControllerTemplateElementIdentifier QhiGMgPOXyAoRyCWnohYtRzMkSLf(Guid P_0, int P_1)
		{
		...
		private Entry eRRAgWJdZcXsjoADFfVVVsSCCdkZA(Guid P_0)
		{
			if (joysticks == null)
			{
				return null;
		...
		private int XDtatwIUeZRKxKuOGQWafVHdKoRI(int P_0)
		{
		...
		agOACnagmLCXYWDIjyBWDOsYmPSu IHardwareControllerTemplateMap_Internal.GetAxisTarget(Controller controller, int elementIdentifierId)
		{
			...
			Entry entry = eRRAgWJdZcXsjoADFfVVVsSCCdkZA(controller.sfymSjcVHxtWxMcRdJtqvPLgjYLfA);
			if (entry == null)
			{
				return null;
			}
			...
			for (int i = 0; i < count; i++)
			{
				...
				if (elementIdentifierMap != null && elementIdentifierMap.templateId == elementIdentifierId)
				{
					if (elementIdentifierMap.splitAxis)
					{
						return new agOACnagmLCXYWDIjyBWDOsYmPSu(ControllerTemplateElementType.Axis, true, new VpAKgrswCxoCdmGxzoexhctSYmGI(controller, -1, AxisRange.Full), new VpAKgrswCxoCdmGxzoexhctSYmGI(controller, elementIdentifierMap.joystickId, AxisRange.Positive), new VpAKgrswCxoCdmGxzoexhctSYmGI(controller, elementIdentifierMap.joystickId2, AxisRange.Positive));
					}
					return new agOACnagmLCXYWDIjyBWDOsYmPSu(ControllerTemplateElementType.Axis, false, new VpAKgrswCxoCdmGxzoexhctSYmGI(controller, elementIdentifierMap.joystickId, AxisRange.Full), new VpAKgrswCxoCdmGxzoexhctSYmGI(controller, -1, AxisRange.Positive), new VpAKgrswCxoCdmGxzoexhctSYmGI(controller, -1, AxisRange.Positive));
				}
			}
			return null;
		}

		agOACnagmLCXYWDIjyBWDOsYmPSu IHardwareControllerTemplateMap_Internal.GetButtonTarget(Controller controller, int elementIdentifierId)
		{
			ControllerTemplateElementIdentifier elementIdentifier = GetElementIdentifier(elementIdentifierId);
			if (elementIdentifier == null)
			{
			...
			for (int i = 0; i < count; i++)
			{
				...
				if (elementIdentifierMap != null && elementIdentifierMap.templateId == elementIdentifierId)
				{
					return new agOACnagmLCXYWDIjyBWDOsYmPSu(ControllerTemplateElementType.Button, false, new VpAKgrswCxoCdmGxzoexhctSYmGI(controller, elementIdentifierMap.joystickId, AxisRange.Full), new VpAKgrswCxoCdmGxzoexhctSYmGI(controller, -1, AxisRange.Positive), new VpAKgrswCxoCdmGxzoexhctSYmGI(controller, -1, AxisRange.Positive));
				}
			}
			return null;
		}
