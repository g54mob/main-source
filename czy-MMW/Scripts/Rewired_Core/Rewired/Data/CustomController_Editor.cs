...
namespace Rewired.Data
{
	...
	public sealed class CustomController_Editor
	{
		...
		private sealed class REHNcwwTdPTzHUcsOlhoJCiCCQSq : IEnumerable<ControllerElementIdentifier>, IEnumerable, IEnumerator<ControllerElementIdentifier>, IEnumerator, IDisposable
		{
			private int XWgeBBdMmXUrFaxiFpRfqkPjPgayA;

			private ControllerElementIdentifier oHAflScFoSiTTdcBylEliYptrGbfb;

			private int FCVBwUalYrwPTKKptUNqrqzzOjWCA;

			public CustomController_Editor WFPgnKKDkUuSmGtHxDrjwhDKssnTA;

			private int NDmoKAMXlLOsxoMdGBfFIiUvptCW;
			...
			ControllerElementIdentifier IEnumerator<ControllerElementIdentifier>.Current
			{
				...
				get
				{
					return oHAflScFoSiTTdcBylEliYptrGbfb;
				}
			}
			...
			[DebuggerHidden]
			public REHNcwwTdPTzHUcsOlhoJCiCCQSq(int P_0)
			{
				XWgeBBdMmXUrFaxiFpRfqkPjPgayA = P_0;
				FCVBwUalYrwPTKKptUNqrqzzOjWCA = Environment.CurrentManagedThreadId;
			}
			...
			{
				int xWgeBBdMmXUrFaxiFpRfqkPjPgayA = XWgeBBdMmXUrFaxiFpRfqkPjPgayA;
				CustomController_Editor wFPgnKKDkUuSmGtHxDrjwhDKssnTA = WFPgnKKDkUuSmGtHxDrjwhDKssnTA;
				switch (xWgeBBdMmXUrFaxiFpRfqkPjPgayA)
				{
				default:
					return false;
				case 0:
					XWgeBBdMmXUrFaxiFpRfqkPjPgayA = -1;
					if (wFPgnKKDkUuSmGtHxDrjwhDKssnTA._elementIdentifiers == null)
					{
						return false;
					}
					NDmoKAMXlLOsxoMdGBfFIiUvptCW = 0;
					break;
				case 1:
					XWgeBBdMmXUrFaxiFpRfqkPjPgayA = -1;
					NDmoKAMXlLOsxoMdGBfFIiUvptCW++;
					break;
				}
				if (NDmoKAMXlLOsxoMdGBfFIiUvptCW < wFPgnKKDkUuSmGtHxDrjwhDKssnTA._elementIdentifiers.Count)
				{
					oHAflScFoSiTTdcBylEliYptrGbfb = wFPgnKKDkUuSmGtHxDrjwhDKssnTA._elementIdentifiers[NDmoKAMXlLOsxoMdGBfFIiUvptCW];
					XWgeBBdMmXUrFaxiFpRfqkPjPgayA = 1;
					return true;
				}
				return false;
			...
			{
				REHNcwwTdPTzHUcsOlhoJCiCCQSq rEHNcwwTdPTzHUcsOlhoJCiCCQSq;
				if (XWgeBBdMmXUrFaxiFpRfqkPjPgayA == -2 && FCVBwUalYrwPTKKptUNqrqzzOjWCA == Environment.CurrentManagedThreadId)
				{
					XWgeBBdMmXUrFaxiFpRfqkPjPgayA = 0;
					rEHNcwwTdPTzHUcsOlhoJCiCCQSq = this;
				}
				else
				{
					rEHNcwwTdPTzHUcsOlhoJCiCCQSq = new REHNcwwTdPTzHUcsOlhoJCiCCQSq(0);
					rEHNcwwTdPTzHUcsOlhoJCiCCQSq.WFPgnKKDkUuSmGtHxDrjwhDKssnTA = WFPgnKKDkUuSmGtHxDrjwhDKssnTA;
				}
				return rEHNcwwTdPTzHUcsOlhoJCiCCQSq;
			}
		...
		{
			[IteratorStateMachine(typeof(REHNcwwTdPTzHUcsOlhoJCiCCQSq))]
			get
			{
				return new REHNcwwTdPTzHUcsOlhoJCiCCQSq(-2)
				{
					WFPgnKKDkUuSmGtHxDrjwhDKssnTA = this
				};
			}
		}
		...
		public string[] GetElementIdentifierNames()
		{
			...
			for (int i = 0; i < num; i++)
			{
				array[i] = _elementIdentifiers[i].Rewired_002EInterfaces_002EIControllerElementIdentifierCommon_Internal_002Ename;
			}
			return array;
		}
		...
		public string[] GetElementIdentifierNamesTypeSorted()
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				if (num2 >= 0)
				{
					list2.Add(_elementIdentifiers[num2].Rewired_002EInterfaces_002EIControllerElementIdentifierCommon_Internal_002Ename);
				}
			}
			...
			for (int j = 0; j < num3; j++)
			{
				...
				if (num4 >= 0)
				{
					list.Add(_elementIdentifiers[num4].Rewired_002EInterfaces_002EIControllerElementIdentifierCommon_Internal_002Ename);
				}
			}
		...
		public void AddAxis()
		{
			axes.Add((Axis)hGAHnFKYBKOYSsUnXETbsyxXSMKQ(ControllerElementType.Axis));
		}

		public void AddButton()
		{
			buttons.Add((Button)hGAHnFKYBKOYSsUnXETbsyxXSMKQ(ControllerElementType.Button));
		}
		...
		public void InsertAxis(int index)
		{
			...
			axes.Insert(index, (Axis)hGAHnFKYBKOYSsUnXETbsyxXSMKQ(ControllerElementType.Axis));
		}
		...
		public void InsertButton(int index)
		{
			...
			buttons.Insert(index, (Button)hGAHnFKYBKOYSsUnXETbsyxXSMKQ(ControllerElementType.Button));
		}
		...
		public void DuplicateElement(ControllerElementType type, int index)
		{
			...
			{
			case ControllerElementType.Axis:
				aXjHdCHdtlQTnCKaQrUbXJPNILqo(index, axes);
				break;
			case ControllerElementType.Button:
				aXjHdCHdtlQTnCKaQrUbXJPNILqo(index, buttons);
				break;
			default:
				throw new NotImplementedException();
			}
		...
		private void aXjHdCHdtlQTnCKaQrUbXJPNILqo<_0001>(int P_0, List<_0001> P_1) where _0001 : Element
		{
			...
			ControllerElementIdentifier controllerElementIdentifier = opxJMcckigRzndXwNrieNcnfByxq(val.elementIdentifierId, text);
		...
		private ControllerElementIdentifier opxJMcckigRzndXwNrieNcnfByxq(int P_0, string P_1)
		{
			...
			ControllerElementIdentifier controllerElementIdentifier = new ControllerElementIdentifier(elementIdentifierIdCounter, P_1, _elementIdentifiers[num].Rewired_002EInterfaces_002EIControllerElementIdentifierCommon_Internal_002EpositiveName, _elementIdentifiers[num].Rewired_002EInterfaces_002EIControllerElementIdentifierCommon_Internal_002EnegativeName, _elementIdentifiers[num].elementType, _elementIdentifiers[num].compoundElementType, _elementIdentifiers[num].isMappableOnPlatform);
		...
		private Element hGAHnFKYBKOYSsUnXETbsyxXSMKQ(ControllerElementType P_0)
		{
			switch (P_0)
			{
			case ControllerElementType.Axis:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier2 = qwtpvKTMpBqPmIRlcdMKeTSYjqAw(P_0, text2, string.Empty, string.Empty);
			...
			case ControllerElementType.Button:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier = qwtpvKTMpBqPmIRlcdMKeTSYjqAw(P_0, text, string.Empty, string.Empty);
		...
		private ControllerElementIdentifier qwtpvKTMpBqPmIRlcdMKeTSYjqAw(ControllerElementType P_0, string P_1, string P_2, string P_3)
		{
			int elementIdentifierIdCounter = _elementIdentifierIdCounter;
			_elementIdentifierIdCounter++;
