...
namespace Rewired.Data
{
	...
	{
		private static class xQfTiXEbEiBkDIijWfQukNRuPldAA
		{
			public const string CNjIHWDkWkuwGEMigQNJVkZADZNr = "updateLoop";

			public const string uLHpWCzDFQoluhNWcKCzeCsTuIqq = "alwaysUseUnityInput";

			public const string VFAXnOJclkXfBeDyNcknHgAgbeNqA = "windowsStandalonePrimaryInputSource";

			public const string qDMGHNKtPRqlUAkUxazbFeUUXQFU = "osx_primaryInputSource";

			public const string jZEkAgnoKCDmCZELJJfLmgqDXBPc = "linux_primaryInputSource";

			public const string xLsebFiWPlevqDEoYjxmxiRVdnBWA = "windowsUWP_primaryInputSource";

			public const string uvPLhnFcNnROjGTTTiSyrrNYSBCR = "xboxOne_primaryInputSource";

			public const string zdXeWyyteEqHtiVIKTMYauZgAzSq = "gameCoreXboxOne_primaryInputSource";

			public const string ZRATvSdHORYkOSNBYPoBepVpQtaR = "gameCoreScarlett_primaryInputSource";

			public const string bnyeBliCTApCAgUrIqJdHBUVUxJg = "ps4_primaryInputSource";

			public const string yqzUdapmNEFnPOTPsmQRmKpBiWncA = "ps5_primaryInputSource";

			public const string zzEcOEdWsRZqfruKyLXZJymWbIqKA = "webGL_primaryInputSource";

			public const string CbBUMRiBthaTaEemhGQtesrAmZQR = "stadia_primaryInputSource";

			public const string yaNSHzKuhfFHEJqoTgJbDLGpjNWoA = "useXInput";

			public const string NyFDcucHzdgKRhQngjvnwKsBCMUoc = "windowsStandalone_useSteamRawInputControllerWorkaround";

			public const string sZaujTSdYJCdlqXmZfGLOprhFtJ = "osxStandalone_useEnhancedDeviceSupport";

			public const string ewddHDkIfNbQpgtqEqfCvWFPLnit = "android_supportUnknownGamepads";

			public const string fODhwgSzIFLkXjZYrQiCdlhATOoD = "ps4_assignJoysticksByPS4JoyId";

			public const string gHEktzLlvwJMOHElpfkLyReaEoUhA = "useSteamControllerSupport";

			public const string BEUxHnYOMAUOPTrowIdaZLSxHbex = "logToScreen";

			public const string KxevITnRTfliPEeZWFfAmmqLtDTp = "runInEditMode";

			public const string DPNvzrXlgaVtnOmItZyquxzFUBvl = "allowInputInEditorSceneView";

			public const string wtihATpvqwUtawpAnbhLhpjvWFPPA = "maxJoysticksPerPlayer";

			public const string aUUAxRvqoVLqikVlTpeKJDRbPqYL = "autoAssignJoysticks";

			public const string gTcWAVeCGoHqPxQvBZuuVjnyudJq = "assignJoysticksToPlayingPlayersOnly";

			public const string xKoHuDsTrApBNCosszGHFMSqiyGg = "distributeJoysticksEvenly";

			public const string ucFhifAuhcTSbrUdcBnAefroILgXA = "reassignJoystickToPreviousOwnerOnReconnect";

			public const string yoCbzjBtyujyyCSogQnAmtbntQaEc = "defaultJoystickAxis2DDeadZoneType";

			public const string cUdFJOKZgRyqFNCijKlzlBecrqXgA = "defaultJoystickAxis2DSensitivityType";

			public const string YPXrMrHEuQETlBTmSneIcUHBnKFBc = "defaultAxisSensitivityType";

			public const string EkvdSNbKIMuiqcXGKiHfzCJDkiyj = "force4WayHats";

			public const string FtsxEdePhCaLrdCUlOijJWTOhHeoA = "throttleCalibrationMode";

			public const string YfeHyufXyHMokEUCEwzOnNJMYqdt = "activateActionButtonsOnNegativeValue";

			public const string JmVOWKAYCbvaoqaRhWqCoIOOCDZI = "deferControllerConnectedEventsOnStart";

			public const string ZJYLgGnvSYrtGtLRvpaLvCHFfpzCA = "logLevel";

			public const string XIddANbezSBMNmfwmXucFjVUGZRu = "disableKeyboard";

			public const string FcUHfbxDGMiRJifqyKxebNPLxHYI = "disableMouse";

			public const string UPIBEeMJcBwidLfgmAFZEFMGIRKxA = "ignoreInputWhenAppNotInFocus";

			public const string ccHbZJORerTTbzlzxGGFaMoylMNeb = "useEnhancedDeviceSupport";

			public const string AOGwsFTLjUYBVmzOxHyNsAMImLeo = "useNativeMouse";

			public const string tgvtXfzGTBWBIBqveLxUFueZpWRF = "useNativeKeyboard";

			public const string OnkPFVyiGPqueVcFEEEiEjCpLGRM = "joystickRefreshRate";

			public const string gwkIphOmIdZvLvgzHnKmHwqIGpUA = "assignJoysticksBySystemId";
		}
		...
		private class zaiftsoOLOdQuKPrAWXfafGIVPJi
		{
			public Func<PlatformVars> mGrnPYHEWqdPCCHGKsnTRUgLTpSH;

			public string egoXmKVrHjDExTJPOHAVpJBCXSRL;

			public zaiftsoOLOdQuKPrAWXfafGIVPJi(Func<PlatformVars> P_0, string P_1)
			{
				mGrnPYHEWqdPCCHGKsnTRUgLTpSH = P_0;
				egoXmKVrHjDExTJPOHAVpJBCXSRL = P_1;
			}
		}

		private class cunLbQxOhsTmcgBTMIEQsDWLEyaf
		{
			public Func<Platform, object> UjzByGggVsaXIQxUeBnDNVQagmJp;

			public Action<Platform, object> WSRDclFODZCUGuAkuPeAdmQoCAMKA;

			public cunLbQxOhsTmcgBTMIEQsDWLEyaf(Func<Platform, object> P_0, Action<Platform, object> P_1)
			{
				UjzByGggVsaXIQxUeBnDNVQagmJp = P_0;
				WSRDclFODZCUGuAkuPeAdmQoCAMKA = P_1;
			}
		}
		...
		private Dictionary<int, zaiftsoOLOdQuKPrAWXfafGIVPJi> __platformVarsDict;

		private Dictionary<int, cunLbQxOhsTmcgBTMIEQsDWLEyaf> __getSetPlatformVariableDict;

		private KeyedGetSetValueStore<string> __configVarsValues;

		private Dictionary<string, object> __valueDelegates;

		private Dictionary<int, zaiftsoOLOdQuKPrAWXfafGIVPJi> platformVarsDict
		{
			get
			{
				Dictionary<int, zaiftsoOLOdQuKPrAWXfafGIVPJi> dictionary = __platformVarsDict;
				if (dictionary == null)
				{
					Dictionary<int, zaiftsoOLOdQuKPrAWXfafGIVPJi> obj = new Dictionary<int, zaiftsoOLOdQuKPrAWXfafGIVPJi>
					{
						{
							1,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_windowsStandalone), "platformVars_windowsStandalone")
						},
						{
							29,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_windowsUWP), "platformVars_windowsUWP")
						},
						{
							6,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_linuxStandalone), "platformVars_linuxStandalone")
						},
						{
							4,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_osxStandalone), "platformVars_osxStandalone")
						},
						{
							5,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_iOS), "platformVars_iOS")
						},
						{
							28,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_tvOS), "platformVars_tvOS")
						},
						{
							13,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_ps4), "platformVars_ps4")
						},
						{
							106,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_ps5), "platformVars_ps5")
						},
						{
							15,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_psVita), "platformVars_psVita")
						},
						{
							14,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_psVita), "platformVars_psVita")
						...
						{
							32,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_switch), "platformVars_switch")
						},
						{
							11,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_xboxOne), "platformVars_xboxOne")
						},
						{
							104,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_gameCoreXboxOne), "platformVars_gameCoreXboxOne")
						},
						{
							105,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_gameCoreScarlett), "platformVars_gameCoreScarlett")
						},
						{
							19,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_webGL), "platformVars_webGL")
						},
						{
							103,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_stadia), "platformVars_stadia")
						},
						{
							7,
							new zaiftsoOLOdQuKPrAWXfafGIVPJi(() => GetOrCreatePlatformVars(ref platformVars_android), "platformVars_android")
						}
					};
					Dictionary<int, zaiftsoOLOdQuKPrAWXfafGIVPJi> dictionary2 = obj;
		...
		private Dictionary<int, cunLbQxOhsTmcgBTMIEQsDWLEyaf> getSetPlatformVariableDict
		{
			get
			{
				Dictionary<int, cunLbQxOhsTmcgBTMIEQsDWLEyaf> dictionary = __getSetPlatformVariableDict;
				if (dictionary == null)
				{
					Dictionary<int, cunLbQxOhsTmcgBTMIEQsDWLEyaf> obj = new Dictionary<int, cunLbQxOhsTmcgBTMIEQsDWLEyaf>
					{
						{
							0,
							new cunLbQxOhsTmcgBTMIEQsDWLEyaf((Platform p) => GetPlatformVars(p).disableKeyboard, delegate(Platform platform, object value)
							{
						...
						{
							2,
							new cunLbQxOhsTmcgBTMIEQsDWLEyaf((Platform p) => GetPlatformVars(p).disableMouse, delegate(Platform platform, object value)
							{
						...
						{
							1,
							new cunLbQxOhsTmcgBTMIEQsDWLEyaf((Platform platform) => GetPlatformVars(platform).ignoreInputWhenAppNotInFocus, delegate(Platform platform, object value)
							{
								GetPlatformVars(platform).ignoreInputWhenAppNotInFocus = (bool)value;
							})
						}
					};
					Dictionary<int, cunLbQxOhsTmcgBTMIEQsDWLEyaf> dictionary2 = obj;
		...
		internal string GetPlatformVarsRelPath(Platform platform)
		{
			...
			{
				return platformVarsDict[(int)platform].egoXmKVrHjDExTJPOHAVpJBCXSRL;
			}
		...
		{
			PlatformVars platformVars = ((!platformVarsDict.ContainsKey((int)platform)) ? GetOrCreatePlatformVars(ref platformVars_unknown) : platformVarsDict[(int)platform].mGrnPYHEWqdPCCHGKsnTRUgLTpSH());
		...
		{
			foreach (KeyValuePair<int, zaiftsoOLOdQuKPrAWXfafGIVPJi> item in platformVarsDict)
			{
				if (getSetPlatformVariableDict.ContainsKey((int)var))
				{
					getSetPlatformVariableDict[(int)var].WSRDclFODZCUGuAkuPeAdmQoCAMKA((Platform)item.Key, value);
				}
			}
		}
		...
		private MultiBoolValue GetAllSerializedPlatformVar_multiBool(AllPlatformVar var)
		{
			...
			foreach (KeyValuePair<int, zaiftsoOLOdQuKPrAWXfafGIVPJi> item in platformVarsDict)
			{
				...
				object obj = getSetPlatformVariableDict[(int)var].UjzByGggVsaXIQxUeBnDNVQagmJp((Platform)item.Key);
				if (obj == null)
				{
					continue;
				}
