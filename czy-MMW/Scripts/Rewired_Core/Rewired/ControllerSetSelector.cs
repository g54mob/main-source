...
namespace Rewired
{
	...
	public sealed class ControllerSetSelector : ISerializationCallbackReceiver, IDeepCloneable
	{
		...
		[NonSerialized]
		private Guid iBQBXLdIiVQakUMCEQXoBkKzVLOP;

		internal bool XAmSiiJuYeuFDbmBewxUJBaRqyME => _type != Type.All;
		...
		public Guid hardwareTypeGuid
		{
			get
			{
				...
				return iBQBXLdIiVQakUMCEQXoBkKzVLOP;
			}
			set
			{
				...
				iBQBXLdIiVQakUMCEQXoBkKzVLOP = value;
		...
		public ControllerSetSelector(ControllerSetSelector P_0)
		{
			...
			iBQBXLdIiVQakUMCEQXoBkKzVLOP = P_0.iBQBXLdIiVQakUMCEQXoBkKzVLOP;
		}
		...
		internal ControllerSetSelector(Type P_0, ControllerType P_1, string P_2, string P_3, int P_4)
		{
			...
			_controllerType = P_1;
			_guid = P_2;
			iBQBXLdIiVQakUMCEQXoBkKzVLOP = StringTools.ToGuid(P_2);
		...
		public bool Matches(Controller controller)
		{
			...
			case Type.HardwareType:
				if (iBQBXLdIiVQakUMCEQXoBkKzVLOP != Guid.Empty)
				{
					return iBQBXLdIiVQakUMCEQXoBkKzVLOP == controller.hardwareTypeGuid;
				}
			...
			case Type.ControllerTemplateType:
				return controller.ImplementsTemplate(iBQBXLdIiVQakUMCEQXoBkKzVLOP);
			case Type.PersistentControllerInstance:
				return controller.deviceInstanceGuid == iBQBXLdIiVQakUMCEQXoBkKzVLOP;
		...
		private void FirybHbelqdaiUHfyEGbQlVgxwOB()
		{
			_guid = string.Empty;
			iBQBXLdIiVQakUMCEQXoBkKzVLOP = Guid.Empty;
		}

		void ISerializationCallbackReceiver.OnAfterDeserialize()
		{
			iBQBXLdIiVQakUMCEQXoBkKzVLOP = StringTools.ToGuid(_guid);
		}
