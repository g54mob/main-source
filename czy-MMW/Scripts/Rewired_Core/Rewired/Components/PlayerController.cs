...
namespace Rewired.Components
{
	...
	public class PlayerController : ComponentWrapper<Rewired.PlayerController>, IPlayerController
	{
		...
		protected override void OnAwakeFinished()
		{
			...
			if (base.initialized)
			{
				xxdgDZjKAXfRQRCbFmQQIdPzKMtk(true);
			}
		}
		...
		protected override void Subscribe()
		{
			...
			if (base.source != null)
			{
				base.source.Rewired_002EIPlayerController_002EButtonStateChangedEvent += nnOLOueCSyMkaHJmaoyhPFUEsqVe;
				base.source.Rewired_002EIPlayerController_002EAxisValueChangedEvent += MTpPjvyOfUdYtRiPIdwGlaGxCtem;
				base.source.Rewired_002EIPlayerController_002EEnabledStateChangedEvent += xxdgDZjKAXfRQRCbFmQQIdPzKMtk;
			}
		}
		...
		internal virtual List<ElementInfo> fmfUTyUxfsvALaCjsFYziYsILqmR()
		{
		...
		private void nnOLOueCSyMkaHJmaoyhPFUEsqVe(int P_0, bool P_1)
		{
		...
		private void MTpPjvyOfUdYtRiPIdwGlaGxCtem(int P_0, float P_1)
		{
			if (!base.isActiveAndEnabled)
			{
				return;
		...
		private void xxdgDZjKAXfRQRCbFmQQIdPzKMtk(bool P_0)
		{
			try
			{
		...
		private void pZncGcWlGKMSiAcQssDYRNweZeGo()
		{
			if (_elements == null || _elements.Count <= 0)
			{
				_elements = fmfUTyUxfsvALaCjsFYziYsILqmR();
			}
		}
	}
}
