...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static ReadOnlyCollection<ControllerElementIdentifier> NPSlPoVQJEtsBGousMxJkGoegjie;

		private static ReadOnlyCollection<ControllerElementIdentifier> qVfEpPCrpvVQeEbBHNDeHtFehMYdb;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] yfmptOiDRJwIgbHcKLHFlbrqLUHd;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] fbFQKyKMQwDBJMlVXRyvmaZPLYl;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] lxXbSeZgxzKAncgFGtqvZpPNHHSJA;
		...
		private static readonly string[] HFfzyFTAXAIHAlokBmmIQNxktTFq;

		public const int vendorId_sony = 1356;

		internal static readonly IList<PidVid> pidVids_sony_dualShock4;

		private static readonly PidVid[] iVoXExMZSpPRKzzpHiyBwgNicHnF;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] vWkdatnrjnNzSjcNHUDNfhAtbFih;

		private static readonly ControllerElementIdentifier[] wzGhuVZZLGsibfhsNPnlOBOGJRFO;
		...
		internal static IList<ControllerElementIdentifier> unityUnifiedMouseElementIdentifiers => NPSlPoVQJEtsBGousMxJkGoegjie ?? (NPSlPoVQJEtsBGousMxJkGoegjie = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[11]
		{
		...
		internal static IList<ControllerElementIdentifier> rawInputUnifiedMouseElementIdentifiers => qVfEpPCrpvVQeEbBHNDeHtFehMYdb ?? (qVfEpPCrpvVQeEbBHNDeHtFehMYdb = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[9]
		{
			new ControllerElementIdentifier(0, "Mouse Horizontal", "Mouse Right", "Mouse Left", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, true),
			new ControllerElementIdentifier(1, "Mouse Vertical", "Mouse Up", "Mouse Down", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, true),
			new ControllerElementIdentifier(2, "Mouse Wheel", "Mouse Wheel Up", "Mouse Wheel Down", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, true),
		...
		internal static ControllerElementIdentifier[] unknownJoystickElementIdentifiers_orig => wzGhuVZZLGsibfhsNPnlOBOGJRFO;
		...
		static Consts()
		{
			...
			yfmptOiDRJwIgbHcKLHFlbrqLUHd = new string[3] { "MouseAxis1", "MouseAxis2", "MouseAxis3" };
			fbFQKyKMQwDBJMlVXRyvmaZPLYl = new string[7] { "MouseButton0", "MouseButton1", "MouseButton2", "MouseButton3", "MouseButton4", "MouseButton5", "MouseButton6" };
			lxXbSeZgxzKAncgFGtqvZpPNHHSJA = new string[132]
			{
			...
			HFfzyFTAXAIHAlokBmmIQNxktTFq = new string[5] { "", "Ctrl", "Alt", "Shift", "Cmd" };
			iVoXExMZSpPRKzzpHiyBwgNicHnF = new PidVid[3]
			{
				new PidVid(1476, 1356),
				new PidVid(2976, 1356),
				new PidVid(2508, 1356)
			};
			vWkdatnrjnNzSjcNHUDNfhAtbFih = new string[4] { "Sony Computer Entertainment Wireless Controller", "Sony Interactive Entertainment DUALSHOCK®4 USB Wireless Adaptor", "Wireless Controller", "Sony Interactive Entertainment Wireless Controller" };
			mouseAxisUnityNames = new ReadOnlyCollection<string>(yfmptOiDRJwIgbHcKLHFlbrqLUHd);
			mouseButtonUnityNames = new ReadOnlyCollection<string>(fbFQKyKMQwDBJMlVXRyvmaZPLYl);
			keyboardKeyNames = new ReadOnlyCollection<string>(lxXbSeZgxzKAncgFGtqvZpPNHHSJA);
			keyboardKeyValues = new ReadOnlyCollection<int>(_keyboardKeyValues);
			modifierKeyShortNames = new ReadOnlyCollection<string>(HFfzyFTAXAIHAlokBmmIQNxktTFq);
			pidVids_sony_dualShock4 = new ReadOnlyCollection<PidVid>(iVoXExMZSpPRKzzpHiyBwgNicHnF);
			productNames_sony_dualShock4 = new ReadOnlyCollection<string>(vWkdatnrjnNzSjcNHUDNfhAtbFih);
			...
			wzGhuVZZLGsibfhsNPnlOBOGJRFO = JGtWzyrxAzlhGgyiLBfFsoqiLWLo();
			if (132 != lxXbSeZgxzKAncgFGtqvZpPNHHSJA.Length)
			{
		...
		private static ControllerElementIdentifier[] JGtWzyrxAzlhGgyiLBfFsoqiLWLo()
		{
			int num = 0;
