...
namespace Rewired.Utils
{
	...
	{
		private static byte[] GvNaUaBQajJqKcLAiFosQMUTZbcFb;

		private static byte[] intToFloatBuffer => GvNaUaBQajJqKcLAiFosQMUTZbcFb ?? (GvNaUaBQajJqKcLAiFosQMUTZbcFb = new byte[4]);
