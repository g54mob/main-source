...
namespace Rewired
{
	...
	{
		private const string ukvDxIeHVYcIBLZldYoeBVgbIRyN = "[^a-fA-F0-9]";
		...
		{
			if (string.IsNullOrEmpty(oJbxVMjnPkhrnesnEdzPEZtYiKozA(P_0)))
			{
				productId = 0;
				vendorId = 0;
				return;
		...
		{
			return WXegPfyQVeCSYeNMNEgofYsHiFFwb(oJbxVMjnPkhrnesnEdzPEZtYiKozA(pidVid));
		}
		...
		private bool WXegPfyQVeCSYeNMNEgofYsHiFFwb(string P_0)
		{
		...
		private static string oJbxVMjnPkhrnesnEdzPEZtYiKozA(string P_0)
		{
