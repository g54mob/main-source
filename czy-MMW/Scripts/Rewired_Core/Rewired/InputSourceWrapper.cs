...
namespace Rewired
{
	...
	{
		private T ScbDhXryLESOWsFrrKYuUVYnFoML;

		private bool wWuXlUNdVJdsOMyIhuxocJrDoZZn;

		public T source => ScbDhXryLESOWsFrrKYuUVYnFoML;
		...
		{
			ScbDhXryLESOWsFrrKYuUVYnFoML = P_0;
		}
		...
		{
			if (!wWuXlUNdVJdsOMyIhuxocJrDoZZn)
			{
				wWuXlUNdVJdsOMyIhuxocJrDoZZn = true;
			}
		}
	}
}
