...
namespace Rewired
{
	...
	internal class HardwareControllerMap_Game
	{
			...
			: this(P_0)
		{
			...
			for (int k = 0; k < num; k++)
			{
				int num5 = PKDxAXhMdpvkXWbLVGyiQkDJivSbA(P_1, P_2[k]);
				if (num5 < 0)
				{
			...
			{
				int num6 = PKDxAXhMdpvkXWbLVGyiQkDJivSbA(P_1, P_3[l]);
				if (num6 < 0)
				{
					Logger.LogError("Invalid hardware element identifier id!");
				}
			...
			{
				int num7 = PKDxAXhMdpvkXWbLVGyiQkDJivSbA(P_1, array[m]);
				if (num7 < 0)
				{
					Logger.LogError("Invalid hardware element identifier id!");
				}
			...
			{
				int num8 = PKDxAXhMdpvkXWbLVGyiQkDJivSbA(P_1, array2[n]);
				if (num8 < 0)
				{
					Logger.LogError("Invalid hardware element identifier id!");
				}
		...
		private int PKDxAXhMdpvkXWbLVGyiQkDJivSbA(ControllerElementIdentifier[] P_0, int P_1)
		{
			if (P_0 == null)
			{
				return -1;
