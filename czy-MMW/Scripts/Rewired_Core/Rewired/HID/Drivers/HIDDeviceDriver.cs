...
namespace Rewired.HID.Drivers
{
	...
	internal abstract class HIDDeviceDriver : IControllerDriver, IDisposable
	{
		...
		private bool kALXsnPMYOnvHXtneETKqvezYIdA;
		...
		protected bool disposed => kALXsnPMYOnvHXtneETKqvezYIdA;
		...
		{
			if (!kALXsnPMYOnvHXtneETKqvezYIdA)
			{
				kALXsnPMYOnvHXtneETKqvezYIdA = true;
			}
		}
	}
}
