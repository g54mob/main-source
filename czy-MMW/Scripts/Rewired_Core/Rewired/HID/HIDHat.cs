...
namespace Rewired.HID
{
	...
	internal class HIDHat : HIDControllerElement
	{
		...
		private Func<int, int> qWkwvfZGNgbwKIatexHpGcmkHKfdA;
		...
		{
			qWkwvfZGNgbwKIatexHpGcmkHKfdA = P_2;
		}
		...
		public override void UpdateValue(NativeBuffer inputReport, double timestamp)
		{
			...
			if (type == Type.Custom && qWkwvfZGNgbwKIatexHpGcmkHKfdA != null)
			{
				rawValue = qWkwvfZGNgbwKIatexHpGcmkHKfdA(rawValue);
			}
		}
	}
}
