...
internal static class pMvvECjJycyKibKKCAXEnFbBPTVk
{
	public static ControllerElementType xNeYpGuJHefJZlyNqQjEMgcfdnoC(ElementAssignmentType P_0)
	{
		switch (P_0)
		{
	...
	public static ElementAssignmentType ywpNwVDzqUmJolEkZUPNFDNbmDvr(ControllerType P_0, ControllerElementType P_1, AxisRange P_2)
	{
	...
	public static AxisRange raZnAWYkitdzDcNGOdVNPDPWaHdBb(Pole P_0)
	{
		return P_0 switch
		{
	...
	public static Type ZiMdoEbUQLTkkiymUAoLDIkvJuiBA<_0001>() where _0001 : Controller
	{
		return OYPdyckkuuaaJcjcdFbmXXfNieur(typeof(_0001));
	}

	public static Type OYPdyckkuuaaJcjcdFbmXXfNieur(Type P_0)
	{
	...
	public static Type AZXGExZWlvnLaTOFPxcePqLUezTu(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static Type ReimBRMGzXZTkdlSjngdhSbyvgMD(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerType WVUQwFjeRhevfhUdbNZYjvGXpxKM(Type P_0)
	{
		if (P_0 == null)
		{
	...
	public static ControllerType lyqMztbyatoMUKMuxYoMSsQxpNMe<_0001>()
	{
		return WVUQwFjeRhevfhUdbNZYjvGXpxKM(typeof(_0001));
	}

	public static ControllerType UQadXbWWQUkXbVKCqHrJFAIyVbjT(Type P_0)
	{
		if (!cINEzbspiepfbQtClNgpSTXLPFwA(P_0, out var result))
		{
			throw new Exception(P_0.Name + " is not an allowed type.");
		}
		return result;
	...
	public static ControllerType SkNjRvhdpjKAujKrVASbRGtQyGXb<_0001>() where _0001 : ControllerMap
	{
		return UQadXbWWQUkXbVKCqHrJFAIyVbjT(typeof(_0001));
	}

	public static bool cINEzbspiepfbQtClNgpSTXLPFwA(Type P_0, out ControllerType P_1)
	{
		if (P_0 == null)
		{
	...
	public static bool LbshPzWFARxecbNlUzfmeCirsbrs<_0001>(out ControllerType P_0) where _0001 : ControllerMap
	{
		return cINEzbspiepfbQtClNgpSTXLPFwA(typeof(_0001), out P_0);
	}

	public static ControllerType TpEsyHnKbzCHGbMxxJdysXWnuhb(Type P_0)
	{
		if (P_0 == null)
		{
	...
	public static ControllerType cOFgbhhmfdLXQHXDShqzGIpKMXBrA<_0001>() where _0001 : ControllerMapSaveData
	{
		return TpEsyHnKbzCHGbMxxJdysXWnuhb(typeof(_0001));
	}

	public static bool LNXajvkdHdsLUXViOuqAckfqMFdj(ControllerTemplateElementType P_0, ControllerElementType P_1)
	{
		return P_1 switch
		{
	...
	public static ControllerElementType kfijJzRINKFZsOSueMIhVWyLcRAf(object P_0)
	{
		if (P_0 == null)
		{
		...
		{
			return qiCEXRJtssyvtdadsNZbLyyWCGGU((ControllerTemplateElementType)P_0);
		}
		throw new NotImplementedException();
	}

	public static ControllerElementType qiCEXRJtssyvtdadsNZbLyyWCGGU(ControllerTemplateElementType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerTemplateElementSourceType cPFfIBupiwDuxenOpDirWhIpFzbuA(ControllerTemplateElementType P_0, bool P_1)
	{
		switch (P_0)
		{
	...
	public static ControllerTemplateElementType RBEXvfBrylcGHQlrvbaxUlUsGPcaA(ControllerElementType P_0, bool P_1)
	{
		switch (P_0)
		{
		case ControllerElementType.Axis:
