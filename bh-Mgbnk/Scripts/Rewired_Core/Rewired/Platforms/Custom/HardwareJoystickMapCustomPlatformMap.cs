...
namespace Rewired.Platforms.Custom
{
	...
	{
		private sealed class rtnvvRqiutmcTIGoQLWQKSpJHhMC : IEnumerable<HardwareJoystickMap.Platform_Custom.Axis>, IEnumerable, IEnumerator<HardwareJoystickMap.Platform_Custom.Axis>, IEnumerator, IDisposable
		{
			private int BnxnFPZNyWloAyhlqtqeirHvQTSl;

			private HardwareJoystickMap.Platform_Custom.Axis vfHuFcHqgtVYvejaLaYNOaXHNEzx;

			private int TUWCXlEtqTmCSiAmuLXrqTanRgBmA;

			public HardwareJoystickMapCustomPlatformMap<TMatchingCriteria> dZbILJzqWbenqOEGwRMkhdVVfrFHA;

			private int elxKRwopBSqDyzhulXFTfWJKgCuh;
			...
			[DebuggerHidden]
			public rtnvvRqiutmcTIGoQLWQKSpJHhMC(int P_0)
			{
			}
		...
		private sealed class AeLugFBxaaMcsbvIGCGKAOMuEISt : IEnumerable<HardwareJoystickMap.Platform_Custom.Button>, IEnumerable, IEnumerator<HardwareJoystickMap.Platform_Custom.Button>, IEnumerator, IDisposable
		{
			private int KFdRYQrycemKfefqhqfnGHqyNnaE;

			private HardwareJoystickMap.Platform_Custom.Button KHNuBnCPeZSQoxItpgAJBdmvjNySA;

			private int wCToLvyyUXYsnxBhEGeUgmIInFqO;

			public HardwareJoystickMapCustomPlatformMap<TMatchingCriteria> tJcVPGcysktKudAnHhwUBvsHLYiEb;

			private int mSxHshaIGKArLAoZSFXeegsxNUYf;
			...
			[DebuggerHidden]
			public AeLugFBxaaMcsbvIGCGKAOMuEISt(int P_0)
			{
			}
