...
namespace Rewired.ComponentControls.Effects
{
	...
	public sealed class TouchJoystickRadialIndicator : MonoBehaviour, IRegistrar<TouchJoystickAngleIndicator>
	{
		...
		private static readonly Vector2 XKunTWSwuTQkRNssEGpQffKAYUoO;

		private RectTransform dYPcNHqOIQUVbqgJsZtfCOsVKqCi;

		private List<TouchJoystickAngleIndicator> ehemcpiqYAfErhDglWdvkMfQkzZd;
		...
		private RectTransform dXkAPGkafARYYJTIaIFwxKpSyvmjA => null;
		...
		private void eAmkjYTIGNjyzgEYdrtosmUOtMBiA(TouchJoystickAngleIndicator P_0)
		{
		}
