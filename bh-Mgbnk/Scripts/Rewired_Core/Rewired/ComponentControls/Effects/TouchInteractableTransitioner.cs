...
namespace Rewired.ComponentControls.Effects
{
	...
	public sealed class TouchInteractableTransitioner : MonoBehaviour, IVisibilityChangedHandler, TouchInteractable.IInteractionStateTransitionHandler
	{
		...
		private TouchInteractable.InteractionState ZMqfOZHMIYasPJiblVgoRqEcsNhBb;
		...
		private void DzbfmzxPhyYkZaQtCYnYZMFirymm(bool P_0)
		{
		}

		private void kJHYTZCmwTXnVhOrFTsIiCMguxhj(bool P_0, bool P_1)
		{
		}
		...
		private void SYJcMLlIxTuYyuKhfBBoMfokGXuBA(TouchInteractable.InteractionState P_0, bool P_1)
		{
		}

		private void wvhJboyQzQucMqptfKxpXythouDT(Color P_0, bool P_1)
		{
		}

		private void TmxnLBFFnsrLuujZuOWFZhJjipeR(Sprite P_0)
		{
		}

		private void celTFUeKjxEhZbCUUmdODCRjmcxTb(string P_0)
		{
		}
