...
namespace Rewired.ComponentControls
{
	...
	public class CustomController : ComponentController
	{
		...
		private struct KiLXVYKHYMbZvvyjxfoVHhxraxAi
		{
			public CustomControllerElementSelector.ElementType GFPHVlmVzteIoIVNjBIjBDIIEyDGb;

			public int YOOwqaxWRVmGkIBQfJOzFmrgopZP;

			public float kELJcnJJwMTayTURiKtaOFNHVUBA;

			public KiLXVYKHYMbZvvyjxfoVHhxraxAi(CustomControllerElementSelector.ElementType P_0, int P_1, float P_2)
			{
				GFPHVlmVzteIoIVNjBIjBDIIEyDGb = default(CustomControllerElementSelector.ElementType);
				YOOwqaxWRVmGkIBQfJOzFmrgopZP = 0;
				kELJcnJJwMTayTURiKtaOFNHVUBA = 0f;
			}

			public KiLXVYKHYMbZvvyjxfoVHhxraxAi(CustomControllerElementSelector.ElementType P_0, int P_1, bool P_2)
			{
				GFPHVlmVzteIoIVNjBIjBDIIEyDGb = default(CustomControllerElementSelector.ElementType);
				YOOwqaxWRVmGkIBQfJOzFmrgopZP = 0;
				kELJcnJJwMTayTURiKtaOFNHVUBA = 0f;
			...
			public bool aFFefjpEYufHLPFGGgOkAqTrqeSMA(CustomControllerElementSelector.ElementType P_0, int P_1)
			{
				return false;
			}

			public void JLoktJLgqTJiChISHqqGIxljEAEQ(float P_0)
			{
			}

			public void eqJHyOwiejAFqalvBMRhgoHVbFdF(bool P_0)
			{
			}
		}
		...
		private List<KiLXVYKHYMbZvvyjxfoVHhxraxAi> dYOhxGRPDaALaQvfWRUgrOnMJvWP;

		[NonSerialized]
		private int fNHKuKtdCiMySncnPzFSxKTtofyq;

		private Action edUAFqgDlsFShvvoowSWjCvHHuLR;
		...
		internal override bool rjQJHucPbYJcRVnREFcEEEXpbVnAA()
		{
			return false;
		}

		internal override void IzXasWjsPBhTqjNhVojyvvKyIkFZ()
		{
		}

		internal override void GIwlJZRSZgetsqmmxaDeFkBMgXbyA()
		{
		}
		...
		private Rewired.CustomController FMSplgsPBwzOYerBozQTwAnjAnUB(bool P_0)
		{
			return null;
		}

		private void aoYhFuEifkDRqIGefXeRwwrGvwssA(Rewired.CustomController P_0)
		{
		}
