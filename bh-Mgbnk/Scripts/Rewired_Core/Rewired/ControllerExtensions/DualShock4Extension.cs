...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class FZpRLExJBKdgsATbfaIHyLtDylLE : IControllerExtensionSource
		{
			public readonly IDriver_DualShock4 LNaGkqABoRgJUMQbqFzqDFldehJJB;

			public readonly bool AqpfqzpohUFirQORtsFJfeNqvLt;

			public readonly int chnsPXLXLzANZVZjFtXGCGBoiMsn;

			public FZpRLExJBKdgsATbfaIHyLtDylLE(IDriver_DualShock4 P_0, bool P_1, int P_2)
			{
			}
		}

		private FZpRLExJBKdgsATbfaIHyLtDylLE zFueLdGGnKyMDivOuTOnLzSZAHvS;

		private bool XlXdTQkLOkIqGqUIOBZOwDdlcaro;

		private TimerAbs[] RlJwhbDpaywQRwLZRpyozttyoFPR;
		...
		private void zVAdggKMXQFskGQJcoTyOmKLVkorA(DualShock4MotorType P_0, float P_1, float P_2)
		{
		}
	}
}
