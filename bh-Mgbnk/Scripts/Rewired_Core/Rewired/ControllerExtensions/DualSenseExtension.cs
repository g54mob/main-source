...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class TdpwBkFYYJqQGiFLUHTjGJSOuwit : IControllerExtensionSource
		{
			public readonly IDriver_DualSense jEBigAcKFBPRjlWjYTdAyckvQjmU;

			public readonly bool YWgbxAhdcjnWmNvxyvFkoOAZwBhW;

			public readonly int UgZsbyztcuLAPZNTmgdDjOtCDUcdb;

			public TdpwBkFYYJqQGiFLUHTjGJSOuwit(IDriver_DualSense P_0, bool P_1, int P_2)
			{
			}
		}

		private TdpwBkFYYJqQGiFLUHTjGJSOuwit BTTdmoCXWWXkJPNRXeKVbkiWCsfs;

		private bool LuXduPdmwilQHPrIcfVOnxFhNtUy;

		private TimerAbs[] MGaEtggUDUBkPwJJAobnGFFyOFuhA;
		...
		private void pFxhxDxypCKkziWOWEjZmLjWKQMs(DualShock4MotorType P_0, float P_1, float P_2)
		{
		}
	}
}
