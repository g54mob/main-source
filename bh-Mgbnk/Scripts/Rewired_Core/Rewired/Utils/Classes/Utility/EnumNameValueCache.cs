...
namespace Rewired.Utils.Classes.Utility
{
	...
	{
		private static EnumNameValueCache<TEnum> UjFIkGbEzeyhNlIuTrfNGGmKeLmS;

		private readonly ADictionary<string, TEnum> dPxpvidIecjznFePZUWAYkodkKqS;

		private readonly string[] fdKnhLTOGuafpQKiytDtgJpGyJsW;

		private readonly long[] QLJgAeIGZeFnSNhsWdGyDpHvEnQqA;
