...
namespace Rewired.Utils.Classes.Utility
{
	...
	{
		private const long kLQieluhNbzQivFTybHUHRofTvmUA = 10000000L;

		public static readonly Stopwatch Global;

		private static long VBnUrmxmXwppvcUTzBarslvteVtJ;

		private System.Diagnostics.Stopwatch nWeByKbfTBfkPZJLoQEsKWuJChwOA;

		private long TcbAaPMezoaMpDJdiRXNighUYkxT;
