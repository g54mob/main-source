...
namespace Rewired.Utils
{
	...
	{
		private T qfgAbJCGTaJbbizrbmJOyQleDPdPB;

		private TResult utDSQATaheXpGBWPfjFJFAxArXcw;

		private static Action<object, Func<T, TResult>> gPlEjeAjASQubXQAorMYUgEHqElDb;
		...
		private static void sxeYkfJQxZxeDLTOQDKEvngefLxi(object P_0, Func<T, TResult> P_1)
		{
		}
