...
namespace Rewired.Utils
{
	...
	{
		private T WFklaQRKiufqnhNbEhJUDHMvaQRdA;

		private bool MvogrjIVoexWCUSrDfEvvgBtNGmZ;

		private static Action<object, Predicate<T>> cLfafJeHvtAtNvzwpGetDlODBchc;
		...
		private static void NqUeVEirRHJSAhzZABgadYkeQvtPb(object P_0, Predicate<T> P_1)
		{
		}
