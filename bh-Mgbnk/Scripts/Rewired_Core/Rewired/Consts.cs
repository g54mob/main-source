...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static readonly Guid[] nMJeYqtRmqTPdOlvvxYisfiZollg;

		internal static readonly ReadOnlyCollection<Guid> reservedHardwareTypeGuids;

		private static ControllerElementIdentifier.bGyzYlFkGvakUcfidQcMxjXLDSsDA[] bgsOcxvjnoNZpJhxKKMMgLWlWhpy;

		private static ReadOnlyCollection<ControllerElementIdentifier> MKkQEiuJyWCQrkKGpYKSSgTYvOoTA;

		private static ReadOnlyCollection<ControllerElementIdentifier> xdFYEJSGZlvKCznXOFNprWhAysAe;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] dHIcYlBHqHsZynttFCZGVdoAufFEA;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] gwPayGFVfYTPbAZRIOFnbzbrYnOEA;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] wpbktqsGIhszPkgfDHiiVeStpxCQ;

		internal static readonly IList<int> keyboardKeyValues;

		internal static readonly int[] _keyboardKeyValues;

		private static readonly IList<string> JMfOnhxbvMQvgsnCkihomrEYbzzfA;

		private static readonly string[] HjEnwglFzWMBOoozkWsThgwmIirx;

		private static readonly IList<string> iudFYwPXJvulksploFoxwbSmbNTiA;

		private static readonly string[] vCkqBrocDNjUqTaGiswCPuwZpBDh;
		...
		private static readonly PidVid[] lsKEqfBvufsaqgdJQpaIxidYzGlhA;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] yQEgOfbQAffkyudYAnQEDtqbRVefB;

		internal static readonly IList<PidVid> pidVids_sony_dualSense;

		private static readonly PidVid[] MpyMFaSimvLXLOIZDiulETAjkHdr;

		internal static readonly IList<string> productNames_sony_dualSense;

		private static readonly string[] cSYHbLIyNPCuNFqVoauVNMdaSJzP;

		private static readonly ControllerElementIdentifier[] xmmvCPghwUPLLdLCSHJmWVVacbVHA;
		...
		internal static ControllerElementIdentifier.bGyzYlFkGvakUcfidQcMxjXLDSsDA[] commonMouseElementIdentifierInitOptions => null;
