namespace Rewired
{
	...
	{
		private class VfUAcpjDSmwPKsInrjNfARLeVXNzb
		{
			public string[] CkwCyyaGzpfuLzyoRkLHOSKtasAW;

			public string[] ldyMwxEzyeswdQFuihvmwEmQahvb;

			public VfUAcpjDSmwPKsInrjNfARLeVXNzb(int P_0)
			{
			}
		}

		private static VfUAcpjDSmwPKsInrjNfARLeVXNzb[] TcVgoPCDsHqzHrlKYIAUNeYePrMnA;
