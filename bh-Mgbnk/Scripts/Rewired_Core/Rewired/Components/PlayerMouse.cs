...
namespace Rewired.Components
{
	...
	public sealed class PlayerMouse : PlayerController, IPlayerMouse, IPlayerController, IMouseInputSource
	{
		...
		private Rewired.PlayerMouse QMvsaYpPjhxAqyjvHaxZUBidklRb => null;
		...
		internal override List<ElementInfo> kZPfxafqEeLOrsiTlcYkCgviCAklA()
		{
			return null;
		}

		private void STEHoDgxmlszagNPvGchjBKWaLHV(Vector2 P_0)
		{
		}
