...
namespace Rewired
{
	public sealed class ControllerMapEnabler
	{
		...
		internal class ExHBPPJAiWslLTxuqRFqHCQYvmjs
		{
			public bool FdXSmpYklUidNepsCfzqWcITfCOM;

			public XJLpQppPnUFtZjRQrVdGIOWhiWam[] dXjdCVcsoGjZQmUVqStXFGBBWQyt;

			public ExHBPPJAiWslLTxuqRFqHCQYvmjs(bool P_0, XJLpQppPnUFtZjRQrVdGIOWhiWam[] P_1)
			{
			}
		}

		private bool UiDEkrChLoIQMxJcyKfLUfCbHzmf;

		private Player mYcTCTHSNsFPoCXwbqSAecZeHsos;

		private ExHBPPJAiWslLTxuqRFqHCQYvmjs fbeSYAWjYEDlcrQtkVpEYRSXscoC;

		private readonly int qqXvQEYMuJPXDjhgpQshuYKlhder;

		private List<RuleSet> bBJoUTKgvDxsFFLVTFXhlJWNUsCf;
		...
		internal ControllerMapEnabler(Player P_0, ExHBPPJAiWslLTxuqRFqHCQYvmjs P_1)
		{
		}
		...
		private void qnhXsdOFxIBjlwpzqxdoLZRMVpcN(SerializedObject P_0)
		{
		}

		private bool sjuAxIDbMdeGtWGwkRAZhjetkRfCb(SerializedObject P_0)
		{
			return false;
		}
	}
