...
namespace Rewired.Data.Mapping
{
	...
	internal interface IHardwareControllerTemplateMap_Internal
	{
		...
		vuooprXJHVvacQvysmZLVazcCbGcA GetAxisTarget(Controller controller, int elementIdentifierId);

		vuooprXJHVvacQvysmZLVazcCbGcA GetButtonTarget(Controller controller, int elementIdentifierId);
	}
}
