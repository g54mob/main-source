...
namespace Rewired
{
	...
	{
		private ksUUeloGhUnKxVlWzoyLhFoETsrR PuhyMvLSRdWzukCcSBfdAUZwfbSr;

		private InputActionEventType bWRAJAyEyohDwetHGStDPTPKxRXU;
		...
		internal InputActionEventData(ksUUeloGhUnKxVlWzoyLhFoETsrR P_0, int P_1, int P_2, UpdateLoopType P_3)
		{
			PuhyMvLSRdWzukCcSBfdAUZwfbSr = null;
			bWRAJAyEyohDwetHGStDPTPKxRXU = default(InputActionEventType);
			playerId = 0;
			actionId = 0;
