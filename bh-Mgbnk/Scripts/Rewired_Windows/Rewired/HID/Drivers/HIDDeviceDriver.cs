...
namespace Rewired.HID.Drivers
{
	...
	internal abstract class HIDDeviceDriver : IControllerDriver, IDisposable
	{
		...
		internal interface IHIDDevice
		{
			...
			bool WriteSync(ndPzSZhFNVeBDFDFsrPPRfBbUpJt outputReport, int timeoutMs);

			void WriteAsync(ndPzSZhFNVeBDFDFsrPPRfBbUpJt outputReport, int timeoutMs);
		...
		internal class InitArgs
		{
			...
			public readonly RhzYuVirWegvYsLvvdtRvjIAEUGd connectionType;
			...
			public InitArgs(UpdateLoopSetting P_0, RhzYuVirWegvYsLvvdtRvjIAEUGd P_1, int P_2, int P_3, int P_4, int P_5, IHIDDevice P_6)
			{
			}
		}

		public pCLyOolGSoGnzckhrUopJSxPPQuQA[] axes;

		public ObPWlwvNIZlgLtPWEEVnCpUXVVLm[] buttons;

		public FGSJBFVFVYBfMIKsAxCQjZVJGBqqA[] hats;

		public wqcsgHbRqKmTaBqusbzdwjpIObAM[] accelerometers;

		public wlfdzvjuaZfnTkWOTlZxCBwptsuo[] gyroscopes;

		public WrSlmJxoZFgCLSWPeQjtyKXyDhws[] touchpads;

		public tudIoPOAEDmqsLLiFPEYXeUodAYW[] vibrationMotors;

		public qEpfSxgyzoxzSqMkstzdRksmymJpA[] lights;

		private bool EQxARCBFvfppmDBYcgmhgssRIxOWA;
