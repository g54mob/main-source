...
{
	private float chargeSpeedIncrease = 0.04f;

	private float chargeRewardIncrease = 0.075f;

	public float GetChargeSpeedIncrease()
	{
		return (float)amount * chargeSpeedIncrease;
	}
	...
	public float GetChargeRewardMultiplier()
	{
		...
		object obj = amount * chargeRewardIncrease;
		return (float)obj + 1f;
	}
	...
	public override string GetDescription(LocalizedString localizedString)
	{
		...
		if (!flag)
		{
			...
			float num = chargeSpeedIncrease * 100f;
			Cpp2ILHelpers.NoteDecompilerIssue("Unknown call target operand: \"il2cpp_value_box\"");
			object arg = default(object);
			string value = $"{arg}";
			((Dictionary<object, object>)(object)dictionary).Add((object)"value1", (object)value);
			float num2 = chargeRewardIncrease * 100f;
			Cpp2ILHelpers.NoteDecompilerIssue("Unknown call target operand: \"il2cpp_value_box\"");
			object arg2 = default(object);
			string text3 = $"{arg2}%";
			((Dictionary<object, object>)(object)dictionary).Add((object)"value2", (object)text3);
			...
			if (!flag2)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v251 @ rdx_v15 (Il2CppClass<System.Object[]>)+40]");
				text = (string)0;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v251 @ rdx_v15 (Il2CppClass<System.Object[]>)+40]");
