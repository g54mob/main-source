...
{
	private float damagePerAmount = 0.15f;
	...
	{
		if (dc.enemy != null && (dc.enemy.IsBoss() || dc.enemy.IsElite()))
		{
			float num = additiveDamage + itemAttackModifier._003CadditiveValue_003Ek__BackingField;
			itemAttackModifier.hasModifications = true;
			itemAttackModifier._003CadditiveValue_003Ek__BackingField = num;
		}
	}
