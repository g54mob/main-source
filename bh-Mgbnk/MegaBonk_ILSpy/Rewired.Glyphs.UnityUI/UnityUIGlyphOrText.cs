...
public class UnityUIGlyphOrText : GlyphOrTextBase<Image, Sprite, Text>
{
	protected override string textString
	{
		get
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Rewired.Glyphs.UnityUI.UnityUIGlyphOrText)+20]");
			if ((UnityEngine.Object)0 != null)
			{
				...
				{
					object obj2 = obj;
					Cpp2ILHelpers.NoteDecompilerIssue("Indirect call: [v76 @ rax_v8+5D8] (should have been resolved before IL gen)");
		...
		set
		{
			...
			if ((UnityEngine.Object)0 != null)
			{
				...
				object obj = 0;
				object obj2 = obj;
				Cpp2ILHelpers.NoteDecompilerIssue("Indirect call: [v95 @ rax_v6+5E8] (should have been resolved before IL gen)");
			}
		}
	}
	...
	protected override Sprite glyphGraphic
	{
		get
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Rewired.Glyphs.UnityUI.UnityUIGlyphOrText)+28]");
			if ((UnityEngine.Object)0 != null)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Rewired.Glyphs.UnityUI.UnityUIGlyphOrText)+28]");
				object obj = 0;
