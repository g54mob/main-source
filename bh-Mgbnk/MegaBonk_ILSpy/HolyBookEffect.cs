...
public class HolyBookEffect : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		Delegate obj = Delegate.Combine(ItemHolyBook.A_OnUse, b);
		nint num;
		Delegate obj2;
		object obj3;
		object obj4;
		...
		if ((object)obj == null)
		{
			ItemHolyBook.A_OnUse = (Action<float>)obj;
		}
		else
		{
	...
	private void OnDestroy()
	{
		...
		Delegate obj = Delegate.Remove(ItemHolyBook.A_OnUse, value);
		nint num;
		Delegate obj2;
		object obj3;
		object obj4;
	...
	private void Refresh(ItemBase obj)
	{
		...
		if ((object)MyPlayer.Instance != null)
		{
			...
			if (instance.inventory != null && inventory.itemInventory != null)
			{
				...
				int amount = inventory2.itemInventory.GetAmount(EItem.HolyBook);
