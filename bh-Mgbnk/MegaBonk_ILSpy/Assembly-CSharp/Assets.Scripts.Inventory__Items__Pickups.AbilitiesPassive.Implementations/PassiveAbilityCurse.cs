...
{
	private float difficultyChancePerLevel = 0.01f;
	...
	private void OnLevelup(int level)
	{
		...
		float modification = (float)level * difficultyChancePerLevel;
		statModifier.modifyType = EStatModifyType.Flat;
		statModifier.stat = EStat.Difficulty;
	...
	public override string GetDescription(LocalizedString localizedString)
	{
		...
		if (!flag)
		{
			...
			float num2 = difficultyChancePerLevel * 100f;
