...
{
	private float lifestealPerLevel = 0.01f;
	...
	private void OnLevelup(int level)
	{
		...
		float modification = (float)level * lifestealPerLevel;
		statModifier.modifyType = EStatModifyType.Flat;
		statModifier.stat = EStat.Lifesteal;
	...
	public override string GetDescription(LocalizedString localizedString)
	{
		...
		if (!flag)
		{
			...
			float num2 = lifestealPerLevel * 100f;
