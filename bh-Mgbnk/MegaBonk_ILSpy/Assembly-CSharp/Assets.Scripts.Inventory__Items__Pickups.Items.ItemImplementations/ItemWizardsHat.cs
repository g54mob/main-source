...
{
	private int tomeLevelsPerAmountMax = 10;

	private int tomeLevelsPerAmountMin = 2;
	...
	protected override void OnInitOrAmountChanged()
	{
		...
		if ((nint)obj > 0)
		{
			int num = tomeLevelsPerAmountMin;
			int num2 = tomeLevelsPerAmountMax - obj;
			if (num2 >= tomeLevelsPerAmountMin)
			{
				num = num2;
			}
			int num3 = tomeLevels + num;
			tomeLevels = num3;
		}
		else
		{
			int num4 = tomeLevelsPerAmountMax + tomeLevels;
			tomeLevels = num4;
		}
	}
