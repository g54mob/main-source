...
namespace Pathfinding
{
	...
	public struct PathTracer
	{
		...
		public delegate bool ContainsAndProject_00000974_0024PostfixBurstDelegate(ref Int3 a, ref Int3 b, ref Int3 c, ref Vector3 p, float height, ref NativeMovementPlane movementPlane, out Vector3 projected);

		internal static class ContainsAndProject_00000974_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(ContainsAndProject_00000974_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static ContainsAndProject_00000974_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		public delegate float EstimateRemainingPath_00000988_0024PostfixBurstDelegate(ref Funnel.FunnelState funnelState, ref Funnel.PathPart part, int maxCorners, ref NativeMovementPlane movementPlane);

		internal static class EstimateRemainingPath_00000988_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(EstimateRemainingPath_00000988_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static EstimateRemainingPath_00000988_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		public delegate float RemainingDistanceLowerBound_0000098C_0024PostfixBurstDelegate(in UnsafeSpan<float3> nextCorners, in float3 endOfPart, in NativeMovementPlane movementPlane);

		internal static class RemainingDistanceLowerBound_0000098C_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RemainingDistanceLowerBound_0000098C_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static RemainingDistanceLowerBound_0000098C_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		private static readonly QueueItem[][] TempQueues = new QueueItem[JobsUtility.ThreadIndexCount][];
		...
		{
			return ContainsAndProject_00000974_0024BurstDirectCall.Invoke(ref a, ref b, ref c, ref p, height, ref movementPlane, out projected);
		}
		...
		{
			return EstimateRemainingPath_00000988_0024BurstDirectCall.Invoke(ref funnelState, ref part, maxCorners, ref movementPlane);
		}
		...
		{
			return RemainingDistanceLowerBound_0000098C_0024BurstDirectCall.Invoke(in nextCorners, in endOfPart, in movementPlane);
		}
