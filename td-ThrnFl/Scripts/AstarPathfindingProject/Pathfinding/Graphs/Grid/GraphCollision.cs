...
namespace Pathfinding.Graphs.Grid
{
	...
	public class GraphCollision
	{
		...
		{
			NativeArray<OverlapCapsuleCommand> commands = dependencyTracker.NewNativeArray<OverlapCapsuleCommand>(nodePositions.Length, allocationMethod);
			NativeArray<ColliderHit> nativeArray = dependencyTracker.NewNativeArray<ColliderHit>(nodePositions.Length, allocationMethod);
		...
		{
			NativeArray<OverlapSphereCommand> commands = dependencyTracker.NewNativeArray<OverlapSphereCommand>(nodePositions.Length, allocationMethod);
			NativeArray<ColliderHit> nativeArray = dependencyTracker.NewNativeArray<ColliderHit>(nodePositions.Length, allocationMethod);
