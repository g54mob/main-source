...
namespace Pathfinding.Graphs.Navmesh
{
	...
	public struct BBTree : IDisposable
	{
		...
		{
			public delegate float SquaredRectPointDistanceOnPlane_00000AB3_0024PostfixBurstDelegate(in ProjectionParams projection, ref IntRect rect, ref float3 p);

			internal static class SquaredRectPointDistanceOnPlane_00000AB3_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(SquaredRectPointDistanceOnPlane_00000AB3_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static SquaredRectPointDistanceOnPlane_00000AB3_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				return SquaredRectPointDistanceOnPlane_00000AB3_0024BurstDirectCall.Invoke(in projection, ref rect, ref p);
			}
		...
		private struct NearbyNodesIterator : IEnumerator<CloseNode>, IEnumerator, IDisposable
		{
			...
			public delegate bool MoveNext_00000ABA_0024PostfixBurstDelegate(ref NearbyNodesIterator it);

			internal static class MoveNext_00000ABA_0024BurstDirectCall
			{
				private static IntPtr Pointer;
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(MoveNext_00000ABA_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static MoveNext_00000ABA_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				return MoveNext_00000ABA_0024BurstDirectCall.Invoke(ref it);
			}
		...
		public delegate void Build_00000AA8_0024PostfixBurstDelegate(ref UnsafeSpan<int> triangles, ref UnsafeSpan<Int3> vertices, out BBTree bbTree);

		internal static class Build_00000AA8_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Build_00000AA8_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static Build_00000AA8_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		{
			Build_00000AA8_0024BurstDirectCall.Invoke(ref triangles, ref vertices, out bbTree);
		}
		...
		public static void Initialize_0024NearbyNodesIterator_MoveNext_00000ABA_0024BurstDirectCall()
		{
			NearbyNodesIterator.MoveNext_00000ABA_0024BurstDirectCall.Initialize();
		}
	}
}
