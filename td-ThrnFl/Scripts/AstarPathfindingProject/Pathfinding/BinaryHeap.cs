...
namespace Pathfinding
{
	...
	public struct BinaryHeap
	{
		...
		public delegate void Add_000002EF_0024PostfixBurstDelegate(ref BinaryHeap binaryHeap, ref UnsafeSpan<PathNode> nodes, uint pathNodeIndex, uint g, uint f);

		internal static class Add_000002EF_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Add_000002EF_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static Add_000002EF_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		public delegate uint Remove_000002F2_0024PostfixBurstDelegate(ref UnsafeSpan<PathNode> nodes, ref BinaryHeap binaryHeap, [NoAlias] out uint removedG, [NoAlias] out uint removedF);

		internal static class Remove_000002F2_0024BurstDirectCall
		{
			private static IntPtr Pointer;
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Remove_000002F2_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static Remove_000002F2_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		{
			Add_000002EF_0024BurstDirectCall.Invoke(ref binaryHeap, ref nodes, pathNodeIndex, g, f);
		}
		...
		{
			return Remove_000002F2_0024BurstDirectCall.Invoke(ref nodes, ref binaryHeap, out removedG, out removedF);
		}
