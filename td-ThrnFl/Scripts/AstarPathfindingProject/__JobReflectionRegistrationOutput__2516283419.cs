...
internal class __JobReflectionRegistrationOutput__2516283419
{
	public static void CreateJobReflectionData()
	{
		try
		{
			...
			Unity.Jobs.IJobExtensions.EarlyJobInit<MeshUtility.JobRemoveDuplicateVertices>();
			Unity.Jobs.IJobExtensions.EarlyJobInit<JobRVOPreprocess>();
