...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMMotionBlurShakeEvent_HDRP
	{
		...
		{
			MMMotionBlurShakeEvent_HDRP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
