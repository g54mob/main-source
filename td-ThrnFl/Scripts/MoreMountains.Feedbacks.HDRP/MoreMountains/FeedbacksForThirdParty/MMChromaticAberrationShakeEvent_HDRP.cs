...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMChromaticAberrationShakeEvent_HDRP
	{
		...
		{
			MMChromaticAberrationShakeEvent_HDRP.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
