...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMVignetteShakeEvent
	{
		...
		{
			MMVignetteShakeEvent.OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, feedbacksIntensity, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, interpolateColor, colorCurve, remapColorZero, remapColorOne, targetColor);
		}
	}
}
