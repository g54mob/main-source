...
namespace Rewired
{
	...
	public sealed class InputBehavior
	{
		...
		public InputBehavior(InputBehavior P_0)
			: this()
		{
			KBCjtnJtlvRGIsmjUrhQXDuUgpRY(P_0, this, true);
		}
		...
		public string ToXmlString()
		{
			try
			{
				return oDOKmFnzHYDVnjOvPcQXBPjHvjWkA().ToXmlString(writeDocumentTag: true);
			}
			catch (Exception ex)
			{
		...
		public bool ImportXmlString(string xmlString)
		{
			try
			{
				nHxdOCfJYfFJjdYvkHMDDWSFwTDOA(SerializedObject.FromXml(GetType(), xmlString));
				return true;
			}
			catch (Exception ex)
			{
		...
		public string ToJsonString()
		{
			try
			{
				return oDOKmFnzHYDVnjOvPcQXBPjHvjWkA().ToJsonString();
			}
			catch (Exception ex)
			{
		...
		public bool ImportJsonString(string jsonString)
		{
			try
			{
				nHxdOCfJYfFJjdYvkHMDDWSFwTDOA(SerializedObject.FromJson(GetType(), jsonString));
				return true;
			}
			catch (Exception ex)
			{
		...
		public bool ImportData(InputBehavior inputBehavior)
		{
			...
			KBCjtnJtlvRGIsmjUrhQXDuUgpRY(inputBehavior, this, false);
			return true;
		}
		...
		public void Reset()
		{
			InputBehavior inputBehavior = ReInput.mapping.oobeFUCKgXohzRwOJumsbVieMgHHb(_id);
			if (inputBehavior != null)
			{
				KBCjtnJtlvRGIsmjUrhQXDuUgpRY(inputBehavior, this, true);
			}
		}

		internal SerializedObject oDOKmFnzHYDVnjOvPcQXBPjHvjWkA()
		{
			...
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.vaFqdHQxGUQBtSFqxHiqhgbjfOejA
			{
				...
				HDNykFqkGTdIdaCMqpOZhaRNJXwGb = 5.ToString()
			});
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.vaFqdHQxGUQBtSFqxHiqhgbjfOejA
			{
				MqiGgwQfPHmSRCgxvJyAMdrqqrIv = "id",
				HDNykFqkGTdIdaCMqpOZhaRNJXwGb = _id.ToString()
			});
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.vaFqdHQxGUQBtSFqxHiqhgbjfOejA
			{
			...
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.vaFqdHQxGUQBtSFqxHiqhgbjfOejA
			{
				...
				kGESCebYXkaHwqimYjUfiApoHXHAA = null,
				HDNykFqkGTdIdaCMqpOZhaRNJXwGb = string.Format("{0} {1}{2}{3}{4}{5}", "http://guavaman.com/rewired", "http://guavaman.com/schemas/rewired/", "1.4", "/", GetType().Name, ".xsd")
			});
		...
		internal void nHxdOCfJYfFJjdYvkHMDDWSFwTDOA(SerializedObject P_0)
		{
			Reset();
		...
		private static void KBCjtnJtlvRGIsmjUrhQXDuUgpRY(InputBehavior P_0, InputBehavior P_1, bool P_2)
		{
			if (P_2)
			{
				P_1._id = P_0._id;
