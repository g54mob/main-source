...
namespace Rewired.Components
{
	...
	public sealed class PlayerMouse : PlayerController, IPlayerMouse, IPlayerController, IMouseInputSource
	{
		...
		private Rewired.PlayerMouse yJaxDaDDiehlGvPPBCbprrKdNARR => base.source as Rewired.PlayerMouse;
		...
		bool IPlayerMouse.defaultToCenter
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EdefaultToCenter;
			}
			set
			{
				if (yJaxDaDDiehlGvPPBCbprrKdNARR == null)
				{
					_defaultToCenter = value;
					return;
				}
				yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EdefaultToCenter = value;
				_defaultToCenter = yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EdefaultToCenter;
			}
		}
		...
		public bool clampToMovementArea
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.clampToMovementArea;
			}
			set
			{
				if (yJaxDaDDiehlGvPPBCbprrKdNARR == null)
				...
				yJaxDaDDiehlGvPPBCbprrKdNARR.clampToMovementArea = value;
				_clampToMovementArea = yJaxDaDDiehlGvPPBCbprrKdNARR.clampToMovementArea;
			}
		}
		...
		ScreenRect IPlayerMouse.movementArea
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EmovementArea;
			}
			set
			{
				if (yJaxDaDDiehlGvPPBCbprrKdNARR == null)
				...
				yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EmovementArea = value;
				_movementArea = new Rect(yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EmovementArea.xMin, yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EmovementArea.yMin, yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EmovementArea.width, yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EmovementArea.height);
			}
		}
		...
		Rewired.PlayerMouse.MovementAreaUnit IPlayerMouse.movementAreaUnit
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EmovementAreaUnit;
			}
			set
			{
				if (yJaxDaDDiehlGvPPBCbprrKdNARR == null)
				...
				yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EmovementAreaUnit = value;
				_movementAreaUnit = yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EmovementAreaUnit;
			}
		}
		...
		Vector2 IPlayerMouse.screenPosition
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EscreenPosition;
			}
			set
			{
				if (yJaxDaDDiehlGvPPBCbprrKdNARR != null)
				{
					yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EscreenPosition = value;
				}
			}
		}
		...
		Vector2 IPlayerMouse.screenPositionPrev
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EscreenPositionPrev;
			}
		}
		...
		Vector2 IPlayerMouse.screenPositionDelta
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EscreenPositionDelta;
			}
		}
		...
		Rewired.PlayerController.MouseAxis IPlayerMouse.xAxis
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002ExAxis;
			}
		}
		...
		Rewired.PlayerController.MouseAxis IPlayerMouse.yAxis
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EyAxis;
			}
		}
		...
		Rewired.PlayerController.MouseWheel IPlayerMouse.wheel
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002Ewheel;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.leftButton
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EleftButton;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.rightButton
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002ErightButton;
			}
		}
		...
		Rewired.PlayerController.Button IPlayerMouse.middleButton
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EmiddleButton;
			}
		}
		...
		float IPlayerMouse.pointerSpeed
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EpointerSpeed;
			}
			set
			{
				if (value < 0f)
				...
				if (base.initialized)
				{
					yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EpointerSpeed = value;
					_pointerSpeed = yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EpointerSpeed;
				}
			}
		}
		...
		bool IPlayerMouse.useHardwarePointerPosition
		{
			get
			{
				...
				return yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EuseHardwarePointerPosition;
			}
			set
			{
				...
				if (base.initialized)
				{
					yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EuseHardwarePointerPosition = value;
				}
			}
		}
		...
		bool IMouseInputSource.enabled
		{
			get
			{
				...
				return ((IMouseInputSource)yJaxDaDDiehlGvPPBCbprrKdNARR).enabled;
			}
		}
		...
		Vector2 IMouseInputSource.screenPosition
		{
			get
			{
				...
				return ((IMouseInputSource)yJaxDaDDiehlGvPPBCbprrKdNARR).screenPosition;
			}
		}
		...
		Vector2 IMouseInputSource.screenPositionDelta
		{
			get
			{
				...
				return ((IMouseInputSource)yJaxDaDDiehlGvPPBCbprrKdNARR).screenPositionDelta;
			}
		}
		...
		Vector2 IMouseInputSource.wheelDelta
		{
			get
			{
				...
				return ((IMouseInputSource)yJaxDaDDiehlGvPPBCbprrKdNARR).wheelDelta;
			}
		}
		...
		bool IMouseInputSource.locked
		{
			get
			{
				...
				return ((IMouseInputSource)yJaxDaDDiehlGvPPBCbprrKdNARR).locked;
			}
		}
		...
		event Action<Vector2> IPlayerMouse.ScreenPositionChangedEvent
		{
			add
			{
				if (base.initialized)
				{
					yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EScreenPositionChangedEvent += value;
				}
			}
			remove
			{
		...
		protected override Rewired.PlayerController CreateSource(object args)
		{
			...
			if (list == null || list.Count == 0)
			{
				...
				list = GBKAuiAThnHWfIddnHHwpXmiLaEhA();
			}
		...
		protected override void Subscribe()
		{
			...
			if (yJaxDaDDiehlGvPPBCbprrKdNARR != null)
			{
				yJaxDaDDiehlGvPPBCbprrKdNARR.Rewired_002EIPlayerMouse_002EScreenPositionChangedEvent += aPMQThSFanycIlldqZtlMJYAhrYA;
			}
		}
		...
		internal List<ElementInfo> tSDSQLslwqEuBAprVBaBOmXYgbmz()
		{
		...
		private void aPMQThSFanycIlldqZtlMJYAhrYA(Vector2 P_0)
		{
		...
		bool IMouseInputSource.GetButtonDown(int button)
		{
			...
			return ((IMouseInputSource)yJaxDaDDiehlGvPPBCbprrKdNARR).GetButtonDown(button);
		}
		...
		bool IMouseInputSource.GetButtonUp(int button)
		{
			...
			return ((IMouseInputSource)yJaxDaDDiehlGvPPBCbprrKdNARR).GetButtonUp(button);
		}
		...
		bool IMouseInputSource.GetButton(int button)
		{
			...
			return ((IMouseInputSource)yJaxDaDDiehlGvPPBCbprrKdNARR).GetButton(button);
		}
	}
}
