...
namespace Rewired.Utils.Classes
{
	...
	{
		private const int extxfiiTBfcbHskMHZRtDgeCIJUh = 3;

		[NonSerialized]
		private bool XhKasOFHQtewNUsTvqUchcekOITGb;
		...
		{
			if (!XhKasOFHQtewNUsTvqUchcekOITGb)
			{
				bxFFmPHvJrwqyCDPCQfhxhhCymZsA();
			}
		...
		private void bxFFmPHvJrwqyCDPCQfhxhhCymZsA()
		{
			_data = new List<TypeWrapper>(3);
			XhKasOFHQtewNUsTvqUchcekOITGb = true;
		}
	}
}
