...
namespace Rewired
{
	...
	{
		private const string ZtYNeUKEPVkndOPfcppbkCmBIDSAA = "[^a-fA-F0-9]";
		...
		{
			if (string.IsNullOrEmpty(FuOCxKkkXzQCNdtlFHeUexnubEKN(P_0)))
			{
				productId = 0;
				vendorId = 0;
				return;
		...
		{
			return dKJrOzpNAlbNgAERWhvjfgoADItd(FuOCxKkkXzQCNdtlFHeUexnubEKN(pidVid));
		}
		...
		private bool dKJrOzpNAlbNgAERWhvjfgoADItd(string P_0)
		{
		...
		private static string FuOCxKkkXzQCNdtlFHeUexnubEKN(string P_0)
		{
