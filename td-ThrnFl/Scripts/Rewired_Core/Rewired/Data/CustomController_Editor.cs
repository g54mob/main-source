...
namespace Rewired.Data
{
	...
	public sealed class CustomController_Editor
	{
		...
		private sealed class XuDgqczEhrAldfNsEuITIpYpqEsX : IEnumerable<ControllerElementIdentifier>, IEnumerable, IEnumerator<ControllerElementIdentifier>, IEnumerator, IDisposable
		{
			private int KtewhucPJmZGrBfpfNbxxZXqhMKW;

			private ControllerElementIdentifier ZjyrEGYseqMpXRiEiTQenkZjtdKq;

			private int ZqxbsiMwnETYLxUvstsJggcTIJus;

			public CustomController_Editor FJmEpTgETKbnjgwbiJMNfyMTQowKb;

			private int srBXnzcMZxspTgvnXeJKlQMGNUi;
			...
			ControllerElementIdentifier IEnumerator<ControllerElementIdentifier>.Current
			{
				...
				get
				{
					return ZjyrEGYseqMpXRiEiTQenkZjtdKq;
				}
			}
			...
			[DebuggerHidden]
			public XuDgqczEhrAldfNsEuITIpYpqEsX(int P_0)
			{
				KtewhucPJmZGrBfpfNbxxZXqhMKW = P_0;
				ZqxbsiMwnETYLxUvstsJggcTIJus = Environment.CurrentManagedThreadId;
			}
			...
			{
				int ktewhucPJmZGrBfpfNbxxZXqhMKW = KtewhucPJmZGrBfpfNbxxZXqhMKW;
				CustomController_Editor fJmEpTgETKbnjgwbiJMNfyMTQowKb = FJmEpTgETKbnjgwbiJMNfyMTQowKb;
				switch (ktewhucPJmZGrBfpfNbxxZXqhMKW)
				{
				default:
					return false;
				case 0:
					KtewhucPJmZGrBfpfNbxxZXqhMKW = -1;
					if (fJmEpTgETKbnjgwbiJMNfyMTQowKb._elementIdentifiers == null)
					{
						return false;
					}
					srBXnzcMZxspTgvnXeJKlQMGNUi = 0;
					break;
				case 1:
					KtewhucPJmZGrBfpfNbxxZXqhMKW = -1;
					srBXnzcMZxspTgvnXeJKlQMGNUi++;
					break;
				}
				if (srBXnzcMZxspTgvnXeJKlQMGNUi < fJmEpTgETKbnjgwbiJMNfyMTQowKb._elementIdentifiers.Count)
				{
					ZjyrEGYseqMpXRiEiTQenkZjtdKq = fJmEpTgETKbnjgwbiJMNfyMTQowKb._elementIdentifiers[srBXnzcMZxspTgvnXeJKlQMGNUi];
					KtewhucPJmZGrBfpfNbxxZXqhMKW = 1;
					return true;
				}
				return false;
			...
			{
				XuDgqczEhrAldfNsEuITIpYpqEsX xuDgqczEhrAldfNsEuITIpYpqEsX;
				if (KtewhucPJmZGrBfpfNbxxZXqhMKW == -2 && ZqxbsiMwnETYLxUvstsJggcTIJus == Environment.CurrentManagedThreadId)
				{
					KtewhucPJmZGrBfpfNbxxZXqhMKW = 0;
					xuDgqczEhrAldfNsEuITIpYpqEsX = this;
				}
				else
				{
					xuDgqczEhrAldfNsEuITIpYpqEsX = new XuDgqczEhrAldfNsEuITIpYpqEsX(0);
					xuDgqczEhrAldfNsEuITIpYpqEsX.FJmEpTgETKbnjgwbiJMNfyMTQowKb = FJmEpTgETKbnjgwbiJMNfyMTQowKb;
				}
				return xuDgqczEhrAldfNsEuITIpYpqEsX;
			}
		...
		{
			[IteratorStateMachine(typeof(XuDgqczEhrAldfNsEuITIpYpqEsX))]
			get
			{
				return new XuDgqczEhrAldfNsEuITIpYpqEsX(-2)
				{
					FJmEpTgETKbnjgwbiJMNfyMTQowKb = this
				};
			}
		}
		...
		public void AddAxis()
		{
			axes.Add((Axis)AulDtTTiNHlVmpEjUCMuXUvlAdkl(ControllerElementType.Axis));
		}

		public void AddButton()
		{
			buttons.Add((Button)AulDtTTiNHlVmpEjUCMuXUvlAdkl(ControllerElementType.Button));
		}
		...
		public void InsertAxis(int index)
		{
			...
			axes.Insert(index, (Axis)AulDtTTiNHlVmpEjUCMuXUvlAdkl(ControllerElementType.Axis));
		}
		...
		public void InsertButton(int index)
		{
			...
			buttons.Insert(index, (Button)AulDtTTiNHlVmpEjUCMuXUvlAdkl(ControllerElementType.Button));
		}
		...
		public void DuplicateElement(ControllerElementType type, int index)
		{
			...
			{
			case ControllerElementType.Axis:
				HgMHVGErSmkTsBqhNLHgwBdnRqUD(index, axes);
				break;
			case ControllerElementType.Button:
				HgMHVGErSmkTsBqhNLHgwBdnRqUD(index, buttons);
				break;
			default:
				throw new NotImplementedException();
			}
		...
		private void HgMHVGErSmkTsBqhNLHgwBdnRqUD<_0001>(int P_0, List<_0001> P_1) where _0001 : Element
		{
			...
			ControllerElementIdentifier controllerElementIdentifier = FBKoGirhcbYqDmgyQbcpeEfZOeBr(val.elementIdentifierId, text);
		...
		private ControllerElementIdentifier FBKoGirhcbYqDmgyQbcpeEfZOeBr(int P_0, string P_1)
		{
		...
		private Element AulDtTTiNHlVmpEjUCMuXUvlAdkl(ControllerElementType P_0)
		{
			switch (P_0)
			{
			case ControllerElementType.Axis:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier2 = CDKYwMqBpNyMNyRhDaOAQfVdChYE(P_0, text2, string.Empty, string.Empty, key, string.Empty, string.Empty);
			...
			case ControllerElementType.Button:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier = CDKYwMqBpNyMNyRhDaOAQfVdChYE(P_0, text, string.Empty, string.Empty, key, string.Empty, string.Empty);
		...
		private ControllerElementIdentifier CDKYwMqBpNyMNyRhDaOAQfVdChYE(ControllerElementType P_0, string P_1, string P_2, string P_3, string P_4, string P_5, string P_6)
		{
			int elementIdentifierIdCounter = _elementIdentifierIdCounter;
			_elementIdentifierIdCounter++;
			ControllerElementIdentifier controllerElementIdentifier = new ControllerElementIdentifier(new ControllerElementIdentifier.JJdeZvdjnivmGnZMnwtOMfIBzcAP
