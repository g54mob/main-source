...
namespace Rewired.Data
{
	...
	{
		private static class QeSyrVZDEvXDtVovVtXnmcHUPzJN
		{
			public const string ryGjNEYCKjHEcBKkpYkYqBBeELtu = "updateLoop";

			public const string NTkyiUqPhJSCriMyvLsNVmzhKAAB = "alwaysUseUnityInput";

			public const string wprVIEMAfneWvllqWgraNvWOforP = "windowsStandalonePrimaryInputSource";

			public const string LnbzlRBeXUKVkLSSmaBiqVQsItjf = "osx_primaryInputSource";

			public const string KPgqCMqTcZSmCSmQYAVsRxydFBtG = "linux_primaryInputSource";

			public const string SWBVCJhHTiHYSDeiLgUhJBTnhfzy = "windowsUWP_primaryInputSource";

			public const string HGwZxeMHGmpHFNPhUXsnOFWwZSwd = "xboxOne_primaryInputSource";

			public const string MquuwopsPRuNTjYYHPuHJFDAbogE = "gameCoreXboxOne_primaryInputSource";

			public const string aDxbXSqPYAPLgNkJBptUXfJTFnCU = "gameCoreScarlett_primaryInputSource";

			public const string CCTlAffeTJxIifyhFbluaHEtROht = "ps4_primaryInputSource";

			public const string BcOeBsqqXZTOhBqFpCZIFwfpKETp = "ps5_primaryInputSource";

			public const string KKnyZCHOoYVGThwCxWPUPhegKXGG = "webGL_primaryInputSource";

			public const string BkedvjHnlgsgXQuTSMkrwYIJNgJc = "useXInput";

			public const string uimEDiEMjkfQtZRfomMcvRkyIyqF = "windowsStandalone_useSteamRawInputControllerWorkaround";

			public const string LucoKhEVrRpsJogZlKEBoijBwbTu = "osxStandalone_useEnhancedDeviceSupport";

			public const string FoQyZVlojGvwJldqDjyXInBdAhCv = "android_supportUnknownGamepads";

			public const string QDmkLwXJrGDsrAgJayZHcYboCFOuA = "ps4_assignJoysticksByPS4JoyId";

			public const string HPlHxjUvMffJqOrJqhOQTuUUqdaE = "useSteamControllerSupport";

			public const string qQtdhxFwYNtOhUNwxghdcOABjLKk = "logToScreen";

			public const string xoVARNwRXyCCrHSRNGiZiVsvSHpZ = "runInEditMode";

			public const string wCcETtUoehfSXbRSckxzeVltqQHnA = "allowInputInEditorSceneView";

			public const string HfLqMZwcTvQoEpIbioqUSzJZBcpe = "maxJoysticksPerPlayer";

			public const string ZIxeqZsHaYWoIdyNGReRcEHDVRgX = "autoAssignJoysticks";

			public const string JdRcqXlZIjJwpuqpKrdfyKfMxjvL = "assignJoysticksToPlayingPlayersOnly";

			public const string EzZalDGnlLGIjjRaDtcMkqMKUwifb = "distributeJoysticksEvenly";

			public const string RleQLnrohljYByTrbeTTWBrUZVYF = "reassignJoystickToPreviousOwnerOnReconnect";

			public const string XWpHPbcuajLJUHGaJfqBUPnHFYUz = "defaultJoystickAxis2DDeadZoneType";

			public const string VeObJSUOcAFirTQegslwqccKiBtK = "defaultJoystickAxis2DSensitivityType";

			public const string dbuybKUabZydRSoDJxcLndRLOlzg = "defaultAxisSensitivityType";

			public const string dAUTROuKKZITKcxBZqzmDELbaqWmA = "force4WayHats";

			public const string kFXsUhpBdByxTTZUofVqllHqBKCf = "throttleCalibrationMode";

			public const string jnPAMkEOqSNJQHJCRgJPCVDuyURh = "activateActionButtonsOnNegativeValue";

			public const string mdqLkAPWOaLYObbDsbLXcDUevYhKA = "deferControllerConnectedEventsOnStart";

			public const string iTzMKSkAAZOgusZPqnAiEJIzhELD = "logLevel";

			public const string ebKeLJyRlHBujGrgpzEtaoPkfPrUA = "disableKeyboard";

			public const string oTrJnzkeGFpBjbgajgJpDOXljnyuA = "disableMouse";

			public const string denVgaJtmUiTXIMapBICyqMoYBwX = "ignoreInputWhenAppNotInFocus";

			public const string PtkttDRKgojsJdotmNJEexecGAdrB = "useEnhancedDeviceSupport";

			public const string hzhdYNEGfVRadzfAuGpUkROqiTSnA = "useNativeMouse";

			public const string OvUcJdGsRYjfaICvhPIPEcivafhNA = "useNativeKeyboard";

			public const string pxDbhZtMqYJlYSZUJBvGfUUVMdVB = "joystickRefreshRate";

			public const string DFVPytNsoDTcVadqeekDiuyQIKPfb = "assignJoysticksBySystemId";
		}
		...
		private class UtLgHwAfPRPIQjJzIDXmwLEuwZzUA
		{
			public Func<PlatformVars> BVWfHIShUvBIsINCJArAykklKPwtA;

			public string PXHfbMIMVggaBYOPVIWIoENwRBpJA;

			public UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(Func<PlatformVars> P_0, string P_1)
			{
				BVWfHIShUvBIsINCJArAykklKPwtA = P_0;
				PXHfbMIMVggaBYOPVIWIoENwRBpJA = P_1;
			}
		}

		private class HlYghWdmvzGiYFtNNvRBeBIhpCECc
		{
			public Func<Platform, object> hAQUWKtXZdduoXMWxUkAgQYKTgps;

			public Action<Platform, object> jeyEKzODhIbhcrqSjtXFKYMSWGcG;

			public HlYghWdmvzGiYFtNNvRBeBIhpCECc(Func<Platform, object> P_0, Action<Platform, object> P_1)
			{
				hAQUWKtXZdduoXMWxUkAgQYKTgps = P_0;
				jeyEKzODhIbhcrqSjtXFKYMSWGcG = P_1;
			}
		}
		...
		private Dictionary<int, UtLgHwAfPRPIQjJzIDXmwLEuwZzUA> __platformVarsDict;

		private Dictionary<int, HlYghWdmvzGiYFtNNvRBeBIhpCECc> __getSetPlatformVariableDict;

		private KeyedGetSetValueStore<string> __configVarsValues;

		private Dictionary<string, object> __valueDelegates;

		private Dictionary<int, UtLgHwAfPRPIQjJzIDXmwLEuwZzUA> platformVarsDict
		{
			get
			{
				Dictionary<int, UtLgHwAfPRPIQjJzIDXmwLEuwZzUA> dictionary = __platformVarsDict;
				if (dictionary == null)
				{
					Dictionary<int, UtLgHwAfPRPIQjJzIDXmwLEuwZzUA> obj = new Dictionary<int, UtLgHwAfPRPIQjJzIDXmwLEuwZzUA>
					{
						{
							1,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_windowsStandalone), "platformVars_windowsStandalone")
						},
						{
							29,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_windowsUWP), "platformVars_windowsUWP")
						},
						{
							6,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_linuxStandalone), "platformVars_linuxStandalone")
						},
						{
							4,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_osxStandalone), "platformVars_osxStandalone")
						},
						{
							5,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_iOS), "platformVars_iOS")
						},
						{
							28,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_tvOS), "platformVars_tvOS")
						},
						{
							13,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_ps4), "platformVars_ps4")
						},
						{
							106,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_ps5), "platformVars_ps5")
						},
						{
							15,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_psVita), "platformVars_psVita")
						},
						{
							14,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_psVita), "platformVars_psVita")
						...
						{
							32,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_switch), "platformVars_switch")
						},
						{
							11,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_xboxOne), "platformVars_xboxOne")
						},
						{
							104,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_gameCoreXboxOne), "platformVars_gameCoreXboxOne")
						},
						{
							105,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_gameCoreScarlett), "platformVars_gameCoreScarlett")
						},
						{
							19,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_webGL), "platformVars_webGL")
						},
						{
							7,
							new UtLgHwAfPRPIQjJzIDXmwLEuwZzUA(() => GetOrCreatePlatformVars(ref platformVars_android), "platformVars_android")
						}
					};
					Dictionary<int, UtLgHwAfPRPIQjJzIDXmwLEuwZzUA> dictionary2 = obj;
		...
		private Dictionary<int, HlYghWdmvzGiYFtNNvRBeBIhpCECc> getSetPlatformVariableDict
		{
			get
			{
				Dictionary<int, HlYghWdmvzGiYFtNNvRBeBIhpCECc> dictionary = __getSetPlatformVariableDict;
				if (dictionary == null)
				{
					Dictionary<int, HlYghWdmvzGiYFtNNvRBeBIhpCECc> obj = new Dictionary<int, HlYghWdmvzGiYFtNNvRBeBIhpCECc>
					{
						{
							0,
							new HlYghWdmvzGiYFtNNvRBeBIhpCECc((Platform p) => GetPlatformVars(p).disableKeyboard, delegate(Platform platform, object value)
							{
						...
						{
							2,
							new HlYghWdmvzGiYFtNNvRBeBIhpCECc((Platform p) => GetPlatformVars(p).disableMouse, delegate(Platform platform, object value)
							{
						...
						{
							1,
							new HlYghWdmvzGiYFtNNvRBeBIhpCECc((Platform platform) => GetPlatformVars(platform).ignoreInputWhenAppNotInFocus, delegate(Platform platform, object value)
							{
								GetPlatformVars(platform).ignoreInputWhenAppNotInFocus = (bool)value;
							})
						}
					};
					Dictionary<int, HlYghWdmvzGiYFtNNvRBeBIhpCECc> dictionary2 = obj;
		...
		internal string GetPlatformVarsRelPath(Platform platform)
		{
			...
			{
				return platformVarsDict[(int)platform].PXHfbMIMVggaBYOPVIWIoENwRBpJA;
			}
		...
		{
			PlatformVars platformVars = ((platform == Platform.Custom && NaCVyIMwuDhgdNZldvvjhuHYfOGS.gWMFbUBERbzpcApqKNWTmCSqQImmA) ? NaCVyIMwuDhgdNZldvvjhuHYfOGS.HJsKmaqdYjlHXDInJwuQuCHoYyED() : ((!platformVarsDict.ContainsKey((int)platform)) ? GetOrCreatePlatformVars(ref platformVars_unknown) : platformVarsDict[(int)platform].BVWfHIShUvBIsINCJArAykklKPwtA()));
		...
		{
			foreach (KeyValuePair<int, UtLgHwAfPRPIQjJzIDXmwLEuwZzUA> item in platformVarsDict)
			{
				if (getSetPlatformVariableDict.ContainsKey((int)var))
				{
					getSetPlatformVariableDict[(int)var].jeyEKzODhIbhcrqSjtXFKYMSWGcG((Platform)item.Key, value);
				}
			}
		}
		...
		internal bool SetPlatformVar_useNativeMouse(bool value)
		{
			...
			case Platform.Custom:
				...
				{
					NaCVyIMwuDhgdNZldvvjhuHYfOGS.HJsKmaqdYjlHXDInJwuQuCHoYyED().useNativeMouse = value;
					return true;
				}
				return false;
			default:
		...
		internal bool SetPlatformVar_useNativeKeyboard(bool value)
		{
			...
			case Platform.Custom:
				if (NaCVyIMwuDhgdNZldvvjhuHYfOGS.gWMFbUBERbzpcApqKNWTmCSqQImmA)
				{
					NaCVyIMwuDhgdNZldvvjhuHYfOGS.HJsKmaqdYjlHXDInJwuQuCHoYyED().useNativeKeyboard = value;
					return true;
				}
				return false;
			default:
		...
		private MultiBoolValue GetAllSerializedPlatformVar_multiBool(AllPlatformVar var)
		{
			...
			foreach (KeyValuePair<int, UtLgHwAfPRPIQjJzIDXmwLEuwZzUA> item in platformVarsDict)
			{
				...
				object obj = getSetPlatformVariableDict[(int)var].hAQUWKtXZdduoXMWxUkAgQYKTgps((Platform)item.Key);
				if (obj == null)
				{
					continue;
				}
