...
namespace Rewired
{
	public abstract class ControllerMapSaveData
	{
		...
		internal readonly int fihKPNJCkrlyQftGGqZBvTrAXjSb;
		...
		internal ControllerMapSaveData(Controller P_0, ControllerMap P_1)
		{
			_controller = P_0;
			_map = P_1;
			fihKPNJCkrlyQftGGqZBvTrAXjSb = ReInput.id;
		}

		internal static _0001 ygxoxFCEHeVEgwJYjlxYBbEQsGlS<_0001>(Controller P_0, ControllerMap P_1) where _0001 : ControllerMapSaveData
		{
			return (_0001)ygxoxFCEHeVEgwJYjlxYBbEQsGlS(P_0, P_1);
		}

		internal static ControllerMapSaveData ygxoxFCEHeVEgwJYjlxYBbEQsGlS(Controller P_0, ControllerMap P_1)
		{
