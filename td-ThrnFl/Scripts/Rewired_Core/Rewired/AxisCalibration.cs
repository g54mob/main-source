...
namespace Rewired
{
	...
	public sealed class AxisCalibration
	{
		...
		{
			0,
			AxisCalibrationInfo.GfXToZQsRCqytsljgkqNdKAeFrOR(AxisCalibrationData.Default)
		} };
		...
		private void CreateDefaultHardwareCalibration(AxisCalibrationData defaultData)
		{
			...
			{
				AxisCalibrationInfo value = AxisCalibrationInfo.GfXToZQsRCqytsljgkqNdKAeFrOR(defaultData);
