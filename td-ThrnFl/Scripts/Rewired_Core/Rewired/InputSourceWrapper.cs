...
namespace Rewired
{
	...
	{
		private T tuYVhTiNHBuzcvyrsRRrdFENXZwU;

		private bool FnRzlMMIXYmTeFhWoTarLmhfFNvM;

		public T source => tuYVhTiNHBuzcvyrsRRrdFENXZwU;
		...
		{
			tuYVhTiNHBuzcvyrsRRrdFENXZwU = P_0;
		}
		...
		{
			if (!FnRzlMMIXYmTeFhWoTarLmhfFNvM)
			{
				FnRzlMMIXYmTeFhWoTarLmhfFNvM = true;
			}
		}
	}
}
