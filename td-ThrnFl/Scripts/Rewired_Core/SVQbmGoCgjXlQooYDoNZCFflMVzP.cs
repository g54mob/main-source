...
internal static class SVQbmGoCgjXlQooYDoNZCFflMVzP
{
	public static ControllerElementType UeHIoYfXRtOMvsmupeRJgnkNPpWjA(ElementAssignmentType P_0)
	{
		switch (P_0)
		{
	...
	public static ElementAssignmentType XEhEXMdwTBwOGkmCNQQTaNHWNLoA(ControllerType P_0, ControllerElementType P_1, AxisRange P_2)
	{
	...
	public static AxisRange CLkoCGPySyArSCSbNYACaNwqXVND(Pole P_0)
	{
		return P_0 switch
		{
	...
	public static Type qqfCvQPqQGHYUrbwJjmCzcyDiREg<_0001>() where _0001 : Controller
	{
		return jqiFJmetehNXlFzmgqmhMmvbfweOd(typeof(_0001));
	}

	public static Type jqiFJmetehNXlFzmgqmhMmvbfweOd(Type P_0)
	{
	...
	public static Type djwuMjAfmegEECXzMdabkNiobhxE(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static Type oSDLYLLeSAsahyKbgbghdASSmtgWA(ControllerType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerType lKxuyBclViGMVsApqlKPSvKnBlsn(Type P_0)
	{
		if (P_0 == null)
		{
	...
	public static ControllerType GpDEkhsBiqfPoBLEipLBKrkLdvuKA<_0001>()
	{
		return lKxuyBclViGMVsApqlKPSvKnBlsn(typeof(_0001));
	}

	public static ControllerType hiJwzlNCALHeHQAMfgqGgyEYHdJpA(Type P_0)
	{
		if (!TflsexkprxTQXTyhBlSvdcTxZZjV(P_0, out var result))
		{
			throw new Exception(P_0.Name + " is not an allowed type.");
		}
		return result;
	...
	public static ControllerType layuPNmdlkWxagmCWvNTmMGadukr<_0001>() where _0001 : ControllerMap
	{
		return hiJwzlNCALHeHQAMfgqGgyEYHdJpA(typeof(_0001));
	}

	public static bool TflsexkprxTQXTyhBlSvdcTxZZjV(Type P_0, out ControllerType P_1)
	{
		if (P_0 == null)
		{
	...
	public static bool uKTtsjLiKSZYEkajJsfrTScFdaTk<_0001>(out ControllerType P_0) where _0001 : ControllerMap
	{
		return TflsexkprxTQXTyhBlSvdcTxZZjV(typeof(_0001), out P_0);
	}

	public static ControllerType sSANwkEqhkhOwLntTmaQJXwdDzIU(Type P_0)
	{
		if (P_0 == null)
		{
	...
	public static ControllerType HVgFfddVfuwcqGWPPbjurndwZjzH<_0001>() where _0001 : ControllerMapSaveData
	{
		return sSANwkEqhkhOwLntTmaQJXwdDzIU(typeof(_0001));
	}

	public static bool edqGGblFJsGNqEUwHalLOPrYnSTAA(ControllerTemplateElementType P_0, ControllerElementType P_1)
	{
		return P_1 switch
		{
	...
	public static ControllerElementType NYNFRzJYZXfmEQTkvtZqfqijWwqBA(object P_0)
	{
		if (P_0 == null)
		{
		...
		{
			return ZqnjaZOfwlbSZqPnxxQssHwyaKuDA((ControllerTemplateElementType)P_0);
		}
		throw new NotImplementedException();
	}

	public static ControllerElementType ZqnjaZOfwlbSZqPnxxQssHwyaKuDA(ControllerTemplateElementType P_0)
	{
		return P_0 switch
		{
	...
	public static ControllerTemplateElementSourceType HCkgUNddabJoZqfMogdaWOENwpBY(ControllerTemplateElementType P_0, bool P_1)
	{
		switch (P_0)
		{
	...
	public static ControllerTemplateElementType qJtXJpUXwwvizFfxspHyzGUSDxUj(ControllerElementType P_0, bool P_1)
	{
		switch (P_0)
		{
		case ControllerElementType.Axis:
