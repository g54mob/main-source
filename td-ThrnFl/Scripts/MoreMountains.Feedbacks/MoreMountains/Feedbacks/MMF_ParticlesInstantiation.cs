...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_ParticlesInstantiation : MMF_Feedback
	{
		...
		protected override void CustomInitialization(MMF_Player owner)
		{
			...
			else if (Mode == Modes.Pool && !_poolCreatedOrFound)
			{
		...
		{
			if (Mode == Modes.OnDemand && CachedRecycle && RandomParticlePrefabs.Count == 0 && _instantiatedParticleSystem != null)
			{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1f)
		{
			...
			else if (Mode == Modes.Pool && _objectPooler != null)
			{
