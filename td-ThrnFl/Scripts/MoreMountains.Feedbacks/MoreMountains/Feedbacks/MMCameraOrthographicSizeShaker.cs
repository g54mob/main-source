...
namespace MoreMountains.Feedbacks
{
	...
	public class MMCameraOrthographicSizeShaker : MMShaker
	{
		...
		protected override void Shake()
		{
			...
			_targetCamera.orthographicSize = orthographicSize;
		}
