...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMAudioSourceStereoPanShakeEvent
	{
		...
		{
			MMAudioSourceStereoPanShakeEvent.OnEvent?.Invoke(stereoPanCurve, duration, remapMin, remapMax, relativeStereoPan, feedbacksIntensity, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
