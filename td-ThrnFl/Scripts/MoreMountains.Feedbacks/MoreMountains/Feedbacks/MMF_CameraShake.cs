	...
	public class MMF_CameraShake : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1f)
		{
			if (Active && FeedbackTypeAuthorized)
			{
				...
				MMCameraShakeEvent.Trigger(FeedbackDuration, CameraShakeProperties.Amplitude * num, CameraShakeProperties.Frequency, CameraShakeProperties.AmplitudeX * num, CameraShakeProperties.AmplitudeY * num, CameraShakeProperties.AmplitudeZ * num, RepeatUntilStopped, Channel, ComputedTimescaleMode == TimescaleModes.Unscaled);
			}
		}
