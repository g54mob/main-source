...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_Scale : MMF_Feedback
	{
		...
		public MMTweenType AnimateScaleTweenX = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1.5f), new Keyframe(1f, 0f)));
		...
		public MMTweenType AnimateScaleTweenY = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1.5f), new Keyframe(1f, 0f)));
		...
		public MMTweenType AnimateScaleTweenZ = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1.5f), new Keyframe(1f, 0f)));
		...
		{
			if (AnimateScaleTarget == null || AnimateScaleTweenX == null || AnimateScaleTweenY == null || AnimateScaleTweenZ == null || FeedbackDuration == 0f)
			{
				yield break;
			}
