...
namespace MoreMountains.Feedbacks
{
	...
	public struct MMCameraFieldOfViewShakeEvent
	{
		...
		{
			MMCameraFieldOfViewShakeEvent.OnEvent?.Invoke(animCurve, duration, remapMin, remapMax, relativeValue, feedbacksIntensity, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
