...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_DestinationTransform : MMF_Feedback
	{
		...
		public MMTweenType AnimatePositionTween = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f)));
		...
		public MMTweenType AnimateRotationTween = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f)));
		...
		public MMTweenType AnimateScaleTween = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f)));
		...
		protected virtual IEnumerator AnimateToDestination()
		{
			...
			while (journey >= 0f && journey <= Duration && Duration > 0f)
			{
				...
				_newPosition = Vector3.LerpUnclamped(_pointAPosition, _pointBPosition, _animationTweenType.Evaluate(t));
				_animationTweenType = (SeparateRotationCurve ? AnimateRotationTween : GlobalAnimationTween);
				_newRotation = Quaternion.LerpUnclamped(_pointARotation, _pointBRotation, _animationTweenType.Evaluate(t));
				_animationTweenType = (SeparateScaleCurve ? AnimateScaleTween : GlobalAnimationTween);
				_newScale = Vector3.LerpUnclamped(_pointAScale, _pointBScale, _animationTweenType.Evaluate(t));
