...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_Rotation : MMF_Feedback
	{
		...
		public MMTweenType AnimateRotationTweenX = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f)));
		...
		public MMTweenType AnimateRotationTweenY = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f)));
		...
		public MMTweenType AnimateRotationTweenZ = new MMTweenType(new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0.3f, 1f), new Keyframe(1f, 0f)));
