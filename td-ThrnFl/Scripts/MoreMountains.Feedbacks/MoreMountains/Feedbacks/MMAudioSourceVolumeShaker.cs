...
namespace MoreMountains.Feedbacks
{
	...
	public class MMAudioSourceVolumeShaker : MMShaker
	{
		...
		public AnimationCurve ShakeVolume = new AnimationCurve(new Keyframe(0f, 1f), new Keyframe(0.5f, 0f), new Keyframe(1f, 1f));
		...
		{
			float volume = ShakeFloat(ShakeVolume, RemapVolumeZero, RemapVolumeOne, RelativeVolume, _initialVolume);
