...
namespace MoreMountains.Feedbacks
{
	...
	public class MMAudioFilterHighPassShaker : MMShaker
	{
		...
		{
			base.Initialization();
			_targetAudioHighPassFilter = base.gameObject.GetComponent<AudioHighPassFilter>();
		}
		...
		{
			float cutoffFrequency = ShakeFloat(ShakeHighPass, RemapHighPassZero, RemapHighPassOne, RelativeHighPass, _initialHighPass);
			_targetAudioHighPassFilter.cutoffFrequency = cutoffFrequency;
		}
