...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public struct MMPaniniProjectionShakeEvent_URP
	{
		...
		{
			MMPaniniProjectionShakeEvent_URP.OnEvent?.Invoke(distance, duration, remapMin, remapMax, relativeDistance, attenuation, channel, resetShakerValuesAfterShake, resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop);
		}
	}
}
