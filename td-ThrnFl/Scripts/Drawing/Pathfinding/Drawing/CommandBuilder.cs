...
namespace Pathfinding.Drawing
{
	...
	public struct CommandBuilder : IDisposable
	{
		...
		private class JobWireMesh
		{
			...
			public unsafe delegate void WireMesh_000000D0_0024PostfixBurstDelegate(float3* verts, int* indices, int vertexCount, int indexCount, ref CommandBuilder draw);

			internal static class WireMesh_000000D0_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(WireMesh_000000D0_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static WireMesh_000000D0_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			public delegate void Execute_000000D1_0024PostfixBurstDelegate(ref Mesh.MeshData rawMeshData, ref CommandBuilder draw);

			internal static class Execute_000000D1_0024BurstDirectCall
			{
				private static IntPtr Pointer;
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Execute_000000D1_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static Execute_000000D1_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				WireMesh_000000D0_0024BurstDirectCall.Invoke(verts, indices, vertexCount, indexCount, ref draw);
			}
			...
			{
				Execute_000000D1_0024BurstDirectCall.Invoke(ref rawMeshData, ref draw);
			}
		...
		public static void Initialize_0024JobWireMesh_WireMesh_000000D0_0024BurstDirectCall()
		{
			JobWireMesh.WireMesh_000000D0_0024BurstDirectCall.Initialize();
		}

		public static void Initialize_0024JobWireMesh_Execute_000000D1_0024BurstDirectCall()
		{
			JobWireMesh.Execute_000000D1_0024BurstDirectCall.Initialize();
		}
	}
}
