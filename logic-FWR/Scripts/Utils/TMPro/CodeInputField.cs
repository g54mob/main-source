...
namespace TMPro
{
	...
	public class CodeInputField : Selectable, IUpdateSelectedHandler, IEventSystemHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler, ISubmitHandler, ICancelHandler, ICanvasElement, ILayoutElement, IScrollHandler
	{
		...
		[SerializeField]
		private OnChangeEvent m_OnTextInserted = new OnChangeEvent();

		[SerializeField]
		private UnityEvent m_OnTextMeshUpdated = new UnityEvent();

		[SerializeField]
		private UnityEvent m_OnCarretMoved = new UnityEvent();

		[SerializeField]
		private UnityEvent m_OnBackSpace = new UnityEvent();
		...
		public RectTransform codeCompleter;
		...
		private float m_DoubleClickDelay = 0.25f;

		private bool m_IsApplePlatform;

		public bool blockArrowKeys;
		...
		public bool shouldHideMobileInput
		{
			...
			set
			{
				...
				case RuntimePlatform.WebGLPlayer:
				case RuntimePlatform.tvOS:
					TMPro.SetPropertyUtility.SetStruct(ref m_HideMobileInput, value);
					break;
				default:
		...
		public bool shouldHideSoftKeyboard
		{
			...
			set
			{
				...
				case RuntimePlatform.GameCoreXboxOne:
				case RuntimePlatform.PS5:
					TMPro.SetPropertyUtility.SetStruct(ref m_HideSoftKeyboard, value);
					break;
				default:
		...
		public float caretBlinkRate
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_CaretBlinkRate, value) && m_AllowInput)
				{
					SetCaretActive();
				}
			}
		...
		public int caretWidth
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_CaretWidth, value))
				{
					MarkGeometryAsDirty();
				}
			}
		...
		public RectTransform textViewport
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_TextViewport, value);
			}
		}
		...
		public TMP_Text textComponent
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetClass(ref m_TextComponent, value))
				{
		...
		public Graphic placeholder
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_Placeholder, value);
			}
		}
		...
		public Scrollbar verticalScrollbar
		{
			...
			set
			{
				...
				TMPro.SetPropertyUtility.SetClass(ref m_VerticalScrollbar, value);
		...
		public float scrollSensitivity
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_ScrollSensitivity, value))
				{
					MarkGeometryAsDirty();
				}
			}
		...
		public Color caretColor
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetColor(ref m_CaretColor, value))
				{
					MarkGeometryAsDirty();
				}
			}
		...
		public Color selectionColor
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetColor(ref m_SelectionColor, value))
				{
					MarkGeometryAsDirty();
				}
			}
		...
		public SubmitEvent onEndEdit
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnEndEdit, value);
			}
		}
		...
		public SubmitEvent onSubmit
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnSubmit, value);
			}
		}
		...
		public SelectionEvent onSelect
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnSelect, value);
			}
		}
		...
		public SelectionEvent onDeselect
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnDeselect, value);
			}
		}
		...
		public TextSelectionEvent onTextSelection
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnTextSelection, value);
			}
		}
		...
		public TextSelectionEvent onEndTextSelection
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnEndTextSelection, value);
			}
		}
		...
		public OnChangeEvent onValueChanged
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnValueChanged, value);
			}
		}

		public OnChangeEvent onTextInserted
		{
			get
			{
				return m_OnTextInserted;
			}
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnTextInserted, value);
			}
		}

		public UnityEvent onTextMeshUpdated
		{
			get
			{
				return m_OnTextMeshUpdated;
			}
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnTextMeshUpdated, value);
			}
		}

		public UnityEvent onCarretMoved
		{
			get
			{
				return m_OnCarretMoved;
			}
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnCarretMoved, value);
			}
		}
		...
		public UnityEvent onBackSpace
		{
			get
			{
				return m_OnBackSpace;
			}
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnBackSpace, value);
			}
		}
		...
		public UnityEvent onClicked
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnClicked, value);
			}
		}
		...
		public TouchScreenKeyboardEvent onTouchScreenKeyboardStatusChanged
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnTouchScreenKeyboardStatusChanged, value);
			}
		}
		...
		public OnValidateInput onValidateInput
		{
			...
			set
			{
				TMPro.SetPropertyUtility.SetClass(ref m_OnValidateInput, value);
			}
		}
		...
		public int characterLimit
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_CharacterLimit, Math.Max(0, value)))
				{
					UpdateLabel();
		...
		public float pointSize
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_GlobalPointSize, Math.Max(0f, value)))
				{
		...
		public TMP_FontAsset fontAsset
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetClass(ref m_GlobalFontAsset, value))
				{
		...
		public ContentType contentType
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_ContentType, value))
				{
					EnforceContentType();
				}
			}
		...
		public LineType lineType
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_LineType, value))
				{
		...
		public int lineLimit
		{
			...
			set
			{
				...
				{
					TMPro.SetPropertyUtility.SetStruct(ref m_LineLimit, value);
				}
			}
		}
		...
		public InputType inputType
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_InputType, value))
				{
					SetToCustom();
				}
			}
		...
		public TouchScreenKeyboardType keyboardType
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_KeyboardType, value))
				{
					SetToCustom();
				}
			}
		...
		public CharacterValidation characterValidation
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_CharacterValidation, value))
				{
					SetToCustom();
				}
			}
		...
		public TMP_InputValidator inputValidator
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetClass(ref m_InputValidator, value))
				{
		...
		public char asteriskChar
		{
			...
			set
			{
				if (TMPro.SetPropertyUtility.SetStruct(ref m_AsteriskChar, value))
				{
					UpdateLabel();
				}
			}
			...
			if (!isFocused && m_SelectionStillActive)
			{
				...
				if (gameObject != null && gameObject != base.gameObject)
				{
					...
					if (!m_VerticalScrollbar || !(gameObject == m_VerticalScrollbar.gameObject))
					{
						...
						else if (!m_KeepTextSelectionVisible && gameObject.GetComponent<CodeInputField>() != null)
						{
							ReleaseSelection();
						}
					}
			...
			if (allowInput || !m_OnFocusSelectAll)
			{
				...
				if (flag2)
				{
					...
					if (num5 != -1)
					{
						...
						while (caretPositionInternal > 0 && IsIdentifierChar(m_TextComponent.textInfo.characterInfo[caretPositionInternal - 1].character))
						{
							caretPositionInternal--;
						}
						while (caretSelectPositionInternal < m_TextComponent.textInfo.characterCount && IsIdentifierChar(m_TextComponent.textInfo.characterInfo[caretSelectPositionInternal].character))
						{
		...
		protected EditState KeyPressed(Event evt)
		{
			...
			case KeyCode.C:
				if (flag4)
				{
					...
					{
						clipboard = Helper.StripRichText(GetSelectedString());
					}
					else
					{
						clipboard = "";
		...
		private void MoveRight(bool shift, bool ctrl)
		{
			...
			{
				int num = (stringPositionInternal = num3);
				stringSelectPositionInternal = num;
		...
		private void SendOnTextInserted(string s)
		{
			if (onTextInserted != null)
			{
				onTextInserted.Invoke(s);
			}
		}

		private void SendOnTextMeshUpdated()
		{
			if (onTextMeshUpdated != null)
			{
				onTextMeshUpdated.Invoke();
			}
		}

		private void SendOnCarretMoved()
		{
			if (onCarretMoved != null)
			{
				onCarretMoved.Invoke();
			}
		}

		private void SendOnBackSpace()
		{
			if (onBackSpace != null)
			{
				onBackSpace.Invoke();
		...
		{
			if ((codeCompleter != null && codeCompleter.gameObject.activeInHierarchy && RectTransformUtility.RectangleContainsScreenPoint(codeCompleter, Input.mousePosition, uiCam)) || !m_AllowInput)
			{
				return;
			}
