...
public class AkObstructionOcclusionValues : IDisposable
{
	...
	public void Clear()
	{
		AkSoundEnginePINVOKE.CSharp_AkObstructionOcclusionValues_Clear(swigCPtr);
	}
	...
	{
		AkSoundEnginePINVOKE.CSharp_AkObstructionOcclusionValues_Clone(swigCPtr, getCPtr(other));
	}

	public AkObstructionOcclusionValues()
		: this(AkSoundEnginePINVOKE.CSharp_new_AkObstructionOcclusionValues(), cMemoryOwn: true)
	{
	}
}
