...
public static class AkAudioInputManager
{
	...
	{
		if (audioSamplesDelegates.ContainsKey(playingID))
		{
			return audioSamplesDelegates[playingID](playingID, channelIndex, samples);
		}
		return false;
	}
	...
	{
		if (type == AkCallbackType.AK_EndOfEvent && callbackInfo is AkEventCallbackInfo akEventCallbackInfo)
		{
