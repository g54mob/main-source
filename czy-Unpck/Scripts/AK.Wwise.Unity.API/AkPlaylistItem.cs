...
public class AkPlaylistItem : IDisposable
{
	...
	public AkPlaylistItem()
		: this(AkSoundEnginePINVOKE.CSharp_new_AkPlaylistItem__SWIG_0(), cMemoryOwn: true)
	{
	}

	public AkPlaylistItem(AkPlaylistItem in_rCopy)
		: this(AkSoundEnginePINVOKE.CSharp_new_AkPlaylistItem__SWIG_1(getCPtr(in_rCopy)), cMemoryOwn: true)
	{
	}

	public AkPlaylistItem Assign(AkPlaylistItem in_rCopy)
	{
		return new AkPlaylistItem(AkSoundEnginePINVOKE.CSharp_AkPlaylistItem_Assign(swigCPtr, getCPtr(in_rCopy)), cMemoryOwn: false);
	}
