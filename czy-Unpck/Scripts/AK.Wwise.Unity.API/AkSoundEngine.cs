...
public class AkSoundEngine
{
	...
	public static uint AK_INVALID_PIPELINE_ID => AkSoundEnginePINVOKE.CSharp_AK_INVALID_PIPELINE_ID_get();

	public static ulong AK_INVALID_AUDIO_OBJECT_ID => AkSoundEnginePINVOKE.CSharp_AK_INVALID_AUDIO_OBJECT_ID_get();

	public static uint AK_SOUNDBANK_VERSION => AkSoundEnginePINVOKE.CSharp_AK_SOUNDBANK_VERSION_get();

	public static ushort AK_INT => AkSoundEnginePINVOKE.CSharp_AK_INT_get();

	public static ushort AK_FLOAT => AkSoundEnginePINVOKE.CSharp_AK_FLOAT_get();

	public static byte AK_INTERLEAVED => AkSoundEnginePINVOKE.CSharp_AK_INTERLEAVED_get();

	public static byte AK_NONINTERLEAVED => AkSoundEnginePINVOKE.CSharp_AK_NONINTERLEAVED_get();

	public static uint AK_LE_NATIVE_BITSPERSAMPLE => AkSoundEnginePINVOKE.CSharp_AK_LE_NATIVE_BITSPERSAMPLE_get();

	public static uint AK_LE_NATIVE_SAMPLETYPE => AkSoundEnginePINVOKE.CSharp_AK_LE_NATIVE_SAMPLETYPE_get();

	public static uint AK_LE_NATIVE_INTERLEAVE => AkSoundEnginePINVOKE.CSharp_AK_LE_NATIVE_INTERLEAVE_get();

	public static byte AK_INVALID_MIDI_CHANNEL => AkSoundEnginePINVOKE.CSharp_AK_INVALID_MIDI_CHANNEL_get();

	public static byte AK_INVALID_MIDI_NOTE => AkSoundEnginePINVOKE.CSharp_AK_INVALID_MIDI_NOTE_get();

	public static float kDefaultMaxPathLength => AkSoundEnginePINVOKE.CSharp_kDefaultMaxPathLength_get();

	public static uint kDefaultDiffractionMaxEdges => AkSoundEnginePINVOKE.CSharp_kDefaultDiffractionMaxEdges_get();

	public static uint kDefaultDiffractionMaxPaths => AkSoundEnginePINVOKE.CSharp_kDefaultDiffractionMaxPaths_get();

	public static float kMaxDiffraction => AkSoundEnginePINVOKE.CSharp_kMaxDiffraction_get();

	public static uint kDiffractionMaxEdges => AkSoundEnginePINVOKE.CSharp_kDiffractionMaxEdges_get();

	public static uint kDiffractionMaxPaths => AkSoundEnginePINVOKE.CSharp_kDiffractionMaxPaths_get();

	public static uint kPortalToPortalDiffractionMaxPaths => AkSoundEnginePINVOKE.CSharp_kPortalToPortalDiffractionMaxPaths_get();

	public static GameObjectHashFunction GameObjectHash
	{
		set
		{
			gameObjectHash = ((value == null) ? new GameObjectHashFunction(InternalGameObjectHash) : value);
		}
	}
	...
	public static string WwiseVersion
	{
		get
		{
			uint majorMinorVersion = GetMajorMinorVersion();
			uint subminorBuildVersion = GetSubminorBuildVersion();
			uint num = majorMinorVersion >> 16;
			uint num2 = majorMinorVersion & 0xFFFF;
			uint num3 = subminorBuildVersion >> 16;
			uint num4 = subminorBuildVersion & 0xFFFF;
			return $"{num}.{num2}.{num3} Build {num4}";
		}
	}

	private static void AutoRegister(GameObject gameObject, ulong id)
	{
		Type type = Type.GetType("AkGameObj, AK.Wwise.Unity.MonoBehaviour");
		if (gameObject == null || !gameObject.activeInHierarchy)
		{
			new AutoObject(gameObject);
		}
		else if (gameObject.GetComponent(type) == null)
		{
	...
	public static uint DynamicSequenceOpen(ulong in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, AkDynamicSequenceType in_eDynamicSequenceType)
	{
		...
		uint num = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_0(in_gameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, (int)in_eDynamicSequenceType);
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_1(in_gameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		uint num = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_2(in_gameObjectID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_Seek__SWIG_0(in_playingID, in_iPosition, in_bSeekToNearestMarker);
	}

	public static AKRESULT Seek(uint in_playingID, float in_fPercent, bool in_bSeekToNearestMarker)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_Seek__SWIG_1(in_playingID, in_fPercent, in_bSeekToNearestMarker);
	}
	...
	public static AkPlaylist DynamicSequenceLockPlaylist(uint in_playingID)
	{
		...
		{
			return new AkPlaylist(intPtr, cMemoryOwn: false);
		}
		return null;
	}
	...
	{
		return new AkChannelConfig(AkSoundEnginePINVOKE.CSharp_GetSpeakerConfiguration__SWIG_0(in_idOutput), cMemoryOwn: true);
	}

	public static AkChannelConfig GetSpeakerConfiguration()
	{
		return new AkChannelConfig(AkSoundEnginePINVOKE.CSharp_GetSpeakerConfiguration__SWIG_1(), cMemoryOwn: true);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetOutputDeviceConfiguration(in_idOutput, AkChannelConfig.getCPtr(io_channelConfig), Ak3DAudioSinkCapabilities.getCPtr(io_capabilities));
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_RegisterPluginDLL__SWIG_0(in_DllName, in_DllPath);
	}

	public static AKRESULT RegisterPluginDLL(string in_DllName)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_RegisterPluginDLL__SWIG_1(in_DllName);
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_0(in_eventID, in_gameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer(), in_PlayingID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_1(in_eventID, in_gameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer());
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_2(in_eventID, in_gameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_3(in_eventID, in_gameObjectID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_4(in_pszEventName, in_gameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer(), in_PlayingID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_5(in_pszEventName, in_gameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer());
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_6(in_pszEventName, in_gameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_7(in_pszEventName, in_gameObjectID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ExecuteActionOnEvent__SWIG_0(in_eventID, (int)in_ActionType, in_gameObjectID, in_uTransitionDuration, (int)in_eFadeCurve, in_PlayingID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ExecuteActionOnEvent__SWIG_1(in_eventID, (int)in_ActionType, in_gameObjectID, in_uTransitionDuration, (int)in_eFadeCurve);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ExecuteActionOnEvent__SWIG_2(in_eventID, (int)in_ActionType, in_gameObjectID, in_uTransitionDuration);
	}

	public static AKRESULT ExecuteActionOnEvent(uint in_eventID, AkActionOnEventType in_ActionType, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ExecuteActionOnEvent__SWIG_3(in_eventID, (int)in_ActionType, in_gameObjectID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ExecuteActionOnEvent__SWIG_5(in_pszEventName, (int)in_ActionType, in_gameObjectID, in_uTransitionDuration, (int)in_eFadeCurve, in_PlayingID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ExecuteActionOnEvent__SWIG_6(in_pszEventName, (int)in_ActionType, in_gameObjectID, in_uTransitionDuration, (int)in_eFadeCurve);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ExecuteActionOnEvent__SWIG_7(in_pszEventName, (int)in_ActionType, in_gameObjectID, in_uTransitionDuration);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ExecuteActionOnEvent__SWIG_8(in_pszEventName, (int)in_ActionType, in_gameObjectID);
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostMIDIOnEvent__SWIG_0(in_eventID, in_gameObjectID, in_pPosts.GetBuffer(), in_uNumPosts, in_bAbsoluteOffsets, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_playingID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostMIDIOnEvent__SWIG_1(in_eventID, in_gameObjectID, in_pPosts.GetBuffer(), in_uNumPosts, in_bAbsoluteOffsets, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		uint num = AkSoundEnginePINVOKE.CSharp_PostMIDIOnEvent__SWIG_2(in_eventID, in_gameObjectID, in_pPosts.GetBuffer(), in_uNumPosts, in_bAbsoluteOffsets);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		uint num = AkSoundEnginePINVOKE.CSharp_PostMIDIOnEvent__SWIG_3(in_eventID, in_gameObjectID, in_pPosts.GetBuffer(), in_uNumPosts);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_StopMIDIOnEvent__SWIG_0(in_eventID, in_gameObjectID, in_playingID);
	}

	public static AKRESULT StopMIDIOnEvent(uint in_eventID, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_StopMIDIOnEvent__SWIG_1(in_eventID, in_gameObjectID);
	}

	public static AKRESULT StopMIDIOnEvent(uint in_eventID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_StopMIDIOnEvent__SWIG_2(in_eventID);
	}

	public static AKRESULT StopMIDIOnEvent()
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_StopMIDIOnEvent__SWIG_3();
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_0(in_eventID, in_gameObjectID, in_iPosition, in_bSeekToNearestMarker, in_PlayingID);
	}

	public static AKRESULT SeekOnEvent(uint in_eventID, ulong in_gameObjectID, int in_iPosition, bool in_bSeekToNearestMarker)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_1(in_eventID, in_gameObjectID, in_iPosition, in_bSeekToNearestMarker);
	}

	public static AKRESULT SeekOnEvent(uint in_eventID, ulong in_gameObjectID, int in_iPosition)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_2(in_eventID, in_gameObjectID, in_iPosition);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_3(in_pszEventName, in_gameObjectID, in_iPosition, in_bSeekToNearestMarker, in_PlayingID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_4(in_pszEventName, in_gameObjectID, in_iPosition, in_bSeekToNearestMarker);
	}

	public static AKRESULT SeekOnEvent(string in_pszEventName, ulong in_gameObjectID, int in_iPosition)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_5(in_pszEventName, in_gameObjectID, in_iPosition);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_9(in_eventID, in_gameObjectID, in_fPercent, in_bSeekToNearestMarker, in_PlayingID);
	}

	public static AKRESULT SeekOnEvent(uint in_eventID, ulong in_gameObjectID, float in_fPercent, bool in_bSeekToNearestMarker)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_10(in_eventID, in_gameObjectID, in_fPercent, in_bSeekToNearestMarker);
	}

	public static AKRESULT SeekOnEvent(uint in_eventID, ulong in_gameObjectID, float in_fPercent)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_11(in_eventID, in_gameObjectID, in_fPercent);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_12(in_pszEventName, in_gameObjectID, in_fPercent, in_bSeekToNearestMarker, in_PlayingID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_13(in_pszEventName, in_gameObjectID, in_fPercent, in_bSeekToNearestMarker);
	}

	public static AKRESULT SeekOnEvent(string in_pszEventName, ulong in_gameObjectID, float in_fPercent)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SeekOnEvent__SWIG_14(in_pszEventName, in_gameObjectID, in_fPercent);
	}
	...
	{
		AkSoundEnginePINVOKE.CSharp_CancelEventCallbackGameObject(in_gameObjectID);
	}
	...
	{
		AkSoundEnginePINVOKE.CSharp_StopAll__SWIG_0(in_gameObjectID);
	}
	...
	{
		AkSoundEnginePINVOKE.CSharp_ExecuteActionOnPlayingID__SWIG_0((int)in_ActionType, in_playingID, in_uTransitionDuration, (int)in_eFadeCurve);
	}
	...
	{
		AkSoundEnginePINVOKE.CSharp_ExecuteActionOnPlayingID__SWIG_1((int)in_ActionType, in_playingID, in_uTransitionDuration);
	}

	public static void ExecuteActionOnPlayingID(AkActionOnEventType in_ActionType, uint in_playingID)
	{
		AkSoundEnginePINVOKE.CSharp_ExecuteActionOnPlayingID__SWIG_2((int)in_ActionType, in_playingID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SendPluginCustomGameData(in_busID, in_busObjectID, (int)in_eType, in_uCompanyID, in_uPluginID, in_pData, in_uSizeInBytes);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_0(in_GameObjectID, in_pPositions.m_Buffer, in_NumPositions, (int)in_eMultiPositionType);
	}

	public static AKRESULT SetMultiplePositions(ulong in_GameObjectID, AkPositionArray in_pPositions, ushort in_NumPositions)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_1(in_GameObjectID, in_pPositions.m_Buffer, in_NumPositions);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_2(in_GameObjectID, in_pPositions.m_Buffer, in_NumPositions, (int)in_eMultiPositionType);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_3(in_GameObjectID, in_pPositions.m_Buffer, in_NumPositions);
	}

	public static AKRESULT SetScalingFactor(ulong in_GameObjectID, float in_fAttenuationScalingFactor)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetScalingFactor(in_GameObjectID, in_fAttenuationScalingFactor);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_LoadBank__SWIG_0(in_pszString, out out_bankID);
	}

	public static AKRESULT LoadBank(uint in_bankID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_LoadBank__SWIG_2(in_bankID);
	}

	public static AKRESULT LoadBankMemoryView(IntPtr in_pInMemoryBankPtr, uint in_uInMemoryBankSize, out uint out_bankID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_LoadBankMemoryView__SWIG_0(in_pInMemoryBankPtr, in_uInMemoryBankSize, out out_bankID);
	}

	public static AKRESULT LoadBankMemoryCopy(IntPtr in_pInMemoryBankPtr, uint in_uInMemoryBankSize, out uint out_bankID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_LoadBankMemoryCopy__SWIG_0(in_pInMemoryBankPtr, in_uInMemoryBankSize, out out_bankID);
	}
	...
	public static AKRESULT LoadBank(string in_pszString, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie, out uint out_bankID)
	{
		...
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_LoadBank__SWIG_3(in_pszString, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, out out_bankID);
	}

	public static AKRESULT LoadBank(uint in_bankID, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie)
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_LoadBank__SWIG_5(in_bankID, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
	}
	...
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_LoadBankMemoryView__SWIG_1(in_pInMemoryBankPtr, in_uInMemoryBankSize, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, out out_bankID);
	}
	...
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_LoadBankMemoryCopy__SWIG_1(in_pInMemoryBankPtr, in_uInMemoryBankSize, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, out out_bankID);
	}

	public static AKRESULT UnloadBank(string in_pszString, IntPtr in_pInMemoryBankPtr)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_UnloadBank__SWIG_0(in_pszString, in_pInMemoryBankPtr);
	}

	public static AKRESULT UnloadBank(uint in_bankID, IntPtr in_pInMemoryBankPtr)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_UnloadBank__SWIG_2(in_bankID, in_pInMemoryBankPtr);
	}
	...
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_UnloadBank__SWIG_3(in_pszString, in_pInMemoryBankPtr, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
	}
	...
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_UnloadBank__SWIG_5(in_bankID, in_pInMemoryBankPtr, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
	}
	...
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareBank__SWIG_6((int)in_PreparationType, in_pszString, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, (int)in_uFlags);
	}
	...
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareBank__SWIG_7((int)in_PreparationType, in_pszString, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
	}
	...
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareBank__SWIG_10((int)in_PreparationType, in_bankID, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, (int)in_uFlags);
	}
	...
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareBank__SWIG_11((int)in_PreparationType, in_bankID, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
	}
	...
	{
		int num = 0;
		string[] array = in_ppszString;
		foreach (string text in array)
		{
			num += text.Length + 1;
		}
		int num2 = 2;
		IntPtr intPtr = Marshal.AllocHGlobal(num * num2 + 2);
	...
	public static AKRESULT PrepareEvent(AkPreparationType in_PreparationType, string[] in_ppszString, uint in_uNumEvent, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie)
	{
		...
		try
		{
			return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareEvent__SWIG_2((int)in_PreparationType, intPtr, in_uNumEvent, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		}
		finally
		{
			Marshal.FreeHGlobal(intPtr);
	...
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareEvent__SWIG_3((int)in_PreparationType, in_pEventID, in_uNumEvent, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
	}

	public static AKRESULT SetMedia(AkSourceSettingsArray in_pSourceSettings, uint in_uNumSourceSettings)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMedia(in_pSourceSettings.GetBuffer(), in_uNumSourceSettings);
	}

	public static AKRESULT UnsetMedia(AkSourceSettingsArray in_pSourceSettings, uint in_uNumSourceSettings)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_UnsetMedia(in_pSourceSettings.GetBuffer(), in_uNumSourceSettings);
	}
	...
	{
		int num = 0;
		string[] array = in_ppszGameSyncName;
		foreach (string text in array)
		{
			num += text.Length + 1;
		}
	...
	public static AKRESULT PrepareGameSyncs(AkPreparationType in_PreparationType, AkGroupType in_eGameSyncType, string in_pszGroupName, string[] in_ppszGameSyncName, uint in_uNumGameSyncs, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie)
	{
		...
		try
		{
			return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareGameSyncs__SWIG_2((int)in_PreparationType, (int)in_eGameSyncType, in_pszGroupName, intPtr, in_uNumGameSyncs, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		}
		finally
		{
			Marshal.FreeHGlobal(intPtr);
	...
	{
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareGameSyncs__SWIG_3((int)in_PreparationType, (int)in_eGameSyncType, in_GroupID, in_paGameSyncID, in_uNumGameSyncs, IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
	}

	public static AKRESULT AddListener(ulong in_emitterGameObj, ulong in_listenerGameObj)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddListener(in_emitterGameObj, in_listenerGameObj);
	}

	public static AKRESULT RemoveListener(ulong in_emitterGameObj, ulong in_listenerGameObj)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_RemoveListener(in_emitterGameObj, in_listenerGameObj);
	}

	public static AKRESULT AddDefaultListener(ulong in_listenerGameObj)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddDefaultListener(in_listenerGameObj);
	}

	public static AKRESULT RemoveDefaultListener(ulong in_listenerGameObj)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_RemoveDefaultListener(in_listenerGameObj);
	}

	public static AKRESULT ResetListenersToDefault(ulong in_emitterGameObj)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ResetListenersToDefault(in_emitterGameObj);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetListenerSpatialization__SWIG_0(in_uListenerID, in_bSpatialized, AkChannelConfig.getCPtr(in_channelConfig), in_pVolumeOffsets);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetListenerSpatialization__SWIG_1(in_uListenerID, in_bSpatialized, AkChannelConfig.getCPtr(in_channelConfig));
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetRTPCValue__SWIG_1(in_rtpcID, in_value, in_gameObjectID, in_uValueChangeDuration, (int)in_eFadeCurve);
	}

	public static AKRESULT SetRTPCValue(uint in_rtpcID, float in_value, ulong in_gameObjectID, int in_uValueChangeDuration)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetRTPCValue__SWIG_2(in_rtpcID, in_value, in_gameObjectID, in_uValueChangeDuration);
	}

	public static AKRESULT SetRTPCValue(uint in_rtpcID, float in_value, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetRTPCValue__SWIG_3(in_rtpcID, in_value, in_gameObjectID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetRTPCValue__SWIG_6(in_pszRtpcName, in_value, in_gameObjectID, in_uValueChangeDuration, (int)in_eFadeCurve);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetRTPCValue__SWIG_7(in_pszRtpcName, in_value, in_gameObjectID, in_uValueChangeDuration);
	}

	public static AKRESULT SetRTPCValue(string in_pszRtpcName, float in_value, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetRTPCValue__SWIG_8(in_pszRtpcName, in_value, in_gameObjectID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ResetRTPCValue__SWIG_1(in_rtpcID, in_gameObjectID, in_uValueChangeDuration, (int)in_eFadeCurve);
	}

	public static AKRESULT ResetRTPCValue(uint in_rtpcID, ulong in_gameObjectID, int in_uValueChangeDuration)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ResetRTPCValue__SWIG_2(in_rtpcID, in_gameObjectID, in_uValueChangeDuration);
	}

	public static AKRESULT ResetRTPCValue(uint in_rtpcID, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ResetRTPCValue__SWIG_3(in_rtpcID, in_gameObjectID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ResetRTPCValue__SWIG_5(in_pszRtpcName, in_gameObjectID, in_uValueChangeDuration, (int)in_eFadeCurve, in_bBypassInternalValueInterpolation);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ResetRTPCValue__SWIG_6(in_pszRtpcName, in_gameObjectID, in_uValueChangeDuration, (int)in_eFadeCurve);
	}

	public static AKRESULT ResetRTPCValue(string in_pszRtpcName, ulong in_gameObjectID, int in_uValueChangeDuration)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ResetRTPCValue__SWIG_7(in_pszRtpcName, in_gameObjectID, in_uValueChangeDuration);
	}

	public static AKRESULT ResetRTPCValue(string in_pszRtpcName, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ResetRTPCValue__SWIG_8(in_pszRtpcName, in_gameObjectID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetSwitch__SWIG_0(in_switchGroup, in_switchState, in_gameObjectID);
	}

	public static AKRESULT SetSwitch(string in_pszSwitchGroup, string in_pszSwitchState, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetSwitch__SWIG_1(in_pszSwitchGroup, in_pszSwitchState, in_gameObjectID);
	}

	public static AKRESULT PostTrigger(uint in_triggerID, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostTrigger__SWIG_0(in_triggerID, in_gameObjectID);
	}

	public static AKRESULT PostTrigger(string in_pszTrigger, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostTrigger__SWIG_1(in_pszTrigger, in_gameObjectID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetGameObjectAuxSendValues(in_gameObjectID, in_aAuxSendValues.GetBuffer(), in_uNumSendValues);
	}

	public static AKRESULT SetGameObjectOutputBusVolume(ulong in_emitterObjID, ulong in_listenerObjID, float in_fControlValue)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetGameObjectOutputBusVolume(in_emitterObjID, in_listenerObjID, in_fControlValue);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetOutputDeviceEffect(in_outputDeviceID, in_uFXIndex, in_FXShareSetID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetObjectObstructionAndOcclusion(in_EmitterID, in_ListenerID, in_fObstructionLevel, in_fOcclusionLevel);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultipleObstructionAndOcclusion(in_EmitterID, in_uListenerID, in_fObstructionOcclusionValues.GetBuffer(), in_uNumOcclusionObstruction);
	}
	...
	{
		return AkSoundEnginePINVOKE.CSharp_GetSampleRate();
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetOfflineRenderingFrameTime(in_fFrameTimeInSeconds);
	}

	public static AKRESULT SetOfflineRendering(bool in_bEnableOfflineRendering)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetOfflineRendering(in_bEnableOfflineRendering);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ReplaceOutput__SWIG_0(AkOutputSettings.getCPtr(in_Settings), in_outputDeviceId, out out_pOutputDeviceId);
	}

	public static AKRESULT ReplaceOutput(AkOutputSettings in_Settings, ulong in_outputDeviceId)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ReplaceOutput__SWIG_1(AkOutputSettings.getCPtr(in_Settings), in_outputDeviceId);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetDeviceList__SWIG_0(in_ulCompanyID, in_ulPluginID, out io_maxNumDevices, out_deviceDescriptions.GetBuffer());
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetDeviceList__SWIG_1(in_audioDeviceShareSetID, out io_maxNumDevices, out_deviceDescriptions.GetBuffer());
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetDeviceSpatialAudioSupport(in_idDevice);
	}
	...
	{
		return AkSoundEnginePINVOKE.CSharp_GetSampleTick();
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostCode__SWIG_0((int)in_eError, (int)in_eErrorLevel, in_playingID, in_gameObjID, in_audioNodeID, in_bIsBus);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostCode__SWIG_1((int)in_eError, (int)in_eErrorLevel, in_playingID, in_gameObjID, in_audioNodeID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostCode__SWIG_2((int)in_eError, (int)in_eErrorLevel, in_playingID, in_gameObjID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostString__SWIG_0(in_pszError, (int)in_eErrorLevel, in_playingID, in_gameObjID, in_audioNodeID, in_bIsBus);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostString__SWIG_1(in_pszError, (int)in_eErrorLevel, in_playingID, in_gameObjID, in_audioNodeID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostString__SWIG_2(in_pszError, (int)in_eErrorLevel, in_playingID, in_gameObjID);
	}
	...
	{
		AkSoundEnginePINVOKE.CSharp_MonitorStreamMgrInit(AkStreamMgrSettings.getCPtr(in_streamMgrSettings));
	}

	public static void MonitorStreamingDeviceInit(uint in_deviceID, AkDeviceSettings in_deviceSettings)
	{
		AkSoundEnginePINVOKE.CSharp_MonitorStreamingDeviceInit(in_deviceID, AkDeviceSettings.getCPtr(in_deviceSettings));
	}

	public static void MonitorStreamingDeviceDestroyed(uint in_deviceID)
	{
		AkSoundEnginePINVOKE.CSharp_MonitorStreamingDeviceDestroyed(in_deviceID);
	}

	public static void MonitorStreamMgrTerm()
	{
		AkSoundEnginePINVOKE.CSharp_MonitorStreamMgrTerm();
	}
	...
	public static uint GetNextPowerOfTwo(uint in_uValue)
	{
		return AkSoundEnginePINVOKE.CSharp_GetNextPowerOfTwo(in_uValue);
	}

	public static uint ROTL32(uint x, uint r)
	{
		return AkSoundEnginePINVOKE.CSharp_ROTL32(x, r);
	}

	public static ulong ROTL64(ulong x, ulong r)
	{
		return AkSoundEnginePINVOKE.CSharp_ROTL64(x, r);
	}

	public static void AkGetDefaultHighPriorityThreadProperties(AkThreadProperties out_threadProperties)
	{
		AkSoundEnginePINVOKE.CSharp_AkGetDefaultHighPriorityThreadProperties(AkThreadProperties.getCPtr(out_threadProperties));
	}
	...
	public static AKRESULT GetPosition(ulong in_GameObjectID, AkTransform out_rPosition)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetPosition(in_GameObjectID, AkTransform.getCPtr(out_rPosition));
	}

	public static AKRESULT GetListenerPosition(ulong in_uIndex, AkTransform out_rPosition)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetListenerPosition(in_uIndex, AkTransform.getCPtr(out_rPosition));
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetRTPCValue__SWIG_0(in_rtpcID, in_gameObjectID, in_playingID, out out_rValue, ref io_rValueType);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetRTPCValue__SWIG_1(in_pszRtpcName, in_gameObjectID, in_playingID, out out_rValue, ref io_rValueType);
	}

	public static AKRESULT GetSwitch(uint in_switchGroup, ulong in_gameObjectID, out uint out_rSwitchState)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetSwitch__SWIG_0(in_switchGroup, in_gameObjectID, out out_rSwitchState);
	}

	public static AKRESULT GetSwitch(string in_pstrSwitchGroupName, ulong in_GameObj, out uint out_rSwitchState)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetSwitch__SWIG_1(in_pstrSwitchGroupName, in_GameObj, out out_rSwitchState);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetGameObjectAuxSendValues(in_gameObjectID, out_paAuxSendValues.GetBuffer(), ref io_ruNumSendValues);
	}

	public static AKRESULT GetGameObjectDryLevelValue(ulong in_EmitterID, ulong in_ListenerID, out float out_rfControlValue)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetGameObjectDryLevelValue(in_EmitterID, in_ListenerID, out out_rfControlValue);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetObjectObstructionAndOcclusion(in_EmitterID, in_ListenerID, out out_rfObstructionLevel, out out_rfOcclusionLevel);
	}

	public static AKRESULT QueryAudioObjectIDs(uint in_eventID, ref uint io_ruNumItems, AkObjectInfoArray out_aObjectInfos)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryAudioObjectIDs__SWIG_0(in_eventID, ref io_ruNumItems, out_aObjectInfos.GetBuffer());
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryAudioObjectIDs__SWIG_1(in_pszEventName, ref io_ruNumItems, out_aObjectInfos.GetBuffer());
	}
	...
	{
		return AkSoundEnginePINVOKE.CSharp_GetIsGameObjectActive(in_GameObjId);
	}

	public static float GetMaxRadius(ulong in_GameObjId)
	{
		return AkSoundEnginePINVOKE.CSharp_GetMaxRadius(in_GameObjId);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetPlayingIDsFromGameObject(in_GameObjId, ref io_ruNumIDs, out_aPlayingIDs);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetGameObjectRadius(in_gameObjectID, in_outerRadius, in_innerRadius);
	}

	public static AKRESULT SetImageSource(uint in_srcID, AkImageSourceSettings in_info, uint in_AuxBusID, ulong in_roomID, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetImageSource(in_srcID, AkImageSourceSettings.getCPtr(in_info), in_AuxBusID, in_roomID, in_gameObjectID);
	}

	public static AKRESULT RemoveImageSource(uint in_srcID, uint in_AuxBusID, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_RemoveImageSource(in_srcID, in_AuxBusID, in_gameObjectID);
	}

	public static AKRESULT ClearImageSources(uint in_AuxBusID, ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ClearImageSources__SWIG_0(in_AuxBusID, in_gameObjectID);
	}

	public static AKRESULT ClearImageSources(uint in_AuxBusID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ClearImageSources__SWIG_1(in_AuxBusID);
	}

	public static AKRESULT ClearImageSources()
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ClearImageSources__SWIG_2();
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryReflectionPaths(in_gameObjectID, in_positionIndex, ref out_listenerPos, ref out_emitterPos, out_aPaths.GetBuffer(), out io_uArraySize);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetGameObjectInRoom(in_gameObjectID, in_CurrentRoomID);
	}

	public static AKRESULT SetReflectionsOrder(uint in_uReflectionsOrder, bool in_bUpdatePaths)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetReflectionsOrder(in_uReflectionsOrder, in_bUpdatePaths);
	}

	public static AKRESULT SetNumberOfPrimaryRays(uint in_uNbPrimaryRays)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetNumberOfPrimaryRays(in_uNbPrimaryRays);
	}

	public static AKRESULT SetEarlyReflectionsAuxSend(ulong in_gameObjectID, uint in_auxBusID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetEarlyReflectionsAuxSend(in_gameObjectID, in_auxBusID);
	}

	public static AKRESULT SetEarlyReflectionsVolume(ulong in_gameObjectID, float in_fSendVolume)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetEarlyReflectionsVolume(in_gameObjectID, in_fSendVolume);
	}

	public static AKRESULT SetPortalObstructionAndOcclusion(ulong in_PortalID, float in_fObstruction, float in_fOcclusion)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetPortalObstructionAndOcclusion(in_PortalID, in_fObstruction, in_fOcclusion);
	}

	public static AKRESULT SetGameObjectToPortalObstruction(ulong in_gameObjectID, ulong in_PortalID, float in_fObstruction)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetGameObjectToPortalObstruction(in_gameObjectID, in_PortalID, in_fObstruction);
	}

	public static AKRESULT SetPortalToPortalObstruction(ulong in_PortalID0, ulong in_PortalID1, float in_fObstruction)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetPortalToPortalObstruction(in_PortalID0, in_PortalID1, in_fObstruction);
	}

	public static AKRESULT QueryWetDiffraction(ulong in_portal, out float out_wetDiffraction)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryWetDiffraction(in_portal, out out_wetDiffraction);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryDiffractionPaths(in_gameObjectID, in_positionIndex, ref out_listenerPos, ref out_emitterPos, out_aPaths.GetBuffer(), out io_uArraySize);
	}

	public static AKRESULT ResetStochasticEngine()
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ResetStochasticEngine();
	}
	...
	{
		return StringFromIntPtrWString(AkSoundEnginePINVOKE.CSharp_GetWindowsDeviceName__SWIG_0(index, out out_uDeviceID, (int)uDeviceStateMask));
	}

	public static string GetWindowsDeviceName(int index, out uint out_uDeviceID)
	{
		return StringFromIntPtrWString(AkSoundEnginePINVOKE.CSharp_GetWindowsDeviceName__SWIG_1(index, out out_uDeviceID));
	}

	public static uint GetWindowsDeviceCount(AkAudioDeviceState uDeviceStateMask)
	{
		return AkSoundEnginePINVOKE.CSharp_GetWindowsDeviceCount__SWIG_0((int)uDeviceStateMask);
	}

	public static uint GetWindowsDeviceCount()
	{
		return AkSoundEnginePINVOKE.CSharp_GetWindowsDeviceCount__SWIG_1();
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_Init(AkInitializationSettings.getCPtr(settings));
	}

	public static AKRESULT InitSpatialAudio(AkSpatialAudioInitSettings settings)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_InitSpatialAudio(AkSpatialAudioInitSettings.getCPtr(settings));
	}

	public static AKRESULT InitCommunication(AkCommunicationSettings settings)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_InitCommunication(AkCommunicationSettings.getCPtr(settings));
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_LoadFilePackage(in_pszFilePackageName, out out_uPackageID);
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEventOnRoom__SWIG_0(in_pszEventName, in_roomID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer(), in_PlayingID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEventOnRoom__SWIG_1(in_pszEventName, in_roomID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer());
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEventOnRoom__SWIG_2(in_pszEventName, in_roomID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		uint num = AkSoundEnginePINVOKE.CSharp_PostEventOnRoom__SWIG_3(in_pszEventName, in_roomID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		return StringFromIntPtrOSString(AkSoundEnginePINVOKE.CSharp_GetCurrentLanguage());
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetObjectPosition(in_GameObjectID, Pos, Front, Top);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetSourceMultiplePlayPositions__SWIG_0(in_PlayingID, out_audioNodeID, out_mediaID, out_msTime, ref io_pcPositions, in_bExtrapolate);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetSourceMultiplePlayPositions__SWIG_1(in_PlayingID, out_audioNodeID, out_mediaID, out_msTime, ref io_pcPositions);
	}

	public static AKRESULT SetListeners(ulong in_emitterGameObj, ulong[] in_pListenerGameObjs, uint in_uNumListeners)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetListeners(in_emitterGameObj, in_pListenerGameObjs, in_uNumListeners);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddOutput__SWIG_0(AkOutputSettings.getCPtr(in_Settings), out out_pDeviceID, in_pListenerIDs, in_uNumListeners);
	}

	public static AKRESULT AddOutput(AkOutputSettings in_Settings, out ulong out_pDeviceID, ulong[] in_pListenerIDs)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddOutput__SWIG_1(AkOutputSettings.getCPtr(in_Settings), out out_pDeviceID, in_pListenerIDs);
	}

	public static AKRESULT AddOutput(AkOutputSettings in_Settings, out ulong out_pDeviceID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddOutput__SWIG_2(AkOutputSettings.getCPtr(in_Settings), out out_pDeviceID);
	}

	public static AKRESULT AddOutput(AkOutputSettings in_Settings)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddOutput__SWIG_3(AkOutputSettings.getCPtr(in_Settings));
	}
	...
	{
		AkSoundEnginePINVOKE.CSharp_StopResourceMonitoring();
	}

	public static void GetResourceMonitorDataSummary(AkResourceMonitorDataSummary resourceMonitorDataSummary)
	{
		AkSoundEnginePINVOKE.CSharp_GetResourceMonitorDataSummary(AkResourceMonitorDataSummary.getCPtr(resourceMonitorDataSummary));
	}

	public static void StartDeviceCapture(ulong in_idOutputDeviceID)
	{
		AkSoundEnginePINVOKE.CSharp_StartDeviceCapture(in_idOutputDeviceID);
	}

	public static void StopDeviceCapture(ulong in_idOutputDeviceID)
	{
		AkSoundEnginePINVOKE.CSharp_StopDeviceCapture(in_idOutputDeviceID);
	}

	public static void ClearCaptureData()
	{
		AkSoundEnginePINVOKE.CSharp_ClearCaptureData();
	}

	public static uint UpdateCaptureSampleCount(ulong in_idOutputDeviceID)
	{
		return AkSoundEnginePINVOKE.CSharp_UpdateCaptureSampleCount(in_idOutputDeviceID);
	}

	public static uint GetCaptureSamples(ulong in_idOutputDeviceID, float[] out_pSamples, uint in_uBufferSize)
	{
		return AkSoundEnginePINVOKE.CSharp_GetCaptureSamples(in_idOutputDeviceID, out_pSamples, in_uBufferSize);
	}

	public static AKRESULT SetRoomPortal(ulong in_PortalID, AkTransform Transform, AkExtent Extent, bool bEnabled, ulong FrontRoom, ulong BackRoom)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetRoomPortal(in_PortalID, AkTransform.getCPtr(Transform), AkExtent.getCPtr(Extent), bEnabled, FrontRoom, BackRoom);
	}

	public static AKRESULT SetRoom(ulong in_RoomID, AkRoomParams in_roomParams, ulong GeometryID, string in_pName)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetRoom(in_RoomID, AkRoomParams.getCPtr(in_roomParams), GeometryID, in_pName);
	}

	public static AKRESULT RegisterSpatialAudioListener(ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_RegisterSpatialAudioListener(in_gameObjectID);
	}

	public static AKRESULT UnregisterSpatialAudioListener(ulong in_gameObjectID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_UnregisterSpatialAudioListener(in_gameObjectID);
	}

	public static AKRESULT SetGeometry(ulong in_GeomSetID, AkTriangleArray Triangles, uint NumTriangles, Vector3[] Vertices, uint NumVertices, AkAcousticSurfaceArray Surfaces, uint NumSurfaces, ulong RoomID, bool EnableDiffraction, bool EnableDiffractionOnBoundaryEdges, bool EnableTriangles)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetGeometry(in_GeomSetID, Triangles.GetBuffer(), NumTriangles, Vertices, NumVertices, Surfaces.GetBuffer(), NumSurfaces, RoomID, EnableDiffraction, EnableDiffractionOnBoundaryEdges, EnableTriangles);
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEventOnRoom__SWIG_4(in_eventID, in_roomID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer(), in_PlayingID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEventOnRoom__SWIG_5(in_eventID, in_roomID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer());
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEventOnRoom__SWIG_6(in_eventID, in_roomID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	{
		uint num = AkSoundEnginePINVOKE.CSharp_PostEventOnRoom__SWIG_7(in_eventID, in_roomID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	private static ulong InternalGameObjectHash(GameObject gameObject)
	{
		if (!(gameObject == null))
		{
			return (ulong)gameObject.GetInstanceID();
		}
	...
	{
		ulong akGameObjectID = GetAkGameObjectID(gameObject);
		int result = AkSoundEnginePINVOKE.CSharp_RegisterGameObjInternal(akGameObjectID);
		PostRegisterGameObjUserHook((AKRESULT)result, gameObject, akGameObjectID);
		return (AKRESULT)result;
	}

	public static AKRESULT RegisterGameObj(GameObject gameObject, string name)
	{
		ulong akGameObjectID = GetAkGameObjectID(gameObject);
		int result = AkSoundEnginePINVOKE.CSharp_RegisterGameObjInternal_WithName(akGameObjectID, name);
		PostRegisterGameObjUserHook((AKRESULT)result, gameObject, akGameObjectID);
		return (AKRESULT)result;
	}
	...
	{
		ulong akGameObjectID = GetAkGameObjectID(gameObject);
		int result = AkSoundEnginePINVOKE.CSharp_UnregisterGameObjInternal(akGameObjectID);
		PostUnregisterGameObjUserHook((AKRESULT)result, gameObject, akGameObjectID);
		return (AKRESULT)result;
	}

	public static AKRESULT SetObjectPosition(GameObject gameObject, Transform transform)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetObjectPosition(GetAkGameObjectID(gameObject), transform.position, transform.forward, transform.up);
	}
	...
	{
		ulong akGameObjectID = GetAkGameObjectID(gameObject);
		Vector3 jarg = new Vector3(posX, posY, posZ);
		Vector3 jarg2 = new Vector3(frontX, frontY, frontZ);
		Vector3 jarg3 = new Vector3(topX, topY, topZ);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetObjectPosition(akGameObjectID, jarg, jarg2, jarg3);
	}
	...
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_0(akGameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, (int)in_eDynamicSequenceType);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint DynamicSequenceOpen(GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_1(akGameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint DynamicSequenceOpen(GameObject in_gameObjectID)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		uint num = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_2(akGameObjectID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(uint in_eventID, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, uint in_cExternals, AkExternalSourceInfoArray in_pExternalSources, uint in_PlayingID)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_0(in_eventID, akGameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer(), in_PlayingID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(uint in_eventID, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, uint in_cExternals, AkExternalSourceInfoArray in_pExternalSources)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_1(in_eventID, akGameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer());
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(uint in_eventID, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_2(in_eventID, akGameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(uint in_eventID, GameObject in_gameObjectID)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_3(in_eventID, akGameObjectID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(string in_pszEventName, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, uint in_cExternals, AkExternalSourceInfoArray in_pExternalSources, uint in_PlayingID)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_4(in_pszEventName, akGameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer(), in_PlayingID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(string in_pszEventName, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, uint in_cExternals, AkExternalSourceInfoArray in_pExternalSources)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_5(in_pszEventName, akGameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero, in_cExternals, in_pExternalSources.GetBuffer());
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(string in_pszEventName, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_6(in_pszEventName, akGameObjectID, in_uFlags, (in_uFlags != 0) ? ((IntPtr)1) : IntPtr.Zero, (in_pCookie != null) ? ((IntPtr)in_pCookie.GetHashCode()) : IntPtr.Zero);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(string in_pszEventName, GameObject in_gameObjectID)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_7(in_pszEventName, akGameObjectID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static AKRESULT PostMIDIOnEvent(uint in_eventID, GameObject in_gameObjectID, AkMIDIPostArray in_pPosts, ushort in_uNumPosts)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostMIDIOnEvent__SWIG_3(in_eventID, akGameObjectID, in_pPosts.GetBuffer(), in_uNumPosts);
	}
	...
	public static AKRESULT StopMIDIOnEvent(uint in_eventID, GameObject in_gameObjectID)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_StopMIDIOnEvent__SWIG_1(in_eventID, akGameObjectID);
	}
	...
	public static AKRESULT StopMIDIOnEvent(uint in_eventID, GameObject in_gameObjectID, uint in_playingID)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_StopMIDIOnEvent__SWIG_0(in_eventID, akGameObjectID, in_playingID);
	}
	...
	{
		ulong akGameObjectID = GetAkGameObjectID(in_busObjectID);
		PreGameObjectAPICall(in_busObjectID, akGameObjectID);
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_0(GetAkGameObjectID(in_GameObjectID), in_pPositions.m_Buffer, in_NumPositions, (int)in_eMultiPositionType);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_1(GetAkGameObjectID(in_GameObjectID), in_pPositions.m_Buffer, in_NumPositions);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_2(GetAkGameObjectID(in_GameObjectID), in_pPositions.m_Buffer, in_NumPositions, (int)in_eMultiPositionType);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_3(GetAkGameObjectID(in_GameObjectID), in_pPositions.m_Buffer, in_NumPositions);
	}

	public static AKRESULT SetScalingFactor(GameObject in_GameObjectID, float in_fAttenuationScalingFactor)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetScalingFactor(GetAkGameObjectID(in_GameObjectID), in_fAttenuationScalingFactor);
	}

	public static AKRESULT AddListener(GameObject in_emitterGameObj, GameObject in_listenerGameObj)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_emitterGameObj);
		PreGameObjectAPICall(in_emitterGameObj, akGameObjectID);
		ulong akGameObjectID2 = GetAkGameObjectID(in_listenerGameObj);
		PreGameObjectAPICall(in_listenerGameObj, akGameObjectID2);
	...
	{
		ulong akGameObjectID = GetAkGameObjectID(in_listenerGameObj);
		PreGameObjectAPICall(in_listenerGameObj, akGameObjectID);
	...
	{
		ulong akGameObjectID = GetAkGameObjectID(in_uListenerID);
		PreGameObjectAPICall(in_uListenerID, akGameObjectID);
	...
	{
		ulong akGameObjectID = GetAkGameObjectID(in_emitterObjID);
		PreGameObjectAPICall(in_emitterObjID, akGameObjectID);
		ulong akGameObjectID2 = GetAkGameObjectID(in_listenerObjID);
		PreGameObjectAPICall(in_listenerObjID, akGameObjectID2);
	...
	{
		ulong akGameObjectID = GetAkGameObjectID(in_EmitterID);
		PreGameObjectAPICall(in_EmitterID, akGameObjectID);
		ulong akGameObjectID2 = GetAkGameObjectID(in_ListenerID);
		PreGameObjectAPICall(in_ListenerID, akGameObjectID2);
	...
	public static AKRESULT SetMultipleObstructionAndOcclusion(GameObject in_EmitterID, GameObject in_uListenerID, AkObstructionOcclusionValuesArray in_fObstructionOcclusionValues, uint in_uNumOcclusionObstruction)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_EmitterID);
		PreGameObjectAPICall(in_EmitterID, akGameObjectID);
		ulong akGameObjectID2 = GetAkGameObjectID(in_uListenerID);
		PreGameObjectAPICall(in_uListenerID, akGameObjectID2);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultipleObstructionAndOcclusion(akGameObjectID, akGameObjectID2, in_fObstructionOcclusionValues.GetBuffer(), in_uNumOcclusionObstruction);
	}
	...
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjID);
		PreGameObjectAPICall(in_gameObjID, akGameObjectID);
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetPosition(GetAkGameObjectID(in_GameObjectID), AkTransform.getCPtr(out_rPosition));
	}

	public static AKRESULT GetListenerPosition(GameObject in_uIndex, AkTransform out_rPosition)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_uIndex);
		PreGameObjectAPICall(in_uIndex, akGameObjectID);
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetSwitch__SWIG_1(in_pstrSwitchGroupName, GetAkGameObjectID(in_GameObj), out out_rSwitchState);
	}
	...
	public static AKRESULT SetImageSource(uint in_srcID, AkImageSourceSettings in_info, uint in_AuxBusID, ulong in_roomID, GameObject in_gameObjectID)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetImageSource(in_srcID, AkImageSourceSettings.getCPtr(in_info), in_AuxBusID, in_roomID, akGameObjectID);
	}
	...
	public static AKRESULT RemoveImageSource(uint in_srcID, uint in_AuxBusID, GameObject in_gameObjectID)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_RemoveImageSource(in_srcID, in_AuxBusID, akGameObjectID);
	}
	...
	public static AKRESULT ClearImageSources(uint in_AuxBusID, GameObject in_gameObjectID)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_ClearImageSources__SWIG_0(in_AuxBusID, akGameObjectID);
	}
	...
	public static AKRESULT QueryReflectionPaths(GameObject in_gameObjectID, uint in_positionIndex, ref Vector3 out_listenerPos, ref Vector3 out_emitterPos, AkReflectionPathInfoArray out_aPaths, out uint io_uArraySize)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryReflectionPaths(akGameObjectID, in_positionIndex, ref out_listenerPos, ref out_emitterPos, out_aPaths.GetBuffer(), out io_uArraySize);
	}
	...
	public static AKRESULT SetEarlyReflectionsAuxSend(GameObject in_gameObjectID, uint in_auxBusID)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetEarlyReflectionsAuxSend(akGameObjectID, in_auxBusID);
	}
	...
	public static AKRESULT SetEarlyReflectionsVolume(GameObject in_gameObjectID, float in_fSendVolume)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetEarlyReflectionsVolume(akGameObjectID, in_fSendVolume);
	}
	...
	public static AKRESULT QueryDiffractionPaths(GameObject in_gameObjectID, uint in_positionIndex, ref Vector3 out_listenerPos, ref Vector3 out_emitterPos, AkDiffractionPathInfoArray out_aPaths, out uint io_uArraySize)
	{
		ulong akGameObjectID = GetAkGameObjectID(in_gameObjectID);
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryDiffractionPaths(akGameObjectID, in_positionIndex, ref out_listenerPos, ref out_emitterPos, out_aPaths.GetBuffer(), out io_uArraySize);
	}

	public static AKRESULT RegisterGameObjInternal(GameObject in_GameObj)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_RegisterGameObjInternal(GetAkGameObjectID(in_GameObj));
	}

	public static AKRESULT UnregisterGameObjInternal(GameObject in_GameObj)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_UnregisterGameObjInternal(GetAkGameObjectID(in_GameObj));
	}

	public static AKRESULT RegisterGameObjInternal_WithName(GameObject in_GameObj, string in_pszObjName)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_RegisterGameObjInternal_WithName(GetAkGameObjectID(in_GameObj), in_pszObjName);
	}

	public static AKRESULT SetObjectPosition(GameObject in_GameObjectID, Vector3 Pos, Vector3 Front, Vector3 Top)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetObjectPosition(GetAkGameObjectID(in_GameObjectID), Pos, Front, Top);
	}
