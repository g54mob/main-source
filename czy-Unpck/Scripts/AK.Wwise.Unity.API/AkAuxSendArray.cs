...
public class AkAuxSendArray : IDisposable
{
	...
	public AkAuxSendValue this[int index]
	{
		get
		{
			...
			return new AkAuxSendValue(GetObjectPtr(index), cMemoryOwn: false);
		}
	}
	...
	{
		uint jarg = 4u;
		int result = AkSoundEnginePINVOKE.CSharp_GetGameObjectAuxSendValues(AkSoundEngine.GetAkGameObjectID(gameObject), m_Buffer, ref jarg);
		m_Count = (int)jarg;
