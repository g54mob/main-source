...
namespace Rewired.Utils
{
	...
	{
		private static byte[] XeWhEnBvuEMbPCkOtwEkniGNBjc;

		private static byte[] intToFloatBuffer => XeWhEnBvuEMbPCkOtwEkniGNBjc ?? (XeWhEnBvuEMbPCkOtwEkniGNBjc = new byte[4]);
