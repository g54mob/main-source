namespace Rewired.Platforms.PS4
{
	...
	{
		private IPS4AimExtensionSource Source => (GetSource() as eNGxyyCaaufbYfgDISdfwRfUBWY).ahVlanlbOCBOWeBnfSIFVGtHSeq as IPS4AimExtensionSource;
		...
		public void SetVibration(float strongMotorLevel, float weakMotorLevel, float strongMotorDuration, float weakMotorDuration)
		{
			...
			SetVibration(qBjHgovMyQVkhyEOFBYpjLTrxeL(PS4AimMotorType.StrongMotor), strongMotorLevel, strongMotorDuration, stopOtherMotors: false);
			SetVibration(qBjHgovMyQVkhyEOFBYpjLTrxeL(PS4AimMotorType.WeakMotor), weakMotorLevel, weakMotorDuration, stopOtherMotors: false);
		}
		...
		private static int qBjHgovMyQVkhyEOFBYpjLTrxeL(PS4AimMotorType P_0)
		{
			return (int)P_0;
		}
	}
