...
namespace Rewired.Data.Mapping
{
	...
	internal interface IHardwareControllerTemplateMap_Internal
	{
		...
		OyJZlVlspSSqIjquoKnBSuwliGg GetAxisTarget(Controller controller, int elementIdentifierId);

		OyJZlVlspSSqIjquoKnBSuwliGg GetButtonTarget(Controller controller, int elementIdentifierId);
	}
}
