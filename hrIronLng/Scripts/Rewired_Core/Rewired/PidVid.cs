...
namespace Rewired
{
	...
	{
		private const string ChjvHdIyujeLrQCQuqGqNlglEfB = "[^a-fA-F0-9]";
		...
		{
			if (string.IsNullOrEmpty(McMReSuFlbRmLaTPVfCHrjTRHkd(pidVid)))
			{
				productId = 0;
				vendorId = 0;
				return;
		...
		{
			return tWuBnDbehTWTKptusknsFMvMaPTg(McMReSuFlbRmLaTPVfCHrjTRHkd(pidVid));
		}
		...
		private bool tWuBnDbehTWTKptusknsFMvMaPTg(string P_0)
		{
		...
		private static string McMReSuFlbRmLaTPVfCHrjTRHkd(string P_0)
		{
