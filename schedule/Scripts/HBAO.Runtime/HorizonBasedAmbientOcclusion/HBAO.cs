...
namespace HorizonBasedAmbientOcclusion
{
	...
	public class HBAO : MonoBehaviour
	{
		...
		public struct Presets
		{
			...
			[SerializeField]
			public static Presets defaults => default(Presets);
		}
		...
		public struct GeneralSettings
		{
			...
			[SerializeField]
			public static GeneralSettings defaults => default(GeneralSettings);
		}
		...
		public struct AOSettings
		{
			...
			[SerializeField]
			public static AOSettings defaults => default(AOSettings);
		}
		...
		public struct TemporalFilterSettings
		{
			...
			[SerializeField]
			public static TemporalFilterSettings defaults => default(TemporalFilterSettings);
		}
		...
		public struct BlurSettings
		{
			...
			[SerializeField]
			public static BlurSettings defaults => default(BlurSettings);
		}
		...
		public struct ColorBleedingSettings
		{
			...
			[SerializeField]
			public static ColorBleedingSettings defaults => default(ColorBleedingSettings);
		}
		...
		private CameraEvent cameraEvent => default(CameraEvent);
		...
		private bool isHistoryBufferDirty => false;

		private static RenderTextureFormat defaultHDRRenderTextureFormat => default(RenderTextureFormat);

		private RenderTextureFormat sourceFormat => default(RenderTextureFormat);

		private static RenderTextureFormat colorFormat => default(RenderTextureFormat);

		private static RenderTextureFormat depthFormat => default(RenderTextureFormat);

		private static RenderTextureFormat normalsFormat => default(RenderTextureFormat);

		private static bool isLinearColorSpace => false;

		private bool renderingInSceneView => false;
