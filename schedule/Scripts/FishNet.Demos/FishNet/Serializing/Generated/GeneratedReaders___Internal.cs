...
namespace FishNet.Serializing.Generated
{
	...
	public static class GeneratedReaders___Internal
	{
		...
		{
			return default(HostPasswordBroadcast);
		}
		...
		{
			return default(PasswordBroadcast);
		}
		...
		{
			return default(ResponseBroadcast);
		}
		...
		{
			return default(RigidbodyPrediction.MoveData);
		}
		...
		{
			return default(RigidbodyPrediction.ReconcileData);
		}
