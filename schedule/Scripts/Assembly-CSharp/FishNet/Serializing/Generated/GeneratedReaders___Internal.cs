...
namespace FishNet.Serializing.Generated
{
	...
	public static class GeneratedReaders___Internal
	{
		...
		{
			return default(AirConditioner.EMode);
		}
		...
		{
			return default(Manor.EManorState);
		}
		...
		{
			return default(SlotFilter.EType);
		}
		...
		{
			return default(CartelDealInfo.EStatus);
		}
		...
		{
			return default(Jukebox.ERepeatMode);
		}
