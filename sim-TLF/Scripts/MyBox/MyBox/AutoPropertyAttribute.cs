...
namespace MyBox
{
	...
	public class AutoPropertyAttribute : PropertyAttribute
	{
		...
		public AutoPropertyAttribute(AutoPropertyMode mode = AutoPropertyMode.Children, string predicateMethodName = null, Type predicateMethodTarget = null, bool allowEmpty = false, bool editable = false)
		{
			Mode = mode;
