	...
	public class SliderManager : MonoBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler
	{
		...
		private void Awake()
		{
			...
			if (saveValue)
			{
				...
				{
					value = DreamOSDataManager.ReadFloatData(dataCategory, saveKey);
				}
				else
				{
					DreamOSDataManager.WriteFloatData(dataCategory, saveKey, value);
				}
				mainSlider.value = value;
				mainSlider.onValueChanged.AddListener(delegate
				{
					DreamOSDataManager.WriteFloatData(dataCategory, saveKey, mainSlider.value);
				});
			}
			mainSlider.onValueChanged.AddListener(delegate
			{
