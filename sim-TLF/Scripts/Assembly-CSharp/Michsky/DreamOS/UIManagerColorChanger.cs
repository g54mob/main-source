...
namespace Michsky.DreamOS
{
	...
	public class UIManagerColorChanger : MonoBehaviour
	{
		...
		[Header("Colors")]
		public Color accent = new Color32(0, 150, byte.MaxValue, byte.MaxValue);

		public Color accentMatch = new Color32(byte.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue);

		public Color primary = new Color32(byte.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue);

		public Color secondary = new Color32(25, 35, 45, byte.MaxValue);
