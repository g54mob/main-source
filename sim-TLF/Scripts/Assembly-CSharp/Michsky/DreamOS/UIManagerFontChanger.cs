...
namespace Michsky.DreamOS
{
	...
	public class UIManagerFontChanger : MonoBehaviour
	{
		...
		public void ApplyFonts()
		{
			...
			if (thinFont != null)
			{
				targetUIManager.systemFontThin = thinFont;
			}
			if (lightFont != null)
			{
				targetUIManager.systemFontLight = lightFont;
			}
			if (regularFont != null)
			{
				targetUIManager.systemFontRegular = regularFont;
			}
			if (semiboldFont != null)
			{
				targetUIManager.systemFontSemiBold = semiboldFont;
			}
			if (boldFont != null)
			{
				targetUIManager.systemFontBold = boldFont;
			}
