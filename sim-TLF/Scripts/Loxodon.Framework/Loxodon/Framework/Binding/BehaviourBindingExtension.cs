...
namespace Loxodon.Framework.Binding
{
	public static class BehaviourBindingExtension
	{
		...
		{
			return new BindingSet<TBehaviour, TSource>(behaviour.BindingContext(), behaviour);
		}
		...
		{
			return new BindingSet<TBehaviour>(behaviour.BindingContext(), behaviour);
		}

		public static BindingSet CreateSimpleBindingSet(this Behaviour behaviour)
		{
			return new BindingSet(behaviour.BindingContext(), behaviour);
		}
