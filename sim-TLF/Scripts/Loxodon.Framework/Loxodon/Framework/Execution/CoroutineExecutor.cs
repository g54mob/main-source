...
namespace Loxodon.Framework.Execution
{
	public class CoroutineExecutor : AbstractExecutor, ICoroutineExecutor
	{
		...
		public virtual Loxodon.Framework.Asynchronous.IAsyncResult RunOnCoroutine(IEnumerator routine)
		{
			return Executors.RunOnCoroutine(routine);
		}

		public virtual Loxodon.Framework.Asynchronous.IAsyncResult RunOnCoroutine(Func<IPromise, IEnumerator> func)
		{
