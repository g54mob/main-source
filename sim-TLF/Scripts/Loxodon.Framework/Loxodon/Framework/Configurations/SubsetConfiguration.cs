...
{
	internal class SubsetConfiguration : ConfigurationBase
	{
		...
		protected string GetParentKey(string key)
		{
			...
			return prefix + ConfigurationBase.KEY_DELIMITER + key;
		}
		...
		protected string GetChildKey(string key)
		{
			...
			return key.Substring(prefix.Length + ConfigurationBase.KEY_DELIMITER.Length);
		}
		...
		{
			return new TransformEnumerator<string, string>(parent.GetKeys(prefix), (string key) => GetChildKey(key));
		}
