...
namespace EasyTextEffects.Effects
{
	...
	{
		private static readonly List<TextEffectInstance> EmptyEffectInstanceList = new List<TextEffectInstance>();
		...
		{
			HashSet<TextEffectInstance> effects = (from effect in (topLeftEffects ?? EmptyEffectInstanceList).Concat(topRightEffects ?? EmptyEffectInstanceList).Concat(bottomLeftEffects ?? EmptyEffectInstanceList).Concat(bottomRightEffects ?? EmptyEffectInstanceList)
				where effect
				select effect).ToHashSet();
