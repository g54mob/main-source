...
namespace TMPEffects.Parameters
{
	...
	{
		public struct OffsetBundleParameters
		{
		...
		private static void Create_Hook(ref OffsetBundle newInstance, OffsetBundle originalInstance, OffsetBundleParameters parameters)
		{
		...
		public static bool ValidateOffsetBundleParameters(IDictionary<string, string> parameters, ITMPKeywordDatabase keywords = null, string prefix = "")
		{
			if (parameters == null)
			{
				return true;
		...
		public static OffsetBundleParameters GetOffsetBundleParameters(IDictionary<string, string> parameters, ITMPKeywordDatabase keywords = null, string prefix = "")
		{
			OffsetBundleParameters result = default(OffsetBundleParameters);
			if (parameters == null)
			{
				return result;
			}
		...
		public static OffsetBundle CreateOffsetBundle(OffsetBundle OffsetBundleInstance, OffsetBundleParameters parameters)
		{
			OffsetBundle newInstance = new OffsetBundle();
			newInstance._provider = parameters._provider ?? OffsetBundleInstance._provider;
			newInstance.uniformity = parameters.uniformity ?? OffsetBundleInstance.uniformity;
			newInstance.ignoreAnimatorScaling = parameters.ignoreAnimatorScaling ?? OffsetBundleInstance.ignoreAnimatorScaling;
			newInstance.zeroBasedOffset = parameters.zeroBasedOffset ?? OffsetBundleInstance.zeroBasedOffset;
			Create_Hook(ref newInstance, OffsetBundleInstance, parameters);
			return newInstance;
		}
	}
}
