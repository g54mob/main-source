...
namespace TMPEffects.TMPAnimations.ShowAnimations
{
	...
	public class SpreadShowAnimation : TMPShowAnimation
	{
		...
		{
			float time = Mathf.Lerp(data.startPercentage, data.targetPercentage, (context.AnimatorContext.PassedTime - context.AnimatorContext.StateTime(cData)) / data.duration);
			float t = data.curve.Evaluate(time);
