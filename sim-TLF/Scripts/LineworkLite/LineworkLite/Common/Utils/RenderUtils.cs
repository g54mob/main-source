...
namespace LineworkLite.Common.Utils
{
	public static class RenderUtils
	{
		...
		{
			PassData passData;
			using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PassData>("Clear Stencil (Free Outline)", out passData, ".\\Packages\\dev.ameye.linework-lite\\Runtime\\Common\\Utils\\RenderUtils.cs", 150);
