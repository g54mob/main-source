...
namespace IngameDebugConsole
{
	...
	public class ConsoleCustomTypeParserAttribute : ConsoleAttribute
	{
		...
		{
			DebugLogConsole.AddCustomParameterType(type, (DebugLogConsole.ParseFunction)Delegate.CreateDelegate(typeof(DebugLogConsole.ParseFunction), base.Method), readableName);
		}
	}
}
