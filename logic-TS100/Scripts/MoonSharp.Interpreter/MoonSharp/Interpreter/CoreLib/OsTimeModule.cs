...
namespace MoonSharp.Interpreter.CoreLib
{
	...
	public class OsTimeModule
	{
		...
		private static string StrFTime(string format, DateTime d)
		{
			...
			dictionary.Add('a', "ddd");
			dictionary.Add('A', "dddd");
			dictionary.Add('b', "MMM");
			dictionary.Add('B', "MMMM");
			dictionary.Add('c', "%f");
			dictionary.Add('d', "dd");
			dictionary.Add('D', "MM/dd/yy");
			dictionary.Add('F', "yyyy-MM-dd");
			dictionary.Add('g', "yy");
			dictionary.Add('G', "yyyy");
			dictionary.Add('h', "MMM");
			dictionary.Add('H', "HH");
			dictionary.Add('I', "hh");
			dictionary.Add('m', "MM");
			dictionary.Add('M', "mm");
			dictionary.Add('p', "tt");
			dictionary.Add('r', "h:mm:ss tt");
			dictionary.Add('R', "HH:mm");
			dictionary.Add('S', "ss");
			dictionary.Add('T', "HH:mm:ss");
			dictionary.Add('y', "yy");
			dictionary.Add('Y', "yyyy");
			dictionary.Add('x', "d");
			dictionary.Add('X', "T");
			dictionary.Add('z', "zzz");
			dictionary.Add('Z', "zzz");
			Dictionary<char, string> dictionary2 = dictionary;
			...
			foreach (char c in format)
			{
				...
				else
				{
					...
					{
						stringBuilder.Append(d.ToString(dictionary2[c]));
						continue;
					}
					switch (c)
					{
