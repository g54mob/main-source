...
namespace MoonSharp.Interpreter
{
	public class SymbolRef
	{
		...
		public static SymbolRef Global(string name, SymbolRef envSymbol)
		{
			...
			symbolRef.i_Index = -1;
			symbolRef.i_Type = SymbolRefType.Global;
			symbolRef.i_Env = envSymbol;
			symbolRef.i_Name = name;
			return symbolRef;
		}
		...
		{
			SymbolRef symbolRef = new SymbolRef();
			symbolRef.i_Index = index;
			symbolRef.i_Type = SymbolRefType.Local;
			symbolRef.i_Name = name;
			return symbolRef;
		}
		...
		internal static SymbolRef Upvalue(string name, int index)
		{
			SymbolRef symbolRef = new SymbolRef();
			symbolRef.i_Index = index;
			symbolRef.i_Type = SymbolRefType.Upvalue;
			symbolRef.i_Name = name;
			return symbolRef;
		}
		...
		{
			SymbolRef symbolRef = new SymbolRef();
			symbolRef.i_Type = (SymbolRefType)br.ReadByte();
			symbolRef.i_Index = br.ReadInt32();
			symbolRef.i_Name = br.ReadString();
			return symbolRef;
		}
