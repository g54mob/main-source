...
namespace MoonSharp.Interpreter
{
	public sealed class DynValue
	{
		...
		public static DynValue NewBoolean(bool v)
		{
			...
			dynValue.m_Number = (v ? 1 : 0);
			dynValue.m_Type = DataType.Boolean;
			return dynValue;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Number = num;
			dynValue.m_Type = DataType.Number;
			dynValue.m_HashCode = -1;
			return dynValue;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Object = str;
			dynValue.m_Type = DataType.String;
			return dynValue;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Object = string.Format(format, args);
			dynValue.m_Type = DataType.String;
			return dynValue;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Object = coroutine;
			dynValue.m_Type = DataType.Thread;
			return dynValue;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Object = function;
			dynValue.m_Type = DataType.Function;
			return dynValue;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Object = new CallbackFunction(callBack, name);
			dynValue.m_Type = DataType.ClrFunction;
			return dynValue;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Object = table;
			dynValue.m_Type = DataType.Table;
			return dynValue;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Object = new TailCallData
			{
				Args = args,
				Function = tailFn
			};
			dynValue.m_Type = DataType.TailCallRequest;
			return dynValue;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Object = tailCallData;
			dynValue.m_Type = DataType.TailCallRequest;
			return dynValue;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Object = new YieldRequest
			{
				ReturnValues = args
			};
			dynValue.m_Type = DataType.YieldRequest;
			return dynValue;
		}
		...
		public static DynValue NewTuple(params DynValue[] values)
		{
			...
			DynValue dynValue = new DynValue();
			dynValue.m_Object = values;
			dynValue.m_Type = DataType.Tuple;
			return dynValue;
		}
		...
		public static DynValue NewTupleNested(params DynValue[] values)
		{
			...
			DynValue dynValue2 = new DynValue();
			dynValue2.m_Object = list.ToArray();
			dynValue2.m_Type = DataType.Tuple;
			return dynValue2;
		}
		...
		{
			DynValue dynValue = new DynValue();
			dynValue.m_Object = userData;
			dynValue.m_Type = DataType.UserData;
			return dynValue;
		}
		...
		public override bool Equals(object obj)
		{
			...
			default:
				return object.ReferenceEquals(this, dynValue);
			}
		}
		...
		{
			if (Type != DataType.Nil && Type != DataType.Void)
			{
		...
		public T ToObject<T>()
		{
			return (T)ScriptToClrConversions.DynValueToObjectOfType(this, typeof(T), null, false);
		}
		...
		public T CheckUserDataType<T>(string funcName, int argNum = -1, TypeValidationFlags flags = TypeValidationFlags.AutoConvert)
		{
			...
			throw ScriptRuntimeException.BadArgumentUserData(argNum, funcName, typeof(T), obj, allowNil);
		}
	}
}
