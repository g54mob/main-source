...
{
	public class StompingStation2 : BaseBreweryStation
	{
		[Header("Tablet")]
		[Tooltip("The 3D tablet child attached to this station")]
		[SerializeField]
		private StompingTablet3D tablet;

		private const int GrapesPerBatch = 10;

		private const int SlotGrapes = 0;

		private const int SlotBarrel = 1;
		...
		private static void __rpc_handler_799289885(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
		{
		}
