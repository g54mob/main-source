...
namespace Pathfinding.Drawing
{
	public class DrawingData
	{
		...
		internal struct BuilderData : IDisposable
		{
			...
			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			internal unsafe delegate bool AnyBuffersWrittenTo_000001EB_0024PostfixBurstDelegate(UnsafeAppendBuffer* buffers, int numBuffers);

			internal static class AnyBuffersWrittenTo_000001EB_0024BurstDirectCall
			{
			...
			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			internal unsafe delegate void ResetAllBuffers_000001EC_0024PostfixBurstDelegate(UnsafeAppendBuffer* buffers, int numBuffers);

			internal static class ResetAllBuffers_000001EC_0024BurstDirectCall
			{
				private static IntPtr Pointer;
