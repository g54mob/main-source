...
namespace Pathfinding.Drawing
{
	...
	public struct CommandBuilder : IDisposable
	{
		...
		private class JobWireMesh
		{
			...
			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			internal unsafe delegate void WireMesh_000000D5_0024PostfixBurstDelegate(float3* verts, int* indices, int vertexCount, int indexCount, ref CommandBuilder draw);

			internal static class WireMesh_000000D5_0024BurstDirectCall
			{
			...
			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			internal delegate void Execute_000000D6_0024PostfixBurstDelegate(ref Mesh.MeshData rawMeshData, ref CommandBuilder draw);

			internal static class Execute_000000D6_0024BurstDirectCall
			{
				private static IntPtr Pointer;
			...
			[BurstCompile]
			[MonoPInvokeCallback(typeof(WireMesh_000000D5_0024PostfixBurstDelegate))]
