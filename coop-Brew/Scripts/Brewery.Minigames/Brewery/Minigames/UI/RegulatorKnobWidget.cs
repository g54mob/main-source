...
{
	public class RegulatorKnobWidget : IControlWidget, IDisposable
	{
		...
		private VisualElement knobFace;
		...
		public RegulatorKnobWidget(ControlDefinition def, int controlIndex)
		{
		}
