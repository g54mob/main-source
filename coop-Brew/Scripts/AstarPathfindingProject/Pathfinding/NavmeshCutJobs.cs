...
namespace Pathfinding
{
	...
	internal static class NavmeshCutJobs
	{
		...
		internal delegate void CalculateContour_000008B1_0024PostfixBurstDelegate(ref JobCalculateContour job);

		internal static class CalculateContour_000008B1_0024BurstDirectCall
		{
		...
		[MonoPInvokeCallback(typeof(CalculateContour_000008B1_0024PostfixBurstDelegate))]
		...
		[BurstCompile(FloatPrecision.Standard, FloatMode.Fast)]
		internal static void CalculateContour_0024BurstManaged(ref JobCalculateContour job)
		{
		}
	}
}
