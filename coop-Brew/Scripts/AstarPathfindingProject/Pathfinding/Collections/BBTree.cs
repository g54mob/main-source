...
namespace Pathfinding.Collections
{
	...
	public struct BBTree : IDisposable
	{
		...
		public readonly struct ProjectionParams
		{
			...
			internal delegate float SquaredRectPointDistanceOnPlane_00000DDC_0024PostfixBurstDelegate(in ProjectionParams projection, ref IntRect rect, ref float3 p);

			internal static class SquaredRectPointDistanceOnPlane_00000DDC_0024BurstDirectCall
			{
			...
			[MonoPInvokeCallback(typeof(SquaredRectPointDistanceOnPlane_00000DDC_0024PostfixBurstDelegate))]
			...
			public ProjectionParams(NNConstraint constraint, GraphTransform graphTransform)
			{
				...
				distanceMetric = default(DistanceMetric);
			...
			[BurstCompile(FloatMode = FloatMode.Fast)]
			[IgnoredByDeepProfiler]
			internal static float SquaredRectPointDistanceOnPlane_0024BurstManaged(in ProjectionParams projection, ref IntRect rect, ref float3 p)
			{
				return 0f;
			}
		}
		...
		private struct NearbyNodesIterator : IEnumerator<CloseNode>, IEnumerator, IDisposable
		{
			...
			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			internal delegate bool MoveNext_00000DE3_0024PostfixBurstDelegate(ref NearbyNodesIterator it);

			internal static class MoveNext_00000DE3_0024BurstDirectCall
			{
				private static IntPtr Pointer;
			...
			[MonoPInvokeCallback(typeof(MoveNext_00000DE3_0024PostfixBurstDelegate))]
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			[BurstCompile(FloatMode = FloatMode.Default)]
			internal static bool MoveNext_0024BurstManaged(ref NearbyNodesIterator it)
			{
				return false;
			}
		}
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void Build_00000DD1_0024PostfixBurstDelegate(ref UnsafeSpan<int> triangles, ref UnsafeSpan<Int3> vertices, out BBTree bbTree);

		internal static class Build_00000DD1_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(Build_00000DD1_0024PostfixBurstDelegate))]
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		[BurstCompile]
		internal static void Build_0024BurstManaged(ref UnsafeSpan<int> triangles, ref UnsafeSpan<Int3> vertices, out BBTree bbTree)
		{
			bbTree = default(BBTree);
		}
	}
