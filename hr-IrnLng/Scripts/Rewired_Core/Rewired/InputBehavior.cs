...
namespace Rewired
{
	...
	public sealed class InputBehavior
	{
		...
		public InputBehavior(InputBehavior source)
			: this()
		{
			vLGzhkkOjklipeWBBWZRaDXrsOl(source, this, true);
		}
		...
		public string ToXmlString()
		{
			try
			{
				return bWDCIpwEgtZfEjQoobEHjnYYFMzY().ToXmlString(writeDocumentTag: true);
			}
			catch (Exception ex)
			{
		...
		public bool ImportXmlString(string xmlString)
		{
			try
			{
				AIlTBlatymduYQhsnDZKtmbGMpq(SerializedObject.FromXml(GetType(), xmlString));
				return true;
			}
			catch (Exception ex)
			{
		...
		public string ToJsonString()
		{
			try
			{
				return bWDCIpwEgtZfEjQoobEHjnYYFMzY().ToJsonString();
			}
			catch (Exception ex)
			{
		...
		public bool ImportJsonString(string jsonString)
		{
			try
			{
				AIlTBlatymduYQhsnDZKtmbGMpq(SerializedObject.FromJson(GetType(), jsonString));
				return true;
			}
			catch (Exception ex)
			{
		...
		public bool ImportData(InputBehavior inputBehavior)
		{
			...
			vLGzhkkOjklipeWBBWZRaDXrsOl(inputBehavior, this, false);
			return true;
		}
		...
		public void Reset()
		{
			InputBehavior inputBehavior = ReInput.mapping.nestrrfIVirECTnLUMsmpQfUNFW(_id);
			if (inputBehavior != null)
			{
				vLGzhkkOjklipeWBBWZRaDXrsOl(inputBehavior, this, true);
			}
		}

		internal SerializedObject bWDCIpwEgtZfEjQoobEHjnYYFMzY()
		{
			...
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.yOvafjSNTWBQXamMnEDaXllsdXm
			{
				...
				lvXCTCWOhrCtuFDbbEqyqyUVPhp = 5.ToString()
			});
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.yOvafjSNTWBQXamMnEDaXllsdXm
			{
				NSIraOohUuxbwNWwnOfcoaPLKLA = "id",
				lvXCTCWOhrCtuFDbbEqyqyUVPhp = _id.ToString()
			});
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.yOvafjSNTWBQXamMnEDaXllsdXm
			{
			...
			serializedObject.xmlInfo.attributes.Add(new SerializedObject.XmlInfo.yOvafjSNTWBQXamMnEDaXllsdXm
			{
				...
				KyKFPbDbzyvJvQZYVoBMpXenzVYN = null,
				lvXCTCWOhrCtuFDbbEqyqyUVPhp = string.Format("{0} {1}{2}{3}{4}{5}", "http://guavaman.com/rewired", "http://guavaman.com/schemas/rewired/", "1.4", "/", GetType().Name, ".xsd")
			});
		...
		internal void AIlTBlatymduYQhsnDZKtmbGMpq(SerializedObject P_0)
		{
			Reset();
		...
		private static void vLGzhkkOjklipeWBBWZRaDXrsOl(InputBehavior P_0, InputBehavior P_1, bool P_2)
		{
			if (P_2)
			{
				P_1._id = P_0._id;
