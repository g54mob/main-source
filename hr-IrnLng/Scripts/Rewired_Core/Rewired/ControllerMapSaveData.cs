...
namespace Rewired
{
	public abstract class ControllerMapSaveData
	{
		...
		internal static T ikoBGVHHLVNnLaVaWGffMETVhTJw<T>(Controller P_0, ControllerMap P_1) where T : ControllerMapSaveData
		{
			return (T)ikoBGVHHLVNnLaVaWGffMETVhTJw(P_0, P_1);
		}

		internal static ControllerMapSaveData ikoBGVHHLVNnLaVaWGffMETVhTJw(Controller P_0, ControllerMap P_1)
		{
