...
namespace Rewired.Data.Mapping
{
	...
	public class AxisCalibrationInfo : IDeepCloneable
	{
		...
		internal static AxisCalibrationData zhCkdpsKjdHqcQEmNsdsKGGhQAU(AxisCalibrationInfo P_0)
		{
			if (P_0 == null)
			{
		...
		internal static AxisCalibrationInfo fAvPhzEuEJxlfHOJhqbRRuMLmlI(AxisCalibrationData P_0)
		{
