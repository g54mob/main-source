...
namespace Rewired.Utils
{
	...
	public static class ReflectionTools
	{
		...
		{
			return qgyGuUMgWLqjWsiPvOmmfRwiBpv(classPath, true, ignoreCase);
		}

		internal static Type GetTypeInUnityBuildAssembly(string classPath, bool ignoreCase = false)
		{
			return qgyGuUMgWLqjWsiPvOmmfRwiBpv(classPath, false, ignoreCase);
		}

		private static Type qgyGuUMgWLqjWsiPvOmmfRwiBpv(string P_0, bool P_1, bool P_2 = false)
		{
			Assembly[] assemblies = AppDomain.CurrentDomain.GetAssemblies();
