...
namespace Rewired.Utils
{
	...
	{
		private static string fcCMMypgKobJDAVttPrvBMQcGeQb;
		...
		static StringTools()
		{
			...
			fcCMMypgKobJDAVttPrvBMQcGeQb = Regex.Escape(new string(invalidFileNameChars));
		}

		public static string CleanUpFileName(string name)
		{
			name = name.Trim();
			string pattern = "[ ~`,:;'\\.\\$\\^\\{\\}\\[\\]\\(\\|\\)\\*\\+\\?\\\\" + fcCMMypgKobJDAVttPrvBMQcGeQb + "]";
