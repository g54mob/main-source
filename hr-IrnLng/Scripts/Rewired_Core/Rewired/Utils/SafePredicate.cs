...
namespace Rewired.Utils
{
	...
	internal class SafePredicate<T> : SafeDelegate<Predicate<T>>
	{
		...
		private bool cLorrVypRccfkFSjLEUZZmhWOQHg;

		private static Action<object, Predicate<T>> buNgGXopEIgyYeMtrvoysyFJnUaM;

		private static Action<object, Predicate<T>> invokeDelegate => PPJRmIdjvlGCIhzCKQhRGPLcljj;
		...
		public bool Invoke(T arg0)
		{
			...
			finally
			{
				...
				cLorrVypRccfkFSjLEUZZmhWOQHg = false;
			}
		}
		...
		private static void PPJRmIdjvlGCIhzCKQhRGPLcljj(object P_0, Predicate<T> P_1)
		{
			if (P_1 != null && P_0 is SafePredicate<T> safePredicate)
			{
				safePredicate.cLorrVypRccfkFSjLEUZZmhWOQHg = P_1(safePredicate.tQdDnYjKVGARcwqmQpfqoOulamx);
			}
		}
