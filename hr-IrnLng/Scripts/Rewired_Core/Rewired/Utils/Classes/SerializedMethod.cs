...
namespace Rewired.Utils.Classes
{
	...
	{
		private const int TZaPyzggwvkOBKNLCeEbuOTGxpX = 3;

		[NonSerialized]
		private bool eLgRzRXfONmOtgIpZxVdIASdgfBj;
		...
		{
			if (!eLgRzRXfONmOtgIpZxVdIASdgfBj)
			{
				dRIuXZzDTteTteJeQqlYhZkuqhc();
			}
		...
		private void dRIuXZzDTteTteJeQqlYhZkuqhc()
		{
			_data = new List<TypeWrapper>(3);
			eLgRzRXfONmOtgIpZxVdIASdgfBj = true;
		}
	}
}
