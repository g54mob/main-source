...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class ytALBAlNgQewiRALEftfNZJBgDG : IControllerExtensionSource
		{
			public readonly IDriver_DualSense LvmafjUzQGqiDnMiZfdFizbRjGJh;

			public readonly bool GkLKAMFRzbMjZIZtziMXVcnFggPj;

			public readonly int HSFfOkgYdavTAaqGDaWBzgNaSgu;

			public ytALBAlNgQewiRALEftfNZJBgDG(IDriver_DualSense driver, bool supportsVibration, int vibrationMotorCount)
			{
		...
		private ytALBAlNgQewiRALEftfNZJBgDG fzzXbvFoZzdAqHDolrszRhFTkOz;
		...
		public DualSenseMicrophoneLightMode microphoneLightMode
		{
			get
			{
				...
				return fzzXbvFoZzdAqHDolrszRhFTkOz.LvmafjUzQGqiDnMiZfdFizbRjGJh.microphoneLightMode;
			}
			set
			{
				if (ReInput._id != _reInputId)
				...
				{
					fzzXbvFoZzdAqHDolrszRhFTkOz.LvmafjUzQGqiDnMiZfdFizbRjGJh.microphoneLightMode = value;
				}
			}
		}
		...
		public DualSenseOtherLightBrightness otherLightBrightness
		{
			get
			{
				...
				return fzzXbvFoZzdAqHDolrszRhFTkOz.LvmafjUzQGqiDnMiZfdFizbRjGJh.otherLightBrightness;
			}
			set
			{
				if (ReInput._id != _reInputId)
				...
				{
					fzzXbvFoZzdAqHDolrszRhFTkOz.LvmafjUzQGqiDnMiZfdFizbRjGJh.otherLightBrightness = value;
				}
			}
		}
		...
		public DualSensePlayerLightFlags playerLights
		{
			get
			{
				...
				return fzzXbvFoZzdAqHDolrszRhFTkOz.LvmafjUzQGqiDnMiZfdFizbRjGJh.playerLights;
			}
			set
			{
				if (ReInput._id != _reInputId)
				...
				{
					fzzXbvFoZzdAqHDolrszRhFTkOz.LvmafjUzQGqiDnMiZfdFizbRjGJh.playerLights = value;
				}
			}
		}
		...
		public bool batteryCharging
		{
			get
			{
				...
				return fzzXbvFoZzdAqHDolrszRhFTkOz.LvmafjUzQGqiDnMiZfdFizbRjGJh.BatteryCharging;
			}
		}

		internal DualSenseExtension(IDriver_DualSense driver)
			: base(new ytALBAlNgQewiRALEftfNZJBgDG(driver, driver.VibrationMotorCount > 0, driver.VibrationMotorCount))
		{
		...
		{
			fzzXbvFoZzdAqHDolrszRhFTkOz = P_0 as ytALBAlNgQewiRALEftfNZJBgDG;
