...
namespace Rewired
{
	...
	public sealed class ControllerElementIdentifier : IControllerElementIdentifierCommon_Internal
	{
		...
		private static ControllerElementIdentifier YqluGqHRSAMywIdeQRUtmFnUhbfh;
		...
		internal static ControllerElementIdentifier BlankReadOnly
		{
			get
			{
				if (YqluGqHRSAMywIdeQRUtmFnUhbfh == null)
				{
					ControllerElementIdentifier controllerElementIdentifier = new ControllerElementIdentifier();
					controllerElementIdentifier._id = -1;
					controllerElementIdentifier.KwHYBxmBgLcIKzGXjrgdMieHfpr = true;
					return YqluGqHRSAMywIdeQRUtmFnUhbfh = controllerElementIdentifier;
				}
				return YqluGqHRSAMywIdeQRUtmFnUhbfh;
			}
		}
		...
		private void ilKcPvNOFetaLIGGYVaTSjdosvB()
		{
