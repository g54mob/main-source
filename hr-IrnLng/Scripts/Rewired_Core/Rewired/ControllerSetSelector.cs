...
namespace Rewired
{
	...
	public sealed class ControllerSetSelector : ISerializationCallbackReceiver, IDeepCloneable
	{
		...
		[NonSerialized]
		private Guid dkyucEwifACzGcrXxPgkkBGAXkMF;
		...
		public Guid hardwareTypeGuid
		{
			get
			{
				...
				return dkyucEwifACzGcrXxPgkkBGAXkMF;
			}
			set
			{
				...
				dkyucEwifACzGcrXxPgkkBGAXkMF = value;
		...
		public ControllerSetSelector(ControllerSetSelector source)
		{
			...
			dkyucEwifACzGcrXxPgkkBGAXkMF = source.dkyucEwifACzGcrXxPgkkBGAXkMF;
		}
		...
		internal ControllerSetSelector(Type type, ControllerType controllerType, string guid, string hardwareIdentifier, int controllerId)
		{
			...
			_guid = guid;
			dkyucEwifACzGcrXxPgkkBGAXkMF = StringTools.ToGuid(guid);
		...
		public bool Matches(Controller controller)
		{
			...
			case Type.HardwareType:
				if (dkyucEwifACzGcrXxPgkkBGAXkMF != Guid.Empty)
				{
					return dkyucEwifACzGcrXxPgkkBGAXkMF == controller.hardwareTypeGuid;
				}
			...
			case Type.ControllerTemplateType:
				return controller.ImplementsTemplate(dkyucEwifACzGcrXxPgkkBGAXkMF);
			case Type.PersistentControllerInstance:
				return controller.deviceInstanceGuid == dkyucEwifACzGcrXxPgkkBGAXkMF;
		...
		private void wKELelJoycrWvOXmHpvGEncEmaA()
		{
			_guid = string.Empty;
			dkyucEwifACzGcrXxPgkkBGAXkMF = Guid.Empty;
		}

		void ISerializationCallbackReceiver.OnAfterDeserialize()
		{
			dkyucEwifACzGcrXxPgkkBGAXkMF = StringTools.ToGuid(_guid);
		}
