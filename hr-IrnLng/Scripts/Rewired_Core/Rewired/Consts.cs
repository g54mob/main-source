...
namespace Rewired
{
	...
	public static class Consts
	{
		...
		private static ReadOnlyCollection<ControllerElementIdentifier> EEzSfTTpUetJoiqVFmmMpbqmsmg;

		private static ReadOnlyCollection<ControllerElementIdentifier> XeyxOLnbosPiotiXCKsLNEkeyrt;

		internal static readonly IList<string> mouseAxisUnityNames;

		private static readonly string[] TTxoUljJrQilalQIZAEpLrXSLOy;

		internal static readonly IList<string> mouseButtonUnityNames;

		private static readonly string[] mnShJVgrYhUDWZyxFVduptwwRRh;

		internal static readonly IList<string> keyboardKeyNames;

		private static readonly string[] pLoBUpVcodEsXbXRTaEJTfiHAkV;
		...
		private static readonly string[] UbEwSgDEGhRuIpmLKCNsPLZhuze;

		internal static readonly IList<PidVid> pidVids_sony_dualShock4;

		private static readonly PidVid[] WZIgutkgICejmSqBWKkMRziETdO;

		internal static readonly IList<string> productNames_sony_dualShock4;

		private static readonly string[] PnWgQLGQHcUVSriYmhOhiROlmqzw;

		private static readonly ControllerElementIdentifier[] sGDbxnJONPUqkDdhDDAfSTPIPLv;
		...
		internal static IList<ControllerElementIdentifier> unityUnifiedMouseElementIdentifiers => EEzSfTTpUetJoiqVFmmMpbqmsmg ?? (EEzSfTTpUetJoiqVFmmMpbqmsmg = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[11]
		{
		...
		internal static IList<ControllerElementIdentifier> rawInputUnifiedMouseElementIdentifiers => XeyxOLnbosPiotiXCKsLNEkeyrt ?? (XeyxOLnbosPiotiXCKsLNEkeyrt = new ReadOnlyCollection<ControllerElementIdentifier>(new ControllerElementIdentifier[9]
		{
			new ControllerElementIdentifier(0, "Mouse Horizontal", "Mouse Right", "Mouse Left", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, isMappableOnPlatform: true),
			new ControllerElementIdentifier(1, "Mouse Vertical", "Mouse Up", "Mouse Down", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, isMappableOnPlatform: true),
			new ControllerElementIdentifier(2, "Mouse Wheel", "Mouse Wheel Up", "Mouse Wheel Down", ControllerElementType.Axis, CompoundControllerElementType.Axis2D, isMappableOnPlatform: true),
		...
		internal static ControllerElementIdentifier[] unknownJoystickElementIdentifiers_orig => sGDbxnJONPUqkDdhDDAfSTPIPLv;
		...
		static Consts()
		{
			...
			TTxoUljJrQilalQIZAEpLrXSLOy = new string[3] { "MouseAxis1", "MouseAxis2", "MouseAxis3" };
			mnShJVgrYhUDWZyxFVduptwwRRh = new string[7] { "MouseButton0", "MouseButton1", "MouseButton2", "MouseButton3", "MouseButton4", "MouseButton5", "MouseButton6" };
			pLoBUpVcodEsXbXRTaEJTfiHAkV = new string[132]
			{
			...
			UbEwSgDEGhRuIpmLKCNsPLZhuze = new string[5] { "", "Ctrl", "Alt", "Shift", "Cmd" };
			WZIgutkgICejmSqBWKkMRziETdO = new PidVid[3]
			{
				new PidVid(1476, 1356),
				new PidVid(2976, 1356),
				new PidVid(2508, 1356)
			};
			PnWgQLGQHcUVSriYmhOhiROlmqzw = new string[4] { "Sony Computer Entertainment Wireless Controller", "Sony Interactive Entertainment DUALSHOCK®4 USB Wireless Adaptor", "Wireless Controller", "Sony Interactive Entertainment Wireless Controller" };
			mouseAxisUnityNames = new ReadOnlyCollection<string>(TTxoUljJrQilalQIZAEpLrXSLOy);
			mouseButtonUnityNames = new ReadOnlyCollection<string>(mnShJVgrYhUDWZyxFVduptwwRRh);
			keyboardKeyNames = new ReadOnlyCollection<string>(pLoBUpVcodEsXbXRTaEJTfiHAkV);
			keyboardKeyValues = new ReadOnlyCollection<int>(_keyboardKeyValues);
			modifierKeyShortNames = new ReadOnlyCollection<string>(UbEwSgDEGhRuIpmLKCNsPLZhuze);
			pidVids_sony_dualShock4 = new ReadOnlyCollection<PidVid>(WZIgutkgICejmSqBWKkMRziETdO);
			productNames_sony_dualShock4 = new ReadOnlyCollection<string>(PnWgQLGQHcUVSriYmhOhiROlmqzw);
			...
			sGDbxnJONPUqkDdhDDAfSTPIPLv = vgFyaqvelldLYDrLhXEcWKAonnW();
			if (132 != pLoBUpVcodEsXbXRTaEJTfiHAkV.Length)
			{
		...
		private static ControllerElementIdentifier[] vgFyaqvelldLYDrLhXEcWKAonnW()
		{
			int num = 0;
