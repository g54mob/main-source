...
namespace Rewired
{
	...
	public sealed class InputAction
	{
		...
		[NonSerialized]
		private string jHwvVCWIOFCaofSbBJbBSYoLGbr;

		[NonSerialized]
		private string hxnAQdCtwXerVqIrYJCPZUcYrxMd;
		...
		public string positiveDescriptiveName
		{
			get
			{
				...
				if (string.IsNullOrEmpty(jHwvVCWIOFCaofSbBJbBSYoLGbr))
				{
					jHwvVCWIOFCaofSbBJbBSYoLGbr = _descriptiveName + " +";
				}
				return jHwvVCWIOFCaofSbBJbBSYoLGbr;
			}
			internal set
			{
				_positiveDescriptiveName = value;
				jHwvVCWIOFCaofSbBJbBSYoLGbr = string.Empty;
			}
		}
		...
		public string negativeDescriptiveName
		{
			get
			{
				...
				if (string.IsNullOrEmpty(hxnAQdCtwXerVqIrYJCPZUcYrxMd))
				{
					hxnAQdCtwXerVqIrYJCPZUcYrxMd = _descriptiveName + " -";
				}
				return hxnAQdCtwXerVqIrYJCPZUcYrxMd;
			}
			internal set
			{
				_negativeDescriptiveName = value;
				hxnAQdCtwXerVqIrYJCPZUcYrxMd = string.Empty;
			}
		}
