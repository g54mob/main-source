...
namespace Rewired
{
	...
	public class ControllerTemplateElementIdentifier : IControllerElementIdentifierCommon_Internal, IControllerTemplateElementIdentifier
	{
		...
		{
			return new ControllerElementIdentifier(_id, _name, _positiveName, _negativeName, XqmnYoifzflCsKxcFaHDewlkEkh.BftiocUDprOjmsXKNAlEbrrmBZF(_elementType), CompoundControllerElementType.Axis2D, isMappableOnPlatform);
		}
	}
}
