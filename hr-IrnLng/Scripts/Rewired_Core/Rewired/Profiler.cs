...
namespace Rewired
{
	...
	{
		private const string PthANpHrwUnWgAHDToZTyXjVZiz = "ENABLE_PROFILER must be set in Rewired Core to use the profiler.";

		public static bool enableBinaryLog
		{
			get
			{
				RnwwEJgYXLOecMjpRhuxipDfRtrD();
				return false;
			}
			set
			{
		...
		private static void RnwwEJgYXLOecMjpRhuxipDfRtrD()
		{
