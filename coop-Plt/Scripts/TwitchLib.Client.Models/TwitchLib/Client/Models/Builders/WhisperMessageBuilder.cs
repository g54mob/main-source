namespace TwitchLib.Client.Models.Builders
{
	public sealed class WhisperMessageBuilder : IBuilder<WhisperMessage>, IFromIrcMessageBuilder<WhisperMessage>
	{
		...
		public WhisperMessage BuildFromIrcMessage(FromIrcMessageBuilderDataObject fromIrcMessageBuilderDataObject)
		{
			...
			return new WhisperMessage(fromIrcMessageBuilderDataObject.Message, botUsername);
		}

		public WhisperMessage Build()
		{
			return new WhisperMessage(_twitchLibMessage.Badges, _twitchLibMessage.ColorHex, _twitchLibMessage.Color, _twitchLibMessage.Username, _twitchLibMessage.DisplayName, _twitchLibMessage.EmoteSet, _threadId, _messageId, _twitchLibMessage.UserId, _twitchLibMessage.IsTurbo, _twitchLibMessage.BotUsername, _message, _twitchLibMessage.UserType);
		}
	}
}
