...
{
	[UpdateBefore(typeof(TagStaples))]
	public class TagStapleWhenMissing : ShopBuilderFilter
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass5_0
		{
			public NativeArray<CAppliance> appliances;
		...
		private struct _003C_003Ec__DisplayClass_Filter_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(TagStapleWhenMissing componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_00000F9B_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000F9B_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000F9B_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000F9B_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				if (option.Staple == ShopStapleType.NonStaple && option.StapleWhenMissing && !HasAlready(option.Appliance, appliances))
				{
			...
			public void ScheduleTimeInitialize(TagStapleWhenMissing componentSystem, ref _003C_003Ec__DisplayClass5_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_00000F9B_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		private static bool HasAlready(int app, NativeArray<CAppliance> appliances)
		{
			foreach (CAppliance item in appliances)
			{
				if (app == item.ID)
				{
					return true;
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_Filter_LambdaJob0_RunWithoutJobSystem_00000F9B_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_Filter_LambdaJob0.RunWithoutJobSystem_00000F9B_0024BurstDirectCall.Initialize();
		}
	}
}
