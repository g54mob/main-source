...
{
	public class FilterByTheme : ShopBuilderFilter
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass2_0
		{
			public SGlobalStatusList status;
		...
		private struct _003C_003Ec__DisplayClass_Filter_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(FilterByTheme componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_00000F88_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000F88_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000F88_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000F88_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				if (!option.IsRemoved && option.DecorationRequired != DecorationType.Null && !status.Theme.Contains(option.DecorationRequired))
				{
			...
			public void ScheduleTimeInitialize(FilterByTheme componentSystem, ref _003C_003Ec__DisplayClass2_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_00000F88_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		private SGlobalStatusList Status;
		...
		{
			base.BeforeRun();
			Status = GetOrDefault<SGlobalStatusList>();
		}
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_Filter_LambdaJob0_RunWithoutJobSystem_00000F88_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_Filter_LambdaJob0.RunWithoutJobSystem_00000F88_0024BurstDirectCall.Initialize();
		}
	}
}
