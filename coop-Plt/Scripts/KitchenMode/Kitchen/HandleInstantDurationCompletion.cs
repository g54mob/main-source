...
namespace Kitchen
{
	...
	public class HandleInstantDurationCompletion : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public struct Runtimes
				{
					...
					[NoAlias]
					public LambdaParameterValueProvider_IComponentData_Tag<CInstantlyCompleteDuration>.Runtime runtime_instant;
				}
				...
				[ReadOnly]
				[NoAlias]
				private LambdaParameterValueProvider_IComponentData_Tag<CInstantlyCompleteDuration> forParameter_instant;

				public void ScheduleTimeInitialize(HandleInstantDurationCompletion componentSystem)
				{
					forParameter_e.ScheduleTimeInitialize(componentSystem, isReadOnly: true);
					forParameter_duration.ScheduleTimeInitialize(componentSystem, isReadOnly: false);
					forParameter_instant.ScheduleTimeInitialize(componentSystem, isReadOnly: true);
				}
				...
				public Runtimes PrepareToExecuteOnEntitiesInMethod(ref ArchetypeChunk p0, int p1, int p2)
				{
					return new Runtimes
					{
						...
						runtime_instant = forParameter_instant.PrepareToExecuteOnEntitiesIn(ref p0)
					};
				}
			}

			public unsafe delegate void RunWithoutJobSystem_00000244_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000244_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000244_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000244_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, ref CTakesDuration duration, in CInstantlyCompleteDuration instant)
			{
				if (duration.Active)
				{
					duration.Remaining = -0.1f;
				}
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), ref runtimes.runtime_duration.For(i), runtimes.runtime_instant.For(i));
				}
			}
			...
			{
				RunWithoutJobSystem_00000244_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		private EntityQuery InstantDurations;
		...
		{
			InstantDurations = GetEntityQuery(typeof(CInstantlyCompleteDuration));
		}
		...
		protected override void OnUpdate()
		{
			...
			base.EntityManager.RemoveComponent<CInstantlyCompleteDuration>(InstantDurations);
		}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			entityQueryDesc.All = new ComponentType[2]
			{
				...
				ComponentType.ReadOnly<CInstantlyCompleteDuration>()
			};
			entityQueryDesc.None = new ComponentType[1] { ComponentType.ReadWrite<CPreventUse>() };
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_00000244_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_00000244_0024BurstDirectCall.Initialize();
		}
	}
}
