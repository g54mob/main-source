...
namespace Kitchen
{
	public class ChangeProviderAfterDuration : GameSystemBase
	{
		[NoAlias]
		[BurstCompile]
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public struct Runtimes
				{
					...
					[NoAlias]
					public LambdaParameterValueProvider_IComponentData<CChangeProviderAfterDuration>.Runtime runtime_change;
				}
				...
				[NoAlias]
				[ReadOnly]
				private LambdaParameterValueProvider_IComponentData<CChangeProviderAfterDuration> forParameter_change;

				public void ScheduleTimeInitialize(ChangeProviderAfterDuration componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_000001FD_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_000001FD_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_000001FD_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_000001FD_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), ref runtimes.runtime_provider.For(i), in runtimes.runtime_duration.For(i), in runtimes.runtime_change.For(i));
				}
			}
			...
			{
				RunWithoutJobSystem_000001FD_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			entityQueryDesc.All = new ComponentType[3]
			{
				...
				ComponentType.ReadOnly<CChangeProviderAfterDuration>()
			};
			entityQueryDesc.None = new ComponentType[1] { ComponentType.ReadWrite<CPreventUse>() };
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_000001FD_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_000001FD_0024BurstDirectCall.Initialize();
		}
	}
}
