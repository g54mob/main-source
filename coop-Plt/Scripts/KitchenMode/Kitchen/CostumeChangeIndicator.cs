...
namespace Kitchen
{
	public class CostumeChangeIndicator : ResponsiveObjectView<CostumeChangeIndicator.ViewData, CostumeChangeIndicator.ResponseData>, IInputConsumer
	{
		public class UpdateView : ResponsiveViewSystemBase<ViewData, ResponseData>
		{
			...
			private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
			{
				private struct LambdaParameterValueProviders
				{
					public struct Runtimes
					{
						...
						public LambdaParameterValueProvider_IComponentData<CCostumeChangeInfo>.Runtime runtime_info;
					...
					private LambdaParameterValueProvider_IComponentData<CCostumeChangeInfo> forParameter_info;
				...
				public void OriginalLambdaBody(Entity entity, int entityInQueryIndex, ref CCostumeChangeInfo info, [In] ref CLinkedView view)
				{
			...
			[CompilerGenerated]
			private void _003COnUpdate_003Eb__0_0(Entity entity, int entityInQueryIndex, ref CCostumeChangeInfo info, in CLinkedView view)
			{
			...
			public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
			{
				...
				(array[0] = new EntityQueryDesc()).All = new ComponentType[2]
				{
					...
					ComponentType.ReadWrite<CCostumeChangeInfo>()
				};
		...
		[SerializeField]
		private GridMenuConfig RootMenuConfig;
