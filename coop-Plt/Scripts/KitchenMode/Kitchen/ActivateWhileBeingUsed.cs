...
namespace Kitchen
{
	...
	public class ActivateWhileBeingUsed : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				public struct Runtimes
				{
					...
					public LambdaParameterValueProvider_IComponentData_Tag<CEffectWhileBeingUsed>.Runtime runtime_effect_condition;
				...
				[ReadOnly]
				private LambdaParameterValueProvider_IComponentData_Tag<CEffectWhileBeingUsed> forParameter_effect_condition;

				[ReadOnly]
				private LambdaParameterValueProvider_DynamicBuffer<CBeingActedOnBy> forParameter_actors;

				public void ScheduleTimeInitialize(ActivateWhileBeingUsed componentSystem)
				{
					forParameter_e.ScheduleTimeInitialize(componentSystem, isReadOnly: true);
					forParameter_effect.ScheduleTimeInitialize(componentSystem, isReadOnly: false);
					forParameter_effect_condition.ScheduleTimeInitialize(componentSystem, isReadOnly: true);
				...
				public Runtimes PrepareToExecuteOnEntitiesInMethod(ref ArchetypeChunk p0, int p1, int p2)
				{
					return new Runtimes
					{
						...
						runtime_effect_condition = forParameter_effect_condition.PrepareToExecuteOnEntitiesIn(ref p0),
			...
			internal void OriginalLambdaBody(Entity e, ref CAppliesEffect effect, in CEffectWhileBeingUsed effect_condition, in DynamicBuffer<CBeingActedOnBy> actors)
			{
			...
			public void IterateEntities(ref ArchetypeChunk chunk, ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), ref runtimes.runtime_effect.For(i), runtimes.runtime_effect_condition.For(i), runtimes.runtime_actors.For(i));
				}
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			(array[0] = new EntityQueryDesc()).All = new ComponentType[3]
			{
				...
				ComponentType.ReadOnly<CEffectWhileBeingUsed>(),
