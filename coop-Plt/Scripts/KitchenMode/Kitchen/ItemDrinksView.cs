...
{
	[Serializable]
	public class ItemDrinksView : UpdatableObjectView<ItemDrinksView.ViewData>
	{
		public class UpdateView : IncrementalViewSystemBase<ViewData>
		{
			...
			private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
			{
				private struct LambdaParameterValueProviders
				{
					public struct Runtimes
					{
						...
						public LambdaParameterValueProvider_IComponentData<CDrink>.Runtime runtime_drink;
					}
					...
					[ReadOnly]
					private LambdaParameterValueProvider_IComponentData<CDrink> forParameter_drink;
					...
					public void ScheduleTimeInitialize(UpdateView componentSystem)
					{
						...
						forParameter_drink.ScheduleTimeInitialize(componentSystem, isReadOnly: true);
					}
				...
				public void OriginalLambdaBody(Entity entity, int entityInQueryIndex, [In] ref CLinkedView linked_view, [In] ref CDrink drink)
				{
					hostInstance._003COnUpdate_003Eb__0_0(entity, entityInQueryIndex, in linked_view, in drink);
				}
				...
				public void IterateEntities(ref ArchetypeChunk chunk, ref LambdaParameterValueProviders.Runtimes runtimes)
				{
					...
					{
						OriginalLambdaBody(runtimes.runtime_entity.For(i), runtimes.runtime_entityInQueryIndex.For(i), ref runtimes.runtime_linked_view.For(i), ref runtimes.runtime_drink.For(i));
					}
				}
			...
			[CompilerGenerated]
			private void _003COnUpdate_003Eb__0_0(Entity entity, int entityInQueryIndex, in CLinkedView linked_view, in CDrink drink)
			{
		...
		public struct ViewData : ISpecificViewData, IViewData, IViewResponseData, IViewData.ICheckForChanges<ViewData>
		{
			...
			{
				return view.GetSubView<ItemDrinksView>();
			}
		}
		...
		protected override void UpdateData(ViewData view_data)
		{
			...
			{
				DrinkContainer.SetActive(value: true);
