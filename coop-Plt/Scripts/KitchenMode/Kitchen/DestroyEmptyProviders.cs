...
namespace Kitchen
{
	public class DestroyEmptyProviders : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass0_0
		{
			...
			internal void _003COnUpdate_003Eb__0(Entity e, ref CItemProvider provider)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(DestroyEmptyProviders componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_000001C1_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_000001C1_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_000001C1_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_000001C1_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				if (provider.DestroyOnEmpty && provider.Available == 0)
				{
					ecb.DestroyEntity(e);
				}
			}
			...
			public void ScheduleTimeInitialize(DestroyEmptyProviders componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_000001C1_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			(array[0] = new EntityQueryDesc()).All = new ComponentType[1] { ComponentType.ReadWrite<CItemProvider>() };
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_000001C1_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_000001C1_0024BurstDirectCall.Initialize();
		}
	}
}
