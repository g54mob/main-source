...
namespace Kitchen
{
	public class MoveProvidersIntoHolders : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(MoveProvidersIntoHolders componentSystem)
				{
			...
			{
				if (provider.AutoPlaceOnHolder && !(holder.HeldItem != default(Entity)) && (provider.Maximum <= 0 || provider.Available != 0))
				{
					Entity held_item = ctx.CreateItem(provider.ProvidedItem);
			...
			public void ScheduleTimeInitialize(MoveProvidersIntoHolders componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
