...
namespace Kitchen
{
	public class AutoPartnerView : UpdatableObjectView<AutoPartnerView.ViewData>
	{
		public class UpdateView : IncrementalViewSystemBase<ViewData>
		{
			...
			private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
			{
				...
				public void OriginalLambdaBody(Entity entity, int entityInQueryIndex, [In] ref CAutoPartner partner, [In] ref CLinkedView linked_view)
				{
					hostInstance._003COnUpdate_003Eb__0_0(entity, entityInQueryIndex, in partner, in linked_view);
				}
				...
				public void IterateEntities(ref ArchetypeChunk chunk, ref LambdaParameterValueProviders.Runtimes runtimes)
				{
					...
					{
						OriginalLambdaBody(runtimes.runtime_entity.For(i), runtimes.runtime_entityInQueryIndex.For(i), ref runtimes.runtime_partner.For(i), ref runtimes.runtime_linked_view.For(i));
					}
				}
			...
			[CompilerGenerated]
			private void _003COnUpdate_003Eb__0_0(Entity entity, int entityInQueryIndex, in CAutoPartner partner, in CLinkedView linked_view)
			{
		...
		public struct ViewData : ISpecificViewData, IViewData, IViewResponseData, IViewData.ICheckForChanges<ViewData>
		{
			...
			{
				return view.GetSubView<AutoPartnerView>();
			}
		}
