...
namespace Kitchen
{
	...
	public class DetermineSelf : GameEffectSystemBase
	{
		[BurstCompile]
		[NoAlias]
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(DetermineSelf componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_0000037B_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_0000037B_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_0000037B_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_0000037B_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				RunWithoutJobSystem_0000037B_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			entityQueryDesc.All = new ComponentType[1] { ComponentType.ReadWrite<CAffectedBy>() };
			entityQueryDesc.Any = new ComponentType[2]
			{
				ComponentType.ReadWrite<CEffectRangeSelf>(),
				ComponentType.ReadWrite<CEffectRangeTableSet>()
			};
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_0000037B_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_0000037B_0024BurstDirectCall.Initialize();
		}
	}
}
