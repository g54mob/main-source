...
{
	[Serializable]
	public class DishIndicatorView : UpdatableObjectView<DishIndicatorView.ViewData>
	{
		public class UpdateView : IncrementalViewSystemBase<ViewData>
		{
			...
			private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
			{
				private struct LambdaParameterValueProviders
				{
					public struct Runtimes
					{
						...
						public LambdaParameterValueProvider_IComponentData<CDishInfo>.Runtime runtime_info;
					}
					...
					[ReadOnly]
					private LambdaParameterValueProvider_IComponentData<CDishInfo> forParameter_info;
				...
				public void OriginalLambdaBody(Entity entity, int entityInQueryIndex, [In] ref CLinkedView linked_view, [In] ref CDishInfo info)
				{
					hostInstance._003COnUpdate_003Eb__0_0(entity, entityInQueryIndex, in linked_view, in info);
				}
				...
				public void IterateEntities(ref ArchetypeChunk chunk, ref LambdaParameterValueProviders.Runtimes runtimes)
				{
					...
					{
						OriginalLambdaBody(runtimes.runtime_entity.For(i), runtimes.runtime_entityInQueryIndex.For(i), ref runtimes.runtime_linked_view.For(i), ref runtimes.runtime_info.For(i));
					}
				}
			...
			[CompilerGenerated]
			private void _003COnUpdate_003Eb__0_0(Entity entity, int entityInQueryIndex, in CLinkedView linked_view, in CDishInfo info)
			{
			...
			public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
			{
				...
				(array[0] = new EntityQueryDesc()).All = new ComponentType[2]
				{
					...
					ComponentType.ReadOnly<CDishInfo>()
				};
		...
		[SerializeField]
		private TextMeshPro Difficulty;

		protected override void UpdateData(ViewData view_data)
		{
			if (GameData.Main.TryGet<Dish>(view_data.Dish, out var output))
			{
				Title.text = output.Name;
				Difficulty.text = GetInfoIconString("INFO_RECIPE_DIFFICULTY", "star", output.RecipeDifficulty());
			}
			else
			{
				Title.text = "?";
		...
		private string GetInfoIconString(string type, string icon, int count)
		{
			...
			stringBuilder.Append(" <cspace=0.2em>");
			for (int i = 0; i < 5; i++)
			{
				stringBuilder.Append("<sprite name=\"" + icon + "\" " + ((count <= i) ? "color=#000000" : "") + ">");
			}
			stringBuilder.Append("</cspace></nobr>");
