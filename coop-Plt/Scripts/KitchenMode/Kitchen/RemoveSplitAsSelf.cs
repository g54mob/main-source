...
namespace Kitchen
{
	public class RemoveSplitAsSelf : GameSystemBase
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass0_0
		{
			public RemoveSplitAsSelf _003C_003E4__this;

			public EntityCommandBuffer ecb;

			internal void _003COnUpdate_003Eb__0(Entity e, in CSplittableItem split, in CHeldBy holder)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(RemoveSplitAsSelf componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_00000DB8_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000DB8_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000DB8_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000DB8_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			[ReadOnly]
			[NoAlias]
			private ComponentDataFromEntity<CAutomatedInteractor> _ComponentDataFromEntity_CAutomatedInteractor_1;
			...
			internal void OriginalLambdaBody(Entity e, in CSplittableItem split, in CHeldBy holder)
			{
				if (split.SplitAsSelf && (_ComponentDataFromEntity_CPlayer_0.HasComponent(holder) || _ComponentDataFromEntity_CAutomatedInteractor_1.HasComponent(holder)))
				{
					ecb.RemoveComponent<CSplittableItem>(e);
				}
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), in runtimes.runtime_split.For(i), in runtimes.runtime_holder.For(i));
				}
			}

			public void ScheduleTimeInitialize(RemoveSplitAsSelf componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
				...
				_ComponentDataFromEntity_CAutomatedInteractor_1 = ((ComponentSystemBase)componentSystem).GetComponentDataFromEntity<CAutomatedInteractor>(true);
			}
			...
			{
				RunWithoutJobSystem_00000DB8_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_00000DB8_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_00000DB8_0024BurstDirectCall.Initialize();
		}
	}
}
