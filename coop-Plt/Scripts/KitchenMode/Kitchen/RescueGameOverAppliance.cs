...
namespace Kitchen
{
	public class RescueGameOverAppliance : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass0_0
		{
			...
			internal void _003COnUpdate_003Eb__0(Entity e, in CPreventGameOver prevent, in CPreventGameOverConsumed consumed)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public struct Runtimes
				{
					...
					[NoAlias]
					public LambdaParameterValueProvider_IComponentData_Tag<CPreventGameOver>.Runtime runtime_prevent;
				...
				[ReadOnly]
				[NoAlias]
				private LambdaParameterValueProvider_IComponentData_Tag<CPreventGameOver> forParameter_prevent;

				[NoAlias]
				[ReadOnly]
				private LambdaParameterValueProvider_IComponentData_Tag<CPreventGameOverConsumed> forParameter_consumed;

				public void ScheduleTimeInitialize(RescueGameOverAppliance componentSystem)
				{
					forParameter_e.ScheduleTimeInitialize(componentSystem, isReadOnly: true);
					forParameter_prevent.ScheduleTimeInitialize(componentSystem, isReadOnly: true);
				...
				public Runtimes PrepareToExecuteOnEntitiesInMethod(ref ArchetypeChunk p0, int p1, int p2)
				{
					return new Runtimes
					{
						...
						runtime_prevent = forParameter_prevent.PrepareToExecuteOnEntitiesIn(ref p0),
						runtime_consumed = forParameter_consumed.PrepareToExecuteOnEntitiesIn(ref p0)
					};
				}
			}

			public unsafe delegate void RunWithoutJobSystem_000004C5_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_000004C5_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_000004C5_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_000004C5_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, in CPreventGameOver prevent, in CPreventGameOverConsumed consumed)
			{
				ecb.RemoveComponent<CPreventGameOver>(e);
				ecb.AddComponent<CIsBroken>(e);
				ecb.AddComponent<CPermanentlyBroken>(e);
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), runtimes.runtime_prevent.For(i), runtimes.runtime_consumed.For(i));
				}
			}

			public void ScheduleTimeInitialize(RescueGameOverAppliance componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_000004C5_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			{
				ComponentType.ReadOnly<CPreventGameOver>(),
				ComponentType.ReadOnly<CPreventGameOverConsumed>()
			};
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_000004C5_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_000004C5_0024BurstDirectCall.Initialize();
		}
	}
}
