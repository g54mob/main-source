...
namespace Kitchen
{
	...
	public class PruneOnlyOrderSatisfaction : GenericSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(PruneOnlyOrderSatisfaction componentSystem)
				{
			...
			public PruneOnlyOrderSatisfaction hostInstance;
		...
		{
			if (accept.Status != ItemAcceptStatus.Pruned && (accept.Flags & TransferFlags.OrderSatisfaction) == 0 && Require<CItemTransferProposal>(accept.Proposal, out CItemTransferProposal comp) && (comp.Flags & TransferFlags.OnlyOrderSatisfaction) != TransferFlags.Null)
			{
