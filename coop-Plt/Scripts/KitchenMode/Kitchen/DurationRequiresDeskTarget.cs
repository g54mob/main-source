...
namespace Kitchen
{
	...
	public class DurationRequiresDeskTarget : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(DurationRequiresDeskTarget componentSystem)
				{
			...
			internal void OriginalLambdaBody(Entity e, ref CTakesDuration duration, in CDeskTarget target)
			{
				if (target.Target == default(Entity))
				{
			...
			public void IterateEntities(ref ArchetypeChunk chunk, ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), ref runtimes.runtime_duration.For(i), in runtimes.runtime_target.For(i));
				}
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			{
				ComponentType.ReadOnly<CDurationRequiresDeskTarget>(),
				ComponentType.ReadWrite<CTakesDuration>(),
				ComponentType.ReadOnly<CDeskTarget>()
			};
