...
namespace Kitchen
{
	public class ChangeProviderWhenEmpty : GameSystemBase
	{
		[NoAlias]
		[BurstCompile]
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public struct Runtimes
				{
					...
					[NoAlias]
					public LambdaParameterValueProvider_IComponentData<CChangeProviderWhenEmpty>.Runtime runtime_change;
				}
				...
				[NoAlias]
				[ReadOnly]
				private LambdaParameterValueProvider_IComponentData<CChangeProviderWhenEmpty> forParameter_change;

				public void ScheduleTimeInitialize(ChangeProviderWhenEmpty componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_000000FF_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_000000FF_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_000000FF_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_000000FF_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, ref CItemProvider provider, in CChangeProviderWhenEmpty change)
			{
				if (provider.Available == 0 && !provider.Matches(change.ReplaceItem))
				{
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), ref runtimes.runtime_provider.For(i), in runtimes.runtime_change.For(i));
				}
			}
			...
			{
				RunWithoutJobSystem_000000FF_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			(array[0] = new EntityQueryDesc()).All = new ComponentType[2]
			{
				...
				ComponentType.ReadOnly<CChangeProviderWhenEmpty>()
			};
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_000000FF_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_000000FF_0024BurstDirectCall.Initialize();
		}
	}
}
