...
namespace Kitchen
{
	public class UpdateDrinkRequest : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass1_0
		{
			...
			internal void _003COnUpdate_003Eb__0(Entity e, ref CWantsDrink drink, in DynamicBuffer<CGroupMember> group)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(UpdateDrinkRequest componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_00000AE2_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000AE2_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000AE2_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000AE2_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, ref CWantsDrink drink, in DynamicBuffer<CGroupMember> group)
			{
				if (drink.TimeToNextDrink > 0f)
				{
					drink.TimeToNextDrink -= dt * (float)group.Length;
				}
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), ref runtimes.runtime_drink.For(i), runtimes.runtime_group.For(i));
				}
			}

			public void ScheduleTimeInitialize(UpdateDrinkRequest componentSystem, ref _003C_003Ec__DisplayClass1_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_00000AE2_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_00000AE2_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_00000AE2_0024BurstDirectCall.Initialize();
		}
	}
}
