...
namespace Kitchen
{
	...
	[UpdateAfter(typeof(TileManager))]
	public class DestroyDoubleOccupations : GenericSystemBase
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass0_0
		{
			public DestroyDoubleOccupations _003C_003E4__this;
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(DestroyDoubleOccupations componentSystem)
				{
			...
			{
				if (_003C_003E4__this.TileManager.GetOccupant(pos.Position) != e)
				{
					ecb.DestroyEntity(e);
				}
			}
			...
			public void ScheduleTimeInitialize(DestroyDoubleOccupations componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			entityQueryDesc.None = new ComponentType[1] { ComponentType.ReadWrite<CDoesNotOccupy>() };
