...
{
	[Serializable]
	public class LimitedItemSourceView : UpdatableObjectView<LimitedItemSourceView.ViewData>
	{
		public class UpdateLimitedItemSourceView : BurstIncrementalViewSystemBase<ViewData>
		{
			...
			private struct _003C_003Ec__DisplayClass2_0
			{
				...
				internal void _003CPopulateNewViewUpdates_003Eb__1(Entity entity, int entityInQueryIndex, in CAppliance appliance, in CLinkedView linked_view, in CItemProvider provider)
				{
					LambdaForEachDescriptionConstructionMethods.ThrowCodeGenInvalidMethodCalledException();
				}
			}
			...
			private struct _003C_003Ec__DisplayClass_PopulateNewViewUpdates_LambdaJob0 : IJobChunk
			{
				private struct LambdaParameterValueProviders
				{
					...
					public void ScheduleTimeInitialize(UpdateLimitedItemSourceView componentSystem)
					{
				...
				public unsafe delegate void RunWithoutJobSystem_0000072E_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

				internal static class RunWithoutJobSystem_0000072E_0024BurstDirectCall
				{
					...
					private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
					{
						if (Pointer == (IntPtr)0)
						{
							Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_0000072E_0024PostfixBurstDelegate).TypeHandle);
						}
						P_0 = Pointer;
					}
					...
					static RunWithoutJobSystem_0000072E_0024BurstDirectCall()
					{
						Constructor();
					}
				...
				internal void OriginalLambdaBody(Entity entity, int entityInQueryIndex, in CAppliance appliance, in CLinkedView linked_view, in CItemProvider provider)
				{
					ViewData view_data = new ViewData
					{
						...
						DisplayedComponents = provider.ProvidedComponents,
				...
				public void ScheduleTimeInitialize(UpdateLimitedItemSourceView componentSystem, ref _003C_003Ec__DisplayClass2_0 displayClass)
				{
				...
				{
					RunWithoutJobSystem_0000072E_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
				}
			...
			private struct _003C_003Ec__DisplayClass_PopulateNewViewUpdates_LambdaJob1 : IJobChunk
			{
				...
				public unsafe delegate void RunWithoutJobSystem_00000737_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

				internal static class RunWithoutJobSystem_00000737_0024BurstDirectCall
				{
					private static IntPtr Pointer;
					...
					private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
					{
						if (Pointer == (IntPtr)0)
						{
							Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000737_0024PostfixBurstDelegate).TypeHandle);
						}
						P_0 = Pointer;
					}
					...
					static RunWithoutJobSystem_00000737_0024BurstDirectCall()
					{
						Constructor();
					}
				...
				public unsafe static void RunWithoutJobSystem(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData)
				{
					RunWithoutJobSystem_00000737_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
				}
			...
			public static EntityQuery _003C_003EGetEntityQuery_ForPopulateNewViewUpdates_LambdaJob0_From(ComponentSystemBase componentSystem)
			{
				...
				entityQueryDesc.All = new ComponentType[4]
				{
					...
					ComponentType.ReadOnly<CDynamicMenuProvider>(),
			...
			public static EntityQuery _003C_003EGetEntityQuery_ForPopulateNewViewUpdates_LambdaJob1_From(ComponentSystemBase componentSystem)
			{
				...
				{
					ComponentType.ReadWrite<CDynamicMenuProvider>(),
					ComponentType.ReadWrite<CHeldAppliance>()
				};
				return componentSystem.GetEntityQuery(array);
			}

			public static void Initialize_0024_003C_003Ec__DisplayClass_PopulateNewViewUpdates_LambdaJob0_RunWithoutJobSystem_0000072E_0024BurstDirectCall()
			{
				_003C_003Ec__DisplayClass_PopulateNewViewUpdates_LambdaJob0.RunWithoutJobSystem_0000072E_0024BurstDirectCall.Initialize();
			}

			public static void Initialize_0024_003C_003Ec__DisplayClass_PopulateNewViewUpdates_LambdaJob1_RunWithoutJobSystem_00000737_0024BurstDirectCall()
			{
				_003C_003Ec__DisplayClass_PopulateNewViewUpdates_LambdaJob1.RunWithoutJobSystem_00000737_0024BurstDirectCall.Initialize();
			}
		}
		...
		public struct ViewData : ISpecificViewData, IViewData, IViewResponseData, IViewData.ICheckForChanges<ViewData>
		{
			...
			[Key(1)]
			public ItemList DisplayedComponents;
			...
			{
				return view.GetSubView<LimitedItemSourceView>();
			}

			public bool IsChangedFrom(ViewData check)
			{
				if (DisplayedType == check.DisplayedType && DisplayedComponents.IsEquivalent(check.DisplayedComponents))
				{
		...
		private bool OnlyShowOne;

		[SerializeField]
		private bool FixedType;

		[Header("State")]
		private int DisplayedItems = -1;

		private ViewData Data;

		public void SetPrefab(GameObject prefab, int item_id, ItemList item_components)
		{
			for (int i = 0; i < Items.Count; i++)
			{
				GameObject gameObject = Items[i];
				GameObject gameObject2 = UnityEngine.Object.Instantiate(prefab, gameObject.transform.parent, worldPositionStays: true);
				...
				{
					component.PerformUpdate(item_id, item_components);
				}
				Items[i] = gameObject2;
		...
		public void SetAmount(int amount)
		{
			if (Empty != null)
			{
				Empty.SetActive(amount == 0);
			}
			if (amount != DisplayedItems)
			{
				for (int i = 0; i < Items.Count; i++)
				{
					Items[i].SetActive(OnlyShowOne ? (i == amount - 1) : (i < amount));
				}
			}
		}
		...
		protected override void UpdateData(ViewData data)
		{
			ViewData data2 = Data;
			Data = data;
			if (!FixedType && (Data.DisplayedType != data2.DisplayedType || !Data.DisplayedComponents.IsEquivalent(data2.DisplayedComponents)) && Data.DisplayedType != 0)
			{
				SetPrefab(GameData.Main.GetPrefab(Data.DisplayedType), Data.DisplayedType, Data.DisplayedComponents);
			}
