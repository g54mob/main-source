...
namespace Kitchen
{
	[UpdateInGroup(typeof(ActivateEffectsGroup), OrderLast = true)]
	public class DisableHeldEffects : GameSystemBase
	{
		[BurstCompile]
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(DisableHeldEffects componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_000002FB_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_000002FB_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_000002FB_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_000002FB_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, ref CAppliesEffect effect, in CHeldBy held_by)
			{
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), ref runtimes.runtime_effect.For(i), in runtimes.runtime_held_by.For(i));
				}
			}
			...
			{
				RunWithoutJobSystem_000002FB_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_000002FB_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_000002FB_0024BurstDirectCall.Initialize();
		}
	}
}
