...
namespace Kitchen
{
	...
	public class InstantProcessToolTidyInstantSplit : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(InstantProcessToolTidyInstantSplit componentSystem)
				{
			...
			public InstantProcessToolTidyInstantSplit hostInstance;
			...
			{
				hostInstance._003COnUpdate_003Eb__0_0(e);
			}

			public unsafe static void PerformLambda(void* jobStructPtr, void* runtimesPtr, Entity entity)
			{
				Entity e = UnsafeUtility.AsRef<LambdaParameterValueProviders.Runtimes>(runtimesPtr).runtime_e.For(entity);
				UnsafeUtility.AsRef<_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0>(jobStructPtr).OriginalLambdaBody(e);
			}
		...
		[CompilerGenerated]
		private void _003COnUpdate_003Eb__0_0(Entity e)
		{
			base.EntityManager.RemoveComponent<CInstantlyCompleteSplit>(e);
		}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			(array[0] = new EntityQueryDesc()).All = new ComponentType[1] { ComponentType.ReadOnly<CInstantlyCompleteSplit>() };
