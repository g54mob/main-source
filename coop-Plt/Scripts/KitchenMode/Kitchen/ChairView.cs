...
{
	[Serializable]
	public class ChairView : UpdatableObjectView<ChairView.ViewData>
	{
		public class UpdateView : IncrementalViewSystemBase<ViewData>
		{
			...
			private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
			{
				private struct LambdaParameterValueProviders
				{
					public struct Runtimes
					{
						...
						public LambdaParameterValueProvider_IComponentData<CApplianceChair>.Runtime runtime_chair;
					}
				...
				public void OriginalLambdaBody(Entity entity, int entityInQueryIndex, [In] ref CLinkedView linked_view, [In] ref CApplianceChair chair)
				{
			...
			[CompilerGenerated]
			private void _003COnUpdate_003Eb__0_0(Entity entity, int entityInQueryIndex, in CLinkedView linked_view, in CApplianceChair chair)
			{
		...
		public struct ViewData : ISpecificViewData, IViewData, IViewResponseData, IViewData.ICheckForChanges<ViewData>
		{
			...
			{
				return view.GetSubView<ChairView>();
			}

			public bool IsChangedFrom(ViewData check)
			{
				return InUse != check.InUse;
			}
		}
		...
		protected override void UpdateData(ViewData view_data)
		{
			...
			{
				Animator.SetBool(InUse, view_data.InUse);
			}
		}
	}
}
