...
namespace Kitchen
{
	public class SpreadFire : GameSystemBase
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass2_0
		{
			public SpreadFire _003C_003E4__this;
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(SpreadFire componentSystem)
				{
			...
			internal void OriginalLambdaBody(Entity e, in CPosition pos)
			{
				...
				{
					Vector3 vector = (Vector3)item + (Vector3)pos;
					Entity primaryOccupant = _003C_003E4__this.TileManager.GetPrimaryOccupant(vector);
					if (_003C_003E4__this.EntityManager.HasComponent<CAppliance>(primaryOccupant) && _003C_003E4__this.EntityManager.HasComponent<CIsInteractive>(primaryOccupant) && !_003C_003E4__this.EntityManager.HasComponent<CFireImmune>(primaryOccupant) && !_003C_003E4__this.EntityManager.HasComponent<CIsOnFire>(primaryOccupant) && _003C_003E4__this.TileManager.GetRoom(vector) == room)
					{
						double num = (_003C_003E4__this.EntityManager.HasComponent<CHighlyFlammable>(primaryOccupant) ? 0.1 : 0.02);
						if ((double)Random.value < num * (double)dt * (double)player_factor)
						{
							ecb.AddComponent<CIsOnFire>(primaryOccupant);
						}
					}
				}
			}
			...
			public void ScheduleTimeInitialize(SpreadFire componentSystem, ref _003C_003Ec__DisplayClass2_0 displayClass)
			{
		...
		protected override void OnUpdate()
		{
			...
			displayClass.player_factor = DifficultyHelpers.FireSpreadModifier(player_count);
			_ = base.Entities;
