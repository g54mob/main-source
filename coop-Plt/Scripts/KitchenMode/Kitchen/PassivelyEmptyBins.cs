...
namespace Kitchen
{
	public class PassivelyEmptyBins : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass0_0
		{
			...
			internal void _003COnUpdate_003Eb__0(Entity e, ref CApplianceBin bin)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(PassivelyEmptyBins componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_00000517_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000517_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000517_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000517_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				if (bin.SelfEmptyTime != 0f && bin.CurrentAmount > 0)
				{
					if (bin.NextEmptyTime == 0f)
					{
						bin.NextEmptyTime = time + bin.SelfEmptyTime;
					}
					else if (bin.NextEmptyTime < time)
					{
						bin.CurrentAmount--;
			...
			public void ScheduleTimeInitialize(PassivelyEmptyBins componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_00000517_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_00000517_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_00000517_0024BurstDirectCall.Initialize();
		}
	}
}
