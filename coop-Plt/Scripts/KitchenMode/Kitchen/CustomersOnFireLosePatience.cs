...
namespace Kitchen
{
	public class CustomersOnFireLosePatience : GameSystemBase
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass0_0
		{
			public CustomersOnFireLosePatience _003C_003E4__this;

			public float dt;

			internal void _003COnUpdate_003Eb__0(Entity e, in DynamicBuffer<CTablePlace> places, in DynamicBuffer<CTableSetParts> parts, in COccupiedByGroup group)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(CustomersOnFireLosePatience componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_00000B86_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000B86_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000B86_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000B86_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			[NoAlias]
			[ReadOnly]
			private ComponentDataFromEntity<CGroupGoingToTable> _ComponentDataFromEntity_CGroupGoingToTable_1;
			...
			internal void OriginalLambdaBody(Entity e, in DynamicBuffer<CTablePlace> places, in DynamicBuffer<CTableSetParts> parts, in COccupiedByGroup group)
			{
				if (!_ComponentDataFromEntity_CPatience_0.HasComponent(group) || _ComponentDataFromEntity_CGroupGoingToTable_1.HasComponent(group))
				{
					return;
				}
				CPatience value = _ComponentDataFromEntity_CPatience_0[group];
				for (int i = 0; i < places.Length; i++)
				{
					CTablePlace cTablePlace = places[i];
					if (_ComponentDataFromEntity_CIsOnFire_2.HasComponent(cTablePlace.Chair))
					{
						value.RemainingTime -= dt * 0.25f;
					}
				}
				for (int j = 0; j < parts.Length; j++)
				{
					CTableSetParts cTableSetParts = parts[j];
					if (_ComponentDataFromEntity_CIsOnFire_2.HasComponent(cTableSetParts))
					{
						value.RemainingTime -= dt * 0.25f;
					}
				}
				_ComponentDataFromEntity_CPatience_0[group] = value;
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), runtimes.runtime_places.For(i), runtimes.runtime_parts.For(i), in runtimes.runtime_group.For(i));
				}
			}

			public void ScheduleTimeInitialize(CustomersOnFireLosePatience componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
				_lambdaParameterValueProviders.ScheduleTimeInitialize(componentSystem);
				ReadFromDisplayClass(ref displayClass);
				_ComponentDataFromEntity_CPatience_0 = ((ComponentSystemBase)componentSystem).GetComponentDataFromEntity<CPatience>(false);
				_ComponentDataFromEntity_CGroupGoingToTable_1 = ((ComponentSystemBase)componentSystem).GetComponentDataFromEntity<CGroupGoingToTable>(true);
			...
			{
				RunWithoutJobSystem_00000B86_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_00000B86_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_00000B86_0024BurstDirectCall.Initialize();
		}
	}
}
