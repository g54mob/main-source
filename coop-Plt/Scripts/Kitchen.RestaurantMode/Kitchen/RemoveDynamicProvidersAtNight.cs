...
namespace Kitchen
{
	public class RemoveDynamicProvidersAtNight : NightSystem
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public struct Runtimes
				{
					...
					[NoAlias]
					public LambdaParameterValueProvider_IComponentData<CDynamicItemProvider>.Runtime runtime_dynamic_item_provider;
				}
				...
				[ReadOnly]
				[NoAlias]
				private LambdaParameterValueProvider_IComponentData<CDynamicItemProvider> forParameter_dynamic_item_provider;

				public void ScheduleTimeInitialize(RemoveDynamicProvidersAtNight componentSystem)
				{
					forParameter_e.ScheduleTimeInitialize(componentSystem, isReadOnly: true);
					forParameter_provider.ScheduleTimeInitialize(componentSystem, isReadOnly: false);
					forParameter_dynamic_item_provider.ScheduleTimeInitialize(componentSystem, isReadOnly: true);
				}
				...
				public Runtimes PrepareToExecuteOnEntitiesInMethod(ref ArchetypeChunk p0, int p1, int p2)
				{
					return new Runtimes
					{
						...
						runtime_dynamic_item_provider = forParameter_dynamic_item_provider.PrepareToExecuteOnEntitiesIn(ref p0)
					};
				}
			}

			public unsafe delegate void RunWithoutJobSystem_00000136_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000136_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000136_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000136_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, ref CItemProvider provider, in CDynamicItemProvider dynamic_item_provider)
			{
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), ref runtimes.runtime_provider.For(i), in runtimes.runtime_dynamic_item_provider.For(i));
				}
			}
			...
			{
				RunWithoutJobSystem_00000136_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			entityQueryDesc.All = new ComponentType[2]
			{
				...
				ComponentType.ReadOnly<CDynamicItemProvider>()
			};
			entityQueryDesc.None = new ComponentType[1] { ComponentType.ReadWrite<CPreservesContentsOvernight>() };
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_00000136_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_00000136_0024BurstDirectCall.Initialize();
		}
	}
}
