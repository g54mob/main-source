...
namespace Kitchen
{
	public class PlayersStartWearingSlippers : StartOfDaySystem
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(PlayersStartWearingSlippers componentSystem)
				{
			...
			{
				cosmetics.Shoe = PlayerShoe.Slippers;
			}
		...
		{
			if (!HasStatus(RestaurantStatus.HalloweenTrickAllPlayersWearSlippers))
			{
				return;
			}
			_ = base.Entities;
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			(array[0] = new EntityQueryDesc()).All = new ComponentType[1] { ComponentType.ReadWrite<CPlayerCosmetics>() };
