...
namespace Kitchen
{
	public class PreventDurationByCost : RestaurantSystem
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass0_0
		{
			public PreventDurationByCost _003C_003E4__this;
			...
			internal void _003COnUpdate_003Eb__0(Entity e, in CRerollShopAfterDuration request)
			{
				LambdaForEachDescriptionConstructionMethods.ThrowCodeGenInvalidMethodCalledException();
			}

			internal void _003COnUpdate_003Eb__1(Entity e, in CForSale sale)
			{
				LambdaForEachDescriptionConstructionMethods.ThrowCodeGenInvalidMethodCalledException();
			}
		}
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public struct Runtimes
				{
					...
					[NoAlias]
					public LambdaParameterValueProvider_IComponentData_Tag<CRerollShopAfterDuration>.Runtime runtime_request;
				}
				...
				[NoAlias]
				[ReadOnly]
				private LambdaParameterValueProvider_IComponentData_Tag<CRerollShopAfterDuration> forParameter_request;

				public void ScheduleTimeInitialize(PreventDurationByCost componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_00000511_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000511_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000511_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000511_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, in CRerollShopAfterDuration request)
			{
				bool flag = _ComponentDataFromEntity_CIsInactive_0.HasComponent(e);
				if (cost <= (int)player_money)
				{
					if (flag)
					{
						ecb.RemoveComponent<CIsInactive>(e);
					}
				}
				else if (!flag)
				{
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), runtimes.runtime_request.For(i));
				}
			}

			public void ScheduleTimeInitialize(PreventDurationByCost componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_00000511_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob1 : IJobChunk
		{
			...
			public unsafe delegate void RunWithoutJobSystem_0000051A_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_0000051A_0024BurstDirectCall
			{
				private static IntPtr Pointer;
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_0000051A_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_0000051A_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			internal void OriginalLambdaBody(Entity e, in CForSale sale)
			{
				bool flag = _ComponentDataFromEntity_CIsInactive_0.HasComponent(e);
				if (sale.Price <= (int)player_money)
				{
					if (flag)
					{
						ecb.RemoveComponent<CIsInactive>(e);
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				for (int i = 0; i < count; i++)
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), in runtimes.runtime_sale.For(i));
				}
			}
			...
			public unsafe static void RunWithoutJobSystem(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData)
			{
				RunWithoutJobSystem_0000051A_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		[ReadOnly]
		private EntityQuery _SingletonEntityQuery_SMoney_52;
		...
		protected override void OnUpdate()
		{
			_003C_003Ec__DisplayClass0_0 displayClass = new _003C_003Ec__DisplayClass0_0
			{
				...
				player_money = _SingletonEntityQuery_SMoney_52.GetSingleton<SMoney>(),
		...
		protected internal unsafe override void OnCreateForCompiler()
		{
			...
			_SingletonEntityQuery_SMoney_52 = GetEntityQuery(ComponentType.ReadOnly<SMoney>());
		}

		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			EntityQueryDesc[] array = new EntityQueryDesc[1];
			(array[0] = new EntityQueryDesc()).All = new ComponentType[1] { ComponentType.ReadOnly<CRerollShopAfterDuration>() };
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_00000511_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_00000511_0024BurstDirectCall.Initialize();
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob1_RunWithoutJobSystem_0000051A_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob1.RunWithoutJobSystem_0000051A_0024BurstDirectCall.Initialize();
		}
	}
}
