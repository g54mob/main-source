...
namespace Kitchen
{
	public class ManagePlayerCanPickUp : RestaurantSystem
	{
		...
		private struct _003C_003Ec__DisplayClass0_0
		{
			...
			internal void _003COnUpdate_003Eb__0(Entity e, ref CIsInteractor interactor)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(ManagePlayerCanPickUp componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_00000095_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000095_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000095_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000095_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, ref CIsInteractor interactor)
			{
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), ref runtimes.runtime_interactor.For(i));
				}
			}

			public void ScheduleTimeInitialize(ManagePlayerCanPickUp componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_00000095_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		protected override void OnUpdate()
		{
			...
			{
				displayClass.mode = InteractionMode.Items;
			}
			if (HasSingleton<SIsNightTime>())
			{
				displayClass.mode = InteractionMode.Appliances;
			}
			_ = base.Entities;
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			(array[0] = new EntityQueryDesc()).All = new ComponentType[1] { ComponentType.ReadWrite<CIsInteractor>() };
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_00000095_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_00000095_0024BurstDirectCall.Initialize();
		}
	}
}
