...
namespace Kitchen
{
	public class MarkOutsideAppliancesForDestruction : NightSystem
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass0_0
		{
			public MarkOutsideAppliancesForDestruction _003C_003E4__this;

			public EntityCommandBuffer ecb;

			internal void _003COnUpdate_003Eb__0(Entity e, in CAppliance appliance, in CPosition pos)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(MarkOutsideAppliancesForDestruction componentSystem)
				{
			...
			internal void OriginalLambdaBody(Entity e, in CAppliance appliance, in CPosition pos)
			{
				if (LayoutHelpers.IsOutsidePlayable(_003C_003E4__this.TileManager.GetTile(pos).Type))
				{
					ecb.AddComponent<CDestroyApplianceAtDay>(e);
				}
				else
				{
					ecb.RemoveComponent<CDestroyApplianceAtDay>(e);
				}
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), in runtimes.runtime_appliance.For(i), in runtimes.runtime_pos.For(i));
				}
			}

			public void ScheduleTimeInitialize(MarkOutsideAppliancesForDestruction componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			entityQueryDesc.None = new ComponentType[5]
			{
				ComponentType.ReadWrite<COutsideOnly>(),
				ComponentType.ReadWrite<CImmovable>(),
				ComponentType.ReadWrite<CUnsellableAppliance>(),
				ComponentType.ReadWrite<CHeldAppliance>(),
				ComponentType.ReadWrite<CForSale>()
			};
