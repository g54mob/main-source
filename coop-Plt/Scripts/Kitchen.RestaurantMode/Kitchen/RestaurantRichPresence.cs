...
namespace Kitchen
{
	[UpdateInGroup(typeof(RichPresenceGroup))]
	public class RestaurantRichPresence : RestaurantSystem
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(RestaurantRichPresence componentSystem)
				{
			...
			public void ScheduleTimeInitialize(RestaurantRichPresence componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
		...
		protected override void OnUpdate()
		{
			...
			{
				day = GetOrDefault<SDay>().Day + (Has<SIsNightTime>() ? 1 : 0)
			};
			_ = base.Entities;
