...
namespace Kitchen
{
	...
	public class LockRerollsWithoutBlueprints : GameSystemBase
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass4_0
		{
			public bool has_blueprints;
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(LockRerollsWithoutBlueprints componentSystem)
				{
			...
			public void ScheduleTimeInitialize(LockRerollsWithoutBlueprints componentSystem, ref _003C_003Ec__DisplayClass4_0 displayClass)
			{
		...
		private EntityQuery VisibleRerolls;

		private EntityQuery HiddenRerolls;
		...
		{
			base.Initialise();
			Blueprints = GetEntityQuery(typeof(CApplianceBlueprint));
			VisibleRerolls = GetEntityQuery(new QueryHelper().All(typeof(CRerollShopAfterDuration)).None(typeof(CHideView)));
			HiddenRerolls = GetEntityQuery(new QueryHelper().All(typeof(CRerollShopAfterDuration), typeof(CHideView)));
		}
		...
		protected override void OnUpdate()
		{
			...
			{
				has_blueprints = !Blueprints.IsEmpty
			};
			_ = base.Entities;
			...
			if (displayClass.has_blueprints)
			{
				base.EntityManager.RemoveComponent<CHideView>(HiddenRerolls);
			}
			else
			{
				base.EntityManager.AddComponent<CHideView>(VisibleRerolls);
			}
		}
