...
namespace Kitchen
{
	public class RerollShopAfterDuration : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass1_0
		{
			...
			internal void _003COnUpdate_003Eb__0(Entity e, ref CRerollShopAfterDuration change, ref CTakesDuration duration)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public struct Runtimes
				{
					...
					[NoAlias]
					public LambdaParameterValueProvider_IComponentData_Tag<CRerollShopAfterDuration>.Runtime runtime_change;
				...
				[NoAlias]
				private LambdaParameterValueProvider_IComponentData_Tag<CRerollShopAfterDuration> forParameter_change;

				[NoAlias]
				private LambdaParameterValueProvider_IComponentData<CTakesDuration> forParameter_duration;

				public void ScheduleTimeInitialize(RerollShopAfterDuration componentSystem)
				{
					forParameter_e.ScheduleTimeInitialize(componentSystem, isReadOnly: true);
					forParameter_change.ScheduleTimeInitialize(componentSystem, isReadOnly: false);
			...
			public unsafe delegate void RunWithoutJobSystem_0000054E_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_0000054E_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_0000054E_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_0000054E_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, ref CRerollShopAfterDuration change, ref CTakesDuration duration)
			{
				if (duration.Active && money >= cost && duration.Remaining <= 0f)
				{
					money -= cost;
					cost = DifficultyHelpers.IncreasedRerollCost(cost);
					reroll = true;
				}
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				for (int i = 0; i < count; i++)
				{
					...
					CRerollShopAfterDuration change = runtimes.runtime_change.For(i);
					OriginalLambdaBody(e, ref change, ref runtimes.runtime_duration.For(i));
				}
			}

			public void ScheduleTimeInitialize(RerollShopAfterDuration componentSystem, ref _003C_003Ec__DisplayClass1_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_0000054E_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		protected override void OnUpdate()
		{
			...
			if (displayClass.reroll)
			{
				Set(new SMoney
				{
					Amount = displayClass.money
				});
				Set(new SRerollCost
				{
					Cost = displayClass.cost
				});
				base.EntityManager.CreateEntity(typeof(CShopRerollRequest));
			}
		}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			{
				ComponentType.ReadWrite<CRerollShopAfterDuration>(),
				ComponentType.ReadWrite<CTakesDuration>()
			};
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_0000054E_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_0000054E_0024BurstDirectCall.Initialize();
		}
	}
}
