...
namespace Kitchen
{
	[UpdateBefore(typeof(AssignMenuRequests))]
	public class AssignTwitchMenuRequests : GameSystemBase
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass2_0
		{
			public AssignTwitchMenuRequests _003C_003E4__this;
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(AssignTwitchMenuRequests componentSystem)
				{
			...
			{
				if (_003C_003E4__this.TwitchNameList.GetOrder(e, out var order))
				{
					if (_003C_003E4__this.Has<CManualOrder>(e))
					{
						ecb.SetComponent(e, order);
					}
					else
					{
						ecb.AddComponent(e, order);
					}
				}
			}
			...
			public void ScheduleTimeInitialize(AssignTwitchMenuRequests componentSystem, ref _003C_003Ec__DisplayClass2_0 displayClass)
			{
		...
		protected override void OnUpdate()
		{
			...
			if (TwitchNameList != null && !Has<CSpeedrun>())
			{
