...
namespace Kitchen
{
	public class EnforcePlayerBounds : RestaurantSystem
	{
		public struct CRoomMarker : IComponentData
		{
			public int RoomID;
		}
		...
		private struct _003C_003Ec__DisplayClass3_0
		{
			...
			public EnforcePlayerBounds _003C_003E4__this;

			public NativeArray<CRoomMarker> oob_rooms;
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(EnforcePlayerBounds componentSystem)
				{
			...
			{
				bool flag = !bounds.Contains(pos.Position);
				if (!flag)
				{
					CLayoutRoomTile tile = _003C_003E4__this.TileManager.GetTile(pos);
					foreach (CRoomMarker oob_room in oob_rooms)
					{
			...
			public void ReadFromDisplayClass(ref _003C_003Ec__DisplayClass3_0 displayClass)
			{
				...
				oob_rooms = displayClass.oob_rooms;
			...
			public void WriteToDisplayClass(ref _003C_003Ec__DisplayClass3_0 displayClass)
			{
				...
				displayClass.oob_rooms = oob_rooms;
			...
			public void ScheduleTimeInitialize(EnforcePlayerBounds componentSystem, ref _003C_003Ec__DisplayClass3_0 displayClass)
			{
		...
		private EntityQuery OutOfBoundsRooms;
		...
		{
			base.Initialise();
			OutOfBoundsRooms = GetEntityQuery(typeof(CRoomMarker));
		}
		...
		protected override void OnUpdate()
		{
			_003C_003Ec__DisplayClass3_0 displayClass = new _003C_003Ec__DisplayClass3_0
			{
				...
				oob_rooms = OutOfBoundsRooms.ToComponentDataArray<CRoomMarker>(Allocator.TempJob)
			};
			try
			{
				displayClass.bounds.Encapsulate(displayClass.front_door + new Vector3(0f, 0f, -2f));
			...
			{
				((IDisposable)displayClass.oob_rooms/*cast due to .constrained prefix*/).Dispose();
			}
		}
