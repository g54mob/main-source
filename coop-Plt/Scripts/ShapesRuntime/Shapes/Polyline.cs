...
namespace Shapes
{
	...
	public class Polyline : ShapeRenderer
	{
		...
		protected override Material[] GetMaterials()
		{
			...
			{
				return new Material[1] { ShapesMaterialUtils.GetPolylineMat(joins)[base.BlendMode] };
			}
			return new Material[2]
			{
				ShapesMaterialUtils.GetPolylineMat(joins)[base.BlendMode],
				ShapesMaterialUtils.GetPolylineJoinsMat(joins)[base.BlendMode]
			};
		}
		...
		protected override Bounds GetBounds()
		{
			...
			return new Bounds((vector2 + vector) * 0.5f, vector2 - vector + Vector3.one * (thickness * 0.5f));
		}
	}
}
