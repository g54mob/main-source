...
namespace Shapes
{
	...
	public class Disc : ShapeRenderer
	{
		...
		[SerializeField]
		private float angRadiansEnd = (float)Math.PI * 3f / 4f;
		...
		{
			return new Material[1] { ShapesMaterialUtils.GetDiscMaterial(type)[base.BlendMode] };
		}
		...
		protected override Bounds GetBounds()
		{
			...
			float num2 = (HasThickness ? (radius + num) : radius) * 2f;
