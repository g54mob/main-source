...
namespace Kitchen
{
	...
	public class DespawnCustomerGroupsTutorial : TutorialSystem
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass0_0
		{
			public DespawnCustomerGroupsTutorial _003C_003E4__this;

			public Bounds bounds;

			public EntityCommandBuffer ecb;

			internal void _003COnUpdate_003Eb__0(Entity e, in DynamicBuffer<CGroupMember> group, in CGroupLeaving leaving)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(DespawnCustomerGroupsTutorial componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_0000002B_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_0000002B_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_0000002B_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_0000002B_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, in DynamicBuffer<CGroupMember> group, in CGroupLeaving leaving)
			{
				for (int i = 0; i < group.Length; i++)
				{
					CGroupMember cGroupMember = group[i];
					CPosition cPosition = _ComponentDataFromEntity_CPosition_0[cGroupMember];
					if (bounds.Contains(cPosition))
					{
						return;
					}
				}
				...
				{
					CGroupMember cGroupMember2 = group[j];
					ecb.DestroyEntity(cGroupMember2);
				}
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), runtimes.runtime_group.For(i), runtimes.runtime_leaving.For(i));
				}
			}

			public void ScheduleTimeInitialize(DespawnCustomerGroupsTutorial componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_0000002B_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		protected override void OnUpdate()
		{
			_003C_003Ec__DisplayClass0_0 displayClass = new _003C_003Ec__DisplayClass0_0
			{
				...
				ecb = GetCommandBuffer(ECB.DestructionGroup),
				bounds = new Bounds(Vector3.zero, new Vector3(20f, 10f, 20f))
			};
			_ = base.Entities;
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_0000002B_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_0000002B_0024BurstDirectCall.Initialize();
		}
	}
}
