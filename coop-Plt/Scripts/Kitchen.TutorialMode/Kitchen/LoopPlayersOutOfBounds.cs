...
namespace Kitchen
{
	public class LoopPlayersOutOfBounds : TutorialSystem
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(LoopPlayersOutOfBounds componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_0000003A_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_0000003A_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_0000003A_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_0000003A_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			{
				if (!bounds.Contains(pos) && !pos.ForceSnap)
				{
			...
			public void ScheduleTimeInitialize(LoopPlayersOutOfBounds componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_0000003A_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		protected override void OnUpdate()
		{
			...
			displayClass.bounds.Expand(new Vector3(3f, 0f, 2f));
			displayClass.bounds.Encapsulate(new Vector3(0f, 0f, displayClass.bounds.max.z + 3f));
			_ = base.Entities;
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_0000003A_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_0000003A_0024BurstDirectCall.Initialize();
		}
	}
}
