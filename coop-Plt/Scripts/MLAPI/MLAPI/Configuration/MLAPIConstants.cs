namespace MLAPI.Configuration
{
	internal static class MLAPIConstants
	{
		...
		{
			"MLAPI_CERTIFICATE_HAIL", "MLAPI_CERTIFICATE_HAIL_RESPONSE", "MLAPI_GREETINGS", "MLAPI_CONNECTION_REQUEST", "MLAPI_CONNECTION_APPROVED", "MLAPI_ADD_OBJECT", "MLAPI_DESTROY_OBJECT", "MLAPI_SWITCH_SCENE", "MLAPI_CLIENT_SWITCH_SCENE_COMPLETED", "MLAPI_CHANGE_OWNER",
			"MLAPI_ADD_OBJECTS", "MLAPI_TIME_SYNC", "MLAPI_NETWORKED_VAR_DELTA", "MLAPI_NETWORKED_VAR_UPDATE", "MLAPI_SERVER_RPC", "MLAPI_SERVER_RPC_REQUEST", "MLAPI_SERVER_RPC_RESPONSE", "MLAPI_CLIENT_RPC", "MLAPI_CLIENT_RPC_REQUEST", "MLAPI_CLIENT_RPC_RESPONSE",
			"MLAPI_UNNAMED_MESSAGE", "MLAPI_DESTROY_OBJECTS", "MLAPI_NAMED_MESSAGE", "MLAPI_SYNCED_VAR", "MLAPI_SERVER_LOG", "", "", "", "", "",
			"", "", "INVALID"
		};
	}
}
