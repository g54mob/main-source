...
{
	[Serializable]
	public class DishChoiceView : UpdatableObjectView<DishChoiceView.ViewData>
	{
		public class UpdateView : IncrementalViewSystemBase<ViewData>
		{
			...
			private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
			{
				private struct LambdaParameterValueProviders
				{
					public struct Runtimes
					{
						...
						public LambdaParameterValueProvider_IComponentData<CDishChoice>.Runtime runtime_choice;
					}
					...
					[ReadOnly]
					private LambdaParameterValueProvider_IComponentData<CDishChoice> forParameter_choice;
				...
				public void OriginalLambdaBody(Entity entity, int entityInQueryIndex, [In] ref CLinkedView linked, [In] ref CDishChoice choice)
				{
			...
			[CompilerGenerated]
			private void _003COnUpdate_003Eb__0_0(Entity entity, int entityInQueryIndex, in CLinkedView linked, in CDishChoice choice)
			{
			...
			public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
			{
				...
				(array[0] = new EntityQueryDesc()).All = new ComponentType[2]
				{
					...
					ComponentType.ReadOnly<CDishChoice>()
				};
		...
		public struct ViewData : ISpecificViewData, IViewData, IViewResponseData, IViewData.ICheckForChanges<ViewData>
		{
			...
			{
				return view.GetSubView<DishChoiceView>();
			}
		...
		protected override void UpdateData(ViewData data)
		{
			_ = Data;
			Data = data;
			if (data.Dish != 0 && GameData.Main.TryGet<Dish>(data.Dish, out var output, warn_if_fail: true))
			{
				if (Label != null)
				{
					Label.text = output.Name;
				}
				if (Renderer != null && output.IconPrefab != null)
				{
					RegisterDisposable(Renderer.material).SetTexture(Image, PrefabSnapshot.GetSnapshot(output.IconPrefab));
				}
			}
		}
	}
