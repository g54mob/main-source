...
namespace Kitchen
{
	public class ReturnOrphanedHeldAppliances : GameSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0
		{
			private struct LambdaParameterValueProviders
			{
				public struct Runtimes
				{
					...
					public LambdaParameterValueProvider_IComponentData_Tag<CHeldAppliance>.StructuralChangeRuntime runtime_held;
				...
				[ReadOnly]
				private LambdaParameterValueProvider_IComponentData_Tag<CHeldAppliance> forParameter_held;

				[ReadOnly]
				private LambdaParameterValueProvider_IComponentData<CHeldBy> forParameter_holder;

				public void ScheduleTimeInitialize(ReturnOrphanedHeldAppliances componentSystem)
				{
				...
				public Runtimes PrepareToExecuteWithStructuralChanges(ComponentSystemBase p0, EntityQuery p1)
				{
					...
					result.runtime_held = forParameter_held.PrepareToExecuteWithStructuralChanges(p0, p1);
					result.runtime_holder = forParameter_holder.PrepareToExecuteWithStructuralChanges(p0, p1);
					return result;
				}
			}

			public ReturnOrphanedHeldAppliances hostInstance;
			...
			public void OriginalLambdaBody(Entity e, [In] ref CHeldAppliance held, [In] ref CHeldBy holder)
			{
				hostInstance._003COnUpdate_003Eb__0_0(e, in held, in holder);
			}
			...
			public unsafe static void PerformLambda(void* jobStructPtr, void* runtimesPtr, Entity entity)
			{
				...
				CHeldAppliance originalComponent;
				CHeldAppliance held = reference.runtime_held.For(entity, out originalComponent);
				CHeldBy originalComponent2;
				CHeldBy holder = reference.runtime_holder.For(entity, out originalComponent2);
				UnsafeUtility.AsRef<_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0>(jobStructPtr).OriginalLambdaBody(e, ref held, ref holder);
			}
		...
		[CompilerGenerated]
		private void _003COnUpdate_003Eb__0_0(Entity e, in CHeldAppliance held, in CHeldBy holder)
		{
			if (!Has<CItemHolder>(holder))
			{
				base.EntityManager.AddComponent<CReturnItem>(e);
			}
		}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			entityQueryDesc.None = new ComponentType[1] { ComponentType.ReadWrite<CReturnItem>() };
