...
namespace Kitchen
{
	public class DestroyDuplicatedCrates : FranchiseSystem
	{
		[StructLayout(LayoutKind.Auto)]
		[CompilerGenerated]
		private struct _003C_003Ec__DisplayClass1_0
		{
			public DestroyDuplicatedCrates _003C_003E4__this;

			public EntityCommandBuffer ecb;

			internal void _003COnUpdate_003Eb__0(Entity e, in CCrateAppliance appliance, in CPosition pos)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(DestroyDuplicatedCrates componentSystem)
				{
			...
			internal void OriginalLambdaBody(Entity e, in CCrateAppliance appliance, in CPosition pos)
			{
				if (_003C_003E4__this.Positions.Contains(pos))
				{
					ecb.DestroyEntity(e);
				}
				else
				{
					_003C_003E4__this.Positions.Add(pos);
				}
			}
			...
			public void ScheduleTimeInitialize(DestroyDuplicatedCrates componentSystem, ref _003C_003Ec__DisplayClass1_0 displayClass)
			{
		...
		private HashSet<CPosition> Positions = new HashSet<CPosition>();
