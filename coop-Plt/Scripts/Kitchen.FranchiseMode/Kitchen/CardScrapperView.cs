...
{
	[Serializable]
	public class CardScrapperView : UpdatableObjectView<CardScrapperView.ViewData>
	{
		public class UpdateView : IncrementalViewSystemBase<ViewData>
		{
			...
			private struct _003C_003Ec__DisplayClass0_0
			{
				...
				internal void _003COnUpdate_003Eb__0(Entity entity, int entityInQueryIndex, in CLinkedView linked_view, in CFranchiseScrapper scrap)
				{
			...
			private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
			{
				...
				internal void OriginalLambdaBody(Entity entity, int entityInQueryIndex, in CLinkedView linked_view, in CFranchiseScrapper scrap)
				{
					_003C_003E4__this.SendUpdate(linked_view, new ViewData
					{
						FranchiseExpValue = value,
				...
				public void IterateEntities(ref ArchetypeChunk chunk, ref LambdaParameterValueProviders.Runtimes runtimes)
				{
					...
					{
						OriginalLambdaBody(runtimes.runtime_entity.For(i), runtimes.runtime_entityInQueryIndex.For(i), in runtimes.runtime_linked_view.For(i), runtimes.runtime_scrap.For(i));
					}
				}
			...
			protected override void OnUpdate()
			{
				...
				displayClass.value = 0;
				if (Require<CFranchiseItem>(orCreate.SelectedFranchise, out CFranchiseItem comp))
				{
					foreach (int card in comp.Cards)
					{
						displayClass.value += (int)(base.Data.TryGet<ICard>(card, out var output, warn_if_fail: true) ? output.ExpReward : Unlock.RewardLevel.None);
					}
				}
				_ = base.Entities;
		...
		public struct ViewData : ISpecificViewData, IViewData, IViewResponseData, IViewData.ICheckForChanges<ViewData>
		{
			...
			[Key(1)]
			public int FranchiseExpValue;

			public IUpdatableObject GetRelevantSubview(IObjectView view)
			{
				return view.GetSubView<CardScrapperView>();
			}

			public bool IsChangedFrom(ViewData check)
			{
				if (FranchiseExpValue == check.FranchiseExpValue)
				{
		...
		protected override void UpdateData(ViewData data)
		{
			...
			{
				Label.text = base.Localisation["SCRAP_FOR_XP", new object[1] { data.FranchiseExpValue }];
			}
		}
	}
}
