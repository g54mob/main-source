...
{
	[Serializable]
	public class SeedInfoView : UpdatableObjectView<SeedInfoView.ViewData>
	{
		public class UpdateView : IncrementalViewSystemBase<ViewData>
		{
			...
			private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
			{
				private struct LambdaParameterValueProviders
				{
					public struct Runtimes
					{
						...
						public LambdaParameterValueProvider_IComponentData<CSeededRunInfo>.Runtime runtime_info;
					}
					...
					[ReadOnly]
					private LambdaParameterValueProvider_IComponentData<CSeededRunInfo> forParameter_info;
				...
				public void OriginalLambdaBody(Entity entity, int entityInQueryIndex, [In] ref CLinkedView view, [In] ref CSeededRunInfo info)
				{
			...
			[CompilerGenerated]
			private void _003COnUpdate_003Eb__0_0(Entity entity, int entityInQueryIndex, in CLinkedView view, in CSeededRunInfo info)
			{
				SendUpdate(view.Identifier, new ViewData
				{
					IsSeedOverride = info.IsSeedOverride,
					IsFunctionMode = Has<CShowFunctionMode>(entity)
			...
			public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
			{
				...
				(array[0] = new EntityQueryDesc()).All = new ComponentType[2]
				{
					...
					ComponentType.ReadOnly<CSeededRunInfo>()
				};
		...
		public struct ViewData : ISpecificViewData, IViewData, IViewResponseData, IViewData.ICheckForChanges<ViewData>
		{
			...
			[Key(1)]
			public bool IsFunctionMode;

			public IUpdatableObject GetRelevantSubview(IObjectView view)
			{
				return view.GetSubView<SeedInfoView>();
			}

			public bool IsChangedFrom(ViewData check)
			{
				if (IsSeedOverride == check.IsSeedOverride)
				{
					return IsFunctionMode != check.IsFunctionMode;
				}
				return true;
			}
		}
		...
		[SerializeField]
		private GameObject FunctionMode;

		protected override void UpdateData(ViewData data)
		{
			if (Flower != null)
			{
				Flower.SetActive(data.IsSeedOverride);
			}
			if (FunctionMode != null)
			{
				FunctionMode.SetActive(data.IsFunctionMode);
			}
		}
	}
}
