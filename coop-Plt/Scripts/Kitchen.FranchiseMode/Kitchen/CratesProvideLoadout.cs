...
namespace Kitchen
{
	public class CratesProvideLoadout : FranchiseSystem
	{
		...
		private struct _003C_003Ec__DisplayClass0_0
		{
			...
			internal void _003COnUpdate_003Eb__0(Entity e, in CCrateAppliance upgrade)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public struct Runtimes
				{
					...
					[NoAlias]
					public LambdaParameterValueProvider_IComponentData<CCrateAppliance>.Runtime runtime_upgrade;
				}
				...
				[NoAlias]
				[ReadOnly]
				private LambdaParameterValueProvider_IComponentData<CCrateAppliance> forParameter_upgrade;

				public void ScheduleTimeInitialize(CratesProvideLoadout componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_00000085_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000085_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000085_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000085_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, in CCrateAppliance upgrade)
			{
				ecb.AddComponent(e, new CProvidesLoadoutItem
				{
					ID = upgrade.Appliance
				});
			}
			...
			public void ScheduleTimeInitialize(CratesProvideLoadout componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_00000085_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			entityQueryDesc.All = new ComponentType[1] { ComponentType.ReadOnly<CCrateAppliance>() };
			entityQueryDesc.None = new ComponentType[1] { ComponentType.ReadWrite<CProvidesLoadoutItem>() };
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_00000085_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_00000085_0024BurstDirectCall.Initialize();
		}
	}
}
