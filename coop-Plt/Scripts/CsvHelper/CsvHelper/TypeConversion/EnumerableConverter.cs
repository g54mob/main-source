...
namespace CsvHelper.TypeConversion
{
	public class EnumerableConverter : DefaultTypeConverter
	{
		...
		{
			string message = "Converting IEnumerable types is not supported for a single field. If you want to do this, create your own ITypeConverter and register it in the TypeConverterFactory by calling AddConverter.";
