...
namespace Kitchen
{
	public class LoopPlayersOutOfBoundsTutorial : FranchiseBuilderSystem
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(LoopPlayersOutOfBoundsTutorial componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_00000053_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000053_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000053_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000053_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, ref CPosition pos, in CPlayer player)
			{
				...
				{
					if (pos.Position.x > bounds.max.x)
					{
						pos.Position = new Vector3(bounds.min.x + 0.1f, 0f, pos.Position.z);
					}
					if (pos.Position.x < bounds.min.x)
					{
						pos.Position = new Vector3(bounds.max.x - 0.1f, 0f, pos.Position.z);
					}
					if (pos.Position.z > bounds.max.z)
					{
						pos.Position = new Vector3(pos.Position.x, 0f, bounds.min.z + 0.1f);
					}
					if (pos.Position.z < bounds.min.z)
					{
						pos.Position = new Vector3(pos.Position.x, 0f, bounds.max.z - 0.1f);
					}
					pos.ForceSnap = true;
				}
			}
			...
			public void ScheduleTimeInitialize(LoopPlayersOutOfBoundsTutorial componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_00000053_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_00000053_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_00000053_0024BurstDirectCall.Initialize();
		}
	}
}
