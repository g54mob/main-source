...
namespace Kitchen
{
	public class MovePlayersToStartFranchiseBuilder : FranchiseBuilderFirstFrameSystem
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(MovePlayersToStartFranchiseBuilder componentSystem)
				{
