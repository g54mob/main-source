...
namespace TwitchLib.Api.V5
{
	public class Badges : ApiBase
	{
		...
		public Task<ChannelDisplayBadges> GetSubscriberBadgesForChannelAsync(string channelId)
		{
			...
			return TwitchGetGenericAsync<ChannelDisplayBadges>("/v1/badges/channels/" + channelId + "/display", ApiVersion.V5, null, null, null, "https://badges.twitch.tv");
		}

		public Task<GlobalBadgesResponse> GetGlobalBadgesAsync()
		{
			return TwitchGetGenericAsync<GlobalBadgesResponse>("/v1/badges/global/display", ApiVersion.V5, null, null, null, "https://badges.twitch.tv");
		}
	}
}
