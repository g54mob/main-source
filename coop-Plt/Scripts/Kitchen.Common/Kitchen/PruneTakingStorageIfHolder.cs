...
namespace Kitchen
{
	...
	public class PruneTakingStorageIfHolder : GenericSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(PruneTakingStorageIfHolder componentSystem)
				{
			...
			public PruneTakingStorageIfHolder hostInstance;
		...
		{
			if (proposal.Status != ItemTransferStatus.Pruned && (proposal.Flags & TransferFlags.Storage) != TransferFlags.Null && Has<CHolderFirstIfStorage>(proposal.Source))
			{
