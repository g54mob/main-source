...
namespace Kitchen
{
	[UpdateBefore(typeof(CycleStorageAppliance))]
	public class MaintainStorageAppliances : GenericSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(MaintainStorageAppliances componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_0000008C_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_0000008C_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_0000008C_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_0000008C_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			[NoAlias]
			[ReadOnly]
			private ComponentDataFromEntity<CStoredBy> _ComponentDataFromEntity_CStoredBy_0;
			...
			private void OriginalLambdaBody(Entity e, ref DynamicBuffer<CItemStored> stored_items)
			{
				for (int i = 0; i < stored_items.Length; i++)
				{
					if (!_ComponentDataFromEntity_CStoredBy_0.HasComponent(stored_items[i]))
					{
						stored_items[i] = default(CItemStored);
					}
				}
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				for (int i = 0; i < count; i++)
				{
					...
					OriginalLambdaBody(e, ref stored_items);
				}
			}
			...
			public void ScheduleTimeInitialize(MaintainStorageAppliances componentSystem)
			{
				...
				_ComponentDataFromEntity_CStoredBy_0 = ((ComponentSystemBase)componentSystem).GetComponentDataFromEntity<CStoredBy>(true);
			}
			...
			{
				RunWithoutJobSystem_0000008C_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob1 : IJobChunk
		{
			...
			public unsafe delegate void RunWithoutJobSystem_00000093_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_00000093_0024BurstDirectCall
			{
				private static IntPtr Pointer;
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_00000093_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_00000093_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			internal void OriginalLambdaBody(Entity e, ref DynamicBuffer<CItemStored> stored_items, in CItemStorage storage)
			{
				if (!storage.IsStack)
				{
					return;
				...
				int num = 0;
				for (int num2 = stored_items.Length - 1; num2 >= 0; num2--)
				{
					if (stored_items[num2].StoredItem == default(Entity))
					{
						stored_items.RemoveAt(num2);
					}
					else
					{
						num++;
				...
				stored_items.ResizeUninitialized(num);
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				for (int i = 0; i < count; i++)
				{
					Entity e = runtimes.runtime_e.For(i);
					DynamicBuffer<CItemStored> stored_items = runtimes.runtime_stored_items.For(i);
					OriginalLambdaBody(e, ref stored_items, in runtimes.runtime_storage.For(i));
				}
			}
			...
			public unsafe static void RunWithoutJobSystem(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData)
			{
				RunWithoutJobSystem_00000093_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			(array[0] = new EntityQueryDesc()).All = new ComponentType[1] { ComponentType.ReadWrite<CItemStored>() };
		...
		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_0000008C_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_0000008C_0024BurstDirectCall.Initialize();
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob1_RunWithoutJobSystem_00000093_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob1.RunWithoutJobSystem_00000093_0024BurstDirectCall.Initialize();
		}
	}
}
