...
namespace Kitchen
{
	...
	public class UpdateForcedStackStorage : GenericSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass0_0
		{
			...
			internal void _003COnUpdate_003Eb__0(Entity e, in CItemHolder held, in CItemStorage storage)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				...
				public void ScheduleTimeInitialize(UpdateForcedStackStorage componentSystem)
				{
			...
			public unsafe delegate void RunWithoutJobSystem_000000B1_0024PostfixBurstDelegate(ArchetypeChunkIterator* archetypeChunkIterator, void* jobData);

			internal static class RunWithoutJobSystem_000000B1_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = (IntPtr)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RunWithoutJobSystem_000000B1_0024PostfixBurstDelegate).TypeHandle);
					}
					P_0 = Pointer;
				}
				...
				static RunWithoutJobSystem_000000B1_0024BurstDirectCall()
				{
					Constructor();
				}
			...
			internal void OriginalLambdaBody(Entity e, in CItemHolder held, in CItemStorage storage)
			{
				if (storage.IsStack && !(held.HeldItem != default(Entity)))
				{
					ecb.AddComponent<CCycleItemStorage>(e);
				}
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, [NoAlias] ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), in runtimes.runtime_held.For(i), in runtimes.runtime_storage.For(i));
				}
			}

			public void ScheduleTimeInitialize(UpdateForcedStackStorage componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
			...
			{
				RunWithoutJobSystem_000000B1_0024BurstDirectCall.Invoke(archetypeChunkIterator, jobData);
			}
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			entityQueryDesc.None = new ComponentType[1] { ComponentType.ReadWrite<CCycleItemStorage>() };
			return componentSystem.GetEntityQuery(array);
		}

		public static void Initialize_0024_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0_RunWithoutJobSystem_000000B1_0024BurstDirectCall()
		{
			_003C_003Ec__DisplayClass_OnUpdate_LambdaJob0.RunWithoutJobSystem_000000B1_0024BurstDirectCall.Initialize();
		}
	}
}
