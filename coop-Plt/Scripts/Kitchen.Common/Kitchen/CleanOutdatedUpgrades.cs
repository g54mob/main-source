...
namespace Kitchen
{
	public class CleanOutdatedUpgrades : GenericSystemBase
	{
		...
		private struct _003C_003Ec__DisplayClass0_0
		{
			...
			internal void _003COnUpdate_003Eb__0(Entity e, in CUpgrade upgrade, in CSettingUpgrade setting)
			{
		...
		private struct _003C_003Ec__DisplayClass_OnUpdate_LambdaJob0 : IJobChunk
		{
			private struct LambdaParameterValueProviders
			{
				public struct Runtimes
				{
					...
					public LambdaParameterValueProvider_IComponentData<CSettingUpgrade>.Runtime runtime_setting;
				}
				...
				[ReadOnly]
				private LambdaParameterValueProvider_IComponentData<CSettingUpgrade> forParameter_setting;

				public void ScheduleTimeInitialize(CleanOutdatedUpgrades componentSystem)
				{
			...
			internal void OriginalLambdaBody(Entity e, in CUpgrade upgrade, in CSettingUpgrade setting)
			{
				if (setting.SettingID == AssetReference.HalloweenSetting)
				{
					Debug.LogWarning("Clearing Halloween setting");
					ctx.Destroy(e);
				}
			}
			...
			public void IterateEntities(ref ArchetypeChunk chunk, ref LambdaParameterValueProviders.Runtimes runtimes)
			{
				...
				{
					OriginalLambdaBody(runtimes.runtime_e.For(i), in runtimes.runtime_upgrade.For(i), in runtimes.runtime_setting.For(i));
				}
			}

			public void ScheduleTimeInitialize(CleanOutdatedUpgrades componentSystem, ref _003C_003Ec__DisplayClass0_0 displayClass)
			{
		...
		public static EntityQuery _003C_003EGetEntityQuery_ForOnUpdate_LambdaJob0_From(ComponentSystemBase componentSystem)
		{
			...
			{
				ComponentType.ReadOnly<CUpgrade>(),
				ComponentType.ReadOnly<CSettingUpgrade>()
			};
