...
namespace Rewired
{
	public sealed class HOTASTemplate : ControllerTemplate, IHOTASTemplate, IControllerTemplate
	{
		...
		IControllerTemplateButton IHOTASTemplate.stickTrigger => null;

		IControllerTemplateButton IHOTASTemplate.stickTriggerStage2 => null;

		IControllerTemplateButton IHOTASTemplate.stickPinkyButton => null;

		IControllerTemplateButton IHOTASTemplate.stickPinkyTrigger => null;

		IControllerTemplateButton IHOTASTemplate.stickButton1 => null;

		IControllerTemplateButton IHOTASTemplate.stickButton2 => null;

		IControllerTemplateButton IHOTASTemplate.stickButton3 => null;

		IControllerTemplateButton IHOTASTemplate.stickButton4 => null;

		IControllerTemplateButton IHOTASTemplate.stickButton5 => null;

		IControllerTemplateButton IHOTASTemplate.stickButton6 => null;

		IControllerTemplateButton IHOTASTemplate.stickButton7 => null;

		IControllerTemplateButton IHOTASTemplate.stickButton8 => null;

		IControllerTemplateButton IHOTASTemplate.stickButton9 => null;

		IControllerTemplateButton IHOTASTemplate.stickButton10 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton1 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton2 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton3 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton4 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton5 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton6 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton7 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton8 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton9 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton10 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton11 => null;

		IControllerTemplateButton IHOTASTemplate.stickBaseButton12 => null;

		IControllerTemplateButton IHOTASTemplate.mode1 => null;

		IControllerTemplateButton IHOTASTemplate.mode2 => null;

		IControllerTemplateButton IHOTASTemplate.mode3 => null;

		IControllerTemplateButton IHOTASTemplate.throttleButton1 => null;

		IControllerTemplateButton IHOTASTemplate.throttleButton2 => null;

		IControllerTemplateButton IHOTASTemplate.throttleButton3 => null;

		IControllerTemplateButton IHOTASTemplate.throttleButton4 => null;

		IControllerTemplateButton IHOTASTemplate.throttleButton5 => null;

		IControllerTemplateButton IHOTASTemplate.throttleButton6 => null;

		IControllerTemplateButton IHOTASTemplate.throttleButton7 => null;

		IControllerTemplateButton IHOTASTemplate.throttleButton8 => null;

		IControllerTemplateButton IHOTASTemplate.throttleButton9 => null;

		IControllerTemplateButton IHOTASTemplate.throttleButton10 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton1 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton2 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton3 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton4 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton5 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton6 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton7 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton8 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton9 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton10 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton11 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton12 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton13 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton14 => null;

		IControllerTemplateButton IHOTASTemplate.throttleBaseButton15 => null;

		IControllerTemplateAxis IHOTASTemplate.throttleSlider1 => null;

		IControllerTemplateAxis IHOTASTemplate.throttleSlider2 => null;

		IControllerTemplateAxis IHOTASTemplate.throttleSlider3 => null;

		IControllerTemplateAxis IHOTASTemplate.throttleSlider4 => null;

		IControllerTemplateAxis IHOTASTemplate.throttleDial1 => null;

		IControllerTemplateAxis IHOTASTemplate.throttleDial2 => null;

		IControllerTemplateAxis IHOTASTemplate.throttleDial3 => null;

		IControllerTemplateAxis IHOTASTemplate.throttleDial4 => null;

		IControllerTemplateButton IHOTASTemplate.throttleWheel1Forward => null;

		IControllerTemplateButton IHOTASTemplate.throttleWheel1Back => null;

		IControllerTemplateButton IHOTASTemplate.throttleWheel1Press => null;

		IControllerTemplateButton IHOTASTemplate.throttleWheel2Forward => null;

		IControllerTemplateButton IHOTASTemplate.throttleWheel2Back => null;

		IControllerTemplateButton IHOTASTemplate.throttleWheel2Press => null;

		IControllerTemplateButton IHOTASTemplate.throttleWheel3Forward => null;

		IControllerTemplateButton IHOTASTemplate.throttleWheel3Back => null;

		IControllerTemplateButton IHOTASTemplate.throttleWheel3Press => null;

		IControllerTemplateAxis IHOTASTemplate.leftPedal => null;

		IControllerTemplateAxis IHOTASTemplate.rightPedal => null;

		IControllerTemplateAxis IHOTASTemplate.slidePedals => null;

		IControllerTemplateStick IHOTASTemplate.stick => null;

		IControllerTemplateThumbStick IHOTASTemplate.stickMiniStick1 => null;

		IControllerTemplateThumbStick IHOTASTemplate.stickMiniStick2 => null;

		IControllerTemplateHat IHOTASTemplate.stickHat1 => null;

		IControllerTemplateHat IHOTASTemplate.stickHat2 => null;

		IControllerTemplateHat IHOTASTemplate.stickHat3 => null;

		IControllerTemplateHat IHOTASTemplate.stickHat4 => null;

		IControllerTemplateThrottle IHOTASTemplate.throttle1 => null;

		IControllerTemplateThrottle IHOTASTemplate.throttle2 => null;

		IControllerTemplateThumbStick IHOTASTemplate.throttleMiniStick => null;

		IControllerTemplateHat IHOTASTemplate.throttleHat1 => null;

		IControllerTemplateHat IHOTASTemplate.throttleHat2 => null;

		IControllerTemplateHat IHOTASTemplate.throttleHat3 => null;

		IControllerTemplateHat IHOTASTemplate.throttleHat4 => null;
