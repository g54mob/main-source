...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class fEbANjecorfwXYqpJQYirDKymrs : IControllerExtensionSource
		{
			public readonly IDriver_DualShock4 SdrkurrNmqegCIcGzxlmzPxvtEE;

			public readonly bool XqGTZIoFqJEzYtPZLAGeNDbdpVG;

			public readonly int MfEzZmPsgQpPXFCudtWcxqDKNDx;

			public fEbANjecorfwXYqpJQYirDKymrs(IDriver_DualShock4 driver, bool supportsVibration, int vibrationMotorCount)
			{
			}
		}

		private fEbANjecorfwXYqpJQYirDKymrs imwgydyWOVgGruTMVBaQZGRbcjmk;
