...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class zZvvcJaCcLLobiuwvoXNoXHYHkj : IControllerExtensionSource
		{
			public readonly IDriver_RailDriver SdrkurrNmqegCIcGzxlmzPxvtEE;

			public zZvvcJaCcLLobiuwvoXNoXHYHkj(IDriver_RailDriver driver)
			{
			}
		}

		private zZvvcJaCcLLobiuwvoXNoXHYHkj nyCueoCEaeJTFXVlFaQxFQWnGtp;
