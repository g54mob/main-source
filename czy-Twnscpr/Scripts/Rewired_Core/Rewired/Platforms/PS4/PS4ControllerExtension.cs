...
namespace Rewired.Platforms.PS4
{
	...
	{
		internal class bWVJbybhbWUhNWrxaDrWgppsDgLe : IControllerExtensionSource
		{
			public readonly IPS4ControllerExtensionSource nyCueoCEaeJTFXVlFaQxFQWnGtp;

			public bWVJbybhbWUhNWrxaDrWgppsDgLe(IPS4ControllerExtensionSource source)
			{
			}
		}

		private readonly TimerAbs[] EfTidYLWBMPTWiVcqfqqziYjZcW;
		...
		private void wsHELmCkpDEMIppXIlYndwCDtBJk(int P_0, float P_1, float P_2)
		{
		}
	}
}
