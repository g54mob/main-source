...
namespace Rewired
{
	...
	{
		private const string WhsPYnIdxmfGfbehvORciojzoPwi = "USE_PROFILER must be set in Rewired Core to use the profiler.";
		...
		private static void SWxkTPPsMjtadjZXpMwWvOVLUWo()
		{
		}
