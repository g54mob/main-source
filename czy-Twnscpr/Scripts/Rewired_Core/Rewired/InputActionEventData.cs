...
namespace Rewired
{
	...
	{
		private UrgefVadKjrUWSPkNCMePslzHeYX xGeMHNzEHjgXMFENReFlHXtAFCgo;

		private InputActionEventType fNJeZrSqgtJdNFnSpZMFWYTNskd;
		...
		internal InputActionEventData(UrgefVadKjrUWSPkNCMePslzHeYX vc, int playerId, int actionId, UpdateLoopType updateLoop)
		{
			xGeMHNzEHjgXMFENReFlHXtAFCgo = null;
			fNJeZrSqgtJdNFnSpZMFWYTNskd = default(InputActionEventType);
			this.playerId = 0;
			this.actionId = 0;
