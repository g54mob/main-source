...
{
	public class SpawnerView : FactoryResourceHolderView<SpawnerBehaviour>
	{
		[SerializeField]
		...
		protected override void Init()
		{
			...
			_behaviour.OnChangeResource.RegisterMainThread(ChangeResource);
		...
		private void ResetView()
		{
			if (_behaviour != null)
			{
				...
				_behaviour.OnChangeResource.UnRegisterMainThread(ChangeResource);
			}
